...
test('lexing punctuators', () => {
  expect([...lex('!$&()...:=@[]{|}')]).toEqual([
    ...
    {contents: '(', index: 3, name: 'OPEN_PAREN'},
    {contents: ')', index: 4, name: 'CLOSE_PAREN'},
    {contents: '...', index: 5, name: 'ELLIPSIS'},
    {contents: ':', index: 8, name: 'COLON'},
    {contents: '=', index: 9, name: 'EQUALS'},
    {contents: '@', index: 10, name: 'AT'},
    {contents: '[', index: 11, name: 'OPEN_BRACKET'},
    {contents: ']', index: 12, name: 'CLOSE_BRACKET'},
    {contents: '{', index: 13, name: 'OPEN_BRACES'},
    {contents: '|', index: 14, name: 'BAR'},
    {contents: '}', index: 15, name: 'CLOSE_BRACES'},
  ]);
});
