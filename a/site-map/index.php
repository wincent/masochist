...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    >
      ...
      <tr>
        ...
        >
          ...
          /></a>
          <img
            src="/a/gfx/site-map-header.jpg"
            width="358"
            height="24"
            alt="wincent: site map and search"
            align="middle"
          />
          <!-- End: header content -->
        </td>
          ...
          <ul style="width: 72px; height: 25px;">
            <li class="menu">
              <a href="https://wincent.dev/a/site-map/" title="Site overview"
                ><img
                  src="/a/gfx/header/site-map-on.jpg"
                  width="72"
                  height="25"
                  alt="Site Map"
              /></a>
    ...
    <div id="breadcrumbs">
      <p><a href="https://wincent.dev/">Main</a>&nbsp;&gt;&nbsp;Site Map</p>
    </div>
    <div id="container">
      <div class="content">
        <h3>Site map</h3>
        ...
        <div class="two-columns">
          ...
          <ul>
            <li>
              <a
                href="https://wincent.dev/a/products/synergy-classic/"
                title="The original iTunes menu bar controller"
                >Synergy</a
              >
              <ul>
                ...
                <li>
                  <a
                    href="https://wincent.dev/a/products/synergy-classic/donate/"
                    title="Support development with a donation"
                    >Donate</a
                  >
                </li>
                ...
                <li>
                  <a
                    href="https://wincent.dev/a/products/synergy-classic/faq/"
                    title="Frequently Asked Questions"
                    >FAQ</a
                  >
                </li>
          ...
          <ul>
            ...
            <li>
              <a
                href="https://wincent.dev/a/products/winhex/"
                title="Programmers number conversion tool"
                >WinHex</a
              >
              <ul>
                <li>
                  <a
                    href="https://wincent.dev/a/products/winhex/download/"
                    title="Download WinHex"
                    >Download</a
                  >
                </li>
                <li>
                  <a
                    href="https://wincent.dev/a/products/winhex/purchase/"
                    title="Purchase WinHex"
                    >Purchase</a
                  >
                </li>
                <li>
                  <a
                    href="https://wincent.dev/a/products/winhex/donate/"
                    title="Support development with a donation"
                    >Donate</a
                  >
                </li>
                ...
                <li>
                  <a
                    href="https://wincent.dev/a/products/winhex/faq/"
                    title="Frequently Asked Questions"
                    >FAQ</a
                  >
                </li>
            ...
            <li>
              <a
                href="https://wincent.dev/a/products/wotest/"
                title="Objective-C unit testing framework"
                >WOTest</a
              >
              <ul>
                <li>
                  <a href="https://wincent.dev/a/products/wotest/#download"
                    >Download</a
                  >
                </li>
                <li>
                  <a href="https://wincent.dev/a/products/wotest/#donations"
                    >Donate</a
                  >
                </li>
              </ul>
            ...
            <li>
              ...
              <ul>
                <li>
                  <a
                    href="https://wincent.dev/a/products/wincent-strings-util/#download"
                    >Download</a
                  >
                </li>
                <li>
                  <a
                    href="https://wincent.dev/a/products/wincent-strings-util/#donations"
                    >Donate</a
                  >
                </li>
              </ul>
            ...
            <li>
              ...
              <ul>
                <li>
                  <a href="https://wincent.dev/a/products/atosym/#download"
                    >Download</a
                  >
                </li>
                <li>
                  <a href="https://wincent.dev/a/products/atosym/#donations"
                    >Donate</a
                  >
                </li>
              </ul>
            ...
            <li>
              ...
              <ul>
                <li>
                  <a href="https://wincent.dev/a/products/buildtools/#download"
                    >Download</a
                  >
                </li>
                <li>
                  <a href="https://wincent.dev/a/products/buildtools/#donations"
                    >Donate</a
                  >
                </li>
              </ul>
          ...
          <ul>
            <li>
              ...
              <ul>
                <li>
                  <a href="https://wincent.dev/a/products/bansshee/#download"
                    >Download</a
                  >
                </li>
                <li>
                  <a href="https://wincent.dev/a/products/bansshee/#donations"
                    >Donate</a
                  >
                </li>
              </ul>
        ...
        <div class="two-columns">
          ...
          <h4>
            <a href="../about/" title="About Wincent: the company">About</a>
          </h4>
