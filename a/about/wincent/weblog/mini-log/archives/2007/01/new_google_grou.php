...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2007/01/wordpress_upgra.php"
      title="WordPress upgrade"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2007/01/jpeg2000_flaw_s.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2007/01/jpeg2000_flaw_s.php"
            >JPEG2000 flaw (Safari denial-of-service) &raquo;</a
          >
        </p>
        ...
        <p>
          The updated
          <a href="http://groups.google.com/">Google Groups</a> interface is now
          out of beta. For me, Google has singlehandedly rescued NNTP from
          insignificance and extinction with its combination of a slick
          web-based interface, powerful search, and excellent spam protection
          (via <a href="http://gmail.com/">Gmail</a>).
        </p>
