...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2007/01/mediawiki_4.php"
      title="MediaWiki"
    />
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          Is
          <a
            href="http://weblog.rubyonrails.com/2007/1/19/rails-1-2-rest-admiration-http-lovefest-and-utf-8-celebrations"
            >out</a
          >. No time to work on the Rails rewrite of this site right now (and
          probably not for a long time), but still very happy to see the
          framework evolving.
        </p>

        <div id="a001130more"><div id="more"></div></div>
