    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2007/03/clamav_0901_and.php"
            >&laquo; ClamAV 0.90.1 and clamassassin 1.2.4 upgrade</a
          >
          |
        ...
        <p>
          <a
            href="https://wincent.dev/wiki/Building_and_installing_Ruby_1.8.6_on_Red_Hat_Enterprise_Linux_ES_3"
            >Red Hat upgrade notes</a
          >;
          <a
            href="https://wincent.dev/wiki/Building_and_installing_Ruby_1.8.6_on_Mac_OS_X_Tiger"
            >Mac OS X upgrade notes</a
          >.
        </p>

        <div id="a001318more"><div id="more"></div></div>
