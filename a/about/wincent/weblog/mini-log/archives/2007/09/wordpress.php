    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          <a
            title="WordPress 2.3"
            href="http://wordpress.org/development/2007/09/wordpress-23/"
            >WordPress 2.3</a
          >
          now includes an update notification feature: great for helping you
          keep on top of all those rushed remote vulnerability fixes.
        </p>

        <div id="a002758more"><div id="more"></div></div>
