    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2007/10/cars_announces.php"
            >CARS announces new books &raquo;</a
          >
        </p>
        ...
        <p>
          <a href="http://railsnewbie.com/files/fixture_replacement_demo.mov"
            >Looks very handy</a
          >
          (MOV).
        </p>

        <div id="a002788more"><div id="more"></div></div>
