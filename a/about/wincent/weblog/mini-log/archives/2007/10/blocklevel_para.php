...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2007/10/videos_on_stack.php"
      title="Videos on stack/malloc exploits"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2007/10/zfs.php"
      title="ZFS"
    />
  </head>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2007/10/videos_on_stack.php"
            >&laquo; Videos on stack/malloc exploits</a
          >
          |
        ...
        <p>
          Wolf
          <a href="http://rentzsch.com/notes/blocklevelParallelsFusionMigration"
            >jumps through hoops</a
          >
          to keep his virtualized mail server running. But I'm puzzled as to
          <em>why</em> he's doing this in a virtualized environment anyway. What
          can Debian do that — the obviously extremely-capable — Rentzsch can't
          get Max OS X to do?
        </p>

        <div id="a002802more"><div id="more"></div></div>
