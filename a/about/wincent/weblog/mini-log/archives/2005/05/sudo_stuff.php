...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2005/05/busy_busy_busy.php"
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          Some clean-up of WOSudo and using a 10.3-only feature on it; additions
          to NSDictionary category; nice UI for turning the Dock icon on and
          off.
        </p>

        <div id="a000080more"><div id="more"></div></div>
