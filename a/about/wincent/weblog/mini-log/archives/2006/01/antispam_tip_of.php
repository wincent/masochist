...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/01/wosingleton.php"
      title="WOSingleton"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/02/server_updgrade.php"
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          Sort your spam folder by "Subject". It makes it easier to visually
          scan the folder rapidly to make sure there are no false positives;
          often many spam messages will have matching subjects and so will stand
          out when grouped together, and if you don't speak asian languages then
          you'll benefit from seeing most of the asian-character-based messages
          bubble up to the top.
        </p>

        <div id="a000194more"><div id="more"></div></div>
