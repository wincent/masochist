...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/02/z800i.php"
      title="Z800i"
    />
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          I was just upgrading some Perl CPAN modules. If you had trouble access
          the Bugzilla install while I was doing that sorry for the
          inconvenience (you may have seen some Internal Server Errors and some
          Forbidden responses). I'm all done now and everything should be
          working fine.
        </p>

        <div id="a000211more"><div id="more"></div></div>
