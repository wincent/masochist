...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/09/ruby_185.php"
      title="Ruby 1.8.5"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/09/potentially_of.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/09/potentially_of.php"
            >Potentially of interest &raquo;</a
          >
        </p>
        ...
        <p>
          I just subscribed to the RSS feed for my site-wide "activity log".
          Probably should have done it long ago, but I've just realized that it
          allows me to keep track of things like what people are searching for
          on the site (search strings) and so will help me to improve the
          navigation and make things easier to find.
        </p>

        <div id="a000436more"><div id="more"></div></div>
