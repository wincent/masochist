  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        Non-square album art is working again as shown in the screenshot below
        (see yesterday's post for an image showing the incorrect behaviour): At
        the same time I took the opportunity to implement customizability for
        the badge size, position and border...
        <p>
          <a
        ...
        This was a novel one and the first non-kernel panic involuntary reboot
        I've ever had with the iMac. Today I was waiting for a compile to finish
        and was wishing a friend a merry Christmas over IM when I noticed...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/12/involuntary_reb_7.php"
            >Read full article</a
          >
        </p>
        ...
        With every major release of Mac OS X Apple delivers some delicious new
        APIs to developers. I've missed out on these a lot in the past because
        I've wanted my products to support older versions of Mac OS X. It's...
        <p>
          <a
        ...
        Was quite surprised today when browsing the articles linked to (via this
        article) from Scott Stevenson's new Cocoa Blogs site. I've never used
        NSUndoManager and so I didn't realize that there's actually an example
        of trampoline-based HOM in an Apple...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/12/hom_in_apple.php"
            >Read full article</a
          >
        </p>
        ...
        My take on the MacHeist debacle: yes all publicity is good publicity but
        I also think the support cost of selling somewhere in the ballpark of
        10,000 to 15,000 licenses in a single week would be staggering. At fifty
        cents...
        <p>
          <a
        ...
        Sometimes you are working on a thorny coding problem and find yourself
        feeling less and less happy with the number of kludgey hacks you're
        having to implement in order to get things working. Then comes a "duh!"
        moment in which...
        <p>
          <a
