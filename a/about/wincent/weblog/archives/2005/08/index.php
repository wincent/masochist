  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          The submenus in Synergy Advance can be pretty large if you have a
          large iTunes music library.... If your library has 50,000 songs in it
          then the submenu showing the library playlist alone will contain
          50,000 menu items (and all of those items will appear in the Artists
          and Genres submenus too at various places).
        </p>
        <p>
          <a
