...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/archives/2005/04/"
      title="April 2005"
    />
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a href="https://wincent.dev/a/about/wincent/weblog/archives/2005/04/"
            >&laquo; April 2005</a
          >
          |
        ...
        <p>
          I made notes as I went along and I include them below because perhaps
          some day they will help someone who finds themselvesNotesWell, with
          the backup finally finished (and earlier than expected because
          Impression is incapable of splitting large files over more than two
          DVDs; I had to handle the largest file by hand) it was time to try and
          get this RAID up and running again.Another boot from the Tiger install
          DVD and more fruitless clicking in the Disk Utility UI.... I tried
          "diskutil list", "diskutil destroyRAID /dev/disk2" ("does not appear
          to be a RAID master"), "diskutil eraseDisk HFS+ Untitled1 disk0"
          (stalled at "Creating Partition Map"), "diskutil eraseDisk
          JournaledHFS+ Untitled1 disk0" (also stalled at "Creating Partition
          Map"), "diskutil eraseDisk JournaledHFS+ Untitled1 disk1"
          ("Partitioning encountered error Bad file descriptor (9) on disk
          disk1"), "diskutil partitionDisk disk0 1 JournaledHFS+ Untitled1 10GB"
          (stalled again), "diskutil partitionDisk disk1 1 JournaledHFS+
          Untitled2 10GB", "diskutil repairVolume disk0" ("Error (-9958)
          encounterd attempting to verify/repair disk0", "diskutil repairVolume
          disk1" (same error), "diskutil repairVolume disk2" ("Can't open
          /dev/rdisk2: Resource busy").Next avenue: fsck.
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2005/05/1041_kernel_pan.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          I've just launched piratewatch.org, a developer community with one
          goal: to share information to help one another to efficiently combat
          piracy. It's an idea I've been mulling over for a while; that pirates
          have turned "sharing" into a fine art and that perhaps we would do
          well to use their own weapon against them.
        </p>
        <p>
          <a
        ...
        <p>
          I just read this article at rumor site Think Secret, where they claim
          that "FileMaker Developer" will be renamed to "FileMaker Pro
          Advanced". I know that some have question why I chose to name my new
          product "Synergy Advance", but this move by FileMaker seems a little
        ...
        <p>
          "AEGizmo" is the name for a set of APIs developed by Apple's Jens
          Peter Alfke between 1991 and 1995.
        </p>
        <p>
          <a
        ...
        <p>
          Network Solutions' time in the sun has ended. It's GoDaddy's turn now.
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2005/05/godaddy_vs_netw.php"
            >Read full article</a
          >
        </p>
