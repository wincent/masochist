...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Wincent Colaiuta's weblog: December 2007 Archives</title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/archives/2008/01/"
      title="January 2008"
    />
  </head>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          |
          <a href="https://wincent.dev/a/about/wincent/weblog/archives/2008/01/"
            >January 2008 &raquo;</a
          >
        </p>

        <h2>December 23, 2007</h2>

        <h3 id="a003357">Version numbers</h3>

        I've always been a little confused by Apple's &quot;Property List Key
        Reference&quot;. It seemed that the documented purpose of some of the
        property list keys deviated from the actual behaviour of the OS,
        especial in relation with the display of...
        <p>
          <a
        ...
        <h2>December 21, 2007</h2>

        <h3 id="a003315">Involuntary Reboot Log #22</h3>

        When I got home my machine, which had been up for about a day and had a
        bunch of in-progress work in open applications, started acting funny.
        New Terminal windows were totally blank (neither the command prompt nor
        any other...
        <p>
          <a
        ...
        <h2>December 20, 2007</h2>

        <h3 id="a003293">New keyboard</h3>

        Lately the crusty old white keyboard that came with my iMac has been
        getting harder and harder to use. Key combinations were getting hard to
        type because the Command key would stick at the top unless you pushed
        down really...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/12/new_keyboard.php"
            >Read full article</a
          >
        </p>
        ...
        You used to be able to do this prior to Xcode 3, but I can't see how to
        do this in the current release. Anyone know how? Without this feature
        the scripts menu becomes next to useless (for my usage...
        <p>
          <a
        ...
        <h2>December 15, 2007</h2>

        <h3 id="a003272">Memory management tips under Garbage Collection</h3>

        The CFRelease function Good old-fashioned reference counting (with
        retain and release) has been thrown out the window in the brave new
        Garbage Collected world. Core Foundation objects are Garbage Collected
        too, but they continue to use a reference counting layer...
        <p>
          <a
        ...
        <h2>December 14, 2007</h2>

        <h3 id="a003269">RSpec 1.1.0</h3>

        The release notes belie the scope of the changes in this RSpec release.
        It's been a long time, and this is a huge release with, for me, three
        big things: the &quot;Story Runner&quot; nested example groups total and
        ...
        <h2>December 11, 2007</h2>

        <h3 id="a003264">What is a "release candidate"?</h3>

        A limited definition of &quot;release candidate&quot; is &quot;these are
        the exact binary bits that we think we'll be shipping; and if no
        show-stopping bugs are reported we'll go ahead and ship these exact
        bits&quot;. Personally, I like to nuance this...
        <p>
          <a
        ...
        <h2>December 8, 2007</h2>

        <h3 id="a003224">On Perl's beauty</h3>

        From a comment on this Slashdot story: Every year the design for Perl 6
        becomes more and more contorted and ultra-complicated, basically taking
        every cool feature Larry sees in other languages and mashing them
        together into an incoherent Mulligan stew....
        <p>
          <a
        ...
        <h2>December 5, 2007</h2>

        <h3 id="a003204">Xcode tip: kill the index</h3>

        Just now Xcode crashed while in the background. I immediately checked
        for project.pbxproj corruption but Git showed me that the file was
        unchanged. Each time I tried to open the project Xcode would beachball
        for a few seconds and then...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/12/xcode_tip_kill.php"
            >Read full article</a
          >
        </p>
        ...
        <h3 id="a003203">Bash completion for Git</h3>

        If you're using Git and Bash (if you're using a programmer and have the
        freedom to choose the SCM you use then the former should be true; if
        you're a Mac OS X user then the latter is true by...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/12/bash_completion.php"
            >Read full article</a
          >
        </p>
