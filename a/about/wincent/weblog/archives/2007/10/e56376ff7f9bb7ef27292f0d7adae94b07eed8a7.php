    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/10/creating_new_da.php"
            >&laquo; Creating new daemon users on Leopard</a
          >
          |
        ...
        <h3>USB stick contents <em>before</em> visit to local print shop</h3>

        <ul>
          <li>5 PDF documents</li>
        </ul>
        <h3>USB stick contents <em>after</em> visit to local print shop</h3>

        <ul>
          <li>5 PDF documents</li>
          <li>
            <tt>AutoRun.inf</tt> (with <tt>arch</tt>, <tt>uchg</tt>,
            <tt>hidden</tt> attributes all set; requires root privileges to
            delete)
          </li>
          <li><tt>Data 9.exe</tt></li>
          <li>
            <tt>RavMon.exe</tt> (with <tt>arch</tt>, <tt>uchg</tt>,
            <tt>hidden</tt> attributes all set)
          </li>
          <li>
            <tt
              >._Cargando “Prepress and Printing Terms | Prepress
              Vocabulary”.pdf</tt
            >
            (executable)
          </li>
          <li>
            <tt
              >._BBC NEWS | Entertainment | Police reschedule postponed
              dates.pdf</tt
            >
            (executable)
          </li>
          ...
          <li>
            <tt
              >.Spotlight-V100/Store-V1/Stores/929365BA-861C-404D-BF69-F1ED71E2B3ED/929365BA-861C-404D-BF69-F1ED71E2B3ED.exe</tt
            >
          </li>
        </ul>
        <p>And I got those extra files for <em>free</em>!</p>

        <div id="a002862more"><div id="more"></div></div>
