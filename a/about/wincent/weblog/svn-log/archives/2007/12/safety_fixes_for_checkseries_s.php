...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Safety fixes for check-series script (snippets, 44b1750)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/checkseries_fix_snippets_5c297.php"
            >&laquo; check-series fix (snippets, 5c29711)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/modernize_nstimer_pausing_cate.php"
            >Modernize NSTimer pausing category (Synergy, cd5a4ed) &raquo;</a
          >
        </p>
        ...
        <p>
          Now refuses to run if there are any staged or unstaged changes, and
          actually updates both index and working tree back to old HEAD upon
          finishing (previously we just manipulated the HEAD directly; this was
          a kludge and incorrect anyway because it didn't touch the index or
          working tree).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003268more"><div id="more"></div></div>
