...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update internal list when login items are added or
      removed (WOCommon, ff094c5)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/use_womakecollectable_function.php"
      title="Use WOMakeCollectable function where appropriate (WOCommon, 6eb9559)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/checkseries_fix_snippets_5c297.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/use_womakecollectable_function.php"
            >&laquo; Use WOMakeCollectable function where appropriate (WOCommon,
            6eb9559)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/checkseries_fix_snippets_5c297.php"
            >check-series fix (snippets, 5c29711) &raquo;</a
          >
        </p>
        ...
        <h3>
          Update internal list when login items are added or removed (WOCommon,
          ff094c5)
        </h3>

        <p>
          Add a refreshList method (internal use only) which is called whenever
          we add or remove a login item.
        </p>

        <p>
          This also moves some of the addition logic from WOLoginItemList into a
          new addToList: method in WOLoginItem; in this way each login item can
          keep track of its corresponding LS ref without breaking encapsulation.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003262more"><div id="more"></div></div>
