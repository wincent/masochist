...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Allow explicit override of output encoding (Wincent
      Strings Utility, 6afbc3c)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/split_specs_into_separate_file.php"
      title="Split specs into separate files (Wincent Strings Utility, d789a0b)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/work_around_cfstringcreateexte.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/split_specs_into_separate_file.php"
            >&laquo; Split specs into separate files (Wincent Strings Utility,
            d789a0b)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/work_around_cfstringcreateexte.php"
            >Work around CFStringCreateExternalRepresentation() bug (Wincent
            Strings Utility, b02b784) &raquo;</a
          >
        </p>
        ...
        <h3>
          Allow explicit override of output encoding (Wincent Strings Utility,
          6afbc3c)
        </h3>

        <p>
          This allows wincent-strings-util to be used as a general &quot;clean
          up&quot; tool for localizations. For example, a localization might be
          completed but have excess whitespace and be encoded with a different
          endianness (ie. the original version is sent to the localizer as
          little-endian but the localizer uses an editor which saves it in
          big-endian encoding).
        </p>
