...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update Launch Services and login items at launch
      (Synergy, a93bd55)
    </title>
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          Teach the new wrapper application to take on these two
          responsibilities that were previously handled by the installer.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003422more"><div id="more"></div></div>
