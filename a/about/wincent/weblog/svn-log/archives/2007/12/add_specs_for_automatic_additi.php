...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add specs for automatic addition of BOMs to output
      (Wincent Strings Utility, 36576bc)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/add_test_case_for_cfstringcrea.php"
            >&laquo; Add test case for CFStringCreateExternalRepresentation()
            bug (Wincent Strings Utility, f9236a6)</a
          >
          |
        ...
        <h3>
          Add specs for automatic addition of BOMs to output (Wincent Strings
          Utility, 36576bc)
        </h3>

        <p>
          Make sure that when the input file has no BOM, we automatically add
          one to the output stream.
        </p>
