...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix pending tests by using fallback encodings (Wincent
      Strings Utility, 3f897ce)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/add_specs_for_automatic_additi.php"
      title="Add specs for automatic addition of BOMs to output (Wincent Strings Utility, 36576bc)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/try_multiple_encodings_in_info.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/add_specs_for_automatic_additi.php"
            >&laquo; Add specs for automatic addition of BOMs to output (Wincent
            Strings Utility, 36576bc)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/try_multiple_encodings_in_info.php"
            >Try multiple encodings in -info/-strings code path (Wincent Strings
            Utility, fb6f577) &raquo;</a
          >
        </p>
        ...
        <h3>
          Fix pending tests by using fallback encodings (Wincent Strings
          Utility, 3f897ce)
        </h3>

        <p>
          Instead of using the deprecated NSString stringWithContentsOfFile:
          method (not sure why no deprecation warnings were being issued)
          instead use stringWithContentsOfFile:encoding:error:. The problem with
          the former is that any strings file without a BOM was being
          interpreted using the normal C string encoding, which was incorrect
        ...
        <p>
          ...
          NSUTF16LittleEndianStringEncoding and NSUTF16BigEndianStringEncoding
          if parsing fails.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003335more"><div id="more"></div></div>
