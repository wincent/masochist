...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Reference top-level nib objects for GC and clean
      localizations (Synergy, 28983e7)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/reference_toplevel_nib_objects.php"
      title="Reference top-level nib objects for GC and clean localizations (Synergy, 28983e7)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/rename_englishlproj_to_enlproj_1.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/reference_toplevel_nib_objects.php"
            >&laquo; Reference top-level nib objects for GC and clean
            localizations (Synergy, 28983e7)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/rename_englishlproj_to_enlproj_1.php"
            >Rename English.lproj to en.lproj (Synergy, 636b746) &raquo;</a
          >
        </p>
        ...
        <p>
          I would have liked to propagate this same change to the other nibs
          using ibtool but unfortunately there are quite a few errors (class
          mismatches) reported that prevent this from proceeding; so somewhere
          in the long history of these nibs they have gotten far enough out of
          sync with the authoritative English versions to make them unusable
          with ibtool.
        </p>
        ...
        <p>
          ...
          and copy the strings across by hand from the older localizations that
          I have on file. This will be a lengthy and painful job, so it might be
          sometime before it gets completed.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003409more"><div id="more"></div></div>
