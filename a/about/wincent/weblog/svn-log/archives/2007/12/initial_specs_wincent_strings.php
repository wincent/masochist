...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Initial specs (Wincent Strings Utility, 46693cf)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/handle_case_where_base_is_supp.php"
      title="Handle case where -base is supplied with no other options (Wincent Strings Utility, 06911e1)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/add_specs_for_basic_merge_use.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/handle_case_where_base_is_supp.php"
            >&laquo; Handle case where -base is supplied with no other options
            (Wincent Strings Utility, 06911e1)</a
          >
          |
        ...
        <p>
          This is an initial batch of specs written using RSpec. Seeing as this
          is such a simple tool there doesn't seem to be much sense in doing
          internal testing at the Objective-C level; instead just run the tool
          itself and make sure it does what it's supposed to do. RSpec is used
          despite the fact that wincent-strings-util has absolutely no Ruby in
