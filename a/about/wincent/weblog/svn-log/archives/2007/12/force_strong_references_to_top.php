...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Force strong references to top-level nib objects
      (Synergy, b2cc476)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/force_strong_references_to_top_1.php"
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          Set up some phoney outlets to the top-level objects in the nib so as
          to create strong references to them and thus avoid having them garbage
          collected.
        </p>
        ...
        <p>
          ...
          outlets for all &quot;real&quot; (instantiated) top-level objects (at
          this stage that only means the controller and the MainMenu).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003299more"><div id="more"></div></div>
