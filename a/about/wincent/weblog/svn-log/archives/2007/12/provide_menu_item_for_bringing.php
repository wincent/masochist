...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Provide menu item for bringing preferences window on
      screen (Synergy, c2adcef)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/fix_window_closing_and_termina.php"
      title="Fix window closing and termination behaviour (Synergy, 52c8406)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/close_the_application_when_las.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/fix_window_closing_and_termina.php"
            >&laquo; Fix window closing and termination behaviour (Synergy,
            52c8406)</a
          >
          |
        ...
        <h3>
          Provide menu item for bringing preferences window on screen (Synergy,
          c2adcef)
        </h3>

        <p>
          Useful for when user dismisses preferences window and later decides
          that he/she wants it back.
        </p>

        <p>
          An interesting case is when there are unapplied changes; if the user
          tries to close the window, clicks &quot;Don't Apply&quot;, and then
          tries to quit the application then the window will come back on screen
          again and the sheet will be shown.
        </p>

        <p>
          In order to support this repeated showing of the preferences window
          had to use the setReleasedWhenClosed: method. Note that I may later
          decide to auto-quit the application when the last window is closed.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003448more"><div id="more"></div></div>
