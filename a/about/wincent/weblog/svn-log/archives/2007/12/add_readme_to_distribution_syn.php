...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add README to distribution (Synergy, 7ae6b07)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/add_lsminimumsystemversion_to.php"
      title="Add LSMinimumSystemVersion to Info.plist (Synergy, 10c1f84)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/parenthesize_arguments_to_sile.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/add_lsminimumsystemversion_to.php"
            >&laquo; Add LSMinimumSystemVersion to Info.plist (Synergy,
            10c1f84)</a
          >
          |
        ...
        <p>
          A README is probably necessary given the number of important changes
          in the 3.5 release (principally the change of format from System
        ...
        <div id="a003462more"><div id="more"></div></div>
