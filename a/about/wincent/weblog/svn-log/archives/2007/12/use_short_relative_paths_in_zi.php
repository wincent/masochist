...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Use short relative paths in zip archive (Synergy,
      c9bbb45)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/move_sample_files_into_subdire_1.php"
      title="Move sample files into subdirectory (Synergy, 9d5cbbf)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/use_short_relative_paths_in_zi_1.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/move_sample_files_into_subdire_1.php"
            >&laquo; Move sample files into subdirectory (Synergy, 9d5cbbf)</a
          >
          |
        ...
        <p>
          Don't use absolute paths when preparing the zip archive (all the
          levels wind up in the extracted contents as well); instead keep the
          relative paths as short as possible by changing into the target build
          dir before preparing the archive.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003379more"><div id="more"></div></div>
