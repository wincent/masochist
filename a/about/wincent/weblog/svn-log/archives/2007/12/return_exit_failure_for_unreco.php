...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Return EXIT_FAILURE for unrecognized or illegal options
      (login-tool, 216f8a3)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/add_system_events_target_and_h.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/target_cleanup_logintool_960ca.php"
            >&laquo; Target clean-up (login-tool, 960ca1e)</a
          >
          |
        ...
        <h3>
          Return EXIT_FAILURE for unrecognized or illegal options (login-tool,
          216f8a3)
        </h3>
        ...
        <div id="a003213more"><div id="more"></div></div>
