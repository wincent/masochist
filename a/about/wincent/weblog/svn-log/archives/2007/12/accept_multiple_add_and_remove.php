...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Accept multiple add and remove arguments (login-tool,
      0931d52)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/switch_to_new_launch_services.php"
            >&laquo; Switch to new Launch Services code in WOCommon (login-tool,
            f0a9c33)</a
          >
          |
        ...
        <div id="a003227more"><div id="more"></div></div>
