...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Avoid unnecessary re-setting of color (gdiff, 924a2d6)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/move_wo_border_width_macro_int.php"
      title="Move WO_BORDER_WIDTH macro into global header (gdiff, 8cfdf80)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/teach_glue_view_to_draw_border.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/move_wo_border_width_macro_int.php"
            >&laquo; Move WO_BORDER_WIDTH macro into global header (gdiff,
            8cfdf80)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/teach_glue_view_to_draw_border.php"
            >Teach glue view to draw borders (gdiff, 63cfac2) &raquo;</a
          >
        </p>
        ...
        <p>
          If left border was already drawn, no need to re-set the border color
          again before drawing the right border.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003001more"><div id="more"></div></div>
