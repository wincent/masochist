...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Tell Rails to use UTF-8 in the database (wincent.dev,
      4aba1f8)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/bootstrap_fixturereplacement_w.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/ignore_logs_and_temporary_file.php"
            >&laquo; Ignore logs and temporary files (wincent.dev, 322b6f1)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/bootstrap_fixturereplacement_w.php"
            >Bootstrap FixtureReplacement (wincent.dev, 0dfd797) &raquo;</a
          >
        </p>

        <h2>October 5, 2007</h2>

        <h3>Tell Rails to use UTF-8 in the database (wincent.dev, 4aba1f8)</h3>

        <p>
          Update the configuration to reflect the encoding used in the
          databases.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003056more"><div id="more"></div></div>
