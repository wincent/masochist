...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update WORegistrationTextFieldCell for GC (WOCommon,
      932eefb)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/update_unit_tests_for_garbage.php"
      title="Update unit tests for Garbage Collection (WOCommon, ba8ebeb)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_notes_to_woprocesslauncher.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/update_unit_tests_for_garbage.php"
            >&laquo; Update unit tests for Garbage Collection (WOCommon,
            ba8ebeb)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_notes_to_woprocesslauncher.php"
            >Add notes to WOProcessLauncher class (WOCommon, 366cbb0) &raquo;</a
          >
        </p>
        ...
        <p>
          Changes for GC under Leopard: the move to GC here not only allows us
          to get rid of lots of retains and releases, but we can also dispose of
          the reference counting tricks that we needed in order to keep a single
          shared instance of the field editor.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002879more"><div id="more"></div></div>
