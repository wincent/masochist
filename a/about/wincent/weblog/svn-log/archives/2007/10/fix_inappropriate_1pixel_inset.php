...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix inappropriate 1-pixel inset inside grouping views
      (gdiff, 6c01eb2)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/teach_wodiffview_to_draw_top_a.php"
      title="Teach WODiffView to draw top and bottom borders (gdiff, dc4575c)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/change_scroll_view_nesting_gdi.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/teach_wodiffview_to_draw_top_a.php"
            >&laquo; Teach WODiffView to draw top and bottom borders (gdiff,
            dc4575c)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/change_scroll_view_nesting_gdi.php"
            >Change scroll view nesting (gdiff, 106eb63) &raquo;</a
          >
        </p>
        ...
        <p>
          Fix alignment bug introduced along with the addition of upper and
          lower borders. Only the outermost subviews need to be inset by one
          pixel; additional subviews nested inside the outermost subviews
          automatically inherit that base positioning and therefore shouldn't
          specify an additional inset.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003004more"><div id="more"></div></div>
