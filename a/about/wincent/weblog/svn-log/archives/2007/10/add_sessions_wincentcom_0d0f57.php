...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Add sessions (wincent.dev, 0d0f571)</title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/pretty_formatting_for_creation.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_user_model_wincentcom_d9a5.php"
            >&laquo; Add user model (wincent.dev, d9a50e5)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/pretty_formatting_for_creation.php"
            >Pretty formatting for creation/update timestamps (wincent.dev,
            fba09f2) &raquo;</a
          >
        </p>
        ...
        <h3>Add sessions (wincent.dev, 0d0f571)</h3>

        <p>
          Add a sessions controller and helper; no model is required and the
          truth is that even the helper may prove to be unnecessary in the long
          run. This commit also includes a migration and modifications to the
          routes.rb file to direct the &quot;login&quot; and &quot;logout&quot;
          URLs to the appropriate actions in the sessions controller.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003069more"><div id="more"></div></div>
