...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Garbage collection for NSArrayController+WODragUtilities
      category (WOCommon, 235882a)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/garbage_collection_for_ciimage.php"
            >&laquo; Garbage collection for CIImage+WOConvenience category
            (WOCommon, 35882a2)</a
          >
          |
        ...
        <div id="a002866more"><div id="more"></div></div>
