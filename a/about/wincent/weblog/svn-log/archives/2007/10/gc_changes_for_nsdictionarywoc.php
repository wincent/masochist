...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: GC changes for NSDictionary+WOCreation category
      (WOCommon, ca0232d)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/garbage_collection_for_nsarray.php"
      title="Garbage collection for NSArrayController+WODragUtilities category (WOCommon, 235882a)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/gc_changes_for_nsfilemanagerwo.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/garbage_collection_for_nsarray.php"
            >&laquo; Garbage collection for NSArrayController+WODragUtilities
            category (WOCommon, 235882a)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/gc_changes_for_nsfilemanagerwo.php"
            >GC changes for NSFileManager+WOPathUtilities category (WOCommon,
            0a2b28e) &raquo;</a
          >
        </p>
        ...
        <p>
          In moving from referencing counting to GC for Leopard also fixed a
          tiny leak that could occur in the dictionaryWithKeysAndObjects: method
          in the event that an exception were thrown; in doing so we also avoid
          the expense of entering a @try block.
        </p>

        <div id="a002867more"><div id="more"></div></div>
