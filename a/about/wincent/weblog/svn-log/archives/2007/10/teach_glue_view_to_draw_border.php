...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Teach glue view to draw borders (gdiff, 63cfac2)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/avoid_unnecessary_resetting_of.php"
            >&laquo; Avoid unnecessary re-setting of color (gdiff, 924a2d6)</a
          >
          |
        ...
        <p>
          The WOGlueView class now also draws light gray separator borders (1
          pixel thick) on the left and right.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003002more"><div id="more"></div></div>
