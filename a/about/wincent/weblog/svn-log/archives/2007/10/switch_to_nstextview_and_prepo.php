...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Switch to NSTextView and prepopulate with test data
      (gdiff, a0c959b)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/synergy_r407_16_items_changed.php"
      title="Synergy r407, 16 items changed"
    />
  </head>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/show_placeholder_line_number_i.php"
            >&laquo; Show placeholder line number in WOGutterView (gdiff,
            0c87a5b)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/synergy_r407_16_items_changed.php"
            >Synergy r407, 16 items changed &raquo;</a
          >
        </p>
        ...
        <p>
          Now WOFileView is an NSTextView subclass rather than just a direct
          NSView subclass. This required extensive fiddling in order to get the
          desired auto-resizing and wrapping behavior. To show that it works the
          views are prepopulated with the sample data.
        </p>

        <p>
          There are still some rough edges and other things to take care of,
          namely: the horizontal scroll bars don't appear until the window size
          is manipulated, and; text is drawn aliased (would prefer unaliased
          text in this case).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003007more"><div id="more"></div></div>
