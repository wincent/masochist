...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: GC changes for NSFileManager+WOPathUtilities category
      (WOCommon, 0a2b28e)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/gc_changes_for_nsdictionarywoc.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/gc_changes_for_nsdictionarywoc.php"
            >&laquo; GC changes for NSDictionary+WOCreation category (WOCommon,
            ca0232d)</a
          >
          |
        ...
        <p>
          Under GC and Leopard it no longer makes any sense to use the
          WO_RELEASE macro; use CFRelease instead.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002868more"><div id="more"></div></div>
