...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Makefile cleanup and corrections (wikitext, f2254e1)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/keep_knowngood_antlr_version_i.php"
      title="Keep known-good ANTLR version in repository (wikitext, 85a0852)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/eliminate_scm_noise_by_changin.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/keep_knowngood_antlr_version_i.php"
            >&laquo; Keep known-good ANTLR version in repository (wikitext,
            85a0852)</a
          >
          |
        ...
        <p>
          The makefile now correctly handles dependencies in an optimal way (the
          previous version sometimes re-compiled too much or too little). Now
          touching any of the dependent files will trigger an appropriate ANTLR
          run (if needed), and/or re-compilation or re-linking of only the
          necessary files.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003021more"><div id="more"></div></div>
