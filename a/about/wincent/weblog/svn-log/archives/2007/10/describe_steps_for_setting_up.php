...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Describe steps for setting up database (wincent.dev,
      7208f45)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/bootstrap_rspec_wincentcom_18f.php"
      title="Bootstrap RSpec (wincent.dev, 18f33b5)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/ignore_logs_and_temporary_file.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/bootstrap_rspec_wincentcom_18f.php"
            >&laquo; Bootstrap RSpec (wincent.dev, 18f33b5)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/ignore_logs_and_temporary_file.php"
            >Ignore logs and temporary files (wincent.dev, 322b6f1) &raquo;</a
          >
        </p>

        <h2>October 5, 2007</h2>

        <h3>Describe steps for setting up database (wincent.dev, 7208f45)</h3>

        <p>
          Instructions for setting up local development and test databases
          (passwordless access to a local MySQL instance). Once the database is
