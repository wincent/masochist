...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Tweak extension build for Leopard compatibility
      (wikitext, 7a51010)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/update_rakefile_to_really_clea.php"
      title="Update Rakefile to really clean (wikitext, b5c0548)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/fix_antlr_installation_procedu.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/update_rakefile_to_really_clea.php"
            >&laquo; Update Rakefile to really clean (wikitext, b5c0548)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/fix_antlr_installation_procedu.php"
            >Fix ANTLR installation procedure to allow repeated installs
            (wikitext, 281927e) &raquo;</a
          >
        </p>
        ...
        <p>
          These tweaks fix the build breakage under Leopard caused by the fact
          that the ANTLR runtime is non-Universal and Ruby is Universal. We set
          the ARCHFLAGS environment variable to force a non-Universal extension
          to be built.
        </p>

        <p>
          In the future may actually produce a Universal version of the runtime,
          at which point will remove this somewhat kludgy hack.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003044more"><div id="more"></div></div>
