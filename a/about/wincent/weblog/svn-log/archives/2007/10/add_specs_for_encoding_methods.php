...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add specs for encoding methods (wikitext, 292af90)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/whitespace_cleanup_wikitext_b4.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_benchmark_runner_wikitext.php"
            >&laquo; Add benchmark runner (wikitext, 9d5875b)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/whitespace_cleanup_wikitext_b4.php"
            >Whitespace cleanup (wikitext, b40adde) &raquo;</a
          >
        </p>
        ...
        <p>
          Although the encoding conversion methods already receive extensive
          indirect testing (because they are indirectly exercised by all of the
          parsing specs) this commit adds specific specs so as to test all the
          possible failure paths when passed invalidly encoding inputs.
        </p>

        <p>
          As a result of adding these specs I discovered one minor issue: that
          one of the failing code paths would never be exercised because it was
          effectively masked by another failing code path; so this commit also
