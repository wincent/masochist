...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Split WOFileView into superclass with two subclasses
      (gdiff, 01d3ea9)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_stepper_to_document_window.php"
      title="Add stepper to document window (gdiff, 466ab7f)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_files_property_to_wodiff_g.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_stepper_to_document_window.php"
            >&laquo; Add stepper to document window (gdiff, 466ab7f)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_files_property_to_wodiff_g.php"
            >Add files property to WODiff (gdiff, 1bd48d5) &raquo;</a
          >
        </p>
        ...
        <p>
          WOFileView is now a superclass of two new subclasses, WOFromFileView
          and WOToFileView. Almost all of the behaviour will be in the
          superclass with minor overrides in the subclasses. Basically the only
          difference in behaviour is which part of the represented WOFile object
          the subclass represents.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002994more"><div id="more"></div></div>
