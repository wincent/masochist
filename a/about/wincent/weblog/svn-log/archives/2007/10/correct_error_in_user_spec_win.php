...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Correct error in User spec (wincent.dev, d55c2c6)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/whitespace_fix_wincentcom_df00.php"
      title="Whitespace fix (wincent.dev, df00cf2)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/initial_import_wikitext_db2cb8.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/whitespace_fix_wincentcom_df00.php"
            >&laquo; Whitespace fix (wincent.dev, df00cf2)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/initial_import_wikitext_db2cb8.php"
            >Initial import (wikitext, db2cb81) &raquo;</a
          >
        </p>

        <h2>October 15, 2007</h2>

        <h3>Correct error in User spec (wincent.dev, d55c2c6)</h3>

        <p>
          Should have been using delete_all, not delete(:all); the delete method
