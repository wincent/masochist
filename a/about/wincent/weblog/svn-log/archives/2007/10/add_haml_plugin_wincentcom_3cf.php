...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Add Haml plugin (wincent.dev, 3cf854a)</title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/indentation_in_application_rea.php"
            >&laquo; Indentation in application README (wincent.dev, b8b1d12)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/bootstrap_rspec_wincentcom_18f.php"
            >Bootstrap RSpec (wincent.dev, 18f33b5) &raquo;</a
          >
        </p>

        <h2>October 5, 2007</h2>

        <h3>Add Haml plugin (wincent.dev, 3cf854a)</h3>

        <p>
          Note that HTTP access to hamptoncatlin.com and subdomains (including
