...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Update script/spec (wincent.dev, 57f43c1)</title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/set_up_ignores_in_test_subdire.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/turn_on_activerecord_session_s.php"
            >&laquo; Turn on ActiveRecord session store (wincent.dev,
            405881e)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/set_up_ignores_in_test_subdire.php"
            >Set up ignores in test subdirectory (wincent.dev, 0169c6c)
            &raquo;</a
          >
        </p>
        ...
        <h3>Update script/spec (wincent.dev, 57f43c1)</h3>

        <p>
          Yet another file which should have been updated as part of the move to
          the RSpec trunk (b8c4b59).
        </p>

        <div id="a003073more"><div id="more"></div></div>
