...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add WOPublic to project as folder reference (WOCommon,
      153e314)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_symlink_to_wopublic_tree_w.php"
            >&laquo; Add symlink to WOPublic tree (WOCommon, 9278332)</a
          >
          |
        ...
        <p>
          Add folder reference to WOPublic to make management through Xcode a
          little easier.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002894more"><div id="more"></div></div>
