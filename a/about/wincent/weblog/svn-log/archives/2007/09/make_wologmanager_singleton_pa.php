...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Make WOLogManager singleton pattern truly advisory
      (WOCommon, 545d56c)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/remove_wosysctl_dependency_on.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/comment_corrections_in_wologma.php"
            >&laquo; Comment corrections in WOLogManager (WOCommon, a6a07ed)</a
          >
          |
        ...
        <p>
          Commit 343dc6b removed WOLogManager's dependency on WOSingleton but
          there was one place (in the init method) where the code still had an
          &quot;enforcement&quot; approach to the singleton pattern. This commit
          removes that code thus making the behaviour totally advisory.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002723more"><div id="more"></div></div>
