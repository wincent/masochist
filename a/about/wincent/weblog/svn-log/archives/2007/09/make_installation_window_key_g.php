...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Make installation window key (gdiff, 42890f6)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/return_success_status_from_ins.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/return_success_status_from_ins.php"
            >&laquo; Return success status from installer tool (gdiff,
            5ecde66)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/add_doxygen_target_gdiff_e0d01.php"
            >Add Doxygen target (gdiff, e0d0150) &raquo;</a
          >
        </p>
        ...
        <p>
          When bringing up the installation window don't just order it to the
          front; actually make it the key window as well. In this way the user
          can just hit the Return or Enter keys to initiate the default install.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002976more"><div id="more"></div></div>
