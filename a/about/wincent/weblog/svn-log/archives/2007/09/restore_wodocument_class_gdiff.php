    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/fix_syntax_error_in_tool_gdiff.php"
            >&laquo; Fix syntax error in tool (gdiff, a98814a)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/remove_redundant_system_header.php"
            >Remove redundant system header imports (gdiff, 4e63885) &raquo;</a
          >
        </p>
        ...
        <p>
          This class is the result of refactoring the original MyDocument class,
          but due to an oversight the renamed files weren't added to the
          repository.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002955more"><div id="more"></div></div>
