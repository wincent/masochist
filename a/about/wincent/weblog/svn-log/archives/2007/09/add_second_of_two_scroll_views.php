...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add second of two scroll views (gdiff, 429df2e)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/let_glue_view_pick_up_any_pixe.php"
      title="Let glue view pick up any pixel slack (gdiff, 50b3dbc)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/remove_sethasverticalscroller.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/let_glue_view_pick_up_any_pixe.php"
            >&laquo; Let glue view pick up any pixel slack (gdiff, 50b3dbc)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/remove_sethasverticalscroller.php"
            >Remove setHasVerticalScroller calls (gdiff, 5895b3a) &raquo;</a
          >
        </p>
        ...
        <p>
          Completing the work started in 390c5b3, the right hand side is now
          also located inside a scroll view with no vertical scroll bar. The
          NSScroller that was previously grouped along with the left file view
          and its gutter has now been move outside of the group (it makes no
          sense to have a scroller inside the document view of an NSScrollView).
        </p>

        <p>
          This required some reworking of the WODiffView autoresizing code, and
          in the process I discovered that the incorporation of the
          &quot;slack&quot; in the glue view (introduced in commit 50b3dbc) was
          being thrown away during window resizes; so as part of the updates to
          the autoresizing code I now ensure that the slack is accommodated by
          the glue view during window resizing as well.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002987more"><div id="more"></div></div>
