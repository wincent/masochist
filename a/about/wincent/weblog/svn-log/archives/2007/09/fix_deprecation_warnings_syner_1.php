...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/update_project_settings_for_le_1.php"
      title="Update project settings for Leopard (Synergy, da40c00)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/additional_leopardrelated_proj_1.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/update_project_settings_for_le_1.php"
            >&laquo; Update project settings for Leopard (Synergy, da40c00)</a
          >
          |
        ...
        <p>
          Compiling under Leopard and GCC 4.0 yields various warnings about
          deprecated APIs and some questionable C constructs. This commit
          replaces all calls to deprecated APIs with calls to new APIs, and
          makes other changes to eliminate C-related warnings.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003131more"><div id="more"></div></div>
