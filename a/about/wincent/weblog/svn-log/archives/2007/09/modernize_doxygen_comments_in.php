...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Modernize Doxygen comments in WOSysctl (WOCommon,
      08d144f)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/update_memory_barrier_document.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/remove_wosysctl_dependency_on.php"
            >&laquo; Remove WOSysctl dependency on WOSingleton (WOCommon,
            6587b27)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/update_memory_barrier_document.php"
            >Update memory barrier documentation (WOCommon, dfbe816) &raquo;</a
          >
        </p>
        ...
        <p>
          Update Doxygen comments to use new format, as well as adding
          appropriate group start and end markers.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002725more"><div id="more"></div></div>
