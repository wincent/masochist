...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Move subview initialization into WODiffView (gdiff,
      1cc773c)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/remove_debugging_log_statement.php"
      title="Remove debugging log statement (gdiff, 1d0c023)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/initial_import_of_wodebugmacro.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/remove_debugging_log_statement.php"
            >&laquo; Remove debugging log statement (gdiff, 1d0c023)</a
          >
          |
        ...
        <p>
          WODocument is a controller class which previously set up its own
          document window and all the subviews. Now all of the subview
          initialization has been moved into WODiffView.
        </p>
        ...
        <p>
          When the controller needs to access the subviews (for example to
          initiate scrolling) I will add the appropriate properties or action
          methods to the WODiffView class.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002991more"><div id="more"></div></div>
