...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Teach tool new ways to get input (gdiff, 64de21c)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/refactor_rename_mydocumentnib.php"
      title="Refactor: rename MyDocument.nib to Document.nib (gdiff, 7175fde)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/factor_out_path_for_tool_funct.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/refactor_rename_mydocumentnib.php"
            >&laquo; Refactor: rename MyDocument.nib to Document.nib (gdiff,
            7175fde)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/factor_out_path_for_tool_funct.php"
            >Factor out path_for_tool function (gdiff, 86bf53c) &raquo;</a
          >
        </p>
        ...
        <p>
          (1) When supplied no arguments reads Git diff output from the standard
          input. This allows usages such as:
        </p>

        <p>git-diff ARGUMENTS | gdiff cat PATCHFILES... | gdiff</p>

        <p>
          (2) As a special case, when supplied a single argument,
          &quot;--help&quot;, shows usage information.
        </p>

        <p>
          (3) In all other cases tries to invoke git-diff, passing along the
          supplied arguments and capturing the input. That is:
        </p>
        ...
        <p>
          ...
          environment variable, and if no PATH is set the search falls back to
          the locations specified by the user.cs_path sysctl setting.
        </p>

        <p>
          At the moment the tool doesn't actually do anything with the input. A
          future commit will add the ability to locate the GUI application and
          pass the input to it for processing.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002951more"><div id="more"></div></div>
