    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/show_usage_information_when_no.php"
            >&laquo; Show usage information when no arguments supplied (gdiff,
            cf8804a)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/capture_blob_ids_gdiff_74a672c.php"
            >Capture blob ids (gdiff, 74a672c) &raquo;</a
          >
        </p>
        ...
        <p>
          Updates to WOFile and WODiffMachine to record filenames during
          scanning. At this point the WOFile class is basically complete as all
          it has to do is track filenames and changes.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002927more"><div id="more"></div></div>
