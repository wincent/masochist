...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Thin class wrapper for state machine (gdiff, d0d55ee)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/add_makefile_gdiff_dac88ba.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/add_makefile_gdiff_dac88ba.php"
            >&laquo; Add Makefile (gdiff, dac88ba)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/whitespace_cleanup_gdiff_1a26c.php"
            >Whitespace cleanup (gdiff, 1a26c37) &raquo;</a
          >
        </p>
        ...
        <p>
          This commit refactors the previous implementation, splitting it off
          into a thin objective wrapper with a separate main executable
          implementation. In addition the basic models which the state machine
          will use to build up a representation of the diff (diffs, files,
          changes) have been added.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002923more"><div id="more"></div></div>
