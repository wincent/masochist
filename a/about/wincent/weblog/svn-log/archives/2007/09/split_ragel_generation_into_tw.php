...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Split Ragel generation into two phases (gdiff, 3e94d7d)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/roll_ragel_generation_into_xco.php"
      title="Roll Ragel generation into Xcode build (gdiff, 828150d)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/roll_tool_into_xcode_project_g.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/roll_ragel_generation_into_xco.php"
            >&laquo; Roll Ragel generation into Xcode build (gdiff, 828150d)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/roll_tool_into_xcode_project_g.php"
            >Roll tool into Xcode project (gdiff, cc8b116) &raquo;</a
          >
        </p>
        ...
        <p>
          In an effort to fix the spurious rebuilds mentioned in commit 828150d
          I split the Ragel generation into two phases, each with a separate
          build rule.
        </p>

        <p>
          The first phase operates on &quot;.rl&quot; files, feeding them into
          ragel to produce XML files with a &quot;.ragel&quot; extension.
        </p>

        <p>
          The second phase takes those &quot;.ragel&quot; files and uses
          rlgen-cd to produce the Objective-C source.
        </p>

        <p>
          The generation of dot files was removed entirely to eliminate a
          potential source of complication in the dependency analysis (although
          it should work with any number of files).
        </p>

        <p>
          Although the spurious rebuilds persist (curiously only in Release
          builds, not in Debug builds) I am going to keep this commit as I think
          the two phase approach is more robust. I can later add in dot-file
          generation as a separate target if desired.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002947more"><div id="more"></div></div>
