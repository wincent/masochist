...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Clarify comments with respect to copying of singleton
      objects (WOCommon, 1d27e78)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/remove_wosingleton_class_and_a.php"
      title="Remove WOSingleton class and all references to it (WOCommon, 839cadd)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/set_garbage_collection_to_requ.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/remove_wosingleton_class_and_a.php"
            >&laquo; Remove WOSingleton class and all references to it
            (WOCommon, 839cadd)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/set_garbage_collection_to_requ.php"
            >Set Garbage Collection to &quot;required&quot; (buildtools,
            6df5a68) &raquo;</a
          >
        </p>
        ...
        <p>
          Note that most singleton classes inherit from WOObject, which in turn
          inherits from NSObject, and that given that neither of these implement
          the NSCopying protocol &quot;out of the box&quot; then it isn't even
          necessary to provide a special implementation of copyWithZone: in the
          vast majority of cases.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002742more"><div id="more"></div></div>
