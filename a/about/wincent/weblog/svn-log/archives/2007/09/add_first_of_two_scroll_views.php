...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add first of two scroll views (gdiff, 390c5b3)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/add_missing_header_import_gdif.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/add_missing_header_import_gdif.php"
            >&laquo; Add missing header import (gdiff, 4679d86)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/remove_noop_nsview_overrides_g.php"
            >Remove no-op NSView overrides (gdiff, dc7f887) &raquo;</a
          >
        </p>
        ...
        <p>
          Rather than replicate all the work done by NSScrollView (and behind
          the scenes NSClipView) I am going to try letting NSScrollView do as
          much as possible. This commit starts the migration, placing the
          content on the left-hand side inside a programmatically created
          scrollview.
        </p>

        <p>
          The previously used NSView that was used for grouping purposes is
          still required seeing as an NSScrollView expects a single document
          view. The autoresizing machinery works without modification using the
          scrollview as a drop-in replacement for the NSView.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002984more"><div id="more"></div></div>
