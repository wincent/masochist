...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Drop use of WOSingleton for WOBaseCore (WOCommon,
      4c61ee1)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/layout_tweak_for_woprocessmana.php"
      title="Layout tweak for WOProcessManager (WOCommon, 34b61b0)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/modernize_wocdsawrapper_header.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/layout_tweak_for_woprocessmana.php"
            >&laquo; Layout tweak for WOProcessManager (WOCommon, 34b61b0)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/modernize_wocdsawrapper_header.php"
            >Modernize WOCDSAWrapper header (WOCommon, 5f66c76) &raquo;</a
          >
        </p>
        ...
        <p>
          WOBaseCore is a lightweight wrapper class that contains only class
          methods and is never actually instantiated, so there is no need for it
          to be a singleton. If there ever does arise a need for it to have
          singleton behaviour then a straightforward local (non-abstract)
          implementation can be easily added rather than depending on
          WOSingleton.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002733more"><div id="more"></div></div>
