...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update Gestalt-based APIs to match Apple's clipping
      behaviour (WOCommon, 6ce256c)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/better_performance_in_singleto.php"
      title="Better performance in singleton pattern (WOCommon, 7a71a42)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/initial_import_of_diffrl_file.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/better_performance_in_singleto.php"
            >&laquo; Better performance in singleton pattern (WOCommon,
            7a71a42)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/initial_import_of_diffrl_file.php"
            >Initial import of diff.rl file (gdiff, 2ab5e1c) &raquo;</a
          >
        </p>
        ...
        <h3>
          Update Gestalt-based APIs to match Apple's clipping behaviour
          (WOCommon, 6ce256c)
        </h3>

        <p>
          Apple's gestaltSystemVersion wraps in such a way that Mac OS X
          10.4.10, for example, is represented as 0x00001049. This commit
          updates the WOMachine API to match this clipping behaviour exactly.
        </p>

        <p>
          If more precise detection of the system version is required in the
          future there are two approaches which (reading the system version
          plist, and switching to newer parts of the Gestalt API) which can be
          implemented, but in the absence of any pressing need for such a shift
          there is no justification for making changes just yet (&quot;do the
          simplest thing that could possibly work&quot;).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002747more"><div id="more"></div></div>
