...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/02/walrus_r47_2_items_changed.php"
      title="Walrus r47, 2 items changed"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/02/walrus_r49_3_items_changed.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/02/walrus_r47_2_items_changed.php"
            >&laquo; Walrus r47, 2 items changed</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/02/walrus_r49_3_items_changed.php"
            >Walrus r49, 3 items changed &raquo;</a
          >
        </p>
        ...
        <p>
          Large-scale reorganization (nearly 4,000 lines of diffs): removing old
          hand-coded lexer and parser files obsoleted by the parser generator;
          centralize all 'require' and 'autoload' statements into a single
          overarching header file (saves a couple of lines or more in most
          files); move initialized into shared header and remove local overrides
          (cleaner code); use jcore library and jlength method for greater speed
          when determining the length of Unicode strings; initial implementation
          of ProcParslet class
        </p>

        <div id="a001201more"><div id="more"></div></div>
