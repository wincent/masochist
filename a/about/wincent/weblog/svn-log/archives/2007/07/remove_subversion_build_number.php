...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove Subversion build number (WOTest, 4cdc88d)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/ignore_temporary_files_wotest.php"
            >&laquo; Ignore temporary files (WOTest, 723791d)</a
          >
          |
        ...
        <p>
          Now that this code is stored in a Git repository, remove the
          build-number embedding procedure which got the SVK/Subversion revision
