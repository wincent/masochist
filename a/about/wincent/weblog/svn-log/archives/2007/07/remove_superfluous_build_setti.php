...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove superfluous build settings on aggregate targets
      (WOHotKey, b0678b9)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/update_xcode_project_bundle_fo_1.php"
      title="Update Xcode project bundle format (WOHotKey, 39dc89e)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/restore_product_name_wohotkey.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/update_xcode_project_bundle_fo_1.php"
            >&laquo; Update Xcode project bundle format (WOHotKey, 39dc89e)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/restore_product_name_wohotkey.php"
            >Restore PRODUCT_NAME (WOHotKey, f9fa9cf) &raquo;</a
          >
        </p>
        ...
        <h3>
          Remove superfluous build settings on aggregate targets (WOHotKey,
          b0678b9)
        </h3>

        <p>
          Not sure whether this is a new feature of Xcode or whether the
          settings were always present but not exposed, but I've just noticed a
          bunch of redundant build settings on aggregate targets. This commit
          removes them.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002570more"><div id="more"></div></div>
