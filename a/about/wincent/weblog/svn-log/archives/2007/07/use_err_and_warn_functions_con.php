...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Use err() and warn() functions consistently (buildtools,
      3611298)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/check_for_empty_product_name_b.php"
            >&laquo; Check for empty PRODUCT_NAME (buildtools, 2104d18)</a
          >
          |
        ...
        <p>
          Some of the scripts were using vanilla &quot;echo&quot; statements for
          issuing warnings and errors. This commit brings all scripts into line,
          consistently using the warn() and err() functions defined in Common.sh
          for that purpose.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002564more"><div id="more"></div></div>
