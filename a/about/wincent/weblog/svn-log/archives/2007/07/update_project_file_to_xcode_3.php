...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update project file to Xcode 3 format (Wincent Strings
      Utility, 98173a5)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/update_xcode_project_bundle_ig.php"
            >&laquo; Update Xcode project bundle ignore file (Wincent Strings
            Utility, 9613227)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/use_configuration_from_wincent.php"
            >Use configuration from Wincent Build Tools (Wincent Strings
            Utility, 205ed23) &raquo;</a
          >
        </p>
        ...
        <h3>
          Update project file to Xcode 3 format (Wincent Strings Utility,
          98173a5)
        </h3>
        ...
        <div id="a002505more"><div id="more"></div></div>
