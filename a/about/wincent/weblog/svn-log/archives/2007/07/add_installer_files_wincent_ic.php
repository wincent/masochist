...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add installer files (Wincent Icon Utility, 9aa464b)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/add_rtf_version_of_license_win.php"
            >&laquo; Add RTF version of license (Wincent Icon Utility,
            0b7157f)</a
          >
          |
        ...
        <p>
          Add a PackageMaker document and the remaining dependent file (the
          background PDF; the other dependent file, the license RTF file, was
          added in the previous commit).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002557more"><div id="more"></div></div>
