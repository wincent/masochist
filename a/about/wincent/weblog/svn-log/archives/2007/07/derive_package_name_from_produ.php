...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Derive package name from PRODUCT_NAME (buildtools,
      20994a2)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/add_package_building_target_wi.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/add_usrlocalshareman_to_manpat.php"
            >&laquo; Add /usr/local/share/man to MANPATH (snippets, 3eeb288)</a
          >
          |
        ...
        <p>
          Make the target package name argument optional as well; if it is not
          supplied the a name will be derived from the PRODUCT_NAME build
          setting by appending &quot;.pkg&quot;.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002561more"><div id="more"></div></div>
