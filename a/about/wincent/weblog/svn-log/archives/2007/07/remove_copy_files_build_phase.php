...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove &quot;Copy Files&quot; build phase (Wincent Icon
      Utility, a17e17a)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/corrections_for_last_commit_wi.php"
      title="Corrections for last commit (Wincent Icon Utility, b685fd5)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/better_handling_when_growlnoti.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/corrections_for_last_commit_wi.php"
            >&laquo; Corrections for last commit (Wincent Icon Utility,
            b685fd5)</a
          >
          |
        ...
        <h3>
          Remove &quot;Copy Files&quot; build phase (Wincent Icon Utility,
          a17e17a)
        </h3>

        <p>
          The default Xcode template now includes an unwanted &quot;Copy
          Files&quot; files phase that copies the manual page to
          /usr/share/man/man1/ which causes builds to fail when running as a
          normal user. This is a new behaviour with the latest Xcode build; I
          don't know the exact cause but I suspect that the behaviour of the
          SKIP_INSTALL build setting might have changed (the Copy Files phase is
          in fact set to &quot;Copy only when installing&quot;).
        </p>

        <p>This commit removes the unwanted phase.</p>

        <p>
          Two more appropriate solutions for installing the manual page would be
          either preparing an Installer package (for installations outside of
          Xcode) or setting up a completely separate &quot;Install&quot; target
          (for use within Xcode) that could be fired off explicitly when
          desired.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002554more"><div id="more"></div></div>
