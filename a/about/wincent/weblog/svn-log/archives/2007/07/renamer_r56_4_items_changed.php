    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/set_up_ignores_for_xcode_proje_7.php"
            >&laquo; Set up ignores for Xcode project bundle (Clipboard
            Commando, 2090b0c)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/initial_import_renamer_a88000b.php"
            >Initial import (REnamer, a88000b) &raquo;</a
          >
        </p>
        ...
        <p>
          Commit pending changes (new notes, adjustments to help documentation)
          prior to migration to Git
        </p>

        <div id="a002444more"><div id="more"></div></div>
