...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Gate problematic mock object test (WOTest, 2088ff0)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/remove_unit_test_made_redundan.php"
      title="Remove unit test made redundant by garbage collection (WOTest, 0f96414)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/turn_off_zero_link_buildtools.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/remove_unit_test_made_redundan.php"
            >&laquo; Remove unit test made redundant by garbage collection
            (WOTest, 0f96414)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/turn_off_zero_link_buildtools.php"
            >Turn off Zero Link (buildtools, 36e3c46) &raquo;</a
          >
        </p>
        ...
        <p>
          The handling of unrecognized selectors appears to have changed in
          Leopard in ways that cause one of the mock object tests to fail.
          Specifically, an NSInvalidArgumentException is raised and it appears
          that the -[NSProxy doesNotRecognizeSelector:] method is being called;
          setting breakpoints indicates that the -forward:: method on the WOMock
          class is no longer being invoked.
        </p>

        <p>
          So I am temporarily gating off this test so that we can get error-free
          test runs, pending further investigation. I plan to rework much of the
          mock/stub API in any case based on better understanding obtained
          through my experiences with RSpec (my use of the terms
          &quot;mock&quot; and &quot;stub&quot; is incorrect, based on my first
          contact with those terms in the OCMock framework); at a minimum, I
          plan to rename WOStub and its subclasses to better reflect what it
          actually does (it is a message recorder and should probably be called
          as such). I may also later add WOMock subclasses that really are stubs
          (non-verifying mocks).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002530more"><div id="more"></div></div>
