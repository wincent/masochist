...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Use configuration from Wincent Build Tools (Wincent
      Strings Utility, 205ed23)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/update_project_file_to_xcode_3.php"
            >&laquo; Update project file to Xcode 3 format (Wincent Strings
            Utility, 98173a5)</a
          >
          |
        ...
        <h3>
          Use configuration from Wincent Build Tools (Wincent Strings Utility,
          205ed23)
        </h3>

        <p>
          Replace hard-coded settings with configuration inherited from the
          Wincent Build Tools.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002506more"><div id="more"></div></div>
