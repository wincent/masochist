...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Check for empty PRODUCT_NAME (buildtools, 2104d18)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/add_package_building_target_wi.php"
            >&laquo; Add package building target (Wincent Icon Utility,
            bffc1c8)</a
          >
          |
        ...
        <p>
          Check for empty PRODUCT_NAME and bail with an error message if
          necessary. We don't want an empty PRODUCT_NAME because that would
          yield a nonsensical target package name &quot;.pkg&quot;.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002563more"><div id="more"></div></div>
