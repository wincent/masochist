...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Corrections for last commit (Wincent Icon Utility,
      b685fd5)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/handle_preexisting_icon_files.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/handle_preexisting_icon_files.php"
            >&laquo; Handle pre-existing icon files (Wincent Icon Utility,
            6b08d35)</a
          >
          |
        ...
        <p>
          Correct two problems introduced in the last commit: one misnamed
          function and one case typo in a variable name.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002553more"><div id="more"></div></div>
