...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove hard-coded tool name in RunDoxygen.sh
      (buildtools, 9b4238b)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/add_installer_files_wincent_ic.php"
            >&laquo; Add installer files (Wincent Icon Utility, 9aa464b)</a
          >
          |
        ...
        <p>
          Replace hard-coded tool name in RunDoxygen.sh with special shell
          variable, bringing it in line with with the other scripts in the
          buildtools do.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002558more"><div id="more"></div></div>
