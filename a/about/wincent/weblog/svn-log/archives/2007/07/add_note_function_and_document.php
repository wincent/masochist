...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add note() function and documentation (buildtools,
      d75ece2)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/use_err_and_warn_functions_con.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/use_err_and_warn_functions_con.php"
            >&laquo; Use err() and warn() functions consistently (buildtools,
            3611298)</a
          >
          |
        ...
        <p>
          Add a note() function to Common.sh, as well as documentation which
          clarifies the purpose of and difference between note(), err() and
          warn().
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002565more"><div id="more"></div></div>
