...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove redundant build settings (WOTest, dca6ddc)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/restore_product_name_wohotkey.php"
            >&laquo; Restore PRODUCT_NAME (WOHotKey, f9fa9cf)</a
          >
          |
        ...
        <p>
          Prune redundant build settings from aggregate targets, leaving only
