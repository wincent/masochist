...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove Subversion build number updates (WOHotKey,
      dc547c6)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/remove_redundant_build_setting.php"
      title="Remove redundant build settings (WOTest, dca6ddc)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/remove_references_to_old_build.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/remove_redundant_build_setting.php"
            >&laquo; Remove redundant build settings (WOTest, dca6ddc)</a
          >
          |
        ...
        <p>
          Now that this code is hosted in a Git repository the old machinery for
          updating the build number based on the SVK/Subversion revision number
          is no longer applicable, so remove it.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002573more"><div id="more"></div></div>
