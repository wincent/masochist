...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update license to GPL v3 (Wincent Strings Utility,
      da3429b)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/remove_subversionspecific_keyw_3.php"
            >&laquo; Remove Subversion-specific keywords (Wincent Strings
            Utility, 24edba9)</a
          >
          |
        ...
        <p>
          Replace previous license file with GPL version 3. Update the license
          header of all source files.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002500more"><div id="more"></div></div>
