...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix NSArray reference which was really an NSMutableArray
      (WOCommon, ada8ea0)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/remove_reference_to_commoninit.php"
      title="Remove reference to &amp;quot;commonInit&amp;quot; method in WOPreferencesWindowController (WOCommon, 5b43413)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/updates_for_changes_to_cdsa_ap.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/remove_reference_to_commoninit.php"
            >&laquo; Remove reference to &quot;commonInit&quot; method in
            WOPreferencesWindowController (WOCommon, 5b43413)</a
          >
          |
        ...
        <p>
          As part of the change to Objective-C 2.0 fast enumeration I discovered
          that one of the untyped (id) objects that I was previously treating as
          a mutable array was actually mislabelled as immutable. This commit
          adjusts the test to reflect reality, quelling a compiler warning as a
          result.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002645more"><div id="more"></div></div>
