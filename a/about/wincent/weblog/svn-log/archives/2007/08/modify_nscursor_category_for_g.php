...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Modify NSCursor category for garbage collection
      (WOBezel, 73e0de7)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/readability_edits_to_woalertbe.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/readability_improvements_to_ns.php"
            >&laquo; Readability improvements to NSBezierPath category (WOBezel,
            3e23a51)</a
          >
          |
        ...
        <p>
          Change previously static local variables to globals so that the
          desired singleton behaviour can be achieved under garbage collection
          (ie. once initialized, the custom cursors will act as singletons and
          be available for the duration of execution).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002613more"><div id="more"></div></div>
