...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove files from previous RSpec version (wincent.dev,
      71d1c5b)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/update_fixturereplacement_winc.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/add_performance_request_script.php"
            >&laquo; Add performance request script from Rails 2.0 RC 1
            (wincent.dev, 3df8d19)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/update_fixturereplacement_winc.php"
            >Update FixtureReplacement (wincent.dev, 563b8ab) &raquo;</a
          >
        </p>

        <h2>November 16, 2007</h2>

        <h3>Remove files from previous RSpec version (wincent.dev, 71d1c5b)</h3>

        <p>
          These files should have been removed in the upgrade to revision 2902
          but for some reason they weren't.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003150more"><div id="more"></div></div>
