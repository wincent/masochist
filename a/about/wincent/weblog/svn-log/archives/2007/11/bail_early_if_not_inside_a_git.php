...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Bail early if not inside a Git repo (snippets, fbc5f09)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/release_note_script_snippets_6.php"
      title="Release note script (snippets, 6c0e4f7)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/set_up_ignores_for_dialog_xcod.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/release_note_script_snippets_6.php"
            >&laquo; Release note script (snippets, 6c0e4f7)</a
          >
          |
        ...
        <p>
          This should allow us to continue gracefully if building from a source
          other than a Git repository working tree (like a tarball, for
          example).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003176more"><div id="more"></div></div>
