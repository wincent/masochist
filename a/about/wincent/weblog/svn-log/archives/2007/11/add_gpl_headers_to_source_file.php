...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add GPL headers to source files (gdiff, 5db5b71)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/correct_typo_in_sample_readme.php"
            >&laquo; Correct typo in sample README (gdiff, 26216f1)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/import_backupruncompleted_scri.php"
            >Import backup-run-completed script from old repo (snippets,
            caf917e) &raquo;</a
          >
        </p>
        ...
        <div id="a003105more"><div id="more"></div></div>
