...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Increase backup frequency (snippets, 29c6fcc)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/update_configuration_to_use_la.php"
      title="Update configuration to use larger backup volume (snippets, a46c336)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/tweak_rakefile_for_linux_walru.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/update_configuration_to_use_la.php"
            >&laquo; Update configuration to use larger backup volume (snippets,
            a46c336)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/tweak_rakefile_for_linux_walru.php"
            >Tweak Rakefile for Linux (Walrus, 116bb1c) &raquo;</a
          >
        </p>
        ...
        <p>
          Now that we are targetting a larger backup volume, switch to more
          frequent backups. This raises the count from 4 times per day (every 6
          hours) to 12 times per day (every 2 hours).
        </p>

        <p>
          This is the practical limit for backup frequency as each backup
          currently takes about 1 hour and 40 minutes.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003101more"><div id="more"></div></div>
