...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Import files from Install repository (Synergy, d23da4c)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/add_fixturereplacement_upgrade.php"
      title="Add FixtureReplacement upgrade notes (wincent.dev, 6ead2fc)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/import_files_from_install_repo_1.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/add_fixturereplacement_upgrade.php"
            >&laquo; Add FixtureReplacement upgrade notes (wincent.dev,
            6ead2fc)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/import_files_from_install_repo_1.php"
            >Import files from Install repository (Synergy, d23da4c) &raquo;</a
          >
        </p>
        ...
        <p>
          These files which were previously in the Install repository never
          really should have been there. Moving them into the Synergy repo is
          the first step towards handling the entire build process (from source
          through to disk image) from a single Xcode project file instead of
          two.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003159more"><div id="more"></div></div>
