...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix last of test-time crashes under 10.5 (WOTest,
      c6cb292)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/fix_testtime_crashes_caused_by.php"
      title="Fix test-time crashes caused by 10.5 runtime changes (WOTest, 8e83a65)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/gc_changes_for_the_symbol_spit.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/fix_testtime_crashes_caused_by.php"
            >&laquo; Fix test-time crashes caused by 10.5 runtime changes
            (WOTest, 8e83a65)</a
          >
          |
        ...
        <p>
          Fix another test-time crash that's new under 10.5, this one stemming
          from the use of the Object root class. It appears that this class is
          not compatible with the new runtime when GC is set to
          &quot;required&quot;, as these same tests didn't used to crash prior
          to turning that setting on.
        </p>
