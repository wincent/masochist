...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add README to ANTLR subdirectory (wikitext, eef7b94)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/add_license_gdiff_7ddd6f5.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/add_license_gdiff_7ddd6f5.php"
            >&laquo; Add LICENSE (gdiff, 7ddd6f5)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/fix_typo_in_readme_wikitext_f4.php"
            >Fix typo in README (wikitext, f432017) &raquo;</a
          >
        </p>
        ...
        <p>
          Add note explaining what the ANTLR subdirectory is all about and why
          it's in the repository.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003096more"><div id="more"></div></div>
