...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Produce code-level release notes during build (Synergy,
      894da4c)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/add_missing_e_switch_to_echo_s.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/add_missing_e_switch_to_echo_s.php"
            >&laquo; Add missing -e switch to echo statement (buildtools,
            d9cc199)</a
          >
          |
        ...
        <p>
          Use the new ReleaseNotes.sh script to automatically generate
          code-level release notes during the build process.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003184more"><div id="more"></div></div>
