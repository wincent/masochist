...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add missing -e switch to echo statement (buildtools,
      d9cc199)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/produce_codelevel_release_note.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/dont_trust_xcode_to_obey_the_e.php"
            >&laquo; Don't trust Xcode to obey the -e (buildtools, 1307e40)</a
          >
          |
        ...
        <p>
          ...
          emitted. This relies on the Bash echo built-in, as the executable
          /bin/echo does not support this switch.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003182more"><div id="more"></div></div>
