...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2006/12/synergy_advance_r367_4_items_c.php"
      title="Synergy Advance r367, 4 items changed"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2006/12/synergy_advance_r369_2_items_c.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2006/12/synergy_advance_r367_4_items_c.php"
            >&laquo; Synergy Advance r367, 4 items changed</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2006/12/synergy_advance_r369_2_items_c.php"
            >Synergy Advance r369, 2 items changed &raquo;</a
          >
        </p>
        ...
        <p>
          Refactoring of Dock code: support for Code Signing in Leopard requires
          us to abandon the self-modifying Info.plist trick for hiding the Dock
          icon, but the alternatives (Carbon TransformProcessType API and/or
          separate Dock helper application) impose unacceptable limitations; so
          have removed the ability to hide the Dock icon while keeping existing
          Dock code bundled as a separate plug-in and will be adding more
          functionality to justify the investment in Dock &quot;real
          estate&quot;. Added preferences UI for modifying color and
          transparency of various elements.
        </p>

        <div id="a001067more"><div id="more"></div></div>
