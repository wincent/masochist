...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2006/10/sa_r14_1_item_changed.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2006/10/sa_r12_2_items_changed.php"
            >&laquo; SA r12, 2 items changed</a
          >
          |
        ...
        <p>
          Columns in identities window now remember their widths, ordering etc;
          identities table view now uses alternating row colors
        </p>

        <div id="a000721more"><div id="more"></div></div>
