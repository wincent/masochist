...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Improve key/value observing of user defaults (REnamer,
      e229a72)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/avoid_void_pointer_arithmetic.php"
            >&laquo; Avoid void pointer arithmetic in
            WOCreateFSRefArrayFromAEDesc() (REnamer, 2fe20b9)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/defer_to_super_if_we_dont_hand.php"
            >Defer to super if we don't handle the KVO message (REnamer,
            0c0ac38) &raquo;</a
          >
        </p>
        ...
        <p>
          Instead of observing the controller, we can observe the defaults
          object directly.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003724more"><div id="more"></div></div>
