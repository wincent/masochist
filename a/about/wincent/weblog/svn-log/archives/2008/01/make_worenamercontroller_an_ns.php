...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Make WOREnamerController an NSWindowController subclass
      (REnamer, c598bef)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_woapplicationcontroller_cl.php"
      title="Add WOApplicationController class (REnamer, d5f6402)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/split_mainmenuxib_into_two_ren.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_woapplicationcontroller_cl.php"
            >&laquo; Add WOApplicationController class (REnamer, d5f6402)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/split_mainmenuxib_into_two_ren.php"
            >Split MainMenu.xib into two (REnamer, c4536d6) &raquo;</a
          >
        </p>
        ...
        <p>
          Remove some of the application-level functionality of
          WOREnamerController and make it an NSWindowController subclass; it
          will be repurposed as a per-window controller with the goal of being
          able to have multiple running instances.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003712more"><div id="more"></div></div>
