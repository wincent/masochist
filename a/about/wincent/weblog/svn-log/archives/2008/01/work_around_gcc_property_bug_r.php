...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Work around GCC property bug (REnamer, 7c20dd2)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/complete_migration_to_objectiv.php"
      title="Complete migration to Objective-C 2.0 properties in controller (REnamer, 69e0d1e)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/archiveunarchive_colors_used_i.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/complete_migration_to_objectiv.php"
            >&laquo; Complete migration to Objective-C 2.0 properties in
            controller (REnamer, 69e0d1e)</a
          >
          |
        ...
        <p>
          GCC refuses to synthesize a write accessor for one of the properties,
          so lose the &quot;declare readonly then redeclare as readwrite&quot;
          pattern for that property only. It's not known why GCC should do this
          for one and only one of the properties.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003563more"><div id="more"></div></div>
