...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix typo in in place editor helper (wincent.dev,
      a29bd91)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/clean_up_in_in_place_editor_he.php"
            >&laquo; Clean up in in place editor helper macros (wincent.dev,
            3fa763d)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_update_attribute_to_active.php"
            >Add update_attribute! to Active Record (wincent.dev, cec57c5)
            &raquo;</a
          >
        </p>
        ...
        <h3>Fix typo in in place editor helper (wincent.dev, a29bd91)</h3>

        <p>Bad variable name.</p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003794more"><div id="more"></div></div>
