...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Have fallback case for escapes (REnamer, 4c15966)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/changes_for_pcre_match_limit_r.php"
      title="Changes for PCRE_MATCH_LIMIT (REnamer, d297c67)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_vertical_tab_detection_ren.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/changes_for_pcre_match_limit_r.php"
            >&laquo; Changes for PCRE_MATCH_LIMIT (REnamer, d297c67)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_vertical_tab_detection_ren.php"
            >Fix vertical tab detection (REnamer, 4c78079) &raquo;</a
          >
        </p>
        ...
        <p>
          Although it's not mentioned in the pcretest manpage as far as I can
          tell, in addition to the list of supported escapes a fallback case is
          accepted (and expected to be implemented) that handles a backslash
          followed by any other character, as is common in most languages which
          incorporate some form of escapes.
        </p>

        <p>
          Roll in support for this, thus fixing a bunch of different test
          failures.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003553more"><div id="more"></div></div>
