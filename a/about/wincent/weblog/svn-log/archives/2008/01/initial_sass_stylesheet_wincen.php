...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Initial Sass stylesheet (wincent.dev, 0d58fa2)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_needles_model_wincentcom_9.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_needles_model_wincentcom_9.php"
            >&laquo; Add &quot;needles&quot; model (wincent.dev, 99bb491)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/upgrade_to_haml_181_wincentcom.php"
            >Upgrade to Haml 1.8.1 (wincent.dev, 55f9609) &raquo;</a
          >
        </p>

        <h2>January 29, 2008</h2>

        <h3>Initial Sass stylesheet (wincent.dev, 0d58fa2)</h3>

        <p>
          Just a few top level elements styled for now, as well as flashes and
          the beginnings of the header and footer.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003811more"><div id="more"></div></div>
