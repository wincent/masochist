...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Start conversion of help documentation (REnamer,
      ade7ded)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/prepare_icon_graphics_for_help.php"
      title="Prepare icon graphics for help (REnamer, 3ffbd6d)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/throw_up_dialog_if_plugin_cant.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/prepare_icon_graphics_for_help.php"
            >&laquo; Prepare icon graphics for help (REnamer, 3ffbd6d)</a
          >
          |
        ...
        <p>
          As a starting point I previously imported the documentation from
          Hextrapolate for use as a template. This is the first commit in the
          conversion which will turn all this into the documentation for
          REnamer.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003681more"><div id="more"></div></div>
