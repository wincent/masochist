...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Teach plug-in to find application executable (REnamer,
      2f9bd1a)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/teach_tool_to_find_main_applic.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/teach_tool_to_find_main_applic.php"
            >&laquo; Teach tool to find main application executable (REnamer,
            9d7f325)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/update_application_bundle_iden.php"
            >Update application bundle identifier (REnamer, bec7018) &raquo;</a
          >
        </p>
        ...
        <p>
          This does the same thing for the plug-in that 9d7f325 did for the
          tool.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003573more"><div id="more"></div></div>
