...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Teach plug-in to launch using LSOpenItemsWithRole()
      (REnamer, 20661f5)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/change_worenamercontroller_to.php"
      title="Change WOREnamerController to WOREnamerDocument (REnamer, 2b68e85)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/free_fsref_array_in_separate_f.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/change_worenamercontroller_to.php"
            >&laquo; Change WOREnamerController to WOREnamerDocument (REnamer,
            2b68e85)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/free_fsref_array_in_separate_f.php"
            >Free FSRef array in separate function (REnamer, ac28b68) &raquo;</a
          >
        </p>
        ...
        <p>
          This solves an issue with the old implementation which used execv()
          where it would allow multiple instances of the application to be
          launched.
        </p>

        <p>
          As a nice side effect, this simplifies the code considerably and
          should run faster too with large numbers of files because we are
          basically working with FSRefs the whole time rather than converting
          them to path representations.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003719more"><div id="more"></div></div>
