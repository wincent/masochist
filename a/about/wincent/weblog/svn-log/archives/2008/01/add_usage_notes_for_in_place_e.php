...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add usage notes for in_place_editor_field (wincent.dev,
      59cc4a8)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/flesh_out_locales_controller_w.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/extract_in_place_editor_field.php"
            >&laquo; Extract in_place_editor_field_id function (wincent.dev,
            4539ee9)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/flesh_out_locales_controller_w.php"
            >Flesh out locales controller (wincent.dev, 9bd9613) &raquo;</a
          >
        </p>
        ...
        <h3>
          Add usage notes for in_place_editor_field (wincent.dev, 59cc4a8)
        </h3>

        <p>
          It isn't immediately obvious that the in_place_editor_field method
          expects a symbol or string parameter that indicates the name of an
          instance variable (normal locals won't work), so document that.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003799more"><div id="more"></div></div>
