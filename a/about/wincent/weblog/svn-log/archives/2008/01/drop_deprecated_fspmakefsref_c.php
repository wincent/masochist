...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Drop deprecated FSpMakeFSRef call (REnamer, f333c71)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_script_for_rebuilding_pcre.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_localization_note_renamer.php"
            >&laquo; Add localization note (REnamer, 6949f24)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_script_for_rebuilding_pcre.php"
            >Add script for rebuilding PCRE from within Xcode (REnamer, a5db51d)
            &raquo;</a
          >
        </p>
        ...
        <p>
          There is no useful substitute for this call, and testing shows that
          this codepath is never exercised, at least not on Mac OS X 10.5.1, so
          drop it.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003514more"><div id="more"></div></div>
