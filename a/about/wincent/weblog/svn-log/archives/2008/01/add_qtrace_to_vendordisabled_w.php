...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add QTrace to vendor/disabled (wincent.dev, 7dbf482)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/override_local_request_method.php"
      title="Override local_request? method for previewing errors (wincent.dev, 9d5b9a1)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/remove_rails_graphic_from_publ.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/override_local_request_method.php"
            >&laquo; Override local_request? method for previewing errors
            (wincent.dev, 9d5b9a1)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/remove_rails_graphic_from_publ.php"
            >Remove Rails graphic from &quot;public/images&quot; directory
            (wincent.dev, 9c4a451) &raquo;</a
          >
        </p>

        <h2>January 26, 2008</h2>

        <h3>Add QTrace to vendor/disabled (wincent.dev, 7dbf482)</h3>

        <p>
          This is a useful plug-in for printing out stack traces for matching
          database queries but I don't want it installed all the time. Adding it
          to the &quot;vendor/disabled&quot; folder from which it can easily be
          deployed on an as-needs basis.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003807more"><div id="more"></div></div>
