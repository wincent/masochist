...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Upgrade to Rails 2.0.2 (wincent.dev, 4bf1ec8)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/upgrade_to_haml_180_wincentcom.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/upgrade_to_haml_180_wincentcom.php"
            >&laquo; Upgrade to Haml 1.8.0 (wincent.dev, 14c0c89)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/upgrade_rspec_to_111_wincentco.php"
            >Upgrade RSpec to 1.1.1 (wincent.dev, 9adf928) &raquo;</a
          >
        </p>

        <h2>January 10, 2008</h2>

        <h3>Upgrade to Rails 2.0.2 (wincent.dev, 4bf1ec8)</h3>

        <p>And update app notes on upgrade procedure.</p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003736more"><div id="more"></div></div>
