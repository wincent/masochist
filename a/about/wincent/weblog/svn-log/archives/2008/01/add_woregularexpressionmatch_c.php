...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add WORegularExpressionMatch class (REnamer, 4d6aeb0)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/more_consistent_normalization.php"
      title="More consistent normalization of Unicode forms (REnamer, a1ecf6e)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/property_overhaul_for_woregula.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/more_consistent_normalization.php"
            >&laquo; More consistent normalization of Unicode forms (REnamer,
            a1ecf6e)</a
          >
          |
        ...
        <p>
          This is a wrapper class that I initially intended as a mere
          optimization (avoid unnecessary object instantiations by using scalar
          instance variables rather than wrapping scalars in NSNumber instances
          and storing them in an NSDictionary), but it actually has a very nice
          usability and readability impact as well, as evidenced by the
