...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Teach release notes script to take an optional prefix
      parameter (buildtools, d78a5bf)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/use_nondashed_form_of_git_comm.php"
      title="Use non-dashed form of Git commands (buildtools, 43661e2)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/tag_buildtools_with_each_relea.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/use_nondashed_form_of_git_comm.php"
            >&laquo; Use non-dashed form of Git commands (buildtools,
            43661e2)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/tag_buildtools_with_each_relea.php"
            >Tag buildtools with each release (Synergy, 3079b00) &raquo;</a
          >
        </p>
        ...
        <p>
          In the &quot;main&quot; project repository we just invoke the script
          as normal (without parameters) and it uses &quot;git describe&quot; to
          find the last tag, the previous tag, and emit the differences between
          them.
        </p>

        <p>
          In the secondary repositories we pass a &quot;tag prefix&quot; which
          we use to locate the tags corresponding to the release of the
          &quot;main&quot; project; in other words this depends on a convention
          in which we create tags in the secondary repositories which have a
          unique prefix which identifies the main project.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003763more"><div id="more"></div></div>
