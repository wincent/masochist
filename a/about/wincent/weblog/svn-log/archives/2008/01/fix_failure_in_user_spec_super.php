...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix failure in user spec (superuser mass assignment)
      (wincent.dev, 7636e1d)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/allow_custom_matcher_to_work_w.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/user_spec_fixes_for_mass_assig.php"
            >&laquo; User spec fixes for mass assignment (wincent.dev,
            ab7e57d)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/allow_custom_matcher_to_work_w.php"
            >Allow custom matcher to work with associations (wincent.dev,
            b2c76ac) &raquo;</a
          >
        </p>
        ...
        <h3>
          Fix failure in user spec (superuser mass assignment) (wincent.dev,
          7636e1d)
        </h3>

        <p>
          The spec failed because we were testing the first user, which is by
          default the superuser. So perform the test on the second user instead.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003750more"><div id="more"></div></div>
