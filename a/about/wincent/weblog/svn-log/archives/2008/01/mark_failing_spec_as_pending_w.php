...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Mark failing spec as pending (Walrus, 1a4311d)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/better_error_handling_when_run.php"
      title="Better error handling when running under Xcode (Walrus, 4625397)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/dont_rely_on_synthesized_sette.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/better_error_handling_when_run.php"
            >&laquo; Better error handling when running under Xcode (Walrus,
            4625397)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/dont_rely_on_synthesized_sette.php"
            >Don't rely on synthesized setter for mutable property (Synergy,
            5e08528) &raquo;</a
          >
        </p>
        ...
        <p>
          This is a spec that has long failed because of limitations in the
          boundary checking in the current algorithm. It's a non-critical
          limitation though so I've always let it slide.
        </p>

        <p>
          But seeing as I'd like to roll out another release soon I'd like to
          have failure-free spec runs. Marking this one as pending.
        </p>

        <p>
          In the long, long term this kind of issue will be solved by a total
