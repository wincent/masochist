...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/avoid_void_pointer_arithmetic.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_lsopenitemswithrole_usage.php"
            >&laquo; Fix LSOpenItemsWithRole usage (REnamer, 293cecc)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/avoid_void_pointer_arithmetic.php"
            >Avoid void pointer arithmetic in WOCreateFSRefArrayFromAEDesc()
            (REnamer, 2fe20b9) &raquo;</a
          >
        </p>
        ...
        <p>
          For consistency with selectedFiles member, this should be called
          selectedFileCount. Also, move it up higher in the struct (it is more
          conventional for it to precede the selectedFiles member).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003722more"><div id="more"></div></div>
