...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Rename lastRegularExpressionError to lastPatternError
      (REnamer, a99ffb9)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_spelling_error_in_woregula.php"
      title="Fix spelling error in WORegularExpressionMatch header (REnamer, 9c4ac0c)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/rename_validisvalid_to_pattern.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_spelling_error_in_woregula.php"
            >&laquo; Fix spelling error in WORegularExpressionMatch header
            (REnamer, 9c4ac0c)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/rename_validisvalid_to_pattern.php"
            >Rename valid/isValid to patternValid/isPatternValid (REnamer,
            adea2c7) &raquo;</a
          >
        </p>
        ...
        <h3>
          Rename lastRegularExpressionError to lastPatternError (REnamer,
          a99ffb9)
        </h3>

        <p>
          For consistency, seeing as we have a lastSubstitutionError, it makes
          more sense to have a &quot;lastPatternError&quot;. This means that the
          names for the two types of errors (one in the &quot;Find&quot; string,
