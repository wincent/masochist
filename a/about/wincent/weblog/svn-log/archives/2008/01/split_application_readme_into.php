...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Split application README into two files (wincent.dev,
      9f3f65e)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/big_reworking_of_authenticatio.php"
            >&laquo; Big reworking of authentication machinery (wincent.dev,
            d9afad4)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/nest_translations_inside_local.php"
            >Nest translations inside locales (wincent.dev, bb54bc7) &raquo;</a
          >
        </p>

        <h2>January 24, 2008</h2>

        <h3>Split application README into two files (wincent.dev, 9f3f65e)</h3>

        <p>Now we have setup notes and design notes.</p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003781more"><div id="more"></div></div>
