...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Upgrade RSpec to 1.1.1 (wincent.dev, 9adf928)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/upgrade_to_rails_202_wincentco.php"
            >&laquo; Upgrade to Rails 2.0.2 (wincent.dev, 4bf1ec8)</a
          >
          |
        ...
        <h3>Upgrade RSpec to 1.1.1 (wincent.dev, 9adf928)</h3>

        <p>And update notes.</p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003738more"><div id="more"></div></div>
