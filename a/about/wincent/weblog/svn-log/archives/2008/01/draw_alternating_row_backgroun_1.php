...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Draw alternating row backgrounds all the way to the
      bottom (REnamer, 6fcc806)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/draw_custom_sort_indicators_in.php"
      title="Draw custom sort indicators in HUD table view (REnamer, cbd1796)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/refactoring_drawing_of_row_bac.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/draw_custom_sort_indicators_in.php"
            >&laquo; Draw custom sort indicators in HUD table view (REnamer,
            cbd1796)</a
          >
          |
        ...
        <h3>
          Draw alternating row backgrounds all the way to the bottom (REnamer,
          6fcc806)
        </h3>

        <p>
          No need to do any further subclassing, can just overdraw until we hit
          the edge of the clip rectangle.
        </p>

        <p>
          This is the initial implementation which clearly shows what's being
          done (draw existing rows, then overdraw past bottom of clip
          rectangle). I'm about to commit a refactored implementation that
          eliminates the repetition by combining the two phases.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003619more"><div id="more"></div></div>
