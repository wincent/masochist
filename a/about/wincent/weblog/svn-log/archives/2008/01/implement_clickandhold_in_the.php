...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Implement click-and-hold in the non-knob part of the
      slot (REnamer, 655a288)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/move_nscontrol_overrides_to_to.php"
      title="Move NSControl overrides to top of file (REnamer, 1f43be9)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_hud_subgroup_to_xcode_proj.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/move_nscontrol_overrides_to_to.php"
            >&laquo; Move NSControl overrides to top of file (REnamer,
            1f43be9)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_hud_subgroup_to_xcode_proj.php"
            >Add HUD subgroup to Xcode project (REnamer, eca26a2) &raquo;</a
          >
        </p>
        ...
        <h3>
          Implement click-and-hold in the non-knob part of the slot (REnamer,
          655a288)
        </h3>

        <p>
          Previous clicking in the non-knob part of the lost resulted in a
          &quot;page up&quot; or &quot;page down&quot; movement. Now
          clicking-and-holding results in a repeated action, depending on which
          part of the slot the mouse is in at that moment. This brings the
          custom scroller behaviour completely in line to that of the rest of
          the system.
        </p>

        <p>
          There is still one change I'd like to make (making the page up/down
          intervals larger), but that will have to be done in the NSScrollView
          subclass.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003658more"><div id="more"></div></div>
