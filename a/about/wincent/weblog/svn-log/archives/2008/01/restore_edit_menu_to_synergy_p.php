...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Restore Edit menu to Synergy Preferences application
      (Synergy, ffaa428)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_inapp_regular_expression_f.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_inapp_regular_expression_f.php"
            >&laquo; Fix in-app regular expression failures (REnamer,
            33a0178)</a
          >
          |
        ...
        <p>
          I was overly enthusiastic in removing this; it turns out that without
          it the keyboard shortcuts for Copy and Paste don't work, and that
          makes entering registration information unnecessarily painful.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003608more"><div id="more"></div></div>
