...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix a couple of crashers in the plug-in (REnamer,
      00629cf)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/avoid_temporary_object_creatio.php"
      title="Avoid temporary object creation in plug-in (REnamer, c881c75)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_localization_note_renamer.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/avoid_temporary_object_creatio.php"
            >&laquo; Avoid temporary object creation in plug-in (REnamer,
            c881c75)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_localization_note_renamer.php"
            >Add localization note (REnamer, 6949f24) &raquo;</a
          >
        </p>
        ...
        <p>
          Just tying up a couple of loose ends that fell out from the rewrite;
          we fully-initialize the plug-in structure now just in case there's
          random garbage in the memory returned by malloc(), and also restore
          the check for NULL before calling CFRelease on the menu item title.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003512more"><div id="more"></div></div>
