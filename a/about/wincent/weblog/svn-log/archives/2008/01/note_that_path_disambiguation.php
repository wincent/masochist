...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Note that path disambiguation algorithm is based on a
      trie (REnamer, 9f3562a)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/remove_old_pcre_license_file_r.php"
            >&laquo; Remove old PCRE license file (REnamer, 50a6350)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/flag_inappropriate_use_of_nsus.php"
            >Flag inappropriate use of NSUserDefaultsController (REnamer,
            cb37213) &raquo;</a
          >
        </p>
        ...
        <h3>
          Note that path disambiguation algorithm is based on a trie (REnamer,
          9f3562a)
        </h3>
