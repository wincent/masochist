...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Dim text in location column (REnamer, 02d4ca8)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/use_smaller_font_in_preview_wi.php"
            >&laquo; Use smaller font in preview window cells (REnamer,
            4f40d3d)</a
          >
          |
        ...
        <p>
          Use a more subdued color in the location column seeing as this is
          really just supplemental information and we don't want to distract the
          user.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003617more"><div id="more"></div></div>
