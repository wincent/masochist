...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Teach autotest to re-run specs when executable changes
      (Wincent Strings Utility, 7cd221d)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/remove_redundant_autotest_requ.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/upgrade_to_rspec_112_wincentco.php"
            >&laquo; Upgrade to RSpec 1.1.2 (wincent.dev, 8e2cb5c)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/remove_redundant_autotest_requ.php"
            >Remove redundant autotest require (Wincent Strings Utility,
            4c1d9a0) &raquo;</a
          >
        </p>
        ...
        <h3>
          Teach autotest to re-run specs when executable changes (Wincent
          Strings Utility, 7cd221d)
        </h3>
        ...
        <div id="a003645more"><div id="more"></div></div>
