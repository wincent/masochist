...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Teach table header header cells to draw transparent
      backgrounds (REnamer, ddda4fb)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/draw_sort_indicators_in_hud_ta.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_wohudtableheadercell_class.php"
            >&laquo; Add WOHUDTableHeaderCell class (REnamer, 595ca86)</a
          >
          |
        ...
        <p>
          This unfortuantely requires overriding a private method, but it seems
          to be the only way.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003596more"><div id="more"></div></div>
