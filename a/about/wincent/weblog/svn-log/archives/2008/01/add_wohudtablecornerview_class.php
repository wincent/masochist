...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add WOHUDTableCornerView class (REnamer, c1e39a4)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/remove_custom_hud_clip_view_re.php"
            >&laquo; Remove custom HUD clip view (REnamer, f124cc7)</a
          >
          |
        ...
        <p>
          This replaces the standard corner view (which draws a silver gradient)
