...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Show preview window only for main window (REnamer,
      cd1b156)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/move_progress_text_when_resizi.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/move_progress_text_when_resizi.php"
            >&laquo; Move progress text when resizing window (REnamer,
            b56f7e5)</a
          >
          |
        ...
        <p>
          Now that we support multiple &quot;documents&quot; it can be confusing
          to have multiple preview windows on screen at the same time; so, only
          show the preview window for the current main window.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003733more"><div id="more"></div></div>
