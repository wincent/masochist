    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_nsdrawer_delegate_methods.php"
            >&laquo; Add NSDrawer delegate methods (REnamer, 921ccc5)</a
          >
          |
        ...
        <p>
          Turn off column order and size autosaving for the preview table; it
          doesn't work properly because our preview table view sometimes has two
          columns and sometimes three, and the one whose presence is toggled is
          the first one.
        </p>
