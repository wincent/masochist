...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix pointer error in the plug-in (REnamer, 5eb12a6)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/remove_test_comments_in_nsappl.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/throw_up_dialog_if_plugin_cant.php"
            >&laquo; Throw up dialog if plug-in can't find main application
            (REnamer, fbfc2ad)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/remove_test_comments_in_nsappl.php"
            >Remove test comments in NSApplication convenience category
            (WOCommon, 1656a77) &raquo;</a
          >
        </p>
        ...
        <p>
          We were copying to argv[1] when we really wanted to copy to
          &amp;argv[1].
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003683more"><div id="more"></div></div>
