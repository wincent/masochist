...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix table sorting and column selection (REnamer,
      6c7f8c7)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_stack_trace_notes_to_wohud.php"
      title="Add stack trace notes to WOHUDTableHeaderCell class (REnamer, 68eb428)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/refactoring_for_table_header_c.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_stack_trace_notes_to_wohud.php"
            >&laquo; Add stack trace notes to WOHUDTableHeaderCell class
            (REnamer, 68eb428)</a
          >
          |
        ...
        <p>
          These are really two related changes to the nib file: firstly,
          removing the table view's content binding (this is redundant because
          each column has its value binding set up with the array controller);
          and secondly, specify column identifiers so that autosaving of column
          geometry can be turned on.
        </p>

        <p>
          I originally had a third change here as well, enabling column
          selection, but that proved to be unnecessary in order to get sorting
          working.
        </p>

        <p>
          Note that a few issues still remain: the sort indicators appear but do
          not change direction when sort direction is changed, and the
          highlighting behaviour is incorrect.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003602more"><div id="more"></div></div>
