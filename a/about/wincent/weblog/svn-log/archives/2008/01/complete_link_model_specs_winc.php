...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Complete Link model specs (wincent.dev, f80c10f)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/remove_dbschemarb_file_wincent.php"
            >&laquo; Remove db/schema.rb file (wincent.dev, de09bc5)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_skeletal_specs_for_models.php"
            >Add skeletal specs for models which were missing them (wincent.dev,
            a65baf4) &raquo;</a
          >
        </p>
        ...
        <h3>Complete Link model specs (wincent.dev, f80c10f)</h3>

        <p>
          These specs test all of the visible behaviour in the Link model and
          the migration that creates it in the database.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003940more"><div id="more"></div></div>
