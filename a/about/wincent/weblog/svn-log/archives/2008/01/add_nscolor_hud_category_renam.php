...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/update_argument_handling_in_ma.php"
      title="Update argument handling in main application (REnamer, 6340d58)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/xcode_project_bundle_updates_r.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/update_argument_handling_in_ma.php"
            >&laquo; Update argument handling in main application (REnamer,
            6340d58)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/xcode_project_bundle_updates_r.php"
            >Xcode project bundle updates (REnamer, cc55e06) &raquo;</a
          >
        </p>
        ...
        <p>
          Not sure whether this is a good idea or not so I haven't included this
          code in the application, but it is a demonstration of how we could get
          rid of our macros (which re-instantiate the color objects on every
          use) and replace them with persistent singleton objects.
        </p>

        <p>
          This is a space-for-time tradeoff which we probably only need to make
          if profiling indicates that it's required.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003696more"><div id="more"></div></div>
