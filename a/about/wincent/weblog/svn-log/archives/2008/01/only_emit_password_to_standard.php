...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Only emit password to standard error, not to the log
      (wincent.dev, c4b9b7e)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/pretty_permalinks_for_locales.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/use_color_when_logging_admin_p.php"
            >&laquo; Use color when logging admin password (wincent.dev,
            75355bc)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/pretty_permalinks_for_locales.php"
            >Pretty permalinks for locales (wincent.dev, 2fccd09) &raquo;</a
          >
        </p>
        ...
        <p>
          As mentioned in 75355bc, we can avoid emitting to the log and thus
          improve security a little bit.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003785more"><div id="more"></div></div>
