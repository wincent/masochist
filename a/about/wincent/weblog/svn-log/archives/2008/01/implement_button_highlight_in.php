...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Implement button highlight in custom scroller (REnamer,
      0bfde98)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/custom_nsscroller_subclass_ren.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/custom_nsscroller_subclass_ren.php"
            >&laquo; Custom NSScroller subclass (REnamer, 3fa4cd7)</a
          >
          |
        ...
        <p>
          Currently only works for the horizontal scroller; hopefully will find
          a way of making it work for the vertical scroller as well.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003628more"><div id="more"></div></div>
