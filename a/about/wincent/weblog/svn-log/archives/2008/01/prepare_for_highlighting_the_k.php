...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Prepare for highlighting the knob in the WOHUDScroller
      class (REnamer, c1a4b63)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/teach_wohudscrollview_how_to_s.php"
      title="Teach WOHUDScrollView how to scroll (REnamer, 46da7d1)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_trackknob_and_trackscrollb.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/teach_wohudscrollview_how_to_s.php"
            >&laquo; Teach WOHUDScrollView how to scroll (REnamer, 46da7d1)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_trackknob_and_trackscrollb.php"
            >Add trackKnob: and trackScrollButtons: implementations (REnamer,
            3308124) &raquo;</a
          >
        </p>
        ...
        <h3>
          Prepare for highlighting the knob in the WOHUDScroller class (REnamer,
          c1a4b63)
        </h3>

        <p>
          Add an instance variable to control the whether the knob is drawn
          highlighted or not in the WOHUDScroller class.
        </p>

        <p>
          This is the first in a series of commits whose purpose is to work
          around an inconsistency in Cocoa, and while we're at it make the
          control behave a little more like the one in Interface Builder.
        </p>

        <p>
          While rendering currently works great when the scroll arrows are
          apart, if the user wants them displayed next to each other then we get
          smearing glitches.
        </p>

        <p>
          I've investigated the issue and determined that this is caused by the
          system calling drawRect: with an undersized rectangle. The problem
          doesn't occur when the arrows are apart.
        </p>

        <p>
          I looked at various workarounds, including overriding private NSView
          methods and trying to force a redraw in a larger area but there was no
          obvious and straightforward solution.
        </p>

        <p>
          So the only robust and future-proof solution seems to be to override
          mouseDown: completely and not call super. This commit is one step that
          lays the ground work for that change. More to follow.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003654more"><div id="more"></div></div>
