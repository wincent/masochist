...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Extract sort descriptor methods into NSTableColumn
      category (REnamer, a0bd9ee)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/set_default_cell_text_color_to.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/refactoring_for_table_header_c.php"
            >&laquo; Refactoring for table header cell drawing (REnamer,
            9729ba7)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/set_default_cell_text_color_to.php"
            >Set default cell text color to white (REnamer, d347fdf) &raquo;</a
          >
        </p>
        ...
        <h3>
          Extract sort descriptor methods into NSTableColumn category (REnamer,
          a0bd9ee)
        </h3>

        <p>
          As mentioned in 9729ba7, clean things up by extracting the sort
          descriptor functionality into a separate category.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003604more"><div id="more"></div></div>
