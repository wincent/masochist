...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add trackKnob: and trackScrollButtons: implementations
      (REnamer, 3308124)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/prepare_for_highlighting_the_k.php"
            >&laquo; Prepare for highlighting the knob in the WOHUDScroller
            class (REnamer, c1a4b63)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/avoid_more_glitches_by_monitor.php"
            >Avoid more glitches by monitoring for frame changes (REnamer,
            c4bdee5) &raquo;</a
          >
        </p>
        ...
        <p>
          These are pixel-perfect implementations which eliminate all smearing
          artefacts that occurred when calling super. Unfortunately in order to
          guarantee this smear-free behaviour some overdrawing is required, but
          as the area of the scroller is so small this should not pose any
          performance problem.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003655more"><div id="more"></div></div>
