...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Autoload FixtureReplacement in the console (wincent.dev,
      6912254)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_passphrase_mass_assignment.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/allow_custom_matcher_to_work_w.php"
            >&laquo; Allow custom matcher to work with associations
            (wincent.dev, b2c76ac)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_passphrase_mass_assignment.php"
            >Fix passphrase mass assignment specs (wincent.dev, 3c019bc)
            &raquo;</a
          >
        </p>
        ...
        <p>
          Add an .irbrc file which includes the FixtureReplacement module
          whenever firing up the Rails console.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003754more"><div id="more"></div></div>
