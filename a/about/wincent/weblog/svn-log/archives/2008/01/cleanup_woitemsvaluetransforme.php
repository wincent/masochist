...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Clean-up WOItemsValueTransformer header (REnamer,
      a0e8cc3)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/teach_window_controller_to_hav.php"
            >&laquo; Teach window controller to have cake and eat it too
            (REnamer, 457adee)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_spelling_error_in_woregula.php"
            >Fix spelling error in WORegularExpressionMatch header (REnamer,
            9c4ac0c) &raquo;</a
          >
        </p>
        ...
        <p>
          Remove redundant import and add a pragma mark section header for
          macros.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003745more"><div id="more"></div></div>
