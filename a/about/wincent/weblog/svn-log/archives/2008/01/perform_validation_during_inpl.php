...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Perform validation during in-place editing (wincent.dev,
      bc34e99)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_update_attribute_to_active.php"
      title="Add update_attribute! to Active Record (wincent.dev, cec57c5)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/show_alert_if_model_validation.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_update_attribute_to_active.php"
            >&laquo; Add update_attribute! to Active Record (wincent.dev,
            cec57c5)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/show_alert_if_model_validation.php"
            >Show alert if model validation fails for in-place editing
            (wincent.dev, 21d51ba) &raquo;</a
          >
        </p>
        ...
        <p>
          This is the first step in making in-place editing play nicely with the
          validation system. Firstly, rather than blindly bypassing validation
          during AJAX in-place editing (what were they thinking?) we do
          validate. Secondly, in the event that saving (validation) fails we
          restore the old value of the field so that the user can see it.
        </p>

        <p>
          The next step will be to see if we can get the parent controller to
          display a flash message explaining the cause of the validation
          failure.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003796more"><div id="more"></div></div>
