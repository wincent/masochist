...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: More color tweaks for the HUD (REnamer, 6fddabd)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/use_smaller_font_in_preview_wi.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/turn_preview_window_resizing_b.php"
            >&laquo; Turn preview window resizing back on (REnamer, 413a463)</a
          >
          |
        ...
        <p>
          Drop the customizable location color; there really are only a few
          colors that look good on HUDs so there is no sense in offering a
          preference for it.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003615more"><div id="more"></div></div>
