...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Avoid overriding the private method in NSTableHeaderCell
      (REnamer, 9c7a69e)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/draw_sort_indicator_only_in_pr.php"
      title="Draw sort indicator only in primary sort column (REnamer, c5044f4)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/highlight_on_mouse_click_renam.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/draw_sort_indicator_only_in_pr.php"
            >&laquo; Draw sort indicator only in primary sort column (REnamer,
            c5044f4)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/highlight_on_mouse_click_renam.php"
            >Highlight on mouse click (REnamer, 0efec76) &raquo;</a
          >
        </p>
        ...
        <h3>
          Avoid overriding the private method in NSTableHeaderCell (REnamer,
          9c7a69e)
        </h3>

        <p>
          Refactor to achieve same results without relying on the override of a
          private method in NSTableHeaderCell.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003599more"><div id="more"></div></div>
