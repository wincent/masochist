...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Disallow keyboard-based selection in preview table view
      (REnamer, f1ca6cc)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_utf8_regular_expression_ma.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/implement_button_highlight_in.php"
            >&laquo; Implement button highlight in custom scroller (REnamer,
            0bfde98)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_utf8_regular_expression_ma.php"
            >Fix UTF-8 regular expression matching (REnamer, e1df3cb) &raquo;</a
          >
        </p>
        ...
        <h3>
          Disallow keyboard-based selection in preview table view (REnamer,
          f1ca6cc)
        </h3>

        <p>
          I'm not sure whether I'll keep this change but this at least shows how
          selection can easily be suppressed from within the delegate.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003629more"><div id="more"></div></div>
