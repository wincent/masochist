...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Cleanup whitespace in links routing spec (wincent.dev,
      a7b7f59)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_linkscreate_action_wincent.php"
      title="Add links/create action (wincent.dev, 9d91051)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/update_fixturereplacement_exam.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_linkscreate_action_wincent.php"
            >&laquo; Add links/create action (wincent.dev, 9d91051)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/update_fixturereplacement_exam.php"
            >Update FixtureReplacement example data (wincent.dev, d6ad037)
            &raquo;</a
          >
        </p>
        ...
        <h3>Cleanup whitespace in links routing spec (wincent.dev, a7b7f59)</h3>

        <p>
          Although I actually question the value of these specs generated by the
          RSpec scaffolding; this is really just testing that map.resources
          :links with no other parameters does what it should, and that's
          already covered by Rails' own tests.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003936more"><div id="more"></div></div>
