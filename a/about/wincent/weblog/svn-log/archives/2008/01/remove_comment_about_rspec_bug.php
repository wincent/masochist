...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove comment about RSpec bug (wincent.dev, f7ebc62)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/user_spec_fixes_for_mass_assig.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/reset_session_on_loginlogout_w.php"
            >&laquo; Reset session on login/logout (wincent.dev, 4a69b0d)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/user_spec_fixes_for_mass_assig.php"
            >User spec fixes for mass assignment (wincent.dev, ab7e57d)
            &raquo;</a
          >
        </p>
        ...
        <h3>Remove comment about RSpec bug (wincent.dev, f7ebc62)</h3>

        <p>
          I sent in a patch for this some time ago and it's included in the
          currently released version of RSpec (and probably the version prior
          too; I'm not sure exactly when it was included).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003746more"><div id="more"></div></div>
