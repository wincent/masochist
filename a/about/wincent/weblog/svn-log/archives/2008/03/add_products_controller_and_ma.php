...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add products controller and make it the default (root)
      route (wincent.dev, e1580bd)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/add_databaselevel_constraint_f.php"
      title="Add database-level constraint for product name uniqueness (wincent.dev, 7805a54)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/add_permalink_column_to_produc.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/add_databaselevel_constraint_f.php"
            >&laquo; Add database-level constraint for product name uniqueness
            (wincent.dev, 7805a54)</a
          >
          |
        ...
        <p>
          ...
          products controller, and concretely the &quot;index&quot; action.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004217more"><div id="more"></div></div>
