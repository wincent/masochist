...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Require name in products model (wincent.dev, e323bf2)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/add_example_data_for_products.php"
            >&laquo; Add example data for products model (wincent.dev,
            4109d10)</a
          >
          |
        ...
        <h3>Require name in products model (wincent.dev, e323bf2)</h3>

        <p>Add validation and corresponding spec.</p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004214more"><div id="more"></div></div>
