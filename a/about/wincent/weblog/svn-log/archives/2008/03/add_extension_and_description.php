...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add extension and description to products model
      (migration) (wincent.dev, 4eb5a36)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/update_products_link_in_navbar.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/update_products_link_in_navbar.php"
            >&laquo; Update products link in navbar (wincent.dev, 76cf73f)</a
          >
          |
        ...
        <p>
          We don't need to store the full path to the icon file but we do need
          to store the icon file extension; with this we can reconstruct the
          full path on demand.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004228more"><div id="more"></div></div>
