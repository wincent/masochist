...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Make separate administrator namespace (wincent.dev,
      13a0aec)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/tags_interface_wincentcom_37ee.php"
      title="Tags interface (wincent.dev, 37ee0e1)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/size_tag_font_depending_on_pop.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/tags_interface_wincentcom_37ee.php"
            >&laquo; Tags interface (wincent.dev, 37ee0e1)</a
          >
          |
        ...
        <h3>Make separate administrator namespace (wincent.dev, 13a0aec)</h3>

        <p>
          In general I prefer in-place editing where possible but there are some
          cases where it is useful to have an administrator-only view of a
          model. For example, consider the Tag model, where it is nice to have a
          read-only &quot;cloud&quot; view for normal users, while for admin
          users we can provide a straightforward table view with in-place editor
          fields and sortable table columns.
        </p>

        <p>
          Not sure why, but at some point my &quot;admin_only&quot; and
          &quot;logged_in_only&quot; helpers broke, so I've simplified them by
          removing the &quot;simple_concat&quot; method and now they're working
          again.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003967more"><div id="more"></div></div>
