...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Note about multi-tag search options (wincent.dev,
      e9b5ebd)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_main_form_css_class_wincen.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_main_form_css_class_wincen.php"
            >&laquo; Add &quot;main_form&quot; CSS class (wincent.dev,
            2ca2c9e)</a
          >
          |
        ...
        <h3>Note about multi-tag search options (wincent.dev, e9b5ebd)</h3>

        <p>
          For now given &quot;foo bar baz&quot; we show only items which have
          all three tags. This seems the most logical default, but note here
          that we could also easily show items which match any of the tags, and
          rank them according to the number of tags which match.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004151more"><div id="more"></div></div>
