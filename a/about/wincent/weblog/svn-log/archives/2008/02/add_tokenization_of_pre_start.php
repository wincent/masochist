...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add tokenization of PRE_START and PRE_END (wikitext,
      940a83b)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_wikitext_commandline_tool.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/note_about_routesrb_modificati.php"
            >&laquo; Note about routes.rb modifications in Edge Rails
            (wincent.dev, a945990)</a
          >
          |
        ...
        <p>
          ...
          &lt;pre&gt;&lt;/pre&gt; tags to mark up PRE spans rather than just
          using the existing mechanism of prefixing each line with a space. This
          will be particularly useful when pasting in long code samples and the
          like.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004036more"><div id="more"></div></div>
