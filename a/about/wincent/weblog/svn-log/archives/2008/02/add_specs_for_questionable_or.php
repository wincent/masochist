...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add specs for questionable or invalid links (wikitext,
      b00e7b1)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_tokenization_of_mailto_uri.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/handle_uris_in_internal_link_t.php"
            >&laquo; Handle URIs in internal link text (wikitext, 256c0e9)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_tokenization_of_mailto_uri.php"
            >Add tokenization of mailto URIs (wikitext, c70f28a) &raquo;</a
          >
        </p>
        ...
        <p>
          These specs show how the transformer responds in the face of odd or
          questionable input (strange characters in link text, for example).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004022more"><div id="more"></div></div>
