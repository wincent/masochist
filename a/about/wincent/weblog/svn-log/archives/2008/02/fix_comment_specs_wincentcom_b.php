...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Fix Comment specs (wincent.dev, b522ae6)</title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/drop_redundant_authentication.php"
      title="Drop redundant authentication specs (wincent.dev, 1545453)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/run_specs_whenever_example_dat.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/drop_redundant_authentication.php"
            >&laquo; Drop redundant authentication specs (wincent.dev,
            1545453)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/run_specs_whenever_example_dat.php"
            >Run specs whenever example_data.rb changes (wincent.dev, a673655)
            &raquo;</a
          >
        </p>
        ...
        <h3>Fix Comment specs (wincent.dev, b522ae6)</h3>

        <p>
          The default specs that RSpec provides weren't working so make the
          minimal changes required to get them going.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003953more"><div id="more"></div></div>
