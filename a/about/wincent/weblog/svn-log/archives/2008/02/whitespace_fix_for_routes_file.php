...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Whitespace fix for routes file (wincent.dev, 002b836)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_convenience_methods_to_str.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_convenience_methods_to_str.php"
            >&laquo; Add convenience methods to String class for translating
            wikitext markup (wincent.dev, 8a32b3d)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/simplify_localetranslation_rou.php"
            >Simplify locale/translation routing (wincent.dev, ea50092)
            &raquo;</a
          >
        </p>
        ...
        <h3>Whitespace fix for routes file (wincent.dev, 002b836)</h3>

        <p>Add missing newline at end of file to quieten diff output.</p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003946more"><div id="more"></div></div>
