...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Whitespace fix (wincent.dev, c9914a6)</title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/drop_html_caching_from_revisio.php"
            >&laquo; Drop HTML caching from revisions table (wincent.dev,
            5313bbb)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/drop_redundant_authentication.php"
            >Drop redundant authentication specs (wincent.dev, 1545453)
            &raquo;</a
          >
        </p>
        ...
        <h3>Whitespace fix (wincent.dev, c9914a6)</h3>

        <p>Remove unneeded empty line.</p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003951more"><div id="more"></div></div>
