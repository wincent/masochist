...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Show id in Links controller (wincent.dev, 3af4297)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/bump_version_number_postreleas_8.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/bump_version_number_postreleas_8.php"
            >&laquo; Bump version number post-release (wikitext, 5e55ff4)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/validate_permalink_format_for.php"
            >Validate permalink format for links (wincent.dev, d522c0d)
            &raquo;</a
          >
        </p>
        ...
        <h3>Show id in Links controller (wincent.dev, 3af4297)</h3>

        <p>
          This is an admin-only view, and the permalink is optional, so it makes
          sense to show the id here in the index view.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004148more"><div id="more"></div></div>
