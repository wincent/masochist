...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix autolinking spec (missing variable) (wikitext,
      340e5a5)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_specs_to_test_external_lin.php"
            >&laquo; Add specs to test external_link_class overrides (wikitext,
            a69f859)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/hook_up_indentation_method_wik.php"
            >Hook up indentation method (wikitext, a7bc5e6) &raquo;</a
          >
        </p>
        ...
        <p>
          In a recent refactoring (splitting an example into multiple ones) I
          missed out carrying across this variable.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003994more"><div id="more"></div></div>
