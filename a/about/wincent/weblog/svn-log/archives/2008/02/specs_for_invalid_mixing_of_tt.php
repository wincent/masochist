...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Specs for invalid mixing of &lt;tt&gt; and backtick
      spans (wikitext, 01a490c)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/teach_parser_to_handle_backtic.php"
            >&laquo; Teach parser to handle backticks (wikitext, 894e2af)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/revert_escaped_tt_tokenization.php"
            >Revert ESCAPED_TT tokenization (wikitext, caa69cc) &raquo;</a
          >
        </p>
        ...
        <h3>
          Specs for invalid mixing of &lt;tt&gt; and backtick spans (wikitext,
          01a490c)
        </h3>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003857more"><div id="more"></div></div>
