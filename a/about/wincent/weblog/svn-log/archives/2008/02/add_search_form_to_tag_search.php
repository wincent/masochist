...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add search form to tag search results page (wincent.dev,
      d828803)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/restrict_visibility_during_tag.php"
            >&laquo; Restrict visibility during tag searches (wincent.dev,
            470696b)</a
          >
          |
        ...
        <p>
          This allows the user to do another search after doing a previous one,
          and also provides a fallback for users who don't have JavaScript
