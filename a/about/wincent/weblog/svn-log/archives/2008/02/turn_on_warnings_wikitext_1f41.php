...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/return_nil_from_the_profiling.php"
      title="Return nil from the profiling_parse method (wikitext, cd6bf8e)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_inline_is_not_at_beginning.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/return_nil_from_the_profiling.php"
            >&laquo; Return nil from the profiling_parse method (wikitext,
            cd6bf8e)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_inline_is_not_at_beginning.php"
            >Fix &quot;inline is not at beginning of declaration&quot; warning
            (wikitext, e5a1e6e) &raquo;</a
          >
        </p>
        ...
        <p>
          I noticed that the compile on RHEL 5.1 was much chattier than on Mac
          OS X and RHEL 3; it turns out that RHEL 5.1 has a bunch of warnings
          enabled by default wheres on the other targets they are not and so I
          was getting warning-free builds.
        </p>

        <p>
          Crank up the warnings so that all problems can be found and fixed, and
