...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Show spinner graphic while updating preview
      (wincent.dev, a7dd462)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/disable_haml_indentation_for_t.php"
            >&laquo; Disable Haml indentation for text areas as well
            (wincent.dev, fcb2803)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_syntax_error_in_new_articl.php"
            >Fix syntax error in new article template (wincent.dev, 2d35085)
            &raquo;</a
          >
        </p>
        ...
        <div id="a004084more"><div id="more"></div></div>
