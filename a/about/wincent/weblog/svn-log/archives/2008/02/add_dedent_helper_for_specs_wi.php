...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add &quot;dedent&quot; helper for specs (wikitext,
      54a7a69)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/more_blockquote_specs_and_one.php"
      title="More blockquote specs and one fix for nested pre blocks (wikitext, b6e1984)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/more_blockquote_specs_wikitext.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/more_blockquote_specs_and_one.php"
            >&laquo; More blockquote specs and one fix for nested pre blocks
            (wikitext, b6e1984)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/more_blockquote_specs_wikitext.php"
            >More blockquote specs (wikitext, 00e2719) &raquo;</a
          >
        </p>
        ...
        <p>
          I'm finding the multiline spec data hard to read because it breaks the
          flow of the indentation (where does one spec end and another begin?
          are we nested inside multiple &quot;describe&quot; blocks? etc).
        </p>

        <p>
          So here I add a &quot;dedent&quot; helper which will allow me to
          indent the spec data for better readability while editing, and then
          dedent the data at runtime for actual checking.
        </p>

        <p>
          As a safety valve I make sure that we're not asked to dedent more
          whitespace than we actually have.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004051more"><div id="more"></div></div>
