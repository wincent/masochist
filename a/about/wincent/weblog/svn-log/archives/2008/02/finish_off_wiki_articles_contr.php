...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Finish off (wiki) articles controller (wincent.dev,
      e27c63a)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/nicer_css_for_pre_blocks_wince.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_handling_of_permalinks_wit.php"
            >&laquo; Fix handling of permalinks with periods in them
            (wincent.dev, 1a848c1)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/nicer_css_for_pre_blocks_wince.php"
            >Nicer CSS for PRE blocks (wincent.dev, de69284) &raquo;</a
          >
        </p>

        <h2>February 12, 2008</h2>

        <h3>Finish off (wiki) articles controller (wincent.dev, e27c63a)</h3>

        <p>
          Now we have an edit action, the show action handles redirects (and
          tries to catch cyclical redirects), and basic validation is performed.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004077more"><div id="more"></div></div>
