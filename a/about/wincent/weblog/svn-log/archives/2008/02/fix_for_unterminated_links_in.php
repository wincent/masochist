...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix for unterminated links in LI blocks (wikitext,
      2e23cfe)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_handling_of_unclosed_spanl.php"
            >&laquo; Fix handling of unclosed span-level elements in lists
            (wikitext, 2a996a7)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_unterminated_external_link.php"
            >Fix unterminated external links nested inside LI blocks (wikitext,
            50350ef) &raquo;</a
          >
        </p>
        ...
        <p>
          Another class of bad input; this is the spec that tests for it and the
          modifications required to make it pass.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004018more"><div id="more"></div></div>
