...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add new instance variable, space_to_underscore
      (wikitext, adfcb69)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_sample_document_and_cheats.php"
      title="Add sample document and cheatsheet (wikitext, a7f20b7)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_space_to_underscore_to_par.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_sample_document_and_cheats.php"
            >&laquo; Add sample document and cheatsheet (wikitext, a7f20b7)</a
          >
          |
        ...
        <p>
          This instance variable will permit the creation of MediaWiki-style
          links, where [[foo bar]] is a like to &quot;/wiki/foo_bar&quot; rather
          than &quot;/wiki/foo%20bar&quot;.
        </p>

        <p>
          The benefit is prettier URLs; the downside is that [[foo bar]] and
          [[foo_bar]] now point to the same article. As this is a trade off it
          will default to off by default.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004104more"><div id="more"></div></div>
