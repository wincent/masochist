...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Prettify wiki URLs (wincent.dev, 7a865f9)</title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/allow_option_overrides_at_inti.php"
      title="Allow option overrides at intialization time (wikitext, f2658b6)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/basic_tag_display_wincentcom_6.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/allow_option_overrides_at_inti.php"
            >&laquo; Allow option overrides at intialization time (wikitext,
            f2658b6)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/basic_tag_display_wincentcom_6.php"
            >Basic tag display (wincent.dev, 61b8b6f) &raquo;</a
          >
        </p>

        <h2>February 18, 2008</h2>

        <h3>Prettify wiki URLs (wincent.dev, 7a865f9)</h3>

        <p>
          Adopt MediaWiki convention of converting spaces to underscores in
          article titles. This means that we get cleaner-looking URLs in the
          browser's address/location bar (eg &quot;foo_bar&quot; instead of
          &quot;foo%20bar&quot;) at the cost of having to disallow underscores
          in article titles.
        </p>

        <p>
          I've added a corresponding validation. I prefer explicitly disallowing
          the underscore rather than accepting it and therefore permitting the
          ambiguity wherein you can create two articles, &quot;foo bar&quot; and
          &quot;foo_bar&quot;, and you can only conveniently link to one of
          them.
        </p>

        <p>
          I think this is an acceptable tradeoff because attractive URLs are
          important and space is exceedingly common in article titles whereas
          underscore is not.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004143more"><div id="more"></div></div>
