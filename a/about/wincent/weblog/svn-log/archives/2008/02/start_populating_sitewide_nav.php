...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Start populating site-wide nav bar (wincent.dev,
      477b843)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/more_highlevel_updates_to_arti.php"
            >&laquo; More high-level updates to Articles controller
            (wincent.dev, 5c6888e)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/use_post_rather_than_get_for_w.php"
            >Use &quot;post&quot; rather than &quot;get&quot; for wiki article
            AJAX preview (wincent.dev, 4f318b5) &raquo;</a
          >
        </p>

        <h2>February 13, 2008</h2>

        <h3>Start populating site-wide nav bar (wincent.dev, 477b843)</h3>

        <p>Trying to keep the number of links in the navbar nice and low.</p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004081more"><div id="more"></div></div>
