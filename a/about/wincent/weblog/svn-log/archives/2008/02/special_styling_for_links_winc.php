...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Special styling for links (wincent.dev, 45e3ce0)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_validation_of_tag_name_att.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/change_tag_cloud_formatting_wi.php"
            >&laquo; Change tag cloud formatting (wincent.dev, 0ca64e0)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_validation_of_tag_name_att.php"
            >Add validation of tag name attribute (wincent.dev, 4cdb738)
            &raquo;</a
          >
        </p>
        ...
        <h3>Special styling for links (wincent.dev, 45e3ce0)</h3>

        <p>
          This is for horizontal rows of links, to make them stand out a little
          more.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003970more"><div id="more"></div></div>
