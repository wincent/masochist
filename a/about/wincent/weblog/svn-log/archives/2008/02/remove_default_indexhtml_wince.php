...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove default index.html (wincent.dev, 1c84a1c)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_basic_rails_test_app_wince.php"
      title="Add basic Rails test app (wincent.dev, 9434674)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_sample_database_configurat.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_basic_rails_test_app_wince.php"
            >&laquo; Add basic Rails test app (wincent.dev, 9434674)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_sample_database_configurat.php"
            >Add sample database configuration file (wincent.dev, aedc881)
            &raquo;</a
          >
        </p>
        ...
        <h3>Remove default index.html (wincent.dev, 1c84a1c)</h3>

        <p>
          We want to actually exercise the Rails stack, so we'll let the route
          fall through to a simple controller.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004207more"><div id="more"></div></div>
