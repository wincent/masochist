...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Teach parser to extract &quot;indent&quot; option
      (wikitext, c032589)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/teach_wikitextparserparse_to_a.php"
            >&laquo; Teach Wikitext::Parser#parse to accept an options hash
            (wikitext, 73fb12a)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/minor_cleanup_in_list_handling.php"
            >Minor cleanup in list handling (wikitext, 0a8fe9f) &raquo;</a
          >
        </p>
        ...
        <p>
          Don't actually do anything with it yet, but it's there ready to be
          used.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003980more"><div id="more"></div></div>
