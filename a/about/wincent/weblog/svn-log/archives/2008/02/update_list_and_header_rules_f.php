...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update list and header rules for new BLOCKQUOTE_START
      token (wikitext, 9e985ab)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_tokenization_of_literal_bl.php"
      title="Add tokenization of literal blockquote tags (wikitext, 8888a18)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/basic_blockquote_implementatio.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_tokenization_of_literal_bl.php"
            >&laquo; Add tokenization of literal blockquote tags (wikitext,
            8888a18)</a
          >
          |
        ...
        <h3>
          Update list and header rules for new BLOCKQUOTE_START token (wikitext,
          9e985ab)
        </h3>

        <p>
          These rules previously held if at the start of the line or immediately
          after a BLOCKQUOTE token; now that we have BLOCKQUOTE_START as well we
