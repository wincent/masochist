...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Nicer CSS for PRE blocks (wincent.dev, de69284)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/finish_off_wiki_articles_contr.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/finish_off_wiki_articles_contr.php"
            >&laquo; Finish off (wiki) articles controller (wincent.dev,
            e27c63a)</a
          >
          |
        ...
        <h3>Nicer CSS for PRE blocks (wincent.dev, de69284)</h3>

        <p>
          Do Wikipedia style borders around PRE blocks to make them stand out
          better.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004078more"><div id="more"></div></div>
