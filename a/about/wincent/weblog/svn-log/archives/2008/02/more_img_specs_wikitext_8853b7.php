...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/update_documentation_for_new_o.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/additional_specs_for_img_prefi.php"
            >&laquo; Additional specs for img_prefix attribute (wikitext,
            2a1afb2)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/update_documentation_for_new_o.php"
            >Update documentation for new options (wikitext, f6f5a8c) &raquo;</a
          >
        </p>
        ...
        <p>
          Add image markup to the integration tests and demonstrate embedding of
          images in various types of inline span.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004161more"><div id="more"></div></div>
