...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Swap out calls to NIL_P when deleting items (wikitext,
      fb30594)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_offbyone_error_in_aryh_wik.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_offbyone_error_in_aryh_wik.php"
            >&laquo; Fix off-by-one error in ary.h (wikitext, fb26fbc)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_notes_file_to_benchmarks_s.php"
            >Add notes file to benchmarks subdirectory (wikitext, fdccb3b)
            &raquo;</a
          >
        </p>
        ...
        <p>
          Without this substitution we can never empty the stack because we
          never notice when we're done.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003893more"><div id="more"></div></div>
