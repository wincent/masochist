...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/normalize_negative_indents_to.php"
      title="Normalize negative indents to 0 (wikitext, 4f88966)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_custom_string_struct_imple.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/normalize_negative_indents_to.php"
            >&laquo; Normalize negative indents to 0 (wikitext, 4f88966)</a
          >
          |
        ...
        <p>
          Test user overrides of base indentation. The intention here is for
          incorporation in Haml templates (or any other templating system that
          takes care to produce beautifully-formatted HTML). The user can supply
          a base indentation level that matches the expected indentation level
          in the enclosing Haml template; in this way the wikitext-generated
