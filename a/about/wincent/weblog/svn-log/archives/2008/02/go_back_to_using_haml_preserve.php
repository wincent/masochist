...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Go back to using Haml &quot;preserve&quot; method
      (wincent.dev, c031ee8)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/revert_teach_haml_to_respect_p.php"
      title="Revert &amp;quot;Teach Haml to respect preformatted text&amp;quot; (wincent.dev, add2e6c)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/note_about_routesrb_modificati.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/revert_teach_haml_to_respect_p.php"
            >&laquo; Revert &quot;Teach Haml to respect preformatted text&quot;
            (wincent.dev, add2e6c)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/note_about_routesrb_modificati.php"
            >Note about routes.rb modifications in Edge Rails (wincent.dev,
            a945990) &raquo;</a
          >
        </p>
        ...
        <h3>
          Go back to using Haml &quot;preserve&quot; method (wincent.dev,
          c031ee8)
        </h3>

        <p>
          Will soon follow up with a patch to undo the ugliness from inside the
          &quot;render&quot; method. Clearly a hack, and I'd love to be rid of
          it, but will have to be that way for now.
        </p>

        <p>
          The main issue with it is that it involves applying two totally
          redundant transformations: one to insert newline escapes and another
          to remove them. Combined, these cancel each other out and the total
          effect is a no-op, but we're forced to use them to prevent Haml from
          mangling the PRE blocks (we gain correctly formatted PRE blocks in the
          browser but lose our nice source formatting and get back a horrible
          uninterrupted blob of text instead).
        </p>

        <p>
          This time-wasting transform is especially a shame because of all the
          effort I've put in to making the wikitext translator fast, so I'd
          still like to find an elegant way to teach Haml how to pass designated
          blocks of text without touching the formatting in any way.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004072more"><div id="more"></div></div>
