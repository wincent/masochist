...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update translations specs (wincent.dev, 08270ea)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_show_method_to_comments_co.php"
            >&laquo; Add show method to comments controller (wincent.dev,
            35495cb)</a
          >
          |
          ...
          <a
            ...
            (wincent.dev, 813baad) &raquo;</a
          >
        </p>

        <h2>February 7, 2008</h2>

        <h3>Update translations specs (wincent.dev, 08270ea)</h3>
