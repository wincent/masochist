...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Emit trailing newline after opening blockquote block
      (wikitext, d718a4b)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_specs_for_nesting_headers.php"
            >&laquo; Add specs for nesting headers inside blockquote blocks
            (wikitext, dc41edb)</a
          >
          |
        ...
        <h3>
          Emit trailing newline after opening blockquote block (wikitext,
          d718a4b)
        </h3>

        <p>
          This is in preparation for more indentation changes. Seeing as you can
          nest things inside a blockquote and those things can change the
