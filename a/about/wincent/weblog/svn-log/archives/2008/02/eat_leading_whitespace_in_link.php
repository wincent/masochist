...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Eat leading whitespace in link targets (wikitext,
      e8b3b86)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/more_autolinking_specs_wikitex.php"
      title="More autolinking specs (wikitext, 256d5c2)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/eat_leading_whitespace_during.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/more_autolinking_specs_wikitex.php"
            >&laquo; More autolinking specs (wikitext, 256d5c2)</a
          >
          |
        ...
        <p>
          We do this during the sanitization phase because its only at that
          point that we know we've got valid input and are actually going to
          emit a link. If we did it during parsing but prior to confirming that
          we had a valid link then we might end up throwing away a space that
          we'll later need.
        </p>
        ...
        <div id="a003922more"><div id="more"></div></div>
