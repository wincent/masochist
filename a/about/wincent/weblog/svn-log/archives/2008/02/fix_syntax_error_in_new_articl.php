...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix syntax error in new article template (wincent.dev,
      2d35085)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/show_spinner_graphic_while_upd.php"
            >&laquo; Show spinner graphic while updating preview (wincent.dev,
            a7dd462)</a
          >
          |
        ...
        <h3>Fix syntax error in new article template (wincent.dev, 2d35085)</h3>
