...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Handle URIs in internal link text (wikitext, 256c0e9)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/cleanup_rollback_functions_wik.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/cleanup_rollback_functions_wik.php"
            >&laquo; Clean-up rollback functions (wikitext, 1367c53)</a
          >
          |
        ...
        <p>
          A URI in the link text part of an internal link is invalid, so roll it
          back. (Note that external links are differnt: there there is no harm
          in allowig URIs in the link text. It is only a problem in the internal
          link case because it could confuse the routing if we allowed URI
          characters in article titles.)
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004021more"><div id="more"></div></div>
