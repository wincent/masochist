...
sudo ssh -L 10143:wincent.dev:143 \
         ...
         robinson@example.com</pre
            ...
            <p>
              ...
              <tt>robinson</tt> on the host <tt>wincent.dev</tt>; forward any
            ...
            <p>
              ...
              Instead of connecting to <tt>wincent.dev</tt> port 143, it will
            ...
            <p>
              ...
              <a
                href="https://wincent.dev/wiki/Using_Stunnel_to_secure_SMTP_transport"
                >Stunnel</a
            ...
            <p>
              ...
              running at <tt>wincent.dev</tt> (actually the same machine as the
...
cp imapd.pem sendmail.pem</pre
            ...
            <p>
              ...
              case, <tt>wincent.dev</tt>). This is because third parties
...
define(`confSERVER_KEY',`/usr/share/ssl/certs/sendmail.pem')dnl</pre
            ...
            <p>
              ...
              can do a <tt>telnet wincent.dev 25</tt> and see if it lists
              STARTTLS in response to <tt>ehlo wincent.dev</tt>. When testing
            ...
            <p>
              ...
              (in my case, <tt>wincent.dev</tt>), the new ports (993 and 995),
