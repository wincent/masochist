    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/knowledge-base/archives/2004/11/how_to_file_a_g.php"
            >&laquo; How to file a good bug report</a
          >
          |
        ...
        <p>
          I just tried grabbing the source to
          <a href="http://www.thp.uni-duisburg.de/pstree/README">pstree</a>,
          which is now up to 2.26, but it appears not to be on the
          <a href="http://www.thp.uni-duisburg.de/ftpdoc.html">FTP server</a>
          anymore. Luckily you can still grab the source
          <a href="http://www.thp.uni-duisburg.de/pstree/pstree.tar.gz"
            >from here</a
          >.
        </p>
        ...
        <div id="a000033more">
          <div id="more">
            <p>
              As is often the case, these instructions presume that you have the
              Xcode Tools installed, along with wget. There are instructions
              elsewhere on this site about how to install wget.
            </p>
