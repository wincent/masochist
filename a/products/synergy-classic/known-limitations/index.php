    ...
    <div id="breadcrumbs">
      <p>
        <a href="https://wincent.dev/">Main</a>&nbsp;&gt;&nbsp;<a href="../../"
          >Products</a
        >&nbsp;&gt;&nbsp;<a href="../">Synergy Classic</a>&nbsp;&gt;&nbsp;Known
        Limitations
      </p>
    </div>
    <div id="container">
      ...
      <div id="center">
        <div class="content">
          ...
          <ul>
            <li>
              If the Finder is the frontmost application and you have the
              Aladdin Systems StuffIt contextual menu module installed, StuffIt
              will insert a "StuffIt" submenu at the bottom of the Synergy
              global menu. This is a bug in the StuffIt software.
            </li>
            <li>
              The playlists submenu does not differentiate playlists with
              identical names.
            </li>
            <li>
              It is not possible to toggle the shuffle mode on and off when
              iTunes does not have a current track selection. This is a
              limitation of iTunes. Similarly, it is not possible to toggle the
              repeat mode under these circumstances.
            </li>
            <li>
              When hovering the mouse over the play button to display track
              information, if the mouse is held right at the top of the screen
              (over the top row of pixels), the information window is aligned so
              that the top left hand corner of it is beneath the mouse cursor.
              In tracks with long information strings, this causes the tooltip
              to run off the right edge of the screen. Other areas of the play
              button work normally. This is an Apple bug.
            </li>
            <li>
              When clicking the menu bar control buttons and moving the mouse to
              the right over Apple's "Menu Extras", those menus will drop down
              thus showing that the Menu Bar area is active. This is an Apple
              bug, as it appears to affect all applications that use Menu Bar
              status items, including applications from other vendors. A
              work-around is being investigated, but in the meantime
              <a href="http://www.apple.com/macosx/feedback/"
                >sending feedback to Apple</a
              >
              is encouraged.
            </li>
            <li>
              Spanish localisation does not extend to the Preference Pane or
              this documentation, only to the menu bar application.
            </li>
          </ul>
