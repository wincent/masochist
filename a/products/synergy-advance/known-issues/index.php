    ...
    <div id="breadcrumbs">
      <p>
        <a href="https://wincent.dev/">Main</a>&nbsp;&gt;&nbsp;<a href="../../"
          >Products</a
        >&nbsp;&gt;&nbsp;<a href="../">Synergy Advance</a>&nbsp;&gt;&nbsp;Known
        Issues
      </p>
    </div>
    <div id="container">
      ...
      <div id="center">
        <div class="content">
          ...
          <p>
            Here is a summary of the known issues in the public preview release
            (version 0.2):
          </p>
          ...
          <ul>
            ...
            <li>
              The "Refresh" menu items in the "Playlists", "Genres" and
              "Artists" submenus are not yet hooked up and have no effect.
            </li>
            <li>
              The "Recent Tracks" and "Upcoming Tracks" submenus in the Global
              Menu are not yet hooked up and are permanently ghosted.
            </li>
            <li>
              There are two blank menu items in the Global Menu which correspond
              to modules that will be released in the next previews. They are
              currently scheduled for public preview release 0.5 and 0.6.
              Information about the release schedule is
              <a href="https://wincent.dev/a/products/synergy-advance/road-map/"
                >available here</a
              >.
            </li>
            <li>
              If you issue a command such as "Play" to iTunes when it is not
              running nothing will happen. The behaviour of Synergy was the
              opposite (it would launch iTunes in this case and then start
            ...
            <li>
              There are some polish issues still to be resolved with the Instant
              Messaging preference pane. For example, if Synergy Advance sets a
              custom status message or user image it does not restore the
              previous status or image afterwards. This is most noticeable when
              you are using cover art as a user image and a song starts playing
              for which there is no cover art (iChat wil continue to use the
              same user image rather than resetting).
            </li>
            <li>
              Some of the items in the Synergy Advance AppleScript dictionary
              refer to features that are not present in the current release but
              will become available when the corresponding modules are added to
              one of the upcoming public preview releases.
            </li>
          </ul>
