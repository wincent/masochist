    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/knowledge-base/archives/2004/12/upgrading_to_su.php"
            >&laquo; Upgrading to Subversion 1.1.2</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/knowledge-base/archives/2005/04/information_for.php"
            >Information for beta testers &raquo;</a
          >
        </p>
        ...
        <p>
          <a href="http://subversion.tigris.org/">Subversion</a> 1.1.4 came out
          a few days ago so I decided to take the opportunity to upgrade my
          existing installation and also update my existing
          <a href="http://www.sleepycat.com/download/db/index.shtml"
            >BerkleyDB</a
          >
          install to the latest release (4.3.27). Unlike
          <a
            href="https://wincent.dev/a/knowledge-base/archives/2004/12/upgrading_to_su.php"
            >earlier versions</a
          >
          this Subversion release works fine with the BerkleyDB 4.3 series.
        </p>

        <p>
          As per usual, these instructions assume that you have the Xcode Tools
          installed and they use
          <a
            href="https://wincent.dev/a/knowledge-base/archives/2004/11/building_wget_f.php"
            >wget</a
          >
          to grab the source. If you don't have wget you could use curl, which
          is bundled with Mac OS X (type "man curl" in the terminal for more
          details). If you want to perform a new install of Subversion rather
          than just upgrade you should see the
          <a
            href="https://wincent.dev/a/knowledge-base/archives/2004/11/building_subver.php"
            >original article</a
          >
          in which I performed the installation.
        </p>

        <div id="a000053more">
          <div id="more">
            <p>
              Because I'm updating the backend (the database) I had to do a dump
              of my repository, perform the upgrade and then import the dumps
              into a new repository as described
              <a
                href="http://svnbook.red-bean.com/en/1.1/ch05s03.html#svn-ch-5-sect-3.5"
                >here</a
              >. For example, to dump my
              <a href="https://wincent.dev/">Synergy</a> repository I
...
svn --version</pre>
            ...
            <p>
              Now I was ready to recreate my old repositories and insert the
              contents back in:
            </p>
...
sudo /usr/local/apache2/bin/apachectl start</pre>
            ...
            <p>
              And that's all for, until next time... (looks like we can expect a
              <a href="http://subversion.tigris.org/svn_1.2_releasenotes.html"
                >1.2 release</a
              >
              soon).
            </p>
