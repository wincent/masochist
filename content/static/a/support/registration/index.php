    ...
    <div id="container">
      ...
      <div id="center">
        <div class="content">
          ...
          <p>
            As of version 6, <a href="/wiki/Synergy">Synergy</a> is free and can
            be downloaded from
            <a href="/products/synergy/download">the download page</a>.
          </p>
          <p>
            Version 6 requires <a href="/wiki/OS_X">OS X</a> 10.9
            <a href="/wiki/Mavericks">Mavericks</a> or later; if you want to use
            Synergy with an older version of OS X you can obtain a previous
            Synergy release from the download page and use the following
