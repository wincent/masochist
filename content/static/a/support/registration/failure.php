    ...
    <div id="container">
      ...
      <div id="center">
        <div class="content">
          ...
          <p>
            Your request has been processed, but no registration records were
            found matching the email address and product/license type that you
            specified.
          </p>

          <p>
            Before trying again, please
            <a href="index.php">read the instructions carefully</a> and only
            then proceed to the
            <a href="form.php">recovery system interface</a>. Take special care
            when entering the email address, as it must be 100% accurate.
          </p>
