    ...
    <div id="container">
      ...
      <div id="center">
        <div class="content">
          ...
          <p>
            Synergy comes with no warranty whatsoever, either expressed or
            implied. As the developer, I have done my best to ensure that it has
            no bugs, but I cannot offer any guarantees as to the fitness of the
            product for any purpose, nor can I be held liable for any damages or
            losses caused directly or indirectly by your use of the software.
          </p>

          <p>
            It is the responsibility of the user to verify that he/she only
            downloads and uses an unmodified copy of Synergy. The
            <a href="../download/">download page</a> lists the various sites
            from which Synergy can be downloaded, and also has instructions
            showing how to verify that copies downloaded from these various
            sites match the official Synergy distribution.
          </p>
        </div>
      </div>
      <div id="right">
