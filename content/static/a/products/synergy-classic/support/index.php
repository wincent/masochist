    ...
    <div id="container">
      ...
      <div id="center">
        <div class="content">
          ...
          <p>
            The following support resources are available to you 24 hours a day,
            365 days a year through this website.
          </p>

          <h4>Synergy Frequently Asked Questions</h4>

          <p>
            The <a href="../faq/">FAQ</a> contains the answers to the most
            common Synergy questions.
          </p>
          ...
          <p>
            ...
            <a href="https://wincent.dev/a/support/registration/"
              >license code retrieval system</a
            >
            allows you to enter the email address you used at the time of
            purchase and have your license code re-mailed to that address.
            Licenses are tied to the purchase address for security reasons, so
            it is important to correctly specify the address when purchasing,
            and to keep good backups in the event that you should change
            addresses. It is recommended that you burn a copy of your license
            notice to CD and also keep a printed copy.
          </p>

          <p class="more">
            Click
            <a href="https://wincent.dev/a/support/registration/">here</a> to
            retrieve your code
          </p>
          ...
          <p>
            The
            <a href="https://wincent.dev/a/support/"
              >wincent.dev support pages</a
            >
            group together all the support resources available to you from this
            website, as well as containing site-wide support information that
            applies not only to Synergy but to all other Wincent products and
            services.
          </p>

          <p class="more">
            Click <a href="https://wincent.dev/a/support/">here</a> to go to the
            support pages
          </p>
          ...
          <p>
            ...
            is a collection of useful tips, "how to" articles, and general
            information that covers a variety of topics that may be of interest
            to Mac users, developers, and IT.
          </p>

          <p class="more">
            Click <a href="https://wincent.dev/a/knowledge-base/">here</a> to
          ...
          <p>
            The <a href="https://wincent.dev/a/news/">news pages</a> contain the
            latest product and site news, and it's recommended that you check
            for updates before contacting me or opening a support ticket. For
            example, if there is a problem with the site or if I have limited
            access to the Net I will post an update to the news page so that you
            know what's happening.
          </p>

          <p class="more">
            Click <a href="https://wincent.dev/a/news/">here</a> to visit the
            news pages
          </p>
          ...
          <p>
            The
            <a href="https://wincent.dev/a/contact/">contact page</a> contains a
            list of useful solutions to common issues (like lost license codes,
            email address updates and so forth). If you wish to provide feedback
            you can use the contact page to get in touch with me. If you want
            personalized technical support, then you will need to open a support
            ticket (see below).
          </p>

          <p class="more">
            Click <a href="https://wincent.dev/a/contact/">here</a> to use the
            contact page
          </p>
          ...
          <p>
            If the existing online resources aren't sufficient to help you solve
            your problem, please
            <a href="https://wincent.dev/a/support/tickets/"
              >open a support ticket</a
            >. This is the fastest way to receive personalized attention,
            because it will not only send me an email but also store the details
            of your inquiry in a database so that I can track the issue more
            easily.
          </p>

          <p class="more">
            Click <a href="https://wincent.dev/a/support/tickets/">here</a> to
