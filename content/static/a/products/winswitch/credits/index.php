    ...
    <div id="container">
      ...
      <div id="center">
        <div class="content">
          ...
          <h4>Original FUSe codebase</h4>
          <ul>
            <li>
              <a href="http://www.codingmonkeys.de/map/">Martin Pittenauer</a>
              of <a href="http://www.codingmonkeys.de/">TheCodingMonkeys</a>
            </li>
          </ul>

          <h4>Localizations</h4>
          <ul>
            <li>Jesper Juul Keller (Danish)</li>
            <li>Joost Kroon (Dutch)</li>
            <li>Lauri Vanajas (Finnish)</li>
            <li>Fabrice Laurens (French)</li>
            <li>
              Charly Avital; Seth Dimbert, Doron Neuberger and Yehoshua Goldring
              of the Hyman Brand Hebrew Academy (Hebrew)
            </li>
            <li>Sjur N&oslash;rsteb&oslash; Moshagen (Norwegian)</li>
            <li>Jan Maas (German)</li>
            <li>Michele Zangrossi (Italian)</li>
            <li>Yuzuru Shiraiwa (Japanese)</li>
            <li>Wincent Colaiuta (Spanish)</li>
            <li>Christoffer Araskog (Swedish)</li>
