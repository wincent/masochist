...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/03/mediawiki.php"
      title="MediaWiki"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/03/woqueue.php"
      title="WOQueue"
    />
  </head>
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          I just checked the list of Xcode bugs that I've filed with Apply
          lately and I see that recently I've been averaging two new reports per
          day. All of them still marked as "Open"... Now just waiting for Apple
          to do the usual and mark them as "Duplicate", "Behaves correctly" or
          "Insufficient information"...
        </p>

        <div id="a000226more"><div id="more"></div></div>
