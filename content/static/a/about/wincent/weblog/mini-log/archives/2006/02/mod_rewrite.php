...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/02/wotest.php"
      title="WOTest"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/02/css_tweaks.php"
      title="CSS tweaks"
    />
  </head>
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          Just spent an hour banging my head up against
          <a href="http://httpd.apache.org/docs/2.0/mod/mod_rewrite.html"
            >mod_rewrite</a
          >
          (trying to get multiple rewrite rules defined at various levels of
          specificity &mdash; in overlapping <tt>VirtualHost</tt>,
          <tt>Directory</tt>, <tt>Location</tt> scopes &mdash; to play nicely
          with each other). I emerge from the battle victorious but with a
          headache. And hating mod_rewrite.
        </p>

        <div id="a000204more"><div id="more"></div></div>
