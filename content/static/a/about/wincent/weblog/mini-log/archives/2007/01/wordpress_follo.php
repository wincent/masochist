...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2007/01/yamoabdmgf.php"
      title="YAMOABDMGF"
    />
  </head>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2007/01/another_wordpre.php"
            >&laquo; Another WordPress upgrade (2.0.6)</a
          >
          |
        ...
        <p>
          Checking again today I saw that the
          <a href="http://wordpress.org/">WordPress</a> folks finally got around
          to tagging their 2.0.6 release, so I did
          <a
            href="https://wincent.dev/wiki/Upgrading_from_WordPress_2.0.5_to_2.0.6_using_Subversion"
            >the upgrade</a
          >.
        </p>

        <div id="a001120more"><div id="more"></div></div>
