...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2007/05/firebug.php"
      title="Firebug"
    />
  </head>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          ...
          <a href="https://wincent.dev/wiki/Rails">Rails</a> stuff
          lately (website improvements); as an example, he's an article I just
          posted to the
          <a href="https://wincent.dev/wiki/wiki">wiki</a> with the
          lessons learned from this morning: &quot;<a
            href="https://wincent.dev/wiki/Validating%20passwords%20with%20Ruby%20on%20Rails"
            >Validating passwords with Ruby on Rails</a
          >&quot;.
        </p>

        <div id="a002187more"><div id="more"></div></div>
