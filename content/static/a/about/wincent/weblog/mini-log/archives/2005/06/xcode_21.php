    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2005/06/upgrading_proje.php"
            >Upgrading project files to xcodeproj &raquo;</a
          >
        </p>
        ...
        <p>
          Xcode 2.1 looks like a ripper update with some great features. Can't
          wait to start using it...
        </p>

        <div id="a000090more"><div id="more"></div></div>
