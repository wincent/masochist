...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/08/a_new_feature_r.php"
      title="A new feature request for Xcode"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/08/cocacola_zero.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/08/a_new_feature_r.php"
            >&laquo; A new feature request for Xcode</a
          >
          |
        ...
        <p>
          I'm not longer using <tt>LC_ALL</tt> to have stuff in Spanish
          (<tt>es_ES.UTF-8</tt>) because it can cause garbled characters to
          appear in my source code when I do automated build date updating (for
          example, <em>sábado</em>, the Spanish name for "Saturday" includes a
          non-ASCII character). So now I'm setting <tt>LANG</tt> to Spanish and
          <tt>LC_TIME</tt> to <tt>en_US.UTF-8</tt>; this should give me Spanish
          everything, except for dates.
        </p>

        <div id="a000372more"><div id="more"></div></div>
