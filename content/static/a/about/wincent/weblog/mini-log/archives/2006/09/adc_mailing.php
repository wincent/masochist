...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/09/pet_safari_hate.php"
      title="Pet Safari hate"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/09/synergy_30_is_n.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/09/synergy_30_is_n.php"
            >Synergy 3.0 is now out &raquo;</a
          >
        </p>
        ...
        <p>
          Just got the latest Apple Developer Connection mailing (September
          2006) and am a little disappointed to see that there's no Leopard
          preview disc in it. Seems like Apple still only wants those who
          attended WWDC to have it. I unfortunately couldn't go (no cash, no
          visa). Ironic that it is far easier for pirates to obtain the software
          than it is for ADC Select members (cost US$500 per year).
        </p>

        <div id="a000400more"><div id="more"></div></div>
