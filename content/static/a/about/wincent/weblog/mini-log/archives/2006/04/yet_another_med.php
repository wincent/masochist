...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/04/mediawiki_162.php"
      title="MediaWiki 1.6.2"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/04/die_kludge.php"
      title="Die kludge"
    />
  </head>
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          So many <a href="http://mediawiki.org/">MediaWiki</a> updates in such
          little time. Now up to 1.6.3. Thank goodness that
          <a href="http://www.mediawiki.org/wiki/Download_from_SVN"
            >it can be done in about 60 seconds</a
          >
          using <a href="http://subversion.tigris.org/">Subversion</a>.
        </p>

        <div id="a000298more"><div id="more"></div></div>
