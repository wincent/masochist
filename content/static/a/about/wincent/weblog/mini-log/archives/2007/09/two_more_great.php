...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2007/09/functional_prog_1.php"
      title="Functional Programming For The Rest of Us"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2007/09/applied.php"
      title="Applied"
    />
  </head>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2007/09/functional_prog_1.php"
            >&laquo; Functional Programming For The Rest of Us</a
          >
          |
        ...
        <p>
          <a
            title="defmacro - Writing A Lisp Interpreter In Haskell"
            href="http://www.defmacro.org/ramblings/lisp-in-haskell.html#real-world"
            >Writing A Lisp Interpreter In Haskell</a
          >
          and
          <a
            title="defmacro - On Haskell, Intuition And Expressive Power"
            href="http://www.defmacro.org/ramblings/haskell-productivity.html"
            >On Haskell, Intuition And Expressive Power</a
          >.
        </p>

        <div id="a002698more"><div id="more"></div></div>
