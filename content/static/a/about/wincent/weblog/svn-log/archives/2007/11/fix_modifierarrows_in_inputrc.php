...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix (modifier)+arrows in inputrc (snippets, 858e42e)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/update_for_xcode_30_snippets_3.php"
      title="Update for Xcode 3.0 (snippets, 3d7963c)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/unwrap_for_readability_synergy.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/update_for_xcode_30_snippets_3.php"
            >&laquo; Update for Xcode 3.0 (snippets, 3d7963c)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/unwrap_for_readability_synergy.php"
            >Unwrap for readability (Synergy, f4713ab) &raquo;</a
          >
        </p>
        ...
        <p>
          This is really a two-step process; first, you need to have
          Control-Left and Control-Right correctly configured in your inputrc
          file (this patch corrects a couple of mistakes there), and secondly,
          you need to configure the Terminal preferences to send the exact same
          key sequences when pressing Control-Left and Control-Right, otherwise
          readline/bash will never see them (this commit also makes a note to
          that effect).
        </p>

        <p>
          The apparently useless Option-Left/Option-Right bindings are now
          commented out. It seems that they don't work unless you do
          configuration in the Terminal preferences, but once you've done that
          you no longer need the bindings anyway.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003155more"><div id="more"></div></div>
