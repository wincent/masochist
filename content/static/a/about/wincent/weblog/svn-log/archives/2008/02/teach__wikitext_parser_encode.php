...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Teach _Wikitext_parser_encode_link_target to take a
      parser parameter (wikitext, 605aba1)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/remove_unnecessary_regular_exp.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/remove_unnecessary_regular_exp.php"
            >&laquo; Remove unnecessary regular expression machines from Ragel
            machine (wikitext, 3de5048)</a
          >
          |
        ...
        <h3>
          Teach _Wikitext_parser_encode_link_target to take a parser parameter
          (wikitext, 605aba1)
        </h3>

        <p>
          Instead of passing a string object, pass a pointer to a parser struct
          instead. This is groundwork for teaching
          _Wikitext_parser_encode_link_target how to handle links when
          &quot;treat slash as special&quot; is in effect.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004026more"><div id="more"></div></div>
