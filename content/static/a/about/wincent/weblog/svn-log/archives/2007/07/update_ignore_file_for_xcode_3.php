...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update ignore file for Xcode 3 mode files (WOTest,
      732472c)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/ignore_temporary_files_wotest.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/ignore_userspecific_files_in_x.php"
            >&laquo; Ignore user-specific files in Xcode project bundle (WOTest,
            a50333e)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/ignore_temporary_files_wotest.php"
            >Ignore temporary files (WOTest, 723791d) &raquo;</a
          >
        </p>
        ...
        <p>
          Xcode 3 mode files have a new extension (mode1v3), so update the
          ignore file accordingly.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002521more"><div id="more"></div></div>
