...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Add tag search (wincent.dev, 80753b1)</title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/group_tag_results_according_to.php"
      title="Group tag results according to taggable type (wincent.dev, 7513d98)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_tag_search_box_to_navigati.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/group_tag_results_according_to.php"
            >&laquo; Group tag results according to taggable type (wincent.dev,
            7513d98)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_tag_search_box_to_navigati.php"
            >Add tag search box to navigation bar (wincent.dev, 94ad75f)
            &raquo;</a
          >
        </p>
        ...
        <h3>Add tag search (wincent.dev, 80753b1)</h3>

        <p>
          We offer two kinds of search. The first one isn't really
          &quot;search&quot; at all; basically, if the user navigates to
          &quot;/tags/foo&quot; then we show a list of everything (if anything)
          that's been tagged with &quot;foo&quot;.
        </p>

        <p>
          In the second mode we do a real search using a query string. For
          example, &quot;/tags/search?q=foo&quot; will display all items tagged
          with &quot;foo&quot;; &quot;/tags/search?q=foo+bar&quot; will display
          all items tagged with &quot;foo&quot; and with &quot;bar&quot; (merely
          being tagged with one of them is not enough). If the user searches for
          three tags, &quot;foo bar baz&quot;, and there &quot;baz&quot; is not
          a known tag name then we show the results for &quot;foo&quot; and
          &quot;bar&quot;, and display a flash advising that &quot;baz&quot;
          doesn't exist and was excluded from the results.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004146more"><div id="more"></div></div>
