...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Handle pre-existing icon files (Wincent Icon Utility,
      6b08d35)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/edit_error_messages_for_redund.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/edit_error_messages_for_redund.php"
            >&laquo; Edit error messages for redundancy (Wincent Icon Utility,
            4457f16)</a
          >
          |
        ...
        <p>
          This is an initial attempt at handling pre-existing icon files (easy
          enough to encounter when doing repeated builds). If an existing file
          is already present we try to open it, remove any existing icon
          resources, and then proceed to the normal codepath (adding the new
          icon resource).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002552more"><div id="more"></div></div>
