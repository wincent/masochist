...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Trim robots.txt (wincent.dev, 63cdd2e)</title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_sample_database_configurat.php"
            >&laquo; Add sample database configuration file (wincent.dev,
            aedc881)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/add_confirmation_of_emails_win.php"
            >Add confirmation of emails (wincent.dev, 78a395a) &raquo;</a
          >
        </p>

        <h2>March 4, 2008</h2>

        <h3>Trim robots.txt (wincent.dev, 63cdd2e)</h3>

        <p>
          Keeping the default robots.txt file is a form of information leak
          (&quot;this is a Rails application!&quot;).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004209more"><div id="more"></div></div>
