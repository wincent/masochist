...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Refactor for deployment using RubyGems (wikitext,
      80ae725)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_a_simple_rakefile_wikitext.php"
      title="Add a simple Rakefile (wikitext, 02d11e9)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/additional_dependency_info_for.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_a_simple_rakefile_wikitext.php"
            >&laquo; Add a simple Rakefile (wikitext, 02d11e9)</a
          >
          |
        ...
        <p>
          On thinking about the need for this to run on multiple platforms I
          decided that it wasn't really suited to being used as a Rails plug-in:
        </p>

        <p>
          - Rails plugins are usually deployed by simply unpacking them into the
          &quot;vendor/plugins&quot; directory; given that this is actually a C
          extension this means that a second step is required (compilation)
        </p>

        <p>
          - I looked at cross-compiling here locally before deploying the plugin
          but that seems awfully brittle with plenty of scope for breakage when
          one of the target systems is upgraded
        </p>
        ...
        <p>
          So even though I would prefer to have all of the dependencies of my
          Rails applications frozen into the &quot;vendor&quot; directory, it
          seems that deployment as a RubyGem is the most robust solution. I can
          still tie my application to a particular version of the gem by doing
          something like:
        </p>
        ...
        <p>
          So this commit refactors the working tree to match the typical
          RubyGems pattern (ext, spec subdirectories). At the same time while
          preparing the gem specification I realized that the inconsistencies in
          the naming conventions were too ugly to bear, and so as part of the
          move I renamed many of the files and symbols (capitalization changes
          and omitting underscores).
        </p>

        <p>
          As all of these changes have to be made in a single batch to keep the
          specs passing I am not splitting this up into a series of smaller
          commits.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003028more"><div id="more"></div></div>
