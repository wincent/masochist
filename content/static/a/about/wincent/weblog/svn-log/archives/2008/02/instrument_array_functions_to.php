...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Instrument array functions to pick optimal buffer size
      (wikitext, 2199333)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/more_array_wrapper_instrumenta.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/tweak_rakefile_rebuild_wheneve.php"
            >&laquo; Tweak Rakefile: rebuild whenever ary.h changes (wikitext,
            e942be5)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/more_array_wrapper_instrumenta.php"
            >More array wrapper instrumentation: delete calls (wikitext,
            ea8fc88) &raquo;</a
          >
        </p>
        ...
        <h3>
          Instrument array functions to pick optimal buffer size (wikitext,
          2199333)
        </h3>

        <p>
          Add basic instrumentation to the array wrapper functions to see how
          big they grow in typical use. Running the entire spec suite the
          lengthiest array seen had 26 entries, so we'll use this information in
          setting a default size in our custom array implementation.
        </p>
