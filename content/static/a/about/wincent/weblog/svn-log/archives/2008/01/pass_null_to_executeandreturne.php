...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Pass NULL to executeAndReturnError: (Synergy, 994da25)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/really_add_doublehyphen_form_w.php"
      title="Really add double-hyphen form (Wincent Strings Utility, a318aff)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/update_copyright_years_wopubli.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/really_add_doublehyphen_form_w.php"
            >&laquo; Really add double-hyphen form (Wincent Strings Utility,
            a318aff)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/update_copyright_years_wopubli.php"
            >Update copyright years (WOPublic, 5813a39) &raquo;</a
          >
        </p>
        ...
        <p>
          ...
          that could explain the crash. The NSAppleScript instance is set up
          using a static NSString literal which by definition can never be
          garbage collected. I am beginning to fear that NSAppleScript can't be
          used at all in a garbage collected environment.
        </p>

        <p>
          As a defensive tactic I'm updating all invocations of the method to
          pass NULL for the error dictionary. This usage is not documented, but
          it does follow a pattern employed by many other Apple APIs and there
          are plenty of examples of code out there in the wild that do use this
          pattern.
        </p>

        <p>
          So basically this is a &quot;try it and see&quot; change to see if it
          eliminates the sporadic crashes. If it doesn't then more drastic
          measures will be required, most likely involving the replacement of
