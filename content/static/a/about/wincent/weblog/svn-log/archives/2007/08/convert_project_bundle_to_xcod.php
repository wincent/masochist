...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Convert project bundle to Xcode 3.0 format (Synergy
      Advance, 62b0784)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/update_tests_to_use_new_founda.php"
            >&laquo; Update tests to use new Foundation API (WOCommon,
            09eae47)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/cleanup_build_settings_synergy.php"
            >Clean-up build settings (Synergy Advance, 8c0d371) &raquo;</a
          >
        </p>
