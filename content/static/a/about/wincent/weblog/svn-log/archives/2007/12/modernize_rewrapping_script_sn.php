...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Modernize re-wrapping script (snippets, 5c90dea)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/import_unwrapping_script_from.php"
      title="Import unwrapping script from Subversion repo (snippets, 4a74ad8)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/import_nightlies_script_from_s.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/import_unwrapping_script_from.php"
            >&laquo; Import unwrapping script from Subversion repo (snippets,
            4a74ad8)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/import_nightlies_script_from_s.php"
            >Import nightlies script from Subversion repository (snippets,
            1eda727) &raquo;</a
          >
        </p>
        ...
        <p>
          Although the original version of the script worked it was probably one
          of the first Ruby scripts I'd ever written, if not the first one. This
          is a re-write with a little more experience and (more standard Ruby
          idioms and some refactoring for ease of comprehension).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003382more"><div id="more"></div></div>
