...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Command refactoring for better error detection
      (snippets, 098ddbc)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/ignore_ref_name_snippets_22e4a.php"
            >&laquo; Ignore ref_name (snippets, 22e4a24)</a
          >
          |
        ...
        <p>
          Refactor most invocations of the git tool into separate methods to
          allow<br />
          better error checking. Now non-zero exit codes will cause an exception
          to be<br />
