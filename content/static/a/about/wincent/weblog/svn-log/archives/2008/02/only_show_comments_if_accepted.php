...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Only show comments if accepted now or in the past
      (wincent.dev, 5e48659)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/make_sure_admin_sees_all_comme.php"
            >&laquo; Make sure admin sees all comments in posts &quot;show&quot;
            template (wincent.dev, 00d93e7)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/renumber_migrations_to_fill_in.php"
            >Renumber migrations to fill in gap (wincent.dev, bfa4476)
            &raquo;</a
          >
        </p>
        ...
        <h3>
          Only show comments if accepted now or in the past (wincent.dev,
          5e48659)
        </h3>

        <p>
          There are actually three states we need to distinguish among here:
          posts where comments are accepted, posts where comments are not
          accepted but have been in the past, and posts where comments are not
          accepted now and never have been.
        </p>

        <p>
          In the first two cases we'll show comment-related stuff in the views,
          but in the last case we won't show anything at all.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004126more"><div id="more"></div></div>
