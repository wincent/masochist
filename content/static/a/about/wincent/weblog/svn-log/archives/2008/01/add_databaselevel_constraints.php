...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add database-level constraints for uniqueness
      (wincent.dev, 163821f)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/flesh_out_locales_controller_w.php"
            >&laquo; Flesh out locales controller (wincent.dev, 9bd9613)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/inplace_editing_for_translatio.php"
            >In-place editing for translations (wincent.dev, 022faf3) &raquo;</a
          >
        </p>
        ...
        <p>
          Seeing as validates_uniqueness_of is vulnerable to race conditions, it
          is really only a bit of UI-level polish; at the level of database
          integrity we have to rely on real constraints.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003801more"><div id="more"></div></div>
