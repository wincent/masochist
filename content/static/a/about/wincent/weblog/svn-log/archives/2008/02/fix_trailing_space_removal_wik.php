...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix trailing space removal (wikitext, 13e622d)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/teach_link_encoding_function_t.php"
      title="Teach link encoding function to convert spaces to underscores (wikitext, b435829)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_specs_for_space_to_undersc.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/teach_link_encoding_function_t.php"
            >&laquo; Teach link encoding function to convert spaces to
            underscores (wikitext, b435829)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_specs_for_space_to_undersc.php"
            >Add specs for &quot;space_to_underscore&quot; mode (wikitext,
            b3d136f) &raquo;</a
          >
        </p>
        ...
        <p>
          This was an off-by-one error that was harmless under normal operation
          because both code paths ended up returning the same length.
        </p>

        <p>
          But when running under &quot;space_to_underscore&quot; mode it was
          enough to actually prevent the trailing space removal from working in
          the case where there was only one trailing space.
        </p>

        <p>
          It worked when &quot;space_to_underscore&quot; was false only because
          each space was actually three characters (%20) so the test passed
          anyway.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004113more"><div id="more"></div></div>
