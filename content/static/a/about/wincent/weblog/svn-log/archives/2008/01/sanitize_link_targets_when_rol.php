...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Sanitize link targets when rolling back failed internal
      links (wikitext, 8da0a08)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/raise_range_errors_for_invalid.php"
      title="Raise range errors for invalid link text (wikitext, b5ad8d6)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_typo_in_unordered_list_spe.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/raise_range_errors_for_invalid.php"
            >&laquo; Raise range errors for invalid link text (wikitext,
            b5ad8d6)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_typo_in_unordered_list_spe.php"
            >Fix typo in unordered list specs (wikitext, 2e7ed73) &raquo;</a
          >
        </p>
        ...
        <h3>
          Sanitize link targets when rolling back failed internal links
          (wikitext, 8da0a08)
        </h3>

        <p>
          We have to do this because the parser is actually just a simple
          stream-based transformer. It doesn't (and can't) have any lookahead so
          it acts upon tokens as soon as they are received.
        </p>

        <p>
          This in turn means that we accept things like QUOT tokens while
          scanning the internal link target. If we later hit a syntax error
          before the link is finished then we can't backtrack and instead have
          to rollback (or re-apply) the stuff we've scanned so far. This in turn
          means sanitizing things like those QUOT tokens (turning them into
          named entities) and and other non-printables.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003833more"><div id="more"></div></div>
