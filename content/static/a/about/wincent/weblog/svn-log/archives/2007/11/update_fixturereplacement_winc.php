...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update FixtureReplacement (wincent.dev, 563b8ab)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/remove_files_from_previous_rsp.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/remove_files_from_previous_rsp.php"
            >&laquo; Remove files from previous RSpec version (wincent.dev,
            71d1c5b)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/add_fixturereplacement_upgrade.php"
            >Add FixtureReplacement upgrade notes (wincent.dev, 6ead2fc)
            &raquo;</a
          >
        </p>
        ...
        <h3>Update FixtureReplacement (wincent.dev, 563b8ab)</h3>

        <p>
          Also bump FixtureReplacement up to the current tip of the trunk
          (revision 83) at the same time as the Rails 2.0 RC 1 and RSpec
          upgrades.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003151more"><div id="more"></div></div>
