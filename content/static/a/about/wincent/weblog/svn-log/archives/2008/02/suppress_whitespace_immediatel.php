...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Suppress whitespace immediately after the separator in
      internal links (wikitext, 968db92)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/minor_update_to_readme_testing.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/minor_update_to_readme_testing.php"
            >&laquo; Minor update to README (testing) (wikitext, d8dfb10)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/trim_trailing_whitespace_from.php"
            >Trim trailing whitespace from internal link text (wikitext,
            fdf390a) &raquo;</a
          >
        </p>
        ...
        <h3>
          Suppress whitespace immediately after the separator in internal links
          (wikitext, 968db92)
        </h3>

        <p>
          If we've seen the internal link start marker, the link target, and the
          separator, we know we're guaranteed to have a valid link (even if the
          user doesnt close it we will auto-close it). In this case it is safe
          to suppress the emission of whitespace rather than letting it through
          and sanitizing afterwards (like we have to do with spaces that come
          before the separator).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003931more"><div id="more"></div></div>
