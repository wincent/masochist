...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Switch to shared configuration from buildtools (Wincent
      Icon Utility, 1b3c196)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/prepare_ignores_for_xcode_proj.php"
      title="Prepare ignores for Xcode project bundle (Wincent Icon Utility, fc0fe2c)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/include_filefolder_name_in_err.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/prepare_ignores_for_xcode_proj.php"
            >&laquo; Prepare ignores for Xcode project bundle (Wincent Icon
            Utility, fc0fe2c)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/include_filefolder_name_in_err.php"
            >Include file/folder name in error messages (Wincent Icon Utility,
            6b89434) &raquo;</a
          >
        </p>
        ...
        <h3>
          Switch to shared configuration from buildtools (Wincent Icon Utility,
          1b3c196)
        </h3>

        <p>
          Switch to the shared configuration from the Wincent Build Tools, thus
          allowing the removal of the sample prefix header file provided by
          Xcode. Minor changes to code to silence warnings produced as a result
          of the new configuration.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002544more"><div id="more"></div></div>
