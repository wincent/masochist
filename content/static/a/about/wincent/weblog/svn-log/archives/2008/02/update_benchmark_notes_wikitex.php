    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_custom_string_struct_imple.php"
            >&laquo; Add custom string struct implementation (wikitext,
            4f06bdd)</a
          >
          |
        ...
        <p>
          Since I last added benchmark information to the notes a few features
          have been added which slow down processing, so we need a new baseline
          before I begin the next round of optimizations.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004006more"><div id="more"></div></div>
