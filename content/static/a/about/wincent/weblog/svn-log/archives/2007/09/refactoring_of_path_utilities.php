...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Refactoring of path utilities for readability (gdiff,
      cadc4d8)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/fix_syntax_error_in_tool_gdiff.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/factor_out_path_for_tool_funct.php"
            >&laquo; Factor out path_for_tool function (gdiff, 86bf53c)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/fix_syntax_error_in_tool_gdiff.php"
            >Fix syntax error in tool (gdiff, a98814a) &raquo;</a
          >
        </p>
        ...
        <p>
          For better readability, break out two chunks of the path_for_tool
          function and place them in dedicated functions of their own:
          get_search_path_from_environment and get_search_path_from_sysctl. This
          makes the program flow a little more readable and also enables some
          neater handling of resource cleanup, seeing as now only one of the
          function explicitly mallocs memory.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002953more"><div id="more"></div></div>
