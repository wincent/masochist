...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add specs for case insensitive tokenization of TT tokens
      (wikitext, 93ceb30)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/update_links_in_documentation.php"
            >&laquo; Update links in documentation (wikitext, 9e6ee97)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/tokenize_em_and_strong_html_ta.php"
            >Tokenize em and strong HTML tags (wikitext, 2baf13a) &raquo;</a
          >
        </p>
        ...
        <h3>
          Add specs for case insensitive tokenization of TT tokens (wikitext,
          93ceb30)
        </h3>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003911more"><div id="more"></div></div>
