...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Complete GC conversion of NSArrayController drag
      category (WOCommon, cc93f2a)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/gc_conversion_for_nsarray_crea.php"
      title="GC conversion for NSArray creation category (WOCommon, 9f2709e)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/gc_changes_to_nsattributedstri.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/gc_conversion_for_nsarray_crea.php"
            >&laquo; GC conversion for NSArray creation category (WOCommon,
            9f2709e)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/gc_changes_to_nsattributedstri.php"
            >GC changes to NSAttributedString creation category (WOCommon,
            84bcfe4) &raquo;</a
          >
        </p>
        ...
        <h3>
          Complete GC conversion of NSArrayController drag category (WOCommon,
          cc93f2a)
        </h3>

        <p>
          Commit 235882a was only an incomplete conversion of the
          NSArrayController drag category to GC; this commit removes the
          remaining release message which should have been taken out the first
          time.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003236more"><div id="more"></div></div>
