...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add custom db rake tasks (wincent.dev, 62dd8af)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/speedup_fixturereplacement_win.php"
            >&laquo; Speed-up FixtureReplacement (wincent.dev, 6c036a7)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/prepare_spec_helper_wincentcom.php"
            >Prepare spec helper (wincent.dev, edf298e) &raquo;</a
          >
        </p>

        <h2>October 14, 2007</h2>

        <h3>Add custom db rake tasks (wincent.dev, 62dd8af)</h3>

        <p>
          Convenience tasks for migrating and resetting the databases under each
