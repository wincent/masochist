    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/02/walrus_r100_2_items_changed.php"
            >&laquo; Walrus r100, 2 items changed</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/03/walrus_r102_8_items_changed.php"
            >Walrus r102, 8 items changed &raquo;</a
          >
        </p>
        ...
        <p>
          Clean up specs (some cases of 'should_not_equal' which should have
          been 'should_not ==')
        </p>

        <div id="a001258more"><div id="more"></div></div>
