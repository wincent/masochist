...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Roll tool into Xcode project (gdiff, cc8b116)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/refactor_rename_mydocument_to.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/split_ragel_generation_into_tw.php"
            >&laquo; Split Ragel generation into two phases (gdiff, 3e94d7d)</a
          >
          |
        ...
        <p>
          Rather than having a tool subdirectory and a gui subdirectory the
          top-level directory now corresponds to a single Xcode project which
          contains two targets, one for the GUI and one for the command-line
          tool.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002948more"><div id="more"></div></div>
