...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Set up a tokenizing benchmark for ANTLR lexer (wikitext,
      bdc7a11)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_tokenization_benchmarks_fo.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/move_encoding_benchmarks_into.php"
            >&laquo; Move encoding benchmarks into separate subdirectory
            (wikitext, 4aaffb1)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_tokenization_benchmarks_fo.php"
            >Add tokenization benchmarks for ANTLR-backed scanner (wikitext,
            fcfc13c) &raquo;</a
          >
        </p>
        ...
        <p>
          This function doesn't actually do anything with the tokens, it just
          asks the lexer for tokens as fast as it can dish them out.
        </p>

        <p>
          The intention is to measure the raw speed of the tokenization part
          only (ie. the part due to ANTLR only).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003872more"><div id="more"></div></div>
