...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Split MainMenu.xib into two (REnamer, c4536d6)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/update_xcode_project_bundle_fo_3.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/make_worenamercontroller_an_ns.php"
            >&laquo; Make WOREnamerController an NSWindowController subclass
            (REnamer, c598bef)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/update_xcode_project_bundle_fo_3.php"
            >Update Xcode project bundle for multi-window refactoring (REnamer,
            4b88522) &raquo;</a
          >
        </p>
        ...
        <p>
          Separate out the functionality that was in the MainMenu.xib into two
          segments: app-wide stuff (like the preference window) and per-window
          stuff (like the preview pane, the Find/Replace window etc).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003713more"><div id="more"></div></div>
