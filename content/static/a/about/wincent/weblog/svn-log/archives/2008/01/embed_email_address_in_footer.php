...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Embed email address in footer (wincent.dev, ac2ca7c)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/initial_version_of_design_prot.php"
      title="Initial version of design prototype (wincent.dev, 403b233)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/big_reworking_of_authenticatio.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/initial_version_of_design_prot.php"
            >&laquo; Initial version of design prototype (wincent.dev,
            403b233)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/big_reworking_of_authenticatio.php"
            >Big reworking of authentication machinery (wincent.dev, d9afad4)
            &raquo;</a
          >
        </p>
        ...
        <h3>Embed email address in footer (wincent.dev, ac2ca7c)</h3>

        <p>
          Include clickable email address in footer. The spammers already have
          my address so there is no point in trying to hide it; better to make
          it as easy as possible for my customers to contact me.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003778more"><div id="more"></div></div>
