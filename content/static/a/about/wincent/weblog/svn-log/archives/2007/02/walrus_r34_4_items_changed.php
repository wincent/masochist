    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/02/walrus_r33_1_item_changed.php"
            >&laquo; Walrus r33, 1 item changed</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/02/walrus_r35_1_item_changed.php"
            >Walrus r35, 1 item changed &raquo;</a
          >
        </p>
        ...
        <p>
          Track position within input stream (to provide memoizer with
          coordinates)
        </p>

        <div id="a001182more"><div id="more"></div></div>
