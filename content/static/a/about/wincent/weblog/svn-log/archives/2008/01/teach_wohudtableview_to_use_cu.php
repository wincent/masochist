...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Teach WOHUDTableView to use custom corner view (REnamer,
      d1e387b)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_wohudtablecornerview_class.php"
            >&laquo; Add WOHUDTableCornerView class (REnamer, c1e39a4)</a
          >
          |
        ...
        <p>
          Use the new corner view class created in c1e39a4, thus eliminating the
          last non-HUD element from the preview window.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003667more"><div id="more"></div></div>
