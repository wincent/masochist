...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Be encoding-agnostic with respect to paths (gdiff,
      cb1f777)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/capture_blob_ids_gdiff_74a672c.php"
      title="Capture blob ids (gdiff, 74a672c)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/replace_atoi_with_explicit_con.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/capture_blob_ids_gdiff_74a672c.php"
            >&laquo; Capture blob ids (gdiff, 74a672c)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/replace_atoi_with_explicit_con.php"
            >Replace atoi() with explicit conversion (gdiff, 5e549a8) &raquo;</a
          >
        </p>
        ...
        <p>
          While thinking about how to handle possible different,
          platform-dependent text encodings in path names I realized that the
          best thing to do would be to be encoding-agnostic and do what Git
          goes: display the raw bytes of the path using escape sequences for
          non-ASCII and non-printable characters.
        </p>

        <p>
          gdiff doesn't actually need the paths in order to show the file
          contents (it will ask Git for the blobs based on their hash
          identifiers) so the paths are for display purposes only. For display
          the non-ambiguous format using escape markers is actually much better.
