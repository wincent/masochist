...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add WOMakeCollectable function (WOPublic, 1035d53)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/new_version_of_logintool_syner.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/new_version_of_logintool_syner.php"
            >&laquo; New version of login-tool (Synergy, a73dbe7)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/use_womakecollectable_function.php"
            >Use WOMakeCollectable function where appropriate (WOCommon,
            6eb9559) &raquo;</a
          >
        </p>
        ...
        <p>
          It's not safe to pass NULL values to CFMakeCollectable, so this
          wrapper function performs a check before doing so. It can be used in
          places where an explicit check would only add clutter.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003263more"><div id="more"></div></div>
