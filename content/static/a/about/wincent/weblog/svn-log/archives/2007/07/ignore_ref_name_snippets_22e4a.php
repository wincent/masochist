...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/stricter_check_for_creation_ev.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/stricter_check_for_creation_ev.php"
            >&laquo; Stricter check for creation events (snippets, f2fe528)</a
          >
          |
        ...
        <p>
          Ignore ref_name for now seeing as it is not used for any real purpose.
          If I<br />
          later decide to take specific actions depending on the reference name
          (for<br />
          example, distinguishing between unannotated tags, annotated tags,
          branch<br />
          commits and tracking branch events, as demonstrated in the
          post-receive-email<br />
          hook that comes with Git) I can always do something with the ref_name.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;<br /></p>

        <div id="a002414more"><div id="more"></div></div>
