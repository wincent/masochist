...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Perform manual lookahead for H1_END and friends
      (wikitext, c461466)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/many_more_token_matches_wikite.php"
      title="Many more token matches (wikitext, af622ee)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_uri_matching_rule_wikitext.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/many_more_token_matches_wikite.php"
            >&laquo; Many more token matches (wikitext, af622ee)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_uri_matching_rule_wikitext.php"
            >Add URI matching rule (wikitext, e956ebb) &raquo;</a
          >
        </p>
        ...
        <p>
          Ragel is much closer to the metal than ANTLR; in order to check if
          we've found the last token before a newline or the end-of-file we have
          to do manually lookahead using pointers.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003865more"><div id="more"></div></div>
