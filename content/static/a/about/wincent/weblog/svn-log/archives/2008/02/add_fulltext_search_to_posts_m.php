...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add full-text search to Posts model (wincent.dev,
      8e8cbcf)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/extract_common_tag_results_cod.php"
            >&laquo; Extract common tag results code into a partial
            (wincent.dev, b470ec6)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_preprocessing_of_wikitext.php"
            >Add preprocessing of wikitext (wincent.dev, 8d444fd) &raquo;</a
          >
        </p>

        <h2>February 19, 2008</h2>

        <h3>Add full-text search to Posts model (wincent.dev, 8e8cbcf)</h3>

        <p>
          This commit includes tweaks to get my acts_as_searchable model
          working.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004199more"><div id="more"></div></div>
