...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove UTF-8 BOM marker from test input files (REnamer,
      fe1dbad)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/update_test_inputs_renamer_779.php"
            >&laquo; Update test inputs (REnamer, 779de20)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/create_symlink_to_latest_versi.php"
            >Create symlink to latest version of pcre.h header (REnamer,
            3fdee73) &raquo;</a
          >
        </p>
        ...
        <p>
          Shouldn't be necessary, and Xcode doesn't like it (tries to display it
          in the editor windows).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003548more"><div id="more"></div></div>
