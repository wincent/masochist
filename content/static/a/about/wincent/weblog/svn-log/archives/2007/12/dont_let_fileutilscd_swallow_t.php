...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Don't let FileUtils.cd swallow the return value
      (snippets, 5652285)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/use_abbreviated_sha1_hashes_in.php"
      title="Use abbreviated SHA-1 hashes in nightlies (snippets, 3d6f550)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/remove_deprecated_method_call.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/use_abbreviated_sha1_hashes_in.php"
            >&laquo; Use abbreviated SHA-1 hashes in nightlies (snippets,
            3d6f550)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/remove_deprecated_method_call.php"
            >Remove deprecated method call in NSScanner lexing utilities
            (WOCommon, 18702b0) &raquo;</a
          >
        </p>
        ...
        <p>
          Explicitly return the value from the block (the block itself) will
          evaluate to nil.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003453more"><div id="more"></div></div>
