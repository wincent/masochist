...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Teach sanitizer to trim trailing whitespace (wikitext,
      1207027)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/eat_trailing_space_while_encod.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/eat_trailing_space_while_encod.php"
            >&laquo; Eat trailing space while encoding link targets (wikitext,
            a77ecb5)</a
          >
          |
        ...
        <p>
          The only problem here is when we rollback a failed link we might end
          up trimming space from it; will look into a fix for that.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003925more"><div id="more"></div></div>
