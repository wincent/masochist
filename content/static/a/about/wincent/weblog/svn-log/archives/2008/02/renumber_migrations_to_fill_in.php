...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Renumber migrations to fill in gap (wincent.dev,
      bfa4476)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_public_field_to_comments_m.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/only_show_comments_if_accepted.php"
            >&laquo; Only show comments if accepted now or in the past
            (wincent.dev, 5e48659)</a
          >
          |
        ...
        <h3>Renumber migrations to fill in gap (wincent.dev, bfa4476)</h3>

        <p>
          This fills in the gap left by the removal of the &quot;create
          revisions&quot; migration.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004127more"><div id="more"></div></div>
