...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix off-by-one error in corner view (REnamer, 12253da)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/only_draw_border_if_visible_in.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/only_draw_border_if_visible_in.php"
            >&laquo; Only draw border if visible in header cell (REnamer,
            9e5b34a)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/factor_out_color_macros_into_w.php"
            >Factor out color macros into WOHUD.h (REnamer, cd6174e) &raquo;</a
          >
        </p>
        ...
        <p>
          In the flipped coordinate system case, the border would be drawn one
          pixel too low.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003671more"><div id="more"></div></div>
