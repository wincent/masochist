...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix spec breakage caused by removal of Revisions model
      (wincent.dev, 1f9a20f)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/move_login_as_method_into_spec.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/move_login_as_method_into_spec.php"
            >&laquo; Move login_as method into spec helper (wincent.dev,
            8e136a7)</a
          >
          |
        ...
        <h3>
          Fix spec breakage caused by removal of Revisions model (wincent.dev,
          1f9a20f)
        </h3>

        <p>
          These were some lingering files which should have been removed at the
