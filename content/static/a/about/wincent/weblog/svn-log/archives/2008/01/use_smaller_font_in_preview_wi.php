...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Use smaller font in preview window cells (REnamer,
      4f40d3d)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/more_color_tweaks_for_the_hud.php"
      title="More color tweaks for the HUD (REnamer, 6fddabd)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/dim_text_in_location_column_re.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/more_color_tweaks_for_the_hud.php"
            >&laquo; More color tweaks for the HUD (REnamer, 6fddabd)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/dim_text_in_location_column_re.php"
            >Dim text in location column (REnamer, 02d4ca8) &raquo;</a
          >
        </p>
        ...
        <p>
          By default the data cell font used in table views is quite a bit
          larger than that used in the header cells. While this might look fine
          in normal windows it looks bad in HUD panels, which also have a
          smaller font used in the title bar.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003616more"><div id="more"></div></div>
