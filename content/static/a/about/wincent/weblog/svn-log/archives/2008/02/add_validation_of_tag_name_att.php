...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add validation of tag name attribute (wincent.dev,
      4cdb738)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/special_styling_for_links_winc.php"
            >&laquo; Special styling for links (wincent.dev, 45e3ce0)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/minor_rewrapping_for_readabili.php"
            >Minor rewrapping for readability (wincent.dev, ba69361) &raquo;</a
          >
        </p>

        <h2>February 7, 2008</h2>

        <h3>Add validation of tag name attribute (wincent.dev, 4cdb738)</h3>
