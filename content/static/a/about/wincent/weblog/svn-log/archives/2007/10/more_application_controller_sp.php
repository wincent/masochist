...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: More application controller specs (wincent.dev, 64cb423)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/synergy_r410_16_items_changed.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_application_controller_spe.php"
            >&laquo; Add application controller specs (wincent.dev, f7ec927)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/synergy_r410_16_items_changed.php"
            >Synergy r410, 16 items changed &raquo;</a
          >
        </p>

        <h2>October 21, 2007</h2>

        <h3>More application controller specs (wincent.dev, 64cb423)</h3>

        <p>
          Specs to confirm that the setup_locale method is protected, and that
