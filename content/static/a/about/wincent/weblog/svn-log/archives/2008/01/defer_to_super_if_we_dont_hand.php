...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Defer to super if we don't handle the KVO message
      (REnamer, 0c0ac38)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/improve_keyvalue_observing_of.php"
      title="Improve key/value observing of user defaults (REnamer, e229a72)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/create_worenamerwindowcontroll.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/improve_keyvalue_observing_of.php"
            >&laquo; Improve key/value observing of user defaults (REnamer,
            e229a72)</a
          >
          |
        ...
        <p>
          I can't think of any reason why we would receive a message that we
          don't handle, but it doesn't hurt to check for this eventuality and
          defer to super if it ever arises.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003725more"><div id="more"></div></div>
