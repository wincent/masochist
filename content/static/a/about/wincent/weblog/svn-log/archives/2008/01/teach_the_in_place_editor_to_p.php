...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Teach the in place editor to play nicely with forgery
      protection (wincent.dev, 2b5cbd0)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/clean_up_in_in_place_editor_he.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_in_place_editing_plugin_wi.php"
            >&laquo; Add in_place_editing_plugin (wincent.dev, 209d96c)</a
          >
          |
        ...
        <h3>
          Teach the in place editor to play nicely with forgery protection
          (wincent.dev, 2b5cbd0)
        </h3>

        <p>
          This requires me to commandeer the &quot;:with&quot; option for my own
          uses, but it seems a worthwhile trade-off (the alternative workaround
          is to disable forgery protection for in place editors, but that's
          opening too much of a hole).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003792more"><div id="more"></div></div>
