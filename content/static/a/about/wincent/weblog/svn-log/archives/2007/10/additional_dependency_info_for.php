...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Additional dependency info for Rakefile (wikitext,
      3fd78b8)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/refactor_for_deployment_using.php"
      title="Refactor for deployment using RubyGems (wikitext, 80ae725)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/use_len_macros_for_structure_a.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/refactor_for_deployment_using.php"
            >&laquo; Refactor for deployment using RubyGems (wikitext,
            80ae725)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/use_len_macros_for_structure_a.php"
            >Use LEN macros for structure access (wikitext, bd7cbef) &raquo;</a
          >
        </p>
        ...
        <p>
          Rather than just firing off the Makefile from within the Rakefile,
          some basic dependency info is added so that Rake knows when to bother
          running &quot;make&quot; again.
        </p>

        <p>
          The default task is the &quot;all&quot; task, which builds (only if
          necessary) and runs the specs. Note that because the actual building
          is delegated to make, and the Makefile has its own set of dependency
          information, the build will only perform as much as is necessary (for
          example, if the grammar file is touched then everything gets rebuilt;
          if only the wikitext.c file is touched then only that gets rebuilt and
          is relinked against the other object files).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003029more"><div id="more"></div></div>
