...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Use GIT_PAGER instead of PAGER (buildtools, d3177b3)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/set_pager_to_cat_when_capturin.php"
            >&laquo; Set PAGER to cat when capturing git exit status
            (buildtools, fd2e869)</a
          >
          |
        ...
        <p>
          The previous commit (fd2e869) worked but using GIT_PAGER rather than
          PAGER is strictly more correct in terms of the intention behind the
          commit (stopping Git from using the pager).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002628more"><div id="more"></div></div>
