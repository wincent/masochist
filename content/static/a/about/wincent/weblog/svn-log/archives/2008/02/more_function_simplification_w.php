...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: More function simplification (wikitext, dd54a50)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/simplify_rollback_of_external.php"
      title="Simplify rollback of external links (wikitext, c7ffbac)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/update_code_comments_for_funct.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/simplify_rollback_of_external.php"
            >&laquo; Simplify rollback of external links (wikitext, c7ffbac)</a
          >
          |
        ...
        <p>
          Here we are four more members to the parser struct to avoid having to
          pass so many parameters.
        </p>

        <p>
          This allows us to simplify the &quot;pop from stack&quot;, &quot;pop
          from stack up to&quot;, &quot;pop excess elements&quot;,
          &quot;rollback failed link&quot; and &quot;rollback failed internal
          link&quot; functions considerably; the parameter counts for these
          functions have gone from 4, 6, 6, 8 and 5 to 2, 4, 1, 3 and 2
          respectively, with the possibility of further simplificationin the
          future.
        </p>

        <p>
          A nice side effect of this change is that the calling parser code can
          be simplified in many places too; I as able to trim off a number of
          repeated lines that were no longer necessary, or which could be moved
          out into the functions.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003989more"><div id="more"></div></div>
