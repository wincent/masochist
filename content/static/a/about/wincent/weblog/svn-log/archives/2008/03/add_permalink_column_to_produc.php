...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add permalink column to products table (wincent.dev,
      a4263df)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/add_products_controller_and_ma.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/add_products_controller_and_ma.php"
            >&laquo; Add products controller and make it the default (root)
            route (wincent.dev, e1580bd)</a
          >
          |
        ...
        <h3>Add permalink column to products table (wincent.dev, a4263df)</h3>
