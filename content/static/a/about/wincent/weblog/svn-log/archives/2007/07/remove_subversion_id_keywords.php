...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove Subversion $Id$ keywords (WODebug, 685b576)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/remove_cleansvnsh_file_wodebug.php"
      title="Remove CleanSVN.sh file (WODebug, 22147df)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/skip_subversion_build_number_u.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/remove_cleansvnsh_file_wodebug.php"
            >&laquo; Remove CleanSVN.sh file (WODebug, 22147df)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/skip_subversion_build_number_u.php"
            >Skip Subversion build number update (WODebug, 42a75fe) &raquo;</a
          >
        </p>
        ...
        <p>
          Remove now-redundant Subversion-only keywords from source files, as
          well as related code that incorporates them as part of the build
          number during the build. Note this commit only removes the code-level
          components of the build number embedding process; in a separate commit
          I will modify the corresponding Shell Script build phase.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002585more"><div id="more"></div></div>
