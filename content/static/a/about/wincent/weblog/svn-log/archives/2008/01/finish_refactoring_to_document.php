...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Finish refactoring to document-based application
      (REnamer, 0ae1721)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/migrate_functionality_into_app.php"
      title="Migrate functionality into application controller (REnamer, 4066730)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/use_nsdocument_close_when_user.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/migrate_functionality_into_app.php"
            >&laquo; Migrate functionality into application controller (REnamer,
            4066730)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/use_nsdocument_close_when_user.php"
            >Use NSDocument close when user clicks Cancel button (REnamer,
            0a3c7bb) &raquo;</a
          >
        </p>
        ...
        <p>
          &quot;Finish&quot; in the sense that the code compiles works, and 90%
          of the functionality is now hooked up. The most painful part of the
          refactoring is now done and all that's left are polish issues.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003728more"><div id="more"></div></div>
