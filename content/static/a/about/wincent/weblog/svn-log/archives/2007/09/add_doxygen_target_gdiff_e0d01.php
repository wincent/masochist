...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/make_installation_window_key_g.php"
      title="Make installation window key (gdiff, 42890f6)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/use_new_thread_apis_gdiff_5130.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/make_installation_window_key_g.php"
            >&laquo; Make installation window key (gdiff, 42890f6)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/use_new_thread_apis_gdiff_5130.php"
            >Use new thread APIs (gdiff, 513091e) &raquo;</a
          >
        </p>
        ...
        <p>
          This commit adds a Doxygen target for producing code-level
          documentation. At the moment, the latest Doxygen release (1.5.3)
          doesn't build on Leopard although a pre-built binary does run. Doxygen
          does not yet understand the property syntax of Objective-C 2.0.
        </p>

        <p>
          Likewise, the latest version of Graphviz (2.8) (whose &quot;dot&quot;
          tool is invoked by Doxygen to depict inheritance hierarchies) doesn't
          yet build on Leopard, although I suspect an existing binary would work
          without problems.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002977more"><div id="more"></div></div>
