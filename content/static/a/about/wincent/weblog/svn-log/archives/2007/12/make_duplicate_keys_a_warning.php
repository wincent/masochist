...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Make duplicate keys a warning rather than an error
      (Wincent Strings Utility, 434fa5c)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/hook_up_new_combine_and_extrac.php"
      title="Hook up new combine() and extract() functions (Wincent Strings Utility, 97d6426)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/update_man_page_for_new_featur.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/hook_up_new_combine_and_extrac.php"
            >&laquo; Hook up new combine() and extract() functions (Wincent
            Strings Utility, 97d6426)</a
          >
          |
        ...
        <h3>
          Make duplicate keys a warning rather than an error (Wincent Strings
          Utility, 434fa5c)
        </h3>

        <p>
          Instead of disallowing duplicate keys during a combine operation,
          issue a warning and allow the &quot;target&quot; version to take
          precedence.
        </p>

        <p>
          This facilitates a common workflow wherein a localization is
          incomplete and its strings file contains a number of key/value pairs
          that are unlocalized. In this case those pairs will be extracted with
          extract() and the partial strings file that results can be localized.
          When it comes time to integrate the partial file, it is necessary to
          allow those new strings to override the existing, unlocalized ones in
          the previous version of the localizations' string file.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003322more"><div id="more"></div></div>
