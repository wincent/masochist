...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add temporary file reference to Xcode project (WOBezel,
      28ba2ce)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/remove_other_sources_group_wob.php"
      title="Remove &amp;quot;Other Sources&amp;quot; group (WOBezel, 3be02fb)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/set_pager_to_cat_when_capturin.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/remove_other_sources_group_wob.php"
            >&laquo; Remove &quot;Other Sources&quot; group (WOBezel,
            3be02fb)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/set_pager_to_cat_when_capturin.php"
            >Set PAGER to cat when capturing git exit status (buildtools,
            fd2e869) &raquo;</a
          >
        </p>
        ...
        <p>
          I've added the com.wincent.buildtools.gitrev.h file to the Xcode
          project in the hope that it will help Xcode's dependency analysis.
          Regrettably, it seems that this doesn't make any difference: one would
          hope that Xcode would see that a file included from the Info.plist
          preprocessing header file is modified and regenerate the property list
          accordingly, but it does not. The only way to get the Info.plist file
          to be generated again is to perform a full clean first.
        </p>

        <p>
          This is definitely a bug in Xcode and one that I don't recall seeing
          in the last version; I'm going to commit this change anyway seeing as
