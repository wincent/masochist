...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: spec_server update (wincent.dev, f7ea090)</title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/prepare_spec_helper_wincentcom.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/prepare_spec_helper_wincentcom.php"
            >&laquo; Prepare spec helper (wincent.dev, edf298e)</a
          >
          |
          ...
          <a
            ...
            (wincent.dev, 471fe24) &raquo;</a
          >
        </p>

        <h2>October 15, 2007</h2>

        <h3>spec_server update (wincent.dev, f7ea090)</h3>

        <p>
          Minor update to the script/spec_server script; this should have
