...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove deprecated methods (WOCommon, c5028f5)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/avoid_uninitialized_use_of_var.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/avoid_uninitialized_use_of_var.php"
            >&laquo; Avoid uninitialized use of variable (Synergy, 26d81a6)</a
          >
          |
        ...
        <p>
          From NSDictionary creation category. This commit also includes some
          minor re-wrapping close to the removed method (no substantive
          changes).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003434more"><div id="more"></div></div>
