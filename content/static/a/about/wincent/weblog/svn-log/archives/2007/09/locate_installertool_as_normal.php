...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Locate installer-tool as normal resource (gdiff,
      5d40d99)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/add_missing_early_return_when.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/add_missing_early_return_when.php"
            >&laquo; Add missing early return when authorization denied (gdiff,
            3b273d0)</a
          >
          |
        ...
        <p>
          ...
          (Objective-C executables linked against the Objective-C runtime) but
          not for pure C executables. So must use pathForResource:ofType: to
          locate the installer tool instead.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002968more"><div id="more"></div></div>
