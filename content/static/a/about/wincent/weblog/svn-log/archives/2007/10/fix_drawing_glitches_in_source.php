...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix drawing glitches in source list (gdiff, b001fe1)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/draw_top_and_bottom_borders_in.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/use_source_list_selection_high.php"
            >&laquo; Use source list selection highlighting (gdiff, d107dbe)</a
          >
          |
        ...
        <p>
          The cause of the drawing glitches was a missing super call in the
          drawRect: method in the subclass template. Not only are the glitches
          fixed but the background color now draws as well.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003010more"><div id="more"></div></div>
