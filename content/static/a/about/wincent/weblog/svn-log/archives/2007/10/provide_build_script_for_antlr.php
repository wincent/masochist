...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Provide build script for ANTLR (wikitext, 282eee9)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/refactor_script_into_build_and.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/eliminate_scm_noise_by_changin.php"
            >&laquo; Eliminate SCM noise by changing ANTLR template (wikitext,
            39d1565)</a
          >
          |
        ...
        <p>
          Make the ANTLR build process less error prone by doing it all in a
          reproducible script which cleans, extracts the tar archives, applies
          the patches, works around the build bug, and builds both ANTLR itself
          and the C target runtime.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003023more"><div id="more"></div></div>
