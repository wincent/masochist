...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Raise range errors for invalid link text (wikitext,
      b5ad8d6)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/first_version_of_link_sanitiza.php"
      title="First version of link sanitization function (wikitext, 0a857f1)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/sanitize_link_targets_when_rol.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/first_version_of_link_sanitiza.php"
            >&laquo; First version of link sanitization function (wikitext,
            0a857f1)</a
          >
          |
        ...
        <p>
          Raise an error if link text includes &quot;&gt;&quot; or
          &quot;&lt;&quot;. In practice this should never happen because the
          only intended caller is the Wikitext::Parser itself, but put this in
          just in case.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003832more"><div id="more"></div></div>
