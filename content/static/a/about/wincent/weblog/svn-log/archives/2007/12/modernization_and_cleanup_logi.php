...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Modernization and clean-up (login-tool, 8790dd9)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/upgrade_xcode_project_bundle_l.php"
      title="Upgrade Xcode project bundle (login-tool, fdbb4cb)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/switch_to_gc_logintool_72eb109.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/upgrade_xcode_project_bundle_l.php"
            >&laquo; Upgrade Xcode project bundle (login-tool, fdbb4cb)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/switch_to_gc_logintool_72eb109.php"
            >Switch to GC (login-tool, 72eb109) &raquo;</a
          >
        </p>
        ...
        <p>
          ...
          remove Subversion buzz - update and normalize copyright - rewrap to
          132-columns for better readability - improve alignment for better
          readability - use C99 for loops - whitespace fixes (trailing
          whitespace, missing newline at end of file) - use EXIT_SUCCESS rather
          than 0
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003209more"><div id="more"></div></div>
