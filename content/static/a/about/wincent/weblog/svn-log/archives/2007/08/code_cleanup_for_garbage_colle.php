...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Code clean-up for garbage collection (WOTest, 2eab9a2)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/workaround_objectivec_20_prope.php"
      title="Workaround Objective-C 2.0 properties bug (WOTest, 2507142)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/readability_improvements_to_ns.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/workaround_objectivec_20_prope.php"
            >&laquo; Workaround Objective-C 2.0 properties bug (WOTest,
            2507142)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/readability_improvements_to_ns.php"
            >Readability improvements to NSBezierPath category (WOBezel,
            3e23a51) &raquo;</a
          >
        </p>
        ...
        <p>
          ...
          have effectively been turned into no-ops by the move to garbage
          collection (retain, release, autorelease), as well as replacing
          &quot;release&quot; messages sent to autorelease pools with
          &quot;drain&quot;, replacing the alloc/init pattern with the
          straightforward autoreleased alternative where possible (for brevity),
          removing methods that will now never be meaningfully called (dealloc,
          release, retainCount etc), and switching some accessors over to
          synthesized properties where this enabled me to get rid of no-op
          retain, release and autorelease message sends.
        </p>

        <p>
          I also performed some minor reformatting (better wrapping and column
          alignment) where the already-mentioned changes touch code which would
          benefit from such reformatting (improved readability); there are still
          plenty of places in the codebase where the wrapping could be tweaked
          to make better use of the full 132 columns.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002611more"><div id="more"></div></div>
