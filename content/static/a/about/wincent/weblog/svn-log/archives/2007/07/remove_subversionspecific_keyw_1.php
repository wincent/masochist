...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove Subversion-specific keywords (WOCommon, 54b91bb)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/update_copyright_year_range_sy.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/remove_subversionspecific_keyw.php"
            >&laquo; Remove Subversion-specific keywords (Synergy Advance,
            3b37a73)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/update_copyright_year_range_sy.php"
            >Update copyright year range (Synergy Advance, 68ec4e5) &raquo;</a
          >
        </p>
        ...
        <p>
          Remove $now-redundant $Id$ tags for all files; these were specific to
          Subversion and are no longer useful now that the code is being managed
          in a Git repository.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002451more"><div id="more"></div></div>
