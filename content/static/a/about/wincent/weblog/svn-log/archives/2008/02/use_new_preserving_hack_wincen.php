...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Use new preserving hack (wincent.dev, 1be5ca4)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/teach_haml_to_respect_preforma.php"
            >&laquo; Teach Haml to respect preformatted text (wincent.dev,
            0eb6273)</a
          >
          |
        ...
        <h3>Use new preserving hack (wincent.dev, 1be5ca4)</h3>
        ...
        <div id="a004070more"><div id="more"></div></div>
