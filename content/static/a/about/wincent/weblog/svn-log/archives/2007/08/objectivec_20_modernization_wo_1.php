...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Objective-C 2.0 modernization (WOHotKey, e3f4f9a)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/make_commoninit_pattern_subcla.php"
      title="Make &amp;quot;commonInit&amp;quot; pattern subclass-friendly (WOHotKey, d6e6a9b)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/tighten_up_exit_status_check_i.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/make_commoninit_pattern_subcla.php"
            >&laquo; Make &quot;commonInit&quot; pattern subclass-friendly
            (WOHotKey, d6e6a9b)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/tighten_up_exit_status_check_i.php"
            >Tighten up exit status check in post-receive script (snippets,
            2be9c00) &raquo;</a
          >
        </p>
        ...
        <h3>Objective-C 2.0 modernization (WOHotKey, e3f4f9a)</h3>

        <p>
          Sweeping changes across the codebase to take advantage of new features
          in Objective-C 2.0; this is still not a complete revision and there
          are still more changes that can be made.
        </p>

        <p>
          Changes so far effected: use of fast enumeration instead of old
          enumeration macros; elimination of now-redundant calls to no-op
          methods such as release, autorelease and friends; elimination of
          dealloc methods where possible and replacement by finalize methods
          where necessary; some of the singleton semantics have changed so
          update some comments to reflect that; some formatting changes for
          better readability in sections where the code needed to be changed as
          part of the Objective-C 2.0 modernization; use of shorter, cleaner
          autoreleased object initialization rather than the alloc/init pattern
          where possible; removal of dead (unimplemented, unneeded) methods
          revealed as a consequence of the switch to Objective-C 2.0 anonymous
          categories; more compact notation for the &quot;work on temporary
          mutable object but return immutable version&quot; pattern (using the
          &quot;copy&quot; method; this is a pattern which is made possible by
          the move to garbage collection); added notes at key-enumeration sites
          as reminders that these cannot be switched to use the new fast
          enumeration syntax; and conversion of manually-coded accessors to
          synthesized properties in many classes.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002621more"><div id="more"></div></div>

        <p class="posted">Posted by wincent at August 11, 2007 7:27 PM</p>
      </div>
    </div>
