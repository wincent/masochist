...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add specs to catch regressions (wikitext, 01ada5a)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_handling_of_unclosed_spanl.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/get_integration_specs_passing.php"
            >&laquo; Get integration specs passing (fix OL/UL nesting in
            BLOCKQUOTE) (wikitext, ae0ffab)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_handling_of_unclosed_spanl.php"
            >Fix handling of unclosed span-level elements in lists (wikitext,
            2a996a7) &raquo;</a
          >
        </p>
        ...
        <p>
          Add several more specs related to recently discovered flaws to make
          sure the issues don't creep back in again.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004016more"><div id="more"></div></div>
