...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Allow horizontal scrollers when necessary (gdiff,
      30abc8d)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/remove_sethasverticalscroller.php"
            >&laquo; Remove setHasVerticalScroller calls (gdiff, 5895b3a)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/remove_debugging_log_statement.php"
            >Remove debugging log statement (gdiff, 1d0c023) &raquo;</a
          >
        </p>
        ...
        <p>
          Although we don't want our scroll views to have vertical scrollers we
          do want them to have horizontal ones if the displayed content is too
          wide.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002989more"><div id="more"></div></div>
