...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update man page to use double-hyphen form (Wincent
      Strings Utility, 211244d)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/update_date_in_manual_page_win.php"
            >&laquo; Update date in manual page (Wincent Strings Utility,
            65cf261)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/really_add_doublehyphen_form_w.php"
            >Really add double-hyphen form (Wincent Strings Utility, a318aff)
            &raquo;</a
          >
        </p>
        ...
        <div id="a003476more"><div id="more"></div></div>
