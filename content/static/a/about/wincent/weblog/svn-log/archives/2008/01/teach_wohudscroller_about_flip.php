...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Teach WOHUDScroller about flipped coordinate systems
      (REnamer, 56c18f7)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/silence_gcc_warning_about_sign.php"
      title="Silence GCC warning about signed/unsigned comparison (REnamer, a5f6563)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/update_todo_notes_renamer_2f49.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/silence_gcc_warning_about_sign.php"
            >&laquo; Silence GCC warning about signed/unsigned comparison
            (REnamer, a5f6563)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/update_todo_notes_renamer_2f49.php"
            >Update TODO notes (REnamer, 2f4961d) &raquo;</a
          >
        </p>
        ...
        <h3>
          Teach WOHUDScroller about flipped coordinate systems (REnamer,
          56c18f7)
        </h3>

        <p>
          Similiar to commit f19e388, here we teach WOHUDScroller to draw
          correctly depending on whether its coordinate system is flipped or
          not, in this case specifically with respect to the arrows.
        </p>

        <p>
          Rather than eliminating repetition here, I think clarity is more
          important, so I've explicitly specified the path for each of the
          permutations of ascending/descending, horizontal/vertical, and
          flipped/unflipped.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003639more"><div id="more"></div></div>
