...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Upgrade to Rails 2.0RC2 (wincent.dev, 5ff1ca1)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/gc_changes_for_the_symbol_spit.php"
            >&laquo; GC changes for the symbol spitter class (WOCommon,
            1be194d)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/update_fixturereplacement_revi.php"
            >Update FixtureReplacement (revision 140) (wincent.dev, bf665d7)
            &raquo;</a
          >
        </p>
        ...
        <h3>Upgrade to Rails 2.0RC2 (wincent.dev, 5ff1ca1)</h3>

        <p>
          Freeze the latest release candidate into the vendor subdirectory and
          use the &quot;rails&quot; commandline tool to update application
          files.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003195more"><div id="more"></div></div>
