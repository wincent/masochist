...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Teach options processor to handle nil values (wikitext,
      15a3470)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_specs_for_image_markup_wik.php"
            >&laquo; Add specs for image markup (wikitext, 8358662)</a
          >
          |
        ...
        <p>
          Previously when looking at the options hash we had no way of
          distinguishing but nil (&quot;unset&quot;) and nil (&quot;explicitly
          set to nil&quot;). Now we explicitly check for the latter so that
          overriding is a little easier; the caller can set options to nil in
          order to suppress them.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004158more"><div id="more"></div></div>
