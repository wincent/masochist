...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Move scaled_tag helper function into application helper
      (wincent.dev, 57f734a)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_pretty_tag_urls_wincentcom.php"
            >&laquo; Fix pretty tag URLs (wincent.dev, 339a076)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_tagging_to_wiki_wincentcom.php"
            >Add tagging to wiki (wincent.dev, de6322a) &raquo;</a
          >
        </p>
        ...
        <h3>
          Move scaled_tag helper function into application helper (wincent.dev,
          57f734a)
        </h3>

        <p>
          Move the scaled_tag helper function from the tags helper to the main
