...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Whitespace fix (wincent.dev, bfa88e8)</title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_article_and_revision_model.php"
            >&laquo; Add Article and Revision models (wincent.dev, 884af44)</a
          >
          |
        ...
        <h3>Whitespace fix (wincent.dev, bfa88e8)</h3>

        <p>Eliminate superfluous spaces.</p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003077more"><div id="more"></div></div>
