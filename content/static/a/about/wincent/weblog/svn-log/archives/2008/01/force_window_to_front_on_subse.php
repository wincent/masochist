...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Force window to front on subsequent &quot;open&quot;
      events (REnamer, f8562dc)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/force_preview_window_to_appear.php"
      title="Force preview window to appear at launch (REnamer, 3c032fa)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/custom_nsdocumentcontroller_su.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/force_preview_window_to_appear.php"
            >&laquo; Force preview window to appear at launch (REnamer,
            3c032fa)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/custom_nsdocumentcontroller_su.php"
            >Custom NSDocumentController subclass (REnamer, db7c7de) &raquo;</a
          >
        </p>
        ...
        <h3>
          Force window to front on subsequent &quot;open&quot; events (REnamer,
          f8562dc)
        </h3>

        <p>
          Now we force the main window to the front on subsequent
          &quot;open&quot; events, which means that when you drop more files on
          the Dock icon the associated window becomes main/key, and its preview
          becomes visible (if appropriate).
        </p>

        <p>
          I am not sure exactly why I have to force this in this way, nor why
          the controller's window message returns nil, but it works.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003737more"><div id="more"></div></div>
