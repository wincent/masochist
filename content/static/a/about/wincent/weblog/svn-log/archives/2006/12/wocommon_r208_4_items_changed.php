    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2006/12/wocommon_r207_6_items_changed.php"
            >&laquo; WOCommon r207, 6 items changed</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2006/12/wocommon_r209_2_items_changed.php"
            >WOCommon r209, 2 items changed &raquo;</a
          >
        </p>
        ...
        <p>
          Correct unit tests and fix test failures for date and date/time
          classes after refactoring and additions
        </p>

        <div id="a000993more"><div id="more"></div></div>
