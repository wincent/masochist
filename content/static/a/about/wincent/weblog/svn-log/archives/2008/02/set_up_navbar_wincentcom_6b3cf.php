...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Set up navbar (wincent.dev, 6b3cfb4)</title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_pagination_to_weblog_wince.php"
            >&laquo; Add pagination to weblog (wincent.dev, b39a0af)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/remove_commented_out_css_wince.php"
            >Remove commented out CSS (wincent.dev, 61f798b) &raquo;</a
          >
        </p>

        <h2>February 15, 2008</h2>

        <h3>Set up navbar (wincent.dev, 6b3cfb4)</h3>

        <p>
          In 2.0 spirit we're going for the simplest navigation possible. Some
          of the CSS exhibits some mysterious behaviour (namely, I had to set a
          -0.35em left margin on the links in the list items in order to get the
          highlighting to correctly extend all the way to the preceding border;
          I have no idea why this hack was required) but it displays correctly
          in both Firefox and Safari.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004130more"><div id="more"></div></div>
