...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add live preview to wiki (wincent.dev, 8140e20)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/remove_redundant_parameters_to.php"
      title="Remove redundant parameters to dedent method (wikitext, f29d562)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/drop_revisions_model_wincentco.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/remove_redundant_parameters_to.php"
            >&laquo; Remove redundant parameters to dedent method (wikitext,
            f29d562)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/drop_revisions_model_wincentco.php"
            >Drop Revisions model (wincent.dev, b6312eb) &raquo;</a
          >
        </p>

        <h2>February 12, 2008</h2>

        <h3>Add live preview to wiki (wincent.dev, 8140e20)</h3>

        <p>
          When creating a new wiki article provide a live AJAX preview. I've got
          this set to a fairly low frequency (checks for changes every 30
          seconds). You always have the option of hitting the preview link to
          force an immediate update.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004074more"><div id="more"></div></div>
