...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Minor formatting clean-up in main controller header
      (REnamer, 4f92fa7)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/remove_test_comments_in_nsappl.php"
            >&laquo; Remove test comments in NSApplication convenience category
            (WOCommon, 1656a77)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/force_way_to_front_on_launch_r.php"
            >Force way to front on launch (REnamer, 2670577) &raquo;</a
          >
        </p>
        ...
        <div id="a003684more"><div id="more"></div></div>
