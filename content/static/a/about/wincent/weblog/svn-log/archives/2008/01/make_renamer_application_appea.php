...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Make REnamer application appear in Dock (REnamer,
      8744815)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/use_hud_style_for_preview_pane.php"
      title="Use HUD style for preview panel (REnamer, 9aa3a3f)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/remove_braindead_diff_invocati.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/use_hud_style_for_preview_pane.php"
            >&laquo; Use HUD style for preview panel (REnamer, 9aa3a3f)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/remove_braindead_diff_invocati.php"
            >Remove braindead diff invocations (buildtools, 88ead02) &raquo;</a
          >
        </p>
        ...
        <p>
          This is part of a general style change. In the prototype, the
          principal object of interest was the contextual menu plugin and the
          application was a helper that was embedded inside the plugin bundle.
        </p>

        <p>
          Now, the application is the star and the plugin lives inside the
          application bundle. This opens up some other possibilities for UI
          interaction, like responding to items dragged and dropped onto the
          Dock icon or the application in the Finder.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003532more"><div id="more"></div></div>
