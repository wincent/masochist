...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Migrate WOProcessManager from WOSingleton to local
      implementation (WOCommon, c37e6c9)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/garbage_collection_changes_for.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/garbage_collection_changes_for.php"
            >&laquo; Garbage collection changes for WOProcessManager (WOCommon,
            6ab78fb)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/layout_tweak_for_woprocessmana.php"
            >Layout tweak for WOProcessManager (WOCommon, 34b61b0) &raquo;</a
          >
        </p>
        ...
        <h3>
          Migrate WOProcessManager from WOSingleton to local implementation
          (WOCommon, c37e6c9)
        </h3>

        <p>
          Dump the abstract enforced singleton pattern obtained from using
          WOSingleton as a superclass and instead use a lightweight local
          advisory implementation implemented using a double-checked locking
          pattern with memory barriers.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002731more"><div id="more"></div></div>
