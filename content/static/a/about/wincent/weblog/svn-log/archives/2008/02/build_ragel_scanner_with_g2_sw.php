...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Build Ragel scanner with -G2 switch (wikitext, 3cd4454)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_notes_file_to_benchmarks_s.php"
      title="Add notes file to benchmarks subdirectory (wikitext, fdccb3b)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/rename_ary_delete_at_to_ary_po.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_notes_file_to_benchmarks_s.php"
            >&laquo; Add notes file to benchmarks subdirectory (wikitext,
            fdccb3b)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/rename_ary_delete_at_to_ary_po.php"
            >Rename ary_delete_at to ary_pop (wikitext, d2ea29f) &raquo;</a
          >
        </p>
        ...
        <p>
          At the recommendation of Adrian Thurston I tried using the -G2 switch
          to turn on the &quot;really fast goto-driven FSM&quot; code generation
          style (as opposed to the default table-driven one).
        </p>

        <p>
          The tokenizer saw a four-fold speed increase (making it almost 38
          times faster than ANTLR instead of just 10 times). As a flow-on
          effect, this reduces the total parse time by about 15%, and there is
          still plenty of scope for optimization in the parser itself.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003895more"><div id="more"></div></div>
