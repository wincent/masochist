...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Tags interface (wincent.dev, 37ee0e1)</title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/teach_acts_as_sortable_to_acce.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/teach_acts_as_sortable_to_acce.php"
            >&laquo; Teach acts_as_sortable to accept default sort order
            parameter (wincent.dev, 813baad)</a
          >
          |
        ...
        <h3>Tags interface (wincent.dev, 37ee0e1)</h3>

        <p>
          This is the beginning of the tagging interface. Note that because I
          want to sort tags by the number of times they're used I had to add a
          counter_cache column to the tags table.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003966more"><div id="more"></div></div>
