...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update blockquote specs to use &quot;dedent&quot; helper
      (wikitext, 3d507da)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/update_indentation_spec_to_use.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/more_blockquote_specs_wikitext.php"
            >&laquo; More blockquote specs (wikitext, 00e2719)</a
          >
          |
        ...
        <h3>
          Update blockquote specs to use &quot;dedent&quot; helper (wikitext,
          3d507da)
        </h3>

        <p>
          While making this change I also discovered and fixed a couple of
          example blocks in which I was setting up test data but never making an
          assertion.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004053more"><div id="more"></div></div>
