...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Add tagging to wiki (wincent.dev, de6322a)</title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/move_scaled_tag_helper_functio.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/move_scaled_tag_helper_functio.php"
            >&laquo; Move scaled_tag helper function into application helper
            (wincent.dev, 57f734a)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_initial_validations_for_ar.php"
            >Add initial validations for Article model (wincent.dev, 5881ce0)
            &raquo;</a
          >
        </p>
        ...
        <h3>Add tagging to wiki (wincent.dev, de6322a)</h3>

        <p>
          You can now specify new tags when creating a wiki article, and they
          are shown when the article is shown.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004065more"><div id="more"></div></div>
