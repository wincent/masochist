...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Change tag cloud formatting (wincent.dev, 0ca64e0)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/special_styling_for_links_winc.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/size_tag_font_depending_on_pop.php"
            >&laquo; Size tag font depending on popularity (wincent.dev,
            b724d1a)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/special_styling_for_links_winc.php"
            >Special styling for links (wincent.dev, 45e3ce0) &raquo;</a
          >
        </p>

        <h2>February 7, 2008</h2>

        <h3>Change tag cloud formatting (wincent.dev, 0ca64e0)</h3>

        <p>
          Changes to the controller to order tags by name, and to the CSS to
          display them in a more cloud-like fashion (drop list, just put all the
