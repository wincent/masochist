...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Tighten up exit status check in post-receive script
      (snippets, 2be9c00)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/initial_version_of_git_build_n.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/objectivec_20_modernization_wo_1.php"
            >&laquo; Objective-C 2.0 modernization (WOHotKey, e3f4f9a)</a
          >
          |
        ...
        <p>
          The post-receive script currently does a somewhat loose exitstatus
          check ($? == 0) which happens to work because the Process::Status
          class evidently overrides the == operator (or implements to_int; I
          haven't actually looked at the source code to know why this works);
          rather than relying on this behaviour this commit explicitly compares
          the exit status ($?.exitstatus == 0) to guard against possible changes
