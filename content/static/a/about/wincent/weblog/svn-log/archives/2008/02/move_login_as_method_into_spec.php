...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Move login_as method into spec helper (wincent.dev,
      8e136a7)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/shorten_body_html_helper_wince.php"
            >&laquo; Shorten body_html helper (wincent.dev, e54a968)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_spec_breakage_caused_by_re.php"
            >Fix spec breakage caused by removal of Revisions model
            (wincent.dev, 1f9a20f) &raquo;</a
          >
        </p>

        <h2>February 13, 2008</h2>

        <h3>Move login_as method into spec helper (wincent.dev, 8e136a7)</h3>

        <p>
          This was originally in the sessions controller specs, but move it up
