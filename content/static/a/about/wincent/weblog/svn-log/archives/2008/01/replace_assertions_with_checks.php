...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Replace assertions with checks in unit tests (REnamer,
      1dd61f2)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/reorganization_renamer_0cff757.php"
      title="Reorganization (REnamer, 0cff757)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/update_gitignores_to_ignore_ba.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/reorganization_renamer_0cff757.php"
            >&laquo; Reorganization (REnamer, 0cff757)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/update_gitignores_to_ignore_ba.php"
            >Update gitignores to ignore bak files (REnamer, 3eaf965) &raquo;</a
          >
        </p>
        ...
        <p>
          We want these checks to be compiled in both Debug and Release builds
          in the unit tests, so use check macros rather than assertion ones (the
          latter get preprocessed away in Release builds).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003579more"><div id="more"></div></div>
