...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Make sure tags only get applied once (wincent.dev,
      3342585)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/whitespace_fix_wincentcom_bfa8.php"
      title="Whitespace fix (wincent.dev, bfa88e8)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_taggable_module_wincentcom.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/whitespace_fix_wincentcom_bfa8.php"
            >&laquo; Whitespace fix (wincent.dev, bfa88e8)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_taggable_module_wincentcom.php"
            >Add Taggable module (wincent.dev, 003f9f3) &raquo;</a
          >
        </p>

        <h2>October 15, 2007</h2>

        <h3>Make sure tags only get applied once (wincent.dev, 3342585)</h3>

        <p>
          Use database-level constraints to ensure that tags only get applied
          once to any given model instance. Application-level constraints are
          not appropriate because they're vulnerable to race conditions (due to
          the window between checking if a tag is already applied and trying to
          apply it).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003078more"><div id="more"></div></div>
