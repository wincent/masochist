...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Modifications to WOAlertBezelView class for garbage
      collection (WOBezel, 50e8fed)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/readability_edits_to_woalertbe.php"
            >&laquo; Readability edits to WOAlertBezelView class (WOBezel,
            69379b9)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/core_animation_notes_wobezel_a.php"
            >Core Animation notes (WOBezel, ae375d1) &raquo;</a
          >
        </p>
        ...
        <h3>
          Modifications to WOAlertBezelView class for garbage collection
          (WOBezel, 50e8fed)
        </h3>

        <p>
          Remove autorelease message send which is now a no-op under garbage
          collection.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002615more"><div id="more"></div></div>
