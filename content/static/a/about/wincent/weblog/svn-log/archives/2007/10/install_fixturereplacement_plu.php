...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Install FixtureReplacement plug-in (wincent.dev,
      07fe43b)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/indentation_in_application_rea.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/install_rspec_plugins_wincentc.php"
            >&laquo; Install RSpec plugins (wincent.dev, cd983c8)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/indentation_in_application_rea.php"
            >Indentation in application README (wincent.dev, b8b1d12) &raquo;</a
          >
        </p>

        <h2>October 5, 2007</h2>

        <h3>Install FixtureReplacement plug-in (wincent.dev, 07fe43b)</h3>

        <p>This is FixtureReplacement with Subversion revision 31.</p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003050more"><div id="more"></div></div>
