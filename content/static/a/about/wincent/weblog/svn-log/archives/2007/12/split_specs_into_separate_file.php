...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Split specs into separate files (Wincent Strings
      Utility, d789a0b)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/run_justbuilt_copy_by_default.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/run_justbuilt_copy_by_default.php"
            >&laquo; Run just-built copy by default (Wincent Strings Utility,
            6646efa)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/allow_explicit_override_of_out.php"
            >Allow explicit override of output encoding (Wincent Strings
            Utility, 6afbc3c) &raquo;</a
          >
        </p>
        ...
        <p>
          Break the specs up into multiple files to make them easier to
          maintain.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003330more"><div id="more"></div></div>
