...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/03/walrus_r103_1_item_changed.php"
      title="Walrus r103, 1 item changed"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/03/walrus_r105_18_items_changed.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/03/walrus_r103_1_item_changed.php"
            >&laquo; Walrus r103, 1 item changed</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/03/walrus_r105_18_items_changed.php"
            >Walrus r105, 18 items changed &raquo;</a
          >
        </p>
        ...
        <p>
          Compilation of '#set' directive; '#set' directive syntax now requires
          a leading dollar sign on the lvalue of the assignment; explicitly
          disallow whitespace between the opening dollar sign and the
          placeholder name (whitespace is allowed if using the 'long format'
          with curly braces, but only after the braces have been opened)
        </p>

        <div id="a001261more"><div id="more"></div></div>
