...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Ignore coverage subdirectory (wincent.dev, bb4ed11)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/set_up_atom_feed_for_posts_win.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_specs_for_post_model_wince.php"
            >&laquo; Add specs for Post model (wincent.dev, 7d22ac0)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/set_up_atom_feed_for_posts_win.php"
            >Set up Atom feed for posts (wincent.dev, 02f8381) &raquo;</a
          >
        </p>

        <h2>February 17, 2008</h2>

        <h3>Ignore coverage subdirectory (wincent.dev, bb4ed11)</h3>

        <p>
          This is where output gets written when running &quot;rake
          spec:rcov&quot;.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004138more"><div id="more"></div></div>
