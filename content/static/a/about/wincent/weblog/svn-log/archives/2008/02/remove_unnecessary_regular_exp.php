...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove unnecessary regular expression machines from
      Ragel machine (wikitext, 3de5048)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/teach__wikitext_parser_encode.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_support_for_https_uris_wik.php"
            >&laquo; Add support for HTTPS URIs (wikitext, 06a4b58)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/teach__wikitext_parser_encode.php"
            >Teach _Wikitext_parser_encode_link_target to take a parser
            parameter (wikitext, 605aba1) &raquo;</a
          >
        </p>
        ...
        <h3>
          Remove unnecessary regular expression machines from Ragel machine
          (wikitext, 3de5048)
        </h3>

        <p>
          I just learned that the &quot;i&quot; (case-insensitive) modifier can
          be applied equally to standard concatenation literals as it can to
          regular expressions. Simplify the grammar (fewer escape sequences) and
          make life easier on the syntax highlighter by replacing the regular
          expression machines with concatentation literals. The generated code
          is identical before and after.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004025more"><div id="more"></div></div>
