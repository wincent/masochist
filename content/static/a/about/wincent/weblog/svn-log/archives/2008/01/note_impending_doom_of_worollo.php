...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Note impending doom of WORolloverButton class (REnamer,
      3eea4d3)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/remove_appkit_import_renamer_1.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/lose_unnecessary_brackets_rena.php"
            >&laquo; Lose unnecessary brackets (REnamer, 7a8bb41)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/remove_appkit_import_renamer_1.php"
            >Remove AppKit import (REnamer, 1af40fe) &raquo;</a
          >
        </p>
        ...
        <h3>
          Note impending doom of WORolloverButton class (REnamer, 3eea4d3)
        </h3>

        <p>
          Can use the &quot;recessed&quot; button style in Leopard rather than
          relying on this custom class.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003525more"><div id="more"></div></div>
