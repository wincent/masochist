...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Objective-C 2.0 changes for WOAudioscrobbler class
      (Synergy, 4cff245)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/clean_up_code_comments_in_wosy.php"
            >&laquo; Clean up code comments in WOSysctl.c (Synergy, dc7cec2)</a
          >
          |
        ...
        <p>
          - properties - remove retain/release/autorelease calls - use class
          extension (anonymous category) for private methods - C99 for loop
          syntax
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003259more"><div id="more"></div></div>
