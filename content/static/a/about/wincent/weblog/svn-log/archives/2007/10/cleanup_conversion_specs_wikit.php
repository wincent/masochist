...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Cleanup conversion specs (wikitext, 374b278)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/correct_submodule_usage_in_spe.php"
            >&laquo; Correct submodule usage in specs (wikitext, e37df19)</a
          >
          |
        ...
        <p>
          Cleanup conversion specs by splitting off the invalid coding samples
          into separate namespaces (UTF8::Invalid and UCS2::Invalid) and
          referring to them by constants.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003040more"><div id="more"></div></div>
