...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Make sure admin sees all comments in posts
      &quot;show&quot; template (wincent.dev, 00d93e7)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/only_show_comments_if_accepted.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/inline_moderation_of_post_comm.php"
            >&laquo; Inline moderation of post comments (wincent.dev,
            ec346e2)</a
          >
          |
        ...
        <h3>
          Make sure admin sees all comments in posts &quot;show&quot; template
          (wincent.dev, 00d93e7)
        </h3>

        <p>
          Previously the admin would only see comments awaiting moderation. Now
          he sees all non-spam comments.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004125more"><div id="more"></div></div>
