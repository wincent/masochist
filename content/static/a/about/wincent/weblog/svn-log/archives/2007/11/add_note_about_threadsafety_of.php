...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add note about thread-safety of WOSingleton class
      (Synergy, 36b46d0)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/add_toplevel_gitignore_file_sy_1.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/add_toplevel_gitignore_file_sy_1.php"
            >&laquo; Add top-level gitignore file (Synergy, e060cb4)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/add_note_about_threadsafety_of_1.php"
            >Add note about thread-safety of WOSingleton class (Synergy,
            36b46d0) &raquo;</a
          >
        </p>
        ...
        <p>
          Basically, it's not thread-safe, so add a note that it should only be
          used in the single-threaded context.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003116more"><div id="more"></div></div>
