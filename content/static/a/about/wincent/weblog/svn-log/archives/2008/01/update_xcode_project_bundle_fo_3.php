...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update Xcode project bundle for multi-window refactoring
      (REnamer, 4b88522)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/split_mainmenuxib_into_two_ren.php"
            >&laquo; Split MainMenu.xib into two (REnamer, c4536d6)</a
          >
          |
        ...
        <p>
          Sync the project bundle with the other changes that have been made to
          support multi-window operation.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003714more"><div id="more"></div></div>
