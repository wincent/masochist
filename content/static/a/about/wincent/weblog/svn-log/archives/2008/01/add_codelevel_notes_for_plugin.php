...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add code-level notes for plug-in (REnamer, 900e393)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/teach_woregularexpression_to_h.php"
            >&laquo; Teach WORegularExpression to handle invalid substitution
            expressions (REnamer, 354d493)</a
          >
          |
        ...
        <p>
          These are just comments added when auditing the plug-in code; things
          to do, points to remember and so on.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003694more"><div id="more"></div></div>
