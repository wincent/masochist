    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/add_application_controller_gdi.php"
            >&laquo; Add application controller (gdiff, bb5fad2)</a
          >
          |
        ...
        <p>
          Replace generic references to the application in the default main menu
          nib with its actual name.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002959more"><div id="more"></div></div>
