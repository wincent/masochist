...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Better performance in singleton pattern (WOCommon,
      7a71a42)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/solution_for_exercise_120_snip.php"
      title="Solution for Exercise 1.20 (snippets, 01c89ee)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/update_gestaltbased_apis_to_ma.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/solution_for_exercise_120_snip.php"
            >&laquo; Solution for Exercise 1.20 (snippets, 01c89ee)</a
          >
          |
        ...
        <p>
          Really just a micro-optimization for an infrequent case, this commit
          performs synchronization against &quot;self&quot; rather than a
          hard-coded class object. We save one message send on an
          infrequently-travelled code path and save a few keystrokes. This is
          safe in a context where the singleton classes themselves aren't
          subclassed, something which will never happen with these examples
          because they already constitute specialized &quot;end points&quot;;
