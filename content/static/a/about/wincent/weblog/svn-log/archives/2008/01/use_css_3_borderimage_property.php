...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Use CSS 3 border-image property in help documentation
      (REnamer, 2785b27)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/import_css_updates_into_web_he.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/tweak_css_to_make_help_documen.php"
            >&laquo; Tweak CSS to make help documentation match Leopard style
            (REnamer, ef59fa4)</a
          >
          |
        ...
        <p>
          When the property is not supported the box is shown without a visible
          border; this seems like an acceptable degradation, seeing as the box
          contents are still visually indented.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003674more"><div id="more"></div></div>
