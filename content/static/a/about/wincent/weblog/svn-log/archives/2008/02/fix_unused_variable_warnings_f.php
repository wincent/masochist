...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix unused variable warnings for GC variables (wikitext,
      6f29a90)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_inline_is_not_at_beginning.php"
            >&laquo; Fix &quot;inline is not at beginning of declaration&quot;
            warning (wikitext, e5a1e6e)</a
          >
          |
        ...
        <p>
          These GC-related variables aren't used, but we don't want to be warned
          about that seeing as it is intentional (we just want them on the stack
          to prevent premature GC).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004187more"><div id="more"></div></div>
