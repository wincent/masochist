...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Instrument wikitext.c for benchmarking purposes
      (wikitext, 7c884ae)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/more_tokenization_specs_wikite.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_uri_matching_rule_wikitext.php"
            >&laquo; Add URI matching rule (wikitext, e956ebb)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/more_tokenization_specs_wikite.php"
            >More tokenization specs (wikitext, 53522a1) &raquo;</a
          >
        </p>
        ...
        <p>
          We want to measure the speed of raw tokenization (how fast the scanner
          can spit out tokens) so prepare a special function just for this
          purpose.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003867more"><div id="more"></div></div>
