...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update installation scripts (Synergy, 4cc7f58)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/more_resources_for_installer_s_1.php"
      title="More resources for installer (Synergy, 9e3a716)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/update_installation_scripts_sy_1.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/more_resources_for_installer_s_1.php"
            >&laquo; More resources for installer (Synergy, 9e3a716)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/update_installation_scripts_sy_1.php"
            >Update installation scripts (Synergy, 4cc7f58) &raquo;</a
          >
        </p>
        ...
        <p>
          This is a fairly thorough rewrite of the installation scripts for
          their new context (run within the Synergy build rather than as a build
          in a separate project).
        </p>

        <p>
          To make things cleaner all of the staging and preparation now takes
          place in the derived files directory rather than in the common build
          folder.
        </p>

        <p>
          Output is considerably less verbose, and the scripts now run with
          &quot;-e&quot; set so as to abort early in the event of an error.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003163more"><div id="more"></div></div>
