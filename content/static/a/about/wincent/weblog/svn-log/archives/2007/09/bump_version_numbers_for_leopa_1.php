...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Bump version numbers for Leopard series (Synergy,
      3a2e8ff)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/solution_for_exercise_117_snip.php"
            >&laquo; Solution for Exercise 1.17 (snippets, 3b62460)</a
          >
          |
        ...
        <p>
          The 3.5 series will be for Leopard only, while the 3.1.x series will
          continue to support legacy systems (currently as far back as Jaguar).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003128more"><div id="more"></div></div>
