...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2006/12/wocommon_r237_1_item_changed.php"
      title="WOCommon r237, 1 item changed"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2006/12/wocommon_r238_1_item_changed.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2006/12/wocommon_r237_1_item_changed.php"
            >&laquo; WOCommon r237, 1 item changed</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2006/12/wocommon_r238_1_item_changed.php"
            >WOCommon r238, 1 item changed &raquo;</a
          >
        </p>
        ...
        <p>
          Hook up user preferences for altering colors used in Dock icon. Also,
          now that the user has the option of setting the transparency of cover
          art displayed in the Dock must change the way the Dock icon badge
          border is drawn (ie. it must be an actual border rather than an
          underlay, otherwise it will be visible when showing semi-transparent
          art).
        </p>

        <div id="a001074more"><div id="more"></div></div>
