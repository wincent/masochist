...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add stack trace notes to WOHUDTableHeaderCell class
      (REnamer, 68eb428)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/highlight_on_mouse_click_renam.php"
            >&laquo; Highlight on mouse click (REnamer, 0efec76)</a
          >
          |
        ...
        <p>
          These stack traces were produced by setting breakpoints in critical
          methods in an otherwise-empty subclass to try and figure out the
          standard code paths.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003601more"><div id="more"></div></div>
