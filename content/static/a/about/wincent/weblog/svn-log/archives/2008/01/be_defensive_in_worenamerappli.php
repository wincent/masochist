...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Be defensive in WOREnamerApplicationIsFinder() (REnamer,
      0d90c7c)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/autosave_adjustments_renamer_4.php"
            >&laquo; Autosave adjustments (REnamer, 4428255)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/log_tweaks_renamer_623a800.php"
            >Log tweaks (REnamer, 623a800) &raquo;</a
          >
        </p>
        ...
        <p>
          Be prepared for NULL return values from the CF function calls. It's
          possible that in applications other than the Finder we could receive
          NULL here.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003688more"><div id="more"></div></div>
