...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Refactoring and new functions (Wincent Strings Utility,
      127e31d)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/whitespace_fixes_wincent_strin.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/whitespace_fixes_wincent_strin.php"
            >&laquo; Whitespace fixes (Wincent Strings Utility, e9cff5a)</a
          >
          |
        ...
        <p>
          This is part of a major clean-up to make way for some new
          functionality. The NSScanner category has been split off into a
          separate file, and a simple wrapper class has been added so as to
          eliminate the error-prone and tedious use of an NSDictionary to model
          an &quot;entry&quot;.
        </p>
        ...
        <p>
          The functions for handling the new options are in place but not hooked
          up yet.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003320more"><div id="more"></div></div>
