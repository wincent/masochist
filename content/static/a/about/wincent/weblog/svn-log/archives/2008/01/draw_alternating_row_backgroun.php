...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Draw alternating row backgrounds in HUD table view
      (REnamer, ee06d30)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/draw_dark_table_view_backgroun.php"
      title="Draw dark table view background in HUD (REnamer, dfab7f0)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_wohudtableheadercell_class.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/draw_dark_table_view_backgroun.php"
            >&laquo; Draw dark table view background in HUD (REnamer,
            dfab7f0)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_wohudtableheadercell_class.php"
            >Add WOHUDTableHeaderCell class (REnamer, 595ca86) &raquo;</a
          >
        </p>
        ...
        <p>
          This is a preliminary implementation that only has effect in the
          populated rows. A subsequent commit will handle drawing the background
          in unpopulated rows.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003594more"><div id="more"></div></div>
