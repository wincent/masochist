...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Whitespace fixup for defaults property list (Synergy,
      479580c)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/reduce_default_button_spacing_1.php"
      title="Reduce default button spacing to 0 pixels (Synergy, b053a91)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/whitespace_fixup_for_defaults_1.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/reduce_default_button_spacing_1.php"
            >&laquo; Reduce default button spacing to 0 pixels (Synergy,
            b053a91)</a
          >
          |
        ...
        <p>
          Use tabs consistently (previously there were mixed hard tabs and soft
          tabs).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002852more"><div id="more"></div></div>
