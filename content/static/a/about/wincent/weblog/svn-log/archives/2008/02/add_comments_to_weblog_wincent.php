...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add comments to weblog (wincent.dev, 5559ac9)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/many_cosmetic_changes_wincentc.php"
      title="Many cosmetic changes (wincent.dev, 4d0860c)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/inline_moderation_of_post_comm.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/many_cosmetic_changes_wincentc.php"
            >&laquo; Many cosmetic changes (wincent.dev, 4d0860c)</a
          >
          |
        ...
        <h3>Add comments to weblog (wincent.dev, 5559ac9)</h3>

        <p>
          This required some nasty dynamic programming due to the nature of
          nested polymorphic associations. Basically if you want to avoid having
          to repeat basically the same comment form for all your
          &quot;commentable&quot; models (which would almost entirely defeat the
          purpose of having a polymorphic comments model in the first place)
          then you have to jump through some hoops at runtime to figure out
          which resource you are nested inside at runtime.
        </p>

        <p>
          The other change which tags along for the ride here is per-page page
          title overrides.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004100more"><div id="more"></div></div>
