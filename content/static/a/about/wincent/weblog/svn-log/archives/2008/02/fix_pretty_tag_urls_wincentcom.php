...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Fix pretty tag URLs (wincent.dev, 339a076)</title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/first_cut_at_wiki_functionalit.php"
            >&laquo; First cut at wiki functionality (wincent.dev, b451c58)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/move_scaled_tag_helper_functio.php"
            >Move scaled_tag helper function into application helper
            (wincent.dev, 57f734a) &raquo;</a
          >
        </p>

        <h2>February 8, 2008</h2>

        <h3>Fix pretty tag URLs (wincent.dev, 339a076)</h3>

        <p>These weren't working due to a misnamed param key.</p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004063more"><div id="more"></div></div>
