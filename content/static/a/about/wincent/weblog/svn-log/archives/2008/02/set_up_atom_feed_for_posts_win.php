...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Set up Atom feed for posts (wincent.dev, 02f8381)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/ignore_coverage_subdirectory_w.php"
      title="Ignore coverage subdirectory (wincent.dev, bb4ed11)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/extract_recent_finder_into_pos.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/ignore_coverage_subdirectory_w.php"
            >&laquo; Ignore coverage subdirectory (wincent.dev, bb4ed11)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/extract_recent_finder_into_pos.php"
            >Extract &quot;recent&quot; finder into Post model (wincent.dev,
            1fa464b) &raquo;</a
          >
        </p>
        ...
        <h3>Set up Atom feed for posts (wincent.dev, 02f8381)</h3>

        <p>
          We use a custom atom field helper seeing as the one that comes with
          Rails can't handle resources with a :controller override in the routes
