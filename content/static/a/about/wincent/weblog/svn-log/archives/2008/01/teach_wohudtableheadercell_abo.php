...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Teach WOHUDTableHeaderCell about flipped coordinate
      systems (REnamer, f19e388)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/do_universal_pcre_builds_in_re.php"
            >&laquo; Do Universal PCRE builds in Release builds only (REnamer,
            b580c6d)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/silence_gcc_warning_about_sign.php"
            >Silence GCC warning about signed/unsigned comparison (REnamer,
            a5f6563) &raquo;</a
          >
        </p>
        ...
        <h3>
          Teach WOHUDTableHeaderCell about flipped coordinate systems (REnamer,
          f19e388)
        </h3>

        <p>
          Draw the sort indicator differently for flipped coordinate systems.
          Note that this commit is really only about technical correctness and
          forwards compatability seeing as the coordinate system is not actually
          flipped by default.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003637more"><div id="more"></div></div>
