...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Use shared support folder for executables (gdiff,
      64aadbd)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/locate_installertool_as_normal.php"
      title="Locate installer-tool as normal resource (gdiff, 5d40d99)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/factor_out_calls_to_authorizat.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/locate_installertool_as_normal.php"
            >&laquo; Locate installer-tool as normal resource (gdiff,
            5d40d99)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/factor_out_calls_to_authorizat.php"
            >Factor out calls to AuthorizationFree (gdiff, 2552ca2) &raquo;</a
          >
        </p>
        ...
        <p>
          Using the shared support folder rather than the localizable resources
          folder should be more secure as it reduces the number of possible
          sites in which an attacker could substitute a hostile binary.
        </p>

        <p>
          As noted elsewhere in the source, these types of security measures are
          an unwinnable battle; basically any application that runs with
          elevated privileges should be considered vulnerable of other users
          have write access to any part of it. Despite this, a &quot;defense in
          depth&quot; strategy suggests that plugging these minor holes is still
