...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/add_first_of_two_scroll_views.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/read_in_sample_files_at_launch.php"
            >&laquo; Read in sample files at launch (gdiff, d86a598)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/add_first_of_two_scroll_views.php"
            >Add first of two scroll views (gdiff, 390c5b3) &raquo;</a
          >
        </p>
        ...
        <p>
          Add back in a missing header import. This was actually in there before
          but I shot myself in the foot trying to amend the last commit (used
          git-reset when I should have used git-checkout; all I wanted to do was
          exclude a file from the commit that I really wanted to be in a
          separate, later commit). In reconstructing the history I missed out
          the header import. Rather than rewrite the history again I'll just
          chalk this up as a lesson learned and do this as a separate commit.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002983more"><div id="more"></div></div>
