    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/replace_nibs_with_xibs_gdiff_f.php"
            >&laquo; Replace nibs with xibs (gdiff, f9735df)</a
          >
          |
        ...
        <p>
          Add some sample files that will be used to scaffold development of the
          gdiff view code. These files are expected to be in the ~/tmp directory
          at runtime.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002980more"><div id="more"></div></div>
