...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Report parse errors on failure (gdiff, 694ee81)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/add_512x512_version_of_icon_sy_1.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/replace_atoi_with_explicit_con.php"
            >&laquo; Replace atoi() with explicit conversion (gdiff, 5e549a8)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/add_512x512_version_of_icon_sy_1.php"
            >Add 512x512 version of icon (Synergy Advance, 1b6f921) &raquo;</a
          >
        </p>
        ...
        <p>
          In addition to returning nil when a parse failure occurs, we now print
          a diagnostic message to the console containing line number
          information.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002931more"><div id="more"></div></div>
