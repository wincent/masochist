...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Factor out color macros into WOHUD.h (REnamer, cd6174e)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_offbyone_error_in_corner_v.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_offbyone_error_in_corner_v.php"
            >&laquo; Fix off-by-one error in corner view (REnamer, 12253da)</a
          >
          |
        ...
        <p>
          The color macros were all defined in WOHUDTableView.h, seeing as that
          was the first class I made when starting work on the HUD controls.
        </p>

        <p>
          This was a bit of an anomaly, as other HUD classes had to include the
          table view header even if they had nothing to do with it.
        </p>

        <p>
          So extract the color macros out into a separate file, WOHUD.h, and
