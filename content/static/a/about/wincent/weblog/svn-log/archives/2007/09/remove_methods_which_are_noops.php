...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove methods which are no-ops under Garbage Collection
      (WOCommon, ca1fae3)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/cleanup_wosingleton_header_woc.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/dump_pathforfolderdomain_test.php"
            >&laquo; Dump pathForFolder:domain: test (WOCommon, 06a34ee)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/cleanup_wosingleton_header_woc.php"
            >Cleanup WOSingleton header (WOCommon, a463e15) &raquo;</a
          >
        </p>
        ...
        <h3>
          Remove methods which are no-ops under Garbage Collection (WOCommon,
          ca1fae3)
        </h3>

        <p>
          Methods like retain, release and so forth were implemented as no-op
          operations for the WOSingleton class. Now, under Garbage Collection,
          not only are they no-ops but the compiler will never actually generate
          any message sends for those selectors. So this commit now removes the
          unneeded methods completely.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002713more"><div id="more"></div></div>
