...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix UTF-8 regular expression matching (REnamer, e1df3cb)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/disallow_keyboardbased_selecti.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/disallow_keyboardbased_selecti.php"
            >&laquo; Disallow keyboard-based selection in preview table view
            (REnamer, f1ca6cc)</a
          >
          |
        ...
        <p>
          Add tests to explore known issues with matching UTF-8 text. Add an
          errorCode property so that callers can distinguish between non-fatal
          (eg. no match) and fatal (eg. bad UTF-8) errors in pcre_exec().
        </p>

        <p>
          The actual cause of the problem was that I was passing in the string
          length in characters rather than bytes.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003630more"><div id="more"></div></div>
