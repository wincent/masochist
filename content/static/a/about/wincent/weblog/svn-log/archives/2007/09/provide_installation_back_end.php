...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Provide installation back end (gdiff, 519e7e3)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/hook_up_user_interface_for_too.php"
            >&laquo; Hook up user interface for tool installation (gdiff,
            194c4f9)</a
          >
          |
        ...
        <p>
          First draft of installation back end added to main application
          controller.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002963more"><div id="more"></div></div>
