...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Use ISO-8859-1 (Latin 1) rather than Mac OS Roman
      encoding (REnamer, 73eaf15)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/tell_preview_scroll_view_not_t.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/test_updates_for_pcre_75_renam.php"
            >&laquo; Test updates for PCRE 7.5 (REnamer, 6748f90)</a
          >
          |
        ...
        <h3>
          Use ISO-8859-1 (Latin 1) rather than Mac OS Roman encoding (REnamer,
          73eaf15)
        </h3>

        <p>
          This seems to be closer to the actual encoding used in the test input
          files.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003570more"><div id="more"></div></div>
