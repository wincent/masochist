    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/remove_unused_variable_synergy.php"
            >&laquo; Remove unused variable (Synergy, 3dc2d5c)</a
          >
          |
        ...
        <p>
          Remove information on Subversion externals and replace it with info on
          relative project locations.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003433more"><div id="more"></div></div>
