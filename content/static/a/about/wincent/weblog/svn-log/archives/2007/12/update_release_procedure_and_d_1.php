...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update release procedure and development notes (Synergy,
      10bd7f6)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/update_release_procedure_and_d.php"
      title="Update release procedure and development notes (Synergy, 10bd7f6)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/remove_nsmenuextra_header_syne.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/update_release_procedure_and_d.php"
            >&laquo; Update release procedure and development notes (Synergy,
            10bd7f6)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/remove_nsmenuextra_header_syne.php"
            >Remove NSMenuExtra header (Synergy, d6cee75) &raquo;</a
          >
        </p>
        ...
        <p>
          ...
          still references to CVS in there, for example, and that was phased out
          a long time ago in favor of Subversion, then SVK and finally Git.
        </p>

        <p>So prune the irrelevant bits.</p>

        <p>
          This commit also includes a simple shell script for tagging releases
          in Git; seeing as each release should really be tagged in at least
          three repositories (Synergy itself, WOCommon and WOPublic), it's
          easier to do this with a single script.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003405more"><div id="more"></div></div>
