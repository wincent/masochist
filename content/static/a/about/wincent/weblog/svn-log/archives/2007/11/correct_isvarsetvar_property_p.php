...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Correct isVar/setVar property pattern in WOHost class
      (WOCommon, ad1d71f)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/add_missing_property_declarati.php"
            >&laquo; Add missing property declaration to WOHost class (WOCommon,
            93f1f1f)</a
          >
          |
        ...
        <p>
          Implementing the isVar/setVar pattern requires an explicit
