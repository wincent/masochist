...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Force way to front on launch (REnamer, 2670577)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_nsdrawer_delegate_methods.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/minor_formatting_cleanup_in_ma.php"
            >&laquo; Minor formatting clean-up in main controller header
            (REnamer, 4f92fa7)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_nsdrawer_delegate_methods.php"
            >Add NSDrawer delegate methods (REnamer, 921ccc5) &raquo;</a
          >
        </p>
        ...
        <p>
          This is necessary when launched from within the Finder plug-in because
          in that case we do not come to the front and the user may not even
          release that we've launched.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003685more"><div id="more"></div></div>
