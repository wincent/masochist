...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add Leopard notes to nightlies script (snippets,
      91dbeaa)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/remove_synergy_jaguar_target_f.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/remove_synergy_jaguar_target_f.php"
            >&laquo; Remove Synergy Jaguar target from nightlies script
            (snippets, 12afe37)</a
          >
          |
        ...
        <p>
          Add download links for Tiger versions of the software (the nightlies
          themselves are targetted for Leopard).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003387more"><div id="more"></div></div>
