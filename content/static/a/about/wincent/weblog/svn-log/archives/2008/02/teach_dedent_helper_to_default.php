...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Teach dedent helper to default to 6 spaces (wikitext,
      e0ba800)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/update_ul_spec_to_use_indentat.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/update_ul_spec_to_use_indentat.php"
            >&laquo; Update ul spec to use indentation helper (wikitext,
            ea4a291)</a
          >
          |
        ...
        <p>
          Now that I've converted all the specs I see that in every single case
          I dedenting by 6 spaces. So teach the dedent helper to assume 6 spaces
          if passed only one parameter.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004060more"><div id="more"></div></div>
