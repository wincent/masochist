...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add early returns to the rollback functions (wikitext,
      1c5c4a6)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_pre_start_and_pre_end_to_t.php"
      title="Add PRE_START and PRE_END to token.c (wikitext, c9137ef)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/rely_on_automated_early_return.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_pre_start_and_pre_end_to_t.php"
            >&laquo; Add PRE_START and PRE_END to token.c (wikitext, c9137ef)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/rely_on_automated_early_return.php"
            >Rely on automated early return from rollback functions (wikitext,
            1dacef0) &raquo;</a
          >
        </p>
        ...
        <p>
          This should make life easier for callers who may want to rollback but
          aren't sure: basically they can just rollback anyway and if there is
          nothing to be done the functions will return early.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004041more"><div id="more"></div></div>
