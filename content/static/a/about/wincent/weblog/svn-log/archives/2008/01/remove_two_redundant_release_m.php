...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove two redundant release messages (REnamer, 1ef4055)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/note_possible_further_renaming.php"
            >&laquo; Note possible further renaming of error properties
            (REnamer, 962112a)</a
          >
          |
        ...
        <p>
          There were still two release messages in the codebase that somehow
          escaped detection until now. These are useless under Garbage
          Collection, so remove them.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003755more"><div id="more"></div></div>
