...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Readability improvements to NSBezierPath category
      (WOBezel, 3e23a51)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/modify_nscursor_category_for_g.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/code_cleanup_for_garbage_colle.php"
            >&laquo; Code clean-up for garbage collection (WOTest, 2eab9a2)</a
          >
          |
        ...
        <p>
          Wrapping and column-alignment changes to make the
          appendRoundedRectanglePath:radius: method in the NSBezierPath category
          more readable.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002612more"><div id="more"></div></div>
