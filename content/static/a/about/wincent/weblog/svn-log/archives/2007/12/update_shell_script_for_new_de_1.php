...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update shell script for new development language path
      (Synergy, a0adca5)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/update_shell_script_for_new_de.php"
      title="Update shell script for new development language path (Synergy, a0adca5)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/call_mainviewdidload_when_show.php"
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <h3>
          Update shell script for new development language path (Synergy,
          a0adca5)
        </h3>
        ...
        <div id="a003416more"><div id="more"></div></div>
