...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add specs for and fix bugs in Taggable module
      (wincent.dev, 719595d)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/refactoring_directory_organiza.php"
      title="Refactoring (directory organization) for acts_as_taggable (wincent.dev, 36d2f80)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_notes_to_taggable_spec_win.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/refactoring_directory_organiza.php"
            >&laquo; Refactoring (directory organization) for acts_as_taggable
            (wincent.dev, 36d2f80)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_notes_to_taggable_spec_win.php"
            >Add notes to Taggable spec (wincent.dev, 7d06fda) &raquo;</a
          >
        </p>
        ...
        <p>
          This commit adds specs for the three public methods of the Taggable
          module, corrects a couple of minor bugs discovered during testing
          (unexpected behaviour of the split method, and typo in a variable
          name), as well as setting up a destroy trigger for taggings which
