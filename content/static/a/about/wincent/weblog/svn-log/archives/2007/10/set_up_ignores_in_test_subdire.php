...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Set up ignores in test subdirectory (wincent.dev,
      0169c6c)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/update_scriptspec_wincentcom_5.php"
            >&laquo; Update script/spec (wincent.dev, 57f43c1)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_stories_subdirectory_wince.php"
            >Add stories subdirectory (wincent.dev, 521539e) &raquo;</a
          >
        </p>

        <h2>October 15, 2007</h2>

        <h3>Set up ignores in test subdirectory (wincent.dev, 0169c6c)</h3>

        <p>
          Set up a gitignore file to ignore everything inside the test
          subdirectory.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003074more"><div id="more"></div></div>
