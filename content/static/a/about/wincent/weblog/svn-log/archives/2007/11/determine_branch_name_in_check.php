...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Determine branch name in check-series script (snippets,
      adccbc7)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/add_checkseries_script_snippet.php"
      title="Add check-series script (snippets, 2815a0f)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/add_scripts_to_xcode_project_s.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/add_checkseries_script_snippet.php"
            >&laquo; Add check-series script (snippets, 2815a0f)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/add_scripts_to_xcode_project_s.php"
            >Add scripts to Xcode project (Synergy, 53bdfaf) &raquo;</a
          >
        </p>
        ...
        <p>
          Previously we just made comparisons against the &quot;origin&quot;,
          and while this worked fine for topic branches forked off of the
          &quot;master&quot; branch, it fell down for those forked off something
          else (like the &quot;next&quot; branch, for example).
        </p>

        <p>
          In order to get the list of commits that really belong to the topic
          branch and only the topic branch we would need to compare against
          &quot;origin/next&quot; in the case of the &quot;next&quot; example.
        </p>

        <p>
          This commit adds code for automatically detecting what branch we are
          on (by reading and parsing GIT_DIR/HEAD), finding out the
          &quot;remote&quot; and &quot;merge&quot; values for that branch, and
          then using them to get an accurate list of the commits unique to the
          topic branch.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003157more"><div id="more"></div></div>
