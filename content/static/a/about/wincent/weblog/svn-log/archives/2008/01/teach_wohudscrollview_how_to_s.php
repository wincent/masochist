...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Teach WOHUDScrollView how to scroll (REnamer, 46da7d1)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/extract_arrowstogether_method.php"
      title="Extract arrowsTogether method and other cleanup (REnamer, 4ed8742)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/prepare_for_highlighting_the_k.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/extract_arrowstogether_method.php"
            >&laquo; Extract arrowsTogether method and other cleanup (REnamer,
            4ed8742)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/prepare_for_highlighting_the_k.php"
            >Prepare for highlighting the knob in the WOHUDScroller class
            (REnamer, c1a4b63) &raquo;</a
          >
        </p>
        ...
        <p>
          NSScrollView doesn't implement the scrollPageUp:, scrollPageDown:,
          scrollLineUp: and scrollLineDown: methods (not sure why; as such the
          embedded class generally has to do this). Seeing as our scroll view
          has all the information necessary to implement these methods, do so,
          thus keeping all the movement code to the scroll view itself.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003653more"><div id="more"></div></div>
