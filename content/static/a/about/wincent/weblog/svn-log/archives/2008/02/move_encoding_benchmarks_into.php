...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Move encoding benchmarks into separate subdirectory
      (wikitext, 4aaffb1)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/set_up_a_tokenizing_benchmark.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/numerous_changes_to_get_tokeni.php"
            >&laquo; Numerous changes to get tokenization benchmarks working
            (wikitext, 1d6b2f1)</a
          >
          |
        ...
        <p>
          As I'll be adding more benchmarks it makes sense to start stashing
          them in a separate subdirectory.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003871more"><div id="more"></div></div>
