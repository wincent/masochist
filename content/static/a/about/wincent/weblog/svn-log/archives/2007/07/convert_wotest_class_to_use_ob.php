...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Convert WOTest class to use Objective-C 2.0 properties
      (WOTest, f2d45e3)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/alignment_fixes_wotest_ae704ac.php"
      title="Alignment fixes (WOTest, ae704ac)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/use_anonymous_private_categori.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/alignment_fixes_wotest_ae704ac.php"
            >&laquo; Alignment fixes (WOTest, ae704ac)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/use_anonymous_private_categori.php"
            >Use anonymous private categories (WOTest, cb0f52f) &raquo;</a
          >
        </p>
        ...
        <h3>
          Convert WOTest class to use Objective-C 2.0 properties (WOTest,
          f2d45e3)
        </h3>

        <p>
          This commit converts most of the accessors for the instance variables
          in the WOTest class to Objective-C 2.0 properties.
        </p>

        <p>
          At the same time some unused instance variables were disposed of or
          marked for future deprecation.
        </p>

        <p>
          Note that due to an apparent bug in the compiler I was unable to
          implement the public-readonly/private-readwrite pattern as suggested
          in the documentation, and so the readonly/readwrite portions are
          commented out. I will be making a reduced test case for this and
          filing a Radar. Watch for a future commit that adds the Radar number
          in a comment.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002605more"><div id="more"></div></div>
