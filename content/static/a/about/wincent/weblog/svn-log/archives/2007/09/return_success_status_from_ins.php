...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Return success status from installer tool (gdiff,
      5ecde66)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/add_missing_null_in_call_to_ex.php"
            >&laquo; Add missing NULL in call to execve (gdiff, 3fd4457)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/make_installation_window_key_g.php"
            >Make installation window key (gdiff, 42890f6) &raquo;</a
          >
        </p>
        ...
        <p>
          The installer tool wasn't indicating success status to the parent,
          only failure.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002975more"><div id="more"></div></div>
