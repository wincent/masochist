...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Additional notes about check macro usage (WOPublic,
      0080b3d)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_wopublic_to_project_as_fol.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_wopublic_to_project_as_fol.php"
            >&laquo; Add WOPublic to project as folder reference (WOCommon,
            153e314)</a
          >
          |
        ...
        <p>
          Add note recommending the use of check macros (rather than assertion
          macros) in unit tests.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002920more"><div id="more"></div></div>
