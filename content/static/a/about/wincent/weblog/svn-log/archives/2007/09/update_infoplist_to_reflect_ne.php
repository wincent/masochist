...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update Info.plist to reflect new document class (gdiff,
      dd4f9e0)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/remove_redundant_system_header.php"
      title="Remove redundant system header imports (gdiff, 4e63885)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/add_application_controller_gdi.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/remove_redundant_system_header.php"
            >&laquo; Remove redundant system header imports (gdiff, 4e63885)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/add_application_controller_gdi.php"
            >Add application controller (gdiff, bb5fad2) &raquo;</a
          >
        </p>
        ...
        <p>
          The refactoring tools provided with Xcode don't actually handle all
          the places where renaming a class may require changes to be made. In
          this case the Info.plist file's NSDocumentClass key still had a stale
          value.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002957more"><div id="more"></div></div>
