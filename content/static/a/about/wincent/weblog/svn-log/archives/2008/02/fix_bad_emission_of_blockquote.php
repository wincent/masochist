...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix bad emission of BLOCKQUOTE inside NO_WIKI spans
      (wikitext, f8384a1)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/initial_handling_of_pre_start.php"
      title="Initial handling of PRE_START and PRE_END in the parser (wikitext, e2ee2bb)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_a_bunch_more_pre_specs_wik.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/initial_handling_of_pre_start.php"
            >&laquo; Initial handling of PRE_START and PRE_END in the parser
            (wikitext, e2ee2bb)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_a_bunch_more_pre_specs_wik.php"
            >Add a bunch more PRE specs (wikitext, 48a3f27) &raquo;</a
          >
        </p>
        ...
        <h3>
          Fix bad emission of BLOCKQUOTE inside NO_WIKI spans (wikitext,
          f8384a1)
        </h3>

        <p>
          Here we were emitting a literally greater-than sign when we should
          have been producing a named entity.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004044more"><div id="more"></div></div>
