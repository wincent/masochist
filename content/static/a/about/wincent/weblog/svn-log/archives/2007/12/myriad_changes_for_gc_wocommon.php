...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/add_new_login_api_files_to_pro.php"
      title="Add new login API files to project (WOCommon, 9e5d357)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/switch_to_new_launch_services.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/add_new_login_api_files_to_pro.php"
            >&laquo; Add new login API files to project (WOCommon, 9e5d357)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/switch_to_new_launch_services.php"
            >Switch to new Launch Services code in WOCommon (login-tool,
            f0a9c33) &raquo;</a
          >
        </p>
        ...
        <p>
          Although this is by no means complete, this commit makes myriad
          changes to many classes and categories for Garbage Collection.
          Autorelease pool release calls have been replaced with drain calls,
          no-op retains, releases and autoreleases have been removed, simpler
          initialization idioms have been used in many places, some variables
          have been renamed for clarity (where previously a temporary mutable
          object was created and then an immutable copy returned we now just
          return the mutable one), and convenience creation methods have been
          deprecated in favor of a simpler copy idiom.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003245more"><div id="more"></div></div>
