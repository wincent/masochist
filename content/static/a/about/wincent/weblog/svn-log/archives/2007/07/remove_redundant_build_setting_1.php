...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove redundant build settings (WOBezel, 4f5a8a9)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/huge_whitespace_cleanup_synerg.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/huge_whitespace_cleanup_synerg.php"
            >&laquo; Huge whitespace cleanup (Synergy, 6705ceb)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/upgrade_xcode_project_bundle_w.php"
            >Upgrade Xcode project bundle (WOBezel, 65bf93c) &raquo;</a
          >
        </p>
        ...
        <p>
          Remove redundant build settings on aggregate targets, leaving only the
          PRODUCT_NAME intact (necessary for dependency analysis).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002596more"><div id="more"></div></div>
