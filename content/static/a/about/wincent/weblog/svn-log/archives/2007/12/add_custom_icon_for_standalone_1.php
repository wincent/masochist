...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add custom icon for standalone preferences application
      (Synergy, 0bd5383)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/add_custom_icon_for_standalone.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/use_more_appropriate_git_comma.php"
            >Use more appropriate Git commands (buildtools, abd6284) &raquo;</a
          >
        </p>
        ...
        <h3>
          Add custom icon for standalone preferences application (Synergy,
          0bd5383)
        </h3>
        ...
        <div id="a003403more"><div id="more"></div></div>
