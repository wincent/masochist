...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Initial cut at &quot;issues&quot; controller index
      (wincent.dev, ff28775)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/remove_commented_out_css_wince.php"
      title="Remove commented out CSS (wincent.dev, 61f798b)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/remove_localization_code_wince.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/remove_commented_out_css_wince.php"
            >&laquo; Remove commented out CSS (wincent.dev, 61f798b)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/remove_localization_code_wince.php"
            >Remove localization code (wincent.dev, 285fd68) &raquo;</a
          >
        </p>
        ...
        <h3>
          Initial cut at &quot;issues&quot; controller index (wincent.dev,
          ff28775)
        </h3>

        <p>
          Simplify the model by removing the supporting &quot;statuses&quot;
          class. There is no need for this kind of dynamic complexity, and not
          only that, we can use the same three basic hard-coded statuses (new,
          in-progress and closed) for all issue types (bug reports, feature
          requests, support tickets, feedback etc); there is really no call for
          fine-grained statuses like &quot;closed (duplicate)&quot;,
          &quot;worksforme&quot; and the like, as they serve only to confuse
          users.
        </p>

        <p>
          In order to get pagination and sorting working I had to teach both the
          paginator and the sortable module to pass on the relevant query
          parameters when generating URLs.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004132more"><div id="more"></div></div>
