...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Teach ary_entry to handle negative offsets (wikitext,
      5747c2f)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_no_item_macro_to_aryh_wiki.php"
      title="Add NO_ITEM macro to ary.h (wikitext, d892368)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_up_remainer_sites_to_use_n.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_no_item_macro_to_aryh_wiki.php"
            >&laquo; Add NO_ITEM macro to ary.h (wikitext, d892368)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_up_remainer_sites_to_use_n.php"
            >Fix up remainer sites to use new array API (wikitext, 6ca4415)
            &raquo;</a
          >
        </p>
        ...
        <p>
          We sometimes pass in values like -1 to ask for the last item in the
          array.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003889more"><div id="more"></div></div>
