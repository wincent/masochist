...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Hook up Help menu item in Synergy Preferences (Synergy,
      ff31fab)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/update_lists_synergy_18a8530.php"
            >&laquo; Update lists (Synergy, 18a8530)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/update_readme_file_to_include.php"
            >Update README file to include upgrade instructions (Synergy,
            fc2cb8c) &raquo;</a
          >
        </p>
        ...
        <h3>
          Hook up Help menu item in Synergy Preferences (Synergy, ff31fab)
        </h3>

        <p>
          For the time being this just takes the user to the online
