...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Draw top and bottom borders in file source list (gdiff,
      094f018)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/fix_drawing_glitches_in_source.php"
      title="Fix drawing glitches in source list (gdiff, b001fe1)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/make_file_source_list_table_co.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/fix_drawing_glitches_in_source.php"
            >&laquo; Fix drawing glitches in source list (gdiff, b001fe1)</a
          >
          |
        ...
        <p>
          This is a preliminary attempt at drawing top and bottom borders in the
          file source list. Some visual glitches may be visible near the bottom
          border if the window is rapidly resized; the cause of these will need
          to be investigated. Also, given that the borders are being drawn just
          inside the view it is possible that they could overlap content inside
          the view; it may be necessary to find a way to somehow inset the
          content or instead perform the drawing elsewhere (the split view
          itself may be a good candidate for this as it would localize all top
          and bottom border drawing to a single place in the code).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003011more"><div id="more"></div></div>
