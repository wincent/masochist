...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Basic blockquote implementation using real HTML tags
      (wikitext, 88da5f3)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/update_list_and_header_rules_f.php"
            >&laquo; Update list and header rules for new BLOCKQUOTE_START token
            (wikitext, 9e985ab)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/more_blockquote_specs_and_one.php"
            >More blockquote specs and one fix for nested pre blocks (wikitext,
            b6e1984) &raquo;</a
          >
        </p>
        ...
        <h3>
          Basic blockquote implementation using real HTML tags (wikitext,
          88da5f3)
        </h3>

        <p>
          Still need to write more specs to be sure I've covered all the edge
          cases, but the basic stuff seems to work.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004049more"><div id="more"></div></div>
