...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Move link encoding function and make it easier to call
      (wikitext, b5b252b)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_spec_for_unterminated_nowi.php"
      title="Add spec for unterminated nowiki span in external link text (wikitext, 0380619)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/prepare_for_prepending_interna.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_spec_for_unterminated_nowi.php"
            >&laquo; Add spec for unterminated nowiki span in external link text
            (wikitext, 0380619)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/prepare_for_prepending_interna.php"
            >Prepare for prepending internal link prefixes to internal links
            (wikitext, b796dcc) &raquo;</a
          >
        </p>
        ...
        <h3>
          Move link encoding function and make it easier to call (wikitext,
          b5b252b)
        </h3>

        <p>
          Just pass a VALUE (Ruby string) rather than a pointer and a length,
          and move the function up near the top of the file where it can be used
