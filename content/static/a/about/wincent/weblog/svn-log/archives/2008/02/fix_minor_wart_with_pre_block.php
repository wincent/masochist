...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix minor wart with pre block closing (wikitext,
      172a51c)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/tweak_newline_emission_of_pre.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/use_custom_string_struct_to_st.php"
            >&laquo; Use custom string struct to store line endings (wikitext,
            bf8a30f)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/tweak_newline_emission_of_pre.php"
            >Tweak newline emission of pre blocks (wikitext, b364c14) &raquo;</a
          >
        </p>
        ...
        <p>
          Under some circumstances (unnested pre block followed by two
          consecutive newlines) we would emit a block that looked like this:
        </p>
        ...
        <p>
          While the former displayed fine in the browser, the latter looks
          better in the HTML source.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004009more"><div id="more"></div></div>
