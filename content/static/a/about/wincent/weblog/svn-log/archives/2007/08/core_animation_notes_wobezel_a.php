...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/modifications_to_woalertbezelv.php"
      title="Modifications to WOAlertBezelView class for garbage collection (WOBezel, 50e8fed)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/objectivec_20_modernization_wo.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/modifications_to_woalertbezelv.php"
            >&laquo; Modifications to WOAlertBezelView class for garbage
            collection (WOBezel, 50e8fed)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/objectivec_20_modernization_wo.php"
            >Objective-C 2.0 modernization (WOBezel, e67aedb) &raquo;</a
          >
        </p>
        ...
        <p>
          Core Animation makes a lot of the code currently in the WOWindow class
          redundant. This commit adds some notes noting changes which will be
          required in order to remove to Core Animation; this is a desirable
          move to make because it will simplify the code and reduce the memory
          footprint.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002616more"><div id="more"></div></div>
