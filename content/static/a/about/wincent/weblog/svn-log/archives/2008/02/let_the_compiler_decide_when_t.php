...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Let the compiler decide when to inline (wikitext,
      cf1128c)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_bug_in_trim_link_target_fu.php"
      title="Fix bug in &amp;quot;trim link target&amp;quot; function (wikitext, 44d9cec)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_spelling_error_in_benchmar.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_bug_in_trim_link_target_fu.php"
            >&laquo; Fix bug in &quot;trim link target&quot; function (wikitext,
            44d9cec)</a
          >
          |
        ...
        <p>
          ...
          that the linker errors went away (they did) but it turns out that
          there was a secondary benefit: the compiler is actually much smarter
          than me, because when I leave things up to the compiler instead of
          explicitly requesting inlining, the spec suite runs 10 to 20% faster.
          There is quite a bit of Ruby/RSpec overhead in the spec suite, so the
          speed improvement of the parser itself is probably significantly more.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004190more"><div id="more"></div></div>
