...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Simplify custom table header cell calculations (REnamer,
      df8c2af)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/teach_hud_corner_view_to_draw.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/teach_hud_corner_view_to_draw.php"
            >&laquo; Teach HUD corner view to draw lower border (REnamer,
            8a39fdf)</a
          >
          |
        ...
        <p>
          Rather than creating an entirely new rectangle and specifying all the
          dimensions, just modify an existing one.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003669more"><div id="more"></div></div>
