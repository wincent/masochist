...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Append extra blank lines at end of output (buildtools,
      c71d3c1)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/automatically_append_wildcard.php"
      title="Automatically append wildcard to tag prefix (buildtools, 579267c)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/produce_release_notes_from_mul.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/automatically_append_wildcard.php"
            >&laquo; Automatically append wildcard to tag prefix (buildtools,
            579267c)</a
          >
          |
        ...
        <p>
          ...
          multiple repositories we may end up invoking the ReleaseNotes.sh
          script several time, successively appending more and more output to
          the generated notes.
        </p>

        <p>
          Add two extra line feeds to make this easier: one because &quot;git
          log&quot; doesn't seem to emit one, and another to provide visual
          separation between sections.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003768more"><div id="more"></div></div>
