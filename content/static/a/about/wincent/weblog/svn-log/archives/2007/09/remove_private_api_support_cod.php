...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove private API support code (WOTest, 2e0037d)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/replace_nibs_with_xibs_gdiff_f.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/use_new_thread_apis_gdiff_5130.php"
            >&laquo; Use new thread APIs (gdiff, 513091e)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/replace_nibs_with_xibs_gdiff_f.php"
            >Replace nibs with xibs (gdiff, f9735df) &raquo;</a
          >
        </p>
        ...
        <p>
          The signatureWithObjCTypes: method in NSMethodSignature is at last
          exposed in Leopard, so remove the all the support code that was
          previously used to (carefully) work with (or around) it and just use
          the now-official API.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002860more"><div id="more"></div></div>
