...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Many cosmetic changes (wincent.dev, 4d0860c)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/use_303_response_for_link_redi.php"
            >&laquo; Use 303 response for link redirection in links controller
            (wincent.dev, 96a1203)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_comments_to_weblog_wincent.php"
            >Add comments to weblog (wincent.dev, 5559ac9) &raquo;</a
          >
        </p>

        <h2>February 14, 2008</h2>

        <h3>Many cosmetic changes (wincent.dev, 4d0860c)</h3>

        <p>
          These are tweaks to the CSS, additional graphics and juggling around
          some links in the articles and posts controllers.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004099more"><div id="more"></div></div>
