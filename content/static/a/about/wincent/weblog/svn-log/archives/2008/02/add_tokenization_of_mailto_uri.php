...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add tokenization of mailto URIs (wikitext, c70f28a)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_specs_for_questionable_or.php"
      title="Add specs for questionable or invalid links (wikitext, b00e7b1)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_support_for_https_uris_wik.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_specs_for_questionable_or.php"
            >&laquo; Add specs for questionable or invalid links (wikitext,
            b00e7b1)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_support_for_https_uris_wik.php"
            >Add support for HTTPS URIs (wikitext, 06a4b58) &raquo;</a
          >
        </p>
        ...
        <p>
          We already had tokenization of email addresses, which in combination
          with autolinking gave us clickable email address links.
        </p>

        <p>
          Now we have tokenization of &quot;mailto&quot; URIs, which means that
          we now also have the option of using the standard external link
          syntax, like we would with any other URI, to provide the link text
          rather than just making the address itself clickable.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004023more"><div id="more"></div></div>
