...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update configuration to use larger backup volume
      (snippets, a46c336)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/expand_tabs_when_calculating_l.php"
            >&laquo; Expand tabs when calculating line widths (snippets,
            5aa35b9)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/increase_backup_frequency_snip.php"
            >Increase backup frequency (snippets, 29c6fcc) &raquo;</a
          >
        </p>
        ...
        <p>
          In light of the most recent hardware failures switch to a larger
          backup volume, thereby allowing for even more frequent backups.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003100more"><div id="more"></div></div>
