...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update Rakefile to include new Rails additions with gem
      (wikitext, fafe7ba)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/inital_forums_implementation_w.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/custom_string_methods_for_rail.php"
            >&laquo; Custom string methods for Rails (wikitext, c58b779)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/inital_forums_implementation_w.php"
            >Inital forums implementation (wincent.dev, d93f88d) &raquo;</a
          >
        </p>
        ...
        <p>
          The Rails-specific functionality is now included with the gem, but
          note that it is not enabled by default. If you wish to include it you
          need to add either or both of these to your environment.rb:
        </p>
