...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add one long-running spec to guard against GC and
      memory-related bugs (wikitext, c0cc9c3)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_invalid_encoding_test_to_b.php"
      title="Add invalid_encoding test to benchmarks subdirectory (wikitext, 29af551)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/bump_version_number_prior_to_r_4.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_invalid_encoding_test_to_b.php"
            >&laquo; Add invalid_encoding test to benchmarks subdirectory
            (wikitext, 29af551)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/bump_version_number_prior_to_r_4.php"
            >Bump version number prior to release (wikitext, 3657402) &raquo;</a
          >
        </p>
        ...
        <h3>
          Add one long-running spec to guard against GC and memory-related bugs
          (wikitext, c0cc9c3)
        </h3>

        <p>
          Add a spec that processes a string 100,000 times. This causes the spec
          suite to run in a matter of seconds rather than tenths of a second,
          but it is desirable to have at least one long-running spec in order to
          try and catch memory or GC-related bugs.
        </p>

        <p>
          Without this it appears that the entire spec suite can run without
          ever triggering GC (or at least, without ever triggering GC enough to
          expose any memory-related flaws). I know this because in developing
          the Data_Wrap_Struct code I was seeing the spec suite pass but was
