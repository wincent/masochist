...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Use HUD style for preview panel (REnamer, 9aa3a3f)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/dump_worolloverbutton_class_re.php"
      title="Dump WORolloverButton class (REnamer, 5bf63a3)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/make_renamer_application_appea.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/dump_worolloverbutton_class_re.php"
            >&laquo; Dump WORolloverButton class (REnamer, 5bf63a3)</a
          >
          |
        ...
        <p>
          This only affects the window bezel itself, not the content. I'll need
          to override the views responsible for drawing the table view to get
          them looking good in a HUD-style panel.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003531more"><div id="more"></div></div>
