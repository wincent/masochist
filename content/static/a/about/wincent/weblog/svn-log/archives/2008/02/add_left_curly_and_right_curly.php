...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add LEFT_CURLY and RIGHT_CURLY symbols (wikitext,
      dd43eff)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_img_start_and_img_end_toke.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_img_start_and_img_end_toke.php"
            >&laquo; Add IMG_START and IMG_END token types (wikitext,
            3ff145f)</a
          >
          |
        ...
        <p>
          In order to avoid ambiguity we have to separately tokenize single
          curly braces and exclude them from the standard PRINTABLE rule.
          Otherwise the greedy matching behaviour would match a run like
          &quot;foo{{bar}}baz&quot; as a single PRINTABLE token rather than a
