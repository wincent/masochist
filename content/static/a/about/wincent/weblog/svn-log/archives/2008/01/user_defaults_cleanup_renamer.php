...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_missing_files_from_rails_2.php"
      title="Add missing files from Rails 2.0.2 upgrade (wincent.dev, ff52bbb)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_notes_on_running_multiple.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_missing_files_from_rails_2.php"
            >&laquo; Add missing files from Rails 2.0.2 upgrade (wincent.dev,
            ff52bbb)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_notes_on_running_multiple.php"
            >Add notes on running multiple controller instances (REnamer,
            8489ecc) &raquo;</a
          >
        </p>
        ...
        <p>
          Replace working but technically incorrect uses of
          NSUserDefaultsController with direct access to the NSUserDefaults.
          Also register the defaults at launch time, rather than just setting
          the initial values for the controller.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003556more"><div id="more"></div></div>
