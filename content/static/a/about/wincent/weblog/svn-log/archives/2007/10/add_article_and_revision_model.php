...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add Article and Revision models (wincent.dev, 884af44)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_stories_subdirectory_wince.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_stories_subdirectory_wince.php"
            >&laquo; Add stories subdirectory (wincent.dev, 521539e)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/whitespace_fix_wincentcom_bfa8.php"
            >Whitespace fix (wincent.dev, bfa88e8) &raquo;</a
          >
        </p>

        <h2>October 15, 2007</h2>

        <h3>Add Article and Revision models (wincent.dev, 884af44)</h3>

        <p>
          These models will be the basis for the wiki functionality. Note that
          there will be no non-wiki &quot;page&quot; functionality; instead of
          setting up a separate Page model you may as well just use Articles and
