...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/import_dialog_project_from_sub.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/import_dialog_project_from_sub.php"
            >&laquo; Import dialog project from Subversion repository (snippets,
            c0a723e)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/update_for_xcode_30_snippets_3.php"
            >Update for Xcode 3.0 (snippets, 3d7963c) &raquo;</a
          >
        </p>
        ...
        <p>
          - If only one of &quot;message&quot; or &quot;title&quot; is supplied,
          use the supplied string for the missing value as well.
        </p>

        <p>
          - Prepare the way for displaying usage information if neither
          &quot;message&quot; nor &quot;title&quot; is provided; for the time
          being we just exit with a non-zero status.
        </p>

        <p>
          At the same time, this commit also provides some whitespace fixes,
          updates the copyright year, and removes some Subversion-related crud.
          All of this is bundled together in a single commit because the file is
