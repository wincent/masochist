...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add convenience methods to String class for translating
      wikitext markup (wincent.dev, 8a32b3d)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/whitespace_fix_for_routes_file.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/more_internal_link_specs_wikit_1.php"
            >&laquo; More internal link specs (wikitext, c92f50a)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/whitespace_fix_for_routes_file.php"
            >Whitespace fix for routes file (wincent.dev, 002b836) &raquo;</a
          >
        </p>
        ...
        <h3>
          Add convenience methods to String class for translating wikitext
          markup (wincent.dev, 8a32b3d)
        </h3>

        <p>
          I was originally planning on storing a copy of the wikitext source in
          the database and also a copy of the generated HTML too. But it turns
          out that the wikitext translator is even faster than I had hoped so I
          can just store the wikitext markup and convert it into HTML on the
          fly.
        </p>

        <p>
          This commit adds a couple of helper methods to the String class for
          doing this conveniently.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003945more"><div id="more"></div></div>
