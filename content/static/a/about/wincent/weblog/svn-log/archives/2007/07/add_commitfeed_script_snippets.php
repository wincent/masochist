    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/add_missing_punctuation_snippe.php"
            >&laquo; Add missing punctuation (snippets, 4532546)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/remove_subversion_tags_snippet.php"
            >Remove Subversion tags (snippets, f1d6935) &raquo;</a
          >
        </p>
        ...
        <p>
          This is the original version of the script (designed for use with
          Subversion).<br />
