...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Whitespace fix (wincent.dev, df00cf2)</title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_notes_to_taggable_spec_win.php"
            >&laquo; Add notes to Taggable spec (wincent.dev, 7d06fda)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/correct_error_in_user_spec_win.php"
            >Correct error in User spec (wincent.dev, d55c2c6) &raquo;</a
          >
        </p>

        <h2>October 15, 2007</h2>

        <h3>Whitespace fix (wincent.dev, df00cf2)</h3>

        <p>Whitespace fix in Tagging migration.</p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003084more"><div id="more"></div></div>
