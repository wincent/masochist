...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Make sure product name is not nil (wincent.dev, 8ef596d)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/create_products_model_wincentc.php"
      title="Create products model (wincent.dev, 68a5a55)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/add_example_data_for_products.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/create_products_model_wincentc.php"
            >&laquo; Create products model (wincent.dev, 68a5a55)</a
          >
          |
        ...
        <h3>Make sure product name is not nil (wincent.dev, 8ef596d)</h3>

        <p>Add a database-level constraint.</p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004212more"><div id="more"></div></div>
