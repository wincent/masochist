...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add /usr/local/share/man to MANPATH (snippets, 3eeb288)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/initial_version_of_packagesh_s.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/initial_version_of_packagesh_s.php"
            >&laquo; Initial version of Package.sh script (buildtools,
            b91af36)</a
          >
          |
        ...
        <p>
          The latest Xcode Foundation tool templates try to install man pages in
          /usr/local/share/man, so update MANPATH in my ~/.bash_profile to
          include that path.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002560more"><div id="more"></div></div>
