...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: WOCommon r490, 2 items changed</title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/04/wocommon_r489_2_items_changed.php"
      title="WOCommon r489, 2 items changed"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/04/wocommon_r491_2_items_changed.php"
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/04/wocommon_r489_2_items_changed.php"
            >&laquo; WOCommon r489, 2 items changed</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/04/wocommon_r491_2_items_changed.php"
            >WOCommon r491, 2 items changed &raquo;</a
          >
        </p>

        <h2>April 27, 2007</h2>

        <h3>WOCommon r490, 2 items changed</h3>

        <p>
          r1485@cuzco (orig r239): wincent | 2006-12-22 20:17:52 +0100
          WOSingleton class now uses NSMapTable instead of an
          NSMutableDictionary because it can be configured to not copy the keys
          (seeing as the keys were class objects this was not really correct or
          a very elegant thing to do). In making this change discovered and
          fixed a subtle race condition in certain circumstances: the order in
          which constructors are called is not determinate (or at least it is
          not publicly documented) so it was possible for another singleton
          class such as WOLogManager to call the WOSingleton class's
          sharedInstance method from it's constructor function before
          WOSingleton's constructor function had been called and before the
          singleton registry had been set up. Also, the switch to map tables
          permitted the use of NSMapInsertKnownAbsent which in turn revealed
          that the sharedInstance and allocWithZone methods were both trying to
          add the same entry to the singleton registry; this was harmless but
          redundant so one of the redundant calls has been removed.
        </p>

        <div id="a001967more"><div id="more"></div></div>

        <p class="posted">Posted by wincent at April 27, 2007 7:06 PM</p>
      </div>
    </div>
    ...
    <div id="footer">
      ...
      <p>Page last updated 00:30:44, 19 February 2010.</p>
      <p>
