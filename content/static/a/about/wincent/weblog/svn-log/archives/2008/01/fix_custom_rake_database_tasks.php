...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix custom rake database tasks (wincent.dev, 9e5a3d1)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/setup_rename_menu_item_renamer.php"
      title="Set-up &amp;quot;Rename...&amp;quot; menu item (REnamer, 9a57ad3)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/use_color_when_logging_admin_p.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/setup_rename_menu_item_renamer.php"
            >&laquo; Set-up &quot;Rename...&quot; menu item (REnamer,
            9a57ad3)</a
          >
          |
        ...
        <h3>Fix custom rake database tasks (wincent.dev, 9e5a3d1)</h3>

        <p>
          Here I was doing stuff like &quot;db:reset:all&quot; (which drops the
          databases, creates them, and then sets up the tables from the old
          schema.rb) when I really meant to do &quot;db:migrate:reset:all&quot;
          (which does the same, except recreates the tables by running all the
          migrations again).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003783more"><div id="more"></div></div>
