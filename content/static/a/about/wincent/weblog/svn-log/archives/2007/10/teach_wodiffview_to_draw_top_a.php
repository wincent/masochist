...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Teach WODiffView to draw top and bottom borders (gdiff,
      dc4575c)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/teach_glue_view_to_draw_border.php"
            >&laquo; Teach glue view to draw borders (gdiff, 63cfac2)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/fix_inappropriate_1pixel_inset.php"
            >Fix inappropriate 1-pixel inset inside grouping views (gdiff,
            6c01eb2) &raquo;</a
          >
        </p>
        ...
        <p>
          WODiffView now draws 1-pixel-wide light gray borders at the top and
          bottom of its bounds.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003003more"><div id="more"></div></div>
