...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Use close() function from Common.sh (buildtools,
      85d1bcb)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/shellscript_cleanup_buildtools.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/update_wincentstringsutil_call.php"
            >&laquo; Update wincent-strings-util calls to use double-hyphen
            switches (buildtools, 7acf42a)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/shellscript_cleanup_buildtools.php"
            >Shell-script clean-up (buildtools, a1267f6) &raquo;</a
          >
        </p>
        ...
        <p>
          The close_document_if_open() function here is redundant; use the
          equivalent close() function defined in Common.sh instead.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003351more"><div id="more"></div></div>
