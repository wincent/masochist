...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Use anonymous categories for private functionality
      (WOHotKey, fc7fca1)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/add_missing_call_to_finalize_w.php"
            >&laquo; Add missing call to finalize (WOTest, 94a6adf)</a
          >
          |
        ...
        <p>
          Replace old WOPrivate categories with Objective-C 2.0 anonymous
          categories; this allows for better compile-time checking.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002619more"><div id="more"></div></div>
