...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Enhancements to UpdateXibs script (buildtools, 30cf542)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/color_support_buildtools_65e6b.php"
      title="Color support (buildtools, 65e6ba8)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/bump_version_number_postreleas_1.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/color_support_buildtools_65e6b.php"
            >&laquo; Color support (buildtools, 65e6ba8)</a
          >
          |
        ...
        <p>
          The script now performs multiple functions: creates/updates strings
          files in the base language if required; creates xibs in the target
          languages if required; creates/updates strings files in the target
          languages if required; merges new strings from the base language
          strings files into the target language strings files; extracts
          incremental strings files (containing new and untranslated strings in
          the target language); and combines incremental strings files with
          existing translations.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003347more"><div id="more"></div></div>
