...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add specs for internal link target encoding (wikitext,
      914cd51)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/cleanup_conversion_specs_wikit.php"
      title="Cleanup conversion specs (wikitext, 374b278)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/quieten_migrations_during_spec.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/cleanup_conversion_specs_wikit.php"
            >&laquo; Cleanup conversion specs (wikitext, 374b278)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/quieten_migrations_during_spec.php"
            >Quieten migrations during specs (wincent.dev, c287d8f) &raquo;</a
          >
        </p>
        ...
        <p>
          Add specs, including comparisons against the behaviour of URI.escape
          in the standard library. Note that I do not bother testing for
          handling of invalid encodings here because that would just be
          duplicating the tests already done elsewhere (we are going through the
          encoding conversion machinery first, and that is already tested in
          other specs).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003041more"><div id="more"></div></div>
