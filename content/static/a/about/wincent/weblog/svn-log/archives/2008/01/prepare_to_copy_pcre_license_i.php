...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Prepare to copy PCRE license into application bundle
      (REnamer, d758e7c)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/update_about_box_text_renamer.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/update_about_box_text_renamer.php"
            >&laquo; Update &quot;About&quot; box text (REnamer, 8053cd7)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_woapplicationcontroller_cl.php"
            >Add WOApplicationController class (REnamer, d5f6402) &raquo;</a
          >
        </p>
        ...
        <h3>
          Prepare to copy PCRE license into application bundle (REnamer,
          d758e7c)
        </h3>

        <p>
          This is just setting up a symlink so that we can install future
          versions of PCRE and automatically pick up the latest license file.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003710more"><div id="more"></div></div>
