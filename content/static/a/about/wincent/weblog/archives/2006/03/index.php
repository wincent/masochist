...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/archives/2006/02/"
      title="February 2006"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/archives/2006/04/"
      title="April 2006"
    />
  </head>
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a href="https://wincent.dev/a/about/wincent/weblog/archives/2006/02/"
            >&laquo; February 2006</a
          >
          |

          <a href="https://wincent.dev/a/about/wincent/weblog/">Index</a>
          |
          <a href="https://wincent.dev/a/about/wincent/weblog/archives/2006/04/"
            >April 2006 &raquo;</a
          >
        </p>
        ...
        <p>
          A long time ago, before Unsanity released "Smart Crash Reports", I
          tried to come up with my own version of Apple's crash reporter
          application. I did this because the existing third-party solutions
          that I saw looked like horrible kludges. They'd do things like watch
          for the launch of the Apple crash reporter (polling), kill it so that
          the window wouldn't bother the user, throw up their own window, wait
          for the crash report to be written to the disk (again polling), and
          finally let the user send the crash report.
        </p>
        <p>
          <a
        ...
        <p>
          "drunkenbatman" of
          <a href="http://www.drunkenblog.com/">drunkenblog.com</a> has
          <a href="http://www.drunkenblog.com/drunkenblog-archives/000760.html"
            >just knowingly posted an article which crashes Safari</a
          >
          (<strong>warning: do not read that article in Safari</strong>).
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/03/drukenbatman_ge.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          Lesson of the day, never double-click the application you can find at
          <tt
            >/Developer/Applications/Performance Tools/CHUD/Hardware
            Tools/Reggie SE</tt
          >. I just made that mistake, out of curiosity, and it hard froze my
          system. By "hard freeze" I mean that not even the mouse pointer would
          move, the clock stopped updated, the machine did not respond to pings
          from elsewhere on the local network, and the only thing that seemed to
          be working well were the fans (roaring like hair dryers).
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/03/involuntary_reb.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          I've revised my <tt>WONotificationCenter</tt> class to more elegantly
          and transparently handle the delivery of notifications to specific
          threads.
        </p>
        <p>
          <a
        ...
        <p>
          Back from the conference. Today's I addressed the one remaining issue
          in my build chain (<a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/03/dstroot_install.php"
            >previously mentioned here</a
          >): an automated process to produce release builds with debugging
          symbols stripped while keeping an unstripped copy locally for the
          purposes of deciphering crash reports.
        </p>
        <p>
          <a
        ...
        <p>
          Have just spent about six hours trying to track down a bug in my code
          that was causing a crash in Synergy Advance. Turns out that it wasn't
          a bug in my code at all, rather it was a misunderstanding of the way
          NSConnection works.
        </p>
        <p>
          <a
        ...
        <p>
          Finally finished that tedious refactoring work I mentioned in my
          <a
        ...
        <p>
          Nothing very exciting to report. Now that all the plumbing is done for
          Synergy Advance's multithreaded Apple Event implementation I am busy
          doing the refactoring required to make use of the new routines.
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/03/all_quiet_on_th.php"
        ...
        <p>
          Tonight I rebooted the server for the first time since moving to
          Rackspace back in August 2005.
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/03/server_reboot.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          After trialing it for about a week I purchased a license. It mops the
          floor with Xcode's Subversion support and allows me to do version
          control operations much faster than I could in the terminal.
        </p>
        <p>
          <a
        ...
        <p>
          So what happens when you try to use NSInvocation and NSMethodSignature
          with methods that accept a variable number of arguments?
        </p>
        <p>
          <a
        ...
        <p>
          It's proving tricky to write unit tests for all these thread-related
          classes I've been working on lately. The problem is that the whole
          testing model pretty much makes the assumption that tests will run on
          a single-thread, and my mock object implementation isn't flexible
          enough.
        </p>
        <p>
          <a
        ...
        <p>
          So the other day I wrote WOQueue, a thread-safe, multi-processor-aware
        ...
        <p>
          The most common thread paradigm is the following:The main thread
          spawns a worker thread to handle long-running processing tasks in the
          background. While the worker thread is labouring away the main thread
          keys the user interface responsive for the user.
        </p>
        <p>
          <a
        ...
        <p>
          I've been using Xcode's built-in Subversion support for a long time
          now. Today I realized that lately I have been doing all my interaction
          with Subversion via the command line, even though I have the support
          turned on in Xcode.
        </p>
        <p>
          <a
        ...
        <p>
          I was just browsing the Objective-C documentation and I noticed
