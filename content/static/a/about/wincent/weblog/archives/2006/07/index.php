      ...
      <div class="content">
        ...
        <p>
          <a
            ...
            >GoDaddy's renewal prices are too high</a
          >
        ...
        <p>
          I've spent today getting to know Ruby on Rails and I must say I am
          very impressed with two things about it so far.
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/07/ruby_on_rails.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          Resetting the IRL counter to "celebrate" the first kernel panic on the
          new iMac (yes, that's irony). No idea what the cause was. Newly
          installed software that was running at the time included a custom
          Intel build I had just made of
          <a href="http://mldonkey.sourceforge.net/Main_Page">MLDonkey</a> and
          <a href="http://www.firaxis.com/games/game_detail.php?gameid=10"
            >Civilization IV</a
          >. One of the first things I did after recovering from the panic is
          trash Civilization IV, just in case &mdash; it's only a game &mdash;
          and if I get another panic while <tt>mlnet</tt> is running I'll be
          trashing that too and never using it again. This machine is far too
          important to my work to take any risks. Paranoia is the order of the
          day.
        </p>
        <p>
          <a
        ...
        <p>
          A little over a month ago I sold something via eBay Spain and the
          winning bidding refused to pay. I went through the dispute process
          &mdash; dispute is "disputa" in Spanish &mdash; and after over a month
          of trying to get payment decided that it was fruitless to continue.
        </p>
        <p>
          <a
        ...
        <p>
          Wasn't too happy to read this:This is the first version of MediaWiki
          to require PHP 5.... (PHP 5.0 is no longer maintained; all PHP 5.0
          users should upgrade to a current 5.1 release to ensure they have all
          security fixes.)
        </p>
        <p>
          <a
