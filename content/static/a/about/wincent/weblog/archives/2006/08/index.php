...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/archives/2006/07/"
      title="July 2006"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/archives/2006/09/"
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a href="https://wincent.dev/a/about/wincent/weblog/archives/2006/07/"
            >&laquo; July 2006</a
          >
          |
          ...
          |
          <a href="https://wincent.dev/a/about/wincent/weblog/archives/2006/09/"
            >September 2006 &raquo;</a
          >
        </p>
        ...
        A customer just brought it to my attention that my PayPal order pages
        are showing up in Spanish, thus making it impossible or difficult for
        people who don't understand Spanish to complete the purchase. I don't
        know when this started,...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/08/darn_paypal.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/08/travelling.php"
            >Read full article</a
          >
        </p>
        ...
        I know a few people have said that they're "underwhelmed" by Leopard but
        I for one am really looking forward to it....
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/08/leopard.php"
            >Read full article</a
          >
        </p>
        ...
        I've never used Higher Order Messaging (HOM) but I am familiar with what
        it is. The main benefit of HOM is that it allows you to reduce lengthy
        code sections like this: NSEnumerator *enumerator = [array
        objectEnumerator]; NSMutableArray *temp =...
        <p>
          <a
        ...
        There are two kinds of problems in computer programming: stimulating
        ones and annoying ones. The former are generally the problems you face
        when inventing something new; the latter are the ones you face when your
        development tools suddenly start behaving...
        <p>
          <a
        ...
        Now that I've got atosym I will be using DWARF debugging information
        format across all my products. The key missing piece of the puzzle was
        realizing that Xcode creates dSYM files using dsymutil(1); so instead of
        letting Xcode handle it...
        <p>
          <a
        ...
        I like to experiment with different licensing models. In the past I've
        released applications as closed-source commercial software, shareware
        both with and without serial numbers, with and without product
        activation, open source free software (with the possibility of
        donations) under...
        <p>
          <a
        ...
        GoDaddy continues to scam with respect to private registrations but I've
        found one way to get around it....
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/08/darn_godaddy.php"
            >Read full article</a
          >
        </p>
        ...
        As part of the move to WOCommon I wrote some unit tests for WOSingleton.
        There is some behaviour that I can test entirely deterministically but
        in trying to test race conditions and concurrency issues I decided that
        one easy way...
        <p>
          <a
        ...
        Pulled my NSString category out of WODebug and moved it into WOCommon,
        splitting it into several categories along the way to allow for
        finer-grained inclusion: WOEmailUtilities, WOFileUtilities,
        WOTaskUtilities and WOURLUtilities. Also moved the WOLogManager,
        WOObject and WOSingleton classes. In doing...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/08/more_work_on_wo.php"
            >Read full article</a
          >
        </p>
        ...
        A while ago I wrote about double-checked locking and memory barriers.
        There are plenty of articles about this on the net. They generally show
        three examples....
        <p>
          <a
        ...
        This isn't the first time I've written about mock objects in WOTest. I
        first added mocks back in June 2005. I later wrote about efforts to
        improve the mock object implementation by making it able to record
        ...
        I'll be continuing these entries in the "mini-log" on the left hand side
        of my weblog. Wednesday 9 August The new app is now "complete", meaning
        that it builds, runs, and basically does what it was designed to do.
        From...
        <p>
          <a
        ...
        Favorite stuff to come out of WWDC: Improved Spotlight in Leopard;
        sounds like it will go from "shows potential but sucks" to "totally
        indispensable tool that enables you to do amazing stuff really quickly".
        Spaces: Exposé is good but Exposé...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/08/favorite_announ.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/08/work_log.php"
            >Read full article</a
          >
        </p>
