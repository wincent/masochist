...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/archives/2005/05/"
      title="May 2005"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/archives/2005/07/"
      title="July 2005"
    />
  </head>
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a href="https://wincent.dev/a/about/wincent/weblog/archives/2005/05/"
            >&laquo; May 2005</a
          >
          |
          ...
          |
          <a href="https://wincent.dev/a/about/wincent/weblog/archives/2005/07/"
            >July 2005 &raquo;</a
          >
        </p>
        ...
        <p>
          Since the disk corruption on the server the other day I have done a
          lot of thinking about how I could minimize downtime and speed-up
          disaster recovery.
        </p>
        <p>
          <a
        ...
        <p>
          Use Apple's bugreporter. It's one way in which we can all help Mac OS
          X to get better. I'm not the most disciplined of bug reporters to
          Apple because I don't like their interface, but I have been filing
          more bug reports lately.
        </p>
        <p>
          <a
        ...
        <p>
          Well, continuing on from my last post on the topic I'm blazing ahead
          with my unit testing framework, WOTest.
        </p>
        <p>
          <a
        ...
        <p>
          In the last month I have received 26 emails from mindless scammers
          trying to lure me to their phoney websites and enter my PayPal details
          (along with my banking information, social security number and
          everything else).... Many of these fools don't even speak English.
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2005/06/paypal_scammers.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          Apple's Objective-C runtime allows you to throw any object as an
          exception.
        </p>
        <p>
          <a
        ...
        <p>
          If it means more powerful computers then I'm all for it. But I wince
          when I think about how painful the transition is going to be...
        </p>
        <p>
          <a
