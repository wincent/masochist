...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Wincent Colaiuta's weblog: Creating new daemon users on Leopard
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/10/on_leopards_sta.php"
            >&laquo; On Leopard's stability</a
          >
          |
        ...
        <p>
          ...
          <a href="https://wincent.dev/wiki/MySQL">MySQL</a> for
...
##</pre
        >
        <p>
          So what am I supposed to do? Use the Directory Utility application to
          turn on the BSD local node and then manually edit
          <tt>/etc/passwd</tt> and set a password using the <tt>passwd</tt> tool
          (for which there is no longer a manpage, but at least
          <tt>password --foo</tt> causes usage information to be printed)? Is
          there a more elegant way than this? What does Mac OS X Server do under
          the hood?
        </p>
        <a name="Update"></a>
        <h3>Update</h3>
        ...
        <ul>
          <li>
            ...
            an <a href="https://wincent.dev/wiki/NDA">NDA</a>, found
            <a
              href="http://www.michaelnygard.com/blog/2007/04/moving_your_home_directory_on.html"
              >this article</a
            >
            published back in April describing the <tt>dscl</tt> tool, a command
            line interface for Directory Services.
          </li>
          <li>
            <a href="http://docs.info.apple.com/article.html?artnum=306494"
              >http://docs.info.apple.com/article.html?artnum=306494</a
            >
          </li>
          <li>
            <a
              href="http://www.royhooper.ca/blog/articles/2007/10/27/creating-os-only-users-on-leopard"
              >http://www.royhooper.ca/blog/articles/2007/10/27/creating-os-only-users-on-leopard</a
            >
          </li>
        </ul>
        <p>
          So it looks like something like this <em>would</em> probably work:
        </p>
        <pre>
...
sudo dscl localhost -create /Local/Default/Users/_mysql UserShell: /usr/bin/false</pre
        >
        <p>
          <em>But</em>, having started to snoop around using <tt>dscl</tt> I saw
          that there already is a MySQL user, it's just that it appears as
          <tt>_mysql</tt>. Information about it can be printed by issuing one of
...
UserShell: /usr/bin/false</pre
        ...
        <div id="a002858more"><div id="more"></div></div>
