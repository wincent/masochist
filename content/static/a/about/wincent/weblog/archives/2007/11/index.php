...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/archives/2007/10/"
      title="October 2007"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/archives/2007/12/"
      title="December 2007"
    />
  </head>
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a href="https://wincent.dev/a/about/wincent/weblog/archives/2007/10/"
            >&laquo; October 2007</a
          >
          |
          ...
          |
          <a href="https://wincent.dev/a/about/wincent/weblog/archives/2007/12/"
            >December 2007 &raquo;</a
          >
        </p>
        ...
        There is an interesting thread on the Git mailing list going on right
        now which demonstrates exactly what it is that Git gets right about
        modelling history. Basically, it doesn't worry about storing metadata
        about file renames, file moves, file...
        <p>
          <a
        ...
        Nicest changes in RubyGems 0.9.5: Automatic installation of platform
        gems Automatic installation of dependencies (can be turned off with
        --ignore-dependencies) The gem dependency command (gem help dependency
        for more info) The gem fetch command (gem help fetch for more info)...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/11/rubygems_095.php"
            >Read full article</a
          >
        </p>
        ...
        Jesus H. Christ, it must suck giant wet donkey balls to be stuck on an
        archaic OS where you need to be dropping into the terminal and tweaking
        configuration files and compiling shit all the time. Can you guess
        the...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/11/pilgrim_on_leop.php"
            >Read full article</a
          >
        </p>
        ...
        So it turns out that SuperDuper! definitely doesn't produce bootable
        backups on Leopard. I had used SuperDuper! to move my old Tiger install
        to a new volume; this was before I found out that SuperDuper! isn't
        comptaible with Leopard. Seeing as...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/11/involuntary_reb_18.php"
            >Read full article</a
          >
        </p>
        ...
        Version Control wins. What actually happened Try to upgrade to the first
        release candidate for Rails 2.0: rake rails:freeze:edge
        TAG=rel_2-0-0_RC1 This didn't work due to a connection failure, but
        before trying again I did a git st and noticed that...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/11/version_control.php"
            >Read full article</a
          >
        </p>
        ...
        So I've been using SuperDuper! on Leopard despite the fact that it is
        officially not compatible. In fact, I didn't actually know it wasn't
        compatible until I went to the Shirt Pocket website in search of an
        explanation as to why...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/11/using_superdupe.php"
            >Read full article</a
          >
        </p>
        ...
        Since seeing this post by Michael Tsai linking to a couple of articles
        on &quot;Why Spaces is broken&quot; I've been wracking my brains trying
        to remember where the heck I wrote about this, seeing as I was quite
        sure I...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/11/why_spaces_is_b.php"
            >Read full article</a
          >
        </p>
        ...
        In light of my last hard reset and subsequent, albeit minor, data loss,
        I've decided to ratchet up my backup regimen another notch. Now that
        Leopard is out I've got a free partition (the one I previously used to
        install...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/11/backup_obsessio.php"
            >Read full article</a
          >
        </p>
        ...
        After yesterday's hard reset it looked for a moment like I was going to
        have to live in a world without RSS. Possibly without mail too. Probably
        wouldn't be a bad thing. After rebooting, dancing the merry Disk First
        Aid...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/11/a_world_without.php"
            >Read full article</a
          >
        </p>
        ...
        Another hard reset, this time not due to a fault in Mac OS X but rather
        due to my iMac's flakey construction (checking a USB cable at the back
        of the enclosure resulted in the wonky power socket temporarily
        cutting...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/11/involuntary_reb_17.php"
            >Read full article</a
          >
        </p>
        ...
        I've been too busy of late to post reports to my much-loved Involuntary
        Reboot Log, but I'm finally catching up with my first three entries
        since upgrading to the final version of Leopard. The first occurred
        during installation. I started...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/11/involuntary_reb_16.php"
            >Read full article</a
          >
        </p>
        ...
        It will probably be a long, long time before this comes to fruit, but
        Laurent Sansonetti has made these very interesting comments: At the end
        of the talk, I spoke about some of the future plans regarding Ruby on
        Mac...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/11/intriguing_plan.php"
            >Read full article</a
          >
        </p>
        ...
        Am I the only one who's not excited about JRuby? Ruby is slow but I
        don't think the right solution is translating it into Java. Don't people
        find Rails apps hard enough to deploy already? They want to add yet...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/11/java.php"
            >Read full article</a
          >
        </p>
