...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/archives/2007/01/"
      title="January 2007"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/archives/2007/03/"
      title="March 2007"
    />
  </head>
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a href="https://wincent.dev/a/about/wincent/weblog/archives/2007/01/"
            >&laquo; January 2007</a
          >
          |

          <a href="https://wincent.dev/a/about/wincent/weblog/">Index</a>
          |
          <a href="https://wincent.dev/a/about/wincent/weblog/archives/2007/03/"
            >March 2007 &raquo;</a
          >
        </p>
        ...
        With memoizing: 235 specifications, 0 failures real 0m7.580s user
        0m7.035s sys 0m0.347s Without memoizing: 235 specifications, 0 failures
        real 0m7.895s user 0m7.612s sys 0m0.253s Goodbye parity, hello
        superiority. The thing which finally pushed us over the hump wasn't
        increasing the...
        <p>
          <a
        ...
        I just added "here document" support to Walrus. This is an extension to
        the normal syntax for the raw directive: #raw Characters which would
        normally have special meaning are treated as normal characters inside
        the #raw block. #end Notice how...
        <p>
          <a
        ...
        If you are an independent Mac software vendor it seems that the way to
        come up with a company name is to combine a modifier (adjective or
        adjectival noun) with a noun. Your algorithm for selecting a random
        modifier should...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/02/coming_up_with.php"
            >Read full article</a
          >
        </p>
        ...
        Following on from yesterday's post, I've now achieved performance parity
        (within about 3 percent) for the memoizing (5.674 seconds) and
        non-memoizing (5.484) parser modes. Given that this is for pretty much
        worst-case scenario input, and I haven't done any profiling...
        <p>
          <a
        ...
        One of the things that's been so good about writing the parser generator
        for Walrus is that it has made the code much more flexible, much easier
        to develop iteratively. In my original design I had a hand-coded parser
        and...
        <p>
          <a
        ...
        The packrat performance numbers I published yesterday were deficient in
        a couple of ways. Firstly, performance was a little slow; I've been able
        to improve this somewhat with some minor changes. Secondly, the "parse
        event" numbers with memoizing turned off...
        <p>
          <a
        ...
        <h3 id="a001184">
          Putting the "packrat" into PEG: adding memoizing to my Ruby parser
          generator
        </h3>

        I've previously written about writing a basic parser generator in Ruby
        and then adding support for Abstract Syntax Trees. In my first article I
        noted: Although I didn't know it when I started, I was writing a parser
        generator that...
        <p>
          <a
        ...
        I finally gave in and purchased a license for TextMate. I say "gave in"
        because I couldn't really justify purchasing yet another text editor
        when I already had a costly license for BBEdit (still my preferred tool
        for HTML editing);...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/02/textmate_wins.php"
            >Read full article</a
          >
        </p>
        ...
        Wow. I just updated the copyright year in the footer at the bottom of
        these pages. It now reads 1997-2007. This website has now been online
        for 10 years! Life goes by all too quickly....
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/02/10_years_online.php"
            >Read full article</a
          >
        </p>
        ...
        In a previous article about writing a parser generator in Ruby I
        promised to talk about Abstract Syntax Trees. The problem with the
        parsers previously described is that the literal results (strings
        arranged in a hierarchical, ordered tree with the...
        <p>
          <a
        ...
        A few days ago a Groklaw article drew my attention to the availability
        of video footage from Bill Gate's 1998 anti-trust case deposition. I
        promptly used MPlayer to capture the MMS streams to disk and over the
        last few days...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/02/gates_depositio.php"
            >Read full article</a
          >
        </p>
        ...
        Just over a year ago I wrote about Bill Gates' failed prediction that
        spam would be "solved" by the beginning of 2006. Microsoft tried to deny
        the demonstrable failure of this prediction by redefining the meaning of
        the word "solved"...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/02/is_spam_solved.php"
            >Read full article</a
          >
        </p>
        ...
        <h3 id="a001147">
          Jobs would like to get rid of DRM, should software developers get rid
          of copy protection?
        </h3>

        Steve Jobs would love to abolish DRM on Apple's music downloads. Am I
        surprised that he feels this way? Not really. Am I surprised that he
        went on the record and said it to the public? Very much so. This...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/02/jobs_would_like.php"
            >Read full article</a
          >
        </p>
        ...
        Rails doesn't scale, or so the saying goes. Ah, that's just a myth, they
        say. Don't worry about it, argue others. Now this, 4,000 requests per
        second. Of course if you throw enough money at the problem Rails will
        "scale"....
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/02/the_railsdoesnt.php"
            >Read full article</a
          >
        </p>
        ...
        Keeping the system executing at all times is the prime directive. You
        never do anything to the system that will break it for more than a few
        seconds. If you have a huge architectural change to make, you find a...
        <p>
          <a
