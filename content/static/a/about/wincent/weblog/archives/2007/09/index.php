...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Wincent Colaiuta's weblog: September 2007 Archives</title>
      ...
      <div class="content">
        <p align="right">
          ...
          <a href="https://wincent.dev/a/about/wincent/weblog/archives/2007/10/"
            >October 2007 &raquo;</a
          >
        </p>

        <h2>September 30, 2007</h2>

        <h3 id="a002766">Spotlight definitely broken on my machine</h3>

        Lately Mail.app has only been returning a subset of the expected results
        when I search for a particular mail. For example, if a customer that
        purchased a Synergy license in the last week asks for their registration
        information to be...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/09/spotlight_defin.php"
            >Read full article</a
          >
        </p>
        ...
        <h2>September 28, 2007</h2>

        <h3 id="a002764">The Apple Store</h3>

        Just saw this post (via Gruber): But while its beauty and usability have
        always run ahead of the pack, its underlying source code has not always
        kept pace. Now the online Apple Store’s inside is as beautiful as its
        exterior—and...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/09/the_apple_store.php"
            >Read full article</a
          >
        </p>
        ...
        <h2>September 26, 2007</h2>

        <h3 id="a002762">Amending commits with Git</h3>

        One of the nice frills that comes with the distributed version control
        model of Git is the ability to amend unpublished commits. With a
        client-server model your commits are permanent and instantly visible,
        which means that if you make a...
        <p>
          <a
        ...
        <h3 id="a002760">Movable Type 4.0.1</h3>

        This is my first post from my new Movable Type install after the upgrade
        from the old version 3.35 to the new 4.0.1. I really couldn't be more
        impressed with the ease of the upgrade process; easily the best I've...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/09/movable_type_40.php"
            >Read full article</a
          >
        </p>
        ...
        <h3 id="a002756">Will it blend?</h3>

        David Heinemeier Hansson is again arguing that Rails is, after all,
        scalable: Jason Hoffman from Joyent had a great tutorial at RailsConf
        Europe on Scaling a Rails Application from the Bottom Up. It defines the
        key terms and measurements of...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/09/will_it_blend.php"
            >Read full article</a
          >
        </p>
        ...
        <h3 id="a002753">Involuntary Reboot Log #16</h3>

        Very similar to the problem I saw back at the start of this month: after
        installing a preview release of a certain operating system the DVD
        appeared as being mounted on the Desktop but both the Finder and the
        Terminal...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/09/involuntary_reb_15.php"
            >Read full article</a
          >
        </p>
        ...
        static BOOL isHex(unichar c) { switch (c) { case '0' ... '9': case 'a'
        ... 'f': case 'A' ... 'F': return YES; default: return NO; } } Well that
        one is an eye-opener. I have often wished for the &quot;range&quot;...
        <p>
          <a
        ...
        <h2>September 20, 2007</h2>

        <h3 id="a002750">Automata</h3>

        Ragel is a truly awesome tool for working with finite automata. It's
        really refreshing to immerse yourself in a deterministic world
        completely and rigorously upheld by mathematical underpinnings. And
        Ragel is an incredibly solid finite state machine compiler that
        implements...
        <p>
          <a
        ...
        <h2>September 15, 2007</h2>

        <h3 id="a002700">Involuntary Reboot Log #15</h3>

        There are some applications that when they crash are capable of taking
        the whole system down. Xcode is one of them. I have no idea why or how
        they can do this. And I don't think it is actually the...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/09/involuntary_reb_14.php"
            >Read full article</a
          >
        </p>
        ...
        <h2>September 12, 2007</h2>

        <h3 id="a002696">Why functional programming</h3>

        So in my spare time I've started learning Haskell because I think it's
        the right time to learn functional programming. I started thinking about
        this almost exactly one year ago when I read this post by Mark Bessey, a
        former...
        <p>
          <a
        ...
        <h3 id="a002666">Anchor</h3>

        If this weren't such a pain it would be hilarious: my embattled iMac's
        brand new Super Drive has given up the ghost after only a couple of
        weeks of operation. Not having a working Super Drive was a serious
        concern...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/09/anchor.php"
            >Read full article</a
          >
        </p>
        ...
        <h3 id="a002665">Stash</h3>

        Git 1.5.3 just came out a few days ago and one of the greatest things
        about it is the addition of the git stash command. This addresses one of
        the most annoying workflow obstacles that I run into many times...
        <p>
          <a
