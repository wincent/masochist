      ...
      <div class="content">
        <p align="right">
          <a href="https://wincent.dev/a/news/quick-links/archives/"
            >Quick links archives index</a
          >
          |
          <a href="https://wincent.dev/a/news/quick-links/archives/2004/12/"
            >December 2004 &raquo;</a
          >
        </p>
        ...
        <p>
          <a href="http://www.stclairsw.com/">St Clair Software</a> has just
          <a href="http://www.stclairsw.com/DefaultFolderX/release.html"
            >released a new version</a
          >
          of Default Folder X (<a
            href="http://www.stclairsoft.com/cgi-bin/dl.cgi?DX-B"
            >download</a
          >), a good example of an app that uses Wincent's
          <a href="https://wincent.dev/a/products/install/">Install</a>
          application.
        </p>

        <p class="posted">Posted 2:06 AM</p>
        ...
        <p>
          <a
            href="http://sourceforge.net/mailarchive/forum.php?thread_id=5902770&#38;forum_id=40629"
            >Apparently</a
          >, the latest
          <a href="http://azureus.sf.net/cvs/">CVS snapshots</a> fix the
          <a href="http://azureus.sourceforge.net/">Azureus</a> Dual-CPU kernel
          panics.
          <a
            href="http://azureus.sourceforge.net/wiki/index.php/ChangeTheAzureusTwoJarFile"
            >Instructions here</a
          >.
        </p>

        <p class="posted">Posted 4:40 PM</p>
        ...
        <p>
          The sophisticated
          <a href="http://www.c-command.com/spamsieve/index.shtml"
            >spam filter</a
          >
          has been
          <a
            href="http://www.c-command.com/spamsieve/manual.shtml#version-history"
            >updated</a
          >
          to version
          <a href="http://www.c-command.com/downloads/SpamSieve-2.2.2.dmg"
            >2.2.2</a
          >. I've been using it for 10 days so far, with 99.1% accuracy.
        </p>

        <p class="posted">Posted 6:13 PM</p>
        ...
        <p>
          <a
            ...
            >This handly little article</a
          >
          over at
          <a href="http://www.macdevcenter.com/">macdevcenter.com</a> gives you
          a straightforward recipe for something that would be very tricky to
          figure out unaided.
        </p>

        <p class="posted">Posted 4:56 AM</p>
        <h4>November 7, 2004</h4>

        <h5 id="a000016">
          Using WinSwitch to tame the Logitech Control Center
        </h5>
        ...
        <p>
          ...
          <a
            ...
            >this hint</a
          >
          over at <a href="http://www.macosxhints.com/">Mac OS X Hints</a> about
          using
          <a href="https://wincent.dev/a/products/winswitch/">WinSwitch</a> to
          tame <a href="http://www.logitech.com/">Logitech's</a> Control Center
          software.
        </p>

        <p class="posted">Posted 1:54 AM</p>
        ...
        <p>
          ...
          <a href="http://www.stclairsw.com/DefaultFolderX/release.html"
            >released</a
          >
          by <a href="http://www.stclairsw.com/">St Clair Software</a>. A good
          example of an app that uses the
          <a href="https://wincent.dev/a/products/install/">Install</a>
          application I wrote.
        </p>

        <p class="posted">Posted 7:54 AM</p>
      </div>
    </div>
