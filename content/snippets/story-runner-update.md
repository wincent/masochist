...
Looking forward to using it, although until the [API](https://wincent.dev/wiki/API) is final I'm not going to touch it; too many other things on the go right now to spend time chasing a moving API.
