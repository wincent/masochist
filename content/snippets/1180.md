---
title: Involuntary reboot log 13.2
tags: involuntary.reboot.log 2023.mbp snippets
---

Machine went into infinite reboot loop on trying to wake it from sleep, eventually requiring the entire logic board to be replaced and losing all data in the process.

# Statistics so far for this machine

- Failure type: [kernel panic](/wiki/Hard_reset)
- OS version: Tahoe
...
- Total days to date: 869
- Average time between failures: 434.5 days

# Summary of events for this machine

1. [2023-11-22](/snippets/1178): got locked out of machine and had to hard-reset.
1. [2026-04-08](/snippets/1180): logic board failure.
...
| 🟢      | [434.5 days](/snippets/1180)                   | 869+ days      | 13.x            | [MacBook Pro "M3 Max" 16 CPU/40 GPU 16" (2023)](https://everymac.com/systems/apple/macbook_pro/specs/macbook-pro-m3-max-16-core-cpu-40-core-gpu-16-late-2023-specs.html)              | personal machine                     |
