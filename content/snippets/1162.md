---
title: Involuntary reboot log 10.11
tags: involuntary.reboot.log 2015.mbp snippets
---

Again keyboard jammed waking from sleep, and it looks like [my on-sleep hook](https://github.com/wincent/wincent/commit/46835b274a32f084f8bf53d32b9995a06d74936d) did not run because key repeat was active _and_ I could see that Karabiner-Elements was still running (because on hitting both shift keys, the caps lock light would toggle).

One last step to try before [turning off the lockscreen entirely](https://github.com/wincent/wincent/commit/5855025962dda75d461b50e8210b293587444832), setting up a Karabiner keybinding to run the kill script from the lockscreen.
...
1. [2017-12-03](/snippets/1162): jammed keyboard on waking from sleep (because key repeat was not [turned off](https://github.com/wincent/wincent/commit/46835b274a32f084f8bf53d32b9995a06d74936d); it seems the hook did not run).

# Statistics so far

-   Failure type: [hard reset](/wiki/Hard_reset)
-   OS version: 10.13.6
-   Uptime at moment of failure: about four days
-   Kernel panics: 0
-   Hard resets: 11
-   Total failures: 11
-   Start of recording keeping: 31 October 2017
-   Total days to date: 398
-   Average time between failures: 36.18 days

# Historical data

For comparison, previous generations of machines (from most oldest to most recent) that I've used have had averages of:

-   [~13.83 days](https://wincent.dev/a/about/wincent/weblog/archives/2006/05/involuntary_reb_1.php) (over ~540 days): PowerMac G5.
...
-   Current personal machine machine; [36.18 days](/snippets/1162) (over 398 days): [MacBook Pro (Haswell, Mid-2015, dual graphics)](http://www.everymac.com/systems/apple/macbook_pro/specs/macbook-pro-core-i7-2.8-15-dual-graphics-mid-2015-retina-display-specs.html).
