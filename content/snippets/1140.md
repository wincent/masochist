---
title: Involuntary reboot log 8.2
tags: involuntary.reboot.log snippets
---

Keyboard started acting laggy, so decided to do a preemptive reboot, but got stuck at black screen with spinning progress indicator. After about 20 minutes, [hard reset](/wiki/Hard_reset).

# Statistics so far

* Failure type: [hard reset](/wiki/Hard_reset)
* OS version: 10.11.4
* Uptime at moment of failure: probably a week or more
* Kernel panics: 1
* Hard resets: 1
* Total failures: 2
* Start of recording keeping: 2 June 2015
* Total days to date: 175 days
* Average time between failures: 87.5 days
