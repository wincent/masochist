...
Thanks to [FixtureReplacement](https://wincent.dev/wiki/FixtureReplacement) my [Rails](https://wincent.dev/wiki/Rails) model [specs](https://wincent.dev/wiki/specs) are looking awfully clean:
