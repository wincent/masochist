...
If you're using [Git](https://wincent.dev/wiki/Git) and [Bash](https://wincent.dev/wiki/Bash) (if you're using a programmer and have the freedom to choose the [SCM](https://wincent.dev/wiki/SCM) you use then the former should be true; if you're a [Mac OS X](https://wincent.dev/wiki/Mac%20OS%20X) user then the latter is true by default unless you've overridden it) then you really should check out the Bash completion script that comes with Git (in `contrib/completion/`).
