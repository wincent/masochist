...
For more information about choosing a payment service please see the answer to [this Frequently Asked Question](https://wincent.dev/a/support/faq/#which). To purchase a Wincent product please see the [Wincent Store](https://wincent.dev/) for an overview of all available products, or go directly to the [Synergy purchase page](https://wincent.dev/a/products/synergy-classic/purchase/) or [Synergy Advance purchase page](https://wincent.dev/a/products/synergy-advance/purchase/).
