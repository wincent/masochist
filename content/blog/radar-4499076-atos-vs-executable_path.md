...
Using `atos` is a bit of a pain with anything that uses embedded frameworks. Unfortunately it's something I need to do in order to [decipher crash reports](https://wincent.dev/a/about/wincent/weblog/archives/2006/03/automated_strip.php).
