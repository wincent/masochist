...
I've never used `NSUndoManager` and so I didn't realize that there's actually an example of trampoline-based [HOM](https://wincent.dev/a/about/wincent/weblog/archives/hom/) in an Apple framework. I wonder if there are others.
