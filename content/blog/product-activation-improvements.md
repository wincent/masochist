...
A little bit more detail about the result can be seen under the heading, ["How many activations may I perform?"](http://wincent.dev/a/support/activation/#limits) on the [product activation](http://wincent.dev/a/support/activation/) page. Here is an excerpt, although you should make a point of visiting [the page in question](http://wincent.dev/a/support/activation/#limits) to be certain that you're reading the most up-to-date information possible:
