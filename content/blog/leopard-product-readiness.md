...
With [Leopard](https://wincent.dev/wiki/Leopard) only 15 hours from release it's time for a product status report:
...
-   Walrus: object-oriented templating system written in [Ruby](https://wincent.dev/wiki/Ruby).
