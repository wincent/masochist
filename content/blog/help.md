...
I [previously wrote](https://wincent.dev/a/about/wincent/weblog/archives/2007/04/payoff_time.php) about how pleased I was with my new workflow for creating end-user help documentation. In that article I said:
...
I've just pushed out updates ([1](https://wincent.dev/a/news/archives/2007/04/hextrapolate_20_1.php), [2](https://wincent.dev/a/news/archives/2007/04/synergy_312_now.php)) to Hextrapolate and Synergy which show the difference between my new approach and my old one.

### The old

Synergy uses [online help documentation](https://wincent.dev/a/products/synergy-classic/). It's fairly extensive, but obviously can't be read offline unless you previously mirror it.
...
They can view the documentation at any time, even when they're offline, because it's embedded inside the application. But prospective users who don't have the application installed can look at it [online too](https://wincent.dev/a/products/hextrapolate/help/front_page.html). The embedded help is easily searchable using the Help Viewer, and the online help is easily searched using the [all-powerful Google](https://wincent.dev/a/site-map/search/).

I win as a developer too for the reasons already stated; above all because I can write the source documentation once and compile it for multiple targets. And it's not just rapid in the do-it-all-in-a-single-step sense; it's agile in the development sense too. Because Walrus is written in [Ruby](https://wincent.dev/wiki/Ruby) I was able to add the dual-targetting capability in less than five-minutes, literally.

### The future

If you've been following the [Subversion log](https://wincent.dev/a/about/wincent/weblog/svn-log/archives/) this past week you'll see that I've been laying low on the check-in front. I've been looking at speeding up Walrus by converting the parser (generated Ruby code) to a ultra-fast C extension. I first looked at using [Ragel](https://wincent.dev/wiki/Ragel) but am now leaning towards [ANTLR](https://wincent.dev/wiki/ANTLR) due to the complexity of the parser.
