...
I've never been able to get [TextMate](https://wincent.dev/wiki/TextMate) to reliably detect [Ruby](https://wincent.dev/wiki/Ruby), [Rails](https://wincent.dev/wiki/Rails) and [RSpec](https://wincent.dev/wiki/RSpec) files. Allan Odgaard, the author of TextMate, [explains here](http://macromates.com/blog/2007/file-type-detection-rspec-rails) how to bend the system to your will.
