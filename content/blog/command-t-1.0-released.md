---
title: Command-T 1.0 released
tags: releases command.t blog
cache_breaker: 1
---

I've just released version 1.0 of the [Command-T](/wiki/Command-T) plug-in for [Vim](/wiki/Vim). This is a powerful, [open source](/wiki/open_source) file-navigation plug-in inspired by the "Command-T" feature in [TextMate](/wiki/TextMate).

# What's changed since [the 1.0b release](/blog/command-t-1.0b-released)

There is just one [little tweak](/repos/command-t/commits/89e27d5c03f42ed46961469a6d12fbff1e299be2) that makes relative path simplification work for Windows users. Other than that, everything is the same.

As always, a full change-log appears under HISTORY in the documentation, and you can explore the commits in the release [here](/repos/command-t/tags/1.0). (Note: the integrated repository browser that I'm linking to here is still relatively new and doesn't have a full feature set yet.)
