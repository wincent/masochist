...
In March 2007 I [announced](http://typechecked.net/a/about/wincent/weblog/archives/2007/03/planned_changes.php) my intention to make nightly builds available, starting with Synergy and after a couple of weeks of testing, Synergy Advance and then Hextrapolate, with other products to follow.
...
-   Users can confirm that bugs are fixed soon after [changes](http://typechecked.net/a/about/wincent/weblog/svn-log/archives/index.php) are committed to the source code repository.
...
I've written a [Ruby](http://typechecked.net/wiki/Ruby) script that performs the following steps for each product:

1.  Checks the [Git](http://typechecked.net/wiki/Git) revision number of the latest version of the codebase: if the revision number hasn't changed since the last run then this means that no changes have been finalized and the product is skipped. You can see which changes are being checked in in real-time by subscribing to the Git log.
...
6.  Publishes a new entry to the [Nightlog](http://typechecked.net/a/about/wincent/weblog/nightlog/) including basic information about the build (name, size, checksum, download URL and so forth).
...
-   List of [Synergy nightlies](http://typechecked.net/a/about/wincent/weblog/nightlog/archives/synergy/).
-   List of [Synergy Advance nightlies](http://typechecked.net/a/about/wincent/weblog/nightlog/archives/synergy_advance/)
-   List of [Hextrapolate nightlies](http://typechecked.net/a/about/wincent/weblog/nightlog/archives/hextrapolate/)
-   The [Nightlog archives](http://typechecked.net/a/about/wincent/weblog/nightlog/) for all products.
...
-   Some notes about the process: "[Setting up a nightly build system](http://typechecked.net/wiki/Setting%20up%20a%20nightly%20build%20system)"
