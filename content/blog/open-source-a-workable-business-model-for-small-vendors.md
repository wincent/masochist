...
Free open source software is very popular. You may be wondering if giving away open source software for free (but accepting donations) is a workable business model for small vendors like [Wincent](https://wincent.dev/). Here are some numbers for [WinSwitch](https://wincent.dev/a/products/winswitch/) for the period running from 10 March 2006 to 7 April 2006:

**Downloads during [version 3.2/3.2b/3.2.1](https://wincent.dev/a/products/winswitch/history/) release cycle:** 8,175
