...
Last month I began trialing the new [nightly builds system](https://wincent.dev/a/news/archives/2007/03/nightly_builds.php) with [nightlies](https://wincent.dev/a/about/wincent/weblog/nightlog/archives/synergy/) for Synergy. This is because I want to move towards a more [open development process](https://wincent.dev/a/about/wincent/weblog/archives/2007/03/planned_changes.php).

Today Synergy Advance has been added to the nightly builds schedule.

These builds are for the curious who wish to get a sneak peak at work in progress towards the next version. The current official release (0.4) is still the one that is recommended for daily use and is available from the [downloads page](https://wincent.dev/a/products/synergy-advance/download/).
