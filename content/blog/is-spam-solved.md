...
Just over a year ago I wrote about [Bill Gates' failed prediction](https://wincent.dev/a/about/wincent/weblog/archives/2006/01/spam_to_be_elim.php) that spam would be "solved" by the beginning of 2006. Microsoft tried to deny the demonstrable failure of this prediction by redefining the meaning of the word "solved" in a [way that does not bear inspection](https://wincent.dev/a/about/wincent/weblog/archives/2006/01/spam_will_be_so.php).
...
Spam that does get through to the client level is largely handled by [SpamSieve](https://wincent.dev/a/about/wincent/weblog/archives/2005/11/spamsieve_one_y.php). The current client-level statistics are as follows:
