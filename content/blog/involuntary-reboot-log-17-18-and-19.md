...
I've been too busy of late to post reports to my much-loved [Involuntary Reboot Log](https://wincent.dev/a/about/wincent/weblog/archives/involuntary_reboot_log/), but I'm finally catching up with my first three entries since upgrading to the final version of [Leopard](https://wincent.dev/wiki/Leopard).
