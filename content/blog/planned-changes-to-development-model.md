...
I've [commented elsewhere](http://wincent.dev/a/support/forums/ubbthreads.php?ubb=showflatΝmber=1008&page=1) that I plan on approximating a [continuous integration](http://wincent.dev/wiki/continuous%20integration) model of development in future releases of Synergy Advance (and all my products in fact).
...
-   Making more of my projects open source: WOTest, Bansshee, WinSwitch, [atosym](http://wincent.dev/a/products/atosym/), [Wincent Build Tools](http://wincent.dev/a/products/buildtools/), and Wincent Strings Utility.
-   Moving the code for these open source projects into a publicly accessible [Subversion](http://wincent.dev/wiki/Subversion) repository.
...
The initial version of the system is now deployed and the first nightlies are available. See [this article for more information](http://wincent.dev/s/nightlies/).
