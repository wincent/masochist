...
I've [commented elsewhere](https://wincent.dev/a/support/forums/ubbthreads.php?ubb=showflatΝmber=1008&page=1) that I plan on approximating a [continuous integration](https://wincent.dev/wiki/continuous%20integration) model of development in future releases of Synergy Advance (and all my products in fact).
...
The initial version of the system is now deployed and the first nightlies are available. See [this article for more information](https://wincent.dev/s/nightlies/).
