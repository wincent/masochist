...
It's nice to have [official confirmation](http://trac.macosforge.org/projects/zfs/wiki/faq) from an Apple employee that progress is being made towards making [ZFS](https://wincent.dev/wiki/ZFS) an option for formatting [Mac OS X](https://wincent.dev/wiki/Mac%20OS%20X) startup disks:
