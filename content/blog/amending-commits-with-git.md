...
One of the nice frills that comes with the [distributed version control](https://wincent.dev/wiki/distributed%20version%20control) model of [Git](https://wincent.dev/wiki/Git) is the ability to amend unpublished commits.
