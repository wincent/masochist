...
Try to upgrade to the first release candidate for [Rails](https://wincent.dev/wiki/Rails) 2.0:
...
Version control to the rescue, specifically [Git](https://wincent.dev/wiki/Git):
