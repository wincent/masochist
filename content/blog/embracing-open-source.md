...
So while I've often talked on this weblog (and on [my old one](https://wincent.dev/a/about/wincent/weblog/)) about how I like open source, and while I've already released a lot of code, behind the scenes for a long time I've actually been working towards a much more comprehensive commitment to open source. (If you want, you can go back and read articles that I wrote in [July 2005](https://wincent.dev/a/about/wincent/weblog/archives/2005/07/open_source_lic.php), [April 2006](https://wincent.dev/a/about/wincent/weblog/archives/2006/04/open_source_a_w.php), [September 2006](https://wincent.dev/a/about/wincent/weblog/archives/2006/09/open_vs_closed.php) and [January 2007](https://wincent.dev/a/about/wincent/weblog/archives/2007/01/open_source.php) to see how my position has gradually evolved.)
...
And on the process level I've been improving the website to lower barriers to participation (and as I've alluded [elsewhere](/pages/legal), the source code for the site itself will eveventually be going public; from the very first commit back in 2007 the code has been prepared with that eventuality in mind). This post has largely been about _code_, but my interest is in open processes and open companies in general. I'll have more to say on that topic in future posts.
