...
So while I've often talked on this weblog (and on [my old one](http://wincent.dev/a/about/wincent/weblog/)) about how I like open source, and while I've already released a lot of code, behind the scenes for a long time I've actually been working towards a much more comprehensive commitment to open source. (If you want, you can go back and read articles that I wrote in [July 2005](http://wincent.dev/a/about/wincent/weblog/archives/2005/07/open_source_lic.php), [April 2006](http://wincent.dev/a/about/wincent/weblog/archives/2006/04/open_source_a_w.php), [September 2006](http://wincent.dev/a/about/wincent/weblog/archives/2006/09/open_vs_closed.php) and [January 2007](http://wincent.dev/a/about/wincent/weblog/archives/2007/01/open_source.php) to see how my position has gradually evolved.)
