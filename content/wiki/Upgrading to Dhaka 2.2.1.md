...
These notes were made while upgrading from [Dhaka 2.2.0](/wiki/Dhaka_2.2.0) to [Dhaka 2.2.1](/wiki/Dhaka_2.2.1) on [Mac OS X](/wiki/Mac_OS_X) [Tiger](/wiki/Tiger).
...
## Output
    ...
    Successfully installed dhaka-2.2.1
    Installing ri documentation for dhaka-2.2.1...
    Installing RDoc documentation for dhaka-2.2.1...
...
## Output
    ...
    Attempting uninstall on dhaka-2.2.0
    Successfully uninstalled dhaka version 2.2.0
    Clean Up Complete
