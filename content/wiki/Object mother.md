...
There are many, many fixture replacements available for [Ruby](/wiki/Ruby). So many, in fact, that it looks like some sort of obligatory induction ritual that every Ruby programmer must undergo in order to become a fully-fledged developer.

-   [Factory Girl](/wiki/Factory_Girl): <http://github.com/thoughtbot/factory_girl>
-   [FixtureReplacement](/wiki/FixtureReplacement): <http://github.com/smtlaissezfaire/fixturereplacement>
