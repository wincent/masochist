...
$ git fetch
$ git tag -v v1.8.1 # confirm tag is correctly signed
$ git checkout v1.8.1
$ NO_GETTEXT=1 make prefix=/usr/local test
$ sudo env NO_GETTEXT=1 make prefix=/usr/local install
$ cd ..
$ curl -O http://git-core.googlecode.com/files/git-manpages-1.8.1.tar.gz
$ openssl sha1 git-manpages-1.8.1.tar.gz # compare SHA-1 against release announcement
$ sudo tar -C /usr/local/share/man -xzvf git-manpages-1.8.1.tar.gz
```
...
$ cd ..
$ curl -O http://git-core.googlecode.com/files/git-manpages-1.8.1.tar.gz
$ openssl sha1 git-manpages-1.8.1.tar.gz
$ tar -C $HOME/man -xzvf git-manpages-1.8.1.tar.gz
```
