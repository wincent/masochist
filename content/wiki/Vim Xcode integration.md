...
## `.m` files are [Objective-C](/wiki/Objective-C), not Matlab

    let filetype_m='objc'

-   Source: <https://www-old.cae.wisc.edu/pipermail/help-octave/2007-April/003712.html>

# External resources

-   <http://www.supermegaultragroovy.com/blog/2004/11/24/gvim-and-xcode/>:
...
-   <http://tech.groups.yahoo.com/group/vim-mac/message/5671>: notes on special [Xcode](/wiki/Xcode) integration features in [MacVim](/wiki/MacVim)
