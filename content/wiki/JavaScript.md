...
[JavaScript](/wiki/JavaScript) was originally a client-side scripting language commonly used in [web](/wiki/web) browsers. Initially it was used for simple tasks such as client-side form validation, but has in recent years been integral in the growing success of AJAX applications, ultimately resulting in the development of popular "thick client" applications such as Google Maps and Gmail, which involve enormous and complex bodies of logic that execute entirely on the client side.

Furthermore, in recent years people have been using JavaScript for server-side code as well (for example, see [node.js](/wiki/node.js)).
