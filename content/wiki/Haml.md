...
-   [DRY](/wiki/DRY), concise, well-indented, attractive markup
-   Rigorously correct [XHTML](/wiki/XHTML) output

Why a new templating system for [Rails](/wiki/Rails)? I think [this quote](http://unspace.ca/discover/haml/) best sums it up:
...
-   1.0 announcement on official [Rails](/wiki/Rails) [weblog](/wiki/weblog): <http://weblog.rubyonrails.org/2007/1/19/haml-1-0>
