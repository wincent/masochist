---
tags: involuntary.reboot.log os.x reliability
---
...
-   Last log entry: [Involuntary Reboot Log 6.6](/snippets/1077)
-   Failure type: hard reset
-   Kernel panics: 1
-   Hard resets: 5
-   Total failures: 6
...
**Note:** This is the machine I'm currently using, so I'll update this later (and certainly no later than moving on to a new machine).
