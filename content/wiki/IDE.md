...
An example [IDE](/wiki/IDE) is [Xcode](/wiki/Xcode), the free [IDE](/wiki/IDE) provided by [Apple](/wiki/Apple) as part of the [Xcode Tools](/wiki/Xcode_Tools) for [Mac OS X](/wiki/Mac_OS_X).
