...
Note that [ANTLR](/wiki/ANTLR) 3.0 does *not* include the stream stacking support. Any version after [changeset 3839](http://fisheye2.cenqua.com/changelog/antlr/?cs=3839) should be fine, or [ANTLR 3.0.1](/wiki/ANTLR_3.0.1) when it is released (not yet released at the time of writing, 20 June 2007).
