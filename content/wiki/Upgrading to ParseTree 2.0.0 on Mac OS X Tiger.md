...
These notes were made while upgrading to the latest version of [ParseTree](/wiki/ParseTree), [ParseTree 2.0.0](/wiki/ParseTree_2.0.0), on [Mac OS X](/wiki/Mac_OS_X) [Tiger](/wiki/Tiger).
...
## Output
    ...
    Successfully installed ParseTree-2.0.0
    Installing ri documentation for ParseTree-2.0.0...
    Installing RDoc documentation for ParseTree-2.0.0...
...
## Output
    ...
    Indexing RI docs for ParseTree version 2.0.0.
    ...
    Indexing RI docs for hoe version 1.2.2.
    ...
    Indexing RI docs for rubyforge version 0.4.3.
...
## Output
    ...
    Attempting uninstall on ParseTree-1.7.1
    Successfully uninstalled ParseTree version 1.7.1
    Attempting uninstall on ruby-prof-0.5.0
    Successfully uninstalled ruby-prof version 0.5.0
    Attempting uninstall on ruby-prof-0.4.1
    Successfully uninstalled ruby-prof version 0.4.1
    Attempting uninstall on ZenTest-3.6.0
    Successfully uninstalled ZenTest version 3.6.0
    Attempting uninstall on hoe-1.2.1
    Successfully uninstalled hoe version 1.2.1
    Attempting uninstall on rubyforge-0.4.2
    Successfully uninstalled rubyforge version 0.4.2
    Clean Up Complete
