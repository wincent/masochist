...
Notes made while updating from [Git 1.7.2.2](/wiki/Git_1.7.2.2) to [Git 1.7.2.3](/wiki/Git_1.7.2.3) from within a local clone of the official upstream [Git](/wiki/Git) repository on [Mac OS X](/wiki/Mac_OS_X) 10.6.4 [Snow Leopard](/wiki/Snow_Leopard):
...
Notes made while updating from [Git 1.7.2.1](/wiki/Git_1.7.2.1) to [Git 1.7.2.3](/wiki/Git_1.7.2.3) on [Fedora](/wiki/Fedora) 8, again from within a local clone of the official upstream Git repository:

## Updating Git itself

I perform this on the two Amazon [EC2](/wiki/EC2) instances that I use to host Git repos:
...
In this case there were no changes relevant to my installation, so there is nothing to install. See "[Updating to Git 1.7.2](/wiki/Updating_to_Git_1.7.2)" for an example of an update involving GitWeb.
