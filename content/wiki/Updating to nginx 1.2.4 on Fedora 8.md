...
```shell
$ curl -O http://nginx.org/download/nginx-1.2.4.tar.gz \
       -O http://nginx.org/download/nginx-1.2.4.tar.gz.asc
$ gpg --verify nginx-1.2.4.tar.gz.asc
$ nice tar xzf nginx-1.2.4.tar.gz
$ cd nginx-1.2.4
