...
As noted in my initial installation notes ("[Installing Haml 1.5.2](/wiki/Installing_Haml_1.5.2)"), the instructions for installing [Haml](/wiki/Haml) in a [Rails](/wiki/Rails) application cause it to be installed in a folder called `stable`, and I feel this is a bad idea.

If the Haml [RubyGem](/wiki/RubyGem) is installed then you can avoid this problem by invoking the following from the top-level directory of your Rails application:
