...
-   4 minor enhancements:
    ...
    -   Added email\_notify, jabber\_notify, and rcov autotest plugins.
    -   Updated rakefile to include examples automatically in example\_dot\_autotest.
...
-   5 bug fixes:
    ...
    -   Fixes for -f (fast start) and last\_mtime in general.
