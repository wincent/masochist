...
## Output
    ...
    Successfully installed zentest-3.5.0
    Installing ri documentation for zentest-3.5.0...
    Installing RDoc documentation for zentest-3.5.0...
