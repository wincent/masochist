...
The `tidy` [command line](/wiki/command_line) tool is shipped as part of the standard [Mac OS X](/wiki/Mac_OS_X) distribution. Type `man tidy` at the [Terminal](/wiki/Terminal) for more information.
