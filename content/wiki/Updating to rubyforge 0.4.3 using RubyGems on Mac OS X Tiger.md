...
## Output
    ...
    .
    complete
    Successfully installed rubyforge-0.4.3
    Installing ri documentation for rubyforge-0.4.3...
    Installing RDoc documentation for rubyforge-0.4.3...
