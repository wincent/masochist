...
## Output
    ...
    Successfully installed ZenTest-3.6.1
    Installing ri documentation for ZenTest-3.6.1...
    Installing RDoc documentation for ZenTest-3.6.1...
