...
These notes were made while upgrading to [Git 1.5.3.1](/wiki/Git_1.5.3.1) on [Mac OS X](/wiki/Mac_OS_X) [Tiger](/wiki/Tiger), using a local clone of the central [Git](/wiki/Git) repository.

For notes on upgrading to 1.5.3.1 from the tarball, see "[Upgrading to Git 1.5.3.1 on Red Hat Enterprise Linux](/wiki/Upgrading_to_Git_1.5.3.1_on_Red_Hat_Enterprise_Linux)".
    ...
    # switching working tree to 1.5.3.1
    git checkout v1.5.3.1
