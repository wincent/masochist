...
## Output
    ...
    Successfully installed spec_ui-0.2.0
    Installing ri documentation for spec_ui-0.2.0...
    Installing RDoc documentation for spec_ui-0.2.0...
