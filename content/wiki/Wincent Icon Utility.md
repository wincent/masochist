...
[Wincent Icon Utility](/wiki/Wincent_Icon_Utility) is a small [command line](/wiki/command_line) tool for taking an ".icns" icons file and applying it to a directory as a custom folder icon. A plaintext copy of the [man page](/wiki/man_page) can be found [here](https://wincent.dev/a/products/wincent-icon-util/wincent-icon-util.1.txt).
