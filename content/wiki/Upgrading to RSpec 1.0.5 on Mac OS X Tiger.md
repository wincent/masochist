...
This time seeing as I had [some local changes](https://wincent.dev/a/about/wincent/weblog/archives/2007/05/rspec_changes.php) to my [TextMate](/wiki/TextMate) bundle I didn't want to perform the normal upgrade procedure:
