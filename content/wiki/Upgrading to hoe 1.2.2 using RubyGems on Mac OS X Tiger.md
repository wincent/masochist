...
These notes were made while updating to [hoe 1.2.2](/wiki/hoe_1.2.2) using [RubyGems](/wiki/RubyGems) on [Mac OS X](/wiki/Mac_OS_X) [Tiger](/wiki/Tiger).
...
## Output
    ...
    Successfully installed hoe-1.2.2
    Installing ri documentation for hoe-1.2.2...
    Installing RDoc documentation for hoe-1.2.2...
