...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <div style="text-align: center; font-family: 'Lucida Grande'; margin: 5px 250px 5px 250px; padding: 5px; font-size: x-small; border: 2px solid silver; -webkit-border-radius: 0.5em; -moz-border-radius: 0.5em; background: #fefefe;">
      ...
      <tr>
        ...
        <td style="background-image: url(/a/gfx/header/center-background.jpg); background-repeat: repeat;" colspan="11" align="center" valign="middle">          <a href="https://wincent.com/"><img src="/a/gfx/wincent-logo-small-gray-bg.jpg" width="43" height="41" alt="wincent" align="middle" /></a>
  ...
  <div id="breadcrumbs">
    <p><a href="https://wincent.com/">Main</a>&nbsp;&gt;&nbsp;Error    </p>
  </div>
    <div id="container">
      <div class="content">
        <h3>An error occurred preventing access to the item you requested</h3>
        <p>Try looking on the <a href="https://wincent.com/a/site-map/">Site Map</a>. Alternatively, search this site using <a href="http://www.google.com/">Google</a>:</p>
        ...
        <div class="two-columns">
          <ul>
            <li><a href="https://wincent.com/a/support/registration/">Lost license code retrieval</a></li>
            <li><a href="https://wincent.com/a/products/synergy-advance/">Synergy Advance</a></li>
            <li><a href="https://wincent.com/a/products/synergy-classic/">Synergy</a></li>
            <li><a href="https://wincent.com/a/products/winswitch/">WinSwitch</a></li>
            <li><a href="https://wincent.com/a/products/winhex/">WinHex</a></li>
            <li><a href="https://wincent.com/a/products/install/">Install</a></li>
          </ul>
        </div>
        <div class="two-columns">
          <ul>
            <li><a href="https://wincent.com/a/support/faq/">Frequently Asked Questions</a></li>
            ...
            <li><a href="https://wincent.com/a/news/">News</a> (formerly wincent.org</a>)</li>
            <li><a href="https://wincent.com/a/about/privacy/">Privacy policy</a></li>
          </ul>
        </div>  
        <p style="clear:both">Please <a href="https://wincent.com/a/contact/">contact</a> the webmaster if you think that you have found a broken link within <a href="https://wincent.com/">wincent.com</a>. If the broken link originates on another website please inform the originating site.</p>
      </div>
    </div>
<div id="footer">
