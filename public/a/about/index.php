...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <div id="breadcrumbs">
      <p><a href="https://wincent.dev/">Main</a>&nbsp;&gt;&nbsp;About</p>
    </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
      ...
      <div id="center">
        <div class="content">
          ...
          <p>
            In November 2002, Wincent publicly released its first commercial
            application, <a href="../products/synergy-classic/">Synergy</a>, an
            innovative iTunes menu bar controller and hot key interface.
          </p>

          <p>
            Since then, Synergy has been under active development and has
            attracted
            <a
              href="https://wincent.dev/a/products/synergy-classic/testimonials/"
              >glowing reviews by the press and the public</a
            >.
          </p>

          <p>
            Wincent's second publicly released application is
            <a href="../products/install/">Install</a>, a flexible and powerful
            deployment solution for software developers; and subsequent Wincent
            releases include <a href="../products/winhex/">WinHex</a>, a
            powerful number conversion aid for programmers and other people who
            work with numbers in a digital setting;
            <a href="../products/winswitch/">WinSwitch</a>, an enhanced
            replacement for Apple's Fast User Switching menu; and
            <a href="https://wincent.dev/a/products/synergy-advance/"
              >Synergy Advance</a
            >, Synergy's "big brother".
          </p>

          <p>
            Wincent specializes in Mac OS X software development using the Cocoa
            frameworks and Objective-C, but also employs other languages and
            technologies as necessary, including Carbon, C, Perl, PHP and even
            the lowly shell. Its products call on all levels of the Mac OS X
            infrastructure, from Mach kernel calls through to high-level
            AppleScript.
          </p>
          ...
          <p>
            ...
            web. He also aims to bring noteworthy software releases to the
