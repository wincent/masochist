...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <div id="breadcrumbs">
    <p><a href="https://wincent.com/">Main</a>&nbsp;&gt;&nbsp;About    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
      ...
      <div id="center">
        <div class="content">
          ...
          <p>Wincent was founded in 1997 by <a href="wincent/">Wincent Colaiuta</a>. It began as a simple website, predominantly in weblog format, hosted at wincent.org. Since then it has evolved into a small but popular software development company, but it continues to be a one-man operation.</p>
          
          <h4>Cocoa software development</h4>
          
          <p>In November 2002, Wincent publicly released its first commercial application, <a href="../products/synergy-classic/">Synergy</a>, an innovative iTunes menu bar controller and hot key interface.</p>
          
          <p>Since then, Synergy has been under active development and has attracted <a href="https://wincent.com/a/products/synergy-classic/testimonials/">glowing reviews by the press and the public</a>.</p>
          
          <p>Wincent's second publicly released application is <a href="../products/install/">Install</a>, a flexible and powerful deployment solution for software developers; and subsequent Wincent releases include <a href="../products/winhex/">WinHex</a>, a powerful number conversion aid for programmers and other people who work with numbers in a digital setting; <a href="../products/winswitch/">WinSwitch</a>, an enhanced replacement for Apple's Fast User Switching menu; and <a href="https://wincent.com/a/products/synergy-advance/">Synergy Advance</a>, Synergy's "big brother".</p>
          
          <p>Wincent specializes in Mac OS X software development using the Cocoa frameworks and Objective-C, but also employs other languages and technologies as necessary, including Carbon, C, Perl, PHP and even the lowly shell. Its products call on all levels of the Mac OS X infrastructure, from Mach kernel calls through to high-level AppleScript.</p>
          
          <h4>Mac tips, news and commentary</h4>
          
          <p>The <a href="../news/">news page</a> and <a href="../knowledge-base/">knowledge base</a> (formerly found at wincent.org) continue to provide valuable Mac tips, news and commentary. These do not seek to compete with other Mac websites by merely duplicating their content. Rather, Wincent seeks to publish the tips and information that are not easily found elsewhere on the web. He also aims to bring noteworthy software releases to the attention of the readership.</p>
