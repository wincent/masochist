...
<ul>
  <li>
    <h4>
      Speed up full-text indexing by doing a multi-row insert (wincent.dev,
      0d3e312)
    </h4>
    <p>
  ...
  <li>
    <h4>
      Fix the n+1 select problem in the tags implementation (wincent.dev,
      513d102)
    </h4>
    <p>
...
<ul>
  <li>
    <h4>Add product creation with icon uploading (wincent.dev, b970662)</h4>
    <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>
  </li>

  <li>
    <h4>
      Add extension and description to products model (migration) (wincent.dev,
      4eb5a36)
    </h4>
    <p>
  ...
  <li>
    <h4>
      Add products listing to index, links are permalinks (wincent.dev, 63db015)
    </h4>
    <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>
  </li>
  ...
  <li>
    <h4>
      Teach products controller to find all products (wincent.dev, b794161)
    </h4>
    <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>
  </li>
  ...
  <li>
    <h4>
      Add &quot;index&quot; action to products controller (wincent.dev, 96c7e77)
    </h4>
  ...
  <li>
    <h4>Add basic products controller specs (wincent.dev, 4b2b9cb)</h4>
    <p>
  ...
  <li>
    <h4>Validate uniqueness of product permalinks (wincent.dev, a33cdbc)</h4>
  ...
  <li>
    <h4>Require permalink on products model (wincent.dev, 6c0c3b7)</h4>
    <p>
  ...
  <li>
    <h4>Add permalink column to products table (wincent.dev, a4263df)</h4>
    <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>
  </li>
</ul>
...
<ul>
  <li>
    <h4>
      Add products controller and make it the default (root) route (wincent.dev,
      e1580bd)
    </h4>
    <p>
  ...
  <li>
    <h4>
      Add database-level constraint for product name uniqueness (wincent.dev,
      7805a54)
    </h4>
    <p>
  ...
  <li>
    <h4>Add example data for products model (wincent.dev, 4109d10)</h4>
    <p>
