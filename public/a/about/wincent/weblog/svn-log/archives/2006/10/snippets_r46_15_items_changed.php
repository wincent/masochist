    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2006/10/wocommon_r89_6_items_changed.php"
            >&laquo; WOCommon r89, 6 items changed</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2006/10/wocommon_r90_63_items_changed.php"
            >WOCommon r90, 63 items changed &raquo;</a
          >
        </p>
        ...
        <p>
          Product name changes in header comments, update and add missing
          copyright headers
        </p>

        <div id="a000595more"><div id="more"></div></div>
