...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2006/12/wocommon_r209_2_items_changed.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2006/12/wocommon_r209_2_items_changed.php"
            >&laquo; WOCommon r209, 2 items changed</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2006/12/synergy_advance_r356_2_items_c.php"
            >Synergy Advance r356, 2 items changed &raquo;</a
          >
        </p>
        ...
        <p>
          Plug-in-specific user defaults are now managed from within the
          plug-ins themselves rather than in the main app; the first plug-in to
          be converted to the new style is the Dock plug-in
        </p>

        <div id="a000995more"><div id="more"></div></div>
