...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2006/10/sa_r13_1_item_changed.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2006/10/sa_r15_26_items_changed.php"
            >SA r15, 26 items changed &raquo;</a
          >
        </p>
        ...
        <p>
          It appears that the outer autorelease pool is rendered unnecessary
          thanks to garbage collection (ie. it appears that no system code is
          causing autorelease messages to be sent); remove the pool
        </p>

        <div id="a000722more"><div id="more"></div></div>
