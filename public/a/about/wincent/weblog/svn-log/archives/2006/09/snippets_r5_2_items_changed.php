    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2006/09/snippets_r6_1_item_changed.php"
            >snippets r6, 1 item changed &raquo;</a
          >
        </p>
        ...
        <p>
          commit-feed.rb post-commit hook script, updates weblog with Suversion
          activity (commit log messages)
        </p>

        <div id="a000443more"><div id="more"></div></div>
