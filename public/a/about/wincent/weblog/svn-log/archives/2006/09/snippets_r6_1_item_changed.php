...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2006/09/snippets_r5_2_items_changed.php"
      title="snippets r5, 2 items changed"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2006/09/snippets_r7_1_item_changed.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2006/09/snippets_r5_2_items_changed.php"
            >&laquo; snippets r5, 2 items changed</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2006/09/snippets_r7_1_item_changed.php"
            >snippets r7, 1 item changed &raquo;</a
          >
        </p>
        ...
        <p>
          Add mkrsshjail.sh script to snippets repository (script written in
          January to make it easy to create chroot jails suitable for use with
          rssh)
        </p>

        <div id="a000444more"><div id="more"></div></div>
