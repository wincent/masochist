...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Objective C 2.0: garbarge collection (Wincent Strings
      Utility, 1de2729)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/remove_references_to_no_longer.php"
      title="Remove references to no longer included Omni files (Wincent Strings Utility, 1736e59)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/objectivec_20_fast_enumeration.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/remove_references_to_no_longer.php"
            >&laquo; Remove references to no longer included Omni files (Wincent
            Strings Utility, 1736e59)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/objectivec_20_fast_enumeration.php"
            >Objective-C 2.0: fast enumeration (Wincent Strings Utility,
            146e1b7) &raquo;</a
          >
        </p>
        ...
        <h3>
          Objective C 2.0: garbarge collection (Wincent Strings Utility,
          1de2729)
        </h3>

        <p>
          Garbarge collection is already turned on; remove release and
          autorelease messages which are now redundant.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002510more"><div id="more"></div></div>
