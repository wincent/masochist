...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: GC changes for WOBundle class (WOCommon, 6e2d71e)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/gc_changes_to_registration_con.php"
            >&laquo; GC changes to registration controller core category
            (WOCommon, db186a6)</a
          >
          |
        ...
        <p>
          Remove unnecessary retain and release calls for running under GC in
          Leopard.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002877more"><div id="more"></div></div>
