...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Switch to WOPublic check and assert macros (WOCommon,
      c9571fb)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/additional_notes_about_check_m.php"
      title="Additional notes about check macro usage (WOPublic, 0080b3d)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/add_path_to_cron_job_notes_sni.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/additional_notes_about_check_m.php"
            >&laquo; Additional notes about check macro usage (WOPublic,
            0080b3d)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/add_path_to_cron_job_notes_sni.php"
            >Add PATH to cron job notes (snippets, a72ff7e) &raquo;</a
          >
        </p>
        ...
        <p>
          Remove the old assertion macros defined in WOCommon and replace
          references to them with the new macros provided by WOPublic.
        </p>

        <p>
          There is now a clear semantic distinction between assertions
          (debugging aids used only at development-time) and checks
          (always-enforced confirmations of expectations, present in both debug
          and release builds). Checks are used in unit tests and wherever a
          normal assertion would be inadequate (for example, when the assertion
          is used to uphold an API contract, but can't do so in release builds
