...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Replace prefix header with global header (gdiff,
      25903a1)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/set_up_default_pbxuser_setting.php"
            >&laquo; Set up default pbxuser settings (gdiff, 6120b07)</a
          >
          |
        ...
        <p>
          Fall back to standard use of &lt;Cocoa/Cocoa.h&gt; as prefix header
          and create a separate target-specific global header for
          target-specific macros.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002942more"><div id="more"></div></div>
