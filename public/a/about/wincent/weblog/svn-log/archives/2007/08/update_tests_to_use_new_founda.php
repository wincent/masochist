...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update tests to use new Foundation API (WOCommon,
      09eae47)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/convert_project_bundle_to_xcod.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/updates_for_changes_to_cdsa_ap.php"
            >&laquo; Updates for changes to CDSA API in Leopard (WOCommon,
            787852a)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/convert_project_bundle_to_xcod.php"
            >Convert project bundle to Xcode 3.0 format (Synergy Advance,
            62b0784) &raquo;</a
          >
        </p>
        ...
        <p>
          In ripping out my old NSRect-to-CGRect functions I overlooked a couple
          of places in the test suite where they were still used. This commit
          replaces those instances with calls to the system-provided functions.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002647more"><div id="more"></div></div>
