...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Initial version of Git build number scripts (buildtools,
      bd6ad3d)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/add_gitbased_build_numbers_wob.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/tighten_up_exit_status_check_i.php"
            >&laquo; Tighten up exit status check in post-receive script
            (snippets, 2be9c00)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/add_gitbased_build_numbers_wob.php"
            >Add Git-based build numbers (WOBezel, a25ca59) &raquo;</a
          >
        </p>
        ...
        <p>
          This commit adds a simple Git utility module which doesn't do much
          yet, just reports &quot;revision numbers&quot; (corresponding to the
          abbreviated hash of the most recent commit), and a script intended for
          use in an Xcode Shell Script build phase that leverages this module
          and uses it to create or update a &quot;build number&quot; file that
          can then be used for as a header for Info.plist preprocessing or other
          purposes.
        </p>

        <p>
          This replaces the old scripts which did the same thing in Subversion
          terms; in the end I decided to go with the abbreviated hash as the
          build number despite the fact that it's not very human intelligible:
          its most important attribute is that it uniquely identifies the exact
          version of the source code that was used to produce a build.
        </p>

        <p>
          Note that due to a bug in Git the &quot;local changes&quot; variant
          does not yet work (this is where the build number has a &quot;+&quot;
          appended to it to indicate local changes since the last commit).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002623more"><div id="more"></div></div>
