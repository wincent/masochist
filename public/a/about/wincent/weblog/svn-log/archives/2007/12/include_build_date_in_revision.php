...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Include build date in revision file (buildtools,
      c26297e)
    </title>
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          But only update it when the Git HEAD commit changes, to avoid spurious
          recompiles in Xcode.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003296more"><div id="more"></div></div>
