...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Cleanup WOSingleton header (WOCommon, a463e15)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/remove_methods_which_are_noops.php"
      title="Remove methods which are no-ops under Garbage Collection (WOCommon, ca1fae3)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/fix_indentation_in_wosingleton.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/remove_methods_which_are_noops.php"
            >&laquo; Remove methods which are no-ops under Garbage Collection
            (WOCommon, ca1fae3)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/fix_indentation_in_wosingleton.php"
            >Fix indentation in WOSingleton.m (WOCommon, a66b2bc) &raquo;</a
          >
        </p>
        ...
        <p>
          Remove redundant method declarations in the header (stuff that is
          inherited from NSObject) and the accompanying Doxygen blocks (some of
          which had technical discrepancies anyway), convert remaining Doxygen
          blocks to use the currently preferred style (the one which gets along
          most nicely with Xcode's automatic indentation), eliminate some
          superfluous whitespace, and update the date format to match the
          standard.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002714more"><div id="more"></div></div>
