...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add stories subdirectory (wincent.dev, 521539e)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_article_and_revision_model.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/set_up_ignores_in_test_subdire.php"
            >&laquo; Set up ignores in test subdirectory (wincent.dev,
            0169c6c)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_article_and_revision_model.php"
            >Add Article and Revision models (wincent.dev, 884af44) &raquo;</a
          >
        </p>

        <h2>October 15, 2007</h2>

        <h3>Add stories subdirectory (wincent.dev, 521539e)</h3>

        <p>Add base files provided by RSpec.</p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003075more"><div id="more"></div></div>
