...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Conditionalize border drawing (gdiff, a994690)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/draw_borders_in_gutter_views_g.php"
            >&laquo; Draw borders in gutter views (gdiff, eff8c91)</a
          >
          |
        ...
        <p>
          Only attempt drawing if the border's rectangle intersects with the
          visible area.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002999more"><div id="more"></div></div>
