...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Keep known-good ANTLR version in repository (wikitext,
      85a0852)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/fix_typo_in_defined_test_wikit.php"
            >&laquo; Fix typo in defined test (wikitext, 4494181)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/makefile_cleanup_and_correctio.php"
            >Makefile cleanup and corrections (wikitext, f2254e1) &raquo;</a
          >
        </p>
        ...
        <p>
          I've had a fair bit of trouble getting things back up and running with
          the move to ANTLR 3.0.1, so I'm going to store a known-good version of
          ANTLR (source archive plus patches) in the repository. This may be
