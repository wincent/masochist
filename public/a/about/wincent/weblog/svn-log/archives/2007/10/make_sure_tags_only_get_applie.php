...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Make sure tags only get applied once (typechecked.net,
      3342585)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/whitespace_fix_wincentcom_bfa8.php"
      title="Whitespace fix (typechecked.net, bfa88e8)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/add_taggable_module_wincentcom.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/whitespace_fix_wincentcom_bfa8.php"
            >&laquo; Whitespace fix (typechecked.net, bfa88e8)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/add_taggable_module_wincentcom.php"
            >Add Taggable module (typechecked.net, 003f9f3) &raquo;</a
          >
        </p>

        <h2>October 15, 2007</h2>

        <h3>Make sure tags only get applied once (typechecked.net, 3342585)</h3>
