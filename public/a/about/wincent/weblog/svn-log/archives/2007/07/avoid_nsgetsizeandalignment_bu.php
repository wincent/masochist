...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Avoid NSGetSizeAndAlignment bug (WOTest, 1266032)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/allow_pointertopointer_compari.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/whitespace_cleanup_wotest_b788.php"
            >&laquo; Whitespace cleanup (WOTest, b788b43)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/allow_pointertopointer_compari.php"
            >Allow pointer-to-pointer comparisons (WOTest, 8210f41) &raquo;</a
          >
        </p>
        ...
        <p>
          Leopard has a bug in the NSGetSizeAndAlignment() function which
          prevents it from handling structs which have bitfields in them. This
          in turn breaks the +[NSValue valueWithBytes:objCType:] method when
          used with structs containing bitfields.
        </p>

        <p>
          So this commit #ifdefs out the tests which fail as a result of this
          bug. A simplified testcase demonstrating the problem has be en added
          to the &quot;other&quot; subdirectory. A Radar has been filed
          (&lt;rdar://problem/5357040&gt;); currently awaiting on a fix from
          Apple.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002526more"><div id="more"></div></div>
