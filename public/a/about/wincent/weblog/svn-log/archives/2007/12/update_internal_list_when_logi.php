...
<title>Git activity log: Update internal list when login items are added or removed (WOCommon, ff094c5)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/use_womakecollectable_function.php" title="Use WOMakeCollectable function where appropriate (WOCommon, 6eb9559)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/checkseries_fix_snippets_5c297.php" title="check-series fix (snippets, 5c29711)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/use_womakecollectable_function.php">&laquo; Use WOMakeCollectable function where appropriate (WOCommon, 6eb9559)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/checkseries_fix_snippets_5c297.php">check-series fix (snippets, 5c29711) &raquo;</a>

</p>

<h2>December 10, 2007</h2>

<h3>Update internal list when login items are added or removed (WOCommon, ff094c5)</h3>

<p>Add a refreshList method (internal use only) which is called whenever we add or remove a login item.</p>

<p>This also moves some of the addition logic from WOLoginItemList into a new addToList: method in WOLoginItem; in this way each login item can keep track of its corresponding LS ref without breaking encapsulation.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003262more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at December 10, 2007  1:15 PM</p>
