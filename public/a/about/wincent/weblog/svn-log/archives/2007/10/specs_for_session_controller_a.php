...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Specs for session controller and tweaks to get them
      passing (wincent.dev, 067ca6f)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/refactor_code_from_user_model.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/make_localization_work_in_sess.php"
            >&laquo; Make localization work in sessions controller (wincent.dev,
            56951c3)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/refactor_code_from_user_model.php"
            >Refactor code from User model into Authentication module
            (wincent.dev, f625239) &raquo;</a
          >
        </p>
        ...
        <h3>
          Specs for session controller and tweaks to get them passing
          (wincent.dev, 067ca6f)
        </h3>

        <p>
          The session controller is now fully specced; some tweaks were
          necessary in order to get all specs passing.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003088more"><div id="more"></div></div>
