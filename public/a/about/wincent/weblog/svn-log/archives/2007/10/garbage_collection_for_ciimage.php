...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Garbage collection for CIImage+WOConvenience category
      (WOCommon, 35882a2)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/use_public_nsmethodsignature_a.php"
            >&laquo; Use public NSMethodSignature API (WOTest, 8ad52f7)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/garbage_collection_for_nsarray.php"
            >Garbage collection for NSArrayController+WODragUtilities category
            (WOCommon, 235882a) &raquo;</a
          >
        </p>
        ...
        <h3>
          Garbage collection for CIImage+WOConvenience category (WOCommon,
          35882a2)
        </h3>

        <p>
          Remove old reference-counting code (no longer needed under GC and
          Leopard).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002865more"><div id="more"></div></div>
