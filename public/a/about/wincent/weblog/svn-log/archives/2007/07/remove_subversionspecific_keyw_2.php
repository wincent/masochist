...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove Subversion-specific keywords (buildtools,
      5ac53a7)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/initial_import_buildtools_e7f5.php"
            >&laquo; Initial import (buildtools, e7f5322)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/use_unambiguous_date_format_bu.php"
            >Use unambiguous date format (buildtools, 627c240) &raquo;</a
          >
        </p>
        ...
        <p>
          Remove all $Id$ tags from source files. They are specific to
          Subversion and now we've migrated to Git.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002480more"><div id="more"></div></div>
