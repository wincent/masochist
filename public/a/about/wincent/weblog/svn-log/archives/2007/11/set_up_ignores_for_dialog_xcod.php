...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Set up ignores for dialog Xcode project bundle
      (snippets, 78468e0)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/bail_early_if_not_inside_a_git.php"
            >&laquo; Bail early if not inside a Git repo (snippets, fbc5f09)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/bump_version_number_postreleas.php"
            >Bump version number post-release (Synergy, fa0519e) &raquo;</a
          >
        </p>
        ...
        <p>
          As per usual, ignore per-user *.pbxuser and *.mode* files, allowing
          only default.pbxuser as a specific exception.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003177more"><div id="more"></div></div>
