...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Call mainViewDidLoad when showing preference pane
      (Synergy, 4a9cbcf)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/update_shell_script_for_new_de_1.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/update_shell_script_for_new_de_1.php"
            >&laquo; Update shell script for new development language path
            (Synergy, a0adca5)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/call_mainviewdidload_when_show_1.php"
            >Call mainViewDidLoad when showing preference pane (Synergy,
            4a9cbcf) &raquo;</a
          >
        </p>
        ...
        <p>
          Add missing call in WOPreferencePane class to ensure the preference
          pane gets properly initialized at load time.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003367more"><div id="more"></div></div>
