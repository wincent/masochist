...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove debugging log statement (gdiff, 1d0c023)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/allow_horizontal_scrollers_whe.php"
      title="Allow horizontal scrollers when necessary (gdiff, 30abc8d)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/move_subview_initialization_in.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/allow_horizontal_scrollers_whe.php"
            >&laquo; Allow horizontal scrollers when necessary (gdiff,
            30abc8d)</a
          >
          |
        ...
        <p>
          Fix another mistake in the botched history rewrite (see 4679d86 for
          more information); this is a debugging log statement that should have
          been removed but which was left in.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002990more"><div id="more"></div></div>
