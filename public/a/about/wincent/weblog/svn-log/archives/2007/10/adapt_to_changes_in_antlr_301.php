...
<title>Git activity log: Adapt to changes in ANTLR 3.0.1 C runtime (wikitext, eda9b8d)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/fix_invisible_character_wikite.php" title="Fix invisible character (wikitext, 4c107f0)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/store_generate_files_in_reposi.php" title="Store generate files in repository (wikitext, 402251b)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/fix_invisible_character_wikite.php">&laquo; Fix invisible character (wikitext, 4c107f0)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/store_generate_files_in_reposi.php">Store generate files in repository (wikitext, 402251b) &raquo;</a>

</p>

<h2>October 16, 2007</h2>

<h3>Adapt to changes in ANTLR 3.0.1 C runtime (wikitext, eda9b8d)</h3>

<p>In version 3.0 of the ANTLR runtime the &quot;start&quot; field in the ANTLR3_COMMON_TOKEN_struct was a character index (the number of characters, not bytes, relative to the start of the input stream). Likewise for the &quot;stop&quot; field.</p>

<p>In version 3.0.1 the &quot;start&quot; field is now an absolute pointer, as is the &quot;stop&quot; field.</p>

<p>One caveat: one thing which appears to be a bug is that the &quot;stop&quot; field does not point to the end of the token, but rather to one byte before it. I suspect that this bug is latent when working with ASCII streams, but it is a problem when working with UCS-2 streams (where each character is 2 byte) because this means that the &quot;stop&quot; field now points to the second half of a character, which is invalid. This commit adjusts the stop field up by 1 byte to compensate.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003017more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at October 16, 2007 12:26 PM</p>
