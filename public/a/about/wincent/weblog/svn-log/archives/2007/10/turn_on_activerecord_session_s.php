...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Turn on ActiveRecord session store (wincent.dev,
      405881e)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_skeletal_models_wincentcom.php"
      title="Add skeletal models (wincent.dev, a50b4bc)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/update_scriptspec_wincentcom_5.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_skeletal_models_wincentcom.php"
            >&laquo; Add skeletal models (wincent.dev, a50b4bc)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/update_scriptspec_wincentcom_5.php"
            >Update script/spec (wincent.dev, 57f43c1) &raquo;</a
          >
        </p>

        <h2>October 15, 2007</h2>

        <h3>Turn on ActiveRecord session store (wincent.dev, 405881e)</h3>

        <p>
          For better peformance, and to tie in with the session controller that
          provides RESTful login and logout.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003072more"><div id="more"></div></div>
