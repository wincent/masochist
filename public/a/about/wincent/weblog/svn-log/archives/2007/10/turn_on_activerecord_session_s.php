...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Turn on ActiveRecord session store (typechecked.net,
      405881e)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/add_skeletal_models_wincentcom.php"
      title="Add skeletal models (typechecked.net, a50b4bc)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/update_scriptspec_wincentcom_5.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/add_skeletal_models_wincentcom.php"
            >&laquo; Add skeletal models (typechecked.net, a50b4bc)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/update_scriptspec_wincentcom_5.php"
            >Update script/spec (typechecked.net, 57f43c1) &raquo;</a
          >
        </p>

        <h2>October 15, 2007</h2>

        <h3>Turn on ActiveRecord session store (typechecked.net, 405881e)</h3>
