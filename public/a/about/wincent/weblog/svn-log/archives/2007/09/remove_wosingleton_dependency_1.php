...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove WOSingleton dependency from
      WORegistrationController (WOCommon, 515521f)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/remove_dependency_on_wosinglet.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/remove_dependency_on_wosinglet.php"
            >&laquo; Remove dependency on WOSingleton from WOLoginManager
            (WOCommon, 4450945)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/update_registration_nib_to_ref.php"
            >Update registration nib to reflect new class hierarchy (WOCommon,
            c08e31e) &raquo;</a
          >
        </p>
        ...
        <h3>
          Remove WOSingleton dependency from WORegistrationController (WOCommon,
          515521f)
        </h3>

        <p>
          Although there should never be any need to have more than one instance
          of WORegistrationController active at any time, there is no real need
          to enforce singleton behaviour either. A single
          WORegistrationController instance is generally instantiated in a nib
          rather than programmatically so there should never be more than one
          instance at a time anyway; even if there were it would be completely
          harmless.
        </p>

        <p>
          So this commit removes the dependency on WOSingleton as it is an
          unnecessary complication.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002739more"><div id="more"></div></div>
