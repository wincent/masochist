...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update FixtureReplacement (typechecked.net, 563b8ab)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/11/remove_files_from_previous_rsp.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/11/remove_files_from_previous_rsp.php"
            >&laquo; Remove files from previous RSpec version (typechecked.net,
            71d1c5b)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/11/add_fixturereplacement_upgrade.php"
            >Add FixtureReplacement upgrade notes (typechecked.net, 6ead2fc)
            &raquo;</a
          >
        </p>
        ...
        <h3>Update FixtureReplacement (typechecked.net, 563b8ab)</h3>
