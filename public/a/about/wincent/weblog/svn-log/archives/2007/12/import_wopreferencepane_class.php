...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Import WOPreferencePane class (WOCommon, b5411f2)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/fix_another_womakecollectablen.php"
            >&laquo; Fix another WOMakeCollectable/NSMakeCollectable issue
            (WOCommon, 42aa205)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/multiple_fixes_for_leopard_woc.php"
            >Multiple fixes for Leopard (WOCommon, af7ad15) &raquo;</a
          >
        </p>
        ...
        <p>
          This was originally developed for Synergy 3.5, but the code is very
          generic and belongs in WOCommon.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003459more"><div id="more"></div></div>
