...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix ANTLR installation procedure to allow repeated
      installs (wikitext, 281927e)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/tweak_extension_build_for_leop.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/tweak_extension_build_for_leop.php"
            >&laquo; Tweak extension build for Leopard compatibility (wikitext,
            7a51010)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/fix_leopard_gcc_warnings_wikit.php"
            >Fix Leopard GCC warnings (wikitext, cee8b13) &raquo;</a
          >
        </p>
        ...
        <h3>
          Fix ANTLR installation procedure to allow repeated installs (wikitext,
          281927e)
        </h3>

        <p>
          Allow repeated installs by explicitly removing previous installed
          versions first.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003045more"><div id="more"></div></div>
