...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Whitespace fix (typechecked.net, bfa88e8)</title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/add_article_and_revision_model.php"
            >&laquo; Add Article and Revision models (typechecked.net, 884af44)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/make_sure_tags_only_get_applie.php"
            >Make sure tags only get applied once (typechecked.net, 3342585)
            &raquo;</a
          >
        </p>
        ...
        <h3>Whitespace fix (typechecked.net, bfa88e8)</h3>
