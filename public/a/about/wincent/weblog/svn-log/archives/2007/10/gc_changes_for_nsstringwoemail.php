...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: GC changes for NSString+WOEmailUtilities class
      (WOCommon, 6375f08)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/gc_changes_for_nsstringwoconve.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/gc_changes_for_nsstringwoconve.php"
            >&laquo; GC changes for NSString+WOConversion category (WOCommon,
            31c36b5)</a
          >
          |
        ...
        <p>
          With the changes in semantics of CF objects under GC in Leopard it
          makes more sense just to work at the CF level throughout the
          emailMessage:subject:to: method rather than casting to Cocoa objects.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002870more"><div id="more"></div></div>
