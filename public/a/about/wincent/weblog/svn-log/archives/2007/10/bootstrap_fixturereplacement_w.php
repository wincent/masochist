...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Bootstrap FixtureReplacement (typechecked.net, 0dfd797)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/tell_rails_to_use_utf8_in_the.php"
            >&laquo; Tell Rails to use UTF-8 in the database (typechecked.net,
            4aba1f8)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/fix_capitalization_in_notes_wi.php"
            >Fix capitalization in notes (typechecked.net, 705b088) &raquo;</a
          >
        </p>

        <h2>October 5, 2007</h2>

        <h3>Bootstrap FixtureReplacement (typechecked.net, 0dfd797)</h3>
