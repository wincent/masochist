...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update Exporter class for Git (snippets, 5bbd3c0)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/remove_sync_options_from_night.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/remove_sync_options_from_night.php"
            >&laquo; Remove sync options from nightlies script (snippets,
            fd897e6)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/bring_uptodate_for_new_workflo.php"
            >Bring up-to-date for new workflow (snippets, 69b16dc) &raquo;</a
          >
        </p>
        ...
        <p>
          Dispose of SVN and SVK subclasses seeing as they'll never be used
          again and place the Git-specific code directly in the Exporter class
          itself.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003389more"><div id="more"></div></div>
