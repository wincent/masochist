...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add FixtureReplacement upgrade notes (typechecked.net,
      6ead2fc)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/11/update_fixturereplacement_winc.php"
            >&laquo; Update FixtureReplacement (typechecked.net, 563b8ab)</a
          >
          |
        ...
        <h3>Add FixtureReplacement upgrade notes (typechecked.net, 6ead2fc)</h3>
