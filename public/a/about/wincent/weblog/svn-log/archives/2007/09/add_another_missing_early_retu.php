...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add another missing early return (gdiff, 9e92950)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/yet_another_early_return_bug_g.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/factor_out_calls_to_authorizat.php"
            >&laquo; Factor out calls to AuthorizationFree (gdiff, 2552ca2)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/yet_another_early_return_bug_g.php"
            >Yet another early return bug (gdiff, d1813b4) &raquo;</a
          >
        </p>
        ...
        <p>
          During forced failure testing discovered another missing early return;
          when the installer tool was failure to communicate its process id back
          to the parent the main appliction wasn't aborting.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002971more"><div id="more"></div></div>
