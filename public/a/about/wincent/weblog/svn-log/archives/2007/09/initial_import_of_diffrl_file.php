...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Initial import of diff.rl file (gdiff, 2ab5e1c)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/update_gestaltbased_apis_to_ma.php"
            >&laquo; Update Gestalt-based APIs to match Apple's clipping
            behaviour (WOCommon, 6ce256c)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/add_makefile_gdiff_dac88ba.php"
            >Add Makefile (gdiff, dac88ba) &raquo;</a
          >
        </p>
        ...
        <p>
          This is a skeletal implementation of a Ragel state machine for parsing
          the output of &quot;git diff&quot;. At this stage it doesn't actually
          do anything other than recognize the diff and print logging statements
