...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Use double-hyphens for all switches (Wincent Strings
      Utility, dea11de)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/update_wincentstringsutil_call.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/update_wincentstringsutil_call.php"
            >Update wincent-strings-util calls to use double-hyphen switches
            (buildtools, 7acf42a) &raquo;</a
          >
        </p>
        ...
        <p>
          The NSUserDefaults standard for command-line switches uses only a
          single hyphen, which is a little unorthodox. Use more conventional
          double hyphens instead by inserting an additional hyphen in the
          default names.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003349more"><div id="more"></div></div>
