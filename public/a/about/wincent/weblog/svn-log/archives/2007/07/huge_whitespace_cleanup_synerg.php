...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/remove_build_subdirectory_syne.php"
      title="Remove build subdirectory (Synergy, 6ef0846)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/remove_redundant_build_setting_1.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/remove_build_subdirectory_syne.php"
            >&laquo; Remove build subdirectory (Synergy, 6ef0846)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/remove_redundant_build_setting_1.php"
            >Remove redundant build settings (WOBezel, 4f5a8a9) &raquo;</a
          >
        </p>
        ...
        <p>
          Massive whitespace cleanup throughout entire codebase (over 15,000
          lines in the diff): substitute spaces for tabs, kill trailing
          whitespace, improve alignment in some places.
        </p>

        <p>
          In some cases the search for unwanted tabs and trailing whitespace
          lead to lines containing redundant comments; rather than fixing the
          whitespace on those lines the entire comment was just removed.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002595more"><div id="more"></div></div>
