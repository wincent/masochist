...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Additional check in current-user installation method
      (gdiff, ddf9172)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/catch_exceptions_during_nstask.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/catch_exceptions_during_nstask.php"
            >&laquo; Catch exceptions during NSTask launch (gdiff, e8ceb3f)</a
          >
          |
        ...
        <p>
          Make sure that the gdiff helper tool really is where we expect it to
          be inside the main GUI app's bundle.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002966more"><div id="more"></div></div>
