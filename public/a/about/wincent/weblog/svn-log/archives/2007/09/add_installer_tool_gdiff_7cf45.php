...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/synergy_r406_1_item_changed.php"
      title="Synergy r406, 1 item changed"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/hook_up_user_interface_for_too.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/synergy_r406_1_item_changed.php"
            >&laquo; Synergy r406, 1 item changed</a
          >
          |
        ...
        <p>
          ...
          (namely, the fact that it doesn't return the exit code or the process
          id of the executed process) it is necessary to interpose an
          intermediary wrapper process that explicitly communicates its process
          id back to the parent process prior to executing the real installer.
        </p>

        <p>
          Hideously cumbersome approach but it's the way the Apple sample code
          does it.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002961more"><div id="more"></div></div>
