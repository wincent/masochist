...
<title>Git activity log: Work around CFStringCreateExternalRepresentation() bug (Wincent Strings Utility, b02b784)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/allow_explicit_override_of_out.php" title="Allow explicit override of output encoding (Wincent Strings Utility, 6afbc3c)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/add_test_case_for_cfstringcrea.php" title="Add test case for CFStringCreateExternalRepresentation() bug (Wincent Strings Utility, f9236a6)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/allow_explicit_override_of_out.php">&laquo; Allow explicit override of output encoding (Wincent Strings Utility, 6afbc3c)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/add_test_case_for_cfstringcrea.php">Add test case for CFStringCreateExternalRepresentation() bug (Wincent Strings Utility, f9236a6) &raquo;</a>

</p>

<h2>December 22, 2007</h2>

<h3>Work around CFStringCreateExternalRepresentation() bug (Wincent Strings Utility, b02b784)</h3>

<p>This commit adds some specs to test the operation of the -encode switch and in so doing has uncovered what looks to be a bug in the CFStringCreateExternalRepresentation() function.</p>

<p>The docs suggest that a BOM should be added to the beginning of the string, but in my testing this is not the case.</p>

<p>The workaround is to manually add the BOM, while double-checking to make sure that the system doesn't add one (just in case the behaviour of the system changes in the future).</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003332more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at December 22, 2007 10:00 PM</p>
