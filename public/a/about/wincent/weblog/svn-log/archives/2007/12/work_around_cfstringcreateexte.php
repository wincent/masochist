...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Work around CFStringCreateExternalRepresentation() bug
      (Wincent Strings Utility, b02b784)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/allow_explicit_override_of_out.php"
      title="Allow explicit override of output encoding (Wincent Strings Utility, 6afbc3c)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/add_test_case_for_cfstringcrea.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/allow_explicit_override_of_out.php"
            >&laquo; Allow explicit override of output encoding (Wincent Strings
            Utility, 6afbc3c)</a
          >
          |
          ...
          <a
            ...
            (Wincent Strings Utility, f9236a6) &raquo;</a
          >
        </p>
        ...
        <h3>
          ...
          Strings Utility, b02b784)
        </h3>

        <p>
          This commit adds some specs to test the operation of the -encode
          switch and in so doing has uncovered what looks to be a bug in the
        ...
        <p>
          ...
          make sure that the system doesn't add one (just in case the behaviour
          of the system changes in the future).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003332more"><div id="more"></div></div>
