...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove NSRect to CGRect conversion functions (WOCommon,
      78afcea)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/cleanup_build_settings_wocommo.php"
            >&laquo; Clean-up build settings (WOCommon, 7e8ed20)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/update_woproxy_for_objectivec.php"
            >Update WOProxy for Objective-C 2.0 (WOCommon, 87ce76e) &raquo;</a
          >
        </p>
        ...
        <p>
          These are now provided by the system instead, so remove the functions
          and their corresponding tests.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002640more"><div id="more"></div></div>
