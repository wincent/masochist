...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Use international-friendly dates in source files
      (WOHotKey, e25bb7c)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/update_copyright_date_ranges_w.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/update_copyright_date_ranges_w.php"
            >&laquo; Update copyright date ranges (WOHotKey, 9910801)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/remove_cleansvnsh_file_wodebug.php"
            >Remove CleanSVN.sh file (WODebug, 22147df) &raquo;</a
          >
        </p>
        ...
        <p>
          Modify some of the source files, which had potentially ambiguous dates
          in them depending on whether the reader assumed a European or US-style
          date format. Instead use an unambiguous, explicit, more verbose
          format.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002583more"><div id="more"></div></div>
