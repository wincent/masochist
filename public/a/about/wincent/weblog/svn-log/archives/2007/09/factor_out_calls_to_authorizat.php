...
<title>Git activity log: Factor out calls to AuthorizationFree (gdiff, 2552ca2)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/use_shared_support_folder_for.php" title="Use shared support folder for executables (gdiff, 64aadbd)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/add_another_missing_early_retu.php" title="Add another missing early return (gdiff, 9e92950)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/use_shared_support_folder_for.php">&laquo; Use shared support folder for executables (gdiff, 64aadbd)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/add_another_missing_early_retu.php">Add another missing early return (gdiff, 9e92950) &raquo;</a>

</p>

<h2>September 27, 2007</h2>

<h3>Factor out calls to AuthorizationFree (gdiff, 2552ca2)</h3>

<p>This commit creates a new method that handles the call to AuthorizationFree and prints a diagnostic message as appropriate. This cleans up some repetition in the code (AuthorizationFree was previously called in three places) and enables for cleaner program flow around the call to AuthorizationExecuteWithPrivileges; specifically, we now handle one error as a special case (failure to execute the tool), then all other errors (general authorization failures) and finally the success case.</p>

<p>This commit also fixes a bug wherein the failure cases did not result in the early termination of the method.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a002970more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at September 27, 2007  1:58 PM</p>
