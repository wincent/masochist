...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Garbage collection changes for WOProcessManager
      (WOCommon, 6ab78fb)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/cleanup_headers_for_woprocessm.php"
      title="Cleanup headers for WOProcessManager (WOCommon, cf35f30)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/migrate_woprocessmanager_from.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/cleanup_headers_for_woprocessm.php"
            >&laquo; Cleanup headers for WOProcessManager (WOCommon, cf35f30)</a
          >
          |
        ...
        <p>
          Lose retains and replace WO_RELEASE call with explicit use of
          CFRelease.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002730more"><div id="more"></div></div>
