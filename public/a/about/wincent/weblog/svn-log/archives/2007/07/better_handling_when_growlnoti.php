...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Better handling when growlnotify is not installed
      (WOTest, f0adf26)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/remove_copy_files_build_phase.php"
      title="Remove &amp;quot;Copy Files&amp;quot; build phase (Wincent Icon Utility, a17e17a)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/add_rtf_version_of_license_win.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/remove_copy_files_build_phase.php"
            >&laquo; Remove &quot;Copy Files&quot; build phase (Wincent Icon
            Utility, a17e17a)</a
          >
          |
        ...
        <p>
          Previouly when growlnotify was not installed env would issue an ugly
          error message to the standard error.
        </p>

        <p>
          This commit redirects standard error to /dev/null so as to suppress
          this output and instead checks the exit status of the env tool. When
          growlnotify cannot be found in the current PATH a note (not an error
          or warning) is printed to the console. Other failure cases issue
