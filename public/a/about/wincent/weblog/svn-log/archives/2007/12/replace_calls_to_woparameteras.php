...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Replace calls to WOParameterAssert (WOCommon, 6c0d040)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/add_wologinitem_class_wocommon.php"
            >&laquo; Add WOLoginItem class (WOCommon, 2d5855f)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/update_symbol_macros_for_wolog.php"
            >Update symbol macros for WOLoginItem (WOCommon, bd7521a) &raquo;</a
          >
        </p>
        ...
        <p>
          Replace a bunch of calls to WOParameterAssert with NSParameterAssert
          (follow-up on recent assertion/check enhancements).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003241more"><div id="more"></div></div>
