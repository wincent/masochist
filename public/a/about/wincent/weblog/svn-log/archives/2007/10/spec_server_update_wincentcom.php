...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: spec_server update (typechecked.net, f7ea090)</title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/prepare_spec_helper_wincentcom.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/prepare_spec_helper_wincentcom.php"
            >&laquo; Prepare spec helper (typechecked.net, edf298e)</a
          >
          |
          ...
          <a
            ...
            (typechecked.net, 471fe24) &raquo;</a
          >
        </p>

        <h2>October 15, 2007</h2>

        <h3>spec_server update (typechecked.net, f7ea090)</h3>
