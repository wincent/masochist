...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Tweak property list keys to match latest documented
      behaviour (Synergy, 2b03b13)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/tweak_property_list_keys_to_ma.php"
      title="Tweak property list keys to match latest documented behaviour (Synergy, 2b03b13)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/remove_installer_readme_docume.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/tweak_property_list_keys_to_ma.php"
            >&laquo; Tweak property list keys to match latest documented
            behaviour (Synergy, 2b03b13)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/remove_installer_readme_docume.php"
            >Remove installer README documents (Synergy, 0f1a108) &raquo;</a
          >
        </p>
        ...
        <p>
          Keep in line with latest recommendations in the Apple &quot;Property
          List Key Reference&quot;. At the same time I used wincent-strings-util
          to regenerate all of the localized variants, which means that the key
          order and comments are now consistent across al localizations. I also
          added in the InfoPlist.strings files for localizations which were
