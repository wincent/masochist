...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update RSpec (revision 3014) (wincent.dev, ff78fe9)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/update_fixturereplacement_revi.php"
      title="Update FixtureReplacement (revision 140) (wincent.dev, bf665d7)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/add_notes_on_installing_mysql.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/update_fixturereplacement_revi.php"
            >&laquo; Update FixtureReplacement (revision 140) (wincent.dev,
            bf665d7)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/add_notes_on_installing_mysql.php"
            >Add notes on installing mysql gem on Leopard (wincent.dev, febe480)
            &raquo;</a
          >
        </p>
        ...
        <h3>Update RSpec (revision 3014) (wincent.dev, ff78fe9)</h3>

        <p>
          To coincide with the update to Rails 2.0RC2, update the copy of the
          RSpec trunk that's currently installed inside the application.
        </p>

        <p>
          Note that in the upgrade notes I've used &quot;git rm -r&quot; rather
          than &quot;rm -r&quot; to blow away the old version as it makes adding
          the new files back in a little easier.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003197more"><div id="more"></div></div>
