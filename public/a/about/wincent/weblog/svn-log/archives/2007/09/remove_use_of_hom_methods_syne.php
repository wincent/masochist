...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove use of HOM methods (Synergy Advance, 04831bb)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/update_project_file_for_new_ve.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/update_project_file_for_new_ve.php"
            >&laquo; Update project file for new version of Xcode (Synergy
            Advance, f35a1f1)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/update_xcode_project_for_lates.php"
            >Update Xcode project for latest version of Xcode (WOCommon,
            9b40995) &raquo;</a
          >
        </p>
        ...
        <p>
          Given that some of the HOM code is broken on Leopard and the time
          before Leopard ships is rapidly dimishing, replace uses of HOM methods
          with conventional program flow. The number of sites where the
          technique is used in the Synergy Advance code base is still quite
          small so this is only a minor change; once Leopard ships I can always
          consider going back and investigating the cause of the breakage, but
          for now I will be removing the HOM stuff from the WOCommon unit tests
          (in a separate commit to the WOCommon repository).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002709more"><div id="more"></div></div>
