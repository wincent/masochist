...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Initial version of Package.sh script (buildtools,
      b91af36)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/remove_hardcoded_tool_name_in.php"
      title="Remove hard-coded tool name in RunDoxygen.sh (buildtools, 9b4238b)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/add_usrlocalshareman_to_manpat.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/remove_hardcoded_tool_name_in.php"
            >&laquo; Remove hard-coded tool name in RunDoxygen.sh (buildtools,
            9b4238b)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/add_usrlocalshareman_to_manpat.php"
            >Add /usr/local/share/man to MANPATH (snippets, 3eeb288) &raquo;</a
          >
        </p>
        ...
        <p>
          Basic implementation of Package.sh script intended for use within a
          Shell Script build phase in Xcode. Takes one obligatory and one
          optional argument: respectively, the name of the installer package to
          produce and a PackageMaker document.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002559more"><div id="more"></div></div>
