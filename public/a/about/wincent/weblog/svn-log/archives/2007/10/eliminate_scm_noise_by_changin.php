...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Eliminate SCM noise by changing ANTLR template
      (wikitext, 39d1565)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/makefile_cleanup_and_correctio.php"
      title="Makefile cleanup and corrections (wikitext, f2254e1)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/provide_build_script_for_antlr.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/makefile_cleanup_and_correctio.php"
            >&laquo; Makefile cleanup and corrections (wikitext, f2254e1)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/provide_build_script_for_antlr.php"
            >Provide build script for ANTLR (wikitext, 282eee9) &raquo;</a
          >
        </p>
        ...
        <p>
          I've just made a tweak to the ANTLR 3.0.1 C target code generation
          template to prevent it from producing SCM noise by embedding build
          dates inside the generated files; this information properly belongs
          outside of the files, in the modification-date metadata. The truly
          important information (the version of ANTLR used to perform the build,
          the source file name and so on) is preserved.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003022more"><div id="more"></div></div>
