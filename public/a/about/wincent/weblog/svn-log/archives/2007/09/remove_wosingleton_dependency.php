...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove WOSingleton dependency from WOCDSAWrapper
      (WOCommon, 1cc4db9)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/modernize_wocdsawrapper_header.php"
            >&laquo; Modernize WOCDSAWrapper header (WOCommon, 5f66c76)</a
          >
          |
        ...
        <p>
          WOCDSAWrapper now uses its own local implementation of the singleton
          pattern rather than depending on WOSingleton.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002735more"><div id="more"></div></div>
