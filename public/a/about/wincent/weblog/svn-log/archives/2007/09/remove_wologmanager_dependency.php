...
<title>Git activity log: Remove WOLogManager dependency on WOSingleton (WOCommon, 343dc6b)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/cleanup_womachine_for_leopard.php" title="Clean-up WOMachine for Leopard (WOCommon, 3c97657)" />

<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/rename_wologmanager_sharedinst.php" title="Rename WOLogManager sharedInstance to sharedManager (WOCommon, 7975cf4)" />
...
<p align="right">
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/cleanup_womachine_for_leopard.php">&laquo; Clean-up WOMachine for Leopard (WOCommon, 3c97657)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>
| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/rename_wologmanager_sharedinst.php">Rename WOLogManager sharedInstance to sharedManager (WOCommon, 7975cf4) &raquo;</a>

</p>

<h2>September 16, 2007</h2>

<h3>Remove WOLogManager dependency on WOSingleton (WOCommon, 343dc6b)</h3>

<p>Make WOLogManager a WOObject subclass, removing the dependency on WOSingleton and instead implementing a local (non-abstract) &quot;advisory&quot; singleton pattern. Given that the initialization code is already thread-safe (done with double-checked locking and memory barriers) I also greatly simplify the load-time initialization code; in the unlikely event that it were called twice only one singleton instance would be instantiated anyway.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a002720more"><div id="more">
