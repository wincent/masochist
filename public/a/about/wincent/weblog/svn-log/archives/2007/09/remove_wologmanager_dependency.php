...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove WOLogManager dependency on WOSingleton (WOCommon,
      343dc6b)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/cleanup_womachine_for_leopard.php"
      title="Clean-up WOMachine for Leopard (WOCommon, 3c97657)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/rename_wologmanager_sharedinst.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/cleanup_womachine_for_leopard.php"
            >&laquo; Clean-up WOMachine for Leopard (WOCommon, 3c97657)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/rename_wologmanager_sharedinst.php"
            >Rename WOLogManager sharedInstance to sharedManager (WOCommon,
            7975cf4) &raquo;</a
          >
        </p>
        ...
        <p>
          Make WOLogManager a WOObject subclass, removing the dependency on
          WOSingleton and instead implementing a local (non-abstract)
          &quot;advisory&quot; singleton pattern. Given that the initialization
          code is already thread-safe (done with double-checked locking and
          memory barriers) I also greatly simplify the load-time initialization
          code; in the unlikely event that it were called twice only one
          singleton instance would be instantiated anyway.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002720more"><div id="more"></div></div>
