...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Add skeletal models (wincent.dev, a50b4bc)</title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/turn_on_activerecord_session_s.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/pretty_formatting_for_creation.php"
            >&laquo; Pretty formatting for creation/update timestamps
            (wincent.dev, fba09f2)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/turn_on_activerecord_session_s.php"
            >Turn on ActiveRecord session store (wincent.dev, 405881e)
            &raquo;</a
          >
        </p>
        ...
        <h3>Add skeletal models (wincent.dev, a50b4bc)</h3>

        <p>
          Adds basic models and controllers with some skeletal details already
          in place -- comments, emails, issues, statuses, taggings, tags -- and
          some other largely empty files (helpers not included in the last
          commit, spec templates) and migrations.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003071more"><div id="more"></div></div>
