...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Use Wincent Icon Utility for setting custom folder icons
      (buildtools, 9abc011)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/exit_with_status_0_on_success.php"
      title="Exit with status 0 on success (Wincent Icon Utility, 4d637be)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/document_new_dependency_buildt.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/exit_with_status_0_on_success.php"
            >&laquo; Exit with status 0 on success (Wincent Icon Utility,
            4d637be)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/document_new_dependency_buildt.php"
            >Document new dependency (buildtools, 9536869) &raquo;</a
          >
        </p>
        ...
        <h3>
          Use Wincent Icon Utility for setting custom folder icons (buildtools,
          9abc011)
        </h3>

        <p>
          The most recent update to the Xcode Tools breaks the previously
          existing mechanism for applying custom icons to folders.
        </p>

        <p>
          I've developed a custom Foundation/Carbon tool to replace the old
          procedure; this commit switches over buildtools to use the new tool. I
