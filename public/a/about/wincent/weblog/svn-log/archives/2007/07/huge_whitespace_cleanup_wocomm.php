...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/set_up_ignore_files_for_xcode.php"
      title="Set up ignore files for Xcode project bundle (REnamer, 7fd2cac)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/add_check_cr_function_to_bash.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/set_up_ignore_files_for_xcode.php"
            >&laquo; Set up ignore files for Xcode project bundle (REnamer,
            7fd2cac)</a
          >
          |
        ...
        <p>
          This is a massive whitespace cleanup of the entire tree (more than
          25,000 lines in the diff) consisting of: converting of mixed
          tabs/spaces to all spaces where appropriate (in source files, for
          example); the reverse case, converting spaces to tabs where
          appropriate (in property list files); removal of trailing whitespace
          on the end of lines; removal of invisible (non-printable) characters
          that had snuck into comments; conversion of Windows line-endings on
          some RSpec-generated files to UNIX line-endings.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002447more"><div id="more"></div></div>
