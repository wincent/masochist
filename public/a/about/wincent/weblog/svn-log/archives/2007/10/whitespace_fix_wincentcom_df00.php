...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Whitespace fix (typechecked.net, df00cf2)</title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/add_notes_to_taggable_spec_win.php"
            >&laquo; Add notes to Taggable spec (typechecked.net, 7d06fda)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/correct_error_in_user_spec_win.php"
            >Correct error in User spec (typechecked.net, d55c2c6) &raquo;</a
          >
        </p>

        <h2>October 15, 2007</h2>

        <h3>Whitespace fix (typechecked.net, df00cf2)</h3>
