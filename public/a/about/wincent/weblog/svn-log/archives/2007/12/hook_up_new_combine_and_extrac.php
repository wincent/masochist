...
<title>Git activity log: Hook up new combine() and extract() functions (Wincent Strings Utility, 97d6426)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/refactoring_and_new_functions.php" title="Refactoring and new functions (Wincent Strings Utility, 127e31d)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/make_duplicate_keys_a_warning.php" title="Make duplicate keys a warning rather than an error (Wincent Strings Utility, 434fa5c)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/refactoring_and_new_functions.php">&laquo; Refactoring and new functions (Wincent Strings Utility, 127e31d)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/make_duplicate_keys_a_warning.php">Make duplicate keys a warning rather than an error (Wincent Strings Utility, 434fa5c) &raquo;</a>

</p>

<h2>December 21, 2007</h2>

<h3>Hook up new combine() and extract() functions (Wincent Strings Utility, 97d6426)</h3>

<p>These two functions can be used to help with incremental localization.</p>

<p>The extract() function looks at a base strings file (in the development language) and compares it with a target strings file (in the target langauge). All strings which are new (not present in the target) or untranslated (present in the target but with the same value as in the base) are extracted. The output can then be sent to translators for translation.</p>

<p>The combine() function takes a partial strings file (of the kind produced by the extract() function) and integrates it with an existing file using a simple additive algorithm (not a merge). It is considered an error if there is any overlap in the keys in the two files.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003321more"><div id="more">
