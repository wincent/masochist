...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Hook up new combine() and extract() functions (Wincent
      Strings Utility, 97d6426)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/refactoring_and_new_functions.php"
      title="Refactoring and new functions (Wincent Strings Utility, 127e31d)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/make_duplicate_keys_a_warning.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/refactoring_and_new_functions.php"
            >&laquo; Refactoring and new functions (Wincent Strings Utility,
            127e31d)</a
          >
          |
        ...
        <h3>
          Hook up new combine() and extract() functions (Wincent Strings
          Utility, 97d6426)
        </h3>
        ...
        <p>
          The extract() function looks at a base strings file (in the
          development language) and compares it with a target strings file (in
          the target langauge). All strings which are new (not present in the
          target) or untranslated (present in the target but with the same value
          as in the base) are extracted. The output can then be sent to
