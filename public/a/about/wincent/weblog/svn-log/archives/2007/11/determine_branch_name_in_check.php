...
<title>Git activity log: Determine branch name in check-series script (snippets, adccbc7)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/11/add_checkseries_script_snippet.php" title="Add check-series script (snippets, 2815a0f)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/11/add_scripts_to_xcode_project_s.php" title="Add scripts to Xcode project (Synergy, 53bdfaf)" />
...
<body>
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../../../../../../">About</a>&nbsp;&gt;&nbsp;<a href="../../../../../">Wincent</a>&nbsp;&gt;&nbsp;<a href="../../../../">Weblog</a>&nbsp;&gt;&nbsp;<a href="../../../">Git log</a>&nbsp;&gt;&nbsp;<a href="../../">Archives</a>&nbsp;&gt;&nbsp;<a href="../">2007</a>&nbsp;&gt;&nbsp;11    </p>
  </div>
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/11/add_checkseries_script_snippet.php">&laquo; Add check-series script (snippets, 2815a0f)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/11/add_scripts_to_xcode_project_s.php">Add scripts to Xcode project (Synergy, 53bdfaf) &raquo;</a>

</p>

<h2>November 25, 2007</h2>

<h3>Determine branch name in check-series script (snippets, adccbc7)</h3>

<p>Previously we just made comparisons against the &quot;origin&quot;, and while this worked fine for topic branches forked off of the &quot;master&quot; branch, it fell down for those forked off something else (like the &quot;next&quot; branch, for example).</p>

<p>In order to get the list of commits that really belong to the topic branch and only the topic branch we would need to compare against &quot;origin/next&quot; in the case of the &quot;next&quot; example.</p>

<p>This commit adds code for automatically detecting what branch we are on (by reading and parsing GIT_DIR/HEAD), finding out the &quot;remote&quot; and &quot;merge&quot; values for that branch, and then using them to get an accurate list of the commits unique to the topic branch.</p>
...
<p class="posted">Posted by wincent at November 25, 2007  8:35 PM</p>
...
<div id="footer">
  ...
  <p>Page last updated 00:30:24, 19 February 2010.</p>
  <p>
