...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add test case for CFStringCreateExternalRepresentation()
      bug (Wincent Strings Utility, f9236a6)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/work_around_cfstringcreateexte.php"
            >&laquo; Work around CFStringCreateExternalRepresentation() bug
            (Wincent Strings Utility, b02b784)</a
          >
          |
        ...
        <h3>
          Add test case for CFStringCreateExternalRepresentation() bug (Wincent
          Strings Utility, f9236a6)
        </h3>
        ...
        <div id="a003333more"><div id="more"></div></div>
