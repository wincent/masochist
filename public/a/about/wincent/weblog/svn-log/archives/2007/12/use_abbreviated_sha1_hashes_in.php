...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Use abbreviated SHA-1 hashes in nightlies (snippets,
      3d6f550)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/close_the_application_when_las.php"
            >&laquo; Close the application when last window is closed (Synergy,
            c7eb0af)</a
          >
          |
        ...
        <p>
          There is no need to show the full SHA-1 hash in the nightlies feed, so
          show the abbreviated one instead.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003452more"><div id="more"></div></div>
