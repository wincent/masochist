...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/04/buildtools_r77_2_items_changed.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/04/buildtools_r75_2_items_changed.php"
            >&laquo; buildtools r75, 2 items changed</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/04/buildtools_r77_2_items_changed.php"
            >buildtools r77, 2 items changed &raquo;</a
          >
        </p>
        ...
        <p>
          Use GCC_PREPROCESSOR_DEFINITIONS_NOT_USED_IN_PRECOMPS for better
          precompiled prefix header sharing, but change DEBUG macro to WO_DEBUG
          macro because the former causes GCC to freak out with the Apple
          headers
        </p>

        <div id="a002110more"><div id="more"></div></div>
