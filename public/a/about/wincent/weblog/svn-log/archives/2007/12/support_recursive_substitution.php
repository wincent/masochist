...
<title>Git activity log: Support recursive substitution (Wincent Strings Utility, 93b954c)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/add_specs_for_missing_command.php" title="Add specs for missing command line switches (Wincent Strings Utility, 247c21e)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/avoid_unnecessary_object_insta.php" title="Avoid unnecessary object instantiation (Wincent Strings Utility, 7fcfe27)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/add_specs_for_missing_command.php">&laquo; Add specs for missing command line switches (Wincent Strings Utility, 247c21e)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/avoid_unnecessary_object_insta.php">Avoid unnecessary object instantiation (Wincent Strings Utility, 7fcfe27) &raquo;</a>

</p>

<h2>December 24, 2007</h2>

<h3>Support recursive substitution (Wincent Strings Utility, 93b954c)</h3>

<p>In updating my apps to match the latest documentation in Apple's &quot;Property List Key Reference&quot; I noticed that it would be useful to be able to do recursive substitution when using the --info and --strings switches; that is, have one key refer to the value of another key in an InfoPlist.strings file rather than one in the Info.plist.</p>

<p>This commit therefore gets rid of the simplistic find-and-replace substitution that was previously implemented and replaces it with a proper recursive substitution mechanism that allows keys in a strings file to refer to other keys in the same file, using multiple levels of recursion if need be, and finally falling back to look-up in the Info.plist file.</p>

<p>The algorithm is smart enough to detect direct and indirect infinite recursion (self-referential subsitutions), allow repeated substitutions, and bail in the event that no suitable substitution can be found.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003360more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at December 24, 2007  4:17 PM</p>
...
<div id="footer">
  ...
  <p>Page last updated 00:30:29, 19 February 2010.</p>
  <p>
