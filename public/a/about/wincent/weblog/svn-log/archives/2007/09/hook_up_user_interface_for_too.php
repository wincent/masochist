...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Hook up user interface for tool installation (gdiff,
      194c4f9)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/add_installer_tool_gdiff_7cf45.php"
      title="Add installer tool (gdiff, 7cf455b)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/provide_installation_back_end.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/add_installer_tool_gdiff_7cf45.php"
            >&laquo; Add installer tool (gdiff, 7cf455b)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/provide_installation_back_end.php"
            >Provide installation back end (gdiff, 519e7e3) &raquo;</a
          >
        </p>
        ...
        <p>
          Add a menu item to bring up the installer dialog, set up the bindings
          and connections for initiating installation in response to button
          clicks, show a progress indicator and disable the buttons when an
          install is in action.
        </p>

        <p>
          This is only the user interface; the back end has not yet been put in
          place.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002962more"><div id="more"></div></div>
