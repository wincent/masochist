...
<title>Git activity log: Remove WOSingleton class and all references to it (WOCommon, 839cadd)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/update_registration_nib_to_ref.php" title="Update registration nib to reflect new class hierarchy (WOCommon, c08e31e)" />

<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/clarify_comments_with_respect.php" title="Clarify comments with respect to copying of singleton objects (WOCommon, 1d27e78)" />
...
<body>
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../../../../../../">About</a>&nbsp;&gt;&nbsp;<a href="../../../../../">Wincent</a>&nbsp;&gt;&nbsp;<a href="../../../../">Weblog</a>&nbsp;&gt;&nbsp;<a href="../../../">Git log</a>&nbsp;&gt;&nbsp;<a href="../../">Archives</a>&nbsp;&gt;&nbsp;<a href="../">2007</a>&nbsp;&gt;&nbsp;09    </p>
  </div>
...
<p align="right">
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/update_registration_nib_to_ref.php">&laquo; Update registration nib to reflect new class hierarchy (WOCommon, c08e31e)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>
| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/clarify_comments_with_respect.php">Clarify comments with respect to copying of singleton objects (WOCommon, 1d27e78) &raquo;</a>

</p>

<h2>September 16, 2007</h2>

<h3>Remove WOSingleton class and all references to it (WOCommon, 839cadd)</h3>

<p>All singleton classes now use independent, non-abstracts implementations of the singleton pattern, so this commit removes the WOSingleton class itself, the accompanying unit tests, and updates the documentation to remove all references to WOSingleton as well explaining the rationale for its removal.</p>

<p>For several years I used a WOSingleton class as a means of encapsulating a rigorously enforced, fast, thread-safe, sub-classable singleton pattern. Thread-safety and speed were achieved by using a combination of synchronization, fast NSMapTable lookups, double-checked locking, and memory barriers.</p>

<p>With the advent of garbage collection I revisited my solution once again and decided to scrap it in favor of a simpler, non-abstract model wherein each singleton class implemented the minimal necessary code to provide an &quot;advisory&quot; singleton. That is, rather than trying to enforce the singleton pattern by overriding allocWithZone: and init, I instead provide a simple sharedInstance (or similar) method which is documented as the preferred means of creating and using an instance of the class. Callers are free to call alloc/init multiple times if they wish, thus creating multiple instances, but the consequences are undefined; this could potentially be useful for testing purposes. My only attempt at &quot;enforcement&quot; is to override copyWithZone:; this is done to prevent inadvertent creation of multiple instances. For speed the sharedInstance method employs a simple double-checked locking pattern with memory barriers (much simpler than the generalized solution that had to work with the not-thread-safe NSMapTable).</p>

<p>Although this approach requires a small amount of code per new singleton class, the result is faster, simpler and less likely to have unidentified bugs.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a002741more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at September 16, 2007  3:08 PM</p>
...
<div id="footer">
  ...
  <p>Page last updated 00:30:31, 19 February 2010.</p>
  <p>
