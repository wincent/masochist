...
<title>Git activity log: Use shared support folder for executables (gdiff, 64aadbd)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/locate_installertool_as_normal.php" title="Locate installer-tool as normal resource (gdiff, 5d40d99)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/factor_out_calls_to_authorizat.php" title="Factor out calls to AuthorizationFree (gdiff, 2552ca2)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/locate_installertool_as_normal.php">&laquo; Locate installer-tool as normal resource (gdiff, 5d40d99)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/factor_out_calls_to_authorizat.php">Factor out calls to AuthorizationFree (gdiff, 2552ca2) &raquo;</a>

</p>

<h2>September 27, 2007</h2>

<h3>Use shared support folder for executables (gdiff, 64aadbd)</h3>

<p>Using the shared support folder rather than the localizable resources folder should be more secure as it reduces the number of possible sites in which an attacker could substitute a hostile binary.</p>

<p>As noted elsewhere in the source, these types of security measures are an unwinnable battle; basically any application that runs with elevated privileges should be considered vulnerable of other users have write access to any part of it. Despite this, a &quot;defense in depth&quot; strategy suggests that plugging these minor holes is still a worthwhile idea, especially when the effort of doing so is minimal.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a002969more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at September 27, 2007  1:40 PM</p>
