...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Include file/folder name in error messages (Wincent Icon
      Utility, 6b89434)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/switch_to_shared_configuration.php"
            >&laquo; Switch to shared configuration from buildtools (Wincent
            Icon Utility, 1b3c196)</a
          >
          |
        ...
        <p>
          Make the error messages slightly more helpful by including the name of
          the file or folder related to the failed operation.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002545more"><div id="more"></div></div>
