...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Draw borders in gutter views (gdiff, eff8c91)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/move_test_setup_code_into_wind.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/move_test_setup_code_into_wind.php"
            >&laquo; Move test setup code into windowControllerDidLoadNib
            (gdiff, 039b748)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/conditionalize_border_drawing.php"
            >Conditionalize border drawing (gdiff, a994690) &raquo;</a
          >
        </p>
        ...
        <p>
          Equip WOGutterView with border-drawing code and set up the left gutter
          view to draw a border on the right and the right gutter view to draw a
          border on the left.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002998more"><div id="more"></div></div>
