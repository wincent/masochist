...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Set executable bits on all executables (buildtools,
      b2ba583)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/remove_svk_script_buildtools_f.php"
            >&laquo; Remove SVK script (buildtools, f9467ea)</a
          >
          |
        ...
        <p>
          This commit sets the executable bit on a number of shell scripts that
          were missing their executable bits.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002490more"><div id="more"></div></div>
