...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Import backup-run-completed script from old repo
      (snippets, caf917e)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/add_gpl_headers_to_source_file.php"
            >&laquo; Add GPL headers to source files (gdiff, 5db5b71)</a
          >
          |
        ...
        <div id="a003106more"><div id="more"></div></div>
