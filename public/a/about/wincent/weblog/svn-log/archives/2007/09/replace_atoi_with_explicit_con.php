...
<title>Git activity log: Replace atoi() with explicit conversion (gdiff, 5e549a8)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/be_encodingagnostic_with_respe.php" title="Be encoding-agnostic with respect to paths (gdiff, cb1f777)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/report_parse_errors_on_failure.php" title="Report parse errors on failure (gdiff, 694ee81)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/be_encodingagnostic_with_respe.php">&laquo; Be encoding-agnostic with respect to paths (gdiff, cb1f777)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/report_parse_errors_on_failure.php">Report parse errors on failure (gdiff, 694ee81) &raquo;</a>

</p>

<h2>September 23, 2007</h2>

<h3>Replace atoi() with explicit conversion (gdiff, 5e549a8)</h3>

<p>Ripping out the atoi() calls allows another great simplification to the state machine: instead of having to maintain multiple pointers to the starting characters of the desired substrings it is sufficient to have a simple accumulator variable and use a Ragel &quot;all transitions&quot; action ($) to perform an incremental ASCII-to-integer conversion.</p>

<p>This not only saves a few lines of code, it should also be faster due to the saved function calls.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a002930more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at September 23, 2007  8:58 PM</p>
