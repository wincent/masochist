...
<title>Git activity log: Address some TODO items (snippets, afe8572)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/11/import_dialog_project_from_sub.php" title="Import dialog project from Subversion repository (snippets, c0a723e)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/11/update_for_xcode_30_snippets_3.php" title="Update for Xcode 3.0 (snippets, 3d7963c)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/11/import_dialog_project_from_sub.php">&laquo; Import dialog project from Subversion repository (snippets, c0a723e)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/11/update_for_xcode_30_snippets_3.php">Update for Xcode 3.0 (snippets, 3d7963c) &raquo;</a>

</p>

<h2>November 15, 2007</h2>

<h3>Address some TODO items (snippets, afe8572)</h3>

<p>This commit address a couple of TODO items:</p>

<p>- If only one of &quot;message&quot; or &quot;title&quot; is supplied, use the supplied string for the missing value as well.</p>

<p>- Prepare the way for displaying usage information if neither &quot;message&quot; nor &quot;title&quot; is provided; for the time being we just exit with a non-zero status.</p>

<p>At the same time, this commit also provides some whitespace fixes, updates the copyright year, and removes some Subversion-related crud. All of this is bundled together in a single commit because the file is so small and all the edits apply to the same range of lines.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003109more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at November 15, 2007  6:10 PM</p>
