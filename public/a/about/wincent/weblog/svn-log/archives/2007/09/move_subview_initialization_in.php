...
<title>Git activity log: Move subview initialization into WODiffView (gdiff, 1cc773c)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/remove_debugging_log_statement.php" title="Remove debugging log statement (gdiff, 1d0c023)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/initial_import_of_wodebugmacro.php" title="Initial import of WODebugMacros.h from WOCommon (WOPublic, 4ab2a99)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/remove_debugging_log_statement.php">&laquo; Remove debugging log statement (gdiff, 1d0c023)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/initial_import_of_wodebugmacro.php">Initial import of WODebugMacros.h from WOCommon (WOPublic, 4ab2a99) &raquo;</a>

</p>

<h2>September 28, 2007</h2>

<h3>Move subview initialization into WODiffView (gdiff, 1cc773c)</h3>

<p>WODocument is a controller class which previously set up its own document window and all the subviews. Now all of the subview initialization has been moved into WODiffView.</p>

<p>This results in a much simpler controller implementation, and there is better locality now that all subview management is encapsulated in WODiffView (previously only the autoresizing code was there).</p>

<p>When the controller needs to access the subviews (for example to initiate scrolling) I will add the appropriate properties or action methods to the WODiffView class.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a002991more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at September 28, 2007  1:51 PM</p>
