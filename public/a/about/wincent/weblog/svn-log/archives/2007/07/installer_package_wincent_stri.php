...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Installer package (Wincent Strings Utility, 538f59e)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/use_relative_path_for_installe.php"
      title="Use relative path for installer window background (Wincent Icon Utility, 9b10438)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/update_xcode_project_bundle_fo.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/use_relative_path_for_installe.php"
            >&laquo; Use relative path for installer window background (Wincent
            Icon Utility, 9b10438)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/update_xcode_project_bundle_fo.php"
            >Update Xcode project bundle format (WOTest, 19425f4) &raquo;</a
          >
        </p>
        ...
        <p>
          Set up installer package (PackageMaker document, installer window
          background PDF, GPL version 3 license in RTF format) and accompanying
          Shell Script build phase.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002567more"><div id="more"></div></div>
