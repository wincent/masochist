...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Drop volatile keyword from singleton initializers
      (WOCommon, 23a9a8a)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/add_pragma_mark_separator_in_w.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/update_memory_barrier_document.php"
            >&laquo; Update memory barrier documentation (WOCommon, dfbe816)</a
          >
          |
        ...
        <p>
          The use of the volatile keyword in the WOLogManager, WOMachine and
          WOSysctl singleton initializers is unnecessary, as correct ordering is
          already guaranteed by the use of memory barriers, so drop it.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002727more"><div id="more"></div></div>
