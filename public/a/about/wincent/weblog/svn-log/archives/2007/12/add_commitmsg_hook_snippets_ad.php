...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/add_reminder_to_use_woassert_i.php"
      title="Add reminder to use WOAssert in NSTimer category (Synergy, d1202ae)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/readability_improvements_for_w.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/add_reminder_to_use_woassert_i.php"
            >&laquo; Add reminder to use WOAssert in NSTimer category (Synergy,
            d1202ae)</a
          >
          |
        ...
        <p>
          - warns if any line in the commit message exceeds a predefined width -
          warns if the commit hasn't been signed off - in the event of a warning
          advises the user that the hook can be bypassed with the --no-verify
          switch
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003266more"><div id="more"></div></div>
