...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Installer fallback on pre-Leopard systems (Synergy,
      79c028c)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/update_version_number_prerelea.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/installer_fallback_on_preleopa.php"
            >&laquo; Installer fallback on pre-Leopard systems (Synergy,
            79c028c)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/update_version_number_prerelea.php"
            >Update version number pre-release (Synergy, 48fa71e) &raquo;</a
          >
        </p>
        ...
        <p>
          When run on pre-Leopard systems the installer should gracefully give
          the user the opportunity to obtain a compatible version from the
          website.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003171more"><div id="more"></div></div>
