...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Teach FixtureReplacement to avoid mass assignment
      (wincent.dev, 80cf713)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/switch_to_rspec_trunk_wincentc.php"
      title="Switch to RSpec trunk (wincent.dev, b8c4b59)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/speedup_fixturereplacement_win.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/switch_to_rspec_trunk_wincentc.php"
            >&laquo; Switch to RSpec trunk (wincent.dev, b8c4b59)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/speedup_fixturereplacement_win.php"
            >Speed-up FixtureReplacement (wincent.dev, 6c036a7) &raquo;</a
          >
        </p>
        ...
        <h3>
          Teach FixtureReplacement to avoid mass assignment (wincent.dev,
          80cf713)
        </h3>

        <p>
          FixtureReplacement uses mass assignment under the hood to create new
          object instances and this can cause exceptions if any of the assigned
          attributes are protected. Given that the idea of FixtureReplacement is
          to quickly and easily set up valid objects (or object graphs) it makes
          sense to avoid these exceptions and allow all attributes to be
          specified in the example_data.rb file whether they are protected or
          not.
        </p>

        <p>
          This patch makes FixtureReplacement use update_attribute to set the
          attributes one by one and thus avoid the mass assignment and the
          possibility of exceptions. A copy has also been sent to Scott Taylor
          (the author of FixtureReplacement).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003061more"><div id="more"></div></div>
