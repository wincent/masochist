...
<title>Git activity log: Teach FixtureReplacement to avoid mass assignment (wincent.com, 80cf713)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/switch_to_rspec_trunk_wincentc.php" title="Switch to RSpec trunk (wincent.com, b8c4b59)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/speedup_fixturereplacement_win.php" title="Speed-up FixtureReplacement (wincent.com, 6c036a7)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/switch_to_rspec_trunk_wincentc.php">&laquo; Switch to RSpec trunk (wincent.com, b8c4b59)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/speedup_fixturereplacement_win.php">Speed-up FixtureReplacement (wincent.com, 6c036a7) &raquo;</a>

</p>

<h2>October 14, 2007</h2>

<h3>Teach FixtureReplacement to avoid mass assignment (wincent.com, 80cf713)</h3>

<p>FixtureReplacement uses mass assignment under the hood to create new object instances and this can cause exceptions if any of the assigned attributes are protected. Given that the idea of FixtureReplacement is to quickly and easily set up valid objects (or object graphs) it makes sense to avoid these exceptions and allow all attributes to be specified in the example_data.rb file whether they are protected or not.</p>

<p>This patch makes FixtureReplacement use update_attribute to set the attributes one by one and thus avoid the mass assignment and the possibility of exceptions. A copy has also been sent to Scott Taylor (the author of FixtureReplacement).</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003061more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at October 14, 2007  3:02 PM</p>
