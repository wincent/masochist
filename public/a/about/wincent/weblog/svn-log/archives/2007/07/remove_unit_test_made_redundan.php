...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove unit test made redundant by garbage collection
      (WOTest, 0f96414)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/gate_problematic_mock_object_t.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/allow_pointertopointer_compari.php"
            >&laquo; Allow pointer-to-pointer comparisons (WOTest, 8210f41)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/gate_problematic_mock_object_t.php"
            >Gate problematic mock object test (WOTest, 2088ff0) &raquo;</a
          >
        </p>
        ...
        <p>
          One of the unit tests expected an exception to be raised when working
          with objects that don't respond to the retain and release methods, but
          in a garbage collected world these messages become no-ops (and in fact
          I believe that the compiler literally optimizes them away to nothing).
        </p>

        <p>
          As such, no exception was being raised and there is no way to
          &quot;fix&quot; either the test or the tested implementation: it's
          simply that the test no longer makes sense in the context of garbage
