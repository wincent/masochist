...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Use wildcards where appropriate (snippets, 17cfb75)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/set_garbage_collection_to_requ.php"
            >&laquo; Set Garbage Collection to &quot;required&quot; (buildtools,
            6df5a68)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/solution_for_exercise_120_snip.php"
            >Solution for Exercise 1.20 (snippets, 01c89ee) &raquo;</a
          >
        </p>
        ...
        <p>
          Use the wildcard operator (_) in pattern matches for parameters which
          aren't actually used in the calculation. This makes it clearer at a
          glance which values we don't care about.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002744more"><div id="more"></div></div>
