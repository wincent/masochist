...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Replace WOLoginManager with WOLoginItemList (WOCommon,
      a89c217)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/accept_multiple_add_and_remove.php"
      title="Accept multiple add and remove arguments (login-tool, 0931d52)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/add_womemoryh_wopublic_a1ddd30.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/accept_multiple_add_and_remove.php"
            >&laquo; Accept multiple add and remove arguments (login-tool,
            0931d52)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/add_womemoryh_wopublic_a1ddd30.php"
            >Add WOMemory.h (WOPublic, a1ddd30) &raquo;</a
          >
        </p>
        ...
        <p>
          The new Launch Services API for managing login items is well suited to
          encapsulation in two classes: WOLoginItem (previously added) and
          WOLoginItemList (added in this commit). This makes all of the API
          previously implemented in the WOLoginManager class redundant, so
          remove the class.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003246more"><div id="more"></div></div>
