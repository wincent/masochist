...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Bootstrap RSpec (typechecked.net, 18f33b5)</title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/add_haml_plugin_wincentcom_3cf.php"
            >&laquo; Add Haml plugin (typechecked.net, 3cf854a)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/describe_steps_for_setting_up.php"
            >Describe steps for setting up database (typechecked.net, 7208f45)
            &raquo;</a
          >
        </p>
        ...
        <h3>Bootstrap RSpec (typechecked.net, 18f33b5)</h3>
