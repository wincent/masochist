...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove old pbproj bundle from SynergyReg subdirectory
      (Synergy, 2e2938d)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/remove_old_pbproj_bundle_from.php"
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <h3>
          Remove old pbproj bundle from SynergyReg subdirectory (Synergy,
          2e2938d)
        </h3>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003411more"><div id="more"></div></div>
