...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add specs for basic -merge use (Wincent Strings Utility,
      c09ab36)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/initial_specs_wincent_strings.php"
            >&laquo; Initial specs (Wincent Strings Utility, 46693cf)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/move_input_files_into_subdirec.php"
            >Move input files into subdirectory (Wincent Strings Utility,
            a9130ab) &raquo;</a
          >
        </p>
        ...
        <p>
          Test some simple cases: merging using an untranslated, partially
          translated, and fully translated target localization.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003327more"><div id="more"></div></div>
