...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Store generate files in repository (wikitext, 402251b)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/adapt_to_changes_in_antlr_301.php"
      title="Adapt to changes in ANTLR 3.0.1 C runtime (wikitext, eda9b8d)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/fix_typo_in_defined_test_wikit.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/adapt_to_changes_in_antlr_301.php"
            >&laquo; Adapt to changes in ANTLR 3.0.1 C runtime (wikitext,
            eda9b8d)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/fix_typo_in_defined_test_wikit.php"
            >Fix typo in defined test (wikitext, 4494181) &raquo;</a
          >
        </p>
        ...
        <p>
          Given the fragility of the ANTLR build chain (upgrading from my
          working 3.0-with-bugfixes copy to 3.0.1-which-also-needed-bugfixes
          version proved to be quite timeconsuming and error-prone) I'm adding
          the ANTLR-generated lexer files to the repository to guard against
          possible future problems. That is, even if I have problems building a
          working future version of ANTLR and can't re-generate the lexer, at
          least I'll have a copy on hand of a prior working version in the
          repository.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003018more"><div id="more"></div></div>
