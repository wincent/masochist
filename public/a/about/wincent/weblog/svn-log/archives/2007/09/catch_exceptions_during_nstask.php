...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Catch exceptions during NSTask launch (gdiff, e8ceb3f)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/build_installer_tool_as_pure_c.php"
      title="Build installer tool as pure C, nor Objective-C (gdiff, 1934124)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/additional_check_in_currentuse.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/build_installer_tool_as_pure_c.php"
            >&laquo; Build installer tool as pure C, nor Objective-C (gdiff,
            1934124)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/additional_check_in_currentuse.php"
            >Additional check in current-user installation method (gdiff,
            ddf9172) &raquo;</a
          >
        </p>
        ...
        <p>
          Although ditto should be present on all Mac OS X systems (it is
          included in the base install) NSTask could conceivably throw an
          exception if the launch path is not accessible (for example if the
