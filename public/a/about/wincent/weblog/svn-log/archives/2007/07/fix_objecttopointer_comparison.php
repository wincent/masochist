...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix object-to-pointer comparisons on Leopard (WOTest,
      a39fc79)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/remove_subversion_build_number.php"
      title="Remove Subversion build number (WOTest, 4cdc88d)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/whitespace_cleanup_wotest_b788.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/remove_subversion_build_number.php"
            >&laquo; Remove Subversion build number (WOTest, 4cdc88d)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/whitespace_cleanup_wotest_b788.php"
            >Whitespace cleanup (WOTest, b788b43) &raquo;</a
          >
        </p>
        ...
        <p>
          The behaviour of the @encode directive has changed on Leopard and this
          breaks a number of the comparisons that previously worked in Tiger.
          For example, comparisons between object pointers and nil, or even
          between nil and nil, were broken.
        </p>

        <p>
          This commit adds some special cases for these types of comparisons
          which now perform simple pointer equality tests instead of failing. I
          also removed one test which failed on Tiger (when nil was encoded as a
          numeric scalar) but no longer fails on Leopard.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002524more"><div id="more"></div></div>
