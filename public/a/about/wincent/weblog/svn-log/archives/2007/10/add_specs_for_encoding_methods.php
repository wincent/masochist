...
<title>Git activity log: Add specs for encoding methods (wikitext, 292af90)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/add_benchmark_runner_wikitext.php" title="Add benchmark runner (wikitext, 9d5875b)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/whitespace_cleanup_wikitext_b4.php" title="Whitespace cleanup (wikitext, b40adde)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/add_benchmark_runner_wikitext.php">&laquo; Add benchmark runner (wikitext, 9d5875b)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/whitespace_cleanup_wikitext_b4.php">Whitespace cleanup (wikitext, b40adde) &raquo;</a>

</p>

<h2>October 18, 2007</h2>

<h3>Add specs for encoding methods (wikitext, 292af90)</h3>

<p>Although the encoding conversion methods already receive extensive indirect testing (because they are indirectly exercised by all of the parsing specs) this commit adds specific specs so as to test all the possible failure paths when passed invalidly encoding inputs.</p>

<p>As a result of adding these specs I discovered one minor issue: that one of the failing code paths would never be exercised because it was effectively masked by another failing code path; so this commit also changes the order in which the paths in question are tested.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003033more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at October 18, 2007  4:38 AM</p>
