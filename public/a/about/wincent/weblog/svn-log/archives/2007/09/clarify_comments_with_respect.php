...
<title>Git activity log: Clarify comments with respect to copying of singleton objects (WOCommon, 1d27e78)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/remove_wosingleton_class_and_a.php" title="Remove WOSingleton class and all references to it (WOCommon, 839cadd)" />

<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/set_garbage_collection_to_requ.php" title="Set Garbage Collection to &amp;quot;required&amp;quot; (buildtools, 6df5a68)" />
...
<p align="right">
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/remove_wosingleton_class_and_a.php">&laquo; Remove WOSingleton class and all references to it (WOCommon, 839cadd)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>
| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/set_garbage_collection_to_requ.php">Set Garbage Collection to &quot;required&quot; (buildtools, 6df5a68) &raquo;</a>

</p>

<h2>September 16, 2007</h2>

<h3>Clarify comments with respect to copying of singleton objects (WOCommon, 1d27e78)</h3>

<p>Note that most singleton classes inherit from WOObject, which in turn inherits from NSObject, and that given that neither of these implement the NSCopying protocol &quot;out of the box&quot; then it isn't even necessary to provide a special implementation of copyWithZone: in the vast majority of cases.</p>
