...
<title>Git activity log: Handle pre-existing icon files (Wincent Icon Utility, 6b08d35)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/edit_error_messages_for_redund.php" title="Edit error messages for redundancy (Wincent Icon Utility, 4457f16)" />

<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/corrections_for_last_commit_wi.php" title="Corrections for last commit (Wincent Icon Utility, b685fd5)" />
...
<p align="right">
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/edit_error_messages_for_redund.php">&laquo; Edit error messages for redundancy (Wincent Icon Utility, 4457f16)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>
| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/corrections_for_last_commit_wi.php">Corrections for last commit (Wincent Icon Utility, b685fd5) &raquo;</a>

</p>

<h2>July 27, 2007</h2>

<h3>Handle pre-existing icon files (Wincent Icon Utility, 6b08d35)</h3>

<p>This is an initial attempt at handling pre-existing icon files (easy enough to encounter when doing repeated builds). If an existing file is already present we try to open it, remove any existing icon resources, and then proceed to the normal codepath (adding the new icon resource).</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a002552more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at July 27, 2007  2:11 PM</p>
