...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Refactor script into build and install portions
      (wikitext, 015e869)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/ignore_built_bundle_on_linux_w.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/provide_build_script_for_antlr.php"
            >&laquo; Provide build script for ANTLR (wikitext, 282eee9)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/ignore_built_bundle_on_linux_w.php"
            >Ignore built bundle on Linux (wikitext, caba3f0) &raquo;</a
          >
        </p>
        ...
        <p>
          Now we have a build script (which builds the ANTLR tool and the C
          target runtime on Darwin, and only the runtime on Linux) and a
          separate install script (which installs tool and runtime on Darwin,
          and only the runtime on Linux).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003024more"><div id="more"></div></div>
