...
<title>Git activity log: Refactor script into build and install portions (wikitext, 015e869)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/provide_build_script_for_antlr.php" title="Provide build script for ANTLR (wikitext, 282eee9)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/ignore_built_bundle_on_linux_w.php" title="Ignore built bundle on Linux (wikitext, caba3f0)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/provide_build_script_for_antlr.php">&laquo; Provide build script for ANTLR (wikitext, 282eee9)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/ignore_built_bundle_on_linux_w.php">Ignore built bundle on Linux (wikitext, caba3f0) &raquo;</a>

</p>

<h2>October 16, 2007</h2>

<h3>Refactor script into build and install portions (wikitext, 015e869)</h3>

<p>Now we have a build script (which builds the ANTLR tool and the C target runtime on Darwin, and only the runtime on Linux) and a separate install script (which installs tool and runtime on Darwin, and only the runtime on Linux).</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003024more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at October 16, 2007 10:02 PM</p>
