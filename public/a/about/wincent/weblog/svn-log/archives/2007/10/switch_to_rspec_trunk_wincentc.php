...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Switch to RSpec trunk (wincent.dev, b8c4b59)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/update_to_rails_20_preview_124.php"
            >&laquo; Update to Rails 2.0 preview (1.2.4.7499) (wincent.dev,
            4eddb40)</a
          >
          |
        ...
        <h3>Switch to RSpec trunk (wincent.dev, b8c4b59)</h3>

        <p>
          Moving to RSpec trunk (currently at revision 2717) because the latest
