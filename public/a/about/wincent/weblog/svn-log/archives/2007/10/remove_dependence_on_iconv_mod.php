...
<title>Git activity log: Remove dependence on Iconv module (wikitext, dda7a33)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/use_len_macros_for_structure_a.php" title="Use LEN macros for structure access (wikitext, bd7cbef)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/add_benchmark_runner_wikitext.php" title="Add benchmark runner (wikitext, 9d5875b)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/use_len_macros_for_structure_a.php">&laquo; Use LEN macros for structure access (wikitext, bd7cbef)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/add_benchmark_runner_wikitext.php">Add benchmark runner (wikitext, 9d5875b) &raquo;</a>

</p>

<h2>October 18, 2007</h2>

<h3>Remove dependence on Iconv module (wikitext, dda7a33)</h3>

<p>So as to depend on one less module, perform the UCS-2/UTF-8 conversion using a pair of custom methods written in C. The code would be easy to extend to handle UTF-32 when/if I move to it.</p>

<p>This change doesn't break any of the existing specs, but I'll be adding additional specs to specifically test the conversion methods and confirm that they appropriately reject invalid input (unlike the old wrapper functions these ones are public).</p>

<p>I also intend to add some benchmarks in a future commit to compare performance with the old implementation.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003031more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at October 18, 2007  1:56 AM</p>
