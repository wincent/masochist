...
<title>Git activity log: Allow pointer-to-pointer comparisons (WOTest, 8210f41)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/avoid_nsgetsizeandalignment_bu.php" title="Avoid NSGetSizeAndAlignment bug (WOTest, 1266032)" />

<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/remove_unit_test_made_redundan.php" title="Remove unit test made redundant by garbage collection (WOTest, 0f96414)" />
...
<p align="right">
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/avoid_nsgetsizeandalignment_bu.php">&laquo; Avoid NSGetSizeAndAlignment bug (WOTest, 1266032)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>
| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/remove_unit_test_made_redundan.php">Remove unit test made redundant by garbage collection (WOTest, 0f96414) &raquo;</a>

</p>

<h2>July 25, 2007</h2>

<h3>Allow pointer-to-pointer comparisons (WOTest, 8210f41)</h3>

<p>Found another case in which comparing nil to nil was leading to a failing test; ultimately the +[NSValue WOTest_compare:] method was being called where both objects were encoded with type &quot;pointer-to-void&quot;.</p>

<p>This commit adds a special case for such comparisons: truly equal pointers are considered to be NSOrderedSame; all others fall through to the default path and an exception is raised.</p>

<p>This is a conservative approach because in reality the only kind of pointer comparison which makes sense in practice is an equality test, not an ordering test.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a002527more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at July 25, 2007  9:47 AM</p>
