...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Use relative path for installer window background
      (Wincent Icon Utility, 9b10438)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/add_note_function_and_document.php"
      title="Add note() function and documentation (buildtools, d75ece2)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/installer_package_wincent_stri.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/add_note_function_and_document.php"
            >&laquo; Add note() function and documentation (buildtools,
            d75ece2)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/installer_package_wincent_stri.php"
            >Installer package (Wincent Strings Utility, 538f59e) &raquo;</a
          >
        </p>
        ...
        <h3>
          Use relative path for installer window background (Wincent Icon
          Utility, 9b10438)
        </h3>

        <p>
          The PackageMaker document mistakenly specified the path to the
          installer window background PDF using an absolute rather than a
          relative path. This commit amends that, making it use a relative path.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002566more"><div id="more"></div></div>
