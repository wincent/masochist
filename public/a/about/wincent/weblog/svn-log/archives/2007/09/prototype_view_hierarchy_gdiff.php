...
<title>Git activity log: Prototype view hierarchy (gdiff, 47bba3c)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/prepare_wofile_class_for_stori.php" title="Prepare WOFile class for storing blob contents (gdiff, 92f1012)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/set_up_default_pbxuser_setting.php" title="Set up default pbxuser settings (gdiff, 6120b07)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/prepare_wofile_class_for_stori.php">&laquo; Prepare WOFile class for storing blob contents (gdiff, 92f1012)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/set_up_default_pbxuser_setting.php">Set up default pbxuser settings (gdiff, 6120b07) &raquo;</a>

</p>

<h2>September 25, 2007</h2>

<h3>Prototype view hierarchy (gdiff, 47bba3c)</h3>

<p>Introduce the basic view hierarchy, using the MyDocument class as a controller which instantiates and configures a WODiffView and its subviews.</p>

<p>WODiffView is a simple container view that implements the auto-resizing logic, ensuring that when the parent window is resized the subviews are appropriately adjusted to match.</p>
...
<p>When resizing the window all &quot;columns&quot; should remain fixed in width except for the two WOFileViews, which should grow and shrink as required to fill all of the available space. All columns resize vertically to fill all available space.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a002940more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at September 25, 2007 12:18 PM</p>
