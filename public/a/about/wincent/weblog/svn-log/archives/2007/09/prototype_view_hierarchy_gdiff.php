...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/prepare_wofile_class_for_stori.php"
      title="Prepare WOFile class for storing blob contents (gdiff, 92f1012)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/set_up_default_pbxuser_setting.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/prepare_wofile_class_for_stori.php"
            >&laquo; Prepare WOFile class for storing blob contents (gdiff,
            92f1012)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/set_up_default_pbxuser_setting.php"
            >Set up default pbxuser settings (gdiff, 6120b07) &raquo;</a
          >
        </p>
        ...
        <p>
          Introduce the basic view hierarchy, using the MyDocument class as a
          controller which instantiates and configures a WODiffView and its
          subviews.
        </p>

        <p>
          WODiffView is a simple container view that implements the
          auto-resizing logic, ensuring that when the parent window is resized
          the subviews are appropriately adjusted to match.
        </p>

        <p>
          On the left we have an NSView which is used to group together a
          WOGutterView (for displaying line numbers) and a WOFileView (for
          displaying the contents of a blob). In the middle we have an
          WOGlueView which is used to draw shaded curves which visually link
          together changes made on one side (the &quot;from&quot; file) and
          those made on the other (the &quot;to&quot; file). Finally, on the
          right we have another NSView which is used to group together another
          WOFileView, another WOGutterView and an NSScroller.
        </p>

        <p>
          When resizing the window all &quot;columns&quot; should remain fixed
          in width except for the two WOFileViews, which should grow and shrink
          as required to fill all of the available space. All columns resize
          vertically to fill all available space.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002940more"><div id="more"></div></div>
