...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Tell Rails to use UTF-8 in the database (typechecked.net,
      4aba1f8)
    </title>
    ...
    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/bootstrap_fixturereplacement_w.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/ignore_logs_and_temporary_file.php"
            >&laquo; Ignore logs and temporary files (typechecked.net, 322b6f1)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/bootstrap_fixturereplacement_w.php"
            >Bootstrap FixtureReplacement (typechecked.net, 0dfd797) &raquo;</a
          >
        </p>

        <h2>October 5, 2007</h2>

        <h3>Tell Rails to use UTF-8 in the database (typechecked.net, 4aba1f8)</h3>
