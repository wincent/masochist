...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove deprecated method call in NSScanner lexing
      utilities (WOCommon, 18702b0)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/dont_let_fileutilscd_swallow_t.php"
      title="Don't let FileUtils.cd swallow the return value (snippets, 5652285)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/swap_in_nsmakecollectable_for.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/dont_let_fileutilscd_swallow_t.php"
            >&laquo; Don't let FileUtils.cd swallow the return value (snippets,
            5652285)</a
          >
          |
        ...
        <h3>
          Remove deprecated method call in NSScanner lexing utilities (WOCommon,
          18702b0)
        </h3>

        <p>
          &quot;copy&quot; is now recommended in favor of the deprecated
          &quot;string&quot; method, but in this case we don't even need to
          worry about that: just pass back the temporary string, even though
          it's mutable.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003454more"><div id="more"></div></div>
