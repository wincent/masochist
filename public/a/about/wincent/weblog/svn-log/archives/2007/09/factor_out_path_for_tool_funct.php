...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Factor out path_for_tool function (gdiff, 86bf53c)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/teach_tool_new_ways_to_get_inp.php"
      title="Teach tool new ways to get input (gdiff, 64de21c)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/refactoring_of_path_utilities.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/teach_tool_new_ways_to_get_inp.php"
            >&laquo; Teach tool new ways to get input (gdiff, 64de21c)</a
          >
          |
        ...
        <p>
          Move tool-locating code into a separate function where it can be used
          by both the command-line tool (to locate git-diff) and the GUI tool
          (to locate git-cat-file).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002952more"><div id="more"></div></div>
