    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/set_up_ignores_for_xcode_proje.php"
            >&laquo; Set up ignores for Xcode project bundle (WOCommon,
            db2b0f0)</a
          >
          |
        ...
        <p>
          Corresponds to revision 92 (tip of the trunk, Leopard) in the old
          Subversion repository.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002430more"><div id="more"></div></div>
