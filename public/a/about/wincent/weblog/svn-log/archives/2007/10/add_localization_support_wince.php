...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add localization support (wincent.dev, 342183f)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_distance_in_words_capabili.php"
      title="Add &amp;quot;distance in words&amp;quot; capability to Time class (wincent.dev, 471fe24)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_user_model_wincentcom_d9a5.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_distance_in_words_capabili.php"
            >&laquo; Add &quot;distance in words&quot; capability to Time class
            (wincent.dev, 471fe24)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_user_model_wincentcom_d9a5.php"
            >Add user model (wincent.dev, d9a50e5) &raquo;</a
          >
        </p>

        <h2>October 15, 2007</h2>

        <h3>Add localization support (wincent.dev, 342183f)</h3>

        <p>
          This commit adds a Locale class, a Translation class, and
          corresponding controllers and migrations. It also modifies the
          application controller so as to set up the locale if possible using a
          before_filter. The actual utility methods on the String class are
          added in lib/string_additions.rb.
        </p>

        <p>
          This is only a partial implementation, not a full localization stack.
          Later on may add special support for localized model attributes and
          possibly other things if the need arises.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003067more"><div id="more"></div></div>
