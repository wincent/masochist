...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add localization support (typechecked.net, 342183f)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/add_distance_in_words_capabili.php"
      title="Add &amp;quot;distance in words&amp;quot; capability to Time class (typechecked.net, 471fe24)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/add_user_model_wincentcom_d9a5.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/add_user_model_wincentcom_d9a5.php"
            >Add user model (typechecked.net, d9a50e5) &raquo;</a
          >
        </p>

        <h2>October 15, 2007</h2>

        <h3>Add localization support (typechecked.net, 342183f)</h3>
