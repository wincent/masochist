...
<title>Git activity log: Add localization support (wincent.com, 342183f)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/add_distance_in_words_capabili.php" title="Add &amp;quot;distance in words&amp;quot; capability to Time class (wincent.com, 471fe24)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/add_user_model_wincentcom_d9a5.php" title="Add user model (wincent.com, d9a50e5)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/add_distance_in_words_capabili.php">&laquo; Add &quot;distance in words&quot; capability to Time class (wincent.com, 471fe24)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/add_user_model_wincentcom_d9a5.php">Add user model (wincent.com, d9a50e5) &raquo;</a>

</p>

<h2>October 15, 2007</h2>

<h3>Add localization support (wincent.com, 342183f)</h3>

<p>This commit adds a Locale class, a Translation class, and corresponding controllers and migrations. It also modifies the application controller so as to set up the locale if possible using a before_filter. The actual utility methods on the String class are added in lib/string_additions.rb.</p>

<p>This is only a partial implementation, not a full localization stack. Later on may add special support for localized model attributes and possibly other things if the need arises.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003067more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at October 15, 2007  3:22 AM</p>
