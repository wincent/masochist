...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Total rewrite of assertion and check macros (WOPublic,
      7a0c0be)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/remove_logging_macros_wopublic.php"
      title="Remove logging macros (WOPublic, 195c4be)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/use_woparametercheck_gdiff_eff.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/remove_logging_macros_wopublic.php"
            >&laquo; Remove logging macros (WOPublic, 195c4be)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/use_woparametercheck_gdiff_eff.php"
            >Use WOParameterCheck (gdiff, efffc30) &raquo;</a
          >
        </p>
        ...
        <p>
          Make a really clear distinction between &quot;assertions&quot; and
          &quot;checks&quot;. The former are debugging tools that don't even
          make it into Release builds and the latter are identical except that
          they appear in both Debug and Release builds; you use
          &quot;checks&quot; rather than &quot;assertions&quot; where performing
          the check is necessary for the fulfilment of your API contract (for
          example, when checking parameters for conformance with the documented
          API).
        </p>

        <p>
          At the same time I got rid of the bascically unused WORequire and
          WO_DEBUG_ONLY macros.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002918more"><div id="more"></div></div>
