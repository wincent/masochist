...
<title>Git activity log: Total rewrite of assertion and check macros (WOPublic, 7a0c0be)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/remove_logging_macros_wopublic.php" title="Remove logging macros (WOPublic, 195c4be)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/use_woparametercheck_gdiff_eff.php" title="Use WOParameterCheck (gdiff, efffc30)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/remove_logging_macros_wopublic.php">&laquo; Remove logging macros (WOPublic, 195c4be)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/use_woparametercheck_gdiff_eff.php">Use WOParameterCheck (gdiff, efffc30) &raquo;</a>

</p>

<h2>October  1, 2007</h2>

<h3>Total rewrite of assertion and check macros (WOPublic, 7a0c0be)</h3>

<p>Make a really clear distinction between &quot;assertions&quot; and &quot;checks&quot;. The former are debugging tools that don't even make it into Release builds and the latter are identical except that they appear in both Debug and Release builds; you use &quot;checks&quot; rather than &quot;assertions&quot; where performing the check is necessary for the fulfilment of your API contract (for example, when checking parameters for conformance with the documented API).</p>

<p>At the same time I got rid of the bascically unused WORequire and WO_DEBUG_ONLY macros.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a002918more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at October  1, 2007  1:18 AM</p>
