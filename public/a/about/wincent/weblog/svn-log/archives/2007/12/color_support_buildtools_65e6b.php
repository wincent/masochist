...
<title>Git activity log: Color support (buildtools, 65e6ba8)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/bump_version_number_for_12_rel.php" title="Bump version number for 1.2 release candidate 1 (Wincent Strings Utility, a2e8ae4)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/enhancements_to_updatexibs_scr.php" title="Enhancements to UpdateXibs script (buildtools, 30cf542)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/bump_version_number_for_12_rel.php">&laquo; Bump version number for 1.2 release candidate 1 (Wincent Strings Utility, a2e8ae4)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/enhancements_to_updatexibs_scr.php">Enhancements to UpdateXibs script (buildtools, 30cf542) &raquo;</a>

</p>

<h2>December 23, 2007</h2>

<h3>Color support (buildtools, 65e6ba8)</h3>

<p>Use tput to test whether the current terminal supports basic color capabilities (bold, foreground color, reset). In itself these tests are not enough to determine whether it is appropriate to use color; for example, when run from inside Xcode or when output is redirected or piped elsewhere the tests will still pass but color may not be appropriate. So an additional test (test -t 1) for an open file descriptor is used to avoid emitting color output in these circumstances.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003346more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at December 23, 2007  6:47 PM</p>
