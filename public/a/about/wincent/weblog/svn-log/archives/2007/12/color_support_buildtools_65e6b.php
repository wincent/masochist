...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/bump_version_number_for_12_rel.php"
      title="Bump version number for 1.2 release candidate 1 (Wincent Strings Utility, a2e8ae4)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/enhancements_to_updatexibs_scr.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/bump_version_number_for_12_rel.php"
            >&laquo; Bump version number for 1.2 release candidate 1 (Wincent
            Strings Utility, a2e8ae4)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/enhancements_to_updatexibs_scr.php"
            >Enhancements to UpdateXibs script (buildtools, 30cf542) &raquo;</a
          >
        </p>
        ...
        <p>
          ...
          capabilities (bold, foreground color, reset). In itself these tests
          are not enough to determine whether it is appropriate to use color;
          for example, when run from inside Xcode or when output is redirected
          or piped elsewhere the tests will still pass but color may not be
          appropriate. So an additional test (test -t 1) for an open file
          descriptor is used to avoid emitting color output in these
          circumstances.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003346more"><div id="more"></div></div>
