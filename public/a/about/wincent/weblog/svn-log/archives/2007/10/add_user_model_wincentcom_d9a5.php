...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Add user model (typechecked.net, d9a50e5)</title>
    ...
    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/add_sessions_wincentcom_0d0f57.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/add_localization_support_wince.php"
            >&laquo; Add localization support (typechecked.net, 342183f)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/add_sessions_wincentcom_0d0f57.php"
            >Add sessions (typechecked.net, 0d0f571) &raquo;</a
          >
        </p>

        <h2>October 15, 2007</h2>

        <h3>Add user model (typechecked.net, d9a50e5)</h3>
