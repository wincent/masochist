...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Add user model (wincent.dev, d9a50e5)</title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_sessions_wincentcom_0d0f57.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_localization_support_wince.php"
            >&laquo; Add localization support (wincent.dev, 342183f)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_sessions_wincentcom_0d0f57.php"
            >Add sessions (wincent.dev, 0d0f571) &raquo;</a
          >
        </p>

        <h2>October 15, 2007</h2>

        <h3>Add user model (wincent.dev, d9a50e5)</h3>

        <p>
          Add a user model, controller and helper, along with specs, the
          supporting authentication library (lib/authentication.rb) and an
          initial migration.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003068more"><div id="more"></div></div>
