...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add note about use of /dev/random (WOCommon, 13b9765)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_wocheck_and_woccheck_macro.php"
      title="Add WOCheck and WOCCheck macros (WOPublic, e9bfc2b)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/initialize_with_new_rails_appl.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_wocheck_and_woccheck_macro.php"
            >&laquo; Add WOCheck and WOCCheck macros (WOPublic, e9bfc2b)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/initialize_with_new_rails_appl.php"
            >Initialize with new Rails application (wincent.dev, 94617f2)
            &raquo;</a
          >
        </p>
        ...
        <p>
          Reading too many bits from /dev/random may constitute an abuse of a
          scarce resource, and the read() call may block if there is not enough
          random data anyway. Ideally in this case we should only read enough to
