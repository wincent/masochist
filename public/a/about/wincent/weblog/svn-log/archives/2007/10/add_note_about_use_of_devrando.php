...
<title>Git activity log: Add note about use of /dev/random (WOCommon, 13b9765)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/add_wocheck_and_woccheck_macro.php" title="Add WOCheck and WOCCheck macros (WOPublic, e9bfc2b)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/initialize_with_new_rails_appl.php" title="Initialize with new Rails application (wincent.com, 94617f2)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/add_wocheck_and_woccheck_macro.php">&laquo; Add WOCheck and WOCCheck macros (WOPublic, e9bfc2b)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/initialize_with_new_rails_appl.php">Initialize with new Rails application (wincent.com, 94617f2) &raquo;</a>

</p>

<h2>October  3, 2007</h2>

<h3>Add note about use of /dev/random (WOCommon, 13b9765)</h3>

<p>Reading too many bits from /dev/random may constitute an abuse of a scarce resource, and the read() call may block if there is not enough random data anyway. Ideally in this case we should only read enough to seed another (psuedo-random) generator.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a002864more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at October  3, 2007  2:48 PM</p>
