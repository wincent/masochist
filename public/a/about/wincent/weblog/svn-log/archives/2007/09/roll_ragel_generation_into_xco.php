...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Roll Ragel generation into Xcode build (gdiff, 828150d)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/move_model_classes_from_tool_i.php"
      title="Move model classes from tool into GUI app (gdiff, 90dff09)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/split_ragel_generation_into_tw.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/move_model_classes_from_tool_i.php"
            >&laquo; Move model classes from tool into GUI app (gdiff,
            90dff09)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/split_ragel_generation_into_tw.php"
            >Split Ragel generation into two phases (gdiff, 3e94d7d) &raquo;</a
          >
        </p>
        ...
        <p>
          Migrate the WODiffMachine class to the GUI application build as well
          using a custom build rule to generate the Objective-C (.m) file from
          the Ragel (.rl) source.
        </p>

        <p>
          Although this works there appears to be a problem in the Xcode
          dependency analysis wherein ragel is run on every single build even
          when no files have been changed; this in turn causes the built
          WODiffMachine Objective-C file to itself be rebuilt, and the project
          relinked. Hopefully will be able to isolate the cause of these
