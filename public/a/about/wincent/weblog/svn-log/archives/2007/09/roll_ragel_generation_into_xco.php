...
<title>Git activity log: Roll Ragel generation into Xcode build (gdiff, 828150d)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/move_model_classes_from_tool_i.php" title="Move model classes from tool into GUI app (gdiff, 90dff09)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/split_ragel_generation_into_tw.php" title="Split Ragel generation into two phases (gdiff, 3e94d7d)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/move_model_classes_from_tool_i.php">&laquo; Move model classes from tool into GUI app (gdiff, 90dff09)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/split_ragel_generation_into_tw.php">Split Ragel generation into two phases (gdiff, 3e94d7d) &raquo;</a>

</p>

<h2>September 25, 2007</h2>

<h3>Roll Ragel generation into Xcode build (gdiff, 828150d)</h3>

<p>Migrate the WODiffMachine class to the GUI application build as well using a custom build rule to generate the Objective-C (.m) file from the Ragel (.rl) source.</p>

<p>Although this works there appears to be a problem in the Xcode dependency analysis wherein ragel is run on every single build even when no files have been changed; this in turn causes the built WODiffMachine Objective-C file to itself be rebuilt, and the project relinked. Hopefully will be able to isolate the cause of these unnecessary rebuilds and eliminate them.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a002946more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at September 25, 2007  1:19 PM</p>
