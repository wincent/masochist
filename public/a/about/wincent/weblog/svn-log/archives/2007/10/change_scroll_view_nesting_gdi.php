...
<title>Git activity log: Change scroll view nesting (gdiff, 106eb63)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/fix_inappropriate_1pixel_inset.php" title="Fix inappropriate 1-pixel inset inside grouping views (gdiff, 6c01eb2)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/show_placeholder_line_number_i.php" title="Show placeholder line number in WOGutterView (gdiff, 0c87a5b)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/fix_inappropriate_1pixel_inset.php">&laquo; Fix inappropriate 1-pixel inset inside grouping views (gdiff, 6c01eb2)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/show_placeholder_line_number_i.php">Show placeholder line number in WOGutterView (gdiff, 0c87a5b) &raquo;</a>

</p>

<h2>October  2, 2007</h2>

<h3>Change scroll view nesting (gdiff, 106eb63)</h3>

<p>Instead of putting the gutter views and file views inside a scroll view put only the file views inside; this change is apparently necessary because otherwise I can't get the autoresizing behaviour and auto-showing/hiding of the horizontal scroll bar to work.</p>

<p>I am not sure whether this is a limitation of the Cocoa text system or there is some kind of magic incantation that would have enabled it to work the other way, but without access to the source code it seems doubtful that it would be worth the effort of trying to figure out what's going on in the bowels of AppKit.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003005more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at October  2, 2007 12:44 AM</p>
