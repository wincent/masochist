...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add column-counting script (snippets, 4dfddee)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/second_stage_in_gc_conversion_1.php"
      title="Second stage in GC conversion (Synergy, 9c2d28d)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/expand_tabs_when_calculating_l.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/second_stage_in_gc_conversion_1.php"
            >&laquo; Second stage in GC conversion (Synergy, 9c2d28d)</a
          >
          |
        ...
        <p>
          Simple Ruby script to print a histogram of line-width frequencies; its
          purpose is to get a feel for the typical line width in a code base
          which doesn't impose hard limits. It can also be used to check code
          bases which do have hard limits for violations.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003098more"><div id="more"></div></div>
