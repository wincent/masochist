...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Update script/spec (typechecked.net, 57f43c1)</title>
    ...
    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/set_up_ignores_in_test_subdire.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/turn_on_activerecord_session_s.php"
            >&laquo; Turn on ActiveRecord session store (typechecked.net,
            405881e)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/set_up_ignores_in_test_subdire.php"
            >Set up ignores in test subdirectory (typechecked.net, 0169c6c)
            &raquo;</a
          >
        </p>
        ...
        <h3>Update script/spec (typechecked.net, 57f43c1)</h3>
