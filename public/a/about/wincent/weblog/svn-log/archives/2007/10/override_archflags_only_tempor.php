...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Override ARCHFLAGS only temporarily (wikitext, 7b7504d)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/fix_leopard_gcc_warnings_wikit.php"
      title="Fix Leopard GCC warnings (wikitext, cee8b13)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/use_public_nsmethodsignature_a.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/fix_leopard_gcc_warnings_wikit.php"
            >&laquo; Fix Leopard GCC warnings (wikitext, cee8b13)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/use_public_nsmethodsignature_a.php"
            >Use public NSMethodSignature API (WOTest, 8ad52f7) &raquo;</a
          >
        </p>
        ...
        <p>
          When building on Darwin rather than setting an environment variable
          permanently just set it for the duration of the mkmf run.
        </p>

        <p>
          I looked at jettisoning this override entirely but experimentation
          shows that the ANTLR runtime is not built with cross-compilatin in
          mind; this was later confirmed on the mailing list by the C runtime
          author.
        </p>
        ...
        <div id="a003047more"><div id="more"></div></div>
