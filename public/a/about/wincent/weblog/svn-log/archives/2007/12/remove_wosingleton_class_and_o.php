...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove WOSingleton class and other cruft (Synergy,
      d48f69d)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/update_embedded_growl_framewor.php"
      title="Update embedded Growl framework to 1.1.2 (Synergy, bde3657)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/remove_unused_help_classes_syn.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/update_embedded_growl_framewor.php"
            >&laquo; Update embedded Growl framework to 1.1.2 (Synergy,
            bde3657)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/remove_unused_help_classes_syn.php"
            >Remove unused help classes (Synergy, c27254f) &raquo;</a
          >
        </p>
        ...
        <p>
          There is now only one class which requires singleton functionality and
          it now has it thanks to fast double-checked locks with memory
          barriers.
        </p>
        ...
        <div id="a003288more"><div id="more"></div></div>
