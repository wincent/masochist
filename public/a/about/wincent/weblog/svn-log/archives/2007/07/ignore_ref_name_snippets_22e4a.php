...
<title>Git activity log: Ignore ref_name (snippets, 22e4a24)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/stricter_check_for_creation_ev.php" title="Stricter check for creation events (snippets, f2fe528)" />

<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/command_refactoring_for_better.php" title="Command refactoring for better error detection (snippets, 098ddbc)" />
...
<p align="right">
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/stricter_check_for_creation_ev.php">&laquo; Stricter check for creation events (snippets, f2fe528)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>
| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/command_refactoring_for_better.php">Command refactoring for better error detection (snippets, 098ddbc) &raquo;</a>

</p>

<h2>July 18, 2007</h2>

<h3>Ignore ref_name (snippets, 22e4a24)</h3>

<p>Ignore ref_name for now seeing as it is not used for any real purpose. If I<br />
later decide to take specific actions depending on the reference name (for<br />
example, distinguishing between unannotated tags, annotated tags, branch<br />
commits and tracking branch events, as demonstrated in the post-receive-email<br />
hook that comes with Git) I can always do something with the ref_name.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt;<br />
</p>

<div id="a002414more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at July 18, 2007  6:02 PM</p>
