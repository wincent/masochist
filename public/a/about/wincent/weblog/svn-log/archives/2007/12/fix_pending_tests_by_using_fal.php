...
<title>Git activity log: Fix pending tests by using fallback encodings (Wincent Strings Utility, 3f897ce)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/add_specs_for_automatic_additi.php" title="Add specs for automatic addition of BOMs to output (Wincent Strings Utility, 36576bc)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/try_multiple_encodings_in_info.php" title="Try multiple encodings in -info/-strings code path (Wincent Strings Utility, fb6f577)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/add_specs_for_automatic_additi.php">&laquo; Add specs for automatic addition of BOMs to output (Wincent Strings Utility, 36576bc)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/try_multiple_encodings_in_info.php">Try multiple encodings in -info/-strings code path (Wincent Strings Utility, fb6f577) &raquo;</a>

</p>

<h2>December 22, 2007</h2>

<h3>Fix pending tests by using fallback encodings (Wincent Strings Utility, 3f897ce)</h3>

<p>Instead of using the deprecated NSString stringWithContentsOfFile: method (not sure why no deprecation warnings were being issued) instead use stringWithContentsOfFile:encoding:error:. The problem with the former is that any strings file without a BOM was being interpreted using the normal C string encoding, which was incorrect and would in turn cause parsing to fail.</p>

<p>In this way we can explicitly try NSUTF16StringEncoding (should work for any file that has a BOM) and then fall back to NSUTF16LittleEndianStringEncoding and NSUTF16BigEndianStringEncoding if parsing fails.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003335more"><div id="more">
