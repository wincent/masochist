...
<title>Git activity log: Additional dependency info for Rakefile (wikitext, 3fd78b8)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/refactor_for_deployment_using.php" title="Refactor for deployment using RubyGems (wikitext, 80ae725)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/use_len_macros_for_structure_a.php" title="Use LEN macros for structure access (wikitext, bd7cbef)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/refactor_for_deployment_using.php">&laquo; Refactor for deployment using RubyGems (wikitext, 80ae725)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/use_len_macros_for_structure_a.php">Use LEN macros for structure access (wikitext, bd7cbef) &raquo;</a>

</p>

<h2>October 17, 2007</h2>

<h3>Additional dependency info for Rakefile (wikitext, 3fd78b8)</h3>

<p>Rather than just firing off the Makefile from within the Rakefile, some basic dependency info is added so that Rake knows when to bother running &quot;make&quot; again.</p>

<p>The default task is the &quot;all&quot; task, which builds (only if necessary) and runs the specs. Note that because the actual building is delegated to make, and the Makefile has its own set of dependency information, the build will only perform as much as is necessary (for example, if the grammar file is touched then everything gets rebuilt; if only the wikitext.c file is touched then only that gets rebuilt and is relinked against the other object files).</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003029more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at October 17, 2007  5:40 PM</p>
