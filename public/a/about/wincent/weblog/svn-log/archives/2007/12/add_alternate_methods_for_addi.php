...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add alternate methods for adding login items
      (login-tool, 62e266f)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/whitespace_fixes_logintool_740.php"
      title="Whitespace fixes (login-tool, 740316b)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/add_new_build_of_logintool_syn.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/whitespace_fixes_logintool_740.php"
            >&laquo; Whitespace fixes (login-tool, 740316b)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/add_new_build_of_logintool_syn.php"
            >Add new build of login-tool (Synergy, a2cc769) &raquo;</a
          >
        </p>
        ...
        <p>
          It appears that System Events is broken on Leopard: telling it to add
          a new login item fails in all three ways that I tried to do so (using
          the scripting bridge, using raw Apple Events, and even trying from the
          Script Editor using the script that Apple itself documents as being
          the way to do it).
        </p>

        <p>
          So this commit preprocesses the non-working solutions away and falls
          back to old-fashioned direct manipulation of the loginwindow.plist.
          This actually is supported by Apple and is listed in their docs as one
          of the ways of adding login items.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003223more"><div id="more"></div></div>
