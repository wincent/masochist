...
<title>Git activity log: Use commit date when creating posts (snippets, 07007a0)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/make_xidius_transparent_bar_th_1.php" title="Make &amp;quot;Xidius' Transparent Bar&amp;quot; the new default button set (Synergy, 74a242d)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/remove_todo_comment_snippets_e.php" title="Remove TODO comment (snippets, e767e66)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/make_xidius_transparent_bar_th_1.php">&laquo; Make &quot;Xidius' Transparent Bar&quot; the new default button set (Synergy, 74a242d)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/remove_todo_comment_snippets_e.php">Remove TODO comment (snippets, e767e66) &raquo;</a>

</p>

<h2>October 28, 2007</h2>

<h3>Use commit date when creating posts (snippets, 07007a0)</h3>

<p>Previously the Git post-receive hook just created new posts as commits were received; now the hook extacts the author date (not the committer date) from each commit and uses that to set the creation date on the post.</p>

<p>This means that there will be a perceived delay between the commit date and the time it shows up on the activity log, but this accurately reflects the way in which commits are not actually published until somebody does a &quot;git push&quot;. It also avoids the clumping together effect of the old system where a bunch of commits that took place over a period of time would appear to have happened all at once when pushed out.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a002850more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at October 28, 2007  8:31 PM</p>
