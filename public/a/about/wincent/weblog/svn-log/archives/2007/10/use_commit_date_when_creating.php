...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Use commit date when creating posts (snippets, 07007a0)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/make_xidius_transparent_bar_th_1.php"
      title="Make &amp;quot;Xidius' Transparent Bar&amp;quot; the new default button set (Synergy, 74a242d)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/remove_todo_comment_snippets_e.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/make_xidius_transparent_bar_th_1.php"
            >&laquo; Make &quot;Xidius' Transparent Bar&quot; the new default
            button set (Synergy, 74a242d)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/remove_todo_comment_snippets_e.php"
            >Remove TODO comment (snippets, e767e66) &raquo;</a
          >
        </p>
        ...
        <p>
          Previously the Git post-receive hook just created new posts as commits
          were received; now the hook extacts the author date (not the committer
          date) from each commit and uses that to set the creation date on the
          post.
        </p>

        <p>
          This means that there will be a perceived delay between the commit
          date and the time it shows up on the activity log, but this accurately
          reflects the way in which commits are not actually published until
          somebody does a &quot;git push&quot;. It also avoids the clumping
          together effect of the old system where a bunch of commits that took
          place over a period of time would appear to have happened all at once
          when pushed out.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002850more"><div id="more"></div></div>
