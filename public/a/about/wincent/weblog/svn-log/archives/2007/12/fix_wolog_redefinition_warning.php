...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix WOLog redefinition warning (WOCommon, 1e78769)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/rewrapping_in_nsmutablestring.php"
      title="Rewrapping in NSMutableString editing utilities (WOCommon, 2ca60b4)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/replace_calls_to_malloc_with_w.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/rewrapping_in_nsmutablestring.php"
            >&laquo; Rewrapping in NSMutableString editing utilities (WOCommon,
            2ca60b4)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/replace_calls_to_malloc_with_w.php"
            >Replace calls to malloc with wmalloc (WOCommon, 62630a6) &raquo;</a
          >
        </p>
        ...
        <p>
          Now that WOLog is a macro rather than a global external, one of the
          definitions is redundant, so remove it.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003440more"><div id="more"></div></div>
