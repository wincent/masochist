...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add checks for duplicate keys within the same file
      (Wincent Strings Utility, c4a5cc7)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/favor_member_over_containsobje.php"
      title="Favor member: over containsObject: (Wincent Strings Utility, 40c92d7)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/add_specs_for_combine_function.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/favor_member_over_containsobje.php"
            >&laquo; Favor member: over containsObject: (Wincent Strings
            Utility, 40c92d7)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/add_specs_for_combine_function.php"
            >Add specs for -combine functionality (Wincent Strings Utility,
            e7ece84) &raquo;</a
          >
        </p>
        ...
        <h3>
          Add checks for duplicate keys within the same file (Wincent Strings
          Utility, c4a5cc7)
        </h3>
        ...
        <div id="a003341more"><div id="more"></div></div>
