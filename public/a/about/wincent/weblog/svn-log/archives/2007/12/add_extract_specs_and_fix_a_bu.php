...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add extract() specs and fix a bug (Wincent Strings
      Utility, 4e7b88d)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/minor_comment_cleanup_wincent.php"
            >&laquo; Minor comment cleanup (Wincent Strings Utility, 5dd6388)</a
          >
          |
        ...
        <p>
          Add specs for the -extract switch and fix a bug discovered as a
          result.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003338more"><div id="more"></div></div>
