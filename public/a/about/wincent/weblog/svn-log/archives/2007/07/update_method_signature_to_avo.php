...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update method signature to avoid deprecated API warnings
      (WOHotKey, f4f9ad8)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/set_up_ignores_for_temporary_f.php"
      title="Set up ignores for temporary files (WOHotKey, 1526604)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/migrate_to_new_leopard_keyboar.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/set_up_ignores_for_temporary_f.php"
            >&laquo; Set up ignores for temporary files (WOHotKey, 1526604)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/migrate_to_new_leopard_keyboar.php"
            >Migrate to new Leopard keyboard APIs (WOHotKey, 7ae51da) &raquo;</a
          >
        </p>
        ...
        <h3>
          Update method signature to avoid deprecated API warnings (WOHotKey,
          f4f9ad8)
        </h3>

        <p>
          The method signature for validateMenuItem: has changed in Leopard.
          This commit updates the signature; functionality is unchanged but the
          new signature avoids some warnings about deprecated APIs that are
          issued inside the method itself.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002576more"><div id="more"></div></div>
