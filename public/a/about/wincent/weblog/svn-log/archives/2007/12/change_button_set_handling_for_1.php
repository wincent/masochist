...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Change button set handling for installerless
      distribution (Synergy, 801a8fd)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/warn_about_c99_comments_wincen.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/change_button_set_handling_for.php"
            >&laquo; Change button set handling for installerless distribution
            (Synergy, 801a8fd)</a
          >
          |
        ...
        <p>
          The buttons sets which were formerly installed by the installer are
          now bundled inside the application. Minor code changes to allow the
          preference pane to share the button sets with the application.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003418more"><div id="more"></div></div>
