...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Ignore logs and temporary files (wincent.dev, 322b6f1)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/describe_steps_for_setting_up.php"
      title="Describe steps for setting up database (wincent.dev, 7208f45)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/tell_rails_to_use_utf8_in_the.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/describe_steps_for_setting_up.php"
            >&laquo; Describe steps for setting up database (wincent.dev,
            7208f45)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/tell_rails_to_use_utf8_in_the.php"
            >Tell Rails to use UTF-8 in the database (wincent.dev, 4aba1f8)
            &raquo;</a
          >
        </p>
        ...
        <h3>Ignore logs and temporary files (wincent.dev, 322b6f1)</h3>

        <p>
          Set up .gitignore files in the log and tmp subdirectories, and remove
          empty log files that were previously added.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003055more"><div id="more"></div></div>
