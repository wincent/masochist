...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/04/buildtools_r73_2_items_changed.php"
      title="buildtools r73, 2 items changed"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/04/buildtools_r75_2_items_changed.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/04/buildtools_r73_2_items_changed.php"
            >&laquo; buildtools r73, 2 items changed</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/04/buildtools_r75_2_items_changed.php"
            >buildtools r75, 2 items changed &raquo;</a
          >
        </p>
        ...
        <p>
          Correct typo; only update revision file if Subversion revision has
          changed (saves some gratuitous rebuilds in Xcode): this means that the
          build timestamp won't be accurate for repeated builds of the same
          revision but it will at least be correct on all fresh checkouts
        </p>

        <div id="a002108more"><div id="more"></div></div>
