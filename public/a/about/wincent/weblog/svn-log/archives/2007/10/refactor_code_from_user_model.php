...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/specs_for_session_controller_a.php"
      title="Specs for session controller and tweaks to get them passing (typechecked.net, 067ca6f)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/add_application_controller_spe.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/add_application_controller_spe.php"
            >Add application controller specs (typechecked.net, f7ec927) &raquo;</a
          >
        </p>
        ...
        <h3>
          Refactor code from User model into Authentication module (typechecked.net,
          f625239)
        </h3>
