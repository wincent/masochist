...
<title>Git activity log: Refactor code from User model into Authentication module (wincent.com, f625239)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/specs_for_session_controller_a.php" title="Specs for session controller and tweaks to get them passing (wincent.com, 067ca6f)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/add_application_controller_spe.php" title="Add application controller specs (wincent.com, f7ec927)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/specs_for_session_controller_a.php">&laquo; Specs for session controller and tweaks to get them passing (wincent.com, 067ca6f)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/add_application_controller_spe.php">Add application controller specs (wincent.com, f7ec927) &raquo;</a>

</p>

<h2>October 20, 2007</h2>

<h3>Refactor code from User model into Authentication module (wincent.com, f625239)</h3>

<p>At the moment the authentication logic is spread across several sites: the User model, the ApplicationController (and by inheritance all its subclasses), and the Authentication module itself.</p>

<p>This commit tries to centralize as much of this code as possible inside the Authentication module with the goal of keeping the authentication code in one place. It is unavoidable that an authentication mechanism be involved with both controllers and models (and later views), but at least we can store the logic in a single file, clearly grouped using submodules (Authentication::Model, Authentication::Controller and so forth), and then incorporate it elsewhere using extend and include.</p>

<p>There still is quite a bit of explicit authentication logic in the user model itself (mostly validation and callback related), and I am not sure what to do about that. Although the idea of keeping authentication code bundled together in one place is superficially appealing, if taken to far it can actually make the code less readable. As such, the refactoring done in this commit is relatively conservative and I won't be taking it any further for the time-being.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003089more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at October 20, 2007  4:02 PM</p>
...
<div id="footer">
  ...
  <p>Page last updated 00:30:23, 19 February 2010.</p>
  <p>
