...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Initial version of standalone preferences application
      (Synergy, b499a72)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/bring_uptodate_for_new_workflo.php"
      title="Bring up-to-date for new workflow (snippets, 69b16dc)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/add_installer_package_target_w.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/bring_uptodate_for_new_workflo.php"
            >&laquo; Bring up-to-date for new workflow (snippets, 69b16dc)</a
          >
          |
        ...
        <h3>
          Initial version of standalone preferences application (Synergy,
          b499a72)
        </h3>
        ...
        <p>
          This change was made after a review of the Garbage Collection
          migration. Synergy's code is found in two places: inside the
          application itself and inside the preference pane (and the application
          is bundled inside the preference pane bundle). The application code
          has been converted to use Garbage Collection but the preference pane
          code could not be converted because the System Preferences application
          is compiled without GC support and the PreferencePanes framework
          against which the preference pane must link does not come in a
          GC-enabled version, at least as of Leopard.
        </p>
        ...
        <p>
          ...
          a new class, WOPreferencePane, to stand in for NSPreferencePane, and a
          simple NSWindow subclass, WOPreferenceWindow, to load and display a
          single pane.
        </p>

        <p>
          An additional benefit of this move is that from now on Synergy will
          not require an installer because as a standalone application it can be
          installed anywhere.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003290more"><div id="more"></div></div>
