...
<title>Git activity log: Initial version of standalone preferences application (Synergy, b499a72)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/bring_uptodate_for_new_workflo.php" title="Bring up-to-date for new workflow (snippets, 69b16dc)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/add_installer_package_target_w.php" title="Add installer package target (Wincent Strings Utility, b1c9b17)" />
...
<body>
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../../../../../../">About</a>&nbsp;&gt;&nbsp;<a href="../../../../../">Wincent</a>&nbsp;&gt;&nbsp;<a href="../../../../">Weblog</a>&nbsp;&gt;&nbsp;<a href="../../../">Git log</a>&nbsp;&gt;&nbsp;<a href="../../">Archives</a>&nbsp;&gt;&nbsp;<a href="../">2007</a>&nbsp;&gt;&nbsp;12    </p>
  </div>
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/bring_uptodate_for_new_workflo.php">&laquo; Bring up-to-date for new workflow (snippets, 69b16dc)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/add_installer_package_target_w.php">Add installer package target (Wincent Strings Utility, b1c9b17) &raquo;</a>

</p>

<h2>December 19, 2007</h2>

<h3>Initial version of standalone preferences application (Synergy, b499a72)</h3>

<p>Now the Synergy prefPane is no longer loaded by the System Preferences and is instead hosted by a standalone application. This commit is an initial version of the application which loads the prefPane bundle and displays the window in the center of the screen on launch.</p>

<p>This change was made after a review of the Garbage Collection migration. Synergy's code is found in two places: inside the application itself and inside the preference pane (and the application is bundled inside the preference pane bundle). The application code has been converted to use Garbage Collection but the preference pane code could not be converted because the System Preferences application is compiled without GC support and the PreferencePanes framework against which the preference pane must link does not come in a GC-enabled version, at least as of Leopard.</p>

<p>This is problematic because some of the Synergy code is shared between the app and the preference pane; it is therefore necessary for the common code to be written using a reference-counting style (which largely negates the benefit of moving to GC) or using conditional compilation to produce two variants of the same code (which is an error-prone process).</p>

<p>So evaluating all this, it seems the best course of action is to host the preference pane in a standalone application. In order to do so I can no longer link against the PreferencePanes framework, so I've made a new class, WOPreferencePane, to stand in for NSPreferencePane, and a simple NSWindow subclass, WOPreferenceWindow, to load and display a single pane.</p>

<p>An additional benefit of this move is that from now on Synergy will not require an installer because as a standalone application it can be installed anywhere.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003290more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at December 19, 2007 11:38 AM</p>
...
<div id="footer">
  ...
  <p>Page last updated 00:30:30, 19 February 2010.</p>
  <p>
