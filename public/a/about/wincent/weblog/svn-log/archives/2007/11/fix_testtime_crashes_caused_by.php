...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix test-time crashes caused by 10.5 runtime changes
      (WOTest, 8e83a65)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/ignore_xcode_index_directory_w.php"
      title="Ignore Xcode index directory (Wincent Icon Utility, 6f55440)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/fix_last_of_testtime_crashes_u.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/ignore_xcode_index_directory_w.php"
            >&laquo; Ignore Xcode index directory (Wincent Icon Utility,
            6f55440)</a
          >
          |
        ...
        <p>
          This commit adds two such methods to the WOLightweightRoot
          implementation, doesNotRecognizeSelector: and
          methodSignatureForSelector:, thus eliminating a crash that would
          derail the test run.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003189more"><div id="more"></div></div>
