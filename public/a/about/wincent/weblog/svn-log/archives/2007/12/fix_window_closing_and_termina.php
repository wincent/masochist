...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix window closing and termination behaviour (Synergy,
      52c8406)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/use_full_path_to_zip_in_nightl.php"
      title="Use full path to zip in nightlies script (snippets, e562da6)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/provide_menu_item_for_bringing.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/use_full_path_to_zip_in_nightl.php"
            >&laquo; Use full path to zip in nightlies script (snippets,
            e562da6)</a
          >
          |
        ...
        <p>
          ...
          distinguishing between application termination and window closing.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003447more"><div id="more"></div></div>
