...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove NSLock from NSTimer category (Synergy, 492a094)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/remove_irrelevant_comment_from.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/nstimer_category_updates_for_g.php"
            >&laquo; NSTimer category updates for GC (Synergy, 137534a)</a
          >
          |
        ...
        <p>
          ...
          @synchronized directive was not available); now this limitation is no
          longer applicable so replace the NSLock idiom with @synchronized.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003254more"><div id="more"></div></div>
