...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Use Doxygen deprecated directive in NSArray creation
      category (WOCommon, 1cde1da)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/nstimer_category_updates_for_g.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/gc_changes_to_nsattributedstri.php"
            >&laquo; GC changes to NSAttributedString creation category
            (WOCommon, 84bcfe4)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/nstimer_category_updates_for_g.php"
            >NSTimer category updates for GC (Synergy, 137534a) &raquo;</a
          >
        </p>
        ...
        <h3>
          Use Doxygen deprecated directive in NSArray creation category
          (WOCommon, 1cde1da)
        </h3>

        <p>
          Rather than just including the deprecation notice in the body of the
          method documentation, use the specific Doxygen directive for that
          purpose.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003238more"><div id="more"></div></div>
