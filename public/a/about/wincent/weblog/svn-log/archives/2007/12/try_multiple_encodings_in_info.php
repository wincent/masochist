...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Try multiple encodings in -info/-strings code path
      (Wincent Strings Utility, fb6f577)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/fix_pending_tests_by_using_fal.php"
      title="Fix pending tests by using fallback encodings (Wincent Strings Utility, 3f897ce)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/minor_comment_cleanup_wincent.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/fix_pending_tests_by_using_fal.php"
            >&laquo; Fix pending tests by using fallback encodings (Wincent
            Strings Utility, 3f897ce)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/minor_comment_cleanup_wincent.php"
            >Minor comment cleanup (Wincent Strings Utility, 5dd6388) &raquo;</a
          >
        </p>
        ...
        <p>
          Although we don't strictly need to parse the input file passed in
          using the -strings switch (as we're just doing a simple find and
          replace) parse it anyway because in this way we can hopefully get the
          encoding right on files which don't have BOMs.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003336more"><div id="more"></div></div>
