...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add test case for Objective-C 2.0 properties bug
      (WOTest, 3fa7f33)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/use_anonymous_private_categori.php"
            >&laquo; Use anonymous private categories (WOTest, cb0f52f)</a
          >
          |
        ...
        <p>
          In a previous commit (f2d45e3) I noted what appears to be a bug in
          either the Objective-C 2.0 properties implementation (spurious
          compiler warnings) or in its documentation.
        </p>

        <p>
          I've prepared this test case demonstrating the problem. In the course
          of doing so I discovered that the problem has a workaround that is
          considerably easier than I originally thought, and the bug doesn't
          actually make it impossible to use the
          public-readonly/private-readwrite property pattern. I will apply the
          new workaround in a subsequent commit.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002609more"><div id="more"></div></div>
