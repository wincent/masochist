...
<title>Git activity log: Add test case for Objective-C 2.0 properties bug (WOTest, 3fa7f33)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/08/use_anonymous_private_categori.php" title="Use anonymous private categories (WOTest, cb0f52f)" />

<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/08/workaround_objectivec_20_prope.php" title="Workaround Objective-C 2.0 properties bug (WOTest, 2507142)" />
...
<p align="right">
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/08/use_anonymous_private_categori.php">&laquo; Use anonymous private categories (WOTest, cb0f52f)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>
| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/08/workaround_objectivec_20_prope.php">Workaround Objective-C 2.0 properties bug (WOTest, 2507142) &raquo;</a>

</p>

<h2>August 11, 2007</h2>

<h3>Add test case for Objective-C 2.0 properties bug (WOTest, 3fa7f33)</h3>

<p>In a previous commit (f2d45e3) I noted what appears to be a bug in either the Objective-C 2.0 properties implementation (spurious compiler warnings) or in its documentation.</p>

<p>I've prepared this test case demonstrating the problem. In the course of doing so I discovered that the problem has a workaround that is considerably easier than I originally thought, and the bug doesn't actually make it impossible to use the public-readonly/private-readwrite property pattern. I will apply the new workaround in a subsequent commit.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a002609more"><div id="more">
