...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add URL encoding for internal target links (wikitext,
      b29f967)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/factor_conversion_routines_out.php"
      title="Factor conversion routines out into per-character functions (wikitext, c5ca963)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/correct_submodule_usage_in_spe.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/factor_conversion_routines_out.php"
            >&laquo; Factor conversion routines out into per-character functions
            (wikitext, c5ca963)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/correct_submodule_usage_in_spe.php"
            >Correct submodule usage in specs (wikitext, e37df19) &raquo;</a
          >
        </p>
        ...
        <p>
          Add machinery for converting strings into URL-encoded strings suitable
          for use as internal target links. Unreserved characters are passed
          through unchanged and all others are escaped using percent encoding;
          prior to escaping the string is first converted to UTF-8 (so that a
          string containing the euro symbol, for instance, will be encoded as
          &quot;%e2%82%ac&quot;).
        </p>

        <p>
          In order for the new functions to make use of the existing
          text-encoding conversion methods a few minor tweaks had to be made to
          the conversion functions (because in these cases the conversion is
          under controlled conditions the converted width is not important in
          some cases, and in others there is no need to free the target buffer
          in the event of an error because it is not dynamically allocated).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003038more"><div id="more"></div></div>
