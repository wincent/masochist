...
<title>Git activity log: Add URL encoding for internal target links (wikitext, b29f967)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/factor_conversion_routines_out.php" title="Factor conversion routines out into per-character functions (wikitext, c5ca963)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/correct_submodule_usage_in_spe.php" title="Correct submodule usage in specs (wikitext, e37df19)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/factor_conversion_routines_out.php">&laquo; Factor conversion routines out into per-character functions (wikitext, c5ca963)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/correct_submodule_usage_in_spe.php">Correct submodule usage in specs (wikitext, e37df19) &raquo;</a>

</p>

<h2>October 18, 2007</h2>

<h3>Add URL encoding for internal target links (wikitext, b29f967)</h3>

<p>Add machinery for converting strings into URL-encoded strings suitable for use as internal target links. Unreserved characters are passed through unchanged and all others are escaped using percent encoding; prior to escaping the string is first converted to UTF-8 (so that a string containing the euro symbol, for instance, will be encoded as &quot;%e2%82%ac&quot;).</p>

<p>In order for the new functions to make use of the existing text-encoding conversion methods a few minor tweaks had to be made to the conversion functions (because in these cases the conversion is under controlled conditions the converted width is not important in some cases, and in others there is no need to free the target buffer in the event of an error because it is not dynamically allocated).</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003038more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at October 18, 2007  6:06 PM</p>
