...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Make localization work in sessions controller
      (wincent.dev, 56951c3)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_notes_on_utf32_support_wik.php"
            >&laquo; Add notes on UTF-32 support (wikitext, 2929556)</a
          >
          |
        ...
        <h3>
          Make localization work in sessions controller (wincent.dev, 56951c3)
        </h3>

        <p>
          Fix a few typos (&quot;localize&quot; for &quot;localized&quot;) and
          add a &quot;require&quot; to get localization working in the sessions
          controller.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003087more"><div id="more"></div></div>
