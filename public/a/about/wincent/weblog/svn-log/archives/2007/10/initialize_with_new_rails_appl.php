...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Initialize with new Rails application (typechecked.net,
      94617f2)
    </title>
    ...
    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/install_rspec_plugins_wincentc.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/install_rspec_plugins_wincentc.php"
            >Install RSpec plugins (typechecked.net, cd983c8) &raquo;</a
          >
        </p>

        <h2>October 5, 2007</h2>

        <h3>Initialize with new Rails application (typechecked.net, 94617f2)</h3>
