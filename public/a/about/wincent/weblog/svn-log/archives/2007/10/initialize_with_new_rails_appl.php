...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Initialize with new Rails application (wincent.dev,
      94617f2)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/install_rspec_plugins_wincentc.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_note_about_use_of_devrando.php"
            >&laquo; Add note about use of /dev/random (WOCommon, 13b9765)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/install_rspec_plugins_wincentc.php"
            >Install RSpec plugins (wincent.dev, cd983c8) &raquo;</a
          >
        </p>

        <h2>October 5, 2007</h2>

        <h3>Initialize with new Rails application (wincent.dev, 94617f2)</h3>

        <p>
          Starting point is a freshly-created Rails 1.2.4 application, with
          Rails itself frozen into the vendor subdirectory.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003048more"><div id="more"></div></div>
