...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update convenience macros for Leopard (WOCommon,
      75b61e8)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/remove_references_to_wosinglet.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_notes_to_woprocesslauncher.php"
            >&laquo; Add notes to WOProcessLauncher class (WOCommon, 366cbb0)</a
          >
          |
        ...
        <p>
          The semantics of some macros have changed under GC and others are no
          longer required; this commit removes macros and updates others (and
          their documentation comments) where appropriate.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002881more"><div id="more"></div></div>
