...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update to Rails 2.0 preview (1.2.4.7499) (typechecked.net,
      4eddb40)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/fix_capitalization_in_notes_wi.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/fix_capitalization_in_notes_wi.php"
            >&laquo; Fix capitalization in notes (typechecked.net, 705b088)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/switch_to_rspec_trunk_wincentc.php"
            >Switch to RSpec trunk (typechecked.net, b8c4b59) &raquo;</a
          >
        </p>

        <h2>October 11, 2007</h2>

        <h3>Update to Rails 2.0 preview (1.2.4.7499) (typechecked.net, 4eddb40)</h3>
