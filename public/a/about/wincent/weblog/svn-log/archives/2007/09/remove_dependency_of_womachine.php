...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove dependency of WOMachine on WOSingleton (WOCommon,
      2f15f2d)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/revert_remove_methods_which_ar.php"
            >&laquo; Revert &quot;Remove methods which are no-ops under Garbage
            Collection&quot; (WOCommon, 303c463)</a
          >
          |
        ...
        <p>
          Implement a simple (non-abstract) advisory singleton pattern for
          WOMachine.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002717more"><div id="more"></div></div>
