...
<title>Git activity log: Draw top and bottom borders in file source list (gdiff, 094f018)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/fix_drawing_glitches_in_source.php" title="Fix drawing glitches in source list (gdiff, b001fe1)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/make_file_source_list_table_co.php" title="Make file source list table column uneditable (gdiff, d14e56b)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/fix_drawing_glitches_in_source.php">&laquo; Fix drawing glitches in source list (gdiff, b001fe1)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/make_file_source_list_table_co.php">Make file source list table column uneditable (gdiff, d14e56b) &raquo;</a>

</p>

<h2>October  2, 2007</h2>

<h3>Draw top and bottom borders in file source list (gdiff, 094f018)</h3>

<p>This is a preliminary attempt at drawing top and bottom borders in the file source list. Some visual glitches may be visible near the bottom border if the window is rapidly resized; the cause of these will need to be investigated. Also, given that the borders are being drawn just inside the view it is possible that they could overlap content inside the view; it may be necessary to find a way to somehow inset the content or instead perform the drawing elsewhere (the split view itself may be a good candidate for this as it would localize all top and bottom border drawing to a single place in the code).</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003011more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at October  2, 2007  1:17 PM</p>
