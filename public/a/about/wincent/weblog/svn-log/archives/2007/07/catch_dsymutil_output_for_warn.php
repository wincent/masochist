...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Catch dsymutil output for warnings (buildtools, 40aa1c6)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/modify_if_statements_in_script.php"
      title="Modify &amp;quot;if&amp;quot; statements in scripts for correctness and brevity (buildtools, add47f3)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/add_readme_for_antlr_branch_wa.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/modify_if_statements_in_script.php"
            >&laquo; Modify &quot;if&quot; statements in scripts for correctness
            and brevity (buildtools, add47f3)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/add_readme_for_antlr_branch_wa.php"
            >Add README for ANTLR branch (Walrus, b8aa77d) &raquo;</a
          >
        </p>
        ...
        <p>
          Use the regular expression matcher built in to Bash 3.0 and up to
          check the dsymutil output for warnings. If warnings are present then
          alert the user of the need to do a Clean before attempting a Release
          Build; the most likely cause is that the binary has already been
          stripped and running dsymutil on it again will produce a useless dSYM
          bundle.
        </p>

        <p>
          This approach is better than letter the dsymutil-generated warnings go
          through to the user because it makes explicit the likely cause as well
          as the required solution.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002494more"><div id="more"></div></div>
