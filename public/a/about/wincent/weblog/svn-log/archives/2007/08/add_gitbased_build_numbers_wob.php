...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add Git-based build numbers (WOBezel, a25ca59)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/initial_version_of_git_build_n.php"
            >&laquo; Initial version of Git build number scripts (buildtools,
            bd6ad3d)</a
          >
          |
        ...
        <p>
          Use the new UpdateGitRevisionsNumbers.rb script in the Wincent Build
          Tools to automatically update the build number as part of each build
          when required.
        </p>

        <p>
          This commit also modifies the .gitignore file so as to ignore the
          temporary file produced as part of the process.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002624more"><div id="more"></div></div>
