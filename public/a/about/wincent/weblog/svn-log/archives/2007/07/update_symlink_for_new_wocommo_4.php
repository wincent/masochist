...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update symlink for new WOCommon location (WOBezel,
      befefb5)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/update_symlink_for_new_wocommo_3.php"
      title="Update symlink for new WOCommon location (Synergy Advance, c728d13)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/update_symlink_for_new_wocommo_5.php"
      title="Update symlink for new WOCommon location (WODebug, 5dcece2)"
    />
  </head>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/update_symlink_for_new_wocommo_3.php"
            >&laquo; Update symlink for new WOCommon location (Synergy Advance,
            c728d13)</a
          >
          |
        ...
        <p>
          Back in the days of Subversion externals each project that used code
          from WOCommon had a local copy of WOCommon incoporated by reference
          using the svn:externals mechanism.
        </p>

        <p>
          When I moved to SVK (which doesn't support Subversion externals) I was
          forced to look for an alternative and opted to check out a copy of
          WOCommon adjacent to the incorporating project's checkout (SVK does
          not allow nested checkouts) and add a symbolic link inside the project
          tree so that relative imports and the like would continue to work
          seamlessly.
        </p>

        <p>
          Upon switching to git these checkouts were no longer quite as
          &quot;lightweight&quot; as before because every single checkout is
          actually a clone of the entire repository and all its history. It
          would be possibly to do a &quot;shallow&quot; clone but that would
          introduce the possibility for inconsistency due to human error.
        </p>

        <p>
          So I've decided to slightly modify the symlink structure so that all
          projects which use WOCommon will share the same checked out copy. We
          lose some redundancy but gain more robustness in the process (less
          scope for forgetting to pull updates, less chance of accidentally
          editing the wrong file if Xcode decides to open up the wrong copy of a
          common file etc).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002474more"><div id="more"></div></div>
