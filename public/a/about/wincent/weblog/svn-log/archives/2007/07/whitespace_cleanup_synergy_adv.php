...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Whitespace cleanup (Synergy Advance, 8d99c8a)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/remove_subversionspecific_keyw.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/add_check_cr_function_to_bash.php"
            >&laquo; Add check_cr function to Bash profile (snippets,
            33ddcb7)</a
          >
          |
        ...
        <p>
          Another extensive whitespace cleanup of the entire tree; although not
          as many changes as in the WOCommon cleanup there are still over 12,000
          lines in the diff. Cleanup consisted of: space-to-tab conversion for
          consistency where needed (in property lists); tab-to-space conversion
          for consistency where needed (source code etc); and removal of
          trailing whitespace.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002449more"><div id="more"></div></div>
