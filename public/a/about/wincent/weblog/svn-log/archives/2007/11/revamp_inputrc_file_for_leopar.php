...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Revamp inputrc file for Leopard (snippets, 3049268)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/add_notes_on_third_machine_see.php"
      title="Add notes on third machine seed algorithm (WOCommon, 6d88aaf)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/add_toplevel_gitignore_file_sy.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/add_notes_on_third_machine_see.php"
            >&laquo; Add notes on third machine seed algorithm (WOCommon,
            6d88aaf)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/11/add_toplevel_gitignore_file_sy.php"
            >Add top-level gitignore file (Synergy, e060cb4) &raquo;</a
          >
        </p>
        ...
        <p>
          It appears that Apple has commandeered the up and down cursor keys in
          the new version of the Terminal in Leopard, breaking my old bindings
          for history-search-backward and history-search-forward. Or maybe its
          just the new version of Bash that ships with Leopard.
        </p>

        <p>
          Whatever the cause, this commit re-instates the old desired behaviour,
          as well as setting up key combinations for word-based movement and
