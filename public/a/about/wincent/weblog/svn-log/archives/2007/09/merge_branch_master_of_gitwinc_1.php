...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      ...
      git.wincent.dev:[filtered]/Synergy (Synergy, 7bc11aa)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/additional_leopardrelated_proj.php"
            >&laquo; Additional Leopard-related project changes (Synergy,
            f2d4f39)</a
          >
          |
        ...
        <h3>
          Merge branch 'master' of git.wincent.dev:[filtered]/Synergy (Synergy,
          7bc11aa)
        </h3>

        <p>&lt;unknown&gt;</p>

        <div id="a002707more"><div id="more"></div></div>
