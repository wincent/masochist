...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Install RSpec plugins (typechecked.net, cd983c8)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/initialize_with_new_rails_appl.php"
            >&laquo; Initialize with new Rails application (typechecked.net,
            94617f2)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/install_fixturereplacement_plu.php"
            >Install FixtureReplacement plug-in (typechecked.net, 07fe43b)
            &raquo;</a
          >
        </p>
        ...
        <h3>Install RSpec plugins (typechecked.net, cd983c8)</h3>
