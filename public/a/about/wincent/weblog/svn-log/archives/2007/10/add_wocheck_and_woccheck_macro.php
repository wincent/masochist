...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add WOCheck and WOCCheck macros (WOPublic, e9bfc2b)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/define_macro_for_devnull_gdiff.php"
      title="Define macro for &amp;quot;/dev/null&amp;quot; (gdiff, 799c018)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_note_about_use_of_devrando.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/define_macro_for_devnull_gdiff.php"
            >&laquo; Define macro for &quot;/dev/null&quot; (gdiff, 799c018)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_note_about_use_of_devrando.php"
            >Add note about use of /dev/random (WOCommon, 13b9765) &raquo;</a
          >
        </p>
        ...
        <p>
          WOCheck is to NSAssert as WOParameterCheck is to NSParameterAssert,
          and WOCCheck is to NSCAssert as WOCParameterCheck is to
          NSCParameterAssert. In other words, these are like assertion macros
          but they are compiled in to both Release and Debug builds. You use
          them where throwing an exception is not merely helpful to your testing
