...
<title>Git activity log: Add WOCheck and WOCCheck macros (WOPublic, e9bfc2b)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/define_macro_for_devnull_gdiff.php" title="Define macro for &amp;quot;/dev/null&amp;quot; (gdiff, 799c018)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/add_note_about_use_of_devrando.php" title="Add note about use of /dev/random (WOCommon, 13b9765)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/define_macro_for_devnull_gdiff.php">&laquo; Define macro for &quot;/dev/null&quot; (gdiff, 799c018)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/add_note_about_use_of_devrando.php">Add note about use of /dev/random (WOCommon, 13b9765) &raquo;</a>

</p>

<h2>October  2, 2007</h2>

<h3>Add WOCheck and WOCCheck macros (WOPublic, e9bfc2b)</h3>

<p>WOCheck is to NSAssert as WOParameterCheck is to NSParameterAssert, and WOCCheck is to NSCAssert as WOCParameterCheck is to NSCParameterAssert. In other words, these are like assertion macros but they are compiled in to both Release and Debug builds. You use them where throwing an exception is not merely helpful to your testing process but is actually necessary to uphold your API contract.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a002919more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at October  2, 2007  6:35 PM</p>
