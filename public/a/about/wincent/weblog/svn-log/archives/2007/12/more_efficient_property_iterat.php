...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: More efficient property iteration (login-tool, 436ebe2)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/teach_logintool_to_list_info_a.php"
      title="Teach login-tool to list info about configured login items (login-tool, c5f3beb)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/refactoring_for_further_script.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/teach_logintool_to_list_info_a.php"
            >&laquo; Teach login-tool to list info about configured login items
            (login-tool, c5f3beb)</a
          >
          |
        ...
        <p>
          ...
          property requiring an Apple Event round-trip) use the
          &quot;properties&quot; method in conjunction with the
          arrayByApplyingSelector: method to slurp down all the properties in a
          single transaction.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003216more"><div id="more"></div></div>
