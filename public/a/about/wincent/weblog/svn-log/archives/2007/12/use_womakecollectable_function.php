...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Use WOMakeCollectable function where appropriate
      (WOCommon, 6eb9559)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/add_womakecollectable_function.php"
      title="Add WOMakeCollectable function (WOPublic, 1035d53)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/update_internal_list_when_logi.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/add_womakecollectable_function.php"
            >&laquo; Add WOMakeCollectable function (WOPublic, 1035d53)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/update_internal_list_when_logi.php"
            >Update internal list when login items are added or removed
            (WOCommon, ff094c5) &raquo;</a
          >
        </p>
        ...
        <p>
          There are a couple of places where the Apple docs don't mention the
          possibility of returning a NULL ref and where the code doesn't bother
          to check for such a ref. To be on the safe side, use WOMakeCollectable
          here rather than CFMakeCollectable.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003261more"><div id="more"></div></div>
