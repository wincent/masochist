...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Objective-C 2.0 modernization (WOBezel, e67aedb)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/core_animation_notes_wobezel_a.php"
      title="Core Animation notes (WOBezel, ae375d1)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/add_missing_call_to_finalize_w.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/core_animation_notes_wobezel_a.php"
            >&laquo; Core Animation notes (WOBezel, ae375d1)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/add_missing_call_to_finalize_w.php"
            >Add missing call to finalize (WOTest, 94a6adf) &raquo;</a
          >
        </p>

        <h2>August 11, 2007</h2>

        <h3>Objective-C 2.0 modernization (WOBezel, e67aedb)</h3>

        <p>
          This commit makes a large number of changes across the codebase to
          take advantage of new features in Objective-C 2.0 and garbage
          collection: non-retained references converted to weak references; most
          accessors replaced with properties and synthesized accessors; dealloc
          methods replaced with finalize methods where appropriate and removed
          entirely when possible; use of anonymous categories for private
          methods (allows for better compile-time checking); some formatting
          changes for better readability where said changes coincide with code
          which already needed to be modified as part of the Objective-C 2.0
          modernization; minor refactoring of some accessor method names as part
          of the transition to properties (for example,
          &quot;setIsResizable&quot; and &quot;setIsCloseable&quot; were renamed
          to &quot;setResizable&quot; and &quot;setCloseable&quot; respectively,
          while the corresponding getters continue as &quot;isResizable&quot;
          and &quot;isCloseable&quot;); removal of some methods which should now
          never be called (retain, release and so on); conversion of some
          old-style Doxygen comments to new-style ones, in sections where code
          was being modified anyway as part of the transition.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002617more"><div id="more"></div></div>

        <p class="posted">Posted by wincent at August 11, 2007 6:00 PM</p>
      </div>
    </div>
