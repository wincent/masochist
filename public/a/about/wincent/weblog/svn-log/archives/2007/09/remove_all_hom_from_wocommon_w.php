...
<title>Git activity log: Remove all HOM from WOCommon (WOCommon, ab9f927)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/update_xcode_project_for_lates.php" title="Update Xcode project for latest version of Xcode (WOCommon, 9b40995)" />

<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/dump_pathforfolderdomain_test.php" title="Dump pathForFolder:domain: test (WOCommon, 06a34ee)" />
...
<p align="right">
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/update_xcode_project_for_lates.php">&laquo; Update Xcode project for latest version of Xcode (WOCommon, 9b40995)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>
| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/dump_pathforfolderdomain_test.php">Dump pathForFolder:domain: test (WOCommon, 06a34ee) &raquo;</a>

</p>

<h2>September 16, 2007</h2>

<h3>Remove all HOM from WOCommon (WOCommon, ab9f927)</h3>

<p>The latest preview seed of Leopard mysteriously breaks much of the HOM code that worked on Tiger and on previous Leopard seeds. Rather than trying to graft an idea that's seen in Ruby, Smalltalk, Haskell and such onto Objective-C, simply go with the flow and accept that the extremely low-level runtime wrangling that is necessary to get this working amounts to chasing a moving target; it's just too brittle to justify the time investment in this, especially when it is effectively swimming against the current, trying to get Objective-C to do something it wasn't designed to do, and generating unorthodox code that will be hard for other Objective-C programmers to digest.</p>

<p>So this commit either modifies or outright removes about 90 files from the source tree; somewhat painful to throw away so much work, but it seems the pragmatic thing to do.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a002711more"><div id="more">
