...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update project settings for Leopard (Synergy, da40c00)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/set_up_ignores_for_xcode_proje_9.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/set_up_ignores_for_xcode_proje_9.php"
            >&laquo; Set up ignores for Xcode project bundle (Synergy,
            0f03841)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/fix_deprecation_warnings_syner_1.php"
            >Fix deprecation warnings (Synergy, 3fc1880) &raquo;</a
          >
        </p>
        ...
        <p>
          This commit makes a number of changes to the project bundle to bring
          it in line with conventions already in use for other projects
          targetting Xcode 3.0 and Leopard.
        </p>

        <p>
          This includes use of the 10.5 SDK, the removal of legacy build
          settings, use of GCC 4.0 across the board, and the renaming of the
          Development/Deployment build configurations to Debug/Release.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003130more"><div id="more"></div></div>
