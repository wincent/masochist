...
<title>Git activity log: Myriad changes for GC (WOCommon, 38e4bea)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/add_new_login_api_files_to_pro.php" title="Add new login API files to project (WOCommon, 9e5d357)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/switch_to_new_launch_services.php" title="Switch to new Launch Services code in WOCommon (login-tool, f0a9c33)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/add_new_login_api_files_to_pro.php">&laquo; Add new login API files to project (WOCommon, 9e5d357)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/switch_to_new_launch_services.php">Switch to new Launch Services code in WOCommon (login-tool, f0a9c33) &raquo;</a>

</p>

<h2>December  9, 2007</h2>

<h3>Myriad changes for GC (WOCommon, 38e4bea)</h3>

<p>Although this is by no means complete, this commit makes myriad changes to many classes and categories for Garbage Collection. Autorelease pool release calls have been replaced with drain calls, no-op retains, releases and autoreleases have been removed, simpler initialization idioms have been used in many places, some variables have been renamed for clarity (where previously a temporary mutable object was created and then an immutable copy returned we now just return the mutable one), and convenience creation methods have been deprecated in favor of a simpler copy idiom.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003245more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at December  9, 2007  7:10 PM</p>
