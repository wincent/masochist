...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: GC changes to NSAttributedString creation category
      (WOCommon, 84bcfe4)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/use_doxygen_deprecated_directi.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/complete_gc_conversion_of_nsar.php"
            >&laquo; Complete GC conversion of NSArrayController drag category
            (WOCommon, cc93f2a)</a
          >
          |
        ...
        <p>
          Under GC the attributedString method is effectively equivalent to
          sending a copy message, so mark the method as deprecated and advise
          callers to use copy instead.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003237more"><div id="more"></div></div>
