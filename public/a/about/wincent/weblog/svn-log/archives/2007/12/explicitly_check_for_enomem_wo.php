...
<title>Git activity log: Explicitly check for ENOMEM (WOPublic, ab2ed1a)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/modernize_nstimer_pausing_cate.php" title="Modernize NSTimer pausing category (Synergy, cd5a4ed)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/use_wmalloc_in_wologinitem_cla.php" title="Use wmalloc in WOLoginItem class (WOCommon, 1d38ca6)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/modernize_nstimer_pausing_cate.php">&laquo; Modernize NSTimer pausing category (Synergy, cd5a4ed)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/use_wmalloc_in_wologinitem_cla.php">Use wmalloc in WOLoginItem class (WOCommon, 1d38ca6) &raquo;</a>

</p>

<h2>December 15, 2007</h2>

<h3>Explicitly check for ENOMEM (WOPublic, ab2ed1a)</h3>

<p>POSIX allows the size argument to malloc to be 0 (in which case either a NULL pointer or a pointer to something that can safely be passed to free is returned). So in order to test for a failed allocation must explicitly check for ENOMEM.</p>

<p>Of course, I personally think that it would almost always be an error to ask malloc for zero bytes, but in that case the mistake will eventually be caught anyway, when the caller tries to write to the returned pointer.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003271more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at December 15, 2007 12:53 PM</p>
