...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Explicitly check for ENOMEM (WOPublic, ab2ed1a)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/modernize_nstimer_pausing_cate.php"
      title="Modernize NSTimer pausing category (Synergy, cd5a4ed)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/use_wmalloc_in_wologinitem_cla.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/modernize_nstimer_pausing_cate.php"
            >&laquo; Modernize NSTimer pausing category (Synergy, cd5a4ed)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/use_wmalloc_in_wologinitem_cla.php"
            >Use wmalloc in WOLoginItem class (WOCommon, 1d38ca6) &raquo;</a
          >
        </p>
        ...
        <p>
          POSIX allows the size argument to malloc to be 0 (in which case either
          a NULL pointer or a pointer to something that can safely be passed to
          free is returned). So in order to test for a failed allocation must
          explicitly check for ENOMEM.
        </p>

        <p>
          Of course, I personally think that it would almost always be an error
          to ask malloc for zero bytes, but in that case the mistake will
          eventually be caught anyway, when the caller tries to write to the
          returned pointer.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003271more"><div id="more"></div></div>
