...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Prepare spec helper (typechecked.net, edf298e)</title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/add_custom_db_rake_tasks_wince.php"
            >&laquo; Add custom db rake tasks (typechecked.net, 62dd8af)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/spec_server_update_wincentcom.php"
            >spec_server update (typechecked.net, f7ea090) &raquo;</a
          >
        </p>

        <h2>October 15, 2007</h2>

        <h3>Prepare spec helper (typechecked.net, edf298e)</h3>
