...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Prepare spec helper (wincent.dev, edf298e)</title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_custom_db_rake_tasks_wince.php"
            >&laquo; Add custom db rake tasks (wincent.dev, 62dd8af)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/spec_server_update_wincentcom.php"
            >spec_server update (wincent.dev, f7ea090) &raquo;</a
          >
        </p>

        <h2>October 15, 2007</h2>

        <h3>Prepare spec helper (wincent.dev, edf298e)</h3>

        <p>
          Include FixtureReplacement from within the spec helper, add a custom
          matcher class for conveniently verifying validations, and remove
          excess comments.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003064more"><div id="more"></div></div>
