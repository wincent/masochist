...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Speed-up FixtureReplacement (typechecked.net, 6c036a7)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/teach_fixturereplacement_to_av.php"
      title="Teach FixtureReplacement to avoid mass assignment (typechecked.net, 80cf713)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/add_custom_db_rake_tasks_wince.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/add_custom_db_rake_tasks_wince.php"
            >Add custom db rake tasks (typechecked.net, 62dd8af) &raquo;</a
          >
        </p>

        <h2>October 14, 2007</h2>

        <h3>Speed-up FixtureReplacement (typechecked.net, 6c036a7)</h3>
