...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Speed-up FixtureReplacement (wincent.dev, 6c036a7)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/teach_fixturereplacement_to_av.php"
      title="Teach FixtureReplacement to avoid mass assignment (wincent.dev, 80cf713)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_custom_db_rake_tasks_wince.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/teach_fixturereplacement_to_av.php"
            >&laquo; Teach FixtureReplacement to avoid mass assignment
            (wincent.dev, 80cf713)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_custom_db_rake_tasks_wince.php"
            >Add custom db rake tasks (wincent.dev, 62dd8af) &raquo;</a
          >
        </p>

        <h2>October 14, 2007</h2>

        <h3>Speed-up FixtureReplacement (wincent.dev, 6c036a7)</h3>

        <p>
          Call send() directly rather than update_attribute(), thus avoiding a
          potentially expensive save() operation on each attribute.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003062more"><div id="more"></div></div>
