...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Exit with status 0 on success (Wincent Icon Utility,
      4d637be)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/use_wincent_icon_utility_for_s.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/include_filefolder_name_in_err.php"
            >&laquo; Include file/folder name in error messages (Wincent Icon
            Utility, 6b89434)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/use_wincent_icon_utility_for_s.php"
            >Use Wincent Icon Utility for setting custom folder icons
            (buildtools, 9abc011) &raquo;</a
          >
        </p>
        ...
        <p>
          If the icon is successfully applied to the target folder exit with a 0
          exit code to indicate success.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002546more"><div id="more"></div></div>
