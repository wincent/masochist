...
<title>Git activity log: Refactoring and new functions (Wincent Strings Utility, 127e31d)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/whitespace_fixes_wincent_strin.php" title="Whitespace fixes (Wincent Strings Utility, e9cff5a)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/hook_up_new_combine_and_extrac.php" title="Hook up new combine() and extract() functions (Wincent Strings Utility, 97d6426)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/whitespace_fixes_wincent_strin.php">&laquo; Whitespace fixes (Wincent Strings Utility, e9cff5a)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/hook_up_new_combine_and_extrac.php">Hook up new combine() and extract() functions (Wincent Strings Utility, 97d6426) &raquo;</a>

</p>

<h2>December 21, 2007</h2>

<h3>Refactoring and new functions (Wincent Strings Utility, 127e31d)</h3>

<p>This is part of a major clean-up to make way for some new functionality. The NSScanner category has been split off into a separate file, and a simple wrapper class has been added so as to eliminate the error-prone and tedious use of an NSDictionary to model an &quot;entry&quot;.</p>

<p>In many places the code has been touched up for better readability.</p>

<p>The functions for handling the new options are in place but not hooked up yet.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003320more"><div id="more">
