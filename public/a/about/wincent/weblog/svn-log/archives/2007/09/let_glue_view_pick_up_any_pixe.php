...
<title>Git activity log: Let glue view pick up any pixel slack (gdiff, 50b3dbc)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/remove_noop_nsview_overrides_g.php" title="Remove no-op NSView overrides (gdiff, dc7f887)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/add_second_of_two_scroll_views.php" title="Add second of two scroll views (gdiff, 429df2e)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/remove_noop_nsview_overrides_g.php">&laquo; Remove no-op NSView overrides (gdiff, dc7f887)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/add_second_of_two_scroll_views.php">Add second of two scroll views (gdiff, 429df2e) &raquo;</a>

</p>

<h2>September 28, 2007</h2>

<h3>Let glue view pick up any pixel slack (gdiff, 50b3dbc)</h3>

<p>Previously we used the right view to pick up the one-pixel slack caused by dividing the window in two when there were on odd number of pixels available. This was slightly ugly because it introduced an arbitrary difference between the left and right views and therefore incurred a slight maintenance penalty.</p>

<p>Now we use the glue view for picking up that slack when necessary. Seeing as there is only one glue view, it is in the center of the window, and its purpose is to draw curves rather than proportional characters it is the ideal candidate for this role.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a002986more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at September 28, 2007 12:59 PM</p>
