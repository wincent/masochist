...
<title>Git activity log: check_cr(): accept filenames with spaces in them (snippets, 710f111)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/turn_off_zero_link_buildtools.php" title="Turn off Zero Link (buildtools, 36e3c46)" />

<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/add_filtering_to_git_postrecei.php" title="Add filtering to Git post-receive hook (snippets, 5df28ff)" />
...
<p align="right">
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/turn_off_zero_link_buildtools.php">&laquo; Turn off Zero Link (buildtools, 36e3c46)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>
| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/add_filtering_to_git_postrecei.php">Add filtering to Git post-receive hook (snippets, 5df28ff) &raquo;</a>

</p>

<h2>July 26, 2007</h2>

<h3>check_cr(): accept filenames with spaces in them (snippets, 710f111)</h3>

<p>The check_cr() function was misbehaving when the input files contained spaces in their names. This commit spawns a subshell so as to conveniently do a temporary override of the IFS (Internal Field Separator).</p>

<p>Now the check_cr() function will accept filenames with spaces (or even tabs) in their names. It will not handle filenames with linefeeds in them, but this should not be a very common case.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a002534more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at July 26, 2007 11:22 AM</p>
