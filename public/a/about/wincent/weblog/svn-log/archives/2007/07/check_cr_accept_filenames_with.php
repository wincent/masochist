...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: check_cr(): accept filenames with spaces in them
      (snippets, 710f111)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/add_filtering_to_git_postrecei.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/turn_off_zero_link_buildtools.php"
            >&laquo; Turn off Zero Link (buildtools, 36e3c46)</a
          >
          |
        ...
        <p>
          The check_cr() function was misbehaving when the input files contained
          spaces in their names. This commit spawns a subshell so as to
          conveniently do a temporary override of the IFS (Internal Field
          Separator).
        </p>

        <p>
          Now the check_cr() function will accept filenames with spaces (or even
          tabs) in their names. It will not handle filenames with linefeeds in
          them, but this should not be a very common case.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002534more"><div id="more"></div></div>
