...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add new build of login-tool (Synergy, a2cc769)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/add_alternate_methods_for_addi.php"
      title="Add alternate methods for adding login items (login-tool, 62e266f)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/switch_to_buildtoolsbased_conf.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/add_alternate_methods_for_addi.php"
            >&laquo; Add alternate methods for adding login items (login-tool,
            62e266f)</a
          >
          |
        ...
        <p>
          This is a Universal Binary and rewrite in Objective-C 2.0 (using GC)
          and the scripting bridge. This should hopefully fix the &quot;not
          starting at login&quot; issues, although there are known problems with
          Apple's implementation of login items under Leopard.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003249more"><div id="more"></div></div>
