...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove files from previous RSpec version (typechecked.net,
      71d1c5b)
    </title>
    ...
    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/11/update_fixturereplacement_winc.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/11/update_fixturereplacement_winc.php"
            >Update FixtureReplacement (typechecked.net, 563b8ab) &raquo;</a
          >
        </p>

        <h2>November 16, 2007</h2>

        <h3>Remove files from previous RSpec version (typechecked.net, 71d1c5b)</h3>
