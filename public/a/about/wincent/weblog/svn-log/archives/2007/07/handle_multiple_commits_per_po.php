...
<title>Git activity log: Handle multiple commits per post-receive invocation (snippets, 9dd5748)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/command_refactoring_for_better.php" title="Command refactoring for better error detection (snippets, 098ddbc)" />

<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/add_list_method_to_commitlist.php" title="Add list method to CommitList (snippets, cda2ffe)" />
...
<body>
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../../../../../../">About</a>&nbsp;&gt;&nbsp;<a href="../../../../../">Wincent</a>&nbsp;&gt;&nbsp;<a href="../../../../">Weblog</a>&nbsp;&gt;&nbsp;<a href="../../../">Git log</a>&nbsp;&gt;&nbsp;<a href="../../">Archives</a>&nbsp;&gt;&nbsp;<a href="../">2007</a>&nbsp;&gt;&nbsp;07    </p>
  </div>
...
<p align="right">
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/command_refactoring_for_better.php">&laquo; Command refactoring for better error detection (snippets, 098ddbc)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>
| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/add_list_method_to_commitlist.php">Add list method to CommitList (snippets, cda2ffe) &raquo;</a>

</p>

<h2>July 18, 2007</h2>

<h3>Handle multiple commits per post-receive invocation (snippets, 9dd5748)</h3>

<p>Handle a wider range of possible post-receive inputs:</p>

<p>Firstly, we now have different handling for creation and update events.</p>

<p>Secondly, both kinds of events may actually reflect multiple commits for a<br />
single push. So we try to get a revision list based on the &quot;new&quot; and the &quot;old&quot;<br />
revisions, taking into account that they may not actually be on the same<br />
branch (so we use &quot;git merge-base&quot; to determine a likely common ancestor) and<br />
trying to avoid generating posts for commits which have already generated<br />
posts in the past (we do this by excluding all refs apart from the current<br />
one; any commits reachable from those other refs have presumably been reported<br />
previously).</p>

<p>There is still a tiny possibly race window in which another user could update<br />
the list of refs after we get the refs list but before we use it to perform<br />
the exclusion, and this could cause reports for some commits to be incorrectly<br />
skipped. As noted in the notes of the post-receive-email sample script that<br />
comes with Git, this race would be quite difficult to avoid, but luckily it is<br />
not very likely (especially in my set-up where I am basically the only<br />
committer).</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt;<br />
</p>

<div id="a002416more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at July 18, 2007  8:26 PM</p>
...
<div id="footer">
  ...
  <p>Page last updated 00:30:38, 19 February 2010.</p>
  <p>
