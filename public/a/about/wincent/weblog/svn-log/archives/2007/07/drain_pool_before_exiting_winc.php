...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Drain pool before exiting (Wincent Strings Utility,
      7001916)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/silence_gcc_unused_variable_wa.php"
      title="Silence GCC unused variable warning (Wincent Strings Utility, e741402)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/initial_commit_wincent_icon_ut.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/silence_gcc_unused_variable_wa.php"
            >&laquo; Silence GCC unused variable warning (Wincent Strings
            Utility, e741402)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/initial_commit_wincent_icon_ut.php"
            >Initial commit (Wincent Icon Utility, 89139c0) &raquo;</a
          >
        </p>
        ...
        <p>
          Rather than just letting the autorelease pool leak at the end of
          execution do the right thing and drain it first. There's no real need
          for it in this case but it's a general good practice so I should get
          into the habit of doing it.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002540more"><div id="more"></div></div>
