...
<title>Git activity log: Update symlink for new WOCommon location (Synergy, ec6cb54)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/update_symlink_for_new_wocommo_7.php" title="Update symlink for new WOCommon location (Synergy, ec6cb54)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/update_symlink_for_new_wocommo_3.php" title="Update symlink for new WOCommon location (Synergy Advance, c728d13)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/update_symlink_for_new_wocommo_7.php">&laquo; Update symlink for new WOCommon location (Synergy, ec6cb54)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/update_symlink_for_new_wocommo_3.php">Update symlink for new WOCommon location (Synergy Advance, c728d13) &raquo;</a>

</p>

<h2>July 23, 2007</h2>

<h3>Update symlink for new WOCommon location (Synergy, ec6cb54)</h3>

<p>Back in the days of Subversion externals each project that used code from WOCommon had a local copy of WOCommon incoporated by reference using the svn:externals mechanism.</p>

<p>When I moved to SVK (which doesn't support Subversion externals) I was forced to look for an alternative and opted to check out a copy of WOCommon adjacent to the incorporating project's checkout (SVK does not allow nested checkouts) and add a symbolic link inside the project tree so that relative imports and the like would continue to work seamlessly.</p>

<p>Upon switching to git these checkouts were no longer quite as &quot;lightweight&quot; as before because every single checkout is actually a clone of the entire repository and all its history. It would be possibly to do a &quot;shallow&quot; clone but that would introduce the possibility for inconsistency due to human error.</p>

<p>So I've decided to slightly modify the symlink structure so that all projects which use WOCommon will share the same checked out copy. We lose some redundancy but gain more robustness in the process (less scope for forgetting to pull updates, less chance of accidentally editing the wrong file if Xcode decides to open up the wrong copy of a common file etc).</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a002472more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at July 23, 2007  1:17 PM</p>
...
<div id="footer">
  ...
  <p>Page last updated 00:30:37, 19 February 2010.</p>
  <p>
