...
<title>Git activity log: Reference top-level nib objects for GC and clean localizations (Synergy, 28983e7)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/reference_toplevel_nib_objects.php" title="Reference top-level nib objects for GC and clean localizations (Synergy, 28983e7)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/rename_englishlproj_to_enlproj_1.php" title="Rename English.lproj to en.lproj (Synergy, 636b746)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/reference_toplevel_nib_objects.php">&laquo; Reference top-level nib objects for GC and clean localizations (Synergy, 28983e7)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/rename_englishlproj_to_enlproj_1.php">Rename English.lproj to en.lproj (Synergy, 636b746) &raquo;</a>

</p>

<h2>December 20, 2007</h2>

<h3>Reference top-level nib objects for GC and clean localizations (Synergy, 28983e7)</h3>

<p>Add top-level strong references to a couple more nibs to ensure that objects don't get inopportunely garbage-collected.</p>

<p>I would have liked to propagate this same change to the other nibs using ibtool but unfortunately there are quite a few errors (class mismatches) reported that prevent this from proceeding; so somewhere in the long history of these nibs they have gotten far enough out of sync with the authoritative English versions to make them unusable with ibtool.</p>

<p>So, for now I am temporarily removing the unsynchronizable nibs entirely; I will have to create new nibs (copies of the English nibs) and copy the strings across by hand from the older localizations that I have on file. This will be a lengthy and painful job, so it might be sometime before it gets completed.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003409more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at December 20, 2007  8:20 PM</p>
