...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Revert &quot;Remove methods which are no-ops under
      Garbage Collection&quot; (WOCommon, 303c463)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/remove_dependency_of_womachine.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/fix_indentation_in_wosingleton.php"
            >&laquo; Fix indentation in WOSingleton.m (WOCommon, a66b2bc)</a
          >
          |
        ...
        <h3>
          Revert &quot;Remove methods which are no-ops under Garbage
          Collection&quot; (WOCommon, 303c463)
        </h3>

        <p>
          This reverts commit ca1fae39ce738fc41d3da3d7c3749b2e3f77fe29. It turns
          out that evidently the runtime still does send those messages at times
          even though they are meaningless under Garbage Collection, thus
          causing some unit tests to fail. This reversion allows the
          singleton-related unit tests to pass again.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002716more"><div id="more"></div></div>
