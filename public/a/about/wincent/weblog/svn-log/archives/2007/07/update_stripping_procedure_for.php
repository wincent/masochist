...
<title>Git activity log: Update stripping procedure for Leopard (buildtools, 7ca1010)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/set_executable_bits_on_all_exe.php" title="Set executable bits on all executables (buildtools, b2ba583)" />

<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/remove_old_stripping_script_bu.php" title="Remove old stripping script (buildtools, 9dbc47e)" />
...
<p align="right">
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/set_executable_bits_on_all_exe.php">&laquo; Set executable bits on all executables (buildtools, b2ba583)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>
| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/remove_old_stripping_script_bu.php">Remove old stripping script (buildtools, 9dbc47e) &raquo;</a>

</p>

<h2>July 25, 2007</h2>

<h3>Update stripping procedure for Leopard (buildtools, 7ca1010)</h3>

<p>A number of changes have taken place in Leopard which allow the simplification of the stripping procedure.</p>

<p>Firstly, the atos tool is now capable of working with Universal Binaries (in fact this capability was added prior to Leopard) and so it is no longer necessary to keep unstripped thin binaries for debugging purposes.</p>

<p>Secondly, the arch names (as reported by lipo) are no longer necessarily &quot;ppc&quot; and &quot;i386&quot; like they were in Tiger. For example, on my test machine they are &quot;ppc7400&quot; and &quot;i386&quot;. The ARCHS environment variable still only contains &quot;ppc&quot; and &quot;i386&quot;, however, and this mismatch causes lipo to complain.</p>

<p>My initial solution was to iterate through VALID_ARCHS trying them out one by one and building up a list of actually-present architectures, but in the end the simplest solution was to forget about using lipo to split things into thin binaries and just work with Universal binaries at every step; this is possible because it seems that the entire tool chain (atos, strip, GDB with dSYM etc) is now capable of working with Universal Binaries.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a002491more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at July 25, 2007  9:37 AM</p>
