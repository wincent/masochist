...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix syntax error in NSFileManager category (WOCommon,
      bda13fc)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/throw_away_wobundle_and_wobase.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/swap_in_nsmakecollectable_for.php"
            >&laquo; Swap in NSMakeCollectable for WOMakeCollectable (WOCommon,
            55f3d33)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/throw_away_wobundle_and_wobase.php"
            >Throw away WOBundle and WOBaseCore (WOCommon, cbbe594) &raquo;</a
          >
        </p>
        ...
        <p>
          This category hasn't actually been used for some time and so a syntax
          error had crept in.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003456more"><div id="more"></div></div>
