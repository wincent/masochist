...
<title>Git activity log: Make duplicate keys a warning rather than an error (Wincent Strings Utility, 434fa5c)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/hook_up_new_combine_and_extrac.php" title="Hook up new combine() and extract() functions (Wincent Strings Utility, 97d6426)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/update_man_page_for_new_featur.php" title="Update man page for new features (Wincent Strings Utility, cf83d69)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/hook_up_new_combine_and_extrac.php">&laquo; Hook up new combine() and extract() functions (Wincent Strings Utility, 97d6426)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/update_man_page_for_new_featur.php">Update man page for new features (Wincent Strings Utility, cf83d69) &raquo;</a>

</p>

<h2>December 21, 2007</h2>

<h3>Make duplicate keys a warning rather than an error (Wincent Strings Utility, 434fa5c)</h3>

<p>Instead of disallowing duplicate keys during a combine operation, issue a warning and allow the &quot;target&quot; version to take precedence.</p>

<p>This facilitates a common workflow wherein a localization is incomplete and its strings file contains a number of key/value pairs that are unlocalized. In this case those pairs will be extracted with extract() and the partial strings file that results can be localized. When it comes time to integrate the partial file, it is necessary to allow those new strings to override the existing, unlocalized ones in the previous version of the localizations' string file.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003322more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at December 21, 2007  7:40 PM</p>
