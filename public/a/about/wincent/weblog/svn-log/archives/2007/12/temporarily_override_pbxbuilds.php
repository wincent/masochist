...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Temporarily override PBXBuildsContinueAfterErrors
      (snippets, 14ccc04)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/teach_nightlies_script_to_find.php"
      title="Teach nightlies script to find out latest Synergy archive name (snippets, f0162d1)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/dont_pass_svnrev_during_synerg.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/teach_nightlies_script_to_find.php"
            >&laquo; Teach nightlies script to find out latest Synergy archive
            name (snippets, f0162d1)</a
          >
          |
        ...
        <p>
          I like to have PBXBuildsContinueAfterErrors set to YES in my user
          defaults so as to catch the maximum number of errors possible in each
          build cycle.
        </p>

        <p>
          But having this set doesn't work too well when building nightlies,
          where we want the first error to derail the build process as soon as
          possible.
        </p>

        <p>
          So set up a temporary override from within the nightlies script to
          allow us to have the best of both worlds.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003395more"><div id="more"></div></div>
