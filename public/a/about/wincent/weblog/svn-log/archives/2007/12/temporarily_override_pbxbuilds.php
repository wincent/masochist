...
<title>Git activity log: Temporarily override PBXBuildsContinueAfterErrors (snippets, 14ccc04)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/teach_nightlies_script_to_find.php" title="Teach nightlies script to find out latest Synergy archive name (snippets, f0162d1)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/dont_pass_svnrev_during_synerg.php" title="Don't pass SVNREV during Synergy nightly build (snippets, c5d7094)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/teach_nightlies_script_to_find.php">&laquo; Teach nightlies script to find out latest Synergy archive name (snippets, f0162d1)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/dont_pass_svnrev_during_synerg.php">Don't pass SVNREV during Synergy nightly build (snippets, c5d7094) &raquo;</a>

</p>

<h2>December 27, 2007</h2>

<h3>Temporarily override PBXBuildsContinueAfterErrors (snippets, 14ccc04)</h3>

<p>I like to have PBXBuildsContinueAfterErrors set to YES in my user defaults so as to catch the maximum number of errors possible in each build cycle.</p>

<p>But having this set doesn't work too well when building nightlies, where we want the first error to derail the build process as soon as possible.</p>

<p>So set up a temporary override from within the nightlies script to allow us to have the best of both worlds.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003395more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at December 27, 2007 12:55 PM</p>
