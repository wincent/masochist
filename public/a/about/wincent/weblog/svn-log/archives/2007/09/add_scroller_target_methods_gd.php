...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add scroller target methods (gdiff, 23421db)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/add_pragma_mark_navigation_aid.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/add_pragma_mark_navigation_aid.php"
            >&laquo; Add pragma mark navigation aids to MyDocument (gdiff,
            67739bc)</a
          >
          |
        ...
        <p>
          Add skeletal methods called whenever the user interacts with the
          scroller. For the time being doesn't actually do anything, pending the
          addition of the model code.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002944more"><div id="more"></div></div>
