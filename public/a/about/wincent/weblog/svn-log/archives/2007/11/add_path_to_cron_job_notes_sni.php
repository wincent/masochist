...
<title>Git activity log: Add PATH to cron job notes (snippets, a72ff7e)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/switch_to_wopublic_check_and_a.php" title="Switch to WOPublic check and assert macros (WOCommon, c9571fb)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/11/add_notes_on_third_machine_see.php" title="Add notes on third machine seed algorithm (WOCommon, 6d88aaf)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/switch_to_wopublic_check_and_a.php">&laquo; Switch to WOPublic check and assert macros (WOCommon, c9571fb)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/11/add_notes_on_third_machine_see.php">Add notes on third machine seed algorithm (WOCommon, 6d88aaf) &raquo;</a>

</p>

<h2>November  2, 2007</h2>

<h3>Add PATH to cron job notes (snippets, a72ff7e)</h3>

<p>Without an adequate path set up the GC script will fail because git-gc depends on various standard tools (like sed etc) and without it the script won't be able to find git-gc in the first place.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a002889more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at November  2, 2007 11:28 AM</p>
