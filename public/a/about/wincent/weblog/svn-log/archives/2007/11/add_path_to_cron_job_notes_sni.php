...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add PATH to cron job notes (snippets, a72ff7e)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/switch_to_wopublic_check_and_a.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/switch_to_wopublic_check_and_a.php"
            >&laquo; Switch to WOPublic check and assert macros (WOCommon,
            c9571fb)</a
          >
          |
        ...
        <p>
          Without an adequate path set up the GC script will fail because git-gc
          depends on various standard tools (like sed etc) and without it the
