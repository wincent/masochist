...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove no-op NSView overrides (gdiff, dc7f887)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/add_first_of_two_scroll_views.php"
            >&laquo; Add first of two scroll views (gdiff, 390c5b3)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/let_glue_view_pick_up_any_pixe.php"
            >Let glue view pick up any pixel slack (gdiff, 50b3dbc) &raquo;</a
          >
        </p>
        ...
        <p>
          The default NSView subclass templates include no-op methods that can
          be overridden. Seeing as the WODiffView class is unlikely to ever need
          to override these methods, remove them and fall through to the super
          class implementations.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002985more"><div id="more"></div></div>
