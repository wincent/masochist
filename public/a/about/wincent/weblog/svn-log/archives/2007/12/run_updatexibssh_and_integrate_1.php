...
<title>Git activity log: Run UpdateXibs.sh and integrate old localization info (Synergy, 350ab66)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/run_updatexibssh_and_integrate.php" title="Run UpdateXibs.sh and integrate old localization info (Synergy, 350ab66)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/add_localized_xib_references_b.php" title="Add localized xib references back to Xcode project (Synergy, 1cce708)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/run_updatexibssh_and_integrate.php">&laquo; Run UpdateXibs.sh and integrate old localization info (Synergy, 350ab66)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/add_localized_xib_references_b.php">Add localized xib references back to Xcode project (Synergy, 1cce708) &raquo;</a>

</p>

<h2>December 23, 2007</h2>

<h3>Run UpdateXibs.sh and integrate old localization info (Synergy, 350ab66)</h3>

<p>Set up the initial strings and untranslated.strings files using UpdateXibs.sh. In so far as is possible, I have tried to use the old localization info extracted from a previous release. In many cases this applies cleanly to the new xibs, but there are many where it does not, and these will still need to be updated by hand; even in the cases where the old strings applied cleanly any custom geometry will have to be added back in by hand because this did not carry across.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003414more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at December 23, 2007  9:30 PM</p>
