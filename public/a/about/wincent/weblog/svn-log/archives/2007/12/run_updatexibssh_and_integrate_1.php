...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Run UpdateXibs.sh and integrate old localization info
      (Synergy, 350ab66)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/add_localized_xib_references_b.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/run_updatexibssh_and_integrate.php"
            >&laquo; Run UpdateXibs.sh and integrate old localization info
            (Synergy, 350ab66)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/add_localized_xib_references_b.php"
            >Add localized xib references back to Xcode project (Synergy,
            1cce708) &raquo;</a
          >
        </p>
        ...
        <p>
          ...
          not, and these will still need to be updated by hand; even in the
          cases where the old strings applied cleanly any custom geometry will
          have to be added back in by hand because this did not carry across.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003414more"><div id="more"></div></div>
