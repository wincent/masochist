...
<title>Git activity log: Throw away WOBundle and WOBaseCore (WOCommon, cbbe594)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/fix_syntax_error_in_nsfilemana.php" title="Fix syntax error in NSFileManager category (WOCommon, bda13fc)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/fix_another_womakecollectablen.php" title="Fix another WOMakeCollectable/NSMakeCollectable issue (WOCommon, 42aa205)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/fix_syntax_error_in_nsfilemana.php">&laquo; Fix syntax error in NSFileManager category (WOCommon, bda13fc)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/fix_another_womakecollectablen.php">Fix another WOMakeCollectable/NSMakeCollectable issue (WOCommon, 42aa205) &raquo;</a>

</p>

<h2>December 27, 2007</h2>

<h3>Throw away WOBundle and WOBaseCore (WOCommon, cbbe594)</h3>

<p>Apple deprecated some crucial API in Leopard and my options were as follows: ignore the deprecation warnings (thus making it impossible to insist on warning-free builds, and only deferring the inevitable moment when support is dropped entirely); switch to the new API (unfortunately not equivalent to the old API, and would have required a kludgey hack); or rip out the old code and forget about the functionality.</p>

<p>Rather than chase a moving target or balance on shakey ground (pick your metaphor) I decided to rip the old code out and forget about it. This means ripping out WOBundle and the entire WOBaseCore bundle; some of the necessary functionality in WOBaseCore has been migrated into other classes in WOCommon. On the bright side, this is a simplification, even if it does mean sacrificing some very useful functionality that proved itself pre-Leopard.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003457more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at December 27, 2007  9:15 PM</p>
