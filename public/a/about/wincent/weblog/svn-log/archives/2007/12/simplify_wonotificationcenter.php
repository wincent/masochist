...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Simplify WONotificationCenter class (WOCommon, a0dd82c)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/remove_eager_loading_of_shared.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/remove_eager_loading_of_shared.php"
            >&laquo; Remove eager loading of shared WOLogManager instance
            (WOCommon, 611433c)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/major_code_audit_and_cleanup_f.php"
            >Major code audit and clean-up for GC (Synergy, 584f867) &raquo;</a
          >
        </p>
        ...
        <p>
          Thanks to new API in Leopard we can replace about 150 lines of very
          complex code (that plays with threads, run loops, mach ports etc) with
          only 25 lines of very simple code. This should be a much more robust
