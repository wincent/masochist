...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Move test setup code into windowControllerDidLoadNib
      (gdiff, 039b748)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/draw_borders_in_gutter_views_g.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_file_property_to_wodiffvie.php"
            >&laquo; Add file property to WODiffView (gdiff, 1ebf57f)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/draw_borders_in_gutter_views_g.php"
            >Draw borders in gutter views (gdiff, eff8c91) &raquo;</a
          >
        </p>
        ...
        <p>
          In order to do some additional set-up for the test code, move it into
          the windowControllerDidLoadNib: method (which is called after the nib
