...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Indentation in application README (typechecked.net, b8b1d12)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/install_fixturereplacement_plu.php"
      title="Install FixtureReplacement plug-in (typechecked.net, 07fe43b)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/add_haml_plugin_wincentcom_3cf.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/install_fixturereplacement_plu.php"
            >&laquo; Install FixtureReplacement plug-in (typechecked.net,
            07fe43b)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/add_haml_plugin_wincentcom_3cf.php"
            >Add Haml plugin (typechecked.net, 3cf854a) &raquo;</a
          >
        </p>

        <h2>October 5, 2007</h2>

        <h3>Indentation in application README (typechecked.net, b8b1d12)</h3>
