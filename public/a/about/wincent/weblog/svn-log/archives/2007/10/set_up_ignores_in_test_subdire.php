...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Set up ignores in test subdirectory (typechecked.net,
      0169c6c)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/update_scriptspec_wincentcom_5.php"
            >&laquo; Update script/spec (typechecked.net, 57f43c1)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/add_stories_subdirectory_wince.php"
            >Add stories subdirectory (typechecked.net, 521539e) &raquo;</a
          >
        </p>

        <h2>October 15, 2007</h2>

        <h3>Set up ignores in test subdirectory (typechecked.net, 0169c6c)</h3>
