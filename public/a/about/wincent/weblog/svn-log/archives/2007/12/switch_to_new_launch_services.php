...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Switch to new Launch Services code in WOCommon
      (login-tool, f0a9c33)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/myriad_changes_for_gc_wocommon.php"
            >&laquo; Myriad changes for GC (WOCommon, 38e4bea)</a
          >
          |
        ...
        <p>
          This is basically a total rewrite of the tool, throwing out all the
