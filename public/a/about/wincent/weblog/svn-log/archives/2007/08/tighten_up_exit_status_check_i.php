...
<title>Git activity log: Tighten up exit status check in post-receive script (snippets, 2be9c00)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/08/objectivec_20_modernization_wo_1.php" title="Objective-C 2.0 modernization (WOHotKey, e3f4f9a)" />

<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/08/initial_version_of_git_build_n.php" title="Initial version of Git build number scripts (buildtools, bd6ad3d)" />
...
<p align="right">
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/08/objectivec_20_modernization_wo_1.php">&laquo; Objective-C 2.0 modernization (WOHotKey, e3f4f9a)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>
| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/08/initial_version_of_git_build_n.php">Initial version of Git build number scripts (buildtools, bd6ad3d) &raquo;</a>

</p>

<h2>August 12, 2007</h2>

<h3>Tighten up exit status check in post-receive script (snippets, 2be9c00)</h3>

<p>The post-receive script currently does a somewhat loose exitstatus check ($? == 0) which happens to work because the Process::Status class evidently overrides the == operator (or implements to_int; I haven't actually looked at the source code to know why this works); rather than relying on this behaviour this commit explicitly compares the exit status ($?.exitstatus == 0) to guard against possible changes to the Ruby API in the future.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a002622more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at August 12, 2007  1:43 AM</p>
