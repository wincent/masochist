...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Updates for changes to CDSA API in Leopard (WOCommon,
      787852a)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/update_tests_to_use_new_founda.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/fix_nsarray_reference_which_wa.php"
            >&laquo; Fix NSArray reference which was really an NSMutableArray
            (WOCommon, ada8ea0)</a
          >
          |
        ...
        <p>
          Quell some compiler warnings by modifying the declared types of some
          variables and function pointers to match those in the Leopard version
          of the CDSA API.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002646more"><div id="more"></div></div>
