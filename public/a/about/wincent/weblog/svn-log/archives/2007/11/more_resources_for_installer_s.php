...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: More resources for installer (Synergy, 9e3a716)
    </title>
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          Add additional resources for the installer (material for
          Contents/Resources/).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003162more"><div id="more"></div></div>
