...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add Article and Revision models (typechecked.net, 884af44)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/add_stories_subdirectory_wince.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/add_stories_subdirectory_wince.php"
            >&laquo; Add stories subdirectory (typechecked.net, 521539e)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/whitespace_fix_wincentcom_bfa8.php"
            >Whitespace fix (typechecked.net, bfa88e8) &raquo;</a
          >
        </p>

        <h2>October 15, 2007</h2>

        <h3>Add Article and Revision models (typechecked.net, 884af44)</h3>
