...
<title>Git activity log: Update registration nib to reflect new class hierarchy (WOCommon, c08e31e)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/remove_wosingleton_dependency_1.php" title="Remove WOSingleton dependency from WORegistrationController (WOCommon, 515521f)" />

<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/remove_wosingleton_class_and_a.php" title="Remove WOSingleton class and all references to it (WOCommon, 839cadd)" />
...
<p align="right">
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/remove_wosingleton_dependency_1.php">&laquo; Remove WOSingleton dependency from WORegistrationController (WOCommon, 515521f)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>
| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/remove_wosingleton_class_and_a.php">Remove WOSingleton class and all references to it (WOCommon, 839cadd) &raquo;</a>

</p>

<h2>September 16, 2007</h2>

<h3>Update registration nib to reflect new class hierarchy (WOCommon, c08e31e)</h3>

<p>The registration controller's inheritance hierarchy has changed so the nib must also be updated. In the process the nib was (non-optionally) upgraded to the new XML-based nib format.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a002740more"><div id="more">
