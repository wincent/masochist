...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update registration nib to reflect new class hierarchy
      (WOCommon, c08e31e)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/remove_wosingleton_dependency_1.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/remove_wosingleton_dependency_1.php"
            >&laquo; Remove WOSingleton dependency from WORegistrationController
            (WOCommon, 515521f)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/remove_wosingleton_class_and_a.php"
            >Remove WOSingleton class and all references to it (WOCommon,
            839cadd) &raquo;</a
          >
        </p>
        ...
        <p>
          The registration controller's inheritance hierarchy has changed so the
          nib must also be updated. In the process the nib was (non-optionally)
          upgraded to the new XML-based nib format.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002740more"><div id="more"></div></div>
