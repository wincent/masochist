...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add notes to Taggable spec (typechecked.net, 7d06fda)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/add_specs_for_and_fix_bugs_in.php"
            >&laquo; Add specs for and fix bugs in Taggable module (typechecked.net,
            719595d)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2007/10/whitespace_fix_wincentcom_df00.php"
            >Whitespace fix (typechecked.net, df00cf2) &raquo;</a
          >
        </p>

        <h2>October 15, 2007</h2>

        <h3>Add notes to Taggable spec (typechecked.net, 7d06fda)</h3>
