...
<title>Git activity log: Modernize UpdateStringsFiles.sh (buildtools, 460689f)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/modernize_localizable_string_u_1.php" title="Modernize localizable string update process (Synergy, e5f48d3)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/update_launch_services_and_log.php" title="Update Launch Services and login items at launch (Synergy, a93bd55)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/modernize_localizable_string_u_1.php">&laquo; Modernize localizable string update process (Synergy, e5f48d3)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/update_launch_services_and_log.php">Update Launch Services and login items at launch (Synergy, a93bd55) &raquo;</a>

</p>

<h2>December 24, 2007</h2>

<h3>Modernize UpdateStringsFiles.sh (buildtools, 460689f)</h3>

<p>Make some tweaks to UpdateStringsFiles.sh to make it more generally suitable. In particular, the ability to specify separate source and resources folders means that we can use this script in the Synergy build process now (because the Synergy code base dates back a very long way now and doesn't follow the standard locations which you get when you set up a new project).</p>

<p>These changes basically make the UpdateStringsFile.sh script redundant, so remove it.</p>

<p>I am still not entirely happy with this script -- it is now showing its age -- despite the fact that it works. In the future will probably do some more refactoring to clean this up and correctly distribute responsibilities among this, the UpdateXibs.sh script, and possibly others.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003373more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at December 24, 2007  7:10 PM</p>
