...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Initial version of post-receive hook (snippets, 60d726a)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/fix_whitespace_snippets_eb4acd.php"
      title="Fix whitespace (snippets, eb4acd2)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/ruby_rewrite_of_postreceive_ho.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/fix_whitespace_snippets_eb4acd.php"
            >&laquo; Fix whitespace (snippets, eb4acd2)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/ruby_rewrite_of_postreceive_ho.php"
            >Ruby rewrite of post-receive hook (snippets, d54a73f) &raquo;</a
          >
        </p>
        ...
        <p>
          This is a Bash script modelled on the example post-receive-email hook
          script<br />
          that comes with Git. This is a base version of the script that parses
          the<br />
          standard input and mines git for information appropriate to include in
          the<br />
          corresponding XML-RPC post to the weblog.
        </p>

        <p>
          Rather than having two, scripts however, the plan is to roll the
          functionality<br />
          of this script and that of the commit-feed.rb script into a single
          Ruby<br />
        ...
        <div id="a002410more"><div id="more"></div></div>
