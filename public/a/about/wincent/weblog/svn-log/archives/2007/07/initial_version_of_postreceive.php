...
<title>Git activity log: Initial version of post-receive hook (snippets, 60d726a)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/fix_whitespace_snippets_eb4acd.php" title="Fix whitespace (snippets, eb4acd2)" />

<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/ruby_rewrite_of_postreceive_ho.php" title="Ruby rewrite of post-receive hook (snippets, d54a73f)" />
...
<p align="right">
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/fix_whitespace_snippets_eb4acd.php">&laquo; Fix whitespace (snippets, eb4acd2)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>
| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/ruby_rewrite_of_postreceive_ho.php">Ruby rewrite of post-receive hook (snippets, d54a73f) &raquo;</a>

</p>

<h2>July 18, 2007</h2>

<h3>Initial version of post-receive hook (snippets, 60d726a)</h3>

<p>This is a Bash script modelled on the example post-receive-email hook script<br />
that comes with Git. This is a base version of the script that parses the<br />
standard input and mines git for information appropriate to include in the<br />
corresponding XML-RPC post to the weblog.</p>

<p>Rather than having two, scripts however, the plan is to roll the functionality<br />
of this script and that of the commit-feed.rb script into a single Ruby<br />
script which handles everything.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt;<br />
</p>

<div id="a002410more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at July 18, 2007  6:01 PM</p>
