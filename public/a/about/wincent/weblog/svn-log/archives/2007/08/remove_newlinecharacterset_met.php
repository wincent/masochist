...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove newlineCharacterSet method (WOCommon, 34f23e1)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/update_wobindablemenuwithsepar.php"
            >&laquo; Update WOBindableMenuWithSeparators for Leopard APIs
            (WOCommon, 7599e9a)</a
          >
          |
          ...
          <a
            ...
            WOPreferencesWindowController (WOCommon, 5b43413) &raquo;</a
          >
        </p>
        ...
        <p>
          The system now implements a newlineCharacterSet method which clashes
          with the implementation in my NSCharacterSet category, so remove the
          duplicate method.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002643more"><div id="more"></div></div>
