...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update versioning and targets (Synergy, 38001f5)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/use_more_appropriate_git_comma.php"
      title="Use more appropriate Git commands (buildtools, abd6284)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/update_versioning_and_targets_1.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/use_more_appropriate_git_comma.php"
            >&laquo; Use more appropriate Git commands (buildtools, abd6284)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/update_versioning_and_targets_1.php"
            >Update versioning and targets (Synergy, 38001f5) &raquo;</a
          >
        </p>
        ...
        <p>
          ...
          used in Synergy Advance. Basically, when building a package for
          release we update the build number based on the current Git commit;
          the version number and copyright years are automatically propagated
          through to the localized InfoPlist.strings files.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003303more"><div id="more"></div></div>
