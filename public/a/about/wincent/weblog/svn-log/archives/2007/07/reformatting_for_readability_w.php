...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Reformatting for readability (Wincent Strings Utility,
      ddef228)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/remove_workaround_for_autoinde.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/objectivec_20_fast_enumeration.php"
            >&laquo; Objective-C 2.0: fast enumeration (Wincent Strings Utility,
            146e1b7)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/remove_workaround_for_autoinde.php"
            >Remove workaround for auto-indentation bug (Wincent Strings
            Utility, f9a9461) &raquo;</a
          >
        </p>
        ...
        <p>
          Mostly whitespace adjustments (horizontal and vertical) to make better
          use of available space.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002512more"><div id="more"></div></div>
