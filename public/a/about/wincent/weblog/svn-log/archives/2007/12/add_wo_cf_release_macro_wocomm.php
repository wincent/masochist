...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/update_symbol_macros_for_wolog.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/update_symbol_macros_for_wolog.php"
            >&laquo; Update symbol macros for WOLoginItem (WOCommon, bd7521a)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/add_new_login_api_files_to_pro.php"
            >Add new login API files to project (WOCommon, 9e5d357) &raquo;</a
          >
        </p>
        ...
        <p>
          Simple wrapper for CFRelease. Mostly useful in error-recovery
          situations where it may not be appropriate to use CFMakeCollectable
          (for example, where you may have a NULL reference and don't want the
          clutter of an explicit check).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003243more"><div id="more"></div></div>
