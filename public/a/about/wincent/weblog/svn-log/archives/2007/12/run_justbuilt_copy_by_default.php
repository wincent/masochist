...
<title>Git activity log: Run just-built copy by default (Wincent Strings Utility, 6646efa)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/move_input_files_into_subdirec.php" title="Move input files into subdirectory (Wincent Strings Utility, a9130ab)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/split_specs_into_separate_file.php" title="Split specs into separate files (Wincent Strings Utility, d789a0b)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/move_input_files_into_subdirec.php">&laquo; Move input files into subdirectory (Wincent Strings Utility, a9130ab)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/split_specs_into_separate_file.php">Split specs into separate files (Wincent Strings Utility, d789a0b) &raquo;</a>

</p>

<h2>December 22, 2007</h2>

<h3>Run just-built copy by default (Wincent Strings Utility, 6646efa)</h3>

<p>When run from inside an Xcode shell script phase the TARGET_BUILD_DIR environment variable enables us to find the just-built copy for testing purposes. The same effect can be achieved by manually exporting the environment variable and running the specs by hand from the command line.</p>

<p>When the environment variable is not set, fall back to just running whatever copy of wincent-strings-util happens to be found first in the PATH.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003329more"><div id="more">
