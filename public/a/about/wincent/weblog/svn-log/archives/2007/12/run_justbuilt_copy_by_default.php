...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Run just-built copy by default (Wincent Strings Utility,
      6646efa)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/move_input_files_into_subdirec.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/move_input_files_into_subdirec.php"
            >&laquo; Move input files into subdirectory (Wincent Strings
            Utility, a9130ab)</a
          >
          |
        ...
        <p>
          ...
          environment variable enables us to find the just-built copy for
          testing purposes. The same effect can be achieved by manually
          exporting the environment variable and running the specs by hand from
          the command line.
        </p>
        ...
        <div id="a003329more"><div id="more"></div></div>
