...
<title>Git activity log: Factor conversion routines out into per-character functions (wikitext, c5ca963)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/flesh_out_accessor_methods_for.php" title="Flesh out accessor methods for the internal link prefix (wikitext, 17856f8)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/add_url_encoding_for_internal.php" title="Add URL encoding for internal target links (wikitext, b29f967)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/flesh_out_accessor_methods_for.php">&laquo; Flesh out accessor methods for the internal link prefix (wikitext, 17856f8)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/10/add_url_encoding_for_internal.php">Add URL encoding for internal target links (wikitext, b29f967) &raquo;</a>

</p>

<h2>October 18, 2007</h2>

<h3>Factor conversion routines out into per-character functions (wikitext, c5ca963)</h3>

<p>Extract two new functions, one for converting a single UCS-2 character into a (possibly multi-byte) UTF-8 representation, and another for performing the reverse operation.</p>

<p>This change will be useful when sanitizing internal link targets in the future; such link targets must be URL-encoded, which means converting them to UTF-8, performing the encoding, and then converting back into UCS-2 for merging into the output stream (whose working format is UCS-2). The functions can be used to efficiently convert on a per-character basis and thus avoid potentially expensive allocations of temporary strings; in fact the whole thing can be done in pure C this way without any Ruby message sends at all.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003037more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at October 18, 2007  3:55 PM</p>
...
<div id="footer">
  ...
  <p>Page last updated 00:30:22, 19 February 2010.</p>
  <p>
