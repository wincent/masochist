...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix export paths for Synergy nightly (snippets, 1823803)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/call_mainviewdidload_when_show_1.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/call_mainviewdidload_when_show_1.php"
            >&laquo; Call mainViewDidLoad when showing preference pane (Synergy,
            4a9cbcf)</a
          >
          |
        ...
        <p>
          Synergy expects to find the WOCommon source at ../../WOCommon/src, not
          at ../../WOCommon, so adjust export path to match, and likewise for
          WOPublic.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003391more"><div id="more"></div></div>
