...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Move input files into subdirectory (Wincent Strings
      Utility, a9130ab)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/add_specs_for_basic_merge_use.php"
            >&laquo; Add specs for basic -merge use (Wincent Strings Utility,
            c09ab36)</a
          >
          |
        ...
        <p>
          Keep the spec directory cleaner by moving the input files into their
          own subdirectory.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003328more"><div id="more"></div></div>
