...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove dependency on WOSingleton from WOLoginManager
      (WOCommon, 4450945)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/modernize_wologinmanager_heade.php"
            >&laquo; Modernize WOLoginManager header (WOCommon, 48ddb87)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/remove_wosingleton_dependency_1.php"
            >Remove WOSingleton dependency from WORegistrationController
            (WOCommon, 515521f) &raquo;</a
          >
        </p>
        ...
        <h3>
          Remove dependency on WOSingleton from WOLoginManager (WOCommon,
          4450945)
        </h3>

        <p>
          Give WOLoginManager its own local implementation of the singleton
