...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Workaround Objective-C 2.0 properties bug (WOTest,
      2507142)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/add_test_case_for_objectivec_2.php"
      title="Add test case for Objective-C 2.0 properties bug (WOTest, 3fa7f33)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/code_cleanup_for_garbage_colle.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/add_test_case_for_objectivec_2.php"
            >&laquo; Add test case for Objective-C 2.0 properties bug (WOTest,
            3fa7f33)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/08/code_cleanup_for_garbage_colle.php"
            >Code clean-up for garbage collection (WOTest, 2eab9a2) &raquo;</a
          >
        </p>
        ...
        <p>
          It turns out that the public-readonly/private-readwrite property
          pattern is not broken after all, and a simple workaround is available
          (redeclare all the attributes &quot;in whole&quot; rather than
          &quot;in part&quot; as the documentation suggests).
        </p>

        <p>
          This commit applies the new workaround and references the Radar and
          test case that correspond to the issue.
        </p>
        ...
        <div id="a002610more"><div id="more"></div></div>
