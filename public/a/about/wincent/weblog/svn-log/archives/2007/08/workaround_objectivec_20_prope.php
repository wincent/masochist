...
<title>Git activity log: Workaround Objective-C 2.0 properties bug (WOTest, 2507142)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/08/add_test_case_for_objectivec_2.php" title="Add test case for Objective-C 2.0 properties bug (WOTest, 3fa7f33)" />

<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/08/code_cleanup_for_garbage_colle.php" title="Code clean-up for garbage collection (WOTest, 2eab9a2)" />
...
<p align="right">
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/08/add_test_case_for_objectivec_2.php">&laquo; Add test case for Objective-C 2.0 properties bug (WOTest, 3fa7f33)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>
| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/08/code_cleanup_for_garbage_colle.php">Code clean-up for garbage collection (WOTest, 2eab9a2) &raquo;</a>

</p>

<h2>August 11, 2007</h2>

<h3>Workaround Objective-C 2.0 properties bug (WOTest, 2507142)</h3>

<p>It turns out that the public-readonly/private-readwrite property pattern is not broken after all, and a simple workaround is available (redeclare all the attributes &quot;in whole&quot; rather than &quot;in part&quot; as the documentation suggests).</p>

<p>This commit applies the new workaround and references the Radar and test case that correspond to the issue.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a002610more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at August 11, 2007  1:44 PM</p>
