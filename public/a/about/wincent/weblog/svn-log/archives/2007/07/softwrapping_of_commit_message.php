...
<title>Git activity log: Soft-wrapping of commit message bodies (snippets, 7be8da9)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/add_example_invocation_to_docu.php" title="Add example invocation to documentation (snippets, ed5284b)" />

<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/add_rdoc_documentation_to_post.php" title="Add RDoc documentation to post-receive script (snippets, 238877e)" />
...
<p align="right">
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/add_example_invocation_to_docu.php">&laquo; Add example invocation to documentation (snippets, ed5284b)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>
| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/07/add_rdoc_documentation_to_post.php">Add RDoc documentation to post-receive script (snippets, 238877e) &raquo;</a>

</p>

<h2>July 19, 2007</h2>

<h3>Soft-wrapping of commit message bodies (snippets, 7be8da9)</h3>

<p>Perform some preprocessing on commit message bodies prior to handing them off to Movable Type: consecutive newline pairs are allowed through and Movable Type interprets these as paragraph breaks; all other newlines are converted to spaces (without this Movable Type would insert line break tags for each one, thus causing the output to be hard-wrapped in the browser.</p>

<p>This allows the best of both worlds: readable, hard-wrapped text in the console and attractive, soft-wrapped text in the web browser.</p>

<p>The cost of all this is that commit message bodies should only be standard text, not code snippets or anything which would require literal newlines to be echoed.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a002421more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at July 19, 2007 10:38 AM</p>
