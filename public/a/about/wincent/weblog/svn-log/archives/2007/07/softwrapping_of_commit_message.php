...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Soft-wrapping of commit message bodies (snippets,
      7be8da9)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/add_example_invocation_to_docu.php"
      title="Add example invocation to documentation (snippets, ed5284b)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/add_rdoc_documentation_to_post.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/add_example_invocation_to_docu.php"
            >&laquo; Add example invocation to documentation (snippets,
            ed5284b)</a
          >
          |
        ...
        <p>
          Perform some preprocessing on commit message bodies prior to handing
          them off to Movable Type: consecutive newline pairs are allowed
          through and Movable Type interprets these as paragraph breaks; all
          other newlines are converted to spaces (without this Movable Type
          would insert line break tags for each one, thus causing the output to
          be hard-wrapped in the browser.
        </p>

        <p>
          This allows the best of both worlds: readable, hard-wrapped text in
          the console and attractive, soft-wrapped text in the web browser.
        </p>

        <p>
          The cost of all this is that commit message bodies should only be
          standard text, not code snippets or anything which would require
