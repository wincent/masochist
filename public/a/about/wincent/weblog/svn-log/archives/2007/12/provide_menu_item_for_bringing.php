...
<title>Git activity log: Provide menu item for bringing preferences window on screen (Synergy, c2adcef)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/fix_window_closing_and_termina.php" title="Fix window closing and termination behaviour (Synergy, 52c8406)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/close_the_application_when_las.php" title="Close the application when last window is closed (Synergy, c7eb0af)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/fix_window_closing_and_termina.php">&laquo; Fix window closing and termination behaviour (Synergy, 52c8406)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/close_the_application_when_las.php">Close the application when last window is closed (Synergy, c7eb0af) &raquo;</a>

</p>

<h2>December 27, 2007</h2>

<h3>Provide menu item for bringing preferences window on screen (Synergy, c2adcef)</h3>

<p>Useful for when user dismisses preferences window and later decides that he/she wants it back.</p>

<p>An interesting case is when there are unapplied changes; if the user tries to close the window, clicks &quot;Don't Apply&quot;, and then tries to quit the application then the window will come back on screen again and the sheet will be shown.</p>

<p>In order to support this repeated showing of the preferences window had to use the setReleasedWhenClosed: method. Note that I may later decide to auto-quit the application when the last window is closed.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003448more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at December 27, 2007  5:14 PM</p>
