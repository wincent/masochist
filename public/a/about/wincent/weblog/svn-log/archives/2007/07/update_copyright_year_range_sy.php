...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update copyright year range (Synergy Advance, 68ec4e5)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/remove_subversionspecific_keyw_1.php"
            >&laquo; Remove Subversion-specific keywords (WOCommon, 54b91bb)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/updated_copyright_year_ranges.php"
            >Updated copyright year ranges (WOCommon, 177e5dd) &raquo;</a
          >
        </p>
        ...
        <p>
          Update copyright year range to end in 2007 for all files changed this
          year.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002452more"><div id="more"></div></div>
