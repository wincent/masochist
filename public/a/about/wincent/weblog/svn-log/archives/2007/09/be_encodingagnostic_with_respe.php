...
<title>Git activity log: Be encoding-agnostic with respect to paths (gdiff, cb1f777)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/capture_blob_ids_gdiff_74a672c.php" title="Capture blob ids (gdiff, 74a672c)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/replace_atoi_with_explicit_con.php" title="Replace atoi() with explicit conversion (gdiff, 5e549a8)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/capture_blob_ids_gdiff_74a672c.php">&laquo; Capture blob ids (gdiff, 74a672c)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/09/replace_atoi_with_explicit_con.php">Replace atoi() with explicit conversion (gdiff, 5e549a8) &raquo;</a>

</p>

<h2>September 23, 2007</h2>

<h3>Be encoding-agnostic with respect to paths (gdiff, cb1f777)</h3>

<p>While thinking about how to handle possible different, platform-dependent text encodings in path names I realized that the best thing to do would be to be encoding-agnostic and do what Git goes: display the raw bytes of the path using escape sequences for non-ASCII and non-printable characters.</p>

<p>gdiff doesn't actually need the paths in order to show the file contents (it will ask Git for the blobs based on their hash identifiers) so the paths are for display purposes only. For display the non-ambiguous format using escape markers is actually much better. This simplifies the code greatly and makes it much more robust.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a002929more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at September 23, 2007  8:44 PM</p>
...
<div id="footer">
  ...
  <p>Page last updated 00:30:33, 19 February 2010.</p>
  <p>
