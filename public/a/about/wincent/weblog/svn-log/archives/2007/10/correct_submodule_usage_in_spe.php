...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Correct submodule usage in specs (wikitext, e37df19)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/add_url_encoding_for_internal.php"
            >&laquo; Add URL encoding for internal target links (wikitext,
            b29f967)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/cleanup_conversion_specs_wikit.php"
            >Cleanup conversion specs (wikitext, 374b278) &raquo;</a
          >
        </p>
        ...
        <p>
          One group of specs was mislablled as pertaining to Wikitext::Parser
          when it in fact pertained to the Wikitext module itself.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003039more"><div id="more"></div></div>
