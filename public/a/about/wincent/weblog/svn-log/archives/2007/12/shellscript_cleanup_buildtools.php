...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/use_close_function_from_common.php"
      title="Use close() function from Common.sh (buildtools, 85d1bcb)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/use_rather_than_backticks_buil.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/use_close_function_from_common.php"
            >&laquo; Use close() function from Common.sh (buildtools,
            85d1bcb)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/use_rather_than_backticks_buil.php"
            >Use $() rather than backticks (buildtools, 6c7aa3e) &raquo;</a
          >
        </p>
        ...
        <p>
          Remove hard-coded paths in /usr/bin (trust PATH to lead to the
          selection of the right tool), use /bin/sh instead of /bin/bash in the
          shebang line, and quote some arguments which contain variables (paths
