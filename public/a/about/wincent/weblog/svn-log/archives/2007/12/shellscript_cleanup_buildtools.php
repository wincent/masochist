...
<title>Git activity log: Shell-script clean-up (buildtools, a1267f6)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/use_close_function_from_common.php" title="Use close() function from Common.sh (buildtools, 85d1bcb)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/use_rather_than_backticks_buil.php" title="Use $() rather than backticks (buildtools, 6c7aa3e)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/use_close_function_from_common.php">&laquo; Use close() function from Common.sh (buildtools, 85d1bcb)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/use_rather_than_backticks_buil.php">Use $() rather than backticks (buildtools, 6c7aa3e) &raquo;</a>

</p>

<h2>December 23, 2007</h2>

<h3>Shell-script clean-up (buildtools, a1267f6)</h3>

<p>Remove hard-coded paths in /usr/bin (trust PATH to lead to the selection of the right tool), use /bin/sh instead of /bin/bash in the shebang line, and quote some arguments which contain variables (paths are unlikely to contain spaces, but err on the safe side).</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003352more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at December 23, 2007  7:55 PM</p>
