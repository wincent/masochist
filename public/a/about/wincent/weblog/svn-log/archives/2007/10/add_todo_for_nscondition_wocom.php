...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add TODO for NSCondition (WOCommon, fb068b5)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/mark_code_for_review_wocommon.php"
            >&laquo; Mark code for review (WOCommon, de92bdc)</a
          >
          |
        ...
        <p>
          The new NSCondition API in Leopard could prove quite useful in
          cleaning up the code in the NSThread convenience category; add a TODO
          note as a reminder.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002873more"><div id="more"></div></div>
