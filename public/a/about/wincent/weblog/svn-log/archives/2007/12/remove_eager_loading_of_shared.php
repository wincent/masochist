...
<title>Git activity log: Remove eager loading of shared WOLogManager instance (WOCommon, 611433c)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/use_wmalloc_in_wologinitem_cla.php" title="Use wmalloc in WOLoginItem class (WOCommon, 1d38ca6)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/simplify_wonotificationcenter.php" title="Simplify WONotificationCenter class (WOCommon, a0dd82c)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/use_wmalloc_in_wologinitem_cla.php">&laquo; Use wmalloc in WOLoginItem class (WOCommon, 1d38ca6)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2007/12/simplify_wonotificationcenter.php">Simplify WONotificationCenter class (WOCommon, a0dd82c) &raquo;</a>

</p>

<h2>December 15, 2007</h2>

<h3>Remove eager loading of shared WOLogManager instance (WOCommon, 611433c)</h3>

<p>For faster startup times and greater simplicity, remove the eager loading of the shared WOLogManager instance.</p>

<p>I did consider instead eagerly loading a lightweight proxy which would allow the deferral of loading the real log manager until first use, but in the end this wasn't the simplest thing which would work (a macro).</p>

<p>The shared manager access already occurs via a thread-safe double-checked locking method with memory barriers, so it should be both fast and safe. In this light the macro is the sanest solution.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003274more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at December 15, 2007  3:20 PM</p>
