...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/initial_import_synergy_7634780_1.php"
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          Initial import corresponding to the tip of the trunk (Leopard) in the
          current Subversion repository (revision 399).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002426more"><div id="more"></div></div>
