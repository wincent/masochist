...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Migrate to new Leopard keyboard APIs (WOHotKey, 7ae51da)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/update_method_signature_to_avo.php"
      title="Update method signature to avoid deprecated API warnings (WOHotKey, f4f9ad8)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/whitespace_fixes_wohotkey_92ce.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/update_method_signature_to_avo.php"
            >&laquo; Update method signature to avoid deprecated API warnings
            (WOHotKey, f4f9ad8)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/whitespace_fixes_wohotkey_92ce.php"
            >Whitespace fixes (WOHotKey, 92ce331) &raquo;</a
          >
        </p>
        ...
        <p>
          Some of the old APIs previously used are now deprecated in Leopard. To
          get a warning free build this commit gets rid of all uses of the old
          APIs and migrates to the new ones.
        </p>

        <p>
          Along the way it seems that KCHR resources have become deprecated (at
          least there is no explicit mention of them in the headers), so the
          related code has been removed; this is expected to have little effect
          on the results because KCHR-based code was only used as a fallback
          when uchr-based lookup failed.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002578more"><div id="more"></div></div>
