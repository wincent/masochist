...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Flesh out accessor methods for the internal link prefix
      (wikitext, 17856f8)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/tighten_up_module_message_send.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/tighten_up_module_message_send.php"
            >&laquo; Tighten up module message sends (wikitext, 8cba11d)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/factor_conversion_routines_out.php"
            >Factor conversion routines out into per-character functions
            (wikitext, c5ca963) &raquo;</a
          >
        </p>
        ...
        <h3>
          Flesh out accessor methods for the internal link prefix (wikitext,
          17856f8)
        </h3>

        <p>
          Provide a write accessor which accepts an internal link prefix in
          UTF-8 encoding, stores it to an instance variable, and also stores a
          UCS-2 copy in a separate instance variable. The latter will be used
          during transformations while the former is the version that's visible
          to the caller via the API.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003036more"><div id="more"></div></div>
