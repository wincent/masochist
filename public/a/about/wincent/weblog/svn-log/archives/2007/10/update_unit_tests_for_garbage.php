...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update unit tests for Garbage Collection (WOCommon,
      ba8ebeb)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/update_woregistrationtextfield.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/10/gc_changes_for_wobundle_class.php"
            >&laquo; GC changes for WOBundle class (WOCommon, 6e2d71e)</a
          >
          |
        ...
        <p>
          Eliminate retain and release messages which are no longer necessary in
          a number of unit tests.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002878more"><div id="more"></div></div>
