...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Use note() when cloning xibs (buildtools, ca566a2)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/first_version_of_updatexibssh.php"
      title="First version of UpdateXibs.sh script (buildtools, 2e42c48)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/move_macro_definitions_to_top.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/first_version_of_updatexibssh.php"
            >&laquo; First version of UpdateXibs.sh script (buildtools,
            2e42c48)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/12/move_macro_definitions_to_top.php"
            >Move macro definitions to top of file (Wincent Strings Utility,
            377a3e7) &raquo;</a
          >
        </p>
        ...
        <p>
          When a new xib is created from scratch, notify with note() rather than
          with echo so that if the script is being run from within Xcode the
          notification will appear as a note in the build results window (so as
          to remind the user to add the new file to the project).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003345more"><div id="more"></div></div>
