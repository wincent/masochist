...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Use waitpid consistently in installer tool and parent
      application (gdiff, 6aa0212)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/add_missing_null_in_call_to_ex.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/yet_another_early_return_bug_g.php"
            >&laquo; Yet another early return bug (gdiff, d1813b4)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/add_missing_null_in_call_to_ex.php"
            >Add missing NULL in call to execve (gdiff, 3fd4457) &raquo;</a
          >
        </p>
        ...
        <p>
          Make usage of waitpid consistent across the installer tool and the
          parent application (where it incorrectly used WNOHANG).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002973more"><div id="more"></div></div>
