...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Updated copyright year ranges (WOCommon, 177e5dd)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/07/update_copyright_year_range_sy.php"
            >&laquo; Update copyright year range (Synergy Advance, 68ec4e5)</a
          >
          |
        ...
        <p>
          Update copyright year range to end on 2007 for all files modified this
          year.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002453more"><div id="more"></div></div>
