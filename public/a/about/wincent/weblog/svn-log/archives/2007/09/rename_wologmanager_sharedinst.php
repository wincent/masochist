...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Rename WOLogManager sharedInstance to sharedManager
      (WOCommon, 7975cf4)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/remove_wologmanager_dependency.php"
      title="Remove WOLogManager dependency on WOSingleton (WOCommon, 343dc6b)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/comment_corrections_in_wologma.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/remove_wologmanager_dependency.php"
            >&laquo; Remove WOLogManager dependency on WOSingleton (WOCommon,
            343dc6b)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2007/09/comment_corrections_in_wologma.php"
            >Comment corrections in WOLogManager (WOCommon, a6a07ed) &raquo;</a
          >
        </p>
        ...
        <p>
          Prefer the more descriptive name, sharedManager, to the generic,
          sharedInstance for the singleton instance of the WOLogManager class.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a002721more"><div id="more"></div></div>
