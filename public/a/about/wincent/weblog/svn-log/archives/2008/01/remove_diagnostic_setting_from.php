...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove diagnostic setting from distro script (Synergy,
      2f8f6ae)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/refactor_distribution_script_s.php"
      title="Refactor distribution script (Synergy, a5bf93d)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_headers_to_release_note_se.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/refactor_distribution_script_s.php"
            >&laquo; Refactor distribution script (Synergy, a5bf93d)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_headers_to_release_note_se.php"
            >Add headers to release note sections (Synergy, d2da2bd) &raquo;</a
          >
        </p>
        ...
        <p>
          Remove temporary &quot;set -x&quot; from distro script which was in
          there for diagnostic purposes (didn't actually mean to include it).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003772more"><div id="more"></div></div>
