...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Tags interface (typechecked.net, 37ee0e1)</title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/teach_acts_as_sortable_to_acce.php"
      title="Teach acts_as_sortable to accept default sort order parameter (typechecked.net, 813baad)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/make_separate_administrator_na.php"
      ...
      <div class="content">
        <p align="right">
          <a
            ...
            parameter (typechecked.net, 813baad)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/make_separate_administrator_na.php"
            >Make separate administrator namespace (typechecked.net, 13a0aec)
            &raquo;</a
          >
        </p>
        ...
        <h3>Tags interface (typechecked.net, 37ee0e1)</h3>
