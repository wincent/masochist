...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add pagination to weblog (typechecked.net, b39a0af)
    </title>
    ...
    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/set_up_navbar_wincentcom_6b3cf.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/set_up_navbar_wincentcom_6b3cf.php"
            >Set up navbar (typechecked.net, 6b3cfb4) &raquo;</a
          >
        </p>

        <h2>February 15, 2008</h2>

        <h3>Add pagination to weblog (typechecked.net, b39a0af)</h3>
