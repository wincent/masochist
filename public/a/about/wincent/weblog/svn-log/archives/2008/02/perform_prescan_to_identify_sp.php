...
<title>Git activity log: Perform prescan to identify special links (wikitext, e298dd6)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/remove_local_autolink_variable.php" title="Remove local &amp;quot;autolink&amp;quot; variable (wikitext, cacaf11)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/make_special_link_matching_a_l.php" title="Make &amp;quot;special link&amp;quot; matching a little stricter (wikitext, 9012ad4)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/remove_local_autolink_variable.php">&laquo; Remove local &quot;autolink&quot; variable (wikitext, cacaf11)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/make_special_link_matching_a_l.php">Make &quot;special link&quot; matching a little stricter (wikitext, 9012ad4) &raquo;</a>

</p>

<h2>February 10, 2008</h2>

<h3>Perform prescan to identify special links (wikitext, e298dd6)</h3>

<p>When encoding a link target perform a quick prescan to see if this is a &quot;special&quot; link or not. At this stage, &quot;special&quot; links are those which contain only letters, numbers and slashes. The idea is that whereas a link like &quot;[[foo bar]]&quot; is interpreted as a wiki article link, one like &quot;[[bug/12]]&quot; is interpreted as a link still internal to the site but external to the wiki, specifically to the bug-tracking part of the site which would be accessed with a path like &quot;/bug/12&quot; (as opposed to the wiki article which would have a path like &quot;/wiki/foo%20bar&quot;).</p>

<p>Seeing as the prescan does constitute extra work, only perform it if the treat_slash_as_special instance variable is set to true. On the other hand, when the prescan does identify a special link it aborts the encoding right there and less work is done in that case.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt;</p>

<div id="a004028more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at February 10, 2008  5:54 PM</p>
