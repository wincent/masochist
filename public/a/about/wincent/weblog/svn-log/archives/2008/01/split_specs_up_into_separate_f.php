...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Split specs up into separate files (wikitext, 8ef9a25)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/rakefile_make_rake_spec_emit_c.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/some_more_specs_for_invalid_mi.php"
            >&laquo; Some more specs for invalid missing external link targets
            (wikitext, dcce3be)</a
          >
          |
        ...
        <p>
          The number of specs was starting to get unmanageably large for a
          single file so split them up into multiple files, grouped according to
          tag or general functionality.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003828more"><div id="more"></div></div>
