...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: More consistent normalization of Unicode forms (REnamer,
      a1ecf6e)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_woregularexpressionmatch_c.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/restore_edit_menu_to_synergy_p.php"
            >&laquo; Restore Edit menu to Synergy Preferences application
            (Synergy, ffaa428)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_woregularexpressionmatch_c.php"
            >Add WORegularExpressionMatch class (REnamer, 4d6aeb0) &raquo;</a
          >
        </p>
        ...
        <p>
          This commit includes tests to probe the Unicode normalization issues
          and fixes to get them all passing. I believe that normalization is now
          applied everywhere it needs to be.
        </p>

        <p>
          The key change is that WOCreateMatchDictionary has been changed to
          work using byte ranges rather than character ranges. A nice side
          effect is that the WOCharacterCountForUTF8String function can be
          entirely removed.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003633more"><div id="more"></div></div>
