...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update example data to get specs passing (typechecked.net,
      0a11fad)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/rerun_all_specs_whenever_schem.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/rerun_all_specs_whenever_schem.php"
            >&laquo; Re-run all specs whenever schema changes (typechecked.net,
            9511ecd)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/whitespace_fix_trim_unnecessar.php"
            >Whitespace fix: trim unnecessary empty line (typechecked.net, e0608c3)
            &raquo;</a
          >
        </p>
        ...
        <h3>Update example data to get specs passing (typechecked.net, 0a11fad)</h3>
