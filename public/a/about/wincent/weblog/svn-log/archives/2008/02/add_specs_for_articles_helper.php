...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add specs for Articles helper (typechecked.net, ab4b878)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/full_spec_suite_for_article_mo.php"
            >&laquo; Full spec suite for Article model (typechecked.net, 90d6ef3)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/add_specs_for_articles_routing.php"
            >Add specs for articles routing (typechecked.net, bc941e4) &raquo;</a
          >
        </p>

        <h2>February 13, 2008</h2>

        <h3>Add specs for Articles helper (typechecked.net, ab4b878)</h3>
