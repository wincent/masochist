...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Finish off (wiki) articles controller (typechecked.net,
      e27c63a)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/nicer_css_for_pre_blocks_wince.php"
            >Nicer CSS for PRE blocks (typechecked.net, de69284) &raquo;</a
          >
        </p>

        <h2>February 12, 2008</h2>

        <h3>Finish off (wiki) articles controller (typechecked.net, e27c63a)</h3>
