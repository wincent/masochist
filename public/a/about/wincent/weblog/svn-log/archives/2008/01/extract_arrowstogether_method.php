...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Extract arrowsTogether method and other cleanup
      (REnamer, 4ed8742)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_button_highlighting_in_ver.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_button_highlighting_in_ver.php"
            >&laquo; Fix button highlighting in vertical scrollbar (REnamer,
            2722970)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/teach_wohudscrollview_how_to_s.php"
            >Teach WOHUDScrollView how to scroll (REnamer, 46da7d1) &raquo;</a
          >
        </p>
        ...
        <p>
          Things are slightly neater with the code that determines whether the
          scroll arrows are together or at opposite ends of the scroller is
          extracted out into a separate method.
        </p>

        <p>
          By way of other cleanup, we also rename the knob variable to knobRect
          for consistency with the other variables in the rectForPart: method.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003652more"><div id="more"></div></div>
