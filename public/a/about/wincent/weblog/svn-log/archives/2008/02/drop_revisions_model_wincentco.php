...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Drop Revisions model (typechecked.net, b6312eb)</title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/add_live_preview_to_wiki_wince.php"
      title="Add live preview to wiki (typechecked.net, 8140e20)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/fix_handling_of_permalinks_wit.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/add_live_preview_to_wiki_wince.php"
            >&laquo; Add live preview to wiki (typechecked.net, 8140e20)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/fix_handling_of_permalinks_wit.php"
            >Fix handling of permalinks with periods in them (typechecked.net,
            1a848c1) &raquo;</a
          >
        </p>
        ...
        <h3>Drop Revisions model (typechecked.net, b6312eb)</h3>
