...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Restrict visibility during tag searches (wincent.dev,
      470696b)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/tighten_up_post_atom_feed_gene.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/tighten_up_post_atom_feed_gene.php"
            >&laquo; Tighten up post Atom feed generation (wincent.dev,
            49fce76)</a
          >
          |
        ...
        <h3>Restrict visibility during tag searches (wincent.dev, 470696b)</h3>

        <p>
          The super user can see everything, logged in users can see public
          records plus their own, and anonymous users can see only public
          records.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004195more"><div id="more"></div></div>
