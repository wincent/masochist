...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Simplify creation of WORegularExpressionMatch objects
      (REnamer, 1dd2077)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/test_cleanup_renamer_8a5f9d1.php"
      title="Test clean-up (REnamer, 8a5f9d1)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_broken_subpattern_matching.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/test_cleanup_renamer_8a5f9d1.php"
            >&laquo; Test clean-up (REnamer, 8a5f9d1)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_broken_subpattern_matching.php"
            >Fix broken subpattern matching (REnamer, 8c006bb) &raquo;</a
          >
        </p>
        ...
        <h3>
          Simplify creation of WORegularExpressionMatch objects (REnamer,
          1dd2077)
        </h3>

        <p>
          Rather than calling pcre_get_substring() just create the string
          directly ourselves; the total number of allocations is rougly the same
          but the code is simpler.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003703more"><div id="more"></div></div>
