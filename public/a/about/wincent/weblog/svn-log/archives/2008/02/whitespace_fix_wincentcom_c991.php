...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Whitespace fix (typechecked.net, c9914a6)</title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/drop_html_caching_from_revisio.php"
            >&laquo; Drop HTML caching from revisions table (typechecked.net,
            5313bbb)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/drop_redundant_authentication.php"
            >Drop redundant authentication specs (typechecked.net, 1545453)
            &raquo;</a
          >
        </p>
        ...
        <h3>Whitespace fix (typechecked.net, c9914a6)</h3>
