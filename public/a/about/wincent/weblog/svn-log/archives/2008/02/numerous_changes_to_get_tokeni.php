...
<title>Git activity log: Numerous changes to get tokenization benchmarks working (wikitext, 1d6b2f1)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/fix_file_mapping_in_autotest_f.php" title="Fix file mapping in .autotest file (wikitext, e26ac95)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/move_encoding_benchmarks_into.php" title="Move encoding benchmarks into separate subdirectory (wikitext, 4aaffb1)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/fix_file_mapping_in_autotest_f.php">&laquo; Fix file mapping in .autotest file (wikitext, e26ac95)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/move_encoding_benchmarks_into.php">Move encoding benchmarks into separate subdirectory (wikitext, 4aaffb1) &raquo;</a>

</p>

<h2>February  2, 2008</h2>

<h3>Numerous changes to get tokenization benchmarks working (wikitext, 1d6b2f1)</h3>

<p>Here I add a Wikitext::Parser::Token class to make debugging and testing a little more convenient and introduce the first version of the raw tokenization benchmark.</p>

<p>I've made some other changes to the code here to fix up some flaws discovered during the development of the benchmark, and at the same time gotten rid of stucture passing to and from the next_token (now we only pass pointers, for speed).</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt;</p>

<div id="a003870more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at February  2, 2008  5:55 PM</p>
