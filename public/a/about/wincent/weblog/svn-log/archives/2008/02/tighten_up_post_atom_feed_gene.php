...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Tighten up post Atom feed generation (typechecked.net,
      49fce76)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/bump_version_number_postreleas_9.php"
      title="Bump version number post-release (wikitext, 25838d5)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/restrict_visibility_during_tag.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/restrict_visibility_during_tag.php"
            >Restrict visibility during tag searches (typechecked.net, 470696b)
            &raquo;</a
          >
        </p>
        ...
        <h3>Tighten up post Atom feed generation (typechecked.net, 49fce76)</h3>
