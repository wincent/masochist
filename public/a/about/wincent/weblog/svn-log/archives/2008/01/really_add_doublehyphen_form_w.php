...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Really add double-hyphen form (Wincent Strings Utility,
      a318aff)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/update_man_page_to_use_doubleh.php"
            >&laquo; Update man page to use double-hyphen form (Wincent Strings
            Utility, 211244d)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/pass_null_to_executeandreturne.php"
            >Pass NULL to executeAndReturnError: (Synergy, 994da25) &raquo;</a
          >
        </p>
