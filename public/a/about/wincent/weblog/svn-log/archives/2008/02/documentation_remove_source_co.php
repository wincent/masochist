...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Documentation: remove source code comments covered
      elsewhere (wikitext, 6574117)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_specs_for_internal_special.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_specs_for_internal_special.php"
            >&laquo; Add specs for internal special links (wikitext, 5dafcee)</a
          >
          |
        ...
        <h3>
          Documentation: remove source code comments covered elsewhere
          (wikitext, 6574117)
        </h3>

        <p>
          Remove redundant RDoc comments from the main wikitext module source
          file as these are now covered in the separate RDoc file in the doc
          subdirectory.
        </p>

        <p>
          At the same time update the definition of
          &quot;treat_slashes_as_special&quot; to reflect the new, stricter
