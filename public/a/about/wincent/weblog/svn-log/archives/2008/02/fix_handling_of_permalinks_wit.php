...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix handling of permalinks with periods in them
      (typechecked.net, 1a848c1)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/drop_revisions_model_wincentco.php"
      title="Drop Revisions model (typechecked.net, b6312eb)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/finish_off_wiki_articles_contr.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/drop_revisions_model_wincentco.php"
            >&laquo; Drop Revisions model (typechecked.net, b6312eb)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/finish_off_wiki_articles_contr.php"
            >Finish off (wiki) articles controller (typechecked.net, e27c63a)
            &raquo;</a
          >
        </p>
        ...
        <h3>
          Fix handling of permalinks with periods in them (typechecked.net, 1a848c1)
        </h3>

        <p>
          Rails considers periods to be a route separator, which I think is very
          unfortunate. Fortunately, you can use the :requirements option in the
          routes file to override this on a per-resource basis. This means that
