...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/sanitize_and_limit_tags_in_sea.php"
      title="Sanitize and limit tags in search to 10 (typechecked.net, c90d6d5)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/add_fulltext_search_to_posts_m.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/sanitize_and_limit_tags_in_sea.php"
            >&laquo; Sanitize and limit tags in search to 10 (typechecked.net,
            c90d6d5)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/add_fulltext_search_to_posts_m.php"
            >Add full-text search to Posts model (typechecked.net, 8e8cbcf)
            &raquo;</a
          >
        </p>
        ...
        <h3>
          Extract common tag results code into a partial (typechecked.net, b470ec6)
        </h3>
