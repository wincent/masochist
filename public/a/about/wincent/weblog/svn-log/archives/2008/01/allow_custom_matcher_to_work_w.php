...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Allow custom matcher to work with associations
      (typechecked.net, b2c76ac)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/fix_failure_in_user_spec_super.php"
      title="Fix failure in user spec (superuser mass assignment) (typechecked.net, 7636e1d)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/autoload_fixturereplacement_in.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/fix_failure_in_user_spec_super.php"
            >&laquo; Fix failure in user spec (superuser mass assignment)
            (typechecked.net, 7636e1d)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/autoload_fixturereplacement_in.php"
            >Autoload FixtureReplacement in the console (typechecked.net, 6912254)
            &raquo;</a
          >
        </p>
        ...
        <h3>
          Allow custom matcher to work with associations (typechecked.net, b2c76ac)
        </h3>

        <p>
          This fixes some more spec failures; basically, associations don't
          appear in the attributes hash, so testing for mass assignment o such
          attributes won't work; we have to message the model object directly
          instead asking for the value of the attribute.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003752more"><div id="more"></div></div>
