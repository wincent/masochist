...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Many cosmetic changes (typechecked.net, 4d0860c)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/add_comments_to_weblog_wincent.php"
            >Add comments to weblog (typechecked.net, 5559ac9) &raquo;</a
          >
        </p>

        <h2>February 14, 2008</h2>

        <h3>Many cosmetic changes (typechecked.net, 4d0860c)</h3>
