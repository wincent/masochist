...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add confirmation of emails (typechecked.net, 78a395a)
    </title>
    ...
    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/03/create_products_model_wincentc.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/03/trim_robotstxt_wincentcom_63cd.php"
            >&laquo; Trim robots.txt (typechecked.net, 63cdd2e)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/03/create_products_model_wincentc.php"
            >Create products model (typechecked.net, 68a5a55) &raquo;</a
          >
        </p>

        <h2>March 4, 2008</h2>

        <h3>Add confirmation of emails (typechecked.net, 78a395a)</h3>
