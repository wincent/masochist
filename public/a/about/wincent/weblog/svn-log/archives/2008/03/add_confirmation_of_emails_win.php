...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add confirmation of emails (wincent.dev, 78a395a)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/trim_robotstxt_wincentcom_63cd.php"
            >&laquo; Trim robots.txt (wincent.dev, 63cdd2e)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/create_products_model_wincentc.php"
            >Create products model (wincent.dev, 68a5a55) &raquo;</a
          >
        </p>

        <h2>March 4, 2008</h2>

        <h3>Add confirmation of emails (wincent.dev, 78a395a)</h3>

        <p>
          And a bunch of other tweaks (ideally would have liked to break this up
