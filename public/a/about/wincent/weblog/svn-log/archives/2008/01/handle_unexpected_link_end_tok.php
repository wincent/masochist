...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Handle unexpected link end tokens (wikitext, de1f703)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_specs_for_link_tokens_insi.php"
      title="Add specs for link tokens inside nowiki spans (wikitext, 3fb39a2)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/more_specs_for_unexpected_link.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_specs_for_link_tokens_insi.php"
            >&laquo; Add specs for link tokens inside nowiki spans (wikitext,
            3fb39a2)</a
          >
          |
        ...
        <p>
          In this case we want to just emit them literally. We only test a
          couple of basic scopes here. There are other cases that are known to
          fail at the moment (EM, for example), so specs for those and fixes
          will come in another commit.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003825more"><div id="more"></div></div>
