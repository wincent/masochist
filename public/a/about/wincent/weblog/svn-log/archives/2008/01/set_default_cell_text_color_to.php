...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Set default cell text color to white (REnamer, d347fdf)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/extract_sort_descriptor_method.php"
            >&laquo; Extract sort descriptor methods into NSTableColumn category
            (REnamer, a0bd9ee)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/color_tweaks_for_preview_hud_r.php"
            >Color tweaks for preview HUD (REnamer, eb57d8c) &raquo;</a
          >
        </p>
        ...
        <p>
          White (or light grey) text is needed in HUD stlye windows, so change
          the text color to white in the table cells.
        </p>

        <p>
          Even so, a NSTextField/NSTextFieldCell subclass will still be
          required, I believe, in order to suppress the unwanted blue selection
          highlighting.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003605more"><div id="more"></div></div>
