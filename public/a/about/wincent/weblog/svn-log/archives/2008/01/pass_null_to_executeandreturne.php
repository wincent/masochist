...
<title>Git activity log: Pass NULL to executeAndReturnError: (Synergy, 994da25)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/really_add_doublehyphen_form_w.php" title="Really add double-hyphen form (Wincent Strings Utility, a318aff)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/update_copyright_years_wopubli.php" title="Update copyright years (WOPublic, 5813a39)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/really_add_doublehyphen_form_w.php">&laquo; Really add double-hyphen form (Wincent Strings Utility, a318aff)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/update_copyright_years_wopubli.php">Update copyright years (WOPublic, 5813a39) &raquo;</a>

</p>

<h2>January  7, 2008</h2>

<h3>Pass NULL to executeAndReturnError: (Synergy, 994da25)</h3>

<p>The only known crasher at the moment is happening NSAppleScript's executeAndReturnError: method.</p>

<p>Unfortunately, I can't see anything at all in the calling environment that could explain the crash. The NSAppleScript instance is set up using a static NSString literal which by definition can never be garbage collected. I am beginning to fear that NSAppleScript can't be used at all in a garbage collected environment.</p>

<p>As a defensive tactic I'm updating all invocations of the method to pass NULL for the error dictionary. This usage is not documented, but it does follow a pattern employed by many other Apple APIs and there are plenty of examples of code out there in the wild that do use this pattern.</p>

<p>So basically this is a &quot;try it and see&quot; change to see if it eliminates the sporadic crashes. If it doesn't then more drastic measures will be required, most likely involving the replacement of NSAppleScript with something else (the scripting bridge, for example).</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003482more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at January  7, 2008  1:24 PM</p>
