...
<title>Git activity log: Defer to super if we don't handle the KVO message (REnamer, 0c0ac38)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/improve_keyvalue_observing_of.php" title="Improve key/value observing of user defaults (REnamer, e229a72)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/create_worenamerwindowcontroll.php" title="Create WOREnamerWindowController class (REnamer, 02706a4)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/improve_keyvalue_observing_of.php">&laquo; Improve key/value observing of user defaults (REnamer, e229a72)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/create_worenamerwindowcontroll.php">Create WOREnamerWindowController class (REnamer, 02706a4) &raquo;</a>

</p>

<h2>January 20, 2008</h2>

<h3>Defer to super if we don't handle the KVO message (REnamer, 0c0ac38)</h3>

<p>I can't think of any reason why we would receive a message that we don't handle, but it doesn't hurt to check for this eventuality and defer to super if it ever arises.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003725more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at January 20, 2008 12:50 PM</p>
