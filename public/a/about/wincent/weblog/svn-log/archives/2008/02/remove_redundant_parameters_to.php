...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove redundant parameters to dedent method (wikitext,
      f29d562)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/teach_dedent_helper_to_default.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/teach_dedent_helper_to_default.php"
            >&laquo; Teach dedent helper to default to 6 spaces (wikitext,
            e0ba800)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_live_preview_to_wiki_wince.php"
            >Add live preview to wiki (wincent.dev, 8140e20) &raquo;</a
          >
        </p>
        ...
        <p>
          Given that 6 is the default dedent quantity there's no need to
          explicitly specify it.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004061more"><div id="more"></div></div>
