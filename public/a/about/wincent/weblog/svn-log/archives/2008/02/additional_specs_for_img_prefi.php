...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Additional specs for img_prefix attribute (wikitext,
      2a1afb2)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_ability_to_set_and_overrid.php"
      title="Add ability to set and override image prefix (wikitext, 60c9b60)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/more_img_specs_wikitext_8853b7.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_ability_to_set_and_overrid.php"
            >&laquo; Add ability to set and override image prefix (wikitext,
            60c9b60)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/more_img_specs_wikitext_8853b7.php"
            >More img specs (wikitext, 8853b7d) &raquo;</a
          >
        </p>
        ...
        <p>
          These were previously tested in the context of img tag generation (see
          img_spec.rb). Now we test the same thing, but in isolation using
          attribute accessors.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004160more"><div id="more"></div></div>
