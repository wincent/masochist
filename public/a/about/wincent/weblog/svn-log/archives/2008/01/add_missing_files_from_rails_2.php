...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add missing files from Rails 2.0.2 upgrade (typechecked.net,
      ff52bbb)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/upgrade_rspec_to_111_wincentco.php"
      title="Upgrade RSpec to 1.1.1 (typechecked.net, 9adf928)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/user_defaults_cleanup_renamer.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/upgrade_rspec_to_111_wincentco.php"
            >&laquo; Upgrade RSpec to 1.1.1 (typechecked.net, 9adf928)</a
          >
          |
        ...
        <h3>
          Add missing files from Rails 2.0.2 upgrade (typechecked.net, ff52bbb)
        </h3>
