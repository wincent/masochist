...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: User spec fixes for mass assignment (typechecked.net,
      ab7e57d)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/remove_comment_about_rspec_bug.php"
            >&laquo; Remove comment about RSpec bug (typechecked.net, f7ebc62)</a
          >
          |
        ...
        <h3>User spec fixes for mass assignment (typechecked.net, ab7e57d)</h3>
