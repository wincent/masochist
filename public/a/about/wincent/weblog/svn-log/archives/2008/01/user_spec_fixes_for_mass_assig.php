...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: User spec fixes for mass assignment (wincent.dev,
      ab7e57d)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/remove_comment_about_rspec_bug.php"
            >&laquo; Remove comment about RSpec bug (wincent.dev, f7ebc62)</a
          >
          |
        ...
        <h3>User spec fixes for mass assignment (wincent.dev, ab7e57d)</h3>

        <p>
          Add a custom matcher to the spec helper to make testing for mass
          assignment a little easier.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003748more"><div id="more"></div></div>
