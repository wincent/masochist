...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update README file to include upgrade instructions
      (Synergy, fc2cb8c)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/hook_up_help_menu_item_in_syne.php"
      title="Hook up Help menu item in Synergy Preferences (Synergy, ff31fab)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/bump_version_number_prior_to_r.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/hook_up_help_menu_item_in_syne.php"
            >&laquo; Hook up Help menu item in Synergy Preferences (Synergy,
            ff31fab)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/bump_version_number_prior_to_r.php"
            >Bump version number prior to release (Synergy, e4c120f) &raquo;</a
          >
        </p>
        ...
        <h3>
          Update README file to include upgrade instructions (Synergy, fc2cb8c)
        </h3>

        <p>
          The new version of Synergy automatically detects any older versions on
          the system and offers to clean it up for you; mention this in the
          README file so that people looking for upgrade instructions won't be
          confused.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003496more"><div id="more"></div></div>
