...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove unnecessary use of objc_msgSend() (REnamer,
      872e3a8)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_utf8_regular_expression_ma.php"
            >&laquo; Fix UTF-8 regular expression matching (REnamer, e1df3cb)</a
          >
          |
        ...
        <p>
          There is really no need for this here as a normal message send can be
          used without provoking any GCC warnings.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003631more"><div id="more"></div></div>
