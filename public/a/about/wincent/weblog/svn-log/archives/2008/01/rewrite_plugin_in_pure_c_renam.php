...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Rewrite plug-in in pure C (REnamer, c217062)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/update_icns_files_with_512x512.php"
            >&laquo; Update icns files with 512x512 icon (REnamer, 4f2b59e)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/avoid_temporary_object_creatio.php"
            >Avoid temporary object creation in plug-in (REnamer, c881c75)
            &raquo;</a
          >
        </p>
        ...
        <p>
          Garbage Collection details should be a bit easier to cope with if this
          is written in pure C (using Core Foundation) rather than Objective-C.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003510more"><div id="more"></div></div>
