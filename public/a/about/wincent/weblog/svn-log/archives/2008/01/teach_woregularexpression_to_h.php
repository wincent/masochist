...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Teach WORegularExpression to handle invalid substitution
      expressions (REnamer, 354d493)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_nsstring_category_for_chec.php"
      title="Add NSString category for checking substitution validity (REnamer, 3e9e2db)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_codelevel_notes_for_plugin.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_nsstring_category_for_chec.php"
            >&laquo; Add NSString category for checking substitution validity
            (REnamer, 3e9e2db)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_codelevel_notes_for_plugin.php"
            >Add code-level notes for plug-in (REnamer, 900e393) &raquo;</a
          >
        </p>
        ...
        <h3>
          Teach WORegularExpression to handle invalid substitution expressions
          (REnamer, 354d493)
        </h3>
        ...
        <p>
          We check for substitution validity at the time when the substitution
          string is set, to avoid doing it repeatedly in a tight loop when
          working on many files.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003693more"><div id="more"></div></div>
