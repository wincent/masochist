...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Sanitize and limit tags in search to 10 (wincent.dev,
      c90d6d5)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_search_form_to_tag_search.php"
      title="Add search form to tag search results page (wincent.dev, d828803)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/extract_common_tag_results_cod.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_search_form_to_tag_search.php"
            >&laquo; Add search form to tag search results page (wincent.dev,
            d828803)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/extract_common_tag_results_cod.php"
            >Extract common tag results code into a partial (wincent.dev,
            b470ec6) &raquo;</a
          >
        </p>
        ...
        <h3>Sanitize and limit tags in search to 10 (wincent.dev, c90d6d5)</h3>

        <p>
          Remove duplicate tags in search query and limit the total number to 10
          to guard against attacks on the database. It is highly unlikely that a
          search with more than 10 tags would return any results anyway, given
          that the average number of tags per item is probably well under five.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004197more"><div id="more"></div></div>
