...
<title>Git activity log: More array wrapper instrumentation: delete calls (wikitext, ea8fc88)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/instrument_array_functions_to.php" title="Instrument array functions to pick optimal buffer size (wikitext, 2199333)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/initial_version_of_custom_arra.php" title="Initial version of custom array API (wikitext, 9eae746)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/instrument_array_functions_to.php">&laquo; Instrument array functions to pick optimal buffer size (wikitext, 2199333)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/initial_version_of_custom_arra.php">Initial version of custom array API (wikitext, 9eae746) &raquo;</a>

</p>

<h2>February  4, 2008</h2>

<h3>More array wrapper instrumentation: delete calls (wikitext, ea8fc88)</h3>

<p>This time we instrument delete calls. Turns out that almost all of them (about 2,000) are popping off the end (with an index of -1); another 18 has an index parameter other than -1 but there were still popping items of the end.</p>

<p>So we'll optimize for exactly that case: deleting from the end (most likely by simply changing the count).</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt;</p>

<div id="a003885more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at February  4, 2008 11:48 PM</p>
