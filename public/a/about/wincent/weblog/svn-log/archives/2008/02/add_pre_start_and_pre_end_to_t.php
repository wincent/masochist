...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add PRE_START and PRE_END to token.c (wikitext, c9137ef)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_tokenizing_mode_to_wikitex.php"
            >&laquo; Add tokenizing mode to &quot;wikitext&quot; tool (wikitext,
            34c34cc)</a
          >
          |
        ...
        <p>
          Without this we can't see those new tokens in our token dumps during
          debugging.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004040more"><div id="more"></div></div>
