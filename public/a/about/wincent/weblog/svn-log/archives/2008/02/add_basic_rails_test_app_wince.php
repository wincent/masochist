...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add basic Rails test app (typechecked.net, 9434674)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/bump_version_number_for_06_rel.php"
      title="Bump version number for 0.6 release (wikitext, e7bd194)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/remove_default_indexhtml_wince.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/remove_default_indexhtml_wince.php"
            >Remove default index.html (typechecked.net, 1c84a1c) &raquo;</a
          >
        </p>

        <h2>February 29, 2008</h2>

        <h3>Add basic Rails test app (typechecked.net, 9434674)</h3>
