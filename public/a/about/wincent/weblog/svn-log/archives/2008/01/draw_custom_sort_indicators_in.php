...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Draw custom sort indicators in HUD table view (REnamer,
      cbd1796)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/draw_alternating_row_backgroun_1.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/dim_text_in_location_column_re.php"
            >&laquo; Dim text in location column (REnamer, 02d4ca8)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/draw_alternating_row_backgroun_1.php"
            >Draw alternating row backgrounds all the way to the bottom
            (REnamer, 6fcc806) &raquo;</a
          >
        </p>
        ...
        <p>
          The default sort indicators are practically invisible with the HUD
          colors, so draw some custom ones instead.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003618more"><div id="more"></div></div>
