...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Use WOHUDScrollView class in main nib (REnamer, 755e2c3)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_wohudscrollview_class_rena.php"
            >&laquo; Add WOHUDScrollView class (REnamer, fecdc0c)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/custom_nsscroller_subclass_ren.php"
            >Custom NSScroller subclass (REnamer, 3fa4cd7) &raquo;</a
          >
        </p>
        ...
        <p>
          Start using the just-created WOHUDScrollView class in the main menu
          nib.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003626more"><div id="more"></div></div>
