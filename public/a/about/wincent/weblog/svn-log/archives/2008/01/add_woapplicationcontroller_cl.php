...
<title>Git activity log: Add WOApplicationController class (REnamer, d5f6402)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/prepare_to_copy_pcre_license_i.php" title="Prepare to copy PCRE license into application bundle (REnamer, d758e7c)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/make_worenamercontroller_an_ns.php" title="Make WOREnamerController an NSWindowController subclass (REnamer, c598bef)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/prepare_to_copy_pcre_license_i.php">&laquo; Prepare to copy PCRE license into application bundle (REnamer, d758e7c)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/make_worenamercontroller_an_ns.php">Make WOREnamerController an NSWindowController subclass (REnamer, c598bef) &raquo;</a>

</p>

<h2>January 18, 2008</h2>

<h3>Add WOApplicationController class (REnamer, d5f6402)</h3>

<p>This is the first commit in a series which might turn out to be a somewhat painful migration. The end goal is to make a dedicated application controller class that works with per-window controllers, one for each rename operation in progress.</p>

<p>I didn't do this originally due to lack of foresight; but the truth is that a user can start one rename, then go to the Finder and start another before setting the first one in action, and so on indefinitely.</p>

<p>The nicest way to handle this is to have one application instance which uses a &quot;document&quot; model and opens one window for each batch of files to be renamed.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003711more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at January 18, 2008 10:23 PM</p>
