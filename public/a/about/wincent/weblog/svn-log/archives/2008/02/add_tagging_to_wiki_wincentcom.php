...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Add tagging to wiki (typechecked.net, de6322a)</title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/move_scaled_tag_helper_functio.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/add_initial_validations_for_ar.php"
            >Add initial validations for Article model (typechecked.net, 5881ce0)
            &raquo;</a
          >
        </p>
        ...
        <h3>Add tagging to wiki (typechecked.net, de6322a)</h3>
