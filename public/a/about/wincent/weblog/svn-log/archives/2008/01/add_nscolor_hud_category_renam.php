...
<title>Git activity log: Add NSColor HUD category (REnamer, c338e66)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/update_argument_handling_in_ma.php" title="Update argument handling in main application (REnamer, 6340d58)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/xcode_project_bundle_updates_r.php" title="Xcode project bundle updates (REnamer, cc55e06)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/update_argument_handling_in_ma.php">&laquo; Update argument handling in main application (REnamer, 6340d58)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/xcode_project_bundle_updates_r.php">Xcode project bundle updates (REnamer, cc55e06) &raquo;</a>

</p>

<h2>January 18, 2008</h2>

<h3>Add NSColor HUD category (REnamer, c338e66)</h3>

<p>Not sure whether this is a good idea or not so I haven't included this code in the application, but it is a demonstration of how we could get rid of our macros (which re-instantiate the color objects on every use) and replace them with persistent singleton objects.</p>

<p>This is a space-for-time tradeoff which we probably only need to make if profiling indicates that it's required.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt;</p>

<div id="a003696more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at January 18, 2008 12:07 PM</p>
