...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix handling of unclosed span-level elements in lists
      (wikitext, 2a996a7)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_specs_to_catch_regressions.php"
            >&laquo; Add specs to catch regressions (wikitext, 01ada5a)</a
          >
          |
        ...
        <p>
          This commit adds some specs which uncovered the problem as well as the
          rather simple fix.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004017more"><div id="more"></div></div>
