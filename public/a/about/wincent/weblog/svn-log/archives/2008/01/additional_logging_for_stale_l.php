...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Additional logging for stale login items (WOCommon,
      4d74d72)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/watch_out_for_nil_login_item_w.php"
      title="Watch out for nil login item (WOCommon, 26afae1)"
    />

    <link
      rel="next"
      href="https://wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/translate_spanish_text_in_syne.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/watch_out_for_nil_login_item_w.php"
            >&laquo; Watch out for nil login item (WOCommon, 26afae1)</a
          >
          |
        ...
        <p>
          We now have confirmation that the problem described in bug #636 is
          caused by stale entries in the login items (file not found on disk).
          Commit 26afae1 already fixes the crash caused by this, but here we add
          some additional logging for this case; informing the user of the stale
          entry makes the log entry more helpful than just reporting &quot;error
          -43&quot;.
        </p>
        ...
        <div id="a003492more"><div id="more"></div></div>
