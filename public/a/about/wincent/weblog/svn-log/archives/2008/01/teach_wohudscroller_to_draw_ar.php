...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Teach WOHUDScroller to draw arrows in the scroller
      buttons (REnamer, f3b70d5)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/eliminate_smearing_problems_wh.php"
            >&laquo; Eliminate smearing problems when dragging scroll knobs
            (REnamer, db0eecf)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/refactor_arrow_rendering_renam.php"
            >Refactor arrow rendering (REnamer, 135bab7) &raquo;</a
          >
        </p>
        ...
        <h3>
          Teach WOHUDScroller to draw arrows in the scroller buttons (REnamer,
          f3b70d5)
        </h3>

        <p>
          There is still some scope for refactoring here; note that the up arrow
          in the flipped coordinate system is the same as the down arrow in the
          unflipped coordinate system, and the flipped down arrow is the same as
          the unflipped up arrow.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003648more"><div id="more"></div></div>
