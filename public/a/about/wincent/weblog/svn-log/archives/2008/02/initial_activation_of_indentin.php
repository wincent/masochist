...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Initial activation of indenting code (wikitext, ee665c4)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/hook_up_indentation_method_wik.php"
      title="Hook up indentation method (wikitext, a7bc5e6)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/adjust_external_links_specs_fo.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/hook_up_indentation_method_wik.php"
            >&laquo; Hook up indentation method (wikitext, a7bc5e6)</a
          >
          |
        ...
        <p>
          At the moment this breaks some of the specs but I wanted to get it in
          the repository in any case as it looks to be very nearly complete.
        </p>

        <p>
          Will follow this up with edits to the specs to make them pass, as
          there are now many expected results that will need to be modified to
          include the indentation.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003996more"><div id="more"></div></div>
