...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Teach HUD corner view to draw lower border (REnamer,
      8a39fdf)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/teach_wohudtableview_to_use_cu.php"
      title="Teach WOHUDTableView to use custom corner view (REnamer, d1e387b)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/simplify_custom_table_header_c.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/teach_wohudtableview_to_use_cu.php"
            >&laquo; Teach WOHUDTableView to use custom corner view (REnamer,
            d1e387b)</a
          >
          |
        ...
        <p>
          This is for consistency with the custom table header cell. It should
          work equally well in unflipped (the default) and flipped coordinate
          systems.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003668more"><div id="more"></div></div>
