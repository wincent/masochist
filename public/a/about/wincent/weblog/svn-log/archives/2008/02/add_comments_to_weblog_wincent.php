...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add comments to weblog (typechecked.net, 5559ac9)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/many_cosmetic_changes_wincentc.php"
      title="Many cosmetic changes (typechecked.net, 4d0860c)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/inline_moderation_of_post_comm.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/many_cosmetic_changes_wincentc.php"
            >&laquo; Many cosmetic changes (typechecked.net, 4d0860c)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/inline_moderation_of_post_comm.php"
            >Inline moderation of post comments (typechecked.net, ec346e2)
            &raquo;</a
          >
        </p>
        ...
        <h3>Add comments to weblog (typechecked.net, 5559ac9)</h3>
