...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add usage notes for in_place_editor_field (typechecked.net,
      59cc4a8)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/extract_in_place_editor_field.php"
            >&laquo; Extract in_place_editor_field_id function (typechecked.net,
            4539ee9)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/flesh_out_locales_controller_w.php"
            >Flesh out locales controller (typechecked.net, 9bd9613) &raquo;</a
          >
        </p>
        ...
        <h3>
          Add usage notes for in_place_editor_field (typechecked.net, 59cc4a8)
        </h3>
