...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Trim trailing whitespace from internal link text
      (wikitext, fdf390a)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/suppress_whitespace_immediatel.php"
            >&laquo; Suppress whitespace immediately after the separator in
            internal links (wikitext, 968db92)</a
          >
          |
        ...
        <p>
          This follows up on the preceding commit that trimmed leading
          whitespace.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003932more"><div id="more"></div></div>
