...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add explicit dependency information to Makefile
      (wikitext, 0134138)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/rename_ary_delete_at_to_ary_po.php"
            >&laquo; Rename ary_delete_at to ary_pop (wikitext, d2ea29f)</a
          >
          |
        ...
        <h3>
          Add explicit dependency information to Makefile (wikitext, 0134138)
        </h3>
        ...
        <div id="a003897more"><div id="more"></div></div>
