...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update argument handling in main application (REnamer,
      6340d58)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_nscolor_hud_category_renam.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_codelevel_notes_for_plugin.php"
            >&laquo; Add code-level notes for plug-in (REnamer, 900e393)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_nscolor_hud_category_renam.php"
            >Add NSColor HUD category (REnamer, c338e66) &raquo;</a
          >
        </p>
        ...
        <p>
          First up, under Garbage Collection we can use a shorter idiom to
          initialize the mutable arguments array.
        </p>

        <p>
          Secondly, note that we can do this processing in
          application:openFiles: rather than in init.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003695more"><div id="more"></div></div>
