...
<title>Git activity log: Suppress whitespace immediately after the separator in internal links (wikitext, 968db92)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/minor_update_to_readme_testing.php" title="Minor update to README (testing) (wikitext, d8dfb10)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/trim_trailing_whitespace_from.php" title="Trim trailing whitespace from internal link text (wikitext, fdf390a)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/minor_update_to_readme_testing.php">&laquo; Minor update to README (testing) (wikitext, d8dfb10)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/trim_trailing_whitespace_from.php">Trim trailing whitespace from internal link text (wikitext, fdf390a) &raquo;</a>

</p>

<h2>February  6, 2008</h2>

<h3>Suppress whitespace immediately after the separator in internal links (wikitext, 968db92)</h3>

<p>If we've seen the internal link start marker, the link target, and the separator, we know we're guaranteed to have a valid link (even if the user doesnt close it we will auto-close it). In this case it is safe to suppress the emission of whitespace rather than letting it through and sanitizing afterwards (like we have to do with spaces that come before the separator).</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt;</p>

<div id="a003931more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at February  6, 2008  5:28 PM</p>
