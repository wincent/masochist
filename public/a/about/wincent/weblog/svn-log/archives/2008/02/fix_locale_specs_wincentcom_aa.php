...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Fix locale specs (wincent.dev, aa385f3)</title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/minimal_changes_to_get_email_s.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/minimal_changes_to_get_email_s.php"
            >&laquo; Minimal changes to get Email specs passing (wincent.dev,
            1bffd19)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/rerun_all_specs_whenever_schem.php"
            >Re-run all specs whenever schema changes (wincent.dev, 9511ecd)
            &raquo;</a
          >
        </p>
        ...
        <h3>Fix locale specs (wincent.dev, aa385f3)</h3>

        <p>Again, minimal changes to get them running.</p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003956more"><div id="more"></div></div>
