...
<title>Git activity log: Fix in-app regular expression failures (REnamer, 33a0178)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/remove_unnecessary_use_of_objc.php" title="Remove unnecessary use of objc_msgSend() (REnamer, 872e3a8)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/restore_edit_menu_to_synergy_p.php" title="Restore Edit menu to Synergy Preferences application (Synergy, ffaa428)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/remove_unnecessary_use_of_objc.php">&laquo; Remove unnecessary use of objc_msgSend() (REnamer, 872e3a8)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/restore_edit_menu_to_synergy_p.php">Restore Edit menu to Synergy Preferences application (Synergy, ffaa428) &raquo;</a>

</p>

<h2>January 13, 2008</h2>

<h3>Fix in-app regular expression failures (REnamer, 33a0178)</h3>

<p>While the unit tests were working perfectly, the in-app functionality was broken for UTF-8 input. The unit tests worked because they were using precomposed UTF-8 for both subject and pattern, while the in-app use of the same functions was failing because the pattern supplied by the user was precomposed UTF-8 but the file name supplied by the system was decomposed UTF-8.</p>

<p>We work around this by using fileSystemRepresentation rather than UTF-8 string, thus normalizing inputs before performing the regular expression match.</p>

<p>This should be fine because we are operating on filesystem objects -- we know the original name will always be decomposed UTF-8 -- so there is no harm in always returning decomposed UTF-8 as well; in other words, this normalization will not lead to spurious rename operations (same file name merely composed differently).</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003632more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at January 13, 2008  2:07 PM</p>
