...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add QTrace to vendor/disabled (typechecked.net, 7dbf482)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/override_local_request_method.php"
      title="Override local_request? method for previewing errors (typechecked.net, 9d5b9a1)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/remove_rails_graphic_from_publ.php"
      ...
      <div class="content">
        <p align="right">
          ...
          <a
            ...
            (typechecked.net, 9c4a451) &raquo;</a
          >
        </p>

        <h2>January 26, 2008</h2>

        <h3>Add QTrace to vendor/disabled (typechecked.net, 7dbf482)</h3>
