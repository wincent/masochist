...
<title>Git activity log: Let the compiler decide when to inline (wikitext, cf1128c)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/fix_bug_in_trim_link_target_fu.php" title="Fix bug in &amp;quot;trim link target&amp;quot; function (wikitext, 44d9cec)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/fix_spelling_error_in_benchmar.php" title="Fix spelling error in benchmark notes (wikitext, 1a59fd3)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/fix_bug_in_trim_link_target_fu.php">&laquo; Fix bug in &quot;trim link target&quot; function (wikitext, 44d9cec)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/fix_spelling_error_in_benchmar.php">Fix spelling error in benchmark notes (wikitext, 1a59fd3) &raquo;</a>

</p>

<h2>February 29, 2008</h2>

<h3>Let the compiler decide when to inline (wikitext, cf1128c)</h3>

<p>This change was initially prompted because I was getting duplicate symbol errors when linking for functions which should have been inlined on RHEL 5.1.</p>

<p>My first trouble-shooting technique was disabling inlining to confirm that the linker errors went away (they did) but it turns out that there was a secondary benefit: the compiler is actually much smarter than me, because when I leave things up to the compiler instead of explicitly requesting inlining, the spec suite runs 10 to 20% faster. There is quite a bit of Ruby/RSpec overhead in the spec suite, so the speed improvement of the parser itself is probably significantly more.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt;</p>

<div id="a004190more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at February 29, 2008  1:12 PM</p>
