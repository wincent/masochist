...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Auto-generation of blog post permalinks (typechecked.net,
      f71a66b)
    </title>
    ...
    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/handle_pathological_case_in_po.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/remove_localization_code_wince.php"
            >&laquo; Remove localization code (typechecked.net, 285fd68)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/handle_pathological_case_in_po.php"
            >Handle pathological case in post permalink generation (typechecked.net,
            e4136b1) &raquo;</a
          >
        </p>
        ...
        <h3>Auto-generation of blog post permalinks (typechecked.net, f71a66b)</h3>
