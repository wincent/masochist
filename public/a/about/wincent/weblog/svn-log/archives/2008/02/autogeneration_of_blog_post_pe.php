...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Auto-generation of blog post permalinks (wincent.dev,
      f71a66b)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/handle_pathological_case_in_po.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/remove_localization_code_wince.php"
            >&laquo; Remove localization code (wincent.dev, 285fd68)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/handle_pathological_case_in_po.php"
            >Handle pathological case in post permalink generation (wincent.dev,
            e4136b1) &raquo;</a
          >
        </p>
        ...
        <h3>Auto-generation of blog post permalinks (wincent.dev, f71a66b)</h3>

        <p>
          It would be nice if we could normalize everything to ASCII but Iconv
          can't be trusted to do the same thing across platforms so instead opt
          for an even lossier approach: basically everything that's not ASCII is
          converted into a hyphen.
        </p>

        <p>
          We perform one database query to see if there's a clash to make sure
          that we generate a unique permalink each time. This would be racy in a
          multi-user scenario but it's envisaged that I'll be the only one
