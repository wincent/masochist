...
<title>Git activity log: Auto-generation of blog post permalinks (wincent.com, f71a66b)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/remove_localization_code_wince.php" title="Remove localization code (wincent.com, 285fd68)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/handle_pathological_case_in_po.php" title="Handle pathological case in post permalink generation (wincent.com, e4136b1)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/remove_localization_code_wince.php">&laquo; Remove localization code (wincent.com, 285fd68)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/handle_pathological_case_in_po.php">Handle pathological case in post permalink generation (wincent.com, e4136b1) &raquo;</a>

</p>

<h2>February 16, 2008</h2>

<h3>Auto-generation of blog post permalinks (wincent.com, f71a66b)</h3>

<p>It would be nice if we could normalize everything to ASCII but Iconv can't be trusted to do the same thing across platforms so instead opt for an even lossier approach: basically everything that's not ASCII is converted into a hyphen.</p>

<p>We perform one database query to see if there's a clash to make sure that we generate a unique permalink each time. This would be racy in a multi-user scenario but it's envisaged that I'll be the only one publishing articles so this is probably fine.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt;</p>

<div id="a004134more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at February 16, 2008  9:31 PM</p>
