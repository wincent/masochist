...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add NSDrawer delegate methods (REnamer, 921ccc5)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/force_way_to_front_on_launch_r.php"
      title="Force way to front on launch (REnamer, 2670577)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/autosave_adjustments_renamer_4.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/force_way_to_front_on_launch_r.php"
            >&laquo; Force way to front on launch (REnamer, 2670577)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/autosave_adjustments_renamer_4.php"
            >Autosave adjustments (REnamer, 4428255) &raquo;</a
          >
        </p>
        ...
        <p>
          It appears that the automatic resizing of open drawers when the parent
          window resizes is broken on Leopard (at least, I can't remember it
          being like this under Tiger and I have seen one mailing list post from
          someone describing the same problem on Leopard).
        </p>

        <p>
          The docs would suggest that the delegate should receive a
          drawerWillResizeContents:toSize: message whenever the parent window is
          resized, but no such messages are received.
        </p>

        <p>
          I am not sure whether this is a big enough deal to implement a work
          around just yet, so for now just making note of this here and in the
          code.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003686more"><div id="more"></div></div>
