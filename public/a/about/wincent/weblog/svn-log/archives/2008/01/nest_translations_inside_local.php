...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Nest translations inside locales (wincent.dev, bb54bc7)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/split_application_readme_into.php"
            >&laquo; Split application README into two files (wincent.dev,
            9f3f65e)</a
          >
          |
        ...
        <h3>Nest translations inside locales (wincent.dev, bb54bc7)</h3>

        <p>
          Nested routes make sense here seeing as translations always, always
          exist within the context of a given locale.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003782more"><div id="more"></div></div>
