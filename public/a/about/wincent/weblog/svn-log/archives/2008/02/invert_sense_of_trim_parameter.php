...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Invert sense of &quot;trim&quot; parameter in
      sanitization function (wikitext, e3b5ea0)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/teach_link_sanitization_functi.php"
      title="Teach link sanitization function to take a parser struct parameter (wikitext, 4256e0a)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/implement_space_to_underscore.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/teach_link_sanitization_functi.php"
            >&laquo; Teach link sanitization function to take a parser struct
            parameter (wikitext, 4256e0a)</a
          >
          |
        ...
        <h3>
          Invert sense of &quot;trim&quot; parameter in sanitization function
          (wikitext, e3b5ea0)
        </h3>

        <p>
          There are only two real call sites of this function, one in rollback
          mode and the other when emitting a valid link. Rename the parameter to
          &quot;rollback&quot; and invert the sense so that passing Qtrue
          indicates &quot;in rollback mode&quot; and Qfalse &quot;not in
          rollback mode&quot;.
        </p>

        <p>
          This in turn will help us when converting spaces to underscores when
