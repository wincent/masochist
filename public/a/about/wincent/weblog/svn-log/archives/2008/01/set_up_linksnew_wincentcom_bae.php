...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Set up links/new (wincent.dev, bae2447)</title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/new_models_lib_additions_and_r.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/new_models_lib_additions_and_r.php"
            >&laquo; New models, lib additions and refactoring (wincent.dev,
            a9173ba)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_linkscreate_action_wincent.php"
            >Add links/create action (wincent.dev, 9d91051) &raquo;</a
          >
        </p>

        <h2>January 29, 2008</h2>

        <h3>Set up links/new (wincent.dev, bae2447)</h3>

        <p>And supporting CSS.</p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003814more"><div id="more"></div></div>
