...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Custom NSDocumentController subclass (REnamer, db7c7de)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/force_window_to_front_on_subse.php"
            >&laquo; Force window to front on subsequent &quot;open&quot; events
            (REnamer, f8562dc)</a
          >
          |
        ...
        <p>
          At this stage this is just an empty subclass, but I've integrated it
          into the application launch procedure.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003739more"><div id="more"></div></div>
