...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Migrate to Objective-C 2.0 properties in the controller
      (REnamer, 5197559)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_typo_in_doxygen_comment_re.php"
            >&laquo; Fix typo in Doxygen comment (REnamer, c807063)</a
          >
          |
        ...
        <h3>
          Migrate to Objective-C 2.0 properties in the controller (REnamer,
          5197559)
        </h3>
        ...
        <div id="a003561more"><div id="more"></div></div>
