...
<title>Git activity log: Add tokenization of literal blockquote tags (wikitext, 8888a18)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/add_specs_for_treat_slash_as_s.php" title="Add specs for treat_slash_as_special instance variable (wikitext, ca14d4c)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/update_list_and_header_rules_f.php" title="Update list and header rules for new BLOCKQUOTE_START token (wikitext, 9e985ab)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/add_specs_for_treat_slash_as_s.php">&laquo; Add specs for treat_slash_as_special instance variable (wikitext, ca14d4c)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/update_list_and_header_rules_f.php">Update list and header rules for new BLOCKQUOTE_START token (wikitext, 9e985ab) &raquo;</a>

</p>

<h2>February 10, 2008</h2>

<h3>Add tokenization of literal blockquote tags (wikitext, 8888a18)</h3>

<p>This is the first step in adding support for literal &lt;blockquote&gt; and &lt;/blockquote&gt; tags. The rationale for this is that when quoting large slabs of text it is much more convenient to use starting and ending tags rather than prefixing every single line with a greater-than sign.</p>

<p>Because blockquote and pre blocks are intimately interrelated I won't allow mixing the two types of syntax, as it could produce results too confusing for the user.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt;</p>

<div id="a004047more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at February 10, 2008 10:04 PM</p>
