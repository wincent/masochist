...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add tokenization of literal blockquote tags (wikitext,
      8888a18)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/update_list_and_header_rules_f.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_specs_for_treat_slash_as_s.php"
            >&laquo; Add specs for treat_slash_as_special instance variable
            (wikitext, ca14d4c)</a
          >
          |
        ...
        <p>
          This is the first step in adding support for literal
          &lt;blockquote&gt; and &lt;/blockquote&gt; tags. The rationale for
          this is that when quoting large slabs of text it is much more
          convenient to use starting and ending tags rather than prefixing every
          single line with a greater-than sign.
        </p>

        <p>
          Because blockquote and pre blocks are intimately interrelated I won't
          allow mixing the two types of syntax, as it could produce results too
          confusing for the user.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004047more"><div id="more"></div></div>
