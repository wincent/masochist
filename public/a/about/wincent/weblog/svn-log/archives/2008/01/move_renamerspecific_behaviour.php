...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Move REnamer-specific behaviour down into subclass
      (REnamer, 593e1a6)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/snap_window_size_to_table_view.php"
      title="Snap window size to table view row height (REnamer, 97148f1)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/tweak_nib_geometry_to_silence.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/snap_window_size_to_table_view.php"
            >&laquo; Snap window size to table view row height (REnamer,
            97148f1)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/tweak_nib_geometry_to_silence.php"
            >Tweak nib geometry to silence nib compilation warnings (REnamer,
            090e5d1) &raquo;</a
          >
        </p>
        ...
        <p>
          ...
          implemented in my WOHUDTableView subclass. I've now extracted this
          into a subclass of its own so that the parent class is more or less
          limited to clean, general functionality that would be usable in any
          application that wants to put a table view in a HUD.
        </p>

        <p>
          Application-specific behaviour that is now in the subclass includes
          the row-resizing behaviour (this requires the table view to be the
          NSWindow delegate, so it's not very generalizable) and the ability to
          drag the window by clicking in the table (this is not very
          generalizable because it makes row selection impossible and is thus
          suited to read-only/display-only tables).
        </p>

        <p>
          These limitations work well for REnamer, so I've run with them; I am
          sure that there are other ways but they would be more complex so best
          to leave them unexplored until they are actually needed.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003622more"><div id="more"></div></div>
