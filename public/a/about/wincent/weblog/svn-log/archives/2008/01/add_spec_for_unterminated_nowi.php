...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add spec for unterminated nowiki span in external link
      text (wikitext, 0380619)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_code_for_terminating_inter.php"
      title="Add code for terminating internal links on hitting line endings (wikitext, 9dd814f)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/move_link_encoding_function_an.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_code_for_terminating_inter.php"
            >&laquo; Add code for terminating internal links on hitting line
            endings (wikitext, 9dd814f)</a
          >
          |
        ...
        <h3>
          Add spec for unterminated nowiki span in external link text (wikitext,
          0380619)
        </h3>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003836more"><div id="more"></div></div>
