...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add code for terminating internal links on hitting line
      endings (wikitext, 9dd814f)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_typo_in_unordered_list_spe.php"
            >&laquo; Fix typo in unordered list specs (wikitext, 2e7ed73)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_spec_for_unterminated_nowi.php"
            >Add spec for unterminated nowiki span in external link text
            (wikitext, 0380619) &raquo;</a
          >
        </p>
        ...
        <h3>
          Add code for terminating internal links on hitting line endings
          (wikitext, 9dd814f)
        </h3>

        <p>
          Another step towards getting internal links working; still a few more
          to go.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003835more"><div id="more"></div></div>
