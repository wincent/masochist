...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Import help files from Hextrapolate (REnamer, 3b343f9)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/sort_files_in_xcode_listing_re.php"
      title="Sort files in Xcode listing (REnamer, e2ec52f)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_files_from_wocommon_needed.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/sort_files_in_xcode_listing_re.php"
            >&laquo; Sort files in Xcode listing (REnamer, e2ec52f)</a
          >
          |
        ...
        <p>
          The help files in REnamer predate Walrus, so move the old help files
          out of the way and import the Walrus-based help documents from
          Hextrapolate. These will serve as a basis for integrating Walrus into
          the help documentation generation for REnamer.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003584more"><div id="more"></div></div>
