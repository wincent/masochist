...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Test updates for PCRE 7.5 (REnamer, 6748f90)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/use_anonymous_category_renamer.php"
      title="Use anonymous category (REnamer, 52760f6)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/use_iso88591_latin_1_rather_th.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/use_anonymous_category_renamer.php"
            >&laquo; Use anonymous category (REnamer, 52760f6)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/use_iso88591_latin_1_rather_th.php"
            >Use ISO-8859-1 (Latin 1) rather than Mac OS Roman encoding
            (REnamer, 73eaf15) &raquo;</a
          >
        </p>
        ...
        <p>
          Store test files in new directory and rather than trying to force them
          into UTF-8, instead allow for per-file encodings to be specified. Time
          will tell whether this level of granularity is enough because there
          could conceivably be mixed test files which contain both UTF-8 and
