...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add HUD subgroup to Xcode project (REnamer, eca26a2)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/implement_clickandhold_in_the.php"
            >&laquo; Implement click-and-hold in the non-knob part of the slot
            (REnamer, 655a288)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_pagewise_scrolling_renamer.php"
            >Fix page-wise scrolling (REnamer, adc7584) &raquo;</a
          >
        </p>
        ...
        <p>
          There are now quite a few files related to the HUD functionality, so
          group these together in the Xcode project.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003659more"><div id="more"></div></div>
