...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Require product names to be unique (typechecked.net,
      b023972)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/03/require_name_in_products_model.php"
            >&laquo; Require name in products model (typechecked.net, e323bf2)</a
          >
          |
          ...
          <a
            ...
            (typechecked.net, 7805a54) &raquo;</a
          >
        </p>

        <h2>March 4, 2008</h2>

        <h3>Require product names to be unique (typechecked.net, b023972)</h3>
