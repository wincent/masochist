...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Require product names to be unique (wincent.dev,
      b023972)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/require_name_in_products_model.php"
            >&laquo; Require name in products model (wincent.dev, e323bf2)</a
          >
          |
          ...
          <a
            ...
            (wincent.dev, 7805a54) &raquo;</a
          >
        </p>

        <h2>March 4, 2008</h2>

        <h3>Require product names to be unique (wincent.dev, b023972)</h3>

        <p>Add validation and corresponding spec.</p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004215more"><div id="more"></div></div>
