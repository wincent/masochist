...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Minor rewrapping for readability (wincent.dev, ba69361)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_validation_of_tag_name_att.php"
            >&laquo; Add validation of tag name attribute (wincent.dev,
            4cdb738)</a
          >
          |
        ...
        <h3>Minor rewrapping for readability (wincent.dev, ba69361)</h3>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003972more"><div id="more"></div></div>
