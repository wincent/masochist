...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add ability to set and override image prefix (wikitext,
      60c9b60)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/teach_options_processor_to_han.php"
      title="Teach options processor to handle nil values (wikitext, 15a3470)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/additional_specs_for_img_prefi.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/teach_options_processor_to_han.php"
            >&laquo; Teach options processor to handle nil values (wikitext,
            15a3470)</a
          >
          |
        ...
        <p>
          By default a reference like {{foo.png}} will now create an img tag
          which sources &quot;/images/foo.png&quot;. This can be overridden
          using the img_prefix attribute, or by passing an option when
          initializing the parser. See the specs for a demonstration of the
          various options.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004159more"><div id="more"></div></div>
