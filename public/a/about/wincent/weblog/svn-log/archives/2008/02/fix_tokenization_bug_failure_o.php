...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix tokenization bug (failure on curly bracket)
      (wikitext, c523b5e)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/teach_wikitextparserparse_to_a.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/use_new_preserving_hack_wincen.php"
            >&laquo; Use new preserving hack (wincent.dev, 1be5ca4)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/teach_wikitextparserparse_to_a.php"
            >Teach Wikitext::Parser#parse to accept an options hash (wikitext,
            73fb12a) &raquo;</a
          >
        </p>
        ...
        <p>
          The printable machine wasn't matching the full set of ASCII because I
          was overlooking one code point. Add that code point and specs to make
          sure this bug never regresses.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003978more"><div id="more"></div></div>
