...
<title>Git activity log: Tweak CSS to make help documentation match Leopard style (REnamer, ef59fa4)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/add_convenience_macro_for_doub.php" title="Add convenience macro for double-checked locking pattern (WOCommon, c5ba560)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/use_css_3_borderimage_property.php" title="Use CSS 3 border-image property in help documentation (REnamer, 2785b27)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/add_convenience_macro_for_doub.php">&laquo; Add convenience macro for double-checked locking pattern (WOCommon, c5ba560)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/use_css_3_borderimage_property.php">Use CSS 3 border-image property in help documentation (REnamer, 2785b27) &raquo;</a>

</p>

<h2>January 17, 2008</h2>

<h3>Tweak CSS to make help documentation match Leopard style (REnamer, ef59fa4)</h3>

<p>These are simple, low-risk changes involving font size, color and weight.</p>

<p>A slightly higher-risk change would be using the CSS3 border-image property to replicate the new &quot;box&quot; style in the Leopard help documentation (higher-risk because it would only work with WebKit; it may be necessary to use it only in the embedded help, which will always be viewed with WebKit by definition, and not use it in the online version, where people might be browsing using Firefox or some other alternative). The alternative to using border-image is to do what Apple does and add a bunch of CSS for each corner and edge, but that's not a very attractive change as it would require lots of source files to be edited and kind of defeats the purpose of CSS.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003673more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at January 17, 2008  3:38 PM</p>
