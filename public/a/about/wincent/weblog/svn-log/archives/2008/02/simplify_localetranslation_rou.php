...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Simplify locale/translation routing (typechecked.net,
      ea50092)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/whitespace_fix_for_routes_file.php"
            >&laquo; Whitespace fix for routes file (typechecked.net, 002b836)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/add_routing_for_wiki_wincentco.php"
            >Add routing for wiki (typechecked.net, 1e83226) &raquo;</a
          >
        </p>

        <h2>February 7, 2008</h2>

        <h3>Simplify locale/translation routing (typechecked.net, ea50092)</h3>
