...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Teach Haml to respect preformatted text (wincent.dev,
      0eb6273)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_notes_on_rails_routing_bug.php"
      title="Add notes on Rails routing bug (wincent.dev, df1be01)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/use_new_preserving_hack_wincen.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_notes_on_rails_routing_bug.php"
            >&laquo; Add notes on Rails routing bug (wincent.dev, df1be01)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/use_new_preserving_hack_wincen.php"
            >Use new preserving hack (wincent.dev, 1be5ca4) &raquo;</a
          >
        </p>

        <h2>February 8, 2008</h2>

        <h3>Teach Haml to respect preformatted text (wincent.dev, 0eb6273)</h3>

        <p>
          This is not a pretty solution but it works for the time-being.
          Basically we insert markers wherever we want the input text to be
          passed through literally.
        </p>

        <p>
          This is necessary because of the way template nesting works. For
          example, if you suppress indenting in a &quot;show&quot; template, the
          contents of that rendered template will eventually get used by the
          enclosing application layout, and at that point you'll get additional
          indenting added back in.
        </p>

        <p>
          So the only way to communicate back to higher levels that you want
          your formatting preserved is to insert marker tags and act upon them
          accordingly.
        </p>

        <p>
          Note that this is different than what the
          &quot;find_and_preserve&quot; method does; that merely looks for pre
          blocks and filters them through preserve before passing them on.
        </p>

        <p>
          In the meantime I am going to continue looking for a more elegant
          solution.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004069more"><div id="more"></div></div>
