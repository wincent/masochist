...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Teach Haml to respect preformatted text (typechecked.net,
      0eb6273)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/add_notes_on_rails_routing_bug.php"
      title="Add notes on Rails routing bug (typechecked.net, df1be01)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/use_new_preserving_hack_wincen.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/add_notes_on_rails_routing_bug.php"
            >&laquo; Add notes on Rails routing bug (typechecked.net, df1be01)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/use_new_preserving_hack_wincen.php"
            >Use new preserving hack (typechecked.net, 1be5ca4) &raquo;</a
          >
        </p>

        <h2>February 8, 2008</h2>

        <h3>Teach Haml to respect preformatted text (typechecked.net, 0eb6273)</h3>
