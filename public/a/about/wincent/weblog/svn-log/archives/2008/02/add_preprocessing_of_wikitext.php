...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add preprocessing of wikitext (typechecked.net, 8d444fd)
    </title>
    ...
    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/make_fulltext_indexing_faster.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/add_fulltext_search_to_posts_m.php"
            >&laquo; Add full-text search to Posts model (typechecked.net,
            8e8cbcf)</a
          >
          |
          ...
          <a
            ...
            (typechecked.net, 7976609) &raquo;</a
          >
        </p>

        <h2>February 19, 2008</h2>

        <h3>Add preprocessing of wikitext (typechecked.net, 8d444fd)</h3>
