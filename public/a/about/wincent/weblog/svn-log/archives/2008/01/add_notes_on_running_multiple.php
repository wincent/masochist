...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add notes on running multiple controller instances
      (REnamer, 8489ecc)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/user_defaults_cleanup_renamer.php"
            >&laquo; User defaults cleanup (REnamer, c210747)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/dump_undeeded_setfrontprocess.php"
            >Dump undeeded SetFrontProcess() call (REnamer, b1f9d41) &raquo;</a
          >
        </p>
        ...
        <p>
          This would in theory allow us to have multiple windows and multiple
          renames in progress at the same time.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003557more"><div id="more"></div></div>
