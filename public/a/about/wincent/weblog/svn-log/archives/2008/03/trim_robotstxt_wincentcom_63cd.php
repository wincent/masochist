...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Trim robots.txt (typechecked.net, 63cdd2e)</title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/add_sample_database_configurat.php"
            >&laquo; Add sample database configuration file (typechecked.net,
            aedc881)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/03/add_confirmation_of_emails_win.php"
            >Add confirmation of emails (typechecked.net, 78a395a) &raquo;</a
          >
        </p>

        <h2>March 4, 2008</h2>

        <h3>Trim robots.txt (typechecked.net, 63cdd2e)</h3>
