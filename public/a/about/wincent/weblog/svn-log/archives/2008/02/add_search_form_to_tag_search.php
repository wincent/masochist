...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add search form to tag search results page (typechecked.net,
      d828803)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/restrict_visibility_during_tag.php"
            >&laquo; Restrict visibility during tag searches (typechecked.net,
            470696b)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/sanitize_and_limit_tags_in_sea.php"
            >Sanitize and limit tags in search to 10 (typechecked.net, c90d6d5)
            &raquo;</a
          >
        </p>
        ...
        <h3>
          Add search form to tag search results page (typechecked.net, d828803)
        </h3>
