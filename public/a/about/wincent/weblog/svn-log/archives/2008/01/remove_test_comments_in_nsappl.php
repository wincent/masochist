...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove test comments in NSApplication convenience
      category (WOCommon, 1656a77)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/minor_formatting_cleanup_in_ma.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_pointer_error_in_the_plugi.php"
            >&laquo; Fix pointer error in the plug-in (REnamer, 5eb12a6)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/minor_formatting_cleanup_in_ma.php"
            >Minor formatting clean-up in main controller header (REnamer,
            4f92fa7) &raquo;</a
          >
        </p>
        ...
        <h3>
          Remove test comments in NSApplication convenience category (WOCommon,
          1656a77)
        </h3>

        <p>
          Testing has now confirmed that the &quot;activate&quot; method is
          indeed necessary so remove the comments about possibly removing it.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003664more"><div id="more"></div></div>
