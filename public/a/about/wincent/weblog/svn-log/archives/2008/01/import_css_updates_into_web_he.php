...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Import CSS updates into web help directory (REnamer,
      ecc32be)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_whitespace_damage_in_css_f.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/use_css_3_borderimage_property.php"
            >&laquo; Use CSS 3 border-image property in help documentation
            (REnamer, 2785b27)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_whitespace_damage_in_css_f.php"
            >Fix whitespace damage in CSS files (REnamer, ba0d253) &raquo;</a
          >
        </p>
        ...
        <p>
          Previously tweaked the CSS in the embedded in-application help; now
          copy those same changes into the web help directory.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003675more"><div id="more"></div></div>
