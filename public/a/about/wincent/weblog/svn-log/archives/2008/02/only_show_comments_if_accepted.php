      ...
      <div class="content">
        <p align="right">
          <a
            ...
            template (typechecked.net, 00d93e7)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/renumber_migrations_to_fill_in.php"
            >Renumber migrations to fill in gap (typechecked.net, bfa4476)
            &raquo;</a
          >
        </p>
        ...
        <h3>
          Only show comments if accepted now or in the past (typechecked.net,
          5e48659)
        </h3>
