...
<title>Git activity log: Add LEFT_CURLY and RIGHT_CURLY symbols (wikitext, dd43eff)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/add_img_start_and_img_end_toke.php" title="Add IMG_START and IMG_END token types (wikitext, 3ff145f)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/teach_tokenize_to_tokenize_new.php" title="Teach tokenize to tokenize new symbols (wikitext, fdf879d)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/add_img_start_and_img_end_toke.php">&laquo; Add IMG_START and IMG_END token types (wikitext, 3ff145f)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/teach_tokenize_to_tokenize_new.php">Teach tokenize to tokenize new symbols (wikitext, fdf879d) &raquo;</a>

</p>

<h2>February 19, 2008</h2>

<h3>Add LEFT_CURLY and RIGHT_CURLY symbols (wikitext, dd43eff)</h3>

<p>In order to avoid ambiguity we have to separately tokenize single curly braces and exclude them from the standard PRINTABLE rule. Otherwise the greedy matching behaviour would match a run like &quot;foo{{bar}}baz&quot; as a single PRINTABLE token rather than a PRINTABLE, IMG_START, PRINTABLE, IMG_END, PRINTABLE sequence.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt;</p>

<div id="a004154more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at February 19, 2008  9:52 AM</p>
