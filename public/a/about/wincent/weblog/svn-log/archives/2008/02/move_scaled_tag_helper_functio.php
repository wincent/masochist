    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/fix_pretty_tag_urls_wincentcom.php"
            >&laquo; Fix pretty tag URLs (typechecked.net, 339a076)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/add_tagging_to_wiki_wincentcom.php"
            >Add tagging to wiki (typechecked.net, de6322a) &raquo;</a
          >
        </p>
        ...
        <h3>
          Move scaled_tag helper function into application helper (typechecked.net,
          57f734a)
        </h3>
