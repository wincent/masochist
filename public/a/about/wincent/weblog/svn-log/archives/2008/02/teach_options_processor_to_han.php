...
<title>Git activity log: Teach options processor to handle nil values (wikitext, 15a3470)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/add_specs_for_image_markup_wik.php" title="Add specs for image markup (wikitext, 8358662)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/add_ability_to_set_and_overrid.php" title="Add ability to set and override image prefix (wikitext, 60c9b60)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/add_specs_for_image_markup_wik.php">&laquo; Add specs for image markup (wikitext, 8358662)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/add_ability_to_set_and_overrid.php">Add ability to set and override image prefix (wikitext, 60c9b60) &raquo;</a>

</p>

<h2>February 19, 2008</h2>

<h3>Teach options processor to handle nil values (wikitext, 15a3470)</h3>

<p>Previously when looking at the options hash we had no way of distinguishing but nil (&quot;unset&quot;) and nil (&quot;explicitly set to nil&quot;). Now we explicitly check for the latter so that overriding is a little easier; the caller can set options to nil in order to suppress them.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt;</p>

<div id="a004158more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at February 19, 2008 11:19 AM</p>
