...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix button highlighting in vertical scrollbar (REnamer,
      2722970)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/remove_redundant_autotest_requ.php"
            >&laquo; Remove redundant autotest require (Wincent Strings Utility,
            4c1d9a0)</a
          >
          |
        ...
        <p>
          Was passing the point in the scroller's coordinate system rather than
          in the window's, as is required by testPart:.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003651more"><div id="more"></div></div>
