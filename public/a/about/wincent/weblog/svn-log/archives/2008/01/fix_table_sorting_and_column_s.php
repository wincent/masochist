...
<title>Git activity log: Fix table sorting and column selection (REnamer, 6c7f8c7)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/add_stack_trace_notes_to_wohud.php" title="Add stack trace notes to WOHUDTableHeaderCell class (REnamer, 68eb428)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/refactoring_for_table_header_c.php" title="Refactoring for table header cell drawing (REnamer, 9729ba7)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/add_stack_trace_notes_to_wohud.php">&laquo; Add stack trace notes to WOHUDTableHeaderCell class (REnamer, 68eb428)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/refactoring_for_table_header_c.php">Refactoring for table header cell drawing (REnamer, 9729ba7) &raquo;</a>

</p>

<h2>January 12, 2008</h2>

<h3>Fix table sorting and column selection (REnamer, 6c7f8c7)</h3>

<p>These are really two related changes to the nib file: firstly, removing the table view's content binding (this is redundant because each column has its value binding set up with the array controller); and secondly, specify column identifiers so that autosaving of column geometry can be turned on.</p>

<p>I originally had a third change here as well, enabling column selection, but that proved to be unnecessary in order to get sorting working.</p>

<p>Note that a few issues still remain: the sort indicators appear but do not change direction when sort direction is changed, and the highlighting behaviour is incorrect.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003602more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at January 12, 2008  5:29 PM</p>
...
<div id="footer">
  ...
  <p>Page last updated 00:30:16, 19 February 2010.</p>
  <p>
