...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove case-sensitive entry from index (REnamer,
      66ca188)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/remove_two_redundant_release_m.php"
      title="Remove two redundant release messages (REnamer, 1ef4055)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/reset_session_on_loginlogout_w.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/remove_two_redundant_release_m.php"
            >&laquo; Remove two redundant release messages (REnamer, 1ef4055)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/reset_session_on_loginlogout_w.php"
            >Reset session on login/logout (wincent.dev, 4a69b0d) &raquo;</a
          >
        </p>
        ...
        <p>
          Git exposes the problems in HFS+ with case sensitivity. In this case I
          renamed a folder from &quot;Tool&quot; to &quot;tool&quot;, and
          because I wasn't careful Git wound up with two entries in the index
          which were actually the same file (Tool/main.m and tool/main.m).
        </p>

        <p>
          I believe I've fixed this now by completely removing both entries from
          the index and then re-adding one of them; this shows up in the history
          as a simple deletion of one of the files, although in reality the work
          tree hasn't changed at all.
        </p>

        <p>
          When Apple's port of ZFS goes final I'll be using it in case-sensitive
          mode, if they provide one.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003757more"><div id="more"></div></div>
