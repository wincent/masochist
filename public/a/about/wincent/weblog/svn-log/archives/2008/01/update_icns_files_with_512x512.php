...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update icns files with 512x512 icon (REnamer, 4f2b59e)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/update_headers_and_whitespace.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/update_headers_and_whitespace.php"
            >&laquo; Update headers and whitespace (REnamer, 370c73b)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/rewrite_plugin_in_pure_c_renam.php"
            >Rewrite plug-in in pure C (REnamer, c217062) &raquo;</a
          >
        </p>
        ...
        <p>
          I had previously imported the new icon (as a PNG file). Now I've
          updated the actual icns files as well.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003509more"><div id="more"></div></div>
