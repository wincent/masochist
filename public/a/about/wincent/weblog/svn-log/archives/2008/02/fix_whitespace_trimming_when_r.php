...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix whitespace trimming when reallocating in the encoder
      (wikitext, 0b85588)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/dont_trim_whitespace_when_roll.php"
      title="Don't trim whitespace when rolling back (wikitext, 77476d9)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_non_space_tracking_when_sa.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/dont_trim_whitespace_when_roll.php"
            >&laquo; Don't trim whitespace when rolling back (wikitext,
            77476d9)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_non_space_tracking_when_sa.php"
            >Fix &quot;non_space&quot; tracking when sanitizing links (wikitext,
            c0bccec) &raquo;</a
          >
        </p>
        ...
        <h3>
          Fix whitespace trimming when reallocating in the encoder (wikitext,
          0b85588)
        </h3>

        <p>
          Must update the &quot;non_space&quot; pointer when reallocating the
          buffer in the link encoder, otherwise we can crash.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003927more"><div id="more"></div></div>
