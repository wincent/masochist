...
<title>Git activity log: Use color when logging admin password (wincent.com, 75355bc)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/fix_custom_rake_database_tasks.php" title="Fix custom rake database tasks (wincent.com, 9e5a3d1)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/only_emit_password_to_standard.php" title="Only emit password to standard error, not to the log (wincent.com, c4b9b7e)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/fix_custom_rake_database_tasks.php">&laquo; Fix custom rake database tasks (wincent.com, 9e5a3d1)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/only_emit_password_to_standard.php">Only emit password to standard error, not to the log (wincent.com, c4b9b7e) &raquo;</a>

</p>

<h2>January 25, 2008</h2>

<h3>Use color when logging admin password (wincent.com, 75355bc)</h3>

<p>When the application is first boot strapped we create an initial user account with admin privileges and log the result to the console and to the log.</p>

<p>This is more secure than providing an account with a default password, although the log file should be cleaned up if there is any chance of a third-party viewing it. In a future commit I'll remove the logging and merely emit the password to standard error (this is more secure still, unless someone happens to be looking over your shoulder during the migration).</p>

<p>In this commit we add colorization (bold green) and some surrounding asterisks to make sure that the password is not drowned out amid all the other output.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003784more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at January 25, 2008 11:44 AM</p>
