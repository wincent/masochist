...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Use color when logging admin password (typechecked.net,
      75355bc)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/fix_custom_rake_database_tasks.php"
      title="Fix custom rake database tasks (typechecked.net, 9e5a3d1)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/only_emit_password_to_standard.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/fix_custom_rake_database_tasks.php"
            >&laquo; Fix custom rake database tasks (typechecked.net, 9e5a3d1)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/only_emit_password_to_standard.php"
            >Only emit password to standard error, not to the log (typechecked.net,
            c4b9b7e) &raquo;</a
          >
        </p>
        ...
        <h3>Use color when logging admin password (typechecked.net, 75355bc)</h3>
