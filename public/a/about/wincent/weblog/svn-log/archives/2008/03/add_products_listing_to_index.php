...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add products listing to index, links are permalinks
      (wincent.dev, 63db015)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/fix_products_routing_wincentco.php"
            >&laquo; Fix products routing (wincent.dev, b906a09)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/update_products_link_in_navbar.php"
            >Update products link in navbar (wincent.dev, 76cf73f) &raquo;</a
          >
        </p>
        ...
        <h3>
          Add products listing to index, links are permalinks (wincent.dev,
          63db015)
        </h3>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004226more"><div id="more"></div></div>
