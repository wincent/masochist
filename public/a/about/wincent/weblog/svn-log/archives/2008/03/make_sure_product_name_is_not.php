...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Make sure product name is not nil (typechecked.net, 8ef596d)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/03/create_products_model_wincentc.php"
            >&laquo; Create products model (typechecked.net, 68a5a55)</a
          >
          |
        ...
        <h3>Make sure product name is not nil (typechecked.net, 8ef596d)</h3>
