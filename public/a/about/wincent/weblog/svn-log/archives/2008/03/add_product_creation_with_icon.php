...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add product creation with icon uploading (typechecked.net,
      b970662)
    </title>
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <h3>Add product creation with icon uploading (typechecked.net, b970662)</h3>
