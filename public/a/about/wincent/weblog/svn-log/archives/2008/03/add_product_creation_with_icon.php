...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add product creation with icon uploading (wincent.dev,
      b970662)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/add_extension_and_description.php"
      title="Add extension and description to products model (migration) (wincent.dev, 4eb5a36)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/fix_the_n1_select_problem_in_t.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/add_extension_and_description.php"
            >&laquo; Add extension and description to products model (migration)
            (wincent.dev, 4eb5a36)</a
          >
          |
        ...
        <h3>Add product creation with icon uploading (wincent.dev, b970662)</h3>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004229more"><div id="more"></div></div>
