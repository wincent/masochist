...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Only draw border if visible in header cell (REnamer,
      9e5b34a)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/simplify_custom_table_header_c.php"
            >&laquo; Simplify custom table header cell calculations (REnamer,
            df8c2af)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_offbyone_error_in_corner_v.php"
            >Fix off-by-one error in corner view (REnamer, 12253da) &raquo;</a
          >
        </p>
        ...
        <p>
          Check to see if the border would actually be visible before drawing
          it.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003670more"><div id="more"></div></div>
