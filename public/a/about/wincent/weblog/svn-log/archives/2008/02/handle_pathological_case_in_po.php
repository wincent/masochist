...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Handle pathological case in post permalink generation
      (wincent.dev, e4136b1)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/autogeneration_of_blog_post_pe.php"
      title="Auto-generation of blog post permalinks (wincent.dev, f71a66b)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/use_nongreedy_match_when_searc.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/autogeneration_of_blog_post_pe.php"
            >&laquo; Auto-generation of blog post permalinks (wincent.dev,
            f71a66b)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/use_nongreedy_match_when_searc.php"
            >Use non-greedy match when searching for a unique permalink
            (wincent.dev, 9abb465) &raquo;</a
          >
        </p>
        ...
        <p>
          Handle case where the suggested permalink evaporates away to nothing
          due to the presence of illegal charactes and nothing else. There are
          actually two eventualities here: one where the record has never been
          saved and doesn't even have an id to fall back to (here we use the
          word &quot;post&quot; as a starting point); the other where the record
