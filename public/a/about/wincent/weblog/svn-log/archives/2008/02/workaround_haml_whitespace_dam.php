...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Workaround Haml whitespace damage of pre blocks
      (wincent.dev, ec72ab3)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_initial_validations_for_ar.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_initial_validations_for_ar.php"
            >&laquo; Add initial validations for Article model (wincent.dev,
            5881ce0)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_notes_on_rails_routing_bug.php"
            >Add notes on Rails routing bug (wincent.dev, df1be01) &raquo;</a
          >
        </p>
        ...
        <h3>
          Workaround Haml whitespace damage of pre blocks (wincent.dev, ec72ab3)
        </h3>

        <p>
          Haml provides a preserve() helper for this which I am reluctantly
          using. Downsides: turns large slabs of transformed wikitext into
          indecipherable, hard-to-debug, ugly slabs; and makes another pass over
          the entire input stream, which runs against the primary design goal of
          the wikitext translator (speed).
        </p>

        <p>
          I'm currently investigating an alternative workaround, the seed of
          which you can see in the application helper. Basically I want to
          suppress all indentation inside the given block; if I can come up with
          a workable solution will submit a patch to Haml.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004067more"><div id="more"></div></div>
