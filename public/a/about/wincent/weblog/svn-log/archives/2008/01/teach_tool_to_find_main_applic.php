...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Teach tool to find main application executable (REnamer,
      9d7f325)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/tell_preview_scroll_view_not_t.php"
            >&laquo; Tell preview scroll view not to draw background (REnamer,
            a2c9e07)</a
          >
          |
        ...
        <p>
          Now that the application executable is no longer inside the plugin we
          have to use a different strategy.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003572more"><div id="more"></div></div>
