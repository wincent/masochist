...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Custom NSScroller subclass (REnamer, 3fa4cd7)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/use_wohudscrollview_class_in_m.php"
      title="Use WOHUDScrollView class in main nib (REnamer, 755e2c3)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/implement_button_highlight_in.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/use_wohudscrollview_class_in_m.php"
            >&laquo; Use WOHUDScrollView class in main nib (REnamer, 755e2c3)</a
          >
          |
        ...
        <p>
          Now we draw scrollers that are suitable for display in a HUD window.
          This really is only a preliminary draft: the colors and geometry will
          almost certainly be tweaked in the future.
        </p>

        <p>
          This commit also includes an empty clip view subclass. This isn't
          hooked up because I can't seem to swap it in without breaking drawing
          entirely. But the eventual intention is to override NSClipView because
          I suspect it is responsible for drawing the unwanted &quot;end
          cap&quot; above the vertical scrollbar.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003627more"><div id="more"></div></div>
