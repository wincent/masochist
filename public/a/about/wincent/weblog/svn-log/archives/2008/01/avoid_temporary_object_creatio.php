...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Avoid temporary object creation in plug-in (REnamer,
      c881c75)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/rewrite_plugin_in_pure_c_renam.php"
      title="Rewrite plug-in in pure C (REnamer, c217062)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_a_couple_of_crashers_in_th.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/rewrite_plugin_in_pure_c_renam.php"
            >&laquo; Rewrite plug-in in pure C (REnamer, c217062)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_a_couple_of_crashers_in_th.php"
            >Fix a couple of crashers in the plug-in (REnamer, 00629cf)
            &raquo;</a
          >
        </p>
        ...
        <p>
          Instead of storing the paths in a CFArray (requiring CFString
          creation, conversion back and forth between file-system
          representations, and lots of temporary objects) just use raw C strings
          (UTF-8 strings, actually) and C arrays.
        </p>

        <p>
          If the contextual menu is slow when used on many thousands of items it
          definitely won't be because of CF overhead, but because of the Apple
          Event communication mechanism.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003511more"><div id="more"></div></div>
