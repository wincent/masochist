...
<title>Git activity log: Avoid temporary object creation in plug-in (REnamer, c881c75)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/rewrite_plugin_in_pure_c_renam.php" title="Rewrite plug-in in pure C (REnamer, c217062)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/fix_a_couple_of_crashers_in_th.php" title="Fix a couple of crashers in the plug-in (REnamer, 00629cf)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/rewrite_plugin_in_pure_c_renam.php">&laquo; Rewrite plug-in in pure C (REnamer, c217062)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/fix_a_couple_of_crashers_in_th.php">Fix a couple of crashers in the plug-in (REnamer, 00629cf) &raquo;</a>

</p>

<h2>January  9, 2008</h2>

<h3>Avoid temporary object creation in plug-in (REnamer, c881c75)</h3>

<p>Instead of storing the paths in a CFArray (requiring CFString creation, conversion back and forth between file-system representations, and lots of temporary objects) just use raw C strings (UTF-8 strings, actually) and C arrays.</p>

<p>If the contextual menu is slow when used on many thousands of items it definitely won't be because of CF overhead, but because of the Apple Event communication mechanism.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003511more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at January  9, 2008  2:04 PM</p>
