...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/complete_link_model_specs_winc.php"
      title="Complete Link model specs (typechecked.net, f80c10f)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/complete_article_model_specs_w.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/complete_link_model_specs_winc.php"
            >&laquo; Complete Link model specs (typechecked.net, f80c10f)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/complete_article_model_specs_w.php"
            >Complete Article model specs (typechecked.net, ef8622f) &raquo;</a
          >
        </p>
        ...
        <h3>
          Add skeletal specs for models which were missing them (typechecked.net,
          a65baf4)
        </h3>
