...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add &quot;wikitext&quot; commandline tool (wikitext,
      a757151)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_tokenization_of_pre_start.php"
      title="Add tokenization of PRE_START and PRE_END (wikitext, 940a83b)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/enhance_output_using_highline.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_tokenization_of_pre_start.php"
            >&laquo; Add tokenization of PRE_START and PRE_END (wikitext,
            940a83b)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/enhance_output_using_highline.php"
            >Enhance output using HighLine (wikitext, 4262958) &raquo;</a
          >
        </p>
        ...
        <p>
          This is a simple tool that allows you to play with wikitext from the
          command line. Type in text and hit Ctrl-D to process it; it will be
          translated into HTML and emitted to the standard output. Hit Ctrl+C to
          exit the session.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004037more"><div id="more"></div></div>
