...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Minor cleanup and fix for blockquote/pre interaction
      (wikitext, 20db47c)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_breakage_in_pre_specs_wiki.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_breakage_in_pre_specs_wiki.php"
            >&laquo; Fix breakage in PRE specs (wikitext, 4be3597)</a
          >
          |
          ...
          <a
            ...
            function (wikitext, 504bb6e) &raquo;</a
          >
        </p>
        ...
        <h3>
          Minor cleanup and fix for blockquote/pre interaction (wikitext,
          20db47c)
        </h3>

        <p>
          This cleanup includes a fix for some odd interaction in one case: a
          blockquote block containing paragraphs alternating with nested pre
          blocks.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004012more"><div id="more"></div></div>
