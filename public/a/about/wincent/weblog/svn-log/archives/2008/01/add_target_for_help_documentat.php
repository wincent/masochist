...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add target for help documentaton regeneration (REnamer,
      5dec45e)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/prepare_help_script_for_extrac.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_files_from_wocommon_needed.php"
            >&laquo; Add files from WOCommon needed by tool (REnamer,
            a2baec6)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/prepare_help_script_for_extrac.php"
            >Prepare help script for extraction (REnamer, 9457239) &raquo;</a
          >
        </p>
        ...
        <p>
          Add help.sh script which is basically identical to the script used in
          Hextrapolate but with the three set-up variables changed. This is
          probably a good candidate for extaction into buildtools.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003586more"><div id="more"></div></div>
