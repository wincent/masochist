...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add tests for subsitution validity checks (REnamer,
      54b1ceb)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/avoid_freeing_static_string_wh.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/avoid_freeing_static_string_wh.php"
            >&laquo; Avoid freeing static string when normalizing (REnamer,
            33cbcd0)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/test_cleanup_renamer_8a5f9d1.php"
            >Test clean-up (REnamer, 8a5f9d1) &raquo;</a
          >
        </p>
        ...
        <p>
          These are tests for both the WORegularExpression class, and the
          NSString category upon which the substitution validity checks are
          built.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003701more"><div id="more"></div></div>
