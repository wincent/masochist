...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update FixtureReplacement example data (typechecked.net,
      d6ad037)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/cleanup_whitespace_in_links_ro.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/cleanup_whitespace_in_links_ro.php"
            >&laquo; Cleanup whitespace in links routing spec (typechecked.net,
            a7b7f59)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/ignore_dbschemarb_wincentcom_d.php"
            >Ignore db/schema.rb (typechecked.net, d4c78a5) &raquo;</a
          >
        </p>

        <h2>January 30, 2008</h2>

        <h3>Update FixtureReplacement example data (typechecked.net, d6ad037)</h3>
