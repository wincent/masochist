...
<title>Git activity log: Wrap str structs with Data_Wrap_Struct (wikitext, 4389475)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/extract_str_free_function_into.php" title="Extract str_free function into separate function (wikitext, 2bc8593)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/add_invalid_encoding_test_to_b.php" title="Add invalid_encoding test to benchmarks subdirectory (wikitext, 29af551)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/extract_str_free_function_into.php">&laquo; Extract str_free function into separate function (wikitext, 2bc8593)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/add_invalid_encoding_test_to_b.php">Add invalid_encoding test to benchmarks subdirectory (wikitext, 29af551) &raquo;</a>

</p>

<h2>February 23, 2008</h2>

<h3>Wrap str structs with Data_Wrap_Struct (wikitext, 4389475)</h3>

<p>This is the companion commit to 7f506d3 which wrapped ary structs. The purpose of this commit is to ensure that str structs get freed in the event of an abnormal exit from the parse function (ie. via an exception).</p>

<p>Note that in order for this change to be made I had to change the initialization of the tabulation struct; it needs to be initialized in the parse function so that it can be added to the stack in the appropriate scope, and this in turn means that it needs to be pre-initialized rather than lazily initialized.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt;</p>

<div id="a004176more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at February 23, 2008  4:34 PM</p>
