...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Prettify wiki URLs (typechecked.net, 7a865f9)</title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/allow_option_overrides_at_inti.php"
      title="Allow option overrides at intialization time (wikitext, f2658b6)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/basic_tag_display_wincentcom_6.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/basic_tag_display_wincentcom_6.php"
            >Basic tag display (typechecked.net, 61b8b6f) &raquo;</a
          >
        </p>

        <h2>February 18, 2008</h2>

        <h3>Prettify wiki URLs (typechecked.net, 7a865f9)</h3>
