...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Show alert if model validation fails for in-place
      editing (wincent.dev, 21d51ba)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/perform_validation_during_inpl.php"
      title="Perform validation during in-place editing (wincent.dev, bc34e99)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/extract_in_place_editor_field.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/perform_validation_during_inpl.php"
            >&laquo; Perform validation during in-place editing (wincent.dev,
            bc34e99)</a
          >
          |
        ...
        <p>
          If validation fails we now display a JavaScript alert before reverting
          the field to its former value. I could look at instead updating the
          flash region of the layout but I actually think a dialog box is a
          little more usable in this case.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003797more"><div id="more"></div></div>
