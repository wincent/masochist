...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Make separate administrator namespace (typechecked.net,
      13a0aec)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/tags_interface_wincentcom_37ee.php"
      title="Tags interface (typechecked.net, 37ee0e1)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/size_tag_font_depending_on_pop.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/tags_interface_wincentcom_37ee.php"
            >&laquo; Tags interface (typechecked.net, 37ee0e1)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/size_tag_font_depending_on_pop.php"
            >Size tag font depending on popularity (typechecked.net, b724d1a)
            &raquo;</a
          >
        </p>
        ...
        <h3>Make separate administrator namespace (typechecked.net, 13a0aec)</h3>
