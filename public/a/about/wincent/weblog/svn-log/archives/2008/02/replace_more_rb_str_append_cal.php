...
<title>Git activity log: Replace more rb_str_append calls with rb_str_cat (wikitext, a5954dc)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/replace_many_rb_str_append_cal.php" title="Replace many rb_str_append calls with rb_str_cat (wikitext, e116b3f)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/add_profiling_parse_method_wik.php" title="Add profiling_parse method (wikitext, c712074)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/replace_many_rb_str_append_cal.php">&laquo; Replace many rb_str_append calls with rb_str_cat (wikitext, e116b3f)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/add_profiling_parse_method_wik.php">Add profiling_parse method (wikitext, c712074) &raquo;</a>

</p>

<h2>February  5, 2008</h2>

<h3>Replace more rb_str_append calls with rb_str_cat (wikitext, a5954dc)</h3>

<p>This time for token text, and it yields an even bigger speed-up. Before:</p>

<p>  short slab of ASCII text    2.380000   0.010000   2.390000 (  2.461861)   short slab of UTF-8 text    4.860000   0.000000   4.860000 (  5.016289)</p>

<p>After:</p>

<p>  short slab of ASCII text    1.570000   0.010000   1.580000 (  1.705596)   short slab of UTF-8 text    3.280000   0.020000   3.300000 (  3.353919)</p>

<p>So that one change alone cuts 33% off the execution time. The combined scanner/parser is now nearly 8 times faster than it was under ANTLR and nearly 3 times faster than it was after the move to Ragel but before I started optimizing the parser.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt;</p>

<div id="a003900more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at February  5, 2008 12:25 PM</p>
