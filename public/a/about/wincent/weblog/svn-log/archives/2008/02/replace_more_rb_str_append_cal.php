...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Replace more rb_str_append calls with rb_str_cat
      (wikitext, a5954dc)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/replace_many_rb_str_append_cal.php"
      title="Replace many rb_str_append calls with rb_str_cat (wikitext, e116b3f)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_profiling_parse_method_wik.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/replace_many_rb_str_append_cal.php"
            >&laquo; Replace many rb_str_append calls with rb_str_cat (wikitext,
            e116b3f)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_profiling_parse_method_wik.php"
            >Add profiling_parse method (wikitext, c712074) &raquo;</a
          >
        </p>
        ...
        <p>
          This time for token text, and it yields an even bigger speed-up.
          Before:
        </p>

        <p>
          short slab of ASCII text 2.380000 0.010000 2.390000 ( 2.461861) short
        ...
        <p>
          short slab of ASCII text 1.570000 0.010000 1.580000 ( 1.705596) short
          slab of UTF-8 text 3.280000 0.020000 3.300000 ( 3.353919)
        </p>
        ...
        <p>
          ...
          and nearly 3 times faster than it was after the move to Ragel but
          before I started optimizing the parser.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003900more"><div id="more"></div></div>
