...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add WOHUDTableHeaderCell class (REnamer, 595ca86)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/draw_alternating_row_backgroun.php"
      title="Draw alternating row backgrounds in HUD table view (REnamer, ee06d30)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/teach_table_header_header_cell.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/draw_alternating_row_backgroun.php"
            >&laquo; Draw alternating row backgrounds in HUD table view
            (REnamer, ee06d30)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/teach_table_header_header_cell.php"
            >Teach table header header cells to draw transparent backgrounds
            (REnamer, ddda4fb) &raquo;</a
          >
        </p>
        ...
        <p>
          Merely calling setTextColor: on the table header cell is not enough;
          the value is apparently ignored, so must create a new subclass with to
          enforce white text in the header cells, and swap the cells in when the
          table is instantiated.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003595more"><div id="more"></div></div>
