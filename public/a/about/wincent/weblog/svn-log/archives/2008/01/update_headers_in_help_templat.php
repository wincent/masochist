...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update headers in help templates (REnamer, 61819ca)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/prepare_help_script_for_extrac.php"
            >&laquo; Prepare help script for extraction (REnamer, 9457239)</a
          >
          |
        ...
        <p>
          Adjust relative paths in all the help templates (in REnamer the
          application code lives one level deeper in the hierarchy), update
          copyright ranges, and get rid of Subversion Id tags.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003588more"><div id="more"></div></div>
