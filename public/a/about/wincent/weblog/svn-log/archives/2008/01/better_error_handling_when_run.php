...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Better error handling when running under Xcode (Walrus,
      4625397)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/update_headers_in_help_templat.php"
            >&laquo; Update headers in help templates (REnamer, 61819ca)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/mark_failing_spec_as_pending_w.php"
            >Mark failing spec as pending (Walrus, 1a4311d) &raquo;</a
          >
        </p>
        ...
        <p>
          Prefix error messages with &quot;:: error:&quot; so that they will be
          highlighted in the build results window when walrus is run from within
          Xcode.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003540more"><div id="more"></div></div>
