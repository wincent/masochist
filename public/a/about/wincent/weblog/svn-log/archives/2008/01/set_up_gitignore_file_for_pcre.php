...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Set up gitignore file for PCRE subdirectory (REnamer,
      2c888e3)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/new_pcre_build_and_build_notes.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/new_pcre_build_and_build_notes.php"
            >&laquo; New PCRE build and build notes (REnamer, df385fc)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/update_headers_and_whitespace.php"
            >Update headers and whitespace (REnamer, 370c73b) &raquo;</a
          >
        </p>
        ...
        <p>
          This allows us to build PCRE in-place in the source tree without
          polluting the Git status output.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003507more"><div id="more"></div></div>
