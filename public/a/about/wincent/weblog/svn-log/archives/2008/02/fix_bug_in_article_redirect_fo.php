...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/fix_spec_breakage_caused_by_re.php"
      title="Fix spec breakage caused by removal of Revisions model (typechecked.net, 1f9a20f)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/add_attribute_accessible_decla.php"
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <h3>
          Fix bug in Article redirect format validation regexp (typechecked.net,
          4dae4d8)
        </h3>
