...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix bug in Article redirect format validation regexp
      (wincent.dev, 4dae4d8)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_spec_breakage_caused_by_re.php"
      title="Fix spec breakage caused by removal of Revisions model (wincent.dev, 1f9a20f)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_attribute_accessible_decla.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_spec_breakage_caused_by_re.php"
            >&laquo; Fix spec breakage caused by removal of Revisions model
            (wincent.dev, 1f9a20f)</a
          >
          |
        ...
        <h3>
          Fix bug in Article redirect format validation regexp (wincent.dev,
          4dae4d8)
        </h3>

        <p>
          Missing parentheses meant that this would sometimes pass when it
          shouldn't have.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004091more"><div id="more"></div></div>
