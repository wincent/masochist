...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: First cut at wiki functionality (typechecked.net, b451c58)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/special_case_record_not_found.php"
      title="Special case record_not_found (typechecked.net, d35ee64)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/fix_pretty_tag_urls_wincentcom.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/special_case_record_not_found.php"
            >&laquo; Special case record_not_found (typechecked.net, d35ee64)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/fix_pretty_tag_urls_wincentcom.php"
            >Fix pretty tag URLs (typechecked.net, 339a076) &raquo;</a
          >
        </p>

        <h2>February 8, 2008</h2>

        <h3>First cut at wiki functionality (typechecked.net, b451c58)</h3>
