...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: First cut at wiki functionality (wincent.dev, b451c58)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/special_case_record_not_found.php"
      title="Special case record_not_found (wincent.dev, d35ee64)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_pretty_tag_urls_wincentcom.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/special_case_record_not_found.php"
            >&laquo; Special case record_not_found (wincent.dev, d35ee64)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_pretty_tag_urls_wincentcom.php"
            >Fix pretty tag URLs (wincent.dev, 339a076) &raquo;</a
          >
        </p>

        <h2>February 8, 2008</h2>

        <h3>First cut at wiki functionality (wincent.dev, b451c58)</h3>

        <p>
          This is a basic first cut at wiki functionality. At the moment we have
          a form for creating new articles; on submitting the form we create the
          article model and attach a first revision model as well with the
          initial content of the body.
        </p>

        <p>
          Articles are located by their titles, and our routes map to the
          &quot;wiki&quot; namespace rather than the &quot;article&quot; one.
          This means that our paths are like &quot;/wiki/foo&quot; rather than
          &quot;/article/1&quot; or even &quot;/article/foo&quot;.
        </p>

        <p>
          If you try to access an article which doesn't exist and you're logged
          in as an admin user then you are taken directly to the &quot;new&quot;
          form with the title pre-populated so you can create the missing
          article if you wish.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003977more"><div id="more"></div></div>
