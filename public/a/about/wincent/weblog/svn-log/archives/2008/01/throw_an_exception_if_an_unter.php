...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Throw an exception if an unterminated substitution
      expression found (REnamer, bc345ad)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/refactoring_of_bundlelocating.php"
            >&laquo; Refactoring of bundle-locating code (REnamer, 2425af5)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_nsstring_category_for_chec.php"
            >Add NSString category for checking substitution validity (REnamer,
            3e9e2db) &raquo;</a
          >
        </p>
        ...
        <h3>
          Throw an exception if an unterminated substitution expression found
          (REnamer, bc345ad)
        </h3>

        <p>
          This brings us into line with the behaviour of Perl, which will emit a
          &quot;Substitution replacement not terminated at line x&quot; message
          in such a case.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003691more"><div id="more"></div></div>
