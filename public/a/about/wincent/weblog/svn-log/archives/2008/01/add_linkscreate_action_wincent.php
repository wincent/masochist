...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add links/create action (typechecked.net, 9d91051)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/set_up_linksnew_wincentcom_bae.php"
            >&laquo; Set up links/new (typechecked.net, bae2447)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/cleanup_whitespace_in_links_ro.php"
            >Cleanup whitespace in links routing spec (typechecked.net, a7b7f59)
            &raquo;</a
          >
        </p>
        ...
        <h3>Add links/create action (typechecked.net, 9d91051)</h3>
