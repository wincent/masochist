...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Cleanup whitespace in links routing spec (typechecked.net,
      a7b7f59)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/add_linkscreate_action_wincent.php"
      title="Add links/create action (typechecked.net, 9d91051)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/update_fixturereplacement_exam.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/add_linkscreate_action_wincent.php"
            >&laquo; Add links/create action (typechecked.net, 9d91051)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/update_fixturereplacement_exam.php"
            >Update FixtureReplacement example data (typechecked.net, d6ad037)
            &raquo;</a
          >
        </p>
        ...
        <h3>Cleanup whitespace in links routing spec (typechecked.net, a7b7f59)</h3>
