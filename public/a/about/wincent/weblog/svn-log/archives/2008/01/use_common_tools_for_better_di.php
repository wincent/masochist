...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Use common tools for better diagnostic messages
      (buildtools, 4ac65e8)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_expansion_error_in_release.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/always_direct_error_and_diagno.php"
            >&laquo; Always direct error and diagnostic output to the stderr
            (buildtools, 4654413)</a
          >
          |
        ...
        <p>
          In the release notes script, source Common.sh and use its functions
          for emitting diagnostic messages.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003765more"><div id="more"></div></div>
