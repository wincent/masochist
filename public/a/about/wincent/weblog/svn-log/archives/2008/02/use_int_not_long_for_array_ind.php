...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Use int, not long for array index parameters (wikitext,
      15912ec)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_up_remainer_sites_to_use_n.php"
            >&laquo; Fix up remainer sites to use new array API (wikitext,
            6ca4415)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_offbyone_error_in_aryh_wik.php"
            >Fix off-by-one error in ary.h (wikitext, fb26fbc) &raquo;</a
          >
        </p>
        ...
        <div id="a003891more"><div id="more"></div></div>
