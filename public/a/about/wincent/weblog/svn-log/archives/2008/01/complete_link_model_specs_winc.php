...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Complete Link model specs (typechecked.net, f80c10f)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/remove_dbschemarb_file_wincent.php"
            >&laquo; Remove db/schema.rb file (typechecked.net, de09bc5)</a
          >
          |
        ...
        <h3>Complete Link model specs (typechecked.net, f80c10f)</h3>
