...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Show tagging count in tool-tip in tag cloud
      (wincent.dev, 2e0f600)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/normalize_tag_name_to_lowercas.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/normalize_tag_name_to_lowercas.php"
            >&laquo; Normalize tag name to lowercase upon storage (wincent.dev,
            75a0af2)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/move_login_form_into_a_partial.php"
            >Move login form into a partial (wincent.dev, 8c98144) &raquo;</a
          >
        </p>
        ...
        <p>
          Hovering the mouse over a tag name in the tag cloud now shows a
          tool-tip with the total number of taggings for that tag.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003974more"><div id="more"></div></div>
