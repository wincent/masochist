...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix breakage in PRE specs (wikitext, 4be3597)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/tweak_newline_emission_of_pre.php"
            >&laquo; Tweak newline emission of pre blocks (wikitext, b364c14)</a
          >
          |
        ...
        <p>
          This is required to prevent us from emitting an initial CRLF upon
          entering a PRE block for the first time.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004011more"><div id="more"></div></div>
