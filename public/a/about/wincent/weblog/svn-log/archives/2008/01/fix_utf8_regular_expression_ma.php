...
<title>Git activity log: Fix UTF-8 regular expression matching (REnamer, e1df3cb)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/disallow_keyboardbased_selecti.php" title="Disallow keyboard-based selection in preview table view (REnamer, f1ca6cc)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/remove_unnecessary_use_of_objc.php" title="Remove unnecessary use of objc_msgSend() (REnamer, 872e3a8)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/disallow_keyboardbased_selecti.php">&laquo; Disallow keyboard-based selection in preview table view (REnamer, f1ca6cc)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/remove_unnecessary_use_of_objc.php">Remove unnecessary use of objc_msgSend() (REnamer, 872e3a8) &raquo;</a>

</p>

<h2>January 13, 2008</h2>

<h3>Fix UTF-8 regular expression matching (REnamer, e1df3cb)</h3>

<p>Add tests to explore known issues with matching UTF-8 text. Add an errorCode property so that callers can distinguish between non-fatal (eg. no match) and fatal (eg. bad UTF-8) errors in pcre_exec().</p>

<p>The actual cause of the problem was that I was passing in the string length in characters rather than bytes.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003630more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at January 13, 2008 12:14 PM</p>
