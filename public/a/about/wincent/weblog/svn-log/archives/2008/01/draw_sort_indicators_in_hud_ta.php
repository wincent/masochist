...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Draw sort indicators in HUD table header cells (REnamer,
      1b8cd05)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/teach_table_header_header_cell.php"
            >&laquo; Teach table header header cells to draw transparent
            backgrounds (REnamer, ddda4fb)</a
          >
          |
        ...
        <p>
          Not sure if this is the best approach but it is a starting point.
          There may be better sites to call the superclass implementation, or we
