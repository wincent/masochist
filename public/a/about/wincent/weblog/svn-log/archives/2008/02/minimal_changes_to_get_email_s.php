...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Minimal changes to get Email specs passing (typechecked.net,
      1bffd19)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/run_specs_whenever_example_dat.php"
            >&laquo; Run specs whenever example_data.rb changes (typechecked.net,
            a673655)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/fix_locale_specs_wincentcom_aa.php"
            >Fix locale specs (typechecked.net, aa385f3) &raquo;</a
          >
        </p>
        ...
        <h3>
          Minimal changes to get Email specs passing (typechecked.net, 1bffd19)
        </h3>
