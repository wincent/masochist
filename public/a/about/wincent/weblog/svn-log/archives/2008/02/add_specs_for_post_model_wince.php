...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add specs for Post model (wincent.dev, 7d22ac0)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/use_nongreedy_match_when_searc.php"
            >&laquo; Use non-greedy match when searching for a unique permalink
            (wincent.dev, 9abb465)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/ignore_coverage_subdirectory_w.php"
            >Ignore coverage subdirectory (wincent.dev, bb4ed11) &raquo;</a
          >
        </p>

        <h2>February 17, 2008</h2>

        <h3>Add specs for Post model (wincent.dev, 7d22ac0)</h3>
