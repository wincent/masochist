...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add specs for Post model (typechecked.net, 7d22ac0)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/ignore_coverage_subdirectory_w.php"
            >Ignore coverage subdirectory (typechecked.net, bb4ed11) &raquo;</a
          >
        </p>

        <h2>February 17, 2008</h2>

        <h3>Add specs for Post model (typechecked.net, 7d22ac0)</h3>
