...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Fix products routing (typechecked.net, b906a09)</title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/03/assign_found_products_for_view.php"
      title="Assign found products for view (typechecked.net, 98ab4ca)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/03/add_products_listing_to_index.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/03/assign_found_products_for_view.php"
            >&laquo; Assign found products for view (typechecked.net, 98ab4ca)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/03/add_products_listing_to_index.php"
            >Add products listing to index, links are permalinks (typechecked.net,
            63db015) &raquo;</a
          >
        </p>
        ...
        <h3>Fix products routing (typechecked.net, b906a09)</h3>
