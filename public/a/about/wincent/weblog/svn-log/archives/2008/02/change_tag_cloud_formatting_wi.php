...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Change tag cloud formatting (typechecked.net, 0ca64e0)
    </title>
    ...
    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/special_styling_for_links_winc.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/size_tag_font_depending_on_pop.php"
            >&laquo; Size tag font depending on popularity (typechecked.net,
            b724d1a)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/special_styling_for_links_winc.php"
            >Special styling for links (typechecked.net, 45e3ce0) &raquo;</a
          >
        </p>

        <h2>February 7, 2008</h2>

        <h3>Change tag cloud formatting (typechecked.net, 0ca64e0)</h3>
