...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Avoid void pointer arithmetic in
      WOCreateFSRefArrayFromAEDesc() (REnamer, 2fe20b9)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/rename_filecount_member_rename.php"
            >&laquo; Rename fileCount member (REnamer, 51930fa)</a
          >
          |
        ...
        <p>
          This code reads more nicely and is perhaps less error prone if we do
          it without void pointer arithmetic.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003723more"><div id="more"></div></div>
