...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Size tag font depending on popularity (wincent.dev,
      b724d1a)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/make_separate_administrator_na.php"
      title="Make separate administrator namespace (wincent.dev, 13a0aec)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/change_tag_cloud_formatting_wi.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/make_separate_administrator_na.php"
            >&laquo; Make separate administrator namespace (wincent.dev,
            13a0aec)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/change_tag_cloud_formatting_wi.php"
            >Change tag cloud formatting (wincent.dev, 0ca64e0) &raquo;</a
          >
        </p>

        <h2>February 7, 2008</h2>

        <h3>Size tag font depending on popularity (wincent.dev, b724d1a)</h3>

        <p>
          According to &quot;Web 2.0&quot; doctrine you need tags and you need
          to change the font size to indicate the popularity of a tag.
        </p>

        <p>
          This commit introduces the resizing in the range of 1.0em (for
