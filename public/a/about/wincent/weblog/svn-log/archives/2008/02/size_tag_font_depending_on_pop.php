...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Size tag font depending on popularity (typechecked.net,
      b724d1a)
    </title>
    ...
    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/change_tag_cloud_formatting_wi.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/make_separate_administrator_na.php"
            >&laquo; Make separate administrator namespace (typechecked.net,
            13a0aec)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/change_tag_cloud_formatting_wi.php"
            >Change tag cloud formatting (typechecked.net, 0ca64e0) &raquo;</a
          >
        </p>

        <h2>February 7, 2008</h2>

        <h3>Size tag font depending on popularity (typechecked.net, b724d1a)</h3>
