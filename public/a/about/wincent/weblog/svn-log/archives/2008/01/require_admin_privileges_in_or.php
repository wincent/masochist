    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/pretty_permalinks_for_locales.php"
            >&laquo; Pretty permalinks for locales (typechecked.net, 2fccd09)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/provide_nice_redirection_if_la.php"
            >Provide nice redirection if lacking privileges (typechecked.net,
            0e41246) &raquo;</a
          >
        </p>
        ...
        <h3>
          Require admin privileges in order to edit translations (typechecked.net,
          7fbf92c)
        </h3>
