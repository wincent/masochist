...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Require admin privileges in order to edit translations
      (wincent.dev, 7fbf92c)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/pretty_permalinks_for_locales.php"
            >&laquo; Pretty permalinks for locales (wincent.dev, 2fccd09)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/provide_nice_redirection_if_la.php"
            >Provide nice redirection if lacking privileges (wincent.dev,
            0e41246) &raquo;</a
          >
        </p>
        ...
        <h3>
          Require admin privileges in order to edit translations (wincent.dev,
          7fbf92c)
        </h3>

        <p>
          Could later open this up to the public but for now just keep it
          simple.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003787more"><div id="more"></div></div>
