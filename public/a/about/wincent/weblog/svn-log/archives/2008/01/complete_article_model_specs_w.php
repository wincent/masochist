...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Complete Article model specs (wincent.dev, ef8622f)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_skeletal_specs_for_models.php"
      title="Add skeletal specs for models which were missing them (wincent.dev, a65baf4)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_initial_version_of_article.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_skeletal_specs_for_models.php"
            >&laquo; Add skeletal specs for models which were missing them
            (wincent.dev, a65baf4)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_initial_version_of_article.php"
            >Add initial version of Articles controller (wincent.dev, 2cbc65e)
            &raquo;</a
          >
        </p>
        ...
        <h3>Complete Article model specs (wincent.dev, ef8622f)</h3>

        <p>
          This includes one change to the database schema required to make the
          specs pass.
        </p>

        <p>
          Although the specs are now &quot;complete&quot; (ie. all facets of the
          model's behaviour are now specified) there is still room for this to
          be fleshed out.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003942more"><div id="more"></div></div>
