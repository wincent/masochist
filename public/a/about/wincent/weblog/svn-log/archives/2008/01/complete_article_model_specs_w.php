...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Complete Article model specs (typechecked.net, ef8622f)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/add_skeletal_specs_for_models.php"
      title="Add skeletal specs for models which were missing them (typechecked.net, a65baf4)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/add_initial_version_of_article.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/add_initial_version_of_article.php"
            >Add initial version of Articles controller (typechecked.net, 2cbc65e)
            &raquo;</a
          >
        </p>
        ...
        <h3>Complete Article model specs (typechecked.net, ef8622f)</h3>
