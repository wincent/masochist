...
<title>Git activity log: Fix bug in &quot;trim link target&quot; function (wikitext, 44d9cec)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/rstring_ptr_and_rstring_len_fi.php" title="RSTRING_PTR and RSTRING_LEN fixes for Ruby 1.8.5 compatibility (wikitext, 7e157f8)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/let_the_compiler_decide_when_t.php" title="Let the compiler decide when to inline (wikitext, cf1128c)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/rstring_ptr_and_rstring_len_fi.php">&laquo; RSTRING_PTR and RSTRING_LEN fixes for Ruby 1.8.5 compatibility (wikitext, 7e157f8)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/let_the_compiler_decide_when_t.php">Let the compiler decide when to inline (wikitext, cf1128c) &raquo;</a>

</p>

<h2>February 29, 2008</h2>

<h3>Fix bug in &quot;trim link target&quot; function (wikitext, 44d9cec)</h3>

<p>This was a bug exposed thanks to a &quot;value computed is not used&quot; warning emitted when building on RHEL 5.1 (but which doesn't appear on Mac OS X or RHEL 3). Although it was a bug, looks harmless enough: basically the leftmost character would be altered instead of the desired behaviour of moving the leftmost boundary. So the worst-case scenario would be an aesthetic glitch in the output, but it turns out that in the spec suite the glitch never appeared in practice.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt;</p>

<div id="a004189more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at February 29, 2008 12:33 PM</p>
