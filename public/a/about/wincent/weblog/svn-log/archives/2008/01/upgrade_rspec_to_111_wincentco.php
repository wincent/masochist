...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Upgrade RSpec to 1.1.1 (typechecked.net, 9adf928)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/upgrade_to_rails_202_wincentco.php"
            >&laquo; Upgrade to Rails 2.0.2 (typechecked.net, 4bf1ec8)</a
          >
          |
        ...
        <h3>Upgrade RSpec to 1.1.1 (typechecked.net, 9adf928)</h3>
