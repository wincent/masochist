...
<title>Git activity log: Tokenize em and strong HTML tags (wikitext, 2baf13a)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/add_specs_for_case_insensitive.php" title="Add specs for case insensitive tokenization of TT tokens (wikitext, 93ceb30)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/update_parser_to_handle_litera.php" title="Update parser to handle literal em and strong HTML tags (wikitext, e9a600d)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/add_specs_for_case_insensitive.php">&laquo; Add specs for case insensitive tokenization of TT tokens (wikitext, 93ceb30)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/update_parser_to_handle_litera.php">Update parser to handle literal em and strong HTML tags (wikitext, e9a600d) &raquo;</a>

</p>

<h2>February  6, 2008</h2>

<h3>Tokenize em and strong HTML tags (wikitext, 2baf13a)</h3>

<p>This is useful for cases where you either type HTML tags instead of wikitext markup without thinking, or where you explicitly prefer to use explicit tags for the purposes of disambiguation (ie. does &quot;'''''&quot; mean &quot;strong em&quot; or &quot;em strong&quot;?). By default, the wikitext extension assumes strong em because it is an on-the-fly transformer and can't look ahead to see what the likely ordering is, but sometimes you want the other order and using HTML tags is one way of imposing it (the other is to insert a zero-length nowiki span, or insert whitespace, between the opening em and strong tags).</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt;</p>

<div id="a003912more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at February  6, 2008 12:08 PM</p>
