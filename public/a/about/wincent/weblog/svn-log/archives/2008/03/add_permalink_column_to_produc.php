...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add permalink column to products table (typechecked.net,
      a4263df)
    </title>
    ...
    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/03/require_permalink_on_products.php"
      ...
      <div class="content">
        <p align="right">
          <a
            ...
            route (typechecked.net, e1580bd)</a
          >
          |
        ...
        <h3>Add permalink column to products table (typechecked.net, a4263df)</h3>
