...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix typo in String additions file (typechecked.net, 02bf922)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/add_routing_for_wiki_wincentco.php"
      title="Add routing for wiki (typechecked.net, 1e83226)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/drop_html_caching_from_revisio.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/add_routing_for_wiki_wincentco.php"
            >&laquo; Add routing for wiki (typechecked.net, 1e83226)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/drop_html_caching_from_revisio.php"
            >Drop HTML caching from revisions table (typechecked.net, 5313bbb)
            &raquo;</a
          >
        </p>
        ...
        <h3>Fix typo in String additions file (typechecked.net, 02bf922)</h3>
