...
<title>Git activity log: Teach parser to interpret image markup (wikitext, 9f49894)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/teach_tokenize_to_tokenize_new.php" title="Teach tokenize to tokenize new symbols (wikitext, fdf879d)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/add_specs_for_image_markup_wik.php" title="Add specs for image markup (wikitext, 8358662)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/teach_tokenize_to_tokenize_new.php">&laquo; Teach tokenize to tokenize new symbols (wikitext, fdf879d)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/add_specs_for_image_markup_wik.php">Add specs for image markup (wikitext, 8358662) &raquo;</a>

</p>

<h2>February 19, 2008</h2>

<h3>Teach parser to interpret image markup (wikitext, 9f49894)</h3>

<p>Given wikitext input like:</p>

<p>  {{foo.png}}</p>

<p>will emit:</p>

<p>  &lt;img src=&quot;foo.png&quot; alt=&quot;foo.png&quot; /&gt;</p>

<p>The &quot;alt&quot; attribute is added because it is required for XHTML validity. In the future I may add a support for overriding the attribute content, perhaps with a syntax like this:</p>

<p>  {{foo.png|a picture of foo}}</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt;</p>

<div id="a004156more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at February 19, 2008 10:39 AM</p>
