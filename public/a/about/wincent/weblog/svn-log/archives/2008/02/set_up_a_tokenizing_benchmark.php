...
<title>Git activity log: Set up a tokenizing benchmark for ANTLR lexer (wikitext, bdc7a11)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/move_encoding_benchmarks_into.php" title="Move encoding benchmarks into separate subdirectory (wikitext, 4aaffb1)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/add_tokenization_benchmarks_fo.php" title="Add tokenization benchmarks for ANTLR-backed scanner (wikitext, fcfc13c)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/move_encoding_benchmarks_into.php">&laquo; Move encoding benchmarks into separate subdirectory (wikitext, 4aaffb1)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/add_tokenization_benchmarks_fo.php">Add tokenization benchmarks for ANTLR-backed scanner (wikitext, fcfc13c) &raquo;</a>

</p>

<h2>February  2, 2008</h2>

<h3>Set up a tokenizing benchmark for ANTLR lexer (wikitext, bdc7a11)</h3>

<p>This function doesn't actually do anything with the tokens, it just asks the lexer for tokens as fast as it can dish them out.</p>

<p>The intention is to measure the raw speed of the tokenization part only (ie. the part due to ANTLR only).</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt;</p>

<div id="a003872more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at February  2, 2008  6:21 PM</p>
