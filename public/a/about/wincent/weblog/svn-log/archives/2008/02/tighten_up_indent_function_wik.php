...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Tighten up indent function (wikitext, 2df3c11)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/correct_file_mode_on_spec_file.php"
      title="Correct file mode on spec files (wikitext, 3870f90)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/ignore_dotso_files_on_linux_wi.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/correct_file_mode_on_spec_file.php"
            >&laquo; Correct file mode on spec files (wikitext, 3870f90)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/ignore_dotso_files_on_linux_wi.php"
            >Ignore dot-so files on Linux (wikitext, 25c10e2) &raquo;</a
          >
        </p>
        ...
        <p>
          This wasn't calculating the string end point correctly nor updating
          the stored length which meant that it was unnecessarily refilling the
          buffer every time; this is quite counterproductive seeing as the whole
          point of the reusable buffer was to avoid re-generating the same
          indentation string over and over.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004121more"><div id="more"></div></div>
