...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Create symlink to latest version of pcre.h header
      (REnamer, 3fdee73)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/remove_utf8_bom_marker_from_te.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/remove_utf8_bom_marker_from_te.php"
            >&laquo; Remove UTF-8 BOM marker from test input files (REnamer,
            fe1dbad)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/test_updates_renamer_f626ef3.php"
            >Test updates (REnamer, f626ef3) &raquo;</a
          >
        </p>
        ...
        <p>
          Located in the source root so that it can be found without changing
          the default header search path.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003549more"><div id="more"></div></div>
