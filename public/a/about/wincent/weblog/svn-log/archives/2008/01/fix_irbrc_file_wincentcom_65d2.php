...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Fix irbrc file (wincent.dev, 65d26e4)</title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_headers_to_release_note_se.php"
            >&laquo; Add headers to release note sections (Synergy, d2da2bd)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/initial_version_of_design_prot.php"
            >Initial version of design prototype (wincent.dev, 403b233)
            &raquo;</a
          >
        </p>
        ...
        <h3>Fix irbrc file (wincent.dev, 65d26e4)</h3>

        <p>
          The previously committed version wasn't functional (I committed an
          in-development version by mistake); this is the version I actually
          wanted to commit.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003776more"><div id="more"></div></div>
