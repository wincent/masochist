...
<title>Git activity log: Basic autolinking for email addresses (wikitext, 4f5854e)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/tokenize_email_addresses_wikit.php" title="Tokenize email addresses (wikitext, 9089f82)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/fix_crasher_with_email_address.php" title="Fix crasher with email addresses inside nowiki and pre spans (wikitext, 47c718c)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/tokenize_email_addresses_wikit.php">&laquo; Tokenize email addresses (wikitext, 9089f82)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/fix_crasher_with_email_address.php">Fix crasher with email addresses inside nowiki and pre spans (wikitext, 47c718c) &raquo;</a>

</p>

<h2>February  6, 2008</h2>

<h3>Basic autolinking for email addresses (wikitext, 4f5854e)</h3>

<p>This handles the basic case; the edge cases still need to be handled (for example, what happens when an email address is part of an internal link text, internal link target, or external link text); I'm going to write specs for these cases before proceding with the implementation.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt;</p>

<div id="a003919more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at February  6, 2008  2:27 PM</p>
