...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Basic autolinking for email addresses (wikitext,
      4f5854e)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/tokenize_email_addresses_wikit.php"
      title="Tokenize email addresses (wikitext, 9089f82)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_crasher_with_email_address.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/tokenize_email_addresses_wikit.php"
            >&laquo; Tokenize email addresses (wikitext, 9089f82)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_crasher_with_email_address.php"
            >Fix crasher with email addresses inside nowiki and pre spans
            (wikitext, 47c718c) &raquo;</a
          >
        </p>
        ...
        <p>
          This handles the basic case; the edge cases still need to be handled
          (for example, what happens when an email address is part of an
          internal link text, internal link target, or external link text); I'm
          going to write specs for these cases before proceding with the
          implementation.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003919more"><div id="more"></div></div>
