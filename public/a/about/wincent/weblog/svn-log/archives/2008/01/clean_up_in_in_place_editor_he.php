...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Clean up in in place editor helper macros (typechecked.net,
      3fa763d)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/teach_the_in_place_editor_to_p.php"
      title="Teach the in place editor to play nicely with forgery protection (typechecked.net, 2b5cbd0)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/fix_typo_in_in_place_editor_he.php"
      ...
      <div class="content">
        <p align="right">
          <a
            ...
            protection (typechecked.net, 2b5cbd0)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/fix_typo_in_in_place_editor_he.php"
            >Fix typo in in place editor helper (typechecked.net, a29bd91)
            &raquo;</a
          >
        </p>
