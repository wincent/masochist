...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add comments for plans on tool usage (REnamer, b1c4889)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/set_up_wocommon_and_wopublic_s.php"
      title="Set up WOCommon and WOPublic symlinks (REnamer, 71513e9)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/xcode_project_bundle_update_re.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/set_up_wocommon_and_wopublic_s.php"
            >&laquo; Set up WOCommon and WOPublic symlinks (REnamer, 71513e9)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/xcode_project_bundle_update_re.php"
            >Xcode project bundle update (REnamer, 69e25d1) &raquo;</a
          >
        </p>
        ...
        <p>
          Rather than making the tool a dumb launcher for the GUI, I'd like to
          make it a renaming utility in its own right, following the same
          metaphor as the GUI (Find &amp; Replace). Add some notes to that
          effect.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003501more"><div id="more"></div></div>
