...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Make full-text indexing faster by bypassing Active
      Record (wincent.dev, 7976609)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_preprocessing_of_wikitext.php"
      title="Add preprocessing of wikitext (wincent.dev, 8d444fd)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/shuffle_some_migration_numbers.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_preprocessing_of_wikitext.php"
            >&laquo; Add preprocessing of wikitext (wincent.dev, 8d444fd)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/shuffle_some_migration_numbers.php"
            >Shuffle some migration numbers (wincent.dev, 3e766e7) &raquo;</a
          >
        </p>
        ...
        <h3>
          Make full-text indexing faster by bypassing Active Record
          (wincent.dev, 7976609)
        </h3>

        <p>
          Well, not bypassing it entirely as we still go through
          connection.insert, but still, this yields a 10-fold speed-up. It is,
          however, still too slow for my liking; several seconds to index a
          largish (40+ KB) article in development mode. Even though production
          will likely be much faster I still don't think this is good enough.
        </p>

        <p>
          In all likelihood I'll defer indexing and do it in a background
          process.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004201more"><div id="more"></div></div>
