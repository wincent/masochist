...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Draw dark table view background in HUD (REnamer,
      dfab7f0)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_wohudtableview_class_renam.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_wohudtableview_class_renam.php"
            >&laquo; Add WOHUDTableView class (REnamer, 86545a3)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/draw_alternating_row_backgroun.php"
            >Draw alternating row backgrounds in HUD table view (REnamer,
            ee06d30) &raquo;</a
          >
        </p>
        ...
        <p>
          This is a first cut in which all rows are drawn with a dark
          background. A subsequent cut will use alternating row backgrounds when
          appropriate.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003593more"><div id="more"></div></div>
