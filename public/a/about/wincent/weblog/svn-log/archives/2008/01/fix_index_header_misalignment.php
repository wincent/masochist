...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix Index header misalignment (REnamer, 97fa977)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/reduce_spacing_between_index_i.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_whitespace_damage_in_css_f.php"
            >&laquo; Fix whitespace damage in CSS files (REnamer, ba0d253)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/reduce_spacing_between_index_i.php"
            >Reduce spacing between index items (REnamer, 18fdbb0) &raquo;</a
          >
        </p>
        ...
        <p>
          Not sure whether this was an issue before, but on Leopard in both
          Safari and Firefox the index page title was too low. Tweak the CSS to
          make it higher.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003677more"><div id="more"></div></div>
