...
<title>Git activity log: Fix minor wart with pre block closing (wikitext, 172a51c)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/use_custom_string_struct_to_st.php" title="Use custom string struct to store line endings (wikitext, bf8a30f)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/tweak_newline_emission_of_pre.php" title="Tweak newline emission of pre blocks (wikitext, b364c14)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/use_custom_string_struct_to_st.php">&laquo; Use custom string struct to store line endings (wikitext, bf8a30f)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/tweak_newline_emission_of_pre.php">Tweak newline emission of pre blocks (wikitext, b364c14) &raquo;</a>

</p>

<h2>February  9, 2008</h2>

<h3>Fix minor wart with pre block closing (wikitext, 172a51c)</h3>

<p>Under some circumstances (unnested pre block followed by two consecutive newlines) we would emit a block that looked like this:</p>
...
<p>While the former displayed fine in the browser, the latter looks better in the HTML source.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt;</p>

<div id="a004009more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at February  9, 2008  1:39 PM</p>
