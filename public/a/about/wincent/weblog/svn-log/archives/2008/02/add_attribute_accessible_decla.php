...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add attribute accessible declaration to Article model
      (wincent.dev, f39c25c)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_bug_in_article_redirect_fo.php"
      title="Fix bug in Article redirect format validation regexp (wincent.dev, 4dae4d8)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/full_spec_suite_for_article_mo.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_bug_in_article_redirect_fo.php"
            >&laquo; Fix bug in Article redirect format validation regexp
            (wincent.dev, 4dae4d8)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/full_spec_suite_for_article_mo.php"
            >Full spec suite for Article model (wincent.dev, 90d6ef3) &raquo;</a
          >
        </p>
        ...
        <h3>
          Add attribute accessible declaration to Article model (wincent.dev,
          f39c25c)
        </h3>

        <p>
          The whole thing is accessible, but add this anyway as basic good
          security practice (the model may be extended in the future).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004092more"><div id="more"></div></div>
