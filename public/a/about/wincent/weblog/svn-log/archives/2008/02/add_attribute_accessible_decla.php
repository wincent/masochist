...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/fix_bug_in_article_redirect_fo.php"
      title="Fix bug in Article redirect format validation regexp (typechecked.net, 4dae4d8)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/full_spec_suite_for_article_mo.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/full_spec_suite_for_article_mo.php"
            >Full spec suite for Article model (typechecked.net, 90d6ef3) &raquo;</a
          >
        </p>
        ...
        <h3>
          Add attribute accessible declaration to Article model (typechecked.net,
          f39c25c)
        </h3>
