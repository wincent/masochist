...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix the n+1 select problem in the tags implementation
      (wincent.dev, 513d102)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/add_product_creation_with_icon.php"
      title="Add product creation with icon uploading (wincent.dev, b970662)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/speed_up_fulltext_indexing_by.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/add_product_creation_with_icon.php"
            >&laquo; Add product creation with icon uploading (wincent.dev,
            b970662)</a
          >
          |
        ...
        <p>
          ...
          &quot;show&quot; action of the tags controller) or all items matching
          multiple tags (ie. the &quot;search&quot; action) we unfortunately had
          an n+1 SELECT problem because we had to inspect each Taggable instance
          to see if the user had access permissions to it.
        </p>

        <p>
          Now we reduce the number of queries by grabbing all Taggables for a
          given taggable type in one hit. In other words, given 3 matching
          Articles and 10 matching Posts, we now do 2 queries during access
          checking rather than 13; and when we display the Taggables in the view
          there are no additional queries because the Taggables have already
          been fetched.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004230more"><div id="more"></div></div>
