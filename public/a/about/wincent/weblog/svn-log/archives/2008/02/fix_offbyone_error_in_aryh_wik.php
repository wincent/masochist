...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix off-by-one error in ary.h (wikitext, fb26fbc)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/use_int_not_long_for_array_ind.php"
            >&laquo; Use int, not long for array index parameters (wikitext,
            15912ec)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/swap_out_calls_to_nil_p_when_d.php"
            >Swap out calls to NIL_P when deleting items (wikitext, fb30594)
            &raquo;</a
          >
        </p>
        ...
        <div id="a003892more"><div id="more"></div></div>
