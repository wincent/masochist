...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Validate permalink format for links (wincent.dev,
      d522c0d)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/show_id_in_links_controller_wi.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/show_id_in_links_controller_wi.php"
            >&laquo; Show id in Links controller (wincent.dev, 3af4297)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_main_form_css_class_wincen.php"
            >Add &quot;main_form&quot; CSS class (wincent.dev, 2ca2c9e)
            &raquo;</a
          >
        </p>
        ...
        <h3>Validate permalink format for links (wincent.dev, d522c0d)</h3>

        <p>Allow letters, numbers and hyphens only.</p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004149more"><div id="more"></div></div>
