...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Upgrade to Rails 2.0.2 (typechecked.net, 4bf1ec8)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/upgrade_to_haml_180_wincentcom.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/upgrade_to_haml_180_wincentcom.php"
            >&laquo; Upgrade to Haml 1.8.0 (typechecked.net, 14c0c89)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/upgrade_rspec_to_111_wincentco.php"
            >Upgrade RSpec to 1.1.1 (typechecked.net, 9adf928) &raquo;</a
          >
        </p>

        <h2>January 10, 2008</h2>

        <h3>Upgrade to Rails 2.0.2 (typechecked.net, 4bf1ec8)</h3>
