...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add update_attribute! to Active Record (typechecked.net,
      cec57c5)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/fix_typo_in_in_place_editor_he.php"
            >&laquo; Fix typo in in place editor helper (typechecked.net,
            a29bd91)</a
          >
          |
        ...
        <h3>Add update_attribute! to Active Record (typechecked.net, cec57c5)</h3>
