...
<title>Git activity log: Clean-up rollback functions (wikitext, 1367c53)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/fix_unterminated_external_link.php" title="Fix unterminated external links nested inside LI blocks (wikitext, 50350ef)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/handle_uris_in_internal_link_t.php" title="Handle URIs in internal link text (wikitext, 256c0e9)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/fix_unterminated_external_link.php">&laquo; Fix unterminated external links nested inside LI blocks (wikitext, 50350ef)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/handle_uris_in_internal_link_t.php">Handle URIs in internal link text (wikitext, 256c0e9) &raquo;</a>

</p>

<h2>February  9, 2008</h2>

<h3>Clean-up rollback functions (wikitext, 1367c53)</h3>

<p>We can cut out about 33 lines of code by taking advantage of the following invariant: as soon as we see a link start marker we know that we'll either be emitting a link, or the text that results from rolling back a failed link. This means that instead of checking to see if we need to start a paragraph in the rollback functions we can just start one unconditionally as soon as we see the link start markers.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt;</p>

<div id="a004020more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at February  9, 2008  8:43 PM</p>
