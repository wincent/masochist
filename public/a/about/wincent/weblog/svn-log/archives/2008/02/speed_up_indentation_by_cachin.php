...
<title>Git activity log: Speed up indentation by caching spaces string (wikitext, 149ec37)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/update_benchmark_notes_wikitex.php" title="Update benchmark notes (wikitext, e9d67ef)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/use_custom_string_struct_to_st.php" title="Use custom string struct to store line endings (wikitext, bf8a30f)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/update_benchmark_notes_wikitex.php">&laquo; Update benchmark notes (wikitext, e9d67ef)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/use_custom_string_struct_to_st.php">Use custom string struct to store line endings (wikitext, bf8a30f) &raquo;</a>

</p>

<h2>February  9, 2008</h2>

<h3>Speed up indentation by caching spaces string (wikitext, 149ec37)</h3>

<p>We lazily create a string struct on demand the first time it is needed, and as larger indent levels are required we grow the buffer and populate it with spaces. We never shrink the buffer and so never have to re-populate it. It is freed only at the end of the parsing operation.</p>

<p>So this will have little or no effect in really short snippets of wikitext (one liners where there is no indentation at all) but on longer slabs with lots of nesting it should afford a nice boost. A typical use case (examples with more nesting would see a larger improvement):</p>

<p>Before:</p>

<p>  longer slab of ASCII text  14.260000   0.040000</p>
...
<div id="a004007more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at February  9, 2008  1:09 PM</p>
