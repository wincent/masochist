...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: New models, lib additions and refactoring (typechecked.net,
      a9173ba)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/upgrade_to_haml_181_wincentcom.php"
      title="Upgrade to Haml 1.8.1 (typechecked.net, 55f9609)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/set_up_linksnew_wincentcom_bae.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/upgrade_to_haml_181_wincentcom.php"
            >&laquo; Upgrade to Haml 1.8.1 (typechecked.net, 55f9609)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/set_up_linksnew_wincentcom_bae.php"
            >Set up links/new (typechecked.net, bae2447) &raquo;</a
          >
        </p>
        ...
        <h3>
          New models, lib additions and refactoring (typechecked.net, a9173ba)
        </h3>
