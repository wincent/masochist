...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Make sure constants get initialized only once in spec
      helper (wikitext, 767f54b)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_explicit_dependency_inform.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_explicit_dependency_inform.php"
            >&laquo; Add explicit dependency information to Makefile (wikitext,
            0134138)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/replace_many_rb_str_append_cal.php"
            >Replace many rb_str_append calls with rb_str_cat (wikitext,
            e116b3f) &raquo;</a
          >
        </p>
        ...
        <h3>
          Make sure constants get initialized only once in spec helper
          (wikitext, 767f54b)
        </h3>

        <p>
          This is necessary to prevent warnings about &quot;already initialized
          constant&quot; when running the specs under autotest.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003898more"><div id="more"></div></div>
