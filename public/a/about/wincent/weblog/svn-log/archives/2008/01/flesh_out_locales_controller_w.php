...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Flesh out locales controller (typechecked.net, 9bd9613)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/add_usage_notes_for_in_place_e.php"
            >&laquo; Add usage notes for in_place_editor_field (typechecked.net,
            59cc4a8)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/add_databaselevel_constraints.php"
            >Add database-level constraints for uniqueness (typechecked.net,
            163821f) &raquo;</a
          >
        </p>
        ...
        <h3>Flesh out locales controller (typechecked.net, 9bd9613)</h3>
