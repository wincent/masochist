    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/user_spec_fixes_for_mass_assig.php"
            >&laquo; User spec fixes for mass assignment (typechecked.net,
            ab7e57d)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/allow_custom_matcher_to_work_w.php"
            >Allow custom matcher to work with associations (typechecked.net,
            b2c76ac) &raquo;</a
          >
        </p>
        ...
        <h3>
          Fix failure in user spec (superuser mass assignment) (typechecked.net,
          7636e1d)
        </h3>
