...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Modify links specs to get them passing (typechecked.net,
      252308d)
    </title>
    ...
    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/add_show_method_to_comments_co.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/migration_tweaks_wincentcom_44.php"
            >&laquo; Migration tweaks (typechecked.net, 44d306e)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/add_show_method_to_comments_co.php"
            >Add show method to comments controller (typechecked.net, 35495cb)
            &raquo;</a
          >
        </p>
        ...
        <h3>Modify links specs to get them passing (typechecked.net, 252308d)</h3>
