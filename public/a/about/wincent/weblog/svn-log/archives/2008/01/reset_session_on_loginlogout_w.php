...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Reset session on login/logout (wincent.dev, 4a69b0d)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/remove_casesensitive_entry_fro.php"
      title="Remove case-sensitive entry from index (REnamer, 66ca188)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/remove_comment_about_rspec_bug.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/remove_casesensitive_entry_fro.php"
            >&laquo; Remove case-sensitive entry from index (REnamer,
            66ca188)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/remove_comment_about_rspec_bug.php"
            >Remove comment about RSpec bug (wincent.dev, f7ebc62) &raquo;</a
          >
        </p>

        <h2>January 22, 2008</h2>

        <h3>Reset session on login/logout (wincent.dev, 4a69b0d)</h3>

        <p>
          Rather than trying to nudge the session into the desired shape (which
          might be error prone), reset it entirely using reset_session.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003744more"><div id="more"></div></div>
