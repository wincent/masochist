...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Reset session on login/logout (typechecked.net, 4a69b0d)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/remove_casesensitive_entry_fro.php"
      title="Remove case-sensitive entry from index (REnamer, 66ca188)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/remove_comment_about_rspec_bug.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/remove_comment_about_rspec_bug.php"
            >Remove comment about RSpec bug (typechecked.net, f7ebc62) &raquo;</a
          >
        </p>

        <h2>January 22, 2008</h2>

        <h3>Reset session on login/logout (typechecked.net, 4a69b0d)</h3>
