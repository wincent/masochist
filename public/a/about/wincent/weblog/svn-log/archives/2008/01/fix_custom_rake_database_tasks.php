...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix custom rake database tasks (typechecked.net, 9e5a3d1)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/setup_rename_menu_item_renamer.php"
      title="Set-up &amp;quot;Rename...&amp;quot; menu item (REnamer, 9a57ad3)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/use_color_when_logging_admin_p.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/use_color_when_logging_admin_p.php"
            >Use color when logging admin password (typechecked.net, 75355bc)
            &raquo;</a
          >
        </p>
        ...
        <h3>Fix custom rake database tasks (typechecked.net, 9e5a3d1)</h3>
