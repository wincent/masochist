...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Add tag search (typechecked.net, 80753b1)</title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/group_tag_results_according_to.php"
      title="Group tag results according to taggable type (typechecked.net, 7513d98)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/add_tag_search_box_to_navigati.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/group_tag_results_according_to.php"
            >&laquo; Group tag results according to taggable type (typechecked.net,
            7513d98)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/add_tag_search_box_to_navigati.php"
            >Add tag search box to navigation bar (typechecked.net, 94ad75f)
            &raquo;</a
          >
        </p>
        ...
        <h3>Add tag search (typechecked.net, 80753b1)</h3>
