...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/simplify_creation_of_woregular.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_tests_for_subsitution_vali.php"
            >&laquo; Add tests for subsitution validity checks (REnamer,
            54b1ceb)</a
          >
          |
        ...
        <p>
          For consistency, convert some parts of the regular expression tests to
          use Objective-C 2.0 properties; these were missed during previous
          modifications to the tests.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003702more"><div id="more"></div></div>
