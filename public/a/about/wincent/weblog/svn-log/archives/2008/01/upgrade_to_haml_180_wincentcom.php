...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Upgrade to Haml 1.8.0 (typechecked.net, 14c0c89)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/fix_initialization_of_mutable.php"
      title="Fix initialization of mutable string in test rig (REnamer, 2b6cf06)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/upgrade_to_rails_202_wincentco.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/upgrade_to_rails_202_wincentco.php"
            >Upgrade to Rails 2.0.2 (typechecked.net, 4bf1ec8) &raquo;</a
          >
        </p>

        <h2>January 10, 2008</h2>

        <h3>Upgrade to Haml 1.8.0 (typechecked.net, 14c0c89)</h3>
