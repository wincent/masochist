...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Maintain internal indentation level variable (wikitext,
      ad3271a)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/emit_trailing_newline_after_op.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/emit_trailing_newline_after_op.php"
            >&laquo; Emit trailing newline after opening blockquote block
            (wikitext, d718a4b)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/introduce_parser_t_struct_wiki.php"
            >Introduce parser_t struct (wikitext, f55c418) &raquo;</a
          >
        </p>
        ...
        <p>
          At this stage we don't do any indentation but we do pass the variable
          around in preparation for when we do.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003984more"><div id="more"></div></div>
