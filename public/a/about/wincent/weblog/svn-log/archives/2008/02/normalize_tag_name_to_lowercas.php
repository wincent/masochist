...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Normalize tag name to lowercase upon storage
      (wincent.dev, 75a0af2)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/minor_rewrapping_for_readabili.php"
      title="Minor rewrapping for readability (wincent.dev, ba69361)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/show_tagging_count_in_tooltip.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/minor_rewrapping_for_readabili.php"
            >&laquo; Minor rewrapping for readability (wincent.dev, ba69361)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/show_tagging_count_in_tooltip.php"
            >Show tagging count in tool-tip in tag cloud (wincent.dev, 2e0f600)
            &raquo;</a
          >
        </p>
        ...
        <h3>
          Normalize tag name to lowercase upon storage (wincent.dev, 75a0af2)
        </h3>

        <p>
          This is for consistency. Note that the case-insensitivity of the
          uniqueness constraints means that it was already impossible to create
          two tags with names like &quot;Foo&quot; and &quot;foo&quot;, but this
          change rules out different but inconsistent tag names like
          &quot;Tennis&quot; and &quot;football&quot; (they would be
