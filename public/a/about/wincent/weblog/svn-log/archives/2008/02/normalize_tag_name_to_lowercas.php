...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/minor_rewrapping_for_readabili.php"
      title="Minor rewrapping for readability (typechecked.net, ba69361)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/show_tagging_count_in_tooltip.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/minor_rewrapping_for_readabili.php"
            >&laquo; Minor rewrapping for readability (typechecked.net, ba69361)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/show_tagging_count_in_tooltip.php"
            >Show tagging count in tool-tip in tag cloud (typechecked.net, 2e0f600)
            &raquo;</a
          >
        </p>
        ...
        <h3>
          Normalize tag name to lowercase upon storage (typechecked.net, 75a0af2)
        </h3>
