...
<title>Git activity log: Drop PCRE library tests from test suite (REnamer, ccce3a5)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/update_application_bundle_iden.php" title="Update application bundle identifier (REnamer, bec7018)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/update_notes_and_todo_files_re.php" title="Update NOTES and TODO files (REnamer, 8feb0b9)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/update_application_bundle_iden.php">&laquo; Update application bundle identifier (REnamer, bec7018)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/update_notes_and_todo_files_re.php">Update NOTES and TODO files (REnamer, 8feb0b9) &raquo;</a>

</p>

<h2>January 11, 2008</h2>

<h3>Drop PCRE library tests from test suite (REnamer, ccce3a5)</h3>

<p>The library gets tested at compile time, so there is no need to re-test it at runtime.</p>

<p>This change was motivated because the test apparatus is quite brittle, basically requiring that the pcretest tool be re-implemented from scratch to play with the WORegularExpression wrapper. There is risk of breakage every time a PCRE update is released, and the implementation did not capture a lot of nuances of the original tests anyway.</p>

<p>I will instead be adding more tests in &quot;native&quot; style (ie. hand-written tests rather than trying to leverage the PCRE ones).</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003575more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at January 11, 2008 10:39 AM</p>
