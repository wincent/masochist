...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Assign found products for view (typechecked.net, 98ab4ca)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/03/teach_products_controller_to_f.php"
      title="Teach products controller to find all products (typechecked.net, b794161)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/03/fix_products_routing_wincentco.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/03/fix_products_routing_wincentco.php"
            >Fix products routing (typechecked.net, b906a09) &raquo;</a
          >
        </p>

        <h2>March 5, 2008</h2>

        <h3>Assign found products for view (typechecked.net, 98ab4ca)</h3>
