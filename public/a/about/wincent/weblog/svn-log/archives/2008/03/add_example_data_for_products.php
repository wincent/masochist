...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add example data for products model (wincent.dev,
      4109d10)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/require_name_in_products_model.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/make_sure_product_name_is_not.php"
            >&laquo; Make sure product name is not nil (wincent.dev, 8ef596d)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/require_name_in_products_model.php"
            >Require name in products model (wincent.dev, e323bf2) &raquo;</a
          >
        </p>

        <h2>March 4, 2008</h2>

        <h3>Add example data for products model (wincent.dev, 4109d10)</h3>

        <p>
          This is the FixtureReplacement data that will be required in order to
          pass validations.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004213more"><div id="more"></div></div>
