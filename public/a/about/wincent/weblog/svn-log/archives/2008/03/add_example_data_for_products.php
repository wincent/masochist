...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add example data for products model (typechecked.net,
      4109d10)
    </title>
    ...
    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/03/require_name_in_products_model.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/03/make_sure_product_name_is_not.php"
            >&laquo; Make sure product name is not nil (typechecked.net, 8ef596d)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/03/require_name_in_products_model.php"
            >Require name in products model (typechecked.net, e323bf2) &raquo;</a
          >
        </p>

        <h2>March 4, 2008</h2>

        <h3>Add example data for products model (typechecked.net, 4109d10)</h3>
