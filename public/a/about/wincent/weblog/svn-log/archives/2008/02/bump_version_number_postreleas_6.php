...
<title>Git activity log: Bump version number post-release (wikitext, fd80e1c)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/minor_updates_to_readme_prior.php" title="Minor updates to README prior to release (wikitext, 03b8fda)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/add_posts_model_wincentcom_ca2.php" title="Add Posts model (wincent.com, ca2dca0)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/minor_updates_to_readme_prior.php">&laquo; Minor updates to README prior to release (wikitext, 03b8fda)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/add_posts_model_wincentcom_ca2.php">Add Posts model (wincent.com, ca2dca0) &raquo;</a>

</p>

<h2>February 13, 2008</h2>

<h3>Bump version number post-release (wikitext, fd80e1c)</h3>

<p>The released version was 0.1. As far as I can tell this is basically a feature-complete release (in terms of the features that I have envisioned for 1.0), so any subsequent releases will be bug-fix-only ones, probably following a numbering scheme like 0.2, 0.3 and so on.</p>

<p>The plan is to use the bundle in production, add more specs, correct any issues that might come up, and go to 1.0 once a reasonable interval has passed.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt;</p>

<div id="a004102more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at February 13, 2008  4:16 PM</p>
