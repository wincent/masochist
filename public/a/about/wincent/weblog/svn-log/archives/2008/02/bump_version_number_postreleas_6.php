...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Bump version number post-release (wikitext, fd80e1c)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/minor_updates_to_readme_prior.php"
      title="Minor updates to README prior to release (wikitext, 03b8fda)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_posts_model_wincentcom_ca2.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/minor_updates_to_readme_prior.php"
            >&laquo; Minor updates to README prior to release (wikitext,
            03b8fda)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_posts_model_wincentcom_ca2.php"
            >Add Posts model (wincent.dev, ca2dca0) &raquo;</a
          >
        </p>
        ...
        <p>
          The released version was 0.1. As far as I can tell this is basically a
          feature-complete release (in terms of the features that I have
          envisioned for 1.0), so any subsequent releases will be bug-fix-only
          ones, probably following a numbering scheme like 0.2, 0.3 and so on.
        </p>

        <p>
          The plan is to use the bundle in production, add more specs, correct
          any issues that might come up, and go to 1.0 once a reasonable
          interval has passed.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004102more"><div id="more"></div></div>
