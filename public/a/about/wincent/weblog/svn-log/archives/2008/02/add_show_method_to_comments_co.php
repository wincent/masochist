...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add show method to comments controller (wincent.dev,
      35495cb)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/modify_links_specs_to_get_them.php"
            >&laquo; Modify links specs to get them passing (wincent.dev,
            252308d)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/update_translations_specs_winc.php"
            >Update translations specs (wincent.dev, 08270ea) &raquo;</a
          >
        </p>

        <h2>February 7, 2008</h2>

        <h3>Add show method to comments controller (wincent.dev, 35495cb)</h3>
