...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add notes on Rails routing bug (typechecked.net, df1be01)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/workaround_haml_whitespace_dam.php"
      title="Workaround Haml whitespace damage of pre blocks (typechecked.net, ec72ab3)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/teach_haml_to_respect_preforma.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/teach_haml_to_respect_preforma.php"
            >Teach Haml to respect preformatted text (typechecked.net, 0eb6273)
            &raquo;</a
          >
        </p>
        ...
        <h3>Add notes on Rails routing bug (typechecked.net, df1be01)</h3>
