...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add notes on Rails routing bug (wincent.dev, df1be01)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/workaround_haml_whitespace_dam.php"
      title="Workaround Haml whitespace damage of pre blocks (wincent.dev, ec72ab3)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/teach_haml_to_respect_preforma.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/workaround_haml_whitespace_dam.php"
            >&laquo; Workaround Haml whitespace damage of pre blocks
            (wincent.dev, ec72ab3)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/teach_haml_to_respect_preforma.php"
            >Teach Haml to respect preformatted text (wincent.dev, 0eb6273)
            &raquo;</a
          >
        </p>
        ...
        <h3>Add notes on Rails routing bug (wincent.dev, df1be01)</h3>

        <p>
          I haven't yet found the cause of this one but it seems that Rails
          doesn't like wiki articles with numbers or periods in the names (not
          sure which yet).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004068more"><div id="more"></div></div>
