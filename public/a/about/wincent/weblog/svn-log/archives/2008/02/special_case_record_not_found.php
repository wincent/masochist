...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Special case record_not_found (wincent.dev, d35ee64)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/move_login_form_into_a_partial.php"
      title="Move login form into a partial (wincent.dev, 8c98144)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/first_cut_at_wiki_functionalit.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/move_login_form_into_a_partial.php"
            >&laquo; Move login form into a partial (wincent.dev, 8c98144)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/first_cut_at_wiki_functionalit.php"
            >First cut at wiki functionality (wincent.dev, b451c58) &raquo;</a
          >
        </p>

        <h2>February 7, 2008</h2>

        <h3>Special case record_not_found (wincent.dev, d35ee64)</h3>

        <p>
          In the default case (when there is no override) the uri parameter will
          actually be an instance of ActiveRecord::RecordNotFound, so watch out
          for that and intercept it; letting it through causes an exception to
          be raised.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003976more"><div id="more"></div></div>
