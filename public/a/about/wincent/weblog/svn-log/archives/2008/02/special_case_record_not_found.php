...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Special case record_not_found (typechecked.net, d35ee64)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/move_login_form_into_a_partial.php"
      title="Move login form into a partial (typechecked.net, 8c98144)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/first_cut_at_wiki_functionalit.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/move_login_form_into_a_partial.php"
            >&laquo; Move login form into a partial (typechecked.net, 8c98144)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/first_cut_at_wiki_functionalit.php"
            >First cut at wiki functionality (typechecked.net, b451c58) &raquo;</a
          >
        </p>

        <h2>February 7, 2008</h2>

        <h3>Special case record_not_found (typechecked.net, d35ee64)</h3>
