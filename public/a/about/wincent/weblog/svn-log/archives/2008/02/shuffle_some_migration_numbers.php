...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Shuffle some migration numbers (wincent.dev, 3e766e7)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/move_databaseyml_into_sample_w.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/make_fulltext_indexing_faster.php"
            >&laquo; Make full-text indexing faster by bypassing Active Record
            (wincent.dev, 7976609)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/move_databaseyml_into_sample_w.php"
            >Move database.yml into sample (wincent.dev, fba3f9a) &raquo;</a
          >
        </p>

        <h2>February 19, 2008</h2>

        <h3>Shuffle some migration numbers (wincent.dev, 3e766e7)</h3>
