...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Shuffle some migration numbers (typechecked.net, 3e766e7)
    </title>
    ...
    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/move_databaseyml_into_sample_w.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/move_databaseyml_into_sample_w.php"
            >Move database.yml into sample (typechecked.net, fba3f9a) &raquo;</a
          >
        </p>

        <h2>February 19, 2008</h2>

        <h3>Shuffle some migration numbers (typechecked.net, 3e766e7)</h3>
