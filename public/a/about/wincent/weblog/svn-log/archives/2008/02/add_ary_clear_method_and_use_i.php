...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add ary_clear method and use it (wikitext, 9b411a0)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/use_alloc_n_instead_of_malloc.php"
            >&laquo; Use ALLOC_N instead of malloc (wikitext, ebe7aea)</a
          >
          |
        ...
        <p>
          A bit of a micro-optimization: add an ary_clear method equivalent to
          the Array#clear method. Although the speed-up should be intangible it
