    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/extract_tagrelated_behaviour_i.php"
            >Extract tag-related behaviour into shared spec (typechecked.net,
            4f817df) &raquo;</a
          >
        </p>
        ...
        <h3>
          Add comments about polymorphic_url problems (typechecked.net, 2e87120)
        </h3>
