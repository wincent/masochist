...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add comments about polymorphic_url problems
      (wincent.dev, 2e87120)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/extract_recent_finder_into_pos.php"
            >&laquo; Extract &quot;recent&quot; finder into Post model
            (wincent.dev, 1fa464b)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/extract_tagrelated_behaviour_i.php"
            >Extract tag-related behaviour into shared spec (wincent.dev,
            4f817df) &raquo;</a
          >
        </p>
        ...
        <h3>
          Add comments about polymorphic_url problems (wincent.dev, 2e87120)
        </h3>

        <p>
          There should be a fairly easy workaround for this in the next release
          (post 2.0.2).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004141more"><div id="more"></div></div>
