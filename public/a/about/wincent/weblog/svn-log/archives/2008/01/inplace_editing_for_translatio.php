...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: In-place editing for translations (typechecked.net, 022faf3)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/add_databaselevel_constraints.php"
      title="Add database-level constraints for uniqueness (typechecked.net, 163821f)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/modify_in_place_editor_field_f.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/add_databaselevel_constraints.php"
            >&laquo; Add database-level constraints for uniqueness (typechecked.net,
            163821f)</a
          >
          |
          ...
          <a
            ...
            (typechecked.net, e2ac00d) &raquo;</a
          >
        </p>

        <h2>January 26, 2008</h2>

        <h3>In-place editing for translations (typechecked.net, 022faf3)</h3>
