...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: In-place editing for translations (wincent.dev, 022faf3)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_databaselevel_constraints.php"
      title="Add database-level constraints for uniqueness (wincent.dev, 163821f)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/modify_in_place_editor_field_f.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_databaselevel_constraints.php"
            >&laquo; Add database-level constraints for uniqueness (wincent.dev,
            163821f)</a
          >
          |
          ...
          <a
            ...
            (wincent.dev, e2ac00d) &raquo;</a
          >
        </p>

        <h2>January 26, 2008</h2>

        <h3>In-place editing for translations (wincent.dev, 022faf3)</h3>

        <p>
          Note that as this is a nested resource I have to pass the URL
          explicitly. I can probably simplify this by further tweaking the
          in_place_editor_field method.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003803more"><div id="more"></div></div>
