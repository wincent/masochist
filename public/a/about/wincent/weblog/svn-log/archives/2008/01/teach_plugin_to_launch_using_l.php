...
<title>Git activity log: Teach plug-in to launch using LSOpenItemsWithRole() (REnamer, 20661f5)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/change_worenamercontroller_to.php" title="Change WOREnamerController to WOREnamerDocument (REnamer, 2b68e85)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/free_fsref_array_in_separate_f.php" title="Free FSRef array in separate function (REnamer, ac28b68)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/change_worenamercontroller_to.php">&laquo; Change WOREnamerController to WOREnamerDocument (REnamer, 2b68e85)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/free_fsref_array_in_separate_f.php">Free FSRef array in separate function (REnamer, ac28b68) &raquo;</a>

</p>

<h2>January 19, 2008</h2>

<h3>Teach plug-in to launch using LSOpenItemsWithRole() (REnamer, 20661f5)</h3>

<p>This solves an issue with the old implementation which used execv() where it would allow multiple instances of the application to be launched.</p>

<p>As a nice side effect, this simplifies the code considerably and should run faster too with large numbers of files because we are basically working with FSRefs the whole time rather than converting them to path representations.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003719more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at January 19, 2008  5:56 PM</p>
