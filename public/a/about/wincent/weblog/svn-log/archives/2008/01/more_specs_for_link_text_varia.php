...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: More specs for link text variations in external links
      (wikitext, 87e6041)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/merge_branch_master_into_ragel.php"
      title="Merge branch 'master' into ragel (wikitext, 6ea6705)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/upgrade_to_rspec_113_wincentco.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/merge_branch_master_into_ragel.php"
            >&laquo; Merge branch 'master' into ragel (wikitext, 6ea6705)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/upgrade_to_rspec_113_wincentco.php"
            >Upgrade to RSpec 1.1.3 (wincent.dev, 7c1b89a) &raquo;</a
          >
        </p>
        ...
        <h3>
          More specs for link text variations in external links (wikitext,
          87e6041)
        </h3>

        <p>
          Test for automatic closing of unclosed spans, as well as handling of
          entities and non-ASCII characters in the link text.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003820more"><div id="more"></div></div>
