...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add support for HTTPS URIs (wikitext, 06a4b58)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_tokenization_of_mailto_uri.php"
            >&laquo; Add tokenization of mailto URIs (wikitext, c70f28a)</a
          >
          |
        ...
        <p>
          This was a bit of an oversight, as I always meant to incorporate it
          alongside HTTP URIs.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004024more"><div id="more"></div></div>
