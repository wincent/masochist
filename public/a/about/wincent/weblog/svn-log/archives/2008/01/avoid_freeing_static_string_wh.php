...
<title>Git activity log: Avoid freeing static string when normalizing (REnamer, 33cbcd0)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/remove_redundant_object_contro.php" title="Remove redundant object controller in main nib (REnamer, 8346fc7)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/add_tests_for_subsitution_vali.php" title="Add tests for subsitution validity checks (REnamer, 54b1ceb)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/remove_redundant_object_contro.php">&laquo; Remove redundant object controller in main nib (REnamer, 8346fc7)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/add_tests_for_subsitution_vali.php">Add tests for subsitution validity checks (REnamer, 54b1ceb) &raquo;</a>

</p>

<h2>January 18, 2008</h2>

<h3>Avoid freeing static string when normalizing (REnamer, 33cbcd0)</h3>

<p>When normalizing patterns we return a static string &quot;&quot; for the empty string. Given that the caller is expected to free normalized strings it will eventually try freeing the static string which will result in an warning being printed to the console.</p>

<p>We could dynamically allocate an empty string and return that instead (which the caller could then safely free), but this is in a performance-critical section of the code so we instead avoid the allocation and return a global static string.</p>

<p>As this is an internal-only API with just two call sites, we have those sites explicitly check for that global before invoking free.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003700more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at January 18, 2008  2:40 PM</p>
