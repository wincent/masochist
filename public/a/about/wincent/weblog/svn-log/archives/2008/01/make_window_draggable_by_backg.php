...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Make window draggable by background (REnamer, e1f154b)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/color_tweaks_for_preview_hud_r.php"
      title="Color tweaks for preview HUD (REnamer, eb57d8c)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/turn_preview_window_resizing_b.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/color_tweaks_for_preview_hud_r.php"
            >&laquo; Color tweaks for preview HUD (REnamer, eb57d8c)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/turn_preview_window_resizing_b.php"
            >Turn preview window resizing back on (REnamer, 413a463) &raquo;</a
          >
        </p>
        ...
        <p>
          Seeing as the &quot;background&quot; of the window is actually the
          NSTableView subclass that fills the entire window, implementing this
          means overriding the mouseDown method in the subclass and running an
          event loop to allow the user to drag the window around.
        </p>

        <p>
          In doing so I'm suppressing selection of table rows, which is not a
          bad thing seeing as they are not editable or reorderable anyway; I
          also conveniently sidestep the need to worry about overriding the
          default selection highlighting behaviour, which isn't appropriate for
          a HUD panel anyway.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003613more"><div id="more"></div></div>
