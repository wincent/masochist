...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/create_symlink_to_latest_versi.php"
      title="Create symlink to latest version of pcre.h header (REnamer, 3fdee73)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/clean_up_in_tests_renamer_93b2.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/create_symlink_to_latest_versi.php"
            >&laquo; Create symlink to latest version of pcre.h header (REnamer,
            3fdee73)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/clean_up_in_tests_renamer_93b2.php"
            >Clean up in tests (REnamer, 93b2130) &raquo;</a
          >
        </p>
        ...
        <p>
          Modify tests to compile correctly on Leopard under Garbage Collection,
          add additional information to the expections raised in the event of a
          parsing error; I was able to use this information to fix a bug in the
          scanning of special UTF-8 hex escapes.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003550more"><div id="more"></div></div>
