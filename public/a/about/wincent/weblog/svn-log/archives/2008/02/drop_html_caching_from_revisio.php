...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Drop HTML caching from revisions table (wincent.dev,
      5313bbb)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_typo_in_string_additions_f.php"
            >&laquo; Fix typo in String additions file (wincent.dev, 02bf922)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/whitespace_fix_wincentcom_c991.php"
            >Whitespace fix (wincent.dev, c9914a6) &raquo;</a
          >
        </p>

        <h2>February 7, 2008</h2>

        <h3>Drop HTML caching from revisions table (wincent.dev, 5313bbb)</h3>

        <p>
          Now we just store the wikitext markup in the database and generate
          HTML on demand.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003950more"><div id="more"></div></div>
