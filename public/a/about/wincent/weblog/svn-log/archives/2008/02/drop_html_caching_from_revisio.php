...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Drop HTML caching from revisions table (typechecked.net,
      5313bbb)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/fix_typo_in_string_additions_f.php"
            >&laquo; Fix typo in String additions file (typechecked.net, 02bf922)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/whitespace_fix_wincentcom_c991.php"
            >Whitespace fix (typechecked.net, c9914a6) &raquo;</a
          >
        </p>

        <h2>February 7, 2008</h2>

        <h3>Drop HTML caching from revisions table (typechecked.net, 5313bbb)</h3>
