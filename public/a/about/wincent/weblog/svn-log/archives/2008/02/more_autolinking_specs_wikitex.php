...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/eat_leading_whitespace_in_link.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_crasher_with_email_address.php"
            >&laquo; Fix crasher with email addresses inside nowiki and pre
            spans (wikitext, 47c718c)</a
          >
          |
        ...
        <p>
          Emails should not be converted into hyperlinks if autolinking is
          turned off.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003921more"><div id="more"></div></div>
