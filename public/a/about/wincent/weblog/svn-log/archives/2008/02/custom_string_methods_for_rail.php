...
<title>Git activity log: Custom string methods for Rails (wikitext, c58b779)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/add_rails_template_handler_wik.php" title="Add Rails template handler (wikitext, cc6949b)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/update_rakefile_to_include_new.php" title="Update Rakefile to include new Rails additions with gem (wikitext, fafe7ba)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/add_rails_template_handler_wik.php">&laquo; Add Rails template handler (wikitext, cc6949b)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/update_rakefile_to_include_new.php">Update Rakefile to include new Rails additions with gem (wikitext, fafe7ba) &raquo;</a>

</p>

<h2>February 21, 2008</h2>

<h3>Custom string methods for Rails (wikitext, c58b779)</h3>

<p>These are the additions to the String class that I've been using in my Rails app. They consist of a &quot;to_wikitext&quot; method and a shorter &quot;w&quot; alias for it.</p>
...
<p>This also demonstrates the use of a simple pre-processing phase. In this case I'm looking for strings like &quot;bug #12&quot; and converting them to &quot;[[bug/12|bug #12]]&quot; before handing them over to the wikitext parser, which has the effect of turning text like &quot;bug #12&quot; into autolinks.</p>

<p>In reality you'd probably provide your own custom implementation seeing as your needs are likely to be different form mine, but this demonstrates the kind of thing that you would do.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt;</p>

<div id="a004170more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at February 21, 2008 11:45 PM</p>
