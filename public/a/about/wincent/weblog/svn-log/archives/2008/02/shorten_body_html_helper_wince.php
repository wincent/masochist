...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Shorten body_html helper (typechecked.net, e54a968)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/extract_body_html_method_into.php"
            >&laquo; Extract body_html method into Articles helper (typechecked.net,
            46d62b2)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/move_login_as_method_into_spec.php"
            >Move login_as method into spec helper (typechecked.net, 8e136a7)
            &raquo;</a
          >
        </p>
        ...
        <h3>Shorten body_html helper (typechecked.net, e54a968)</h3>
