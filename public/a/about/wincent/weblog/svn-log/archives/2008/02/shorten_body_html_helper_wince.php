...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Shorten body_html helper (wincent.dev, e54a968)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/extract_body_html_method_into.php"
            >&laquo; Extract body_html method into Articles helper (wincent.dev,
            46d62b2)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/move_login_as_method_into_spec.php"
            >Move login_as method into spec helper (wincent.dev, 8e136a7)
            &raquo;</a
          >
        </p>
        ...
        <h3>Shorten body_html helper (wincent.dev, e54a968)</h3>

        <p>Make it a simple one-liner.</p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004088more"><div id="more"></div></div>
