...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Teach tokenize to tokenize new symbols (wikitext,
      fdf879d)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_left_curly_and_right_curly.php"
      title="Add LEFT_CURLY and RIGHT_CURLY symbols (wikitext, dd43eff)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/teach_parser_to_interpret_imag.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_left_curly_and_right_curly.php"
            >&laquo; Add LEFT_CURLY and RIGHT_CURLY symbols (wikitext,
            dd43eff)</a
          >
          |
        ...
        <p>
          Tokenize IMG_START, IMG_END, LEFT_CURLY and RIGHT_CURLY, and update
          the specs accordingly.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004155more"><div id="more"></div></div>
