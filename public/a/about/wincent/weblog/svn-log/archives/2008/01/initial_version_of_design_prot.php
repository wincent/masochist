...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Initial version of design prototype (typechecked.net,
      403b233)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/fix_irbrc_file_wincentcom_65d2.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/fix_irbrc_file_wincentcom_65d2.php"
            >&laquo; Fix irbrc file (typechecked.net, 65d26e4)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/embed_email_address_in_footer.php"
            >Embed email address in footer (typechecked.net, ac2ca7c) &raquo;</a
          >
        </p>

        <h2>January 23, 2008</h2>

        <h3>Initial version of design prototype (typechecked.net, 403b233)</h3>
