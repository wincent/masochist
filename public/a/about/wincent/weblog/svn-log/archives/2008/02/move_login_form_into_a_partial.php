...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Move login form into a partial (wincent.dev, 8c98144)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/show_tagging_count_in_tooltip.php"
            >&laquo; Show tagging count in tool-tip in tag cloud (wincent.dev,
            2e0f600)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/special_case_record_not_found.php"
            >Special case record_not_found (wincent.dev, d35ee64) &raquo;</a
          >
        </p>

        <h2>February 7, 2008</h2>

        <h3>Move login form into a partial (wincent.dev, 8c98144)</h3>

        <p>
          This will allow us to display the login form on any page as well as on
          its own dedicated page.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003975more"><div id="more"></div></div>
