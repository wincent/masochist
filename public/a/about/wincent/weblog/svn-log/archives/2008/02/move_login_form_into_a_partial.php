...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Move login form into a partial (typechecked.net, 8c98144)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/show_tagging_count_in_tooltip.php"
            >&laquo; Show tagging count in tool-tip in tag cloud (typechecked.net,
            2e0f600)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/special_case_record_not_found.php"
            >Special case record_not_found (typechecked.net, d35ee64) &raquo;</a
          >
        </p>

        <h2>February 7, 2008</h2>

        <h3>Move login form into a partial (typechecked.net, 8c98144)</h3>
