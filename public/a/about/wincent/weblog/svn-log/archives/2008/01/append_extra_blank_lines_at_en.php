...
<title>Git activity log: Append extra blank lines at end of output (buildtools, c71d3c1)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/automatically_append_wildcard.php" title="Automatically append wildcard to tag prefix (buildtools, 579267c)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/produce_release_notes_from_mul.php" title="Produce release notes from multiple repositories (Synergy, f50166c)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/automatically_append_wildcard.php">&laquo; Automatically append wildcard to tag prefix (buildtools, 579267c)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/produce_release_notes_from_mul.php">Produce release notes from multiple repositories (Synergy, f50166c) &raquo;</a>

</p>

<h2>January 23, 2008</h2>

<h3>Append extra blank lines at end of output (buildtools, c71d3c1)</h3>

<p>When emitting release notes for a project that is spread out across multiple repositories we may end up invoking the ReleaseNotes.sh script several time, successively appending more and more output to the generated notes.</p>

<p>Add two extra line feeds to make this easier: one because &quot;git log&quot; doesn't seem to emit one, and another to provide visual separation between sections.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003768more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at January 23, 2008  4:09 PM</p>
