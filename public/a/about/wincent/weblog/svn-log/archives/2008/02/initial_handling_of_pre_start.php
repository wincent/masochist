...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Initial handling of PRE_START and PRE_END in the parser
      (wikitext, e2ee2bb)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/rely_on_automated_early_return.php"
            >&laquo; Rely on automated early return from rollback functions
            (wikitext, 1dacef0)</a
          >
          |
        ...
        <h3>
          Initial handling of PRE_START and PRE_END in the parser (wikitext,
          e2ee2bb)
        </h3>

        <p>
          This handles the basic case. Will be adding specs to explore the edge
          cases and make the necessary changes to handle them.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004043more"><div id="more"></div></div>
