...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Fix Comment specs (typechecked.net, b522ae6)</title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/drop_redundant_authentication.php"
      title="Drop redundant authentication specs (typechecked.net, 1545453)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/run_specs_whenever_example_dat.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/drop_redundant_authentication.php"
            >&laquo; Drop redundant authentication specs (typechecked.net,
            1545453)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/run_specs_whenever_example_dat.php"
            >Run specs whenever example_data.rb changes (typechecked.net, a673655)
            &raquo;</a
          >
        </p>
        ...
        <h3>Fix Comment specs (typechecked.net, b522ae6)</h3>
