...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add full-text search to Posts model (typechecked.net,
      8e8cbcf)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/add_preprocessing_of_wikitext.php"
            >Add preprocessing of wikitext (typechecked.net, 8d444fd) &raquo;</a
          >
        </p>

        <h2>February 19, 2008</h2>

        <h3>Add full-text search to Posts model (typechecked.net, 8e8cbcf)</h3>
