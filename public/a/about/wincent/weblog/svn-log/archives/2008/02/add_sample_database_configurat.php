...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add sample database configuration file (typechecked.net,
      aedc881)
    </title>
    ...
    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/03/trim_robotstxt_wincentcom_63cd.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/remove_default_indexhtml_wince.php"
            >&laquo; Remove default index.html (typechecked.net, 1c84a1c)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/03/trim_robotstxt_wincentcom_63cd.php"
            >Trim robots.txt (typechecked.net, 63cdd2e) &raquo;</a
          >
        </p>

        <h2>February 29, 2008</h2>

        <h3>Add sample database configuration file (typechecked.net, aedc881)</h3>
