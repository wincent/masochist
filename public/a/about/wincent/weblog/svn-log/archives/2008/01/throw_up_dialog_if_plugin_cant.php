...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Throw up dialog if plug-in can't find main application
      (REnamer, fbfc2ad)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/start_conversion_of_help_docum.php"
      title="Start conversion of help documentation (REnamer, ade7ded)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_pointer_error_in_the_plugi.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/start_conversion_of_help_docum.php"
            >&laquo; Start conversion of help documentation (REnamer,
            ade7ded)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_pointer_error_in_the_plugi.php"
            >Fix pointer error in the plug-in (REnamer, 5eb12a6) &raquo;</a
          >
        </p>
        ...
        <h3>
          Throw up dialog if plug-in can't find main application (REnamer,
          fbfc2ad)
        </h3>

        <p>
          We first try by bundle identifier, but that won't work if the Launch
          Services database is out of date, so we fall back to looking in the
          Applications folder. If that doesn't work either we'd best notify the
          user; we do so and suggest that they try installing into the
          Applications folder, as that is probably the simplest and most
          appropriate bit of trouble-shooting advice that we can give under the
          circumstances.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003682more"><div id="more"></div></div>
