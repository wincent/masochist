...
<title>Git activity log: Throw up dialog if plug-in can't find main application (REnamer, fbfc2ad)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/start_conversion_of_help_docum.php" title="Start conversion of help documentation (REnamer, ade7ded)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/fix_pointer_error_in_the_plugi.php" title="Fix pointer error in the plug-in (REnamer, 5eb12a6)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/start_conversion_of_help_docum.php">&laquo; Start conversion of help documentation (REnamer, ade7ded)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/fix_pointer_error_in_the_plugi.php">Fix pointer error in the plug-in (REnamer, 5eb12a6) &raquo;</a>

</p>

<h2>January 18, 2008</h2>

<h3>Throw up dialog if plug-in can't find main application (REnamer, fbfc2ad)</h3>

<p>We first try by bundle identifier, but that won't work if the Launch Services database is out of date, so we fall back to looking in the Applications folder. If that doesn't work either we'd best notify the user; we do so and suggest that they try installing into the Applications folder, as that is probably the simplest and most appropriate bit of trouble-shooting advice that we can give under the circumstances.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003682more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at January 18, 2008 12:23 AM</p>
