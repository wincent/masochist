...
<title>Git activity log: Add custom string struct implementation (wikitext, 4f06bdd)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/add_indentation_specs_wikitext.php" title="Add indentation specs (wikitext, bf79f03)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/update_benchmark_notes_wikitex.php" title="Update benchmark notes (wikitext, e9d67ef)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/add_indentation_specs_wikitext.php">&laquo; Add indentation specs (wikitext, bf79f03)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/update_benchmark_notes_wikitex.php">Update benchmark notes (wikitext, e9d67ef) &raquo;</a>

</p>

<h2>February  9, 2008</h2>

<h3>Add custom string struct implementation (wikitext, 4f06bdd)</h3>

<p>This is actually the result of some work on an experimental topic branch which didn't work out. Now that we have the parser struct in place, however, it should be possible to gradually make more and more use of the efficient custom string struct instead of instantiating full-blown Ruby Strings. Object instantiation is one of the most costly operations in the translator, and it brings with it a corresponding cost in garbage collection, so I'm hoping that this will lead to a nice speed boost.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt;</p>

<div id="a004005more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at February  9, 2008 12:39 PM</p>
