...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add custom string struct implementation (wikitext,
      4f06bdd)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_indentation_specs_wikitext.php"
      title="Add indentation specs (wikitext, bf79f03)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/update_benchmark_notes_wikitex.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_indentation_specs_wikitext.php"
            >&laquo; Add indentation specs (wikitext, bf79f03)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/update_benchmark_notes_wikitex.php"
            >Update benchmark notes (wikitext, e9d67ef) &raquo;</a
          >
        </p>
        ...
        <p>
          This is actually the result of some work on an experimental topic
          branch which didn't work out. Now that we have the parser struct in
          place, however, it should be possible to gradually make more and more
          use of the efficient custom string struct instead of instantiating
          full-blown Ruby Strings. Object instantiation is one of the most
          costly operations in the translator, and it brings with it a
          corresponding cost in garbage collection, so I'm hoping that this will
          lead to a nice speed boost.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004005more"><div id="more"></div></div>
