...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove references to Revision model in example data
      (wincent.dev, efa788e)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/more_highlevel_updates_to_arti.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/nicer_css_for_pre_blocks_wince.php"
            >&laquo; Nicer CSS for PRE blocks (wincent.dev, de69284)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/more_highlevel_updates_to_arti.php"
            >More high-level updates to Articles controller (wincent.dev,
            5c6888e) &raquo;</a
          >
        </p>
        ...
        <h3>
          Remove references to Revision model in example data (wincent.dev,
          efa788e)
        </h3>

        <p>
          It's necessary to remove these references in order to get the console
          to work (because FixtureReplacement sees the data and expects to find
          the corresponding model).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004079more"><div id="more"></div></div>
