...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/nicer_css_for_pre_blocks_wince.php"
      title="Nicer CSS for PRE blocks (typechecked.net, de69284)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/more_highlevel_updates_to_arti.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/nicer_css_for_pre_blocks_wince.php"
            >&laquo; Nicer CSS for PRE blocks (typechecked.net, de69284)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/more_highlevel_updates_to_arti.php"
            >More high-level updates to Articles controller (typechecked.net,
            5c6888e) &raquo;</a
          >
        </p>
        ...
        <h3>
          Remove references to Revision model in example data (typechecked.net,
          efa788e)
        </h3>
