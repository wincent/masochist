...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove special case for PRE in the &quot;pop excess
      elements&quot; function (wikitext, 504bb6e)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/minor_cleanup_and_fix_for_bloc.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/minor_cleanup_and_fix_for_bloc.php"
            >&laquo; Minor cleanup and fix for blockquote/pre interaction
            (wikitext, 20db47c)</a
          >
          |
        ...
        <h3>
          Remove special case for PRE in the &quot;pop excess elements&quot;
          function (wikitext, 504bb6e)
        </h3>

        <p>
          By explicitly popping back to the closest BLOCKQUOTE block (if any) we
          can avoid the need to supply special case code in the &quot;pop excess
          elements&quot; function.
        </p>

        <p>
          This is better because it keeps the logic for the PRE case more
          localized.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004013more"><div id="more"></div></div>
