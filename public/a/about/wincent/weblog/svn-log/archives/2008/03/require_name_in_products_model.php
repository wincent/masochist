...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Require name in products model (typechecked.net, e323bf2)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/03/add_example_data_for_products.php"
      title="Add example data for products model (typechecked.net, 4109d10)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/03/require_product_names_to_be_un.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/03/add_example_data_for_products.php"
            >&laquo; Add example data for products model (typechecked.net,
            4109d10)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/03/require_product_names_to_be_un.php"
            >Require product names to be unique (typechecked.net, b023972)
            &raquo;</a
          >
        </p>
        ...
        <h3>Require name in products model (typechecked.net, e323bf2)</h3>
