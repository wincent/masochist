...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add NO_ITEM macro to ary.h (wikitext, d892368)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/replace_calls_to__wikitext_cou.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/replace_calls_to__wikitext_cou.php"
            >&laquo; Replace calls to _Wikitext_count with ary_count (wikitext,
            9108643)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/teach_ary_entry_to_handle_nega.php"
            >Teach ary_entry to handle negative offsets (wikitext, 5747c2f)
            &raquo;</a
          >
        </p>
        ...
        <p>
          Using this is slightly nicer than having to explicitly compare against
          INT_MAX.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003888more"><div id="more"></div></div>
