...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Avoid more glitches by monitoring for frame changes
      (REnamer, c4bdee5)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_trackknob_and_trackscrollb.php"
            >&laquo; Add trackKnob: and trackScrollButtons: implementations
            (REnamer, 3308124)</a
          >
          |
        ...
        <p>
          Have the scroll view advise the scrollers whenever its document view
          changes its frame or bounds. This is necessary to prevent glitches
          when, say, the user resizes the table columns (thus causing the scroll
          knobs to redraw).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003656more"><div id="more"></div></div>
