...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Changes for PCRE_MATCH_LIMIT (REnamer, d297c67)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/have_fallback_case_for_escapes.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/clean_up_in_tests_renamer_93b2.php"
            >&laquo; Clean up in tests (REnamer, 93b2130)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/have_fallback_case_for_escapes.php"
            >Have fallback case for escapes (REnamer, 4c15966) &raquo;</a
          >
        </p>
        ...
        <p>
          It appears that PCRE_MATCH_LIMIT and its companion,
          PCRE_MATCH_LIMIT_RECURSION, no longer appear in the test suite, so
          change the code comments accordingly to match.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003552more"><div id="more"></div></div>
