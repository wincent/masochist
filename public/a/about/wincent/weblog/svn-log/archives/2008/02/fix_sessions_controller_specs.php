...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix sessions controller specs (typechecked.net, e89c44d)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/whitespace_fix_trim_unnecessar.php"
      title="Whitespace fix: trim unnecessary empty line (typechecked.net, e0608c3)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/migration_tweaks_wincentcom_44.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/whitespace_fix_trim_unnecessar.php"
            >&laquo; Whitespace fix: trim unnecessary empty line (typechecked.net,
            e0608c3)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/migration_tweaks_wincentcom_44.php"
            >Migration tweaks (typechecked.net, 44d306e) &raquo;</a
          >
        </p>

        <h2>February 7, 2008</h2>

        <h3>Fix sessions controller specs (typechecked.net, e89c44d)</h3>
