...
<title>Git activity log: Fix sessions controller specs (wincent.com, e89c44d)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/whitespace_fix_trim_unnecessar.php" title="Whitespace fix: trim unnecessary empty line (wincent.com, e0608c3)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/migration_tweaks_wincentcom_44.php" title="Migration tweaks (wincent.com, 44d306e)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/whitespace_fix_trim_unnecessar.php">&laquo; Whitespace fix: trim unnecessary empty line (wincent.com, e0608c3)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/migration_tweaks_wincentcom_44.php">Migration tweaks (wincent.com, 44d306e) &raquo;</a>

</p>

<h2>February  7, 2008</h2>

<h3>Fix sessions controller specs (wincent.com, e89c44d)</h3>

<p>This was a tricky one, who to simulate a user login in the specs. The problem is that the testing machinery assumes one request per spec, so you can't do the obvious easy solution of doing a real login and then following it up with other specs.</p>

<p>The next most obvious option is just calling the &quot;current_user=&quot; method but that won't work either. That method sets stuff in cookies and the session and those aren't set up yet prior to doing a post in your specs.</p>

<p>So in the end we just reach in and set the &quot;@current_user&quot; instance variable directly. Note that we have to intercept the call to the &quot;login_before&quot; before filter otherwise it will proceed to clear the instance variable as soon as we initiate an actual request.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt;</p>

<div id="a003960more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at February  7, 2008 12:29 PM</p>
