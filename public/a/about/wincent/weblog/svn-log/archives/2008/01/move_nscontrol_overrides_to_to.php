...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Move NSControl overrides to top of file (REnamer,
      1f43be9)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/avoid_more_glitches_by_monitor.php"
      title="Avoid more glitches by monitoring for frame changes (REnamer, c4bdee5)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/implement_clickandhold_in_the.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/avoid_more_glitches_by_monitor.php"
            >&laquo; Avoid more glitches by monitoring for frame changes
            (REnamer, c4bdee5)</a
          >
          |
        ...
        <p>
          This was originally to be part of c4bdee5; I wanted the scroller
          itself to monitor for frame changes, and so I want the overrides to be
          up the top of the file (I would be overriding either initWithFrame: or
          awakeFromNib).
        </p>

        <p>
          It turned out that the cleaner way to do this was to register from
          within the scroll view (it knows whenever you give it a new document
          view).
        </p>

        <p>
          All the same, keeping this change as the reordering was not
          necessarily a bad thing.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003657more"><div id="more"></div></div>
