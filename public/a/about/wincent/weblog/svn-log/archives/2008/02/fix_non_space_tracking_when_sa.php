...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix &quot;non_space&quot; tracking when sanitizing links
      (wikitext, c0bccec)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_whitespace_trimming_when_r.php"
            >&laquo; Fix whitespace trimming when reallocating in the encoder
            (wikitext, 0b85588)</a
          >
          |
        ...
        <p>
          This is the same bug that could occur during reallocation as was fixed
          for the link encoder in commit 0b85588.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003928more"><div id="more"></div></div>
