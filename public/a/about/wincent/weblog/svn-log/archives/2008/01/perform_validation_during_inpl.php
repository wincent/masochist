...
<title>Git activity log: Perform validation during in-place editing (wincent.com, bc34e99)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/add_update_attribute_to_active.php" title="Add update_attribute! to Active Record (wincent.com, cec57c5)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/show_alert_if_model_validation.php" title="Show alert if model validation fails for in-place editing (wincent.com, 21d51ba)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/add_update_attribute_to_active.php">&laquo; Add update_attribute! to Active Record (wincent.com, cec57c5)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/show_alert_if_model_validation.php">Show alert if model validation fails for in-place editing (wincent.com, 21d51ba) &raquo;</a>

</p>

<h2>January 25, 2008</h2>

<h3>Perform validation during in-place editing (wincent.com, bc34e99)</h3>

<p>This is the first step in making in-place editing play nicely with the validation system. Firstly, rather than blindly bypassing validation during AJAX in-place editing (what were they thinking?) we do validate. Secondly, in the event that saving (validation) fails we restore the old value of the field so that the user can see it.</p>

<p>The next step will be to see if we can get the parent controller to display a flash message explaining the cause of the validation failure.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003796more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at January 25, 2008  5:08 PM</p>
