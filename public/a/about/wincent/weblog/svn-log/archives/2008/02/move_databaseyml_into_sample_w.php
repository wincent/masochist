...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Move database.yml into sample (wincent.dev, fba3f9a)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/shuffle_some_migration_numbers.php"
            >&laquo; Shuffle some migration numbers (wincent.dev, 3e766e7)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/initial_versions_of_capistrano.php"
            >Initial versions of Capistrano files (not yet customized)
            (wincent.dev, 902eb8c) &raquo;</a
          >
        </p>

        <h2>February 20, 2008</h2>

        <h3>Move database.yml into sample (wincent.dev, fba3f9a)</h3>

        <p>
          Preparing for deployment, rename &quot;database.yml&quot; to
          &quot;database.sample.yml&quot;.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004203more"><div id="more"></div></div>
