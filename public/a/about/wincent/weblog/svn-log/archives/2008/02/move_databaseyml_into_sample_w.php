...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Move database.yml into sample (typechecked.net, fba3f9a)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/shuffle_some_migration_numbers.php"
            >&laquo; Shuffle some migration numbers (typechecked.net, 3e766e7)</a
          >
          |
          ...
          <a
            ...
            (typechecked.net, 902eb8c) &raquo;</a
          >
        </p>

        <h2>February 20, 2008</h2>

        <h3>Move database.yml into sample (typechecked.net, fba3f9a)</h3>
