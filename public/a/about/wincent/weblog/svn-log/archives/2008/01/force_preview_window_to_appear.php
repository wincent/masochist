...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Force preview window to appear at launch (REnamer,
      3c032fa)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/show_preview_window_only_for_m.php"
      title="Show preview window only for main window (REnamer, cd1b156)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/force_window_to_front_on_subse.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/show_preview_window_only_for_m.php"
            >&laquo; Show preview window only for main window (REnamer,
            cd1b156)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/force_window_to_front_on_subse.php"
            >Force window to front on subsequent &quot;open&quot; events
            (REnamer, f8562dc) &raquo;</a
          >
        </p>
        ...
        <p>
          The preview window won't necessarily appear at launch time unless we
          force it's associated window to become the main window.
        </p>

        <p>
          This doesn't seem to work for subsequent &quot;open&quot; events,
          however (the new window doesn't become main).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003735more"><div id="more"></div></div>
