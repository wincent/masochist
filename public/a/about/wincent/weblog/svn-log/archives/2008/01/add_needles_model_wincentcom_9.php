...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add &quot;needles&quot; model (wincent.dev, 99bb491)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/upgrade_to_pcre_76_renamer_f6f.php"
      title="Upgrade to PCRE 7.6 (REnamer, f6f39c8)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/initial_sass_stylesheet_wincen.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/upgrade_to_pcre_76_renamer_f6f.php"
            >&laquo; Upgrade to PCRE 7.6 (REnamer, f6f39c8)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/initial_sass_stylesheet_wincen.php"
            >Initial Sass stylesheet (wincent.dev, 0d58fa2) &raquo;</a
          >
        </p>

        <h2>January 29, 2008</h2>

        <h3>Add &quot;needles&quot; model (wincent.dev, 99bb491)</h3>

        <p>
          This is the model that provides site-wide search. &quot;acts as
          ferret&quot; gets good press but it is an external dependency; MySQL's
          own full-text search has a reputation for not scaling well.
        </p>

        <p>
          So we roll our own model to give us what we want using a normal MySQL
          table of &quot;needles&quot; to be found in the &quot;haystack&quot;,
          and it is a standard Active Record model class.
        </p>

        <p>
          At this stage we provide simple AND searches (all the words in the
          query string must be present), OR searches (any of the words is enough
          to match), attribute searches (for example, &quot;title:hello&quot;
          finds models with the word &quot;hello&quot; in the &quot;title&quot;
          attribute), and user-scoped searches (admin users can find all
          results, anonymous users can find only public results, and other users
          can find only results which should be visible to them: their own
          records and any public records).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003810more"><div id="more"></div></div>
