...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Property overhaul for WORegularExpressions class
      (REnamer, ad1d5bb)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/do_universal_pcre_builds_in_re.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_woregularexpressionmatch_c.php"
            >&laquo; Add WORegularExpressionMatch class (REnamer, 4d6aeb0)</a
          >
          |
        ...
        <p>
          Replace hand-coded accessors with Objective-C 2.0 properties and
          synthesized accessors, remove unused accessors, cache normalized forms
          when the corresponding properties are set, replace usage of NSLog with
          WOLogManager.
        </p>

        <p>
          This should probably be a series of commits but I the changes were
          made simultaneously seeing as they required pretty much each file to
          be swept over in its entirety.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003635more"><div id="more"></div></div>
