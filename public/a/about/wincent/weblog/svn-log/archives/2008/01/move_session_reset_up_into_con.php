...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Move session reset up into controller (typechecked.net,
      ab81739)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/updates_for_session_fixation_a.php"
      title="Updates for session fixation attacks (typechecked.net, ba7907d)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/add_in_place_editing_plugin_wi.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/updates_for_session_fixation_a.php"
            >&laquo; Updates for session fixation attacks (typechecked.net,
            ba7907d)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/add_in_place_editing_plugin_wi.php"
            >Add in_place_editing_plugin (typechecked.net, 209d96c) &raquo;</a
          >
        </p>

        <h2>January 25, 2008</h2>

        <h3>Move session reset up into controller (typechecked.net, ab81739)</h3>
