...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Updates for session fixation attacks (typechecked.net,
      ba7907d)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/provide_nice_redirection_if_la.php"
      title="Provide nice redirection if lacking privileges (typechecked.net, 0e41246)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/move_session_reset_up_into_con.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/move_session_reset_up_into_con.php"
            >Move session reset up into controller (typechecked.net, ab81739)
            &raquo;</a
          >
        </p>
        ...
        <h3>Updates for session fixation attacks (typechecked.net, ba7907d)</h3>
