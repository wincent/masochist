...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Updates for session fixation attacks (wincent.dev,
      ba7907d)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/provide_nice_redirection_if_la.php"
      title="Provide nice redirection if lacking privileges (wincent.dev, 0e41246)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/move_session_reset_up_into_con.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/provide_nice_redirection_if_la.php"
            >&laquo; Provide nice redirection if lacking privileges
            (wincent.dev, 0e41246)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/move_session_reset_up_into_con.php"
            >Move session reset up into controller (wincent.dev, ab81739)
            &raquo;</a
          >
        </p>
        ...
        <h3>Updates for session fixation attacks (wincent.dev, ba7907d)</h3>

        <p>
          I've made the authentication mechanism even more secure against
          session fixation attacks by adding another couple of layers of
          &quot;defense in depth&quot;.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003789more"><div id="more"></div></div>
