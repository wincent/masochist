...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix passphrase mass assignment specs (wincent.dev,
      3c019bc)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/autoload_fixturereplacement_in.php"
      title="Autoload FixtureReplacement in the console (wincent.dev, 6912254)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_formatting_in_user_specs_w.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/autoload_fixturereplacement_in.php"
            >&laquo; Autoload FixtureReplacement in the console (wincent.dev,
            6912254)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_formatting_in_user_specs_w.php"
            >Fix formatting in user specs (wincent.dev, cedd461) &raquo;</a
          >
        </p>

        <h2>January 23, 2008</h2>

        <h3>Fix passphrase mass assignment specs (wincent.dev, 3c019bc)</h3>

        <p>
          Must test the mass assignment of the passphrase and the passphrase
          confirmaton at once otherwise validation will prevent the spec from
          succeeding.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003756more"><div id="more"></div></div>
