...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix passphrase mass assignment specs (typechecked.net,
      3c019bc)
    </title>
    ...
    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/fix_formatting_in_user_specs_w.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/autoload_fixturereplacement_in.php"
            >&laquo; Autoload FixtureReplacement in the console (typechecked.net,
            6912254)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/fix_formatting_in_user_specs_w.php"
            >Fix formatting in user specs (typechecked.net, cedd461) &raquo;</a
          >
        </p>

        <h2>January 23, 2008</h2>

        <h3>Fix passphrase mass assignment specs (typechecked.net, 3c019bc)</h3>
