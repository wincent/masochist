...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove old code from WOHUDScroller (REnamer, 1bc1fc4)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/refactor_arrow_rendering_renam.php"
      title="Refactor arrow rendering (REnamer, 135bab7)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/upgrade_to_rspec_112_wincentco.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/refactor_arrow_rendering_renam.php"
            >&laquo; Refactor arrow rendering (REnamer, 135bab7)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/upgrade_to_rspec_112_wincentco.php"
            >Upgrade to RSpec 1.1.2 (wincent.dev, 8e2cb5c) &raquo;</a
          >
        </p>
        ...
        <p>
          The old drawing style was still present in the source files but was
          hidden from the compiler with preprocessor directives. Now that the
          alteranative implementation is up and running, remove the old one from
          the source to keep the files lean; if the old algorithm is ever needed
          in the future it can be consulted using Git.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003650more"><div id="more"></div></div>
