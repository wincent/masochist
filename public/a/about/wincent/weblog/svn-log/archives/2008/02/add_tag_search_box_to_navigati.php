...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add tag search box to navigation bar (wincent.dev,
      94ad75f)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_tag_search_wincentcom_8075.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_tag_search_wincentcom_8075.php"
            >&laquo; Add tag search (wincent.dev, 80753b1)</a
          >
          |
        ...
        <h3>Add tag search box to navigation bar (wincent.dev, 94ad75f)</h3>

        <p>
          May later swap in full-text search box here, but for now go with tags
          as it is simpler.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004147more"><div id="more"></div></div>
