...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Create WOREnamerWindowController class (REnamer,
      02706a4)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/defer_to_super_if_we_dont_hand.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/defer_to_super_if_we_dont_hand.php"
            >&laquo; Defer to super if we don't handle the KVO message (REnamer,
            0c0ac38)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/migrate_functionality_into_app.php"
            >Migrate functionality into application controller (REnamer,
            4066730) &raquo;</a
          >
        </p>
        ...
        <p>
          At the moment we don't actually override the default
          NSWindowController behaviour, but subsequently we will (to provide a
          custom title).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003726more"><div id="more"></div></div>
