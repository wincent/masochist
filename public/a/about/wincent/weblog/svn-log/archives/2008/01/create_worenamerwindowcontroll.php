...
<title>Git activity log: Create WOREnamerWindowController class (REnamer, 02706a4)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/defer_to_super_if_we_dont_hand.php" title="Defer to super if we don't handle the KVO message (REnamer, 0c0ac38)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/migrate_functionality_into_app.php" title="Migrate functionality into application controller (REnamer, 4066730)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/defer_to_super_if_we_dont_hand.php">&laquo; Defer to super if we don't handle the KVO message (REnamer, 0c0ac38)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/migrate_functionality_into_app.php">Migrate functionality into application controller (REnamer, 4066730) &raquo;</a>

</p>

<h2>January 20, 2008</h2>

<h3>Create WOREnamerWindowController class (REnamer, 02706a4)</h3>

<p>At the moment we don't actually override the default NSWindowController behaviour, but subsequently we will (to provide a custom title).</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003726more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at January 20, 2008  2:53 PM</p>
