...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Create products model (wincent.dev, 68a5a55)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/add_confirmation_of_emails_win.php"
      title="Add confirmation of emails (wincent.dev, 78a395a)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/make_sure_product_name_is_not.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/add_confirmation_of_emails_win.php"
            >&laquo; Add confirmation of emails (wincent.dev, 78a395a)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/make_sure_product_name_is_not.php"
            >Make sure product name is not nil (wincent.dev, 8ef596d) &raquo;</a
          >
        </p>

        <h2>March 4, 2008</h2>

        <h3>Create products model (wincent.dev, 68a5a55)</h3>

        <p>
          This is just the bare skeleton created by &quot;script/generate
          model&quot;.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004211more"><div id="more"></div></div>
