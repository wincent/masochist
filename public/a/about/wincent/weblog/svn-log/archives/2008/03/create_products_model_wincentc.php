...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Create products model (typechecked.net, 68a5a55)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/03/add_confirmation_of_emails_win.php"
      title="Add confirmation of emails (typechecked.net, 78a395a)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/03/make_sure_product_name_is_not.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/03/add_confirmation_of_emails_win.php"
            >&laquo; Add confirmation of emails (typechecked.net, 78a395a)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/03/make_sure_product_name_is_not.php"
            >Make sure product name is not nil (typechecked.net, 8ef596d) &raquo;</a
          >
        </p>

        <h2>March 4, 2008</h2>

        <h3>Create products model (typechecked.net, 68a5a55)</h3>
