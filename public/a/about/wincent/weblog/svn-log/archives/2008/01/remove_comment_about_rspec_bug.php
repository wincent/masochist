...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove comment about RSpec bug (typechecked.net, f7ebc62)
    </title>
    ...
    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/user_spec_fixes_for_mass_assig.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/reset_session_on_loginlogout_w.php"
            >&laquo; Reset session on login/logout (typechecked.net, 4a69b0d)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/user_spec_fixes_for_mass_assig.php"
            >User spec fixes for mass assignment (typechecked.net, ab7e57d)
            &raquo;</a
          >
        </p>
        ...
        <h3>Remove comment about RSpec bug (typechecked.net, f7ebc62)</h3>
