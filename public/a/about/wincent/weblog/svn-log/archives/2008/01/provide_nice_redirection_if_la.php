...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Provide nice redirection if lacking privileges
      (wincent.dev, 0e41246)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/require_admin_privileges_in_or.php"
            >&laquo; Require admin privileges in order to edit translations
            (wincent.dev, 7fbf92c)</a
          >
          |
        ...
        <h3>
          Provide nice redirection if lacking privileges (wincent.dev, 0e41246)
        </h3>

        <p>
          Redirect the user to the login page if they request something for
          which they don't have privileges.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003788more"><div id="more"></div></div>
