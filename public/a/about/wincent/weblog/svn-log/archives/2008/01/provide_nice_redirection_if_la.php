...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/require_admin_privileges_in_or.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/updates_for_session_fixation_a.php"
            >Updates for session fixation attacks (typechecked.net, ba7907d)
            &raquo;</a
          >
        </p>
        ...
        <h3>
          Provide nice redirection if lacking privileges (typechecked.net, 0e41246)
        </h3>
