...
<title>Git activity log: Get integration specs passing (fix OL/UL nesting in BLOCKQUOTE) (wikitext, ae0ffab)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/fix_tt_handling_inside_blockqu.php" title="Fix TT handling inside BLOCKQUOTE blocks (wikitext, 52ad5ee)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/add_specs_to_catch_regressions.php" title="Add specs to catch regressions (wikitext, 01ada5a)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/fix_tt_handling_inside_blockqu.php">&laquo; Fix TT handling inside BLOCKQUOTE blocks (wikitext, 52ad5ee)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/add_specs_to_catch_regressions.php">Add specs to catch regressions (wikitext, 01ada5a) &raquo;</a>

</p>

<h2>February  9, 2008</h2>

<h3>Get integration specs passing (fix OL/UL nesting in BLOCKQUOTE) (wikitext, ae0ffab)</h3>

<p>When starting a brand new list may need to pop back to (but not including) the nearest BLOCKQUOTE; this fixes the case where a new list is started inside a BLOCKQUOTE on the line immediately after an open paragraph. It is necessary to pop the paragraph in order for things to be correctly formatted.</p>

<p>With this change all the specs are back passing again.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt;</p>

<div id="a004015more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at February  9, 2008  8:05 PM</p>
