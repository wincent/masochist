...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix initialization of mutable string in test rig
      (REnamer, 2b6cf06)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_vertical_tab_detection_ren.php"
            >&laquo; Fix vertical tab detection (REnamer, 4c78079)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/upgrade_to_haml_180_wincentcom.php"
            >Upgrade to Haml 1.8.0 (wincent.dev, 14c0c89) &raquo;</a
          >
        </p>
        ...
        <p>
          We should be starting with an empty string and populate it as we go.
