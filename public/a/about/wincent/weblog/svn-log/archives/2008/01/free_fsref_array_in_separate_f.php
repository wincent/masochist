...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Free FSRef array in separate function (REnamer, ac28b68)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/teach_plugin_to_launch_using_l.php"
      title="Teach plug-in to launch using LSOpenItemsWithRole() (REnamer, 20661f5)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_lsopenitemswithrole_usage.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/teach_plugin_to_launch_using_l.php"
            >&laquo; Teach plug-in to launch using LSOpenItemsWithRole()
            (REnamer, 20661f5)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_lsopenitemswithrole_usage.php"
            >Fix LSOpenItemsWithRole usage (REnamer, 293cecc) &raquo;</a
          >
        </p>
        ...
        <p>
          There are two places where we walk the FSRef array and free the
          references; extract this out into a separate function for consistency
          (in fact, the two different places were discrepant, and one of them
          didn't correctly NULLify the array after freeing so this is really a
          bug fix, not just a refactoring).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003720more"><div id="more"></div></div>
