...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Add routing for wiki (wincent.dev, 1e83226)</title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/simplify_localetranslation_rou.php"
      title="Simplify locale/translation routing (wincent.dev, ea50092)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_typo_in_string_additions_f.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/simplify_localetranslation_rou.php"
            >&laquo; Simplify locale/translation routing (wincent.dev,
            ea50092)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_typo_in_string_additions_f.php"
            >Fix typo in String additions file (wincent.dev, 02bf922) &raquo;</a
          >
        </p>

        <h2>February 7, 2008</h2>

        <h3>Add routing for wiki (wincent.dev, 1e83226)</h3>

        <p>
          Wiki articles are modelled using the Article model, but we want paths
          like &quot;/wiki/foo&quot; rather than &quot;/article/foo&quot;, so
          set up the routes accordingly.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003948more"><div id="more"></div></div>
