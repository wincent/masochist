...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Add routing for wiki (typechecked.net, 1e83226)</title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/simplify_localetranslation_rou.php"
      title="Simplify locale/translation routing (typechecked.net, ea50092)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/fix_typo_in_string_additions_f.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/simplify_localetranslation_rou.php"
            >&laquo; Simplify locale/translation routing (typechecked.net,
            ea50092)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/fix_typo_in_string_additions_f.php"
            >Fix typo in String additions file (typechecked.net, 02bf922) &raquo;</a
          >
        </p>

        <h2>February 7, 2008</h2>

        <h3>Add routing for wiki (typechecked.net, 1e83226)</h3>
