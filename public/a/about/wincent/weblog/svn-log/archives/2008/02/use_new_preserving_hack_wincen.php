...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Use new preserving hack (typechecked.net, 1be5ca4)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/teach_haml_to_respect_preforma.php"
            >&laquo; Teach Haml to respect preformatted text (typechecked.net,
            0eb6273)</a
          >
          |
        ...
        <h3>Use new preserving hack (typechecked.net, 1be5ca4)</h3>
