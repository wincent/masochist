...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix formatting in user specs (wincent.dev, cedd461)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/update_version_numbers_for_rel.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_passphrase_mass_assignment.php"
            >&laquo; Fix passphrase mass assignment specs (wincent.dev,
            3c019bc)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/update_version_numbers_for_rel.php"
            >Update version numbers for release (Synergy, 64252fc) &raquo;</a
          >
        </p>

        <h2>January 23, 2008</h2>

        <h3>Fix formatting in user specs (wincent.dev, cedd461)</h3>

        <p>This is a whitespace-only fix (purely aesthetic).</p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003758more"><div id="more"></div></div>
