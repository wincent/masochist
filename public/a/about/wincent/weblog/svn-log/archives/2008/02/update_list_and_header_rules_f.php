...
<title>Git activity log: Update list and header rules for new BLOCKQUOTE_START token (wikitext, 9e985ab)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/add_tokenization_of_literal_bl.php" title="Add tokenization of literal blockquote tags (wikitext, 8888a18)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/basic_blockquote_implementatio.php" title="Basic blockquote implementation using real HTML tags (wikitext, 88da5f3)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/add_tokenization_of_literal_bl.php">&laquo; Add tokenization of literal blockquote tags (wikitext, 8888a18)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/basic_blockquote_implementatio.php">Basic blockquote implementation using real HTML tags (wikitext, 88da5f3) &raquo;</a>

</p>

<h2>February 10, 2008</h2>

<h3>Update list and header rules for new BLOCKQUOTE_START token (wikitext, 9e985ab)</h3>

<p>These rules previously held if at the start of the line or immediately after a BLOCKQUOTE token; now that we have BLOCKQUOTE_START as well we need to add that to the lsit of conditions too.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt;</p>

<div id="a004048more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at February 10, 2008 10:13 PM</p>
