...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add live preview to wiki (typechecked.net, 8140e20)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/remove_redundant_parameters_to.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/drop_revisions_model_wincentco.php"
            >Drop Revisions model (typechecked.net, b6312eb) &raquo;</a
          >
        </p>

        <h2>February 12, 2008</h2>

        <h3>Add live preview to wiki (typechecked.net, 8140e20)</h3>
