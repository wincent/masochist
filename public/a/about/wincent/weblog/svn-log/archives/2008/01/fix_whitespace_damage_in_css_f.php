...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix whitespace damage in CSS files (REnamer, ba0d253)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/import_css_updates_into_web_he.php"
            >&laquo; Import CSS updates into web help directory (REnamer,
            ecc32be)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/fix_index_header_misalignment.php"
            >Fix Index header misalignment (REnamer, 97fa977) &raquo;</a
          >
        </p>
        ...
        <p>
          This whitspace damage has been in there for some time but only just
          noticed it.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003676more"><div id="more"></div></div>
