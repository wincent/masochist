...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Extract in_place_editor_field_id function (wincent.dev,
      4539ee9)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/add_usage_notes_for_in_place_e.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/show_alert_if_model_validation.php"
            >&laquo; Show alert if model validation fails for in-place editing
            (wincent.dev, 21d51ba)</a
          >
          |
        ...
        <p>
          Rather than hardcoding in two places the id of the field that will be
          replaced via AJAX, make a helper function that returns the id and call
          that.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003798more"><div id="more"></div></div>
