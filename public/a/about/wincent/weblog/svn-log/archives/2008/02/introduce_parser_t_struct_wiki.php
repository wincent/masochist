...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Introduce parser_t struct (wikitext, f55c418)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/maintain_internal_indentation.php"
      title="Maintain internal indentation level variable (wikitext, ad3271a)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/roll_pending_crlf_into_parser.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/maintain_internal_indentation.php"
            >&laquo; Maintain internal indentation level variable (wikitext,
            ad3271a)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/roll_pending_crlf_into_parser.php"
            >Roll pending_crlf into parser struct (wikitext, 1aab4ce) &raquo;</a
          >
        </p>
        ...
        <p>
          This will make passing parameters around much easier because we'll be
          able to pass a single pointer rather than a raft of variables. As a
          starting point, I've converted the &quot;start para if necessary&quot;
          function to accept a pointer to the new struct as one of its
          parameters.
        </p>

        <p>
          Once fully completed this will be a substantial clean-up and a big
          enhancement for maintainability.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003985more"><div id="more"></div></div>
