...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Inline moderation of post comments (typechecked.net,
      ec346e2)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/add_comments_to_weblog_wincent.php"
      title="Add comments to weblog (typechecked.net, 5559ac9)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/make_sure_admin_sees_all_comme.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/add_comments_to_weblog_wincent.php"
            >&laquo; Add comments to weblog (typechecked.net, 5559ac9)</a
          >
          |
          ...
          <a
            ...
            template (typechecked.net, 00d93e7) &raquo;</a
          >
        </p>

        <h2>February 14, 2008</h2>

        <h3>Inline moderation of post comments (typechecked.net, ec346e2)</h3>
