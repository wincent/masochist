...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Inline moderation of post comments (wincent.dev,
      ec346e2)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_comments_to_weblog_wincent.php"
      title="Add comments to weblog (wincent.dev, 5559ac9)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/make_sure_admin_sees_all_comme.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_comments_to_weblog_wincent.php"
            >&laquo; Add comments to weblog (wincent.dev, 5559ac9)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/make_sure_admin_sees_all_comme.php"
            >Make sure admin sees all comments in posts &quot;show&quot;
            template (wincent.dev, 00d93e7) &raquo;</a
          >
        </p>

        <h2>February 14, 2008</h2>

        <h3>Inline moderation of post comments (wincent.dev, ec346e2)</h3>

        <p>
          Add two buttons underneath each comment, but only when logged in as an
          admin user. The &quot;spam&quot; button marks a message as spam and
          then fades out the offending comment; the &quot;ham&quot; button
          clears the &quot;awaiting moderation&quot; attribute of the comment
          and fades out the &quot;spam&quot;/&quot;ham&quot; buttons.
        </p>

        <p>
          At the top of the listing we show three comment counts: published
          comments, comments awaiting moderation, and spam comments. On the main
          listing page the comment count that we show is actually the sum of
