...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update code comments for function descriptions
      (wikitext, f85b8b6)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/more_function_simplification_w.php"
            >&laquo; More function simplification (wikitext, dd54a50)</a
          >
          |
        ...
        <p>
          In light of the recent and ongoing refactoring, clarify some of the
          function descriptions in code comments to avoid possible confusion.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003990more"><div id="more"></div></div>
