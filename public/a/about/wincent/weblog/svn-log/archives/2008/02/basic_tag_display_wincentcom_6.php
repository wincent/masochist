...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Basic tag display (typechecked.net, 61b8b6f)</title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/prettify_wiki_urls_wincentcom.php"
            >&laquo; Prettify wiki URLs (typechecked.net, 7a865f9)</a
          >
          |
        ...
        <h3>Basic tag display (typechecked.net, 61b8b6f)</h3>
