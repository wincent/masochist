...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Basic tag display (wincent.dev, 61b8b6f)</title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/prettify_wiki_urls_wincentcom.php"
            >&laquo; Prettify wiki URLs (wincent.dev, 7a865f9)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/group_tag_results_according_to.php"
            >Group tag results according to taggable type (wincent.dev, 7513d98)
            &raquo;</a
          >
        </p>
        ...
        <h3>Basic tag display (wincent.dev, 61b8b6f)</h3>
