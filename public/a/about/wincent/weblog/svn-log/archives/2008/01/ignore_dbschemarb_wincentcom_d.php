...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Ignore db/schema.rb (typechecked.net, d4c78a5)</title>
    ...
    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/remove_dbschemarb_file_wincent.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/update_fixturereplacement_exam.php"
            >&laquo; Update FixtureReplacement example data (typechecked.net,
            d6ad037)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/remove_dbschemarb_file_wincent.php"
            >Remove db/schema.rb file (typechecked.net, de09bc5) &raquo;</a
          >
        </p>

        <h2>January 30, 2008</h2>

        <h3>Ignore db/schema.rb (typechecked.net, d4c78a5)</h3>
