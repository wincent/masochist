...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Ignore db/schema.rb (wincent.dev, d4c78a5)</title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/remove_dbschemarb_file_wincent.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/update_fixturereplacement_exam.php"
            >&laquo; Update FixtureReplacement example data (wincent.dev,
            d6ad037)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/remove_dbschemarb_file_wincent.php"
            >Remove db/schema.rb file (wincent.dev, de09bc5) &raquo;</a
          >
        </p>

        <h2>January 30, 2008</h2>

        <h3>Ignore db/schema.rb (wincent.dev, d4c78a5)</h3>

        <p>
          This file is easily regenerated and just creates noise in the
          &quot;git status&quot; output seeing as it changes so often, so ignore
          it.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003938more"><div id="more"></div></div>
