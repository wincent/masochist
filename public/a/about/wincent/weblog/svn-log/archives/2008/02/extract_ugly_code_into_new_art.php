...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Extract ugly code into new Articles helper (typechecked.net,
      3773864)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/fix_syntax_error_in_new_articl.php"
      title="Fix syntax error in new article template (typechecked.net, 2d35085)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/extract_body_html_method_into.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/fix_syntax_error_in_new_articl.php"
            >&laquo; Fix syntax error in new article template (typechecked.net,
            2d35085)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/extract_body_html_method_into.php"
            >Extract body_html method into Articles helper (typechecked.net,
            46d62b2) &raquo;</a
          >
        </p>
        ...
        <h3>
          Extract ugly code into new Articles helper (typechecked.net, 3773864)
        </h3>
