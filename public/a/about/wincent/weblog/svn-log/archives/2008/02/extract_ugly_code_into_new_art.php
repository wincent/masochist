...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Extract ugly code into new Articles helper (wincent.dev,
      3773864)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_syntax_error_in_new_articl.php"
      title="Fix syntax error in new article template (wincent.dev, 2d35085)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/extract_body_html_method_into.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_syntax_error_in_new_articl.php"
            >&laquo; Fix syntax error in new article template (wincent.dev,
            2d35085)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/extract_body_html_method_into.php"
            >Extract body_html method into Articles helper (wincent.dev,
            46d62b2) &raquo;</a
          >
        </p>
        ...
        <h3>
          Extract ugly code into new Articles helper (wincent.dev, 3773864)
        </h3>

        <p>
          The &quot;link_to_remote&quot; and &quot;observe_field&quot; calls are
          ugly and involve a lot of repeated options that appear in both the
          &quot;new&quot; and &quot;edit&quot; templates, so extract them into
          the Articles helper.
        </p>

        <p>
          We also pre-populate the preview content in the edit template (but not
          in the &quot;new&quot; template because there we don't have any
          content when the template is first displayed; I may later modify this
          to handle the situation where there is content due to a failed
          validation and a re-rendering of the form).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004086more"><div id="more"></div></div>
