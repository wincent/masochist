...
<title>Git activity log: Always direct error and diagnostic output to the stderr (buildtools, 4654413)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/tag_buildtools_with_each_relea.php" title="Tag buildtools with each release (Synergy, 3079b00)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/use_common_tools_for_better_di.php" title="Use common tools for better diagnostic messages (buildtools, 4ac65e8)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/tag_buildtools_with_each_relea.php">&laquo; Tag buildtools with each release (Synergy, 3079b00)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/use_common_tools_for_better_di.php">Use common tools for better diagnostic messages (buildtools, 4ac65e8) &raquo;</a>

</p>

<h2>January 23, 2008</h2>

<h3>Always direct error and diagnostic output to the stderr (buildtools, 4654413)</h3>

<p>Without this it may be harder to diagnose script failures (for example, in the ReleaseNotes.sh script we normally redirect the output to a file; in that case any error messages wind up in the file rather than in the Xcode build window where we want to see them).</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003764more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at January 23, 2008  3:58 PM</p>
