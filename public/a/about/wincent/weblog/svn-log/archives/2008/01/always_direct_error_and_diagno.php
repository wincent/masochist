...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Always direct error and diagnostic output to the stderr
      (buildtools, 4654413)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/use_common_tools_for_better_di.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/tag_buildtools_with_each_relea.php"
            >&laquo; Tag buildtools with each release (Synergy, 3079b00)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/use_common_tools_for_better_di.php"
            >Use common tools for better diagnostic messages (buildtools,
            4ac65e8) &raquo;</a
          >
        </p>
        ...
        <h3>
          Always direct error and diagnostic output to the stderr (buildtools,
          4654413)
        </h3>

        <p>
          Without this it may be harder to diagnose script failures (for
          example, in the ReleaseNotes.sh script we normally redirect the output
          to a file; in that case any error messages wind up in the file rather
          than in the Xcode build window where we want to see them).
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003764more"><div id="more"></div></div>
