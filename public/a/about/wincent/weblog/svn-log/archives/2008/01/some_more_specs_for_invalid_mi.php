...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Some more specs for invalid missing external link
      targets (wikitext, dcce3be)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/more_specs_for_unexpected_link.php"
            >&laquo; More specs for unexpected link end tokens (wikitext,
            584f03a)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/split_specs_up_into_separate_f.php"
            >Split specs up into separate files (wikitext, 8ef9a25) &raquo;</a
          >
        </p>
        ...
        <h3>
          Some more specs for invalid missing external link targets (wikitext,
          dcce3be)
        </h3>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003827more"><div id="more"></div></div>
