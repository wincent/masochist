...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove localization code (typechecked.net, 285fd68)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/initial_cut_at_issues_controll.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/autogeneration_of_blog_post_pe.php"
            >Auto-generation of blog post permalinks (typechecked.net, f71a66b)
            &raquo;</a
          >
        </p>
        ...
        <h3>Remove localization code (typechecked.net, 285fd68)</h3>
