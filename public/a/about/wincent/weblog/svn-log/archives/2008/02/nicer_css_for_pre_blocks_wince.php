...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Nicer CSS for PRE blocks (typechecked.net, de69284)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/finish_off_wiki_articles_contr.php"
            >&laquo; Finish off (wiki) articles controller (typechecked.net,
            e27c63a)</a
          >
          |
        ...
        <h3>Nicer CSS for PRE blocks (typechecked.net, de69284)</h3>
