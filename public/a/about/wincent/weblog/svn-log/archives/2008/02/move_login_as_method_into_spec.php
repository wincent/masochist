...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Move login_as method into spec helper (typechecked.net,
      8e136a7)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/shorten_body_html_helper_wince.php"
            >&laquo; Shorten body_html helper (typechecked.net, e54a968)</a
          >
          |
          ...
          <a
            ...
            (typechecked.net, 1f9a20f) &raquo;</a
          >
        </p>

        <h2>February 13, 2008</h2>

        <h3>Move login_as method into spec helper (typechecked.net, 8e136a7)</h3>
