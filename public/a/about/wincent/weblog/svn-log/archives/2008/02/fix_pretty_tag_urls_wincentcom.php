...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Fix pretty tag URLs (typechecked.net, 339a076)</title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/first_cut_at_wiki_functionalit.php"
            >&laquo; First cut at wiki functionality (typechecked.net, b451c58)</a
          >
          |
          ...
          <a
            ...
            (typechecked.net, 57f734a) &raquo;</a
          >
        </p>

        <h2>February 8, 2008</h2>

        <h3>Fix pretty tag URLs (typechecked.net, 339a076)</h3>
