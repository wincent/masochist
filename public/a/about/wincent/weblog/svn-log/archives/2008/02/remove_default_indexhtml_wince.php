...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove default index.html (typechecked.net, 1c84a1c)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/add_basic_rails_test_app_wince.php"
      title="Add basic Rails test app (typechecked.net, 9434674)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/add_sample_database_configurat.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/add_basic_rails_test_app_wince.php"
            >&laquo; Add basic Rails test app (typechecked.net, 9434674)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/add_sample_database_configurat.php"
            >Add sample database configuration file (typechecked.net, aedc881)
            &raquo;</a
          >
        </p>
        ...
        <h3>Remove default index.html (typechecked.net, 1c84a1c)</h3>
