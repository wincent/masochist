...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Re-run all specs whenever schema changes (typechecked.net,
      9511ecd)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/fix_locale_specs_wincentcom_aa.php"
      title="Fix locale specs (typechecked.net, aa385f3)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/update_example_data_to_get_spe.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/fix_locale_specs_wincentcom_aa.php"
            >&laquo; Fix locale specs (typechecked.net, aa385f3)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/update_example_data_to_get_spe.php"
            >Update example data to get specs passing (typechecked.net, 0a11fad)
            &raquo;</a
          >
        </p>
        ...
        <h3>Re-run all specs whenever schema changes (typechecked.net, 9511ecd)</h3>
