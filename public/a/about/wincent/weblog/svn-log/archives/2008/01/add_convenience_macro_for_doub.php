...
<title>Git activity log: Add convenience macro for double-checked locking pattern (WOCommon, c5ba560)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/factor_out_color_macros_into_w.php" title="Factor out color macros into WOHUD.h (REnamer, cd6174e)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/tweak_css_to_make_help_documen.php" title="Tweak CSS to make help documentation match Leopard style (REnamer, ef59fa4)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/factor_out_color_macros_into_w.php">&laquo; Factor out color macros into WOHUD.h (REnamer, cd6174e)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/tweak_css_to_make_help_documen.php">Tweak CSS to make help documentation match Leopard style (REnamer, ef59fa4) &raquo;</a>

</p>

<h2>January 17, 2008</h2>

<h3>Add convenience macro for double-checked locking pattern (WOCommon, c5ba560)</h3>

<p>In the most common usage case of the double-checked locking pattern (lazy initialization of shared resources such as singletons) we almost always use the exact same repetitive code.</p>

<p>Make a macro for this use case, which uses double-checked locking with memory barriers for safety, synchronizes against &quot;self&quot; (which will work well in class methods for singletons, and well in instance methods for other types of lazy initialization), and returns the result.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003661more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at January 17, 2008  1:33 PM</p>
