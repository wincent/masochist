...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add convenience macro for double-checked locking pattern
      (WOCommon, c5ba560)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/factor_out_color_macros_into_w.php"
      title="Factor out color macros into WOHUD.h (REnamer, cd6174e)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/tweak_css_to_make_help_documen.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/factor_out_color_macros_into_w.php"
            >&laquo; Factor out color macros into WOHUD.h (REnamer, cd6174e)</a
          >
          |
        ...
        <h3>
          Add convenience macro for double-checked locking pattern (WOCommon,
          c5ba560)
        </h3>

        <p>
          In the most common usage case of the double-checked locking pattern
          (lazy initialization of shared resources such as singletons) we almost
          always use the exact same repetitive code.
        </p>

        <p>
          Make a macro for this use case, which uses double-checked locking with
          memory barriers for safety, synchronizes against &quot;self&quot;
          (which will work well in class methods for singletons, and well in
          instance methods for other types of lazy initialization), and returns
          the result.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003661more"><div id="more"></div></div>
