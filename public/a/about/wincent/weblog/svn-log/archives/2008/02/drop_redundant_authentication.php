...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Drop redundant authentication specs (wincent.dev,
      1545453)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/whitespace_fix_wincentcom_c991.php"
      title="Whitespace fix (wincent.dev, c9914a6)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_comment_specs_wincentcom_b.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/whitespace_fix_wincentcom_c991.php"
            >&laquo; Whitespace fix (wincent.dev, c9914a6)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_comment_specs_wincentcom_b.php"
            >Fix Comment specs (wincent.dev, b522ae6) &raquo;</a
          >
        </p>

        <h2>February 7, 2008</h2>

        <h3>Drop redundant authentication specs (wincent.dev, 1545453)</h3>

        <p>
          The authentication code is so intimately intertwined with the User
          model and all the rest that it doesn't make much sense to try and test
          it independently.
        </p>

        <p>
          Remove the specs which redundantly re-test stuff that is already
          tested elsewhere. This makes one less site to have to worry about
          updating when refactoring.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003952more"><div id="more"></div></div>
