...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Drop redundant authentication specs (typechecked.net,
      1545453)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/whitespace_fix_wincentcom_c991.php"
      title="Whitespace fix (typechecked.net, c9914a6)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/fix_comment_specs_wincentcom_b.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/whitespace_fix_wincentcom_c991.php"
            >&laquo; Whitespace fix (typechecked.net, c9914a6)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/fix_comment_specs_wincentcom_b.php"
            >Fix Comment specs (typechecked.net, b522ae6) &raquo;</a
          >
        </p>

        <h2>February 7, 2008</h2>

        <h3>Drop redundant authentication specs (typechecked.net, 1545453)</h3>
