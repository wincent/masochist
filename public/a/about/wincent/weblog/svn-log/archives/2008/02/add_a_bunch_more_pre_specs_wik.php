...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add a bunch more PRE specs (wikitext, 48a3f27)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_bad_emission_of_blockquote.php"
      title="Fix bad emission of BLOCKQUOTE inside NO_WIKI spans (wikitext, f8384a1)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_specs_for_treat_slash_as_s.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/fix_bad_emission_of_blockquote.php"
            >&laquo; Fix bad emission of BLOCKQUOTE inside NO_WIKI spans
            (wikitext, f8384a1)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/add_specs_for_treat_slash_as_s.php"
            >Add specs for treat_slash_as_special instance variable (wikitext,
            ca14d4c) &raquo;</a
          >
        </p>
        ...
        <p>
          I'm checking as many weird corner cases and exceptions here as I can
          think of.
        </p>

        <p>
          The basic behaviour is to allow a literal &lt;pre&gt; only at the very
          top level or inside a P block, as long as the latter is not inside a
          BLOCKQUOTE block (this is because I'll later be adding literal
          &lt;blockquote&gt;&lt;/blockquote&gt; support and I don't want to
          allow intermixing the two markup styles to avoid confusion). Any open
          span-level elements are automatically closed whenever such a
          &lt;pre&gt; block is entered, including rolling back any unfinished
          internal or external links.
        </p>

        <p>
          If an unexpected &lt;pre&gt; or &lt;/pre&gt; token appears anywhere
          else, echo it in escaped form to provide feedback to the user; I think
          this is better feedback than just autoclosing the previous
