...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Migrate functionality into application controller
      (REnamer, 4066730)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/create_worenamerwindowcontroll.php"
            >&laquo; Create WOREnamerWindowController class (REnamer,
            02706a4)</a
          >
          |
        ...
        <p>
          Many things which were previously handled by WOREnamerController are
          now handled by the dedicated application controller class.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003727more"><div id="more"></div></div>
