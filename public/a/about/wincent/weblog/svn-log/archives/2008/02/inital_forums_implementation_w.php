...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Inital forums implementation (wincent.dev, d93f88d)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/update_rakefile_to_include_new.php"
            >&laquo; Update Rakefile to include new Rails additions with gem
            (wikitext, fafe7ba)</a
          >
          |
        ...
        <h3>Inital forums implementation (wincent.dev, d93f88d)</h3>

        <p>
          This is an initial, incomplete implementation of the forums. At this
          stage we have a basic forum and topic model (forums have many topics,
          topics have many comments) and controller actions and views for
          creating new forums and topics.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004205more"><div id="more"></div></div>
