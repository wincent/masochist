...
<title>Git activity log: Inital forums implementation (wincent.com, d93f88d)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/update_rakefile_to_include_new.php" title="Update Rakefile to include new Rails additions with gem (wikitext, fafe7ba)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/extract_ary_free_out_into_sepa.php" title="Extract ary_free() out into separate file (wikitext, 840b62d)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/update_rakefile_to_include_new.php">&laquo; Update Rakefile to include new Rails additions with gem (wikitext, fafe7ba)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/extract_ary_free_out_into_sepa.php">Extract ary_free() out into separate file (wikitext, 840b62d) &raquo;</a>

</p>

<h2>February 22, 2008</h2>

<h3>Inital forums implementation (wincent.com, d93f88d)</h3>

<p>This is an initial, incomplete implementation of the forums. At this stage we have a basic forum and topic model (forums have many topics, topics have many comments) and controller actions and views for creating new forums and topics.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt;</p>

<div id="a004205more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at February 22, 2008 11:27 AM</p>
