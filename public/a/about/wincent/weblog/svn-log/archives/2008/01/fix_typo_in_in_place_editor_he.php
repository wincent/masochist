...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Fix typo in in place editor helper (typechecked.net,
      a29bd91)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/clean_up_in_in_place_editor_he.php"
            >&laquo; Clean up in in place editor helper macros (typechecked.net,
            3fa763d)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/add_update_attribute_to_active.php"
            >Add update_attribute! to Active Record (typechecked.net, cec57c5)
            &raquo;</a
          >
        </p>
        ...
        <h3>Fix typo in in place editor helper (typechecked.net, a29bd91)</h3>
