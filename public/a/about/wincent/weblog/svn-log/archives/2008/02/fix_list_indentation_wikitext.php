...
<title>Git activity log: Fix list indentation (wikitext, af34180)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/fix_pre_indentation_wikitext_7.php" title="Fix pre indentation (wikitext, 7428f7d)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/update_integration_tests_for_i.php" title="Update integration tests for indentation (wikitext, 15637bb)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/fix_pre_indentation_wikitext_7.php">&laquo; Fix pre indentation (wikitext, 7428f7d)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/update_integration_tests_for_i.php">Update integration tests for indentation (wikitext, 15637bb) &raquo;</a>

</p>

<h2>February  8, 2008</h2>

<h3>Fix list indentation (wikitext, af34180)</h3>

<p>Quick a tricky one, this one, because the LI token is the only one which varies its behaviour depending on the context.</p>

<p>For example, when it is just a standard list item containing some text we want it to behave like a P token (ie. when we dedent we don't want to emit any spaces). On the other hand, if the LI contains a nested list then it takes on block-like properties and we do want to emit spaces when dedenting (ie. like blockquote).</p>

<p>We implementing this by introducing another imaginary token, NESTED_LIST, which is present when a nested list is present and guides the dedentation process accordingly.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt;</p>

<div id="a004001more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at February  8, 2008  9:05 PM</p>
