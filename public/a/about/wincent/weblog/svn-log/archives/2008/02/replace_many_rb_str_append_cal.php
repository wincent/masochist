...
<title>Git activity log: Replace many rb_str_append calls with rb_str_cat (wikitext, e116b3f)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/make_sure_constants_get_initia.php" title="Make sure constants get initialized only once in spec helper (wikitext, 767f54b)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/replace_more_rb_str_append_cal.php" title="Replace more rb_str_append calls with rb_str_cat (wikitext, a5954dc)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/make_sure_constants_get_initia.php">&laquo; Make sure constants get initialized only once in spec helper (wikitext, 767f54b)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/02/replace_more_rb_str_append_cal.php">Replace more rb_str_append calls with rb_str_cat (wikitext, a5954dc) &raquo;</a>

</p>

<h2>February  5, 2008</h2>

<h3>Replace many rb_str_append calls with rb_str_cat (wikitext, e116b3f)</h3>

<p>I suspected that rb_str_cat would be faster than rb_str_append because it avoids an unnecessary object instantiation. This commit changes all constant strings to use rb_str_cat, shaving about 12% off of the parse time.</p>

<p>Before:</p>

<p>  short slab of ASCII text    2.870000   0.000000   2.870000 (  2.929794)   short slab of UTF-8 text    5.390000   0.010000   5.400000 (  5.399399)</p>
...
<div id="a003899more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at February  5, 2008 11:56 AM</p>
