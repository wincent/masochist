...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Replace many rb_str_append calls with rb_str_cat
      (wikitext, e116b3f)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/make_sure_constants_get_initia.php"
      title="Make sure constants get initialized only once in spec helper (wikitext, 767f54b)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/replace_more_rb_str_append_cal.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/make_sure_constants_get_initia.php"
            >&laquo; Make sure constants get initialized only once in spec
            helper (wikitext, 767f54b)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/replace_more_rb_str_append_cal.php"
            >Replace more rb_str_append calls with rb_str_cat (wikitext,
            a5954dc) &raquo;</a
          >
        </p>
        ...
        <h3>
          Replace many rb_str_append calls with rb_str_cat (wikitext, e116b3f)
        </h3>
        ...
        <p>
          short slab of ASCII text 2.870000 0.000000 2.870000 ( 2.929794) short
          slab of UTF-8 text 5.390000 0.010000 5.400000 ( 5.399399)
        </p>
