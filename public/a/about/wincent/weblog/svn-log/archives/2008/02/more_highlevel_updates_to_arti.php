...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/remove_references_to_revision.php"
      title="Remove references to Revision model in example data (typechecked.net, efa788e)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/start_populating_sitewide_nav.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/start_populating_sitewide_nav.php"
            >Start populating site-wide nav bar (typechecked.net, 477b843)
            &raquo;</a
          >
        </p>
        ...
        <h3>
          More high-level updates to Articles controller (typechecked.net, 5c6888e)
        </h3>
