...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: More high-level updates to Articles controller
      (wincent.dev, 5c6888e)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/remove_references_to_revision.php"
      title="Remove references to Revision model in example data (wincent.dev, efa788e)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/start_populating_sitewide_nav.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/remove_references_to_revision.php"
            >&laquo; Remove references to Revision model in example data
            (wincent.dev, efa788e)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/start_populating_sitewide_nav.php"
            >Start populating site-wide nav bar (wincent.dev, 477b843)
            &raquo;</a
          >
        </p>
        ...
        <h3>
          More high-level updates to Articles controller (wincent.dev, 5c6888e)
        </h3>

        <p>
          A new &quot;index&quot; template which shows the most recently updated
          articles, and the edit template which I actually meant to include in
          an earlier commit.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004080more"><div id="more"></div></div>
