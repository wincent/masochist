...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add in_place_editing_plugin (typechecked.net, 209d96c)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/move_session_reset_up_into_con.php"
            >&laquo; Move session reset up into controller (typechecked.net,
            ab81739)</a
          >
          |
          ...
          <a
            ...
            (typechecked.net, 2b5cbd0) &raquo;</a
          >
        </p>

        <h2>January 25, 2008</h2>

        <h3>Add in_place_editing_plugin (typechecked.net, 209d96c)</h3>
