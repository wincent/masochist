...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Add trimming function for link targets (wikitext,
      d4ff4f5)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/trim_trailing_whitespace_from.php"
      title="Trim trailing whitespace from internal link text (wikitext, fdf390a)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/more_internal_link_specs_wikit_1.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/trim_trailing_whitespace_from.php"
            >&laquo; Trim trailing whitespace from internal link text (wikitext,
            fdf390a)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/more_internal_link_specs_wikit_1.php"
            >More internal link specs (wikitext, c92f50a) &raquo;</a
          >
        </p>
        ...
        <p>
          Unfortunately I found a case where the early scan-time suppression of
          leading and trailing whitespace gets tripped up by faulty input; I had
          forgotten that newlines and end-of-files do not auto-close still-open
          link spans, and so in those cases you actually do a rollback and by
          then you've already eaten your whitespace.
        </p>

        <p>
          So this commit adds a trimming function which is called only when the
          link is fully parsed, confirmed valid, and ready to be emitted.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003933more"><div id="more"></div></div>
