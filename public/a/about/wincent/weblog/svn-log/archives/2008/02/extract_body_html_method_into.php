...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/extract_ugly_code_into_new_art.php"
      title="Extract ugly code into new Articles helper (typechecked.net, 3773864)"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/shorten_body_html_helper_wince.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/extract_ugly_code_into_new_art.php"
            >&laquo; Extract ugly code into new Articles helper (typechecked.net,
            3773864)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/shorten_body_html_helper_wince.php"
            >Shorten body_html helper (typechecked.net, e54a968) &raquo;</a
          >
        </p>
        ...
        <h3>
          Extract body_html method into Articles helper (typechecked.net, 46d62b2)
        </h3>
