...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Extract body_html method into Articles helper
      (wincent.dev, 46d62b2)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/extract_ugly_code_into_new_art.php"
      title="Extract ugly code into new Articles helper (wincent.dev, 3773864)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/shorten_body_html_helper_wince.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/extract_ugly_code_into_new_art.php"
            >&laquo; Extract ugly code into new Articles helper (wincent.dev,
            3773864)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/02/shorten_body_html_helper_wince.php"
            >Shorten body_html helper (wincent.dev, e54a968) &raquo;</a
          >
        </p>
        ...
        <h3>
          Extract body_html method into Articles helper (wincent.dev, 46d62b2)
        </h3>

        <p>
          This allows the &quot;new&quot;, &quot;edit&quot; and &quot;show&quot;
          templates to all use the same method for showing the body text.
        </p>

        <p>
          In the case of the &quot;new&quot; template being called for the first
          time there is no article and so we return an empty string; but when
          validation fails there could well be body content so we return it if
          available. This is used in the preview.
        </p>

        <p>
          Same for the &quot;edit&quot; template, where we use the text in the
          preview.
        </p>

        <p>
          Finally in the &quot;show&quot; template we use the method to display
          the body normally, not as a preview.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a004087more"><div id="more"></div></div>
