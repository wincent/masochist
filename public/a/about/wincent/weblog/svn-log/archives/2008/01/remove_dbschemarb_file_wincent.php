...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Remove db/schema.rb file (typechecked.net, de09bc5)
    </title>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/ignore_dbschemarb_wincentcom_d.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/ignore_dbschemarb_wincentcom_d.php"
            >&laquo; Ignore db/schema.rb (typechecked.net, d4c78a5)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/complete_link_model_specs_winc.php"
            >Complete Link model specs (typechecked.net, f80c10f) &raquo;</a
          >
        </p>

        <h2>January 30, 2008</h2>

        <h3>Remove db/schema.rb file (typechecked.net, de09bc5)</h3>
