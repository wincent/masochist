...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Eliminate smearing problems when dragging scroll knobs
      (REnamer, db0eecf)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/draw_rounded_controls_in_hud_s.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/draw_rounded_controls_in_hud_s.php"
            >&laquo; Draw rounded controls in HUD scroller class (REnamer,
            3e91d70)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/teach_wohudscroller_to_draw_ar.php"
            >Teach WOHUDScroller to draw arrows in the scroller buttons
            (REnamer, f3b70d5) &raquo;</a
          >
        </p>
        ...
        <p>
          I think I might have eliminated the smearing glitches described in
          3e91d70 but using round() instead of floor(). Seems that these
          geometry calculations are a very sensitive beast indeed.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003643more"><div id="more"></div></div>
