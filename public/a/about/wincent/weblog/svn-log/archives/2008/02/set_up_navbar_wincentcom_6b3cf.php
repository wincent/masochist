...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Git activity log: Set up navbar (typechecked.net, 6b3cfb4)</title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/add_pagination_to_weblog_wince.php"
            >&laquo; Add pagination to weblog (typechecked.net, b39a0af)</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/remove_commented_out_css_wince.php"
            >Remove commented out CSS (typechecked.net, 61f798b) &raquo;</a
          >
        </p>

        <h2>February 15, 2008</h2>

        <h3>Set up navbar (typechecked.net, 6b3cfb4)</h3>
