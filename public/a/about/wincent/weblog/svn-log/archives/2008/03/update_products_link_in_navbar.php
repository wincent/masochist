...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update products link in navbar (typechecked.net, 76cf73f)
    </title>
    ...
    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/03/add_extension_and_description.php"
      ...
      <div class="content">
        <p align="right">
          ...
          <a
            ...
            (typechecked.net, 4eb5a36) &raquo;</a
          >
        </p>

        <h2>March 5, 2008</h2>

        <h3>Update products link in navbar (typechecked.net, 76cf73f)</h3>
