...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Update products link in navbar (wincent.dev, 76cf73f)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/03/add_products_listing_to_index.php"
            >&laquo; Add products listing to index, links are permalinks
            (wincent.dev, 63db015)</a
          >
          |
          ...
          <a
            ...
            (wincent.dev, 4eb5a36) &raquo;</a
          >
        </p>

        <h2>March 5, 2008</h2>

        <h3>Update products link in navbar (wincent.dev, 76cf73f)</h3>
