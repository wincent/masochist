...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Snap window size to table view row height (REnamer,
      97148f1)
    </title>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/move_renamerspecific_behaviour.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/refactoring_drawing_of_row_bac.php"
            >&laquo; Refactoring drawing of row backgrounds (REnamer,
            e55ba3c)</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/move_renamerspecific_behaviour.php"
            >Move REnamer-specific behaviour down into subclass (REnamer,
            593e1a6) &raquo;</a
          >
        </p>
        ...
        <p>
          When resizing, force window size to always coincide with the height of
          the rows in the table.
        </p>

        <p>
          I've added the custom code for this into the WOHUDTableView class; if
          I ever want to extract that and make it a reusable class then this
          kind of custom code will need to be moved down into another subclass.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003621more"><div id="more"></div></div>
