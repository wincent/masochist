...
<title>Git activity log: Snap window size to table view row height (REnamer, 97148f1)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/refactoring_drawing_of_row_bac.php" title="Refactoring drawing of row backgrounds (REnamer, e55ba3c)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/move_renamerspecific_behaviour.php" title="Move REnamer-specific behaviour down into subclass (REnamer, 593e1a6)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/refactoring_drawing_of_row_bac.php">&laquo; Refactoring drawing of row backgrounds (REnamer, e55ba3c)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/move_renamerspecific_behaviour.php">Move REnamer-specific behaviour down into subclass (REnamer, 593e1a6) &raquo;</a>

</p>

<h2>January 12, 2008</h2>

<h3>Snap window size to table view row height (REnamer, 97148f1)</h3>

<p>When resizing, force window size to always coincide with the height of the rows in the table.</p>

<p>I've added the custom code for this into the WOHUDTableView class; if I ever want to extract that and make it a reusable class then this kind of custom code will need to be moved down into another subclass.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003621more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at January 12, 2008 11:36 PM</p>
