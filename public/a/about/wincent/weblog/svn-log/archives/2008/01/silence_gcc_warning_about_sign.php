...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Silence GCC warning about signed/unsigned comparison
      (REnamer, a5f6563)
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/teach_wohudtableheadercell_abo.php"
      title="Teach WOHUDTableHeaderCell about flipped coordinate systems (REnamer, f19e388)"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/teach_wohudscroller_about_flip.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/teach_wohudtableheadercell_abo.php"
            >&laquo; Teach WOHUDTableHeaderCell about flipped coordinate systems
            (REnamer, f19e388)</a
          >
          |
        ...
        <p>
          The cast here is safe because the int should always be non-negative
          (confirm that with an assertion) and never large enough to overflow
          size_t.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003638more"><div id="more"></div></div>
