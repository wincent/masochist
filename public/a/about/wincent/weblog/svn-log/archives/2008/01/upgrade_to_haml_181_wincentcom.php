...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Upgrade to Haml 1.8.1 (typechecked.net, 55f9609)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/01/initial_sass_stylesheet_wincen.php"
            >&laquo; Initial Sass stylesheet (typechecked.net, 0d58fa2)</a
          >
          |
        ...
        <h3>Upgrade to Haml 1.8.1 (typechecked.net, 55f9609)</h3>
