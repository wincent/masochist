...
<title>Git activity log: Teach user interface about substitution errors (REnamer, 65c992a)</title>
...
<link rel="prev" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/xcode_project_bundle_updates_r.php" title="Xcode project bundle updates (REnamer, cc55e06)" />


<link rel="next" href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/remove_redundant_object_contro.php" title="Remove redundant object controller in main nib (REnamer, 8346fc7)" />
...
<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/xcode_project_bundle_updates_r.php">&laquo; Xcode project bundle updates (REnamer, cc55e06)</a> |

<a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/">Main</a>

| <a href="http://www.wincent.com/a/about/wincent/weblog/svn-log/archives/2008/01/remove_redundant_object_contro.php">Remove redundant object controller in main nib (REnamer, 8346fc7) &raquo;</a>

</p>

<h2>January 18, 2008</h2>

<h3>Teach user interface about substitution errors (REnamer, 65c992a)</h3>

<p>Previously the user interface only knew about regular expression pattern compilation errors. Now it knows about invalid replacement strings as well.</p>

<p>We display an alert triangle in next to the replacement field in this case with a tool-tip showing the error, and also log it to the log drawer.</p>

<p>In doing this I cleaned up the logging in general so that we no longer re-log the same error if the user adds more characters to one of the fields and the error remains constant.</p>

<p>Signed-off-by: Wincent Colaiuta &lt;win@wincent.com&gt; </p>

<div id="a003698more"><div id="more">

</div></div>

<p class="posted">Posted by wincent at January 18, 2008  1:04 PM</p>
