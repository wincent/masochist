...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Teach user interface about substitution errors (REnamer,
      65c992a)
    </title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/svn-log/archives/2008/01/xcode_project_bundle_updates_r.php"
            >&laquo; Xcode project bundle updates (REnamer, cc55e06)</a
          >
          |
        ...
        <p>
          Previously the user interface only knew about regular expression
          pattern compilation errors. Now it knows about invalid replacement
          strings as well.
        </p>

        <p>
          We display an alert triangle in next to the replacement field in this
          case with a tool-tip showing the error, and also log it to the log
          drawer.
        </p>

        <p>
          In doing this I cleaned up the logging in general so that we no longer
          re-log the same error if the user adds more characters to one of the
          fields and the error remains constant.
        </p>

        <p>Signed-off-by: Greg Hurrell &lt;greg@hurrell.net&gt;</p>

        <div id="a003698more"><div id="more"></div></div>
