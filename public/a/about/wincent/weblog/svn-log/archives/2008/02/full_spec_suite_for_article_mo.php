...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Git activity log: Full spec suite for Article model (typechecked.net, 90d6ef3)
    </title>
    ...
    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/add_specs_for_articles_helper.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/svn-log/archives/2008/02/add_specs_for_articles_helper.php"
            >Add specs for Articles helper (typechecked.net, ab4b878) &raquo;</a
          >
        </p>

        <h2>February 13, 2008</h2>

        <h3>Full spec suite for Article model (typechecked.net, 90d6ef3)</h3>
