    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2005/05/next_album_prev.php"
            >Next Album, Previous Album &raquo;</a
          >
        </p>
        ...
        <p>
          Added WOSplashWindow class (useful not only for splash windows but
          about windows too) and moved common functionality up the class
          hierarchy into new WOWindow class.
        </p>

        <div id="a000073more"><div id="more"></div></div>
