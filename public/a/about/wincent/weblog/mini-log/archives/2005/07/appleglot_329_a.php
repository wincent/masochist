...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2005/07/sysctl3.php"
      title="sysctl(3)"
    />
  </head>
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          I see that Apple has updated their localization tools. AppleGlot can
          now be run from the command line; should make it easier to integrate
          into the Xcode build process.
        </p>

        <div id="a000105more"><div id="more"></div></div>
