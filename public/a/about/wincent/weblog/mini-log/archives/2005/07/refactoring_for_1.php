...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2005/07/favorite_enviro.php"
      title="Favorite environment variable"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2005/11/mac_os_x_1043.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2005/07/favorite_enviro.php"
            >&laquo; Favorite environment variable</a
          >
          |
        ...
        <p>
          Just replaced 54 lines of code with 6 and I'll be able to repeat that
          saving many times over in different places. Admittedly had to write a
          support class of over 200 lines to make this happen but when you work
          out the savings in the long term I will finish way in front.
        </p>

        <div id="a000128more"><div id="more"></div></div>
