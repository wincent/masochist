...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2005/05/sudo_stuff.php"
      title="sudo stuff"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2005/05/disaster_recove.php"
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          Synergy Advance can now optionally self-relaunch if a user makes
          changes which require it. I was quite pleased to see that after
          writing a stack of code to do this in one go it all worked on the very
          first try, no tweaking required.
        </p>

        <div id="a000081more"><div id="more"></div></div>
