...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2005/07/source_code_cou.php"
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          Did some nice refactoring for size, lopping off a couple hundred lines
          of source and hopefully reducing the memory footprint of the code.
        </p>

        <div id="a000122more"><div id="more"></div></div>
