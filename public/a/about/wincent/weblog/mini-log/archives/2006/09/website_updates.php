    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/09/potentially_of.php"
            >&laquo; Potentially of interest</a
          >
          |
        ...
        <p>
          Added more links to the navigation bar ("Other products..." and
          "Wincent Colaiuta's weblog") to make things easier to find, and
          updated some other pages (<a
            href="https://wincent.dev/a/support/activation/"
            >example</a
          >).
        </p>

        <div id="a000478more"><div id="more"></div></div>
