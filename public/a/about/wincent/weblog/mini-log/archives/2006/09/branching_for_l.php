...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://typechecked.net/a/about/wincent/weblog/mini-log/archives/2006/09/better_granular.php"
      title="Better granularity"
    />

    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/mini-log/archives/2006/09/more_repository.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://typechecked.net/a/about/wincent/weblog/mini-log/archives/2006/09/more_repository.php"
            >More repository migrations &raquo;</a
          >
        </p>
        ...
        <p>
          ...
          >,
          <a
            href="https://typechecked.net/wiki/Creating_branches_with_Subversion"
            >created a new branch</a
          >
          of <a href="http://typechecked.net/">Synergy</a> and
          Synergy Advance so that I can
          start implementing Leopard-only features on the trunk.
        </p>

        <div id="a000425more"><div id="more"></div></div>
