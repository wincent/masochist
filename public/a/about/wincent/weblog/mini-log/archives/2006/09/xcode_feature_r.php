...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/09/database_migrat.php"
      title="Database migrations"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/10/cool.php"
      title="Cool"
    />
  </head>
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          Would be nice to be able to turn off syntax-aware indenting within
          code documentation comments (Doxygen). As things currently stand,
          Xcode's auto-indenting gets in the way more often than not when
          writing documentation comments. (<a
            href="http://bugreporter.apple.com/"
            >Radar filed</a
          >).
        </p>

        <div id="a000525more"><div id="more"></div></div>
