  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          So far, 5. I could file more, of course, but I'm trying to limit
          myself to the really annoying ones that affect my work. Don't want to
          spend the whole day filing bug reports with Apple.
        </p>

        <div id="a000746more"><div id="more"></div></div>
