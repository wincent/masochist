...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/03/cocoa_categorie.php"
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          An <tt>NSNotificationCenter</tt> subclass that makes it easy to
          deliver notifications to specific threads (not just the main thread).
        </p>

        <div id="a000233more"><div id="more"></div></div>
