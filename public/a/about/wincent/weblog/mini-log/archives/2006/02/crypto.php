...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/02/bugzilla_2201.php"
      title="Bugzilla 2.20.1"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/02/tip_of_the_day.php"
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          Have done a lot of crypto work this week: code signing, code
          encryption, tools for quickly generating keys and salts. Good stuff.
          Wish I could say more but I like a nice layer of
          <a href="http://en.wikipedia.org/wiki/Security_through_obscurity"
            >security through obscurity</a
          >
          (STO) over my cryptographically strong foundation. STO sucks when it's
          your only source of security; when it's just one layer of many it's
          not actually such a bad thing.
        </p>

        <div id="a000214more"><div id="more"></div></div>
