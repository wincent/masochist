...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/05/mysql.php"
      title="MySQL"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/05/fedex.php"
      title="FedEx"
    />
  </head>
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          And there are 1,623 new spam messages waiting for me. Took about four
          hours to download them over my temporary dial-up connection. This is
          the one circumstance in which spammers actually hurt me. Either way, I
          don't read their messages.
        </p>

        <div id="a000331more"><div id="more"></div></div>
