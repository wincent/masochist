    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/05/a_week_without.php"
            >A week without Net access &raquo;</a
          >
        </p>
        ...
        <p>
          A long-overdue upgrade no the server from
          <a href="http://www.mysql.com/">MySQL</a> 4.1.13 (or was it 4.1.12?)
          to version 4.1.19.
        </p>

        <div id="a000326more"><div id="more"></div></div>
