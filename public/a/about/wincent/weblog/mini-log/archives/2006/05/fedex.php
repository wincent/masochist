...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/05/a_week_without.php"
      title="A week without Net access"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/05/857_am.php"
      title="8:57 AM"
    />
  </head>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/05/a_week_without.php"
            >&laquo; A week without Net access</a
          >
          |
        ...
        <p>
          ...
          <a
            ...
            >The memory</a
          >
          got into Paris this evening just before 8:30 PM. Should hopefully get
          here to Madrid tomorrow, or the day after if there's a delay in
          customs.
        </p>

        <div id="a000333more"><div id="more"></div></div>
