...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/03/i_have_a_dream.php"
      title="I have a dream"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/03/apple_xcode_bug.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/03/apple_xcode_bug.php"
            >Apple Xcode bug reports &raquo;</a
          >
        </p>
        ...
        <p>
          Another <a href="http://www.mediawiki.org/">MediaWiki</a> upgrade
          (1.5.7). Would be nice if the author provided more information about
          the changes other than just, "This version includes fixes for
          compatibility with Internet Explorer 7 beta 2, and various other bugs;
          see the full changelog at the end of the release notes" (the "full"
          changelog provides even less information than the summary sentence!).
        </p>

        <div id="a000225more"><div id="more"></div></div>
