...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/09/branching_for_l.php"
      title="Branching for Leopard"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/09/a_new_class_for.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/09/a_new_class_for.php"
            >A new class for Synergy Advance &raquo;</a
          >
        </p>
        ...
        <p>
          ...
          repositories onto other servers. This is in part because I want to
          install Leopard on a separate drive on the local machine and be able
          to check out the Leopard branches of various projects onto that
          machine; given that I don't really want to share filesystems between
          the pre-release OS and my production install (and in any case I'm even
          less interested in running Subversion on a pre-release system) this
          means that I've had to move a number off repositories off of the local
          host.
        </p>

        <div id="a000427more"><div id="more"></div></div>
