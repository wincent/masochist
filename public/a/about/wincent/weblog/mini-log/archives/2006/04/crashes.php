...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/04/woaequeueconsum.php"
      title="WOAEQueueConsumer"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/04/synergy_advance_2.php"
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          ...
          variables and the whole thing is just too brittle and fragile.
          Probably better off without the protection.
        </p>

        <div id="a000273more"><div id="more"></div></div>
