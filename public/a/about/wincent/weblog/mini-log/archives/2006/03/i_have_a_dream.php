  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          I've finally fulfilled that long-held dream of being able to edit a
          product build/version number in a single place and have the change
          propagate across <em>all</em> the places necessary in a large,
          multi-target, multi-project piece of software (Synergy Advance).
        </p>

        <div id="a000222more"><div id="more"></div></div>
