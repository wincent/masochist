...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/02/crypto.php"
      title="Crypto"
    />
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          When possible, prefer using multiple dependent targets within the same
          project over multiple dependent projects. There's less overhead and
          builds should be faster. All the targets logically included in
          specific product should belong to that product's main project file;
          this makes things like project-wide searching more useful.
        </p>

        <div id="a000220more"><div id="more"></div></div>
