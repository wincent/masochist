...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/03/mach_port_leaks.php"
      title="Mach Port leaks"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/03/mediawiki_158.php"
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          Removed the temporary (and kludgy) workaround in my
          <tt>WOQueueConsumer</tt> class where I was forced to use polling to
          check for newly enqueued items; now it just blocks in the background
          until it's time to respond, courtesy of the magic of
          <tt>NSMachPort</tt>.
        </p>

        <div id="a000256more"><div id="more"></div></div>
