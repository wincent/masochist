...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/03/another_kernel.php"
      title="Another kernel update"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/03/wothread_class.php"
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          Have done a lot of refactoring of my Apple Event code so that most of
          the methods are merely wrappers for lower-level primitives. This makes
          the code much easier to read because most of the methods (even the
          primitive ones) are only a few lines long, and it makes the code more
          maintainable because it narrows down Apple Event activity to only a
          couple of primitives instead of being littered all over the place.
        </p>

        <div id="a000250more"><div id="more"></div></div>
