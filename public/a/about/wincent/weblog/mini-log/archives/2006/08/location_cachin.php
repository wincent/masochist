...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/08/wotest_enhancem.php"
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          ...
          likely culprit. Doesn't always help, but often does. Also added a
          <tt>WO_TEST_START</tt> macro that you can use to immediately cache the
          location if you're writing highly experimental tests and there's a
          high likelihood of raising uncaught exceptions outside of your tests
          (tests already catch them for you) but inside your test methods.
        </p>

        <div id="a000375more"><div id="more"></div></div>
