...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/08/wostealthassert.php"
      title="&lt;tt&gt;WOStealthAssert&lt;/tt&gt;"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/09/adc_mailing.php"
      title="ADC mailing"
    />
  </head>
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          Safari periodically forgets, <em>en masse</em>, which RSS articles
          I've already looked at causing all of my feeds to simultaneously
          indicate new articles. I then have to display all the feeds to reset
          the unread counters back to zero. Very annoying, seeing as it entirely
          defeats the purpose of RSS (ie. bringing sites to your attention only
          when they update). This is evidently an Apple bug and not a case of
          the remote sites changing the timestamps on their feeds, seeing as
          this happens to all the feeds at once. I hope Apple fixes this soon.
        </p>

        <div id="a000398more"><div id="more"></div></div>
