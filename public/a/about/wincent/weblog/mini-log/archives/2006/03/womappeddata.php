...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/03/synergy_advance.php"
      title="Synergy Advance 0.4b"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/03/wincent_crash_r.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/03/wincent_crash_r.php"
            >Wincent Crash Reporter &raquo;</a
          >
        </p>
        ...
        <p>
          An <tt>NSData</tt> subclass (well, not a true subclass; a compound
          class actually) for mapping (potentially very large) files into
          page-aligned virtual memory buffers. It's true that there are methods
          for doing this using <tt>NSData</tt> itself, but they're only
          available on 10.4 and my stuff needs to run on 10.3 as well.
        </p>

        <div id="a000263more"><div id="more"></div></div>
