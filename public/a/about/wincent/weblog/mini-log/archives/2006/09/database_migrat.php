...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/09/website_updates.php"
      title="Website updates"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2006/09/xcode_feature_r.php"
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          I've just discovered that one of my database tables in a custom system
          really should have included a "created" column containing a datetime
          value (it already contains a "ts" column containing a "last updated"
          timestamp value). Wonder how painful it is going to be to
          transition... In hindsight, it was braindead of me not to include this
          column from the beginning, but I was young, innocent, reckless,
          foolhardy... Hope this won't be too painful.
        </p>

        <div id="a000479more"><div id="more"></div></div>
