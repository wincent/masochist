  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          <a
            title="Daring Fireball: The Amazon MP3 Store and Amazon MP3 Downloader"
            href="http://daringfireball.net/2007/09/amazon_mp3_downloader"
            >Can only be a good thing for consumers</a
          >.<br />
        </p>

        <div id="a002757more"><div id="more"></div></div>
