...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="next"
      href="https://typechecked.net/a/about/wincent/weblog/mini-log/archives/2007/03/neooffice_and_o.php"
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          <a href="https://typechecked.net/wiki/redMine">redMine</a> is a
          very impressive project management system built using
          <a href="https://typechecked.net/wiki/Rails">Rails</a>. Still in
          the very early stages but I already like the look of it better than
          <a href="https://typechecked.net/wiki/Trac">Trac</a>.
        </p>
