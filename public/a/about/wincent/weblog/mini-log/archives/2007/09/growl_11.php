    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2007/09/automata_librar.php"
            >&laquo; Automata Library for Haskell</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2007/09/neat_article_on.php"
            >Neat article on using RSpec to test C code &raquo;</a
          >
        </p>
        ...
        <p>
          Somewhat unconventionaly, Growl has jumped straight from
          <a
            title="Growl version history"
            href="http://growl.info/documentation/version_history.php"
            >version 0.7.6 to 1.1</a
          >. I'll be moving my apps over to the new version once Leopard is out
          seeing as that is the only platform I can do testing on right now.
        </p>

        <div id="a002684more"><div id="more"></div></div>
