    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2007/11/yet_more_bad_pr.php"
            >&laquo; Yet more bad press for WordPress</a
          >
          |
        ...
        <p>
          <a
            href="https://sourceforge.net/project/shownotes.php?release_id=556409"
            >Release notes</a
          >.
        </p>

        <div id="a003158more"><div id="more"></div></div>
