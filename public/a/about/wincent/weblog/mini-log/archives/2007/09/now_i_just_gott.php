...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2007/09/automata_librar.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2007/09/write_your_own.php"
            >&laquo; Write Your Own Regular Expression Parser</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2007/09/automata_librar.php"
            >Automata Library for Haskell &raquo;</a
          >
        </p>
        ...
        <p>
          <a
            title="Deterministic finite-state machine - Wikipedia, the free encyclopedia"
            href="http://en.wikipedia.org/wiki/Deterministic_finite_automaton"
            >Given two DFAs</a
          >
          there are efficient algorithms to find a DFA recognizing the union,
          intersection, and complements of the languages they recognize. There
          are also efficient algorithms to determine whether a DFA accepts any
          strings, whether a DFA accepts all strings, whether two DFAs recognize
          the same language, and to find the DFA with a minimum number of states
          for a particular regular language.
        </p>

        <div id="a002682more"><div id="more"></div></div>
