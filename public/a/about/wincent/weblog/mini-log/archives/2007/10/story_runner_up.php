...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2007/10/rails_caching.php"
      title="Rails caching"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2007/10/story_runner.php"
      title="Story runner"
    />
  </head>
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          David Chelimsky has put a lot of work into the new
          <a
            href="http://blog.davidchelimsky.net/articles/2007/10/21/story-runner-in-plain-english"
            >RSpec story runner</a
          >, incorporating suggestions from a wide range of people and arriving
          at a solution that seems pretty much acceptable to everyone.
        </p>
        <p>
          Looking forward to using it, although until the
          <a href="https://wincent.dev/wiki/API">API</a> is final I'm
          not going to touch it; too many other things on the go right now to
          spend time chasing a moving API.
        </p>

        <div id="a002826more"><div id="more"></div></div>
