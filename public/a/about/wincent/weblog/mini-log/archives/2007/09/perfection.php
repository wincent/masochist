    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2007/09/more_on_functio.php"
            >More on functional programming &raquo;</a
          >
        </p>
        ...
        <p>
          <em
            ...
            rien à ajouter, mais quand il n'y a plus rien á retrancher.</em
          >
        </p>
        <p>
        ...
        <p>
          <a href="http://en.wikiquote.org/wiki/Exupery"
            >Ch. III: L'Avion, p. 60</a
          >
        </p>

        <div id="a002675more"><div id="more"></div></div>
