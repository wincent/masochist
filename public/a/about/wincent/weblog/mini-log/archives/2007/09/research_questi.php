...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Mini-log: Research Questions in Finite-state Language Processing
    </title>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2007/09/no_jury_for_sco.php"
      title="No Jury for SCO in SCO vs Novell"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2007/09/write_your_own.php"
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2007/09/no_jury_for_sco.php"
            >&laquo; No Jury for SCO in SCO vs Novell</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/about/wincent/weblog/mini-log/archives/2007/09/write_your_own.php"
            >Write Your Own Regular Expression Parser &raquo;</a
          >
        </p>
        ...
        <p>
          <a
            ...
            href="http://www.let.rug.nl/~vannoord/alp/proposal/node12.html"
            >In order</a
          >
          to experiment with finite-state techniques, it is very important to
          have available an implementation of the Finite-state Calculus, i.e.,
          implementations of all the important finite-state operations such as
          union, concatenation, Kleene closure, difference, intersection,
          complementation, etc. An operation such as union takes two
          finite-state languages l1 and l2 (expressed as regular expressions or
          as finite-state automata) and produces the union of the sentences in
          these languages. Such regular operations are crucial building blocks
          of approximation algorithms and other finite-state language processing
          algorithms.
        </p>

        <div id="a002680more"><div id="more"></div></div>
