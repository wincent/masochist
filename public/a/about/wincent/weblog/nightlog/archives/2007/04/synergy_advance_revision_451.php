    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/about/wincent/weblog/nightlog/archives/2007/04/synergy_advance_revision_429.php"
            >&laquo; Synergy Advance (revision 429)</a
          >
          |
        ...
        <ul>
          ...
          <li>
            <em>SHA1 checksum</em>: 36721586f0a379c0d8d1db1e5da513011e104840
          </li>
          <li>
            <em>Direct link</em>:
            <a
              href="https://typechecked.net/a/products/synergy-advance/download/nightlies/SynergyAdvanceNightly(451).dmg"
              >https://typechecked.net/a/products/synergy-advance/download/nightlies/SynergyAdvanceNightly(451).dmg</a
            >
          </li>
        </ul>
        ...
        <div id="a001667more"><div id="more"></div></div>

        <p class="more-categories">
          More
          <a
            href="https://typechecked.net/a/about/wincent/weblog/nightlog/archives/synergy_advance/"
            >Synergy Advance</a
          >
          nightlies
        </p>
