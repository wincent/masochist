      ...
      <div class="content">
        ...
        <ul>
          ...
          <li>
            <em>Direct link</em>:
            <a
              href="https://typechecked.net/a/products/synergy-classic/download/nightlies/Synergy3.5a2+(c7eb0af).zip"
              >https://typechecked.net/a/products/synergy-classic/download/nightlies/Synergy3.5a2+(c7eb0af).zip</a
            >
          </li>
          <li>
            <em>Product info</em>:
