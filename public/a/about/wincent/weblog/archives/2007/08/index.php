  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        The replacement Superdrive for the iMac arrived today and I just
        finished installing it. There's only one word to describe the job:
        nasty. These iMacs really don't have any &quot;user serviceable&quot;
        parts inside. To get access to the innards you...
        <p>
          <a
        ...
        Today is not a good day as far as this computer is concerned. About an
        hour ago I left the computer running while I was in the shower. On
        returning I found the screen blank, the light off and no...
        <p>
          <a
        ...
        If you have SCO stock (I trust that no one reading this weblog does) the
        time to sell is now. Well, you may as well just burn all the paperwork
        and forget about it. After weeks wondering how the judge...
        <p>
          <a
        ...
        Since I switched to this first-gen Intel iMac as my main desktop machine
        back in May 2006 I've had a pretty bad run with hardware reliability.
        Earlier this year I noticed that the integrated iSight camera was no
        longer working;...
        <p>
          <a
