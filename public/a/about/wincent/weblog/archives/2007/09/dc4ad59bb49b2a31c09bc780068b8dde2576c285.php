    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/09/involuntary_reb_15.php"
            >&laquo; Involuntary Reboot Log #16</a
          >
          |
        ...
        <p>
          ...
          <a
            ...
            >again arguing</a
          >
          that <a href="https://wincent.dev/wiki/Rails">Rails</a> is,
          after all, scalable:
        </p>
        <blockquote>
          Jason Hoffman from Joyent had a great tutorial at RailsConf Europe on
          Scaling a Rails Application from the Bottom Up. It defines the key
          terms and measurements of scaling and explains why scaling in essence
          have nothing to do with Rails. It's a great story to have in hand when
          the inevitable fudzy &quot;But does it scale?&quot; nonsense is thrown
          at you.
        </blockquote>
        <p>
          The thing is, it seems that David is working with a very particular
          definition of &quot;scaling&quot; that seeks to sidestep the key
          issues at the heart of Rail's scaling problems (and there
          <em>are</em> problems). &quot;Scaling in essence has nothing to do
          with Rails&quot;. Really? <em>Nothing</em> at all? Nothing at all
          <em>in essence</em>? There are more than a couple words in there that
          are setting off the sophistry alarm bells...
        </p>
        <p>
          My personal opinion is that Rails is a pretty nice framework but that
          it is undeniably slow, resource hungry, and only &quot;scales&quot;
          when you throw bucket-loads of money at it. And of <em>course</em> it
          &quot;scales&quot; if you do that... But that doesn't make the
          performance problem vanish into thin air; it's still there and it's
          not &quot;fudzy nonsense&quot; but a legitimate concern. Compare with
          the alternatives and note that they all pretty much scale better than
          Rails (application performance, that is; not even touching the subject
          of programmer productivity which is another thing entirely).
        </p>
        <p>
          ...
          <a href="https://wincent.dev/wiki/Ruby">Ruby</a> itself.
        </p>
