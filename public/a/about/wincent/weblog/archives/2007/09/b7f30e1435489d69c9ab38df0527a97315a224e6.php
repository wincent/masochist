...
<title>Wincent Colaiuta's weblog: Spotlight definitely broken on my machine</title>
...
<link rel="prev" href="https://wincent.com/a/about/wincent/weblog/archives/2007/09/the_apple_store.php" title="The Apple Store" />
...
<a href="https://wincent.com/a/about/wincent/weblog/archives/2007/09/the_apple_store.php">&laquo; The Apple Store</a> |
...
<h3>Spotlight definitely broken on my machine</h3>

<p>Lately <a href='https://wincent.com/knowledge-base/Mail.app'>Mail.app</a> has only been returning a subset of the expected results when I search for a particular mail. For example, if a customer that purchased a <a href='http://synergy.wincent.com/'>Synergy</a> license in the last week asks for their registration information to be resent then I can find it, usually within seconds; but if someone who purchased back in 2003 asks me then Mail.app never turns up any results. Using <a href='https://wincent.com/knowledge-base/Spotlight'>Spotlight</a> from outside of Mail.app also fails to return any results even though the emails are <em>known</em> to exist, so I can only conclude that Spotlight is broken. A manual search (sorting by column, manually scrolling, and visually scanning) is not a viable option; I have 6 GB of mail dating as far back as 1996.</p>
<p>In other words, given that Mail.app depends on Spotlight for its searching, a broken Spotlight leads to a broken mail application as well. In these cases I have to engage in a time-consuming search which involves logging into PayPal to find a record of a transaction which took place almost five years ago, and I can then confirm using <tt>grep -R</tt> from the <a href='https://wincent.com/knowledge-base/command%20line'>command line</a> that the registration notice is indeed still present in my <tt>~/Library/Mail/</tt> folder.</p>
<p>So Spotlight is great when it works, principally because its so fast. But if forced to choose between slow and broken, I'll chose slow every time. I just blew away the Spotlight index for my startup volume (<tt>sudo mdutil -E /</tt>) and it will now be rebuilt automatically (will take many hours — the Spotlight menu bar is telling me that there are 23 hours remaining — and the ultra-flakey <tt>mdimportserver</tt> process has <em>already</em> crashed, only two minutes into the scan). I'm hoping that that will fix it.</p>
...
<p class="posted">Posted by wincent at September 30, 2007  3:44 PM</p>
