...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Wincent Colaiuta's weblog: Spotlight definitely broken on my machine
    </title>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          ...
          scrolling, and visually scanning) is not a viable option; I have 6 GB
          of mail dating as far back as 1996.
        </p>
        <p>
          In other words, given that Mail.app depends on Spotlight for its
          searching, a broken Spotlight leads to a broken mail application as
          well. In these cases I have to engage in a time-consuming search which
          ...
          <tt>~/Library/Mail/</tt> folder.
        </p>
        <p>
          So Spotlight is great when it works, principally because its so fast.
          But if forced to choose between slow and broken, I'll chose slow every
          time. I just blew away the Spotlight index for my startup volume (<tt
            >sudo mdutil -E /</tt
          >) and it will now be rebuilt automatically (will take many hours —
          the Spotlight menu bar is telling me that there are 23 hours remaining
          — and the ultra-flakey <tt>mdimportserver</tt> process has
          <em>already</em> crashed, only two minutes into the scan). I'm hoping
