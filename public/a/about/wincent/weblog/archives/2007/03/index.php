...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/archives/2007/04/"
      title="April 2007"
    />
  </head>
      ...
      <div class="content">
        <p align="right">
          <a href="https://wincent.dev/a/about/wincent/weblog/archives/2007/02/"
            >&laquo; February 2007</a
          >
          |

          <a href="https://wincent.dev/a/about/wincent/weblog/">Index</a>
          |
          <a href="https://wincent.dev/a/about/wincent/weblog/archives/2007/04/"
            >April 2007 &raquo;</a
          >
        </p>
        ...
        Most imperative programming consists of lists of instructions, where
        subsequent instructions tend to depend on the results of previous
        instructions: 01 get A 02 pass A to B, producing C 03 get D 04 add C and
        D to get...
        <p>
          <a
        ...
        Spammers. The scourge of the Internet. We have so much to thank them
        for: The waves of junk mail pouring into our inboxes. The painful
        challenge-response systems that stop us from sending legitimate email.
        The DNS blacklists that make sending...
        <p>
          <a
        ...
        As of today the build numbering system used in Synergy Advance has
        undergone a once-off change and I wanted to explain here to help clear
        up any confusion that it may cause. The changes are described in full in
        the...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/03/synergy_advance_2.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/03/synergy_oneday.php"
            >Read full article</a
          >
        </p>
        ...
        You could argue that this one is my fault but I like to blame it on the
        Mac OS X dependence on NetInfo for user information. I was trying to
        find out why another machine on my local network was...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/03/involuntary_reb_8.php"
            >Read full article</a
          >
        </p>
        ...
        I've commented elsewhere that I plan on approximating a continuous
        integration model of development in future releases of Synergy Advance
        (and all my products in fact). In my comment I wrote: After several
        months of positively &quot;seismic&quot; changes to the...
        <p>
          <a
        ...
        I like to keep an eye on Gervase Markham's weblog. Today he published an
        article about converting MediaWiki markup to HTML. It turns out that
        that is something I've wanted to do for some time now. Well, not so
        much...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/03/using_mediawiki.php"
            >Read full article</a
          >
        </p>
        ...
        I've made some minor changes to the Google-powered site search today,
        namely, adding a Wincent logo and header to the search results: I've
        also added some Google AdSense advertising to the Knowledge Base wiki. I
        don't plan to ever put...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/03/improved_google.php"
            >Read full article</a
          >
        </p>
        ...
        Update, 16 March 2007: Charles Steinman has kindly donated to cover the
        registrations for all three domains (dot-org, dot-com and dot-net). I'm
        leaving the original text of the post below for the historical record.
        Ooooh, I hope the title of...
        <p>
          <a
        ...
        The most bizarre drawing glitch I've ever seen, provoked by trying to
        resize the frontmost Safari window; another, unaffected Safari window is
        visible in the background: Not sure if it's a bug in Safari, Mac OS X,
        or both....
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/03/bizarre_display.php"
            >Read full article</a
          >
        </p>
