...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/archives/2007/05/"
      title="May 2007"
    />
  </head>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          |
          <a href="https://wincent.dev/a/about/wincent/weblog/archives/2007/05/"
            >May 2007 &raquo;</a
          >
        </p>
        ...
        Twice in one day... Involuntary reboot stats to date Operating system
        version: undisclosed Kernel panics: 6 Hard resets: 4 Total failures: 10
        Start of recording keeping: 21 May 2006 Total days to date: 342 days
        Average time between failures: 34...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/04/involuntary_reb_10.php"
            >Read full article</a
          >
        </p>
        ...
        Currently running a huge merge between the Tiger and Leopard branches of
        one of my projects (WOCommon). SVK really makes this kind of thing a
        breeze... I was about to say, &quot;I don't know how I ever lived
        without it&quot;,...
        <p>
          <a
        ...
        After a day spent trying to get the minimum number of development tools
        installed onto a clean install of a certain version of a certain OS, I
        finally decided to throw in the towel and give up. Unusable. The
        thing...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/04/involuntary_reb_9.php"
            >Read full article</a
          >
        </p>
        ...
        Yesterday and today I've been working on improving the automated testing
        process used when building products like Synergy Advance and
        Hextrapolate....
        <p>
          <a
        ...
        I previously wrote about how pleased I was with my new workflow for
        creating end-user help documentation. In that article I said: The sky
        really is the limit on this one. One of the things that has always
        frustrated me...
        <p>
          <a
        ...
        So it's official, not just a rumor. we had to borrow some key software
        engineering and QA resources from our Mac OS X team, and as a result we
        will not be able to release Leopard at our Worldwide Developers...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/04/leopard_in_octo.php"
            >Read full article</a
          >
        </p>
        ...
        Will be following these with interest: Write a Ruby parser in ANTLR 3.0
        (Ruby) dcov - Ruby documentation coverage analyzer (Ruby) And with
        somewhat less interest (but still interested!): VLC Mac OS X Framework
        Implementation (VLC) An augmented diff representation...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/04/google_summer_o.php"
            >Read full article</a
          >
        </p>
        ...
        Along with my other development work, since the start of the year I've
        been working on an object-oriented templating system called Walrus. Its
        functionality is similar to that of the Cheetah templating engine but
        it's written in Ruby instead of...
        <p>
          <a
        ...
        Since posting my first screencast yesterday I've received a couple of
        emails asking about the software used to make it. iShowU is used for
        capture. I already held a license for the standard version of Snapz Pro
        X, and normally...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/04/screencasting_s.php"
            >Read full article</a
          >
        </p>
        ...
        I'm planning to start posting screencasts to show off features in my
        products. But this is totally new for me so, by way of practice, here's
        a really quick-and-dirty TextMate tip. In short: tapping the Option key
        converts any existing...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/04/noncontiguous_s.php"
            >Read full article</a
          >
        </p>
        ...
        And I want one. Four times as many cores as my current iMac, and each
        core nearly twice as fast; it wouldn't surprise me if the thing was
        eight times faster in all. Would be nice to get those...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/04/its_official.php"
            >Read full article</a
          >
        </p>
        ...
        Still plenty to be fixed as noted in the announcement... but I think I
        have to do something about my build times: START: Wed Apr 04 06:10:41
        +0200 2007 PROJECT: synergy_jaguar So Synergy gets skipped because there
        have been no...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/04/the_first_syner.php"
            >Read full article</a
          >
        </p>
        ...
        After a cracker broke into the WordPress server last month and replaced
        the official download with a trojan (an incident described by the
        WordPress public-relations team as a &quot;systems issue&quot;) I
        decided to give WordPress the flick, forever (see &quot;Removing...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/04/wordpress_213_b.php"
            >Read full article</a
          >
        </p>
