  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        I've been using RSpec a fair bit this year and have been trying to make
        some contributions back to the community because it is such a wonderful
        project. The thing is, despite its relative youth, RSpec is already a
        very...
        <p>
          <a
        ...
        I've been a little surprised to see so little coverage of RailsConf.
        There's be no hint of activity on the official Rails weblog, and if I
        hadn't been reminded about it by a mention on railscasts.com I would
        have entirely...
        <p>
          <a
        ...
        Today I felt like showing off my stunning ignorance of Ruby on Rails by
        doing a screencast on Behaviour-Driven Development. Well, not really.
        Showing the world how slow and clumsy I am in Rails wasn't my prime
        objective (even though...
        <p>
          <a
            href="https://wincent.com/a/about/wincent/weblog/archives/2007/05/behaviourdriven.php"
            >Read full article</a
          >
        </p>
        ...
        RSpec 1.0.0 is out. This is a big deal because it means there is now a
        firm commitment to keeping the API stable, after a lot of changes in the
        lead-up to 1.0.0. I just wish there was an Objective-C...
        <p>
          <a
        ...
        I was just randomly browsing the HexFiend source when the following
        snippet caught my eye: - (BOOL)shouldEnd { return !!([myThreadStatus
        flag] & SHOULD_END); } Why the double negation (!!)? It's actually very
        clever. I don't know if this is a...
        <p>
          <a
        ...
        Moving on from yesterday's post, the ability to set half-star ratings is
        now available from the Synergy Advance Global Menu too:...
        <p>
          <a
        ...
        Following up on yesterday's post, I've just finished adding the ability
        to set half-star ratings from the new Dock menu in Synergy Advance by
        holding down the Option key. The same is to follow for the Global Menu.
        In the...
        <p>
          <a
        ...
        The next Synergy Advance update will be coming out soon. Rather than
        releasing 0.5 I'm going to jump straight ahead to 0.5.1b because I want
        to include some minor new features. Dock options As explained here,
        there are a number...
        <p>
          <a
        ...
        Rackspace again ranks as most reliable hosting company this month. The
        three leaders each had a perfect month, with no downtime and no failed
        requests for their corporate sites during an entire month of monitoring
        from eight locations around the...
        <p>
          <a
            href="https://wincent.com/a/about/wincent/weblog/archives/2007/05/rackspace_wins.php"
            >Read full article</a
          >
        </p>
        ...
        So Apple has now officially announced that: At the Apple Worldwide
        Developers Conference, we're planning to show you a feature-complete
        version of Mac OS X Leopard, and you can take home a beta copy. I'm
        wondering how long paying ADC...
        <p>
          <a
            href="https://wincent.com/a/about/wincent/weblog/archives/2007/05/when_will_nonww.php"
            >Read full article</a
          >
        </p>
        ...
        When it comes to CAPTCHAs, I really do think there is such a thing as
        being "too good". This test is supposed to tell humans apart from
        machines, but I think it tells humans apart from videntes....
        <p>
          <a
        ...
        In &quot;Disable assertions and logging in your Release build&quot;
        Chris Hanson makes the case for, um, Disabling assertions and logging in
        your release builds. He later follows this up with &quot;Distinguish
        between checks and assertions&quot;. For my first couple of...
        <p>
          <a
