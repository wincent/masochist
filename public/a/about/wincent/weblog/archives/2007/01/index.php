...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/archives/2006/12/"
      title="December 2006"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/archives/2007/02/"
      title="February 2007"
    />
  </head>
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a href="https://wincent.dev/a/about/wincent/weblog/archives/2006/12/"
            >&laquo; December 2006</a
          >
          |

          <a href="https://wincent.dev/a/about/wincent/weblog/">Index</a>
          |
          <a href="https://wincent.dev/a/about/wincent/weblog/archives/2007/02/"
            >February 2007 &raquo;</a
          >
        </p>
        ...
        Ruby is my favorite scripting language. Let me clarify: I like Ruby; it
        generates warm fuzzy feelings in my thorax when I think about it. This
        is quite different from my response to other scripting languages: Perl
        tends to provoke...
        <p>
          <a
        ...
        The ownership and permissions on my InputManagers folders (both inside
        my home folder and at system level): -r-------- 1 root wheel - 0 Jan 27
        2006 InputManagers For these restrictions to be effective you should
        probably revoke group write access...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/01/input_managers.php"
            >Read full article</a
          >
        </p>
        ...
        <p class="more-categories">
          More
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/apple/moab/"
            >MOAB</a
          >
          articles
        </p>
        ...
        Activity on the Subversion log has been quiet lately because I've been
        working on documentation. In many ways the most mind-numbingly,
        excruciatingly boring and unrewarding work imaginable. But the truth is
        I am actually quite enjoying it because as part...
        <p>
          <a
        ...
        This whole MOAB thing has piqued my interest in open source, again. When
        I see Landon Fuller and William Carrel, two very bright and capable
        developers, jumping through hoops to reverse-engineer Transmit and
        provide a workaround for an issue in...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/01/open_source.php"
            >Read full article</a
          >
        </p>
        ...
        It's time to renew again and anyone who reads this blog knows how
        disappointed I am with GoDaddy's renewal prices (1, 2, 3, 4, 5). Unable
        to find a quick link to GoDaddy's current renewal prices on their home
        page,...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/01/wincent_vs_goda.php"
            >Read full article</a
          >
        </p>
        ...
        <p class="more-categories">
          More
          <a href="https://wincent.dev/a/about/wincent/weblog/archives/dns/"
            >DNS</a
          >
          articles , More
        ...
        So today's MOAB entry is a bug in Colloquy, the open source IRC client.
        As was the case with the earlier VLC bug, it was fixed promptly as soon
        as it was reported. But this is open source. Why did...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/01/the_colloquy_mo.php"
            >Read full article</a
          >
        </p>
        ...
        This time they actually did the right thing: [W]ait for Apple to release
        a fix (this issue has been reported to them circa a month ago). But
        there has also been some scandal over the previous issue installing a
        "root...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/01/responsible_dis.php"
            >Read full article</a
          >
        </p>
        ...
        Gruber was wrong on just about all counts, but I've got to admit that
        prior to the keynote I thought that most of his predictions were pretty
        spot on (note: I haven't actually watched the keynote yet, only read
        some...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/01/keynote_reactio.php"
            >Read full article</a
          >
        </p>
        ...
        I wrote yesterday: [R]eally, "fixing" this stuff with APE is like using
        a radio-controlled robot to stick a band-aid on the arm of a running
        child Well, looks like the MOAB fixes group will have to look for
        another solution...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/01/moab_childishne.php"
            >Read full article</a
          >
        </p>
        ...
        I continue to disapprove of the disclosure practices of the people
        running the Month of Apple Bugs (to be clear, I disapprove of how the
        vulnerabilities are being disclosed, not the fact that disclosure is
        taking place). Reading the transcript...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/01/month_of_apple_1.php"
            >Read full article</a
          >
        </p>
        ...
        I've previously written about my love affair with Object-Oriented
        Templating in general terms and as manifested in the beautiful Cheetah
        templating system. But there are a few minor problems with Cheetah: It
        doesn't have a #super directive. It doesn't look...
        <p>
          <a
        ...
        I was curious to find out why the internal IP address of my Mac OS X
        machine on my LAN was being leaked into the headers of all my outgoing
        email messages. Basically, all messages included a header that began...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/01/information_lea.php"
            >Read full article</a
          >
        </p>
        ...
        It was just brought to my attention that RapidSSL is running a promotion
        where you can extend your current SSL certificate for free by one year
        when you switch over from Comodo. Great. My existing Comodo-supplied
        certificate, the one that...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/01/ssl_fun.php"
            >Read full article</a
          >
        </p>
        ...
        So the Month of Apple Bugs has kicked off and I'm happy about it because
        I think it will have some positive effects; as the organizers state:
        This initiative aims to serve as an effort to improve Mac OS X,...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/01/month_of_apple.php"
            >Read full article</a
          >
        </p>
        ...
        Well, I fixed the off-by-one glitch mentioned here. The fix was very
        simple. First, I took some screenshots and was inspecting them at high
        zoom trying to work out the exact nature of the fault. Once I had some
        initial...
        <p>
          <a
        ...
        As I mentioned in the Mini-log, Bugzilla 3.0 has some really nice
        improvements in store. Favorite changes: Textareas zoom larger when you
        click in them (optional). You can change the resolution of a bug without
        re-opening it (long overdue). You...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2007/01/as_i_mentioned.php"
            >Read full article</a
          >
        </p>
