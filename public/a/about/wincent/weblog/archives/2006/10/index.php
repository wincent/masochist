...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/archives/2006/11/"
      title="November 2006"
    />
  </head>
      ...
      <div class="content">
        <p align="right">
          <a href="https://wincent.dev/a/about/wincent/weblog/archives/2006/09/"
            >&laquo; September 2006</a
          >
          |

          <a href="https://wincent.dev/a/about/wincent/weblog/">Index</a>
          |
          <a href="https://wincent.dev/a/about/wincent/weblog/archives/2006/11/"
            >November 2006 &raquo;</a
          >
        </p>
        ...
        I've always had "Continue building after errors" turned off in Xcode for
        the same reason that I have warnings turned on in the first place:
        namely, I don't want to miss seeing any problems (or potential problems)
        in my code....
        <p>
          <a
        ...
        This time it was my fault, kind of. Trying to do some low-level Mach
        stuff to work around a bug in Mac OS X, I ran into a different bug in
        Mac OS X, and this one was enough to...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/10/involuntary_reb_6.php"
            >Read full article</a
          >
        </p>
        ...
        I just opened a ticket asking Rackspace to make some changes to their
        DNS for me (rather than running my own DNS servers I let Rackspace do
        it). Typical of Rackspace, my ticket was immediately acknowledged and 7
        minutes after...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/10/rackspace_custo.php"
            >Read full article</a
          >
        </p>
        ...
        Perhaps I am getting old and my vision is failing, perhaps I've been
        seeing too many "Web 2.0" sites lately, but for whatever reason I've
        lately been looking at pages on this website and thinking that the font
        is too...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/10/old_age.php"
            >Read full article</a
          >
        </p>
        ...
        I offer two payment options for customers: Kagi and PayPal. I think it's
        important to offer multiple alternatives because people generally have
        strong preferences when it comes to making online payments. In this
        article I want to talk about my...
        <p>
          <a
        ...
        So Bansshee is out. I wrote it back in April this year and since then it
        has been performing without skipping a beat. It's been running non-stop
        since I first deployed it. I only reboot the server for kernel
        updates...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/10/bansshee_perfor.php"
            >Read full article</a
          >
        </p>
        ...
        Much like last time but with an updated version of the OS, again a panic
        on boot. Tried unplugging the USB cable connecting the UPS and was able
        to boot. Disk Utility reported one error on the volume containing the...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/10/involuntary_reb_5.php"
            >Read full article</a
          >
        </p>
        ...
        I'm in the process of falling in love with object-oriented templating,
        and specifically with the Cheetah Python-powered templating engine. I've
        always been a big fan of code re-use. This site, for example, has a
        number of re-usable elements that appear...
        <p>
          <a
        ...
        Does this look like the website of a bank that actually cares about
        providing its customers with service? "Contact us. We're all ears", they
        say. Just one of the reasons why I am looking forward to Leopard....
        <p>
          <a
        ...
        Thanks to Key-Value Coding and a nice method on NSArray you can do nice
        things like this......
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/10/whats_cool_abou.php"
            >Read full article</a
          >
        </p>
