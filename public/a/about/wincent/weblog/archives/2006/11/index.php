  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        The promised test results. Totally unscientific and no substitute for
        proper testing and profiling in a real-world application, but they do
        give some orientative information. These results are for a completely
        unoptimized implementation; I won't be optimizing until (and if)...
        <p>
          <a
        ...
        One of the things which tricked me when I first started with HOM (an
        entire 6 days ago) was that I would see examples like this: [[collection
        select] hasPrefix:@"foo"]; And assumed that I could write things like:
        [[[collection select] stringValue]...
        <p>
          <a
        ...
        The Google Mac Weblog continues to be an occasional source of some very
        interesting gems. This time it's about module initializers, something
        which I didn't know existed. A handy replacement for the load method in
        categories with a better-defined execution...
        <p>
          <a
        ...
        Q: Why write yet another HOM implementation when there are already so
        many out there? A: Because it's not the sort of code I would want to use
        without understanding exactly how it worked; and the best way of
        fully...
        <p>
          <a
            href="https://wincent.com/a/about/wincent/weblog/archives/2006/11/a_moments_refle.php"
            >Read full article</a
          >
        </p>
        ...
        The "select" HOM is one of the most frequently used patterns in any
        demonstration of HOM yet ironically it is also the most difficult to
        implement due to a quirk in the way the compiler and runtime work. Given
        code...
        <p>
          <a
        ...
        A couple of days ago I wrote about my first venture into HOM (Higher
        Order Messaging) in the form of a ifResponds selector. I included some
        results that showed that the HOM implementation was about 100 times
        slower than the...
        <p>
          <a
        ...
        I'm very happy with some improvements that I checked in to WOTest last
        night and which improve the readability and usefulness of test
        results....
        <p>
          <a
        ...
        Back in August I wrote the following about HOM (Higher Order Messaging):
        It reads like natural language but behind the scenes there's an
        invisible trampoline object that does the work. The first message
        returns this invisible object with which you...
        <p>
          <a
        ...
        Over the last month I've spent a few hours making minor improvements to
        the navigability of the site. Visitors should now find it a little bit
        easier to move around the site. These are minor polish details, the kind
        of...
        <p>
          <a
            href="https://wincent.com/a/about/wincent/weblog/archives/2006/11/site_improvemen.php"
            >Read full article</a
          >
        </p>
        ...
        I'm very happy to have discovered that you can set up Xcode file
        templates that include more than two files. I've just used this to make
        two new templates, "Objective-C class with tests" and "Objective-C
        category with tests", which create...
        <p>
          <a
        ...
        There are some things that I wish someone had told me when I got started
        programming Cocoa four years ago. There's a lot to learn, of course, so
        even if they had told me (and let's be honest, they probably...
        <p>
          <a
        ...
        For the past two years I've participated in the San Silvestre popular
        running race through Madrid on New Years Eve. This will be my third year
        in the 10Km race. As has been the case in previous years, this year's...
        <p>
          <a
            href="https://wincent.com/a/about/wincent/weblog/archives/2006/11/san_silvestre_w.php"
            >Read full article</a
          >
        </p>
        ...
        The trick I previously described for working around GoDaddy's galling
        bait-and-switch scam on private registrations no longer works. I tried
        to remove privacy on an expiring domain and then renew it, adding
        private registration, and GoDaddy's interface allows me to...
        <p>
          <a
            href="https://wincent.com/a/about/wincent/weblog/archives/2006/11/fighting_godadd.php"
            >Read full article</a
          >
        </p>
        ...
        I am pleasantly suprised to report that it only took me 2 days to get
        WOTest ported to Objective-C 2.0, and in reality not really 2 whole days
        because I've had a lot of other tasks and chores to do...
        <p>
          <a
