  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          Not sure if this is a secret or not, but I just discovered a hitherto
          unknown to me dialog in Mail.app that can be called up by pressing
          Option-Command-I. Curiously, that key combination is shown in the
          menus as belonging to "Add selected messages...", but when you press
          it you get an account information window.
        </p>
        <p>
          <a
