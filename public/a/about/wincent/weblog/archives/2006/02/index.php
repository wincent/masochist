...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/archives/2006/01/"
      title="January 2006"
    />
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a href="https://wincent.dev/a/about/wincent/weblog/archives/2006/01/"
            >&laquo; January 2006</a
          >
          |
        ...
        <p>
          Just filed a couple of feature requests/bug reports with Apple (see?
          It: The ability for Target Templates to contain files (like Project
          Templates can); this would make it a heck of a lot easier to do things
          like adding preference panes to existing projects.
        </p>
        <p>
          <a
        ...
        <p>
          I was just looking at some very old code that I wrote several years
          ago when I didn't really understand the mysteries of Objective-C (or
          even straight C for that matter!).
        </p>
        <p>
          <a
        ...
        <p>
          ...
          <a
            ...
            >I was lamenting</a
          >
          that sometimes I spend far too much time doing non-coding tasks in
          Xcode when I'd rather be churning out reams of beautifully syntax
          highlighted, immaculately indented and
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/02/to_wrap_or_not.php"
            >wrapped</a
          >
          Objective-C code. Today's non-coding efforts (requiring a couple of
          hours) were directed against the infamous " Input/Output Files
          Dependency Bug". I say "infamous" because it's a theme which keeps
          cropping up on the Xcode Users mailing list.
        </p>
        <p>
          <a
        ...
        <p>
          For a long, long, long, long time now I've hard-wrapped all of my
          source code to 80 columns. Why might you do this?
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/02/to_wrap_or_not.php"
        ...
        <p>
          Why use version control if you a lone-developer working on a
          closed-source project? You don't have to collaborate with anyone,
          download the source or send patches, after all. The answer is simple:
          you use version control for the same reason that you do unit testing.
        </p>
        <p>
          <a
        ...
        <p>
          Lately I've spent far too much time clicking, scrolling, dragging,
          copying and pasting in Xcode and not enough time writing code.
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/02/clicketyclick.php"
        ...
        <p>
          Ya.com seems to me to be one of the most unethical and incompetent
          Internet service providers in Spain and perhaps the world. Add the
          unpleasantness and difficulty of dealing with them to the mix and you
          have a recipe for a foul-tasting dish of broadband. My advice: steer
          as far clear of Ya.com as you can.
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/02/yacom_incompete.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          # these two scripts allow me to distribute this tool as
          original+patch# and i can distribute the tool itself (binary) with my
          buildtools distro (the buildtools distro must include the executable,
          the man page, and a license notice)# the omni license is not say
          anything about redistribution of modified source code...... i can
          distribute it along with the GPL software along with instructions on
        ...
        <p>
          There's an interesting discussion about offering free upgrades "for
          life".
        </p>
        <p>
          <a
        ...
        <p>
          Last night between the hours of 4 and 5 AM I was battling against two
          annoying Xcode bugs (in fact, the late hour immediately upgrades them
          to "incredibly annoying"). I spent about an hour wondering why any
          macros that I inserted into my Info.plist file where getting eaten
          when I turned on Info.plist processing.
        </p>
        <p>
          <a
        ...
        <p>
          Why is it that a spindle of 25 Verbatim DVD-Rs costs 38,95€ at my
          favorite local store (FNAC)? Yet I can buy the same(*) spindle at the
          corner shop for 14,95€?
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/02/dvdr_prices.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          Some time ago I wrote about adding mock objects to WOTest. Over the
          last couple of days I set about trying to improve them and make them
