...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/archives/2006/06/"
      title="June 2006"
    />
  </head>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          |
          <a href="https://wincent.dev/a/about/wincent/weblog/archives/2006/06/"
            >June 2006 &raquo;</a
          >
        </p>
        ...
        <p>
          A summary of my favorite changes in the new version of Apple's Xcode
          Tools (2.3).
        </p>
        <p>
          <a
        ...
        <p>
          Since switching to the new iMac I've been using the Apple Mighty
          Mouse. Things I like about it: looks great; lightweight; the scroll
          ball is brilliant.
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/05/mighty_mouse_de.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/05/involuntary_reb_1.php"
            >With the last batch of trouble</a
          >
          with my G5 I decided it was time to switch development over to my
          shiny new iMac. Although it is technically less powerful (only a
          32-bit Intel Core Duo 1.83 GHz compared with a 64-bit dual 2.5 GHz G5)
          I suspect that performance will be almost as good for most things.
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/05/memory_for_the.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          It's amazing how hard it is to get temporary Internet access in Spain.
          Or permanent access for that matter. Earlier this month I decided to
          switch ISPs. On 9 May I sent a letter to my old provider notifying
          them of my desire to discontinue the service and on the same day I
          applied with a new provider.
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/05/telefonica_suck.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          Witness as Adium starts to beachball before coming to the front.Notice
          that NetMonitor continues to update in the Dock, but that the network
          traffic has stalled, indicating that the hidden Azureus application
          has effictively stopped working.Notice that the CPU graph provided by
          the Activity Monitor in the graph, which up until now has shown that
          both 2.5GHz 64-bit CPUs have been idling away at about 1 or 2%
          utilization throughout this entire fiasco (although the machine's fans
          continued to roar at their usual hair-dryer volume the whole time),
          has stopped updating.Notice that the only window which doesn't show a
          beachball when you mouse over it is the one belong to Mail.app....
          Decide that just to be safe you'll follow your standard policy of
          booting from optical media and running Disk First Aid, seeing as
          neither Apple's journaling file system nor their software RAID
          implementation have proven to be adequate protection in the
          past.Insert Tiger install disc.
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/05/involuntary_reb_1.php"
        ...
        <p>
          This is some feedback I just sent to
          <a href="http://www.godaddy.com/">GoDaddy</a>, on the day on which the
          registration for
          <a href="http://piratewatch.org/">piratewatch.org</a> expires. I was
          going to renew it, but I decided that caving into GoDaddy's pricing
          model would only serve to reinforce what I view as their inacceptable
          practice.
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/05/godaddys_renewa.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          Today Xcode's Info.plist preprocessing feature started producing
          invalid XML, thus preventing any of my builds from completing.
        </p>
        <p>
          <a
        ...
        <p>
          Finally figured out why the Dashboard weather widget was displaying
          wildly inaccurate information. It was set to Madrid, New York (does
          that even exist?!)
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/05/scorchio.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          Yesterday I started getting crash notifications for the
          <tt>mds</tt> (Spotlight) daemon that runs with root privileges on Mac
          OS X. These would occur every few minutes. Either some new file that
          I'd downloaded in the past 24 hours was causing Spotlight to choke, or
          some aspect of my Spotlight database was corrupt.
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/05/mds_crashes.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/04/yacom_has_the_w.php"
            >My saga</a
          >
          with my ISP <a href="http://ya.com/">ya.com</a> is drawing to a close.
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/05/goodbye_yacom_a.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          Sadly I think I am alone in the world in not understanding Cocoa
          Bindings. Panther, and Cocoa Bindings, came out in October of 2003,
          well over two years ago. And <em>still</em> I find myself pulling my
          hair out whenever I try to do anything but the simplest binding of
          user interface elements in the preferences to the
          <tt>NSUserDefaults</tt> system.
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/05/cocoa_bindings.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          Yesterday I updated my MediaWiki install to the just-released 1.6.4.
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/05/mediawiki_updat.php"
            >Read full article</a
          >
        </p>
