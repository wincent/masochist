...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/archives/2005/12/"
      title="December 2005"
    />
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a href="https://wincent.dev/a/about/wincent/weblog/archives/2005/12/"
            >&laquo; December 2005</a
          >
          |
        ...
        <p>
          I got a Christmas card and some calendar cards from my webhost,
          Rackspace.
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/01/rackspace_facto.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          Managing build settings in Xcode has always been a bit fiddley. You
          can have per-project build settings (called "Configurations"), and
          per-target settings (simply called "Build settings") which inherit
          from the per-project settings and be used to override them.
        </p>
        <p>
          <a
        ...
        <p>
          My favorite programming text of all time is the O'Reilly C Pocket
          Reference by Peter Prinz and Ulla Kirch-Prinz. If only more books
          could be written like this. Small, compact, clear, comprehensive, it
          tells me everything I've ever needed to know about C.
        </p>
        <p>
          <a
        ...
        <p>
          Earlier today I was lamenting in the "mini-log" that lives on the
          left-hand side of my weblog:Synergy Advance is a huge project with
          lots of dependencies.... It means that if I change a single line of
          code I end up having to recompile the entire project and that takes
          many, many minutes.
        </p>
        <p>
          <a
        ...
        <p>
          When is an NSNumber better than a BOOL?I have a couple of macros that
          I define in my code:#define WO_YES [NSNumber
          numberWithBool:YES]#define WO_NO [NSNumber numberWithBool:NO]This
          enables me to use NSNumbers just as easily as I would use simple
          booleans:variable1 = YES; // easyvariable2 = WO_YES; // just as
          easyWhen is a BOOL better than an NSNumber?When you care about the
          overhead introduced by using a fully-fledged object instead of a
          simple BOOL.
        </p>
        <p>
          <a
        ...
        <p>
          I've already written about this before but a new article has been
          published and I wanted to comment on it. Bill Gates said spam would be
          "solved" by now (well, tomorrow to be precise). Microsoft thinks he
          was right.
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/01/spam_will_be_so.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          When the old server died I switched to Rackspace. At the same time I
          switched to Red Hat Enterprise Linux not because I disliked FreeBSD
          (in fact, I still love it) but because Red Hat was the "most
          supported" option offered by Rackspace, as far as I could tell.
        </p>
        <p>
          <a
        ...
        <p>
          Since Apple announced iLife 06 it seems that every man and his dog has
          set about to pirate it.
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/01/ethical_dimensi.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          Some good news at last: according to Bill Gates all spam will be
          eliminated from the world in just under two weeks from now.
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/01/spam_to_be_elim.php"
            >Read full article</a
          >
        </p>
        ...
        <p class="more-categories">
          More
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/microsoft/"
            >Microsoft</a
          >
          articles
        </p>
        ...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/01/so_microsoft_qu.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/01/apple_is_amazin.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          <a href="http://docs.info.apple.com/article.html?artnum=302810."
            >Mac OS X 10.4.4</a
          >
          is out.
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/01/mac_os_x_1044.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          Although I spend a lot of time running and using iTunes I had never
          purchased anything on the iTunes Music Store, until yesterday.
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/01/the_itunes_musi_1.php"
            >Read full article</a
          >
        </p>
