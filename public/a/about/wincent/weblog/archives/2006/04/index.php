...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/archives/2006/03/"
      title="March 2006"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/archives/2006/05/"
      title="May 2006"
    />
  </head>
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a href="https://wincent.dev/a/about/wincent/weblog/archives/2006/03/"
            >&laquo; March 2006</a
          >
          |
          ...
          |
          <a href="https://wincent.dev/a/about/wincent/weblog/archives/2006/05/"
            >May 2006 &raquo;</a
          >
        </p>
        ...
        <h3 id="a000307">
          Using cross-development SDKs for configure/make-based UNIX tools and
          libraries
        </h3>

        <p>
          It's been a long time since I did a
          <a href="https://wincent.dev/a/products/winhex/">WinHex</a> release.
          One of the reasons has been that I've had trouble compiling the
          <a href="http://swox.com/gmp/"
            >GMP arbitrary precision arithmetic library</a
          >
          upon which WinSwitch depends. Since the last release, GMP has been
          updated a couple of times, the version of
          <a href="http://gcc.gnu.org/">GCC</a> that Apple ships with Mac OS X
          Xcode tools has seen updates too, and the first Intel-based machines
        ...
        <p>
          I recently wrote that I spent some time working on a countermeasure
          for SSH-dictionary attacks.
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/04/bansshee_update.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/04/update_to_the_d.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          So my battle with Ya.com continues. Another month, another incorrect
          bill in which they have charged me double, another letter of
          complaint.
        </p>
        <p>
          <a
        ...
        <p>
          Well I was very happy with the new support for a particular threading
          idiom that I'd developed for Synergy Advance and it seemed to work
          very nicely.But not all was well.I was finding that if I left Synergy
          Advance running overnight I would come back and find that it had
          crashed in the undocumented and tauntingly named NSPortDelegateTickler
          method deep down in the bowels of some Apple framework.
        </p>
        <p>
          <a
        ...
        <p>
          ...
          <a href="https://wincent.dev/a/products/">Wincent product</a> to
          incorporate a self-checksumming feature. Call it "anti-corruption" if
          you will, or call it "anti-piracy"; the basic premise is that the
          executable uses a checksum to guard against corruption, modifications
          or tampering.
        </p>
        <p>
          <a
        ...
        <p>
          Free open source software is very popular. You may be wondering if
          giving away open source software for free (but accepting donations) is
          a workable business model for small vendors like Wincent.
        </p>
        <p>
          <a
        ...
        <p>
          When I first started Synergy Advance one of my first goals was to
          implement that ability for the user to show and hide the Dock icon at
          will. This was fairly simple, so I just stuck the code for it in the
          application's main controller class. But since then things have gotten
          more complicated.
        </p>
        <p>
          <a
        ...
        <p>
          Following up on my recent post on DVD-R prices, today I had to buy
          another spindle and this time I gave in and bought Samsung instead of
          Verbatim, my poster-child of data integrity and non-coasterness.
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2006/04/poverty.php"
            >Read full article</a
          >
        </p>
        ...
        <h3 id="a000272">
          Radar #4499076: <tt>atos</tt> vs <tt>@executable_path</tt>
        </h3>

        <p>
          Unfortunately it's something I need to do in order to decipher crash
          reports.When running "atos" on my binaries with the "-o" switch the
          utility fails to work and I get error messages like the following; in
          this example we are talking about an executable that links against an
          embedded copy of the Growl framework:2006-04-01 17:16:12.767
          atos[13476] NSMachOHeader -initWithPath::: - no file at
          "@executable_path/../Frameworks/Growl.framework/Versions/A/Growl"In
          order to make this error go away I must use "install_name_tool" to get
          rid of the "@executable_path" reference and change it to an absolute
          path.... The workaround works but its not very convenient and it
          requires me to have a copy of any linked frameworks installed at an
          absolute location.The "atos" man page states:"When working with a
          Mach-O executable [passed via the '-o' switch], atos considers
          addresses and symbols defined in that executable, at their default
          locations, as well as those from both statically and dynamically
          linked libraries loaded at startup by that executable, at their
          default locations.
        </p>
        <p>
          <a
