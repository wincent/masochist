...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="prev"
      href="https://wincent.dev/a/about/wincent/weblog/archives/2005/06/"
      title="June 2005"
    />

    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/archives/2005/08/"
      title="August 2005"
    />
  </head>
  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a href="https://wincent.dev/a/about/wincent/weblog/archives/2005/06/"
            >&laquo; June 2005</a
          >
          |
          ...
          |
          <a href="https://wincent.dev/a/about/wincent/weblog/archives/2005/08/"
            >August 2005 &raquo;</a
          >
        </p>
        ...
        <p>
          Every now and again I come up against an infuriating Cocoa bug. Today
          I've just spent a few hours struggling against one in particular.
        </p>
        <p>
          <a
        ...
        <p>
          Donald Knuth famously said "premature optimization is the root of all
          evil".
        </p>
        <p>
          <a
        ...
        <p>
          I just got hold of a Gefen DVI DL Switcher KVM today and wanted to
          post a recommendation. Gefen definitely don't make the cheapest KVMs
          out there but they could well make the best ones.
        </p>
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2005/07/gefen_dvi_dl_sw.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          I just noticed that I'm extending nearly 30 Cocoa classes using
          categories in the WOBase framework alone.
        </p>
        <p>
          <a
        ...
        <p>
          As you learn Objective-C you'll come across lots of advice about how,
          when, why to write accessor methods and you'll see many different ways
          of writing them.
        </p>
        <p>
          <a
        ...
        <p>
          Since my post the other day about my monstrously large main controller
          class I've been working hard on adding new features to Synergy
          Advance. But working on a large body of code is like moulding pottery
          from clay: even as you go along adding new bits you continue to work
          with the already-existing clay, moulding it, reforming it, smoothing
          it and so on.
        </p>
        <p>
          <a
        ...
        <p>
          I just had one of those nice moments where you write some code and you
          know straight away that you've done the right thing. These moments
          usually follow a period of doubt, then something slips into place and
          you realize that you've found the correct solution. In this case I was
          writing an Objective-C wrapper for some sysctl(3) stuff.
        </p>
        <p>
          <a
        ...
        <p>
          I have decided to release lines 4452 to 4455 (inclusive) of the file,
          "WOSynergyAdvanceController.m", part of the source code for Synergy
          Advance, into the public domain.... But I post it here for three
          reasons: (1) It's Sunday and I'm a little bored; (2) Because I love
          short methods (they're much easier to maintain); and (3) Because it's
          one hell of a long source file.
        </p>
        <p>
          <a
        ...
        <p>
          From the very beginning I've wanted Synergy Advance to be as modular
          as possible to maximize code reuse and make it easily extensible. The
          first thing I started by doing was splitting off code into reusable
          frameworks.
        </p>
        <p>
          <a
        ...
        <p>
          There is a lot of misinformation on the net about the different types
          of open source licenses so I just wanted to offer some clarification.
        </p>
        <p>
          <a
