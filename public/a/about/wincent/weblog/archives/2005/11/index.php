  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          I've now been using
          <a href="http://c-command.com/spamsieve/">SpamSieve</a> for just over
          one year and I'm fairly happy with the performance of it.
        </p>
        <p>
          <a
            href="https://wincent.com/a/about/wincent/weblog/archives/2005/11/spamsieve_one_y.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          I've been so pleased with the combination of ClamAV plus clamassassin
          plus procmail that I've decided to "upgrade" the recipes on the server
          so as to delete incoming virus-bearing messages on the server.
        </p>
        <p>
          <a
            href="https://wincent.com/a/about/wincent/weblog/archives/2005/11/clamav_clamassa.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          Not sure when this happened, but somewhere along the road to Mac OS X
          10.4.3 Spotlight got a whole lot better.
        </p>
        <p>
          <a
            href="https://wincent.com/a/about/wincent/weblog/archives/2005/11/spotlight_impro.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          Here's another great entry for the famous "Involuntary Reboot Log".
        </p>
        <p>
          <a
            href="https://wincent.com/a/about/wincent/weblog/archives/2005/11/best_crash_ever.php"
            >Read full article</a
          >
        </p>
        ...
        <p>
          Xcode has toolbar buttons for "Clean", "Clean All", "Build", "Build
          and Run" and so forth. Many, many times each day I find myself
          pressing "Clean" and then "Build" immediately afterwards. It would be
          a nice convenience and time saver if there was a "Clean and Build"
          button that combined the two operations, or failing that, if holding
          the Option key down while pressing the "Build" or "Build and Run" (or
          even the "Build and Debug") buttons could modify their behaviour to
          execute a clean before proceeding with the build.
        </p>
        <p>
          <a
        ...
        <p>
          The top two items for me are:(1) Improvements in the handling of
          Universal Binaries. There are some new build settings which make it
          easier to produce binaries that will run natively on PowerPC machine
          (from version Mac OS X 10.2 and up)(2) Speed improvements when editing
          large files.
        </p>
        <p>
          <a
        ...
        <p>
          A few months ago I had some server troubles and switched to Rackspace
          managed hosting.
        </p>
        <p>
          <a
