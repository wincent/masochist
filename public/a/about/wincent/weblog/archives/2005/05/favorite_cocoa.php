    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2005/05/whats_in_a_name.php"
            >&laquo; What's in a name? FileMaker Pro Advanced</a
          >
          |
        ...
        <p>
          I often run across Cocoa bugs. Found another one today. I'm running
          10.4.1 but I'll bet this happens in Panther too. To reproduce:
        </p>

        <ol>
          <li>
            In a Cocoa application project use Interface Builder to pick a
            submenu and make sure that its "Auto Enables Items" checkbox is set
            (it is by default). This might work for other NSMenus (not submenus)
            as well, but I haven't tested it.
          </li>
          <li>
            At runtime add some items to the submenu programmatically using
            <em>insertItemWithTitle:action:keyEquivalent:atIndex:</em>.
          </li>
          <li>
            Watch in awe as Cocoa fails to call <em>validateMenuItem:</em> for
            any of the added items (but does call it for the items that were
            added to the menu in Interface Builder).
          </li>
          <li>
            Chuckle heartily as you note that added items are ghosted even if
            you send them a <em>setEnabled:</em> message.
          </li>
          <li>
            Forget about using the NSMenuValidation protocol in this kind of
            situation.
          </li>
          <li>
            File <a href="http://bugreporter.apple.com/">bug report</a> with
            Apple.
          </li>
        </ol>

        <p>
          As far as Cocoa bugs go this one is fairly benign. Only cost me about
          10 minutes of troubleshooting time, plus a few more minutes to write
          this up.
        </p>

        <div id="a000075more"><div id="more"></div></div>
