    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2005/05/1041_kernel_pan.php"
            >&laquo; 10.4.1 kernel panics, RAID and data integrity</a
          >
          |
        ...
        <p>
          An incredibly annoying Cocoa bug, this one. In the same nib file in
          which I discovered
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2005/05/favorite_cocoa.php"
            >this bug</a
          >
          I have now run into an issue that is infinitely more annoying because
          I am not aware of any feasible work around.
        </p>

        <p>
          In Interface Builder I've added a new menu item to the Synergy Advance
          Global Menu and lo and behold, Cocoa refuses to apply the
          NSMenuValidation protocol to the new item (although it does on all the
          others). This is evidently related to the other bug but is much more
          serious (the first bug affects programmatically added items; this one
          affects those added using Interface Builder). The end user sees this
          as an item which is always ghosted and is therefore unusable, no
          matter what.
        </p>

        <p>
          What are the workarounds? Perform massive refactoring work to replace
          Apple's broken NSMenuValidation protocol with something that actually
          works? No thanks. Throw out the nib and start from scratch, hoping
          that Cocoa/Interface Builder will deign to allow me to innocently go
          about my business and with no guarantees that it won't render my nib
          unusable again in the future? I don't think so: this is a massive,
          complicated nib with a huge number of outlets and Cocoa bindings.
          Recreating it would take hours and be an error-prone process (one of
          the reasons why I am less than impressed with Cocoa bindings; the
          infamous "glue code" is replaced with a mountain of awkward,
          cumbersome pointing and clicking in IB and brittle, flakey and poorly
          documented under-the-hood trappings in the nib).
        </p>

        <div id="a000088more"><div id="more"></div></div>
