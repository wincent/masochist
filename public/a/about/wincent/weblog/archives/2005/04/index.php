  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          I found a link to Bill Gate's WinHec Keynote in this Slashot article
          and was struck by three things: What a terrible public speaker Bill
          Gates is; not only his monotone voice and total lack of humour, but
          his continual use of the word "customers" to refer to "users".... If
          you watch the keynote and skip forward about one hour and three
          minutes you'll see a sickeningly buzz-word-filled demonstration of
          transparent windows with movies playing in a window behind them, and
          watch in awe as windows shrink in slow motion when you minimize them
          (curiously like Mac OS X's "genie" effect).
        </p>
        <p>
          <a
            href="https://wincent.com/a/about/wincent/weblog/archives/2005/04/bill_gates_and.php"
            >Read full article</a
          >
        </p>
