...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="next"
      href="https://wincent.dev/a/about/wincent/weblog/archives/2008/02/"
      title="February 2008"
    />
  </head>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          ...
          |
          <a href="https://wincent.dev/a/about/wincent/weblog/archives/2008/02/"
            >February 2008 &raquo;</a
          >
        </p>
        ...
        I wrote the other day that I was going to be moving to RHEL 5 in the
        near future. What I wasn't sure at the time was exactly how I'd be
        making the move. At the time it seemed that...
        <p>
          <a
        ...
        Like I said the other day, looks like this iMac is dying. This time the
        machine simply turned itself off when I bumped the desk with my knee; it
        could barely even be called a bump. The average time between...
        <p>
          <a
        ...
        I'm a Rails dabbler who has never actually deployed an application yet
        but has been working in spare moments on a new version of this site that
        will be powered by Rails. I was puzzled today to see excess SELECT...
        <p>
          <a
        ...
        I'm starting to get really worried about this machine. Today we have the
        painters here painting all the rooms, which means that I've had to take
        the iMac out into the kitchen. As I've mentioned before, it has a
        wonky...
        <p>
          <a
        ...
        Git 1.5.4-rc4 is out, and the final 1.5.4 release is likely to come
        soon, probably before the end of the month. My favorite change in this
        build is the fix for the performance regression when commiting a single
        file specified...
        <p>
          <a
        ...
        In October last year I wrote about changing UNIXes. Well, it's a new
        year now and it looks like it is going to happen. I'll be migrating to
        RHEL 5 (from RHEL 3). I don't have a firm date for...
        <p>
          <a
        ...
        Only a few days since the last kernel panic and I've just had another
        hard reset. This time the machine just froze completely with no
        explanation (mouse pointer frozen, clock frozen, no visible movement on
        screen or sound from the...
        <p>
          <a
        ...
        I admit to not being really excited about this year's keynote. I've been
        so engrossed with work of late that I didn't even know what day the
        keynote would take place. And I knew that most of the things that...
        <p>
          <a
        ...
        In this screencast I demo using RSpec and Autotest to do continuous
        integration/BDD (choose your favorite buzzword) of a compiled
        Objective-C tool: I've got the flu right now, so apologies for the
        voice. Here is the commit where I integrate...
        <p>
          <a
        ...
        I like the open source model. I really do think it has the potential to
        produce better software. Note that I said potential; survey the market
        place and you'll find examples of open source projects which are
        best-of-class and others...
        <p>
          <a
        ...
        It's nice to have official confirmation from an Apple employee that
        progress is being made towards making ZFS an option for formatting Mac
        OS X startup disks: Can I boot off of ZFS? Not yet but we are working
        on...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2008/01/bootable_zfs.php"
            >Read full article</a
          >
        </p>
        ...
        Just went out for two hours and when I came back the machine was
        displaying the grey screen of death (kernel panic), with the screen
        saver password prompt visible in the background. Involuntary reboot
        stats to date Operating system version:...
        <p>
          <a
            href="https://wincent.dev/a/about/wincent/weblog/archives/2008/01/involuntary_reb_20.php"
            >Read full article</a
          >
        </p>
        ...
        Looking at the specs on the new Mac Pros, nice to see the
        &quot;grunt&quot; factor rolling inexorably forward. The new Mac Pro
        combines two of Intel’s new 45 nanometer Quad-Core Xeon 5400 processors
        running up to 3.2 GHz, new graphics...
        <p>
          <a
