...
<p class="more"><em>"I shall call it, Mini-log..."</em> (<a href="https://wincent.com/a/about/wincent/weblog/archives/2006/09/keeping_up_to_d.php">about</a>)</p>
  ...
  <li>
    <h4>Ragel 6.0</h4>
    <p>A new release of the <a href='http://www.cs.queensu.ca/~thurston/ragel/'>totally awesome state machine compiler</a>. When you need to parse regular languages fast, remember Ragel.</p>
  ...
  <li>
    <h4>RR</h4>
    <p>A new and very interesting &quot;<a href='http://pivots.pivotallabs.com/users/brian/blog/articles/352-introducing-rr'>test double</a>&quot; (mock, stub, proxy) framework called RR. I really like the terse syntax in the examples.</p>
  ...
  <li>
    ...
    <p>&quot;<a href='http://wordpress.org/development/2007/12/wordpress-232/'>WordPress 2.3.2</a> is an urgent security release&quot;... Familiar-sounding words for anybody who's been tracking the releases of everybody's favorite PHP weblogging engine.</p>
  ...
  <li>
    <h4>Crazy advice</h4>
    <p><a href='http://blog.carlmercier.com/2007/12/14/how-to-fix-that-rubygems-mess-on-leopard/'>Just crazy</a>.</p>
  ...
  <li>
    ...
    <p><a href='http://www.dribin.org/dave/blog/archives/2007/11/28/ssh_agent_leopard/'>Good coverage</a> of the changes.</p>
  ...
  <li>
    <h4>Rails 2.0.1</h4>
    <p><a href='http://rubyforge.org/frs/?group_id=307'>Already</a>, but no release notes and no mention on the <a href='http://weblog.rubyonrails.com/'>official weblog</a>.</p>
  ...
  <li>
    <h4>Rails 2.0</h4>
    <p>Apparently <a href='http://rubyforge.org/frs/?group_id=307'>out</a>, although there's been no announcement on the <a href='http://weblog.rubyonrails.com/'>official weblog</a> yet.</p>
  ...
  <li>
    ...
    <p>Very surprised to see <a href='http://blog.davidchelimsky.net/articles/2007/11/29/nested-example-groups'>this</a> (there always seemed to be a bit of resistance to the idea from the core devs), but very happy too as it will make for some much more readable specs.</p>
  ...
  <li>
    <h4>Rails 2.0RC2</h4>
    <p><a href='http://weblog.rubyonrails.com/2007/11/29/rails-2-0-release-candidate-2'>Almost there...</a></p>
  ...
  <li>
    <h4>Game of life</h4>
    <p><a href='http://xkcd.com/350/'>He's on a roll</a> (see also <a href='http://en.wikipedia.org/wiki/Conway%27s_Game_of_Life'>Wikipedia on the Game of life</a>).</p>
...
<p>I'm currently looking at getting a better microphone to do screencasts. The one I'm most interested in goes for between $84 and $100 in the US (57€ to 68€). Purchased locally here in Spain the mic goes for upwards of 130€.</p>
...
<p>Only a few days since the last kernel panic and I've just had another hard reset. This time the machine just froze completely with no explanation (mouse pointer frozen, clock frozen, no visible movement on screen or sound from the hard drive). This machine may well be on its last legs.</p>
...
<p>I like the open source model. I really do think it has the potential to produce better software. Note that I said <em>potential</em>; survey the market place and you'll find examples of open source projects which are best-of-class and others which are severely lacking.</p>
