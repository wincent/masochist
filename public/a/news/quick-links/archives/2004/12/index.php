  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          Alessandro Ranellucci has updated his
          <a href="http://alex.primafila.net/tinyglot/">tinyglot</a>
          localization script to version 1.1, incorporating a couple of patches
          that I sent him. See
          <a
            href="https://typechecked.net/a/knowledge-base/archives/2004/11/localization_on.php"
            >this article</a
          >
          for more details on localization.
        </p>

        <p class="posted">Posted 6:04 PM</p>
        <h4>December 9, 2004</h4>

        <h5 id="a000037">BBEdit 8.0.3</h5>

        <p>
          <a href="http://www.barebones.com/">Bare Bones</a> has just released
          <a href="http://www.barebones.com/support/bbedit/updates.shtml"
            >BBEdit 8.0.3</a
          >
          with the usual
          <a href="http://www.barebones.com/support/bbedit/arch_bbedit803.shtml"
            >long list of bug fixes</a
          >. Incredibly expensive, but incredibly good too. If your work
          requires you to work with raw text, then it's hard to live without
          <a href="http://www.barebones.com/products/bbedit/index.shtml"
            >BBEdit</a
          >.
        </p>

        <p class="posted">Posted 1:11 AM</p>
      </div>
    </div>
