  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          Default Folder X 2.0b3 is
          <a href="http://www.stclairsw.com/DefaultFolderX/beta.html"
            >a public beta</a
          >
          of <a href="http://www.stclairsw.com/">St Clair Software's</a> popular
          app that uses Wincent's
          <a href="https://wincent.dev/a/products/install/">Install</a>
          application (<a href="http://www.stclairsoft.com/cgi-bin/dl.cgi?DX-B"
            >download</a
          >).
        </p>

        <p class="posted">Posted 10:27 PM</p>
        <h4>March 12, 2005</h4>

        <h5 id="a000050">Default Folder X 2.0b2</h5>

        <p>
          Default Folder X 2.0b2 is
          <a href="http://www.stclairsw.com/DefaultFolderX/beta.html"
            >a public beta</a
          >
          of <a href="http://www.stclairsw.com/">St Clair Software's</a> popular
        ...
        <p class="posted">Posted 8:17 PM</p>
        <h4>March 4, 2005</h4>
        ...
        <p>
          Version 1.2.1 of
          <a href="http://www.speirs.org/flickrexport/">FlickrExport</a>, the
          Flickr Export plug-in for iPhoto by
          <a href="http://www.speirs.org/">Fraser Speirs</a>, is the first
          version that makes use of Wincent's
          <a href="https://wincent.dev/a/products/install/">Install</a>
          application.
        </p>

        <p class="posted">Posted 10:07 PM</p>
      </div>
    </div>
