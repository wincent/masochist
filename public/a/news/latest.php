...
<ul>
  <li>
    ...
    The server migration from Rackspace to INetU is currently underway. My aim
...
<ul>
  <li>
    ...
    Bansshee is a free, open-source tool to thwart dictionary-based SSH attacks.
    As a convenience to users there are three domains
    that resolve to the Bansshee project page.
...
<ul>
  <li>
    ...
    [<a href="https://wincent.dev/a/news/archives/2008/02/upcoming_dns_ch.php"
      >More...</a
    >]
  </li>
</ul>
...
<ul>
  <li>
    ...
    I'm pleased to announce the availability of version 3.5a5 of Synergy, the
