...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Synergy Advance help: AppleScript</title>
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../../../">Products</a>&nbsp;&gt;&nbsp;<a href="../../">Synergy Advance</a>&nbsp;&gt;&nbsp;<a href="../">Help</a>&nbsp;&gt;&nbsp;AppleScript    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
      ...
      <div id="center">
        <div class="content">
          ...
          <h3>Synergy Advance help: AppleScript</h3>
          
          <p>Synergy Advance features AppleScript support (the ability to control Synergy Advance using AppleScript).</p>
          
          <h4>Finding out whether the Global Menu is in the menu bar:</h4>
          
          <pre>tell application "Synergy Advance"
  get show global menu
end tell</pre>
          
          <h4>Adding the Global Menu to the menu bar:</h4>
          
          <pre>tell application "Synergy Advance"
  set show global menu to true
end tell</pre>
          
          <h4>Removing the Global Menu from the menu bar:</h4>
