...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Synergy Advance known issues</title>
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../../">Products</a>&nbsp;&gt;&nbsp;<a href="../">Synergy Advance</a>&nbsp;&gt;&nbsp;Known Issues    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
      ...
      <div id="center">
        <div class="content">
          ...
          <p>Here is a summary of the known issues in the public preview release (version 0.2):</p>
          
          <ul>
            <li>Cross-dissolves between the "Advanced" and "Hot Keys" preference panes are not animated (<a href="http://www.wincent.com/a/support/bugs/show_bug.cgi?id=225">bug #225</a>).</li>
            <li>The "Refresh" menu items in the "Playlists", "Genres" and "Artists" submenus are not yet hooked up and have no effect.</li>
            <li>The "Recent Tracks" and "Upcoming Tracks" submenus in the Global Menu are not yet hooked up and are permanently ghosted.</li>
            <li>There are two blank menu items in the Global Menu which correspond to modules that will be released in the next previews. They are currently scheduled for public preview release 0.5 and 0.6. Information about the release schedule is <a href="http://www.wincent.com/a/products/synergy-advance/road-map/">available here</a>.</li>
            <li>If you issue a command such as "Play" to iTunes when it is not running nothing will happen. The behaviour of Synergy was the opposite (it would launch iTunes in this case and then start playing). I will soon be adding a setting in the advanced preferences pane which allows people to choose the behaviour that they prefer. This is in the bug database as <a href="http://www.wincent.com/a/support/bugs/show_bug.cgi?id=204">bug #204</a>.</li>
            <li>There are some polish issues still to be resolved with the Instant Messaging preference pane. For example, if Synergy Advance sets a custom status message or user image it does not restore the previous status or image afterwards. This is most noticeable when you are using cover art as a user image and a song starts playing for which there is no cover art (iChat wil continue to use the same user image rather than resetting).</li>
            <li>Some of the items in the Synergy Advance AppleScript dictionary refer to features that are not present in the current release but will become available when the corresponding modules are added to one of the upcoming public preview releases.</li>
          </ul>
          
          <p>In addition to the issues listed on this page the <a href="http://bugs.wincent.com/">bug and feature requests database</a> contains descriptions of issues reported by users.</p>
          
          <p>If you discover an issue that is not listed here or in the bugs and feature requests database please <a href="http://bugs.wincent.com/">file a bug report</a>.</p>
          
          <p>You can track the progress of the project using <a href="http://www.wincent.com/s/progress/">these resources</a>.</p>
