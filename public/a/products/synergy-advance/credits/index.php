...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Synergy Advance: credits</title>
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../../">Products</a>&nbsp;&gt;&nbsp;<a href="../">Synergy Advance</a>&nbsp;&gt;&nbsp;Credits    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
      ...
      <div id="center">
        <div class="content">
          ...
          <ul>
            <li><em>Design and development, documentation, website maintenance, customer support</em></li>
          </ul>
          
          <h4>Graphic Artist</h4>
          
          <p>Adam "Elroy" Mazzitelli (<a href="http://www.elroyonline.net/">website</a>)</p>
          
          <ul>
            <li><em>Application icon, preference pane icons, Global Menu graphic</em></li>
          </ul>
          
          <h4>Sponsors</h4>
          
          <p>The following people and organizations have kindly supported the development of Synergy Advance with contributions of 50&euro; or more.</p>
          
          <ul>
            <li>David DeVisser</li>
          </ul>
