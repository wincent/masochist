    ...
    <div id="container">
      ...
      <div id="center">
        <div class="content">
          ...
          />
          <p>
            Synergy Advance is the successor to the popular iTunes accessory,
            <a href="../synergy-classic/">Synergy</a>, written from scratch to
            take advantage of the power of
            <a href="http://www.apple.com/macosx/tiger/"
              >Apple's Tiger operating system</a
            >
            (also runs on Panther).
          </p>

          <h4>Project status</h4>

          <p>
            The first public preview releases are out and available for
            <a href="download/">download</a>. See the
            <a href="road-map/">road map</a> and the
            <a href="known-issues/">known issues</a> pages. You can track the
            progress of the project using
          ...
          <p>
            Synergy Advance is a brand new product written from scratch, so
            upgrade licenses will not be available. Synergy will continue to be
            marketed as a separate product. Synergy will continue to work when
            run on Tiger. Although upgrade licenses will not be available,
            Wincent does offer
            <a href="https://wincent.dev/a/products/synergy-advance/purchase/"
              >discounts</a
            >
            to those who already hold Synergy licenses; the discounted licenses
            will be 7&euro; each.
          </p>
          ...
          <p>
            Synergy is a mature product that runs on Mac OS X Jaguar, Panther
            and Tiger. If you decide to purchase it it will serve you well.
          </p>

          <p>
            Synergy Advance is still in the early stages of its roll out so it
            does not yet feature all the features of Synergy (although it does
            feature some things that Synergy does not and never will have
            because of its architecture). By the time the roll out is complete
            Synergy Advance will do everything that Synergy can do and much more
            (see the <a href="road-map/">road map</a>).
          </p>

          <p>
            Wincent offers discounts to people who hold a Synergy license, so
            the recommendation is that you try out both products (free 7-day
            trials are available) and make a decision based on your trial.
          </p>
        </div>
      </div>
      <div id="right">
