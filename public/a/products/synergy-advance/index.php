...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <div id="breadcrumbs">
    <p><a href="https://wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../">Products</a>&nbsp;&gt;&nbsp;Synergy Advance    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
      ...
      <div id="center">
        <div class="content">
          ...
          <img style="float:left; margin: 20px;" src="https://wincent.com/a/gfx/synergy-advance-icon.jpg" alt="Synergy Advance icon" width="64" height="64" />
          ...
          <p>The first public preview releases are out and available for <a href="download/">download</a>. See the <a href="road-map/">road map</a> and the <a href="known-issues/">known issues</a> pages. You can track the progress of the project using <a href="https://wincent.com/s/progress/">these resources</a>.</p>
          
          <h4>Will Synergy Advance be free for users who have a Synergy license?</h4>
          
          <p>Synergy Advance is a brand new product written from scratch, so upgrade licenses will not be available. Synergy will continue to be marketed as a separate product. Synergy will continue to work when run on Tiger. Although upgrade licenses will not be available, Wincent does offer <a href="https://wincent.com/a/products/synergy-advance/purchase/">discounts</a> to those who already hold Synergy licenses; the discounted licenses will be 7&euro; each.</p>
