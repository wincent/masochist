...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Synergy Advance support</title>
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../../">Products</a>&nbsp;&gt;&nbsp;<a href="../">Synergy Advance</a>&nbsp;&gt;&nbsp;Support    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
      ...
      <div id="center">
        <div class="content">
          ...
          <h3>Synergy Advance support</h3>
          
          <p>The following support resources are available to you 24 hours a day, 365 days a year through this website.</p>
          
          <h4>Synergy Advance Frequently Asked Questions</h4>
          
          <p>The <a href="../faq/">FAQ</a> contains the answers to the most common Synergy Advance questions.</p>
          
          <p class="more">Click <a href="../faq/">here</a> to view the FAQ</p>
          
          <h4>Synergy Advance help documentation</h4>
          
          <p>The <a href="../help/">help documentation</a> provides lots of information about what Synergy Advance is, how it works, what the different options mean and how to get it to do what you want.</p>
          
          <p class="more">Click <a href="../help/">here</a> to view the help documentation</p>
          ...
          <p>The <a href="http://www.wincent.com/a/support/">wincent.com support pages</a> group together all the support resources available to you from this website, as well as containing site-wide support information that applies not only to Synergy Advance but to all other Wincent products and services.</p>
          ...
          <p>There are two Synergy Advance mailing lists that you can join:</p>
          
          <ul>
            <li><em>announce</em>: Synergy Advance announcements list</li>
            <li><em>beta</em>: Synergy Advance beta testing list</li>
          </ul>
