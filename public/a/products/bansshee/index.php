...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Bansshee: SSH dictionary attack prevention</title>
    ...
    <div style="text-align: center; font-family: 'Lucida Grande'; margin: 5px 250px 5px 250px; padding: 5px; font-size: x-small; border: 2px solid silver; -webkit-border-radius: 0.5em; -moz-border-radius: 0.5em; background: #fefefe;">
      ...
      <tr>
        ...
        <td style="background-image: url(/a/gfx/header/center-background.jpg); background-repeat: repeat;" colspan="11" align="center" valign="middle">          <!-- Begin: header content -->
          ...
          <img src="/a/gfx/bansshee-header.jpg" width="462" height="25" alt="Bansshee" align="middle" />
          <!-- End: header content -->
        </td>
  ...
  <div id="breadcrumbs">
    <p><a href="https://wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../">Products</a>&nbsp;&gt;&nbsp;Bansshee    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
      ...
      <div id="center">
        <div class="content">
          ...
          <p>Bansshee is a lightweight daemon written in Perl designed to thwart dictionary-based SSH brute force attacks. For more information see <a href="https://wincent.com/a/about/wincent/weblog/archives/2006/04/bansshee_my_ans.php">this article</a> and a the <a href="https://wincent.com/a/about/wincent/weblog/archives/2006/04/bansshee_update.php">subsequent update</a>.</p>
          
          <h5><a id="download" name="download"></a>Download</h5>
          
          <p>Version 1.0.1 is available for <a href="https://wincent.com/a/products/bansshee/download/bansshee-1.0.1.tar.gz">download here</a> (28KB).</p>
          
          <p>You can also check out the latest version of the source via Git; for example, to check out into a directory named <tt>bansshee</tt>:</p>
          
          <pre>git clone git://git.wincent.com/bansshee.git</pre>
          
          <p>A <a href="http://git.wincent.com/bansshee.git">web-based repository browser</a> is also available.</p>
          
          <h4><a id="donations" name="donations"></a>Donations</h4>
          
          <p>Bansshee is free software released under the BSD license. If it is useful to you, please consider making a <a href="https://www.paypal.com/xclick/business=win@wincent.com&amp;item_name=Bansshee+donation&amp;no_note=1&amp;currency_code=EUR&amp;lc=GB">donation</a>.</p>
          
          <h4><a id="history" name="history"></a>History</h4>

          <h5>1.0.1 (24 June 2009)</h5>

          <ul>
            <li>Add support files for Red Hat Enterprise Linux 5.3.</li>
            <li>License changed from GPL to BSD license.</li>
          </ul>

          <h5>1.0 (16 October 2006)</h5>
          
          <ul>
            <li>First public availability</li>
          </ul>
          
          <h5>1.0-internal (12 April 2006)</h5>
          
          <ul>
            <li>Original version (not publicly released).</li>
          </ul>
