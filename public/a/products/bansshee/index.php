    ...
    <div id="container">
      <div id="left">
        <div class="sidebar">
          ...
          <ul>
            <li>
              <a href="https://wincent.dev/a/products/bansshee/">Information</a>
            </li>
            <li>
              <a href="https://wincent.dev/forums/bansshee"
                >Discussion & support forums</a
              >
            </li>
            <li>
              <a href="https://wincent.dev/support"
      ...
      <div id="center">
        <div class="content">
          ...
          <p>
            Bansshee is a lightweight daemon written in Perl designed to thwart
            dictionary-based SSH brute force attacks. For more information see
            <a
          ...
          <pre>git clone git://git.wincent.dev/bansshee.git</pre>
