    ...
    >
      ...
      <tr>
        ...
        >
          ...
          /></a>
          <img
            src="/a/gfx/clipboard-commando-header.jpg"
            width="444"
            height="24"
            alt="Clipboard Commando: do you copy?"
            align="middle"
          />
          <!-- End: header content -->
        </td>
    ...
    <div id="container">
      <div id="left">
        <div class="sidebar">
          ...
          <ul>
            <li>
              <a
                href="https://wincent.com/a/products/clipboard-commando/purchase/"
                >Purchase</a
              >
            </li>
          </ul>
      ...
      <div id="center">
        <div class="content">
          ...
          <h4>
            <a id="paypal" name="paypal"></a>Purchase Clipboard Commando using
            PayPal
          </h4>
              ...
              <td>
                ...
                >
                  ...
                  <input
                    type="hidden"
                    name="item_name"
                    value="Clipboard Commando for Mac OS X"
                  />
                  <table>
                    <tr>
                      <td>Quantity:</td>
              ...
              <td>
                ...
                >
                  ...
                  <input
                    type="hidden"
                    name="item_name"
                    value="Clipboard Commando for Mac OS X 5 User License"
                  />
                  <table>
                    <tr>
                      <td>Quantity:</td>
              ...
              <td>
                ...
                >
                  ...
                  <input
                    type="hidden"
                    name="item_name"
                    value="Clipboard Commando for Mac OS X 10 User License"
                  />
                  <table>
                    <tr>
                      <td>Quantity:</td>
              ...
              <td>
                ...
                >
                  ...
                  <input
                    type="hidden"
                    name="item_name"
                    value="Clipboard Commando for Mac OS X 50 User License"
                  />
                  <table>
                    <tr>
                      <td>Quantity:</td>
              ...
              <td>
                ...
                >
                  ...
                  <input
                    type="hidden"
                    name="item_name"
                    value="Clipboard Commando for Mac OS X 100 User License"
                  />
                  <table>
                    <tr>
                      <td>Quantity:</td>
          ...
          <p>
            <a href="http://kagi.com/">Kagi</a> does not (yet) allow merchants
            to specify their prices in non-US currency on their order pages. The
            prices below are therefore shown in US dollars and are periodically
            updated to reflect any changes in the exchange rate.
          </p>

          <table align="center">
            <tr>
              <td>
                <a href="http://order.kagi.com/?3MJ&amp;lang=en"
              ...
              <td>
                <form
                  ...
                  id="kagi1"
                  method="post"
                  action="https://order.kagi.com/cgi-bin/store.cgi?storeID=3MJ&amp;lang=en&amp;view=cart"
                >
                  <input
                    type="hidden"
                    name="Product"
                    value="US$ 13 - 1 * clipboardcommandosingleuser_3mj"
                  />
              ...
              <td>
                ...
                >
                  <input
                    type="hidden"
                    name="Product"
                    value="US$ 32 - 1 * clipboardcommando5seat_3mj"
                  />
                  <input type="hidden" name="order/javascript" value="YES" />
                  <input type="submit" name="submit" value="Buy now" />
                </form>
              ...
              <td>
                ...
                >
                  <input
                    type="hidden"
                    name="Product"
                    value="US$ 50 - 1 * clipboardcommando10seat_3mj"
                  />
                  <input type="hidden" name="order/javascript" value="YES" />
                  <input type="submit" name="submit" value="Buy now" />
                </form>
              ...
              <td>
                ...
                >
                  <input
                    type="hidden"
                    name="Product"
                    value="US$ 192 - 1 * clipboardcommando50seat_3mj"
                  />
                  <input type="hidden" name="order/javascript" value="YES" />
                  <input type="submit" name="submit" value="Buy now" />
                </form>
              ...
              <td>
                ...
                >
                  <input
                    type="hidden"
                    name="Product"
                    value="US$ 320 - 1 * clipboardcommando100seat_3mj"
                  />
                  <input type="hidden" name="order/javascript" value="YES" />
                  <input type="submit" name="submit" value="Buy now" />
                </form>
