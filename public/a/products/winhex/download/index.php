    ...
    <div id="container">
      ...
      <div id="center">
        <div class="content">
          ...
          <p>
            All the downloads in this list indicate MD5 checksums so that you
            can verify the integrity of the downloaded files. Please see
            <a
          ...
          <h5>
            ...
            <a href="https://wincent.com/download.php?item=WinHex.zip"
              ><img
                style="float: right;"
          ...
          <h5>
            WinHex 1.0b2 localization pack
            <a
              href="https://wincent.com/download.php?item=WinHexLocalizationPack.zip"
              ><img
                style="float:right;"
                src="/a/gfx/download.jpg"
                alt="Download"
          ...
          <p>
            <a
              href="https://wincent.com/download.php?item=WinHexLocalizationPack.zip"
              >WinHex1.0b2LocalizationPack.zip</a
            >
            (ZIP, 8KB, MD5 checksum: 0be16c034b33447711ce50f20f492d6f).
          </p>
          ...
          <p>
            I use a redirection script that randomly selects mirrors from a list
            and thus ensures that over time each mirror receives a fair share of
            the traffic.
          </p>

          <p>
            Please
            <a href="https://wincent.com/a/contact/mail/">contact me</a> if you
            interested in hosting a mirror.
          </p>
        </div>
      </div>
      <div id="right">
