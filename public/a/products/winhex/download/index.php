...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../../">Products</a>&nbsp;&gt;&nbsp;<a href="../">Winhex</a>&nbsp;&gt;&nbsp;Download    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
      ...
      <div id="center">
        <div class="content">
          ...
          <p>All the downloads in this list indicate MD5 checksums so that you can verify the integrity of the downloaded files. Please see <a href="http://www.wincent.com/a/knowledge-base/archives/2004/11/using_md5_to_ve.php">this knowledge base article</a> for instructions on how to do this.</p>
          
          <h4>WinHex application</h4>
          
          <h5>WinHex 1.0b2 for Mac OS X 10.3 and later <a href="http://www.wincent.com/download.php?item=WinHex.zip"><img style="float: right;" src="/a/gfx/download.jpg" alt="Download" width="80" height="32" /></a></h5>
          
          <p><a href="http://www.wincent.com/download.php?item=WinHex.zip">WinHex1.0b2.zip</a> (ZIP, 160KB, MD5 checksum: de0243fbd6273ba3ccdac242391ed865).</p>
          
          <h4>WinHex localization pack</h4>
          
          <h5>WinHex 1.0b2 localization pack <a href="http://www.wincent.com/download.php?item=WinHexLocalizationPack.zip"><img style="float:right;" src="/a/gfx/download.jpg" alt="Download" width="80" height="32" /></a></h5>
          
          <p><a href="http://www.wincent.com/download.php?item=WinHexLocalizationPack.zip">WinHex1.0b2LocalizationPack.zip</a> (ZIP, 8KB, MD5 checksum: 0be16c034b33447711ce50f20f492d6f).</p>
          
          <p>For tips and information about localization, please see this <a href="http://www.wincent.com/a/knowledge-base/archives/2004/11/localization_on.php">knowledge base article</a>.</p>
          
          <p>I use a redirection script that randomly selects mirrors from a list and thus ensures that over time each mirror receives a fair share of the traffic.</p>
          
          <p>Please <a href="http://www.wincent.com/a/contact/mail/">contact me</a> if you interested in hosting a mirror.</p>
