...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../../">Products</a>&nbsp;&gt;&nbsp;<a href="../">Winhex</a>&nbsp;&gt;&nbsp;FAQ    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
      ...
      <div id="center">
        <div class="content">
          ...
          <ul>
            <li><a href="#gray">What do the gray question marks mean in the ASCII field?</a></li>
            <li><a href="#characters">Why doesn't WinHex let me type the characters I want?</a></li>
          </ul>
          
          <hr />
          
          <h4><a id="gray" name="gray"></a>What do the gray question marks mean in the ASCII field?</h4>
          
          <p>ASCII is a text encoding that uses only 7 bits of information in every byte (8 bits). As such, for any given byte there are only 128 possible numbers for which there exist a corresponding ASCII character. For the other 128 possible numbers (those which use the eighth bit) there is no printable ASCII representation. In these cases, WinHex displays a gray question mark as a placeholder for the non-representable value.</p>
          
          <p>The set of valid ASCII characters is:</p>
          ...
          <h4><a id="characters" name="characters"></a>Why doesn't WinHex let me type the characters I want?</h4>
          
          <p>WinHex only allows you to enter characters that are valid for a given base. The list below shows the characters which are legal for the most common bases:</p>
          
          <table border="0" align="center" cellpadding="10" cellspacing="0">
            <tr>
              <td align="right">Base 16:</td>
              <td>0</td>
              <td>1</td>
              <td>2</td>
              <td>3</td>
          ...
          <p>One of the reasons WinHex does not support bases greater than Base 36 is that this is the highest base that can be represented using the 26 letters of the Roman alphabet (a-z) in tandem with the numerals 0 through to 9.</p>
