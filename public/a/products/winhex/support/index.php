...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <div style="text-align: center; font-family: 'Lucida Grande'; margin: 5px 250px 5px 250px; padding: 5px; font-size: x-small; border: 2px solid silver; -webkit-border-radius: 0.5em; -moz-border-radius: 0.5em; background: #fefefe;">
      ...
      <tr>
        ...
        <td style="background-image: url(/a/gfx/header/center-background.jpg); background-repeat: repeat;" colspan="11" align="center" valign="middle">          <!-- Begin: header content -->
          ...
          <img src="/a/gfx/winhex-header.jpg" width="372" height="25" alt="WinHex: the programmer's pal" align="middle" />
          <!-- End: header content -->
        </td>
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../../">Products</a>&nbsp;&gt;&nbsp;<a href="../">Winhex</a>&nbsp;&gt;&nbsp;Support    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
              <h2>WinHex links</h2>
              <ul>
                <li><a href="http://www.wincent.com/a/products/winhex/">Information</a></li>
                <li><a href="http://www.wincent.com/a/products/winhex/download/">Download</a></li>
                <li><a href="https://secure.wincent.com/a/products/winhex/purchase/">Purchase</a></li>
                <li><a href="https://secure.wincent.com/a/products/winhex/donate/">Donate</a></li>
                <li><a href="https://secure.wincent.com/a/products/winhex/donate/">Sponsor</a></li>
                <li><a href="http://www.wincent.com/a/products/winhex/support/">Support</a></li>
                <li><a href="http://www.wincent.com/a/products/winhex/history/">Version history</a></li>
                <li><a href="http://www.wincent.com/a/products/winhex/faq/">Frequently Asked Questions</a></li>
                <li><a href="http://www.wincent.com/a/products/winhex/credits/">Credits</a></li>
              </ul>
      ...
      <div id="center">
        <div class="content">
          <h3>WinHex support</h3>
          
          <p>The following support resources are available to you 24 hours a day, 365 days a year through this website.</p>
          
          <h4>WinHex Frequently Asked Questions</h4>
          
          <p>The <a href="../faq/">FAQ</a> contains the answers to the most common WinHex questions.</p>
          
          <p class="more">Click <a href="../faq/">here</a> to view the FAQ</p>
          
          <h4>Support pages</h4>
          
          <p>The <a href="http://www.wincent.com/a/support/">wincent.com support pages</a> group together all the support resources available to you from this website, as well as containing site-wide support information that applies not only to WinHex but to all other Wincent products and services.</p>
          ...
          <p>There are two WinHex-related mailing lists that you can join:</p>
          
          <ul>
            <li><em>winhex-announce</em>: WinHex announcements list</li>
            <li><em>winhex-beta</em>: WinHex beta testers list</li>
          </ul>
