...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <div style="text-align: center; font-family: 'Lucida Grande'; margin: 5px 250px 5px 250px; padding: 5px; font-size: x-small; border: 2px solid silver; -webkit-border-radius: 0.5em; -moz-border-radius: 0.5em; background: #fefefe;">
      ...
      <tr>
        ...
        <td style="background-image: url(/a/gfx/header/center-background.jpg); background-repeat: repeat;" colspan="11" align="center" valign="middle">          <!-- Begin: header content -->
          ...
          <img src="/a/gfx/atosym-header.jpg" width="550" height="24" alt="atosym" align="middle" />
          <!-- End: header content -->
        </td>
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../">Products</a>&nbsp;&gt;&nbsp;Atosym    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
              <h2>atosym links</h2>
              <ul>
                <li><a href="http://www.wincent.com/a/products/atosym/">Information</a></li>
                <li><a href="http://www.wincent.com/a/support/forums/ubbthreads.php?ubb=postlist&amp;Board=15&amp;page=1">Discussion & support forums</a></li>
                <li><a href="http://lists.wincent.com/mailman/listinfo/atosym-announce">Mailing list</a></li>
      ...
      <div id="center">
        <div class="content">
          ...
          <p><tt>atosym</tt> is a command-line tool that I hacked together to serve as a replacement for <tt>atos(1)</tt> until Apple makes a version that is compatible with the dSYM debug information format (this was expected in Leopard but it appears to not be the case). Basically it calls on GDB, the only tool currently capable of parsing dSYM files, to do the work behind the scenes.</p>
          
          <h4><a id="usage" name="usage"></a>Usage</h4>
          
          <pre>atosym -d dSYM-file [-arch i386|ppc] [-o offset] [address ...]</pre>
          
          <p>The only compulsory argument is a <tt>dSYM-file</tt> passed in via the <tt>-d</tt> switch.</p>
          
          <p>You may optionally specify an architecture with the <tt>-arch</tt> switch (<tt>i386</tt> or <tt>ppc</tt>; defaults to <tt>i386</tt>).</p>
          
          <p>If you specify an offset with the <tt>-o</tt> switch then it will be automatically added to any addresses before performing conversion to symbols; this is useful when working with loadable bundles which can be located different locations in memory.</p>
          
          <p>If you specify an address (or addresses) in either decimal or hexadecimal notation (preceded with "0x") then <tt>atosym</tt> will attempt the address to symbol conversion.</p>
          
          <p>If you do not specify any addresses then <tt>atosym</tt> will enter interactive mode (demonstrated below).</p>
          
          <h5>Example: non-interactive mode</h5>
          
          <pre>$ atosym -d dSYMfile 0x1f70
Line 10 of "source.m" starts at address 0x1f70 &lt;main+78&gt; and
 ends at 0x1f78.</pre>
          
          <h5>Example: interactive mode</h5>
          
          <pre>$ atosym -d dSYMfile 
...
> quit</pre>
          ...
          <p>Version 1.0 is available for <a href="http://www.wincent.com/download.php?item=atosym.zip">download here</a> (20KB, source and Universal Binary executable included).</p>
                    
          <p>You can also check out the latest version of the source via Git:</p>
          
          <pre>git clone git://git.wincent.com/atosym.git</pre>
          
          <p>Or view the source code using the web-based repository browser at <a href="http://git.wincent.com/atosym.git">git.wincent.com</a>.</p>
          
          <p>An older version of the source code is available in the legacy Subversion repository:</p>
          
          <pre>svn co svn://svn.wincent.com/atosym/trunk</pre>
          
          <h4><a id="donations" name="donations"></a>Donations</h4>
          
          <p><tt>atosym</tt> is free software released under the BSD license. If it is useful to you, please consider making a <a href="https://www.paypal.com/xclick/business=win@wincent.com&amp;item_name=atosym+donation&amp;no_note=1&amp;currency_code=EUR&amp;lc=GB">donation</a>.</p>
          
          <h4>Links</h4>
          
          <ul>
            <li><a href="http://www.softedge.se/dSymbolizer/">dSymbolizer</a> is a GUI-based tool for performing address to symbol conversion on entire crash logs at once.</li>
          </ul>
          ...
          <ul>
            <li>Use <tt>/usr/bin/gdb</tt> script with <tt>-arch</tt> flag instead of manually selecting and launching a GDB executable.</li>
          </ul>
