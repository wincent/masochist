...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <table border="0" align="center" cellspacing="0" cellpadding="0" width="832">
      ...
      <tr>
        ...
        <td style="background-image: url(/a/gfx/header/center-background.jpg); background-repeat: repeat;" colspan="11" align="center" valign="middle">          <!-- Begin: header content -->
          ...
          <img src="/a/gfx/renamer-header.jpg" width="501" height="25" alt="REnamer: change is as good as a holiday" align="middle" />
          <!-- End: header content -->
        </td>
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../../">Products</a>&nbsp;&gt;&nbsp;<a href="../">Renamer</a>&nbsp;&gt;&nbsp;Purchase    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
              <h2>REnamer links</h2>
              <ul>
                <li><a href="https://secure.wincent.com/a/products/renamer/purchase/">Purchase</a></li>
              </ul>
      ...
      <div id="center">
        <div class="content">
          ...
          <h3>Purchase a REnamer license</h3>
          ...
          <h4><a id="paypal" name="paypal"></a>Purchase REnamer using PayPal</h4>
            ...
            <tr>
              ...
              <td>
                <form name="paypal1" id="paypal1" method="post" action="https://www.paypal.com/cgi-bin/webscr" onSubmit="return TestFormValues('paypal1')">
                  ...
                  <input type="hidden" name="item_name" value="REnamer for Mac OS X" />
                  <table>
                    <tr>
                      <td>Quantity:</td>
            ...
            <tr>
              ...
              <td>
                <form name="paypal2" id="paypal2" method="post" action="https://www.paypal.com/cgi-bin/webscr" onSubmit="return TestFormValues('paypal2')">
                  ...
                  <input type="hidden" name="cancel_return" value="http://www.wincent.com/" />
                  <input type="hidden" name="notify_url" value="https://secure.wincent.com/cgi-bin/paypal_ipn.pl">
                  <input type="hidden" name="item_name" value="REnamer for Mac OS X 5 User License" />
                  <table>
                    <tr>
                      <td>Quantity:</td>
                      <td><input type="text" name="quantity" value="1" size="4" /></td>
            ...
            <tr>
              ...
              <td>
                <form name="paypal3" id="paypal3" method="post" action="https://www.paypal.com/cgi-bin/webscr" onSubmit="return TestFormValues('paypal3')">
                  ...
                  <input type="hidden" name="cancel_return" value="http://www.wincent.com/" />
                  <input type="hidden" name="notify_url" value="https://secure.wincent.com/cgi-bin/paypal_ipn.pl">
                  <input type="hidden" name="item_name" value="REnamer for Mac OS X 10 User License" />
                  <table>
                    <tr>
                      <td>Quantity:</td>
                      <td><input type="text" name="quantity" value="1" size="4" /></td>
            ...
            <tr>
              ...
              <td>
                <form name="paypal4" id="paypal4" method="post" action="https://www.paypal.com/cgi-bin/webscr" onSubmit="return TestFormValues('paypal4')">
                  ...
                  <input type="hidden" name="cancel_return" value="http://www.wincent.com/" />
                  <input type="hidden" name="notify_url" value="https://secure.wincent.com/cgi-bin/paypal_ipn.pl">
                  <input type="hidden" name="item_name" value="REnamer for Mac OS X 50 User License" />
                  <table>
                    <tr>
                      <td>Quantity:</td>
                      <td><input type="text" name="quantity" value="1" size="4" /></td>
            ...
            <tr>
              ...
              <td>
                <form name="paypal5" id="paypal5" method="post" action="https://www.paypal.com/cgi-bin/webscr" onSubmit="return TestFormValues('paypal5')">
                  ...
                  <input type="hidden" name="cancel_return" value="http://www.wincent.com/" />
                  <input type="hidden" name="notify_url" value="https://secure.wincent.com/cgi-bin/paypal_ipn.pl">
                  <input type="hidden" name="item_name" value="REnamer for Mac OS X 100 User License" />
                  <table>
                    <tr>
                      <td>Quantity:</td>
                      <td><input type="text" name="quantity" value="1" size="4" /></td>
            ...
            <tr>
              ...
              <td>
                <form name="kagi1" id="kagi1" method="post" action="https://order.kagi.com/cgi-bin/store.cgi?storeID=3MJ&amp;lang=en&amp;view=cart">
                  <input type="hidden" name="Product" value="US$ 13 - 1 * renamersingleuser_3mj" />
            ...
            <tr>
              ...
              <td>
                <form name="kagi2" id="kagi2" method="post" action="https://order.kagi.com/cgi-bin/store.cgi?storeID=3MJ&amp;lang=en&amp;view=cart">
                  <input type="hidden" name="Product" value="US$ 32 - 1 * renamer5seat_3mj" />
                  <input type="hidden" name="order/javascript" value="YES" /> 
                  <input type="submit" name="submit" value="Buy now" />
                </form>
              </td>
            ...
            <tr>
              ...
              <td>
                <form name="kagi3" id="kagi3" method="post" action="https://order.kagi.com/cgi-bin/store.cgi?storeID=3MJ&amp;lang=en&amp;view=cart">
                  <input type="hidden" name="Product" value="US$ 50 - 1 * renamer10seat_3mj" />
                  <input type="hidden" name="order/javascript" value="YES" /> 
                  <input type="submit" name="submit" value="Buy now" />
                </form>
              </td>
            ...
            <tr>
              ...
              <td>
                <form name="kagi4" id="kagi4" method="post" action="https://order.kagi.com/cgi-bin/store.cgi?storeID=3MJ&amp;lang=en&amp;view=cart">
                  <input type="hidden" name="Product" value="US$ 192 - 1 * renamer50seat_3mj" />
                  <input type="hidden" name="order/javascript" value="YES" /> 
                  <input type="submit" name="submit" value="Buy now" />
                </form>
              </td>
            ...
            <tr>
              ...
              <td>
                <form name="kagi5" id="kagi5" method="post" action="https://order.kagi.com/cgi-bin/store.cgi?storeID=3MJ&amp;lang=en&amp;view=cart">
                  <input type="hidden" name="Product" value="US$ 320 - 1 * renamer100seat_3mj" />
                  <input type="hidden" name="order/javascript" value="YES" /> 
                  <input type="submit" name="submit" value="Buy now" />
                </form>
              </td>
