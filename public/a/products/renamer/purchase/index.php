    ...
    >
      ...
      <tr>
        ...
        >
          ...
          /></a>
          <img
            src="/a/gfx/renamer-header.jpg"
            width="501"
            height="25"
            alt="REnamer: change is as good as a holiday"
            align="middle"
          />
          <!-- End: header content -->
        </td>
    ...
    <div id="container">
      <div id="left">
        <div class="sidebar">
          ...
          <ul>
            <li>
              <a href="https://wincent.com/a/products/renamer/purchase/"
                >Purchase</a
              >
            </li>
          </ul>
      ...
      <div id="center">
        <div class="content">
          ...
          <h4>
            <a id="paypal" name="paypal"></a>Purchase REnamer using PayPal
          </h4>
              ...
              <td>
                ...
                >
                  ...
                  <input
                    type="hidden"
                    name="item_name"
                    value="REnamer for Mac OS X 5 User License"
                  />
                  <table>
                    <tr>
                      <td>Quantity:</td>
              ...
              <td>
                ...
                >
                  ...
                  <input
                    type="hidden"
                    name="item_name"
                    value="REnamer for Mac OS X 10 User License"
                  />
                  <table>
                    <tr>
                      <td>Quantity:</td>
              ...
              <td>
                ...
                >
                  ...
                  <input
                    type="hidden"
                    name="item_name"
                    value="REnamer for Mac OS X 50 User License"
                  />
                  <table>
                    <tr>
                      <td>Quantity:</td>
              ...
              <td>
                ...
                >
                  ...
                  <input
                    type="hidden"
                    name="item_name"
                    value="REnamer for Mac OS X 100 User License"
                  />
                  <table>
                    <tr>
                      <td>Quantity:</td>
              ...
              <td>
                ...
                >
                  <input
                    type="hidden"
                    name="Product"
                    value="US$ 13 - 1 * renamersingleuser_3mj"
                  />
              ...
              <td>
                ...
                >
                  <input
                    type="hidden"
                    name="Product"
                    value="US$ 32 - 1 * renamer5seat_3mj"
                  />
                  <input type="hidden" name="order/javascript" value="YES" />
                  <input type="submit" name="submit" value="Buy now" />
                </form>
              ...
              <td>
                ...
                >
                  <input
                    type="hidden"
                    name="Product"
                    value="US$ 50 - 1 * renamer10seat_3mj"
                  />
                  <input type="hidden" name="order/javascript" value="YES" />
                  <input type="submit" name="submit" value="Buy now" />
                </form>
              ...
              <td>
                ...
                >
                  <input
                    type="hidden"
                    name="Product"
                    value="US$ 192 - 1 * renamer50seat_3mj"
                  />
                  <input type="hidden" name="order/javascript" value="YES" />
                  <input type="submit" name="submit" value="Buy now" />
                </form>
              ...
              <td>
                ...
                >
                  <input
                    type="hidden"
                    name="Product"
                    value="US$ 320 - 1 * renamer100seat_3mj"
                  />
                  <input type="hidden" name="order/javascript" value="YES" />
                  <input type="submit" name="submit" value="Buy now" />
                </form>
