    ...
    <div id="container">
      ...
      <div id="center">
        <div class="content">
          ...
          />
          <p>
            Hextrapolate is a flexible number conversion utility for programmers
            and other people who work with numbers in a digital setting. It
          ...
          <p>
            ...
            (base 2) representations, as well as two adjustable fields for the
            other bases and two for text representation in either ASCII (7-bit
          ...
          <p>
            The current release of Hextrapolate requires Mac OS X 10.4 or later.
            The 1.0-series release which runs on Mac OS X 10.3 (Panther) is also
            available on the
            <a href="/a/products/hextrapolate/download/">download</a> page.
          </p>
          ...
          <p>
            The following issues are known to exist in version 2.0 and will be
