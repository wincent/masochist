...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../">Products</a>&nbsp;&gt;&nbsp;Hextrapolate    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
      ...
      <div id="center">
        <div class="content">
          ...
          <img style="float:left; margin: 20px; " src="../../gfx/winhex-icon.jpg" alt="Hextrapolate icon" width="128" height="128" />
          <p>Hextrapolate is a flexible number conversion utility for programmers and other people  who work with numbers in a digital setting. It converts, in real time, any  number in any base representation from base 2 (binary) through to base 36. Numbers can be arbitrarily large, limited only by the availability of system  resources.</p>
          
          <p>By default, the main window provides spaces for the entry and display of hexadecimal, decimal (base 10), octal (base 8) and binary (base 2) representations, as well as two adjustable fields for the other bases and two for text representation in either ASCII (7-bit text), UTF-8 or UTF-16.</p>
          
          <div class="screenshots">
            <img src="screenshots/splash.png" alt="Hextrapolate main window" width="338" height="269" />
            <p>Hextrapolate main window</p>
          </div>
          
          <h4>System requirements</h4>
          
          <p>The current release of Hextrapolate requires Mac OS X 10.4 or later. The 1.0-series release which runs on Mac OS X 10.3 (Panther) is also available on the <a href="/a/products/hextrapolate/download/">download</a> page.</p>
          
          <h4>Installation and removal</h4>
          
          <p>To install Hextrapolate, drag it to your preferred location.</p>
          
          <p>To remove it, drag it to the Trash.</p>
          
          <h4>Known issues in version 2.0</h4>
          
          <p>The following issues are known to exist in version 2.0 and will be addressed in a subsequent release:</p>
          
          <ul>
            <li>No automatic version-checking facility is provided.</li>
          </ul>
