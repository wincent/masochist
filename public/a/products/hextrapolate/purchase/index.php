...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Hextrapolate: purchase</title>
    <link rel="stylesheet" href="/a/styles.css" type="text/css" />
    <script type="text/javascript">
      window.onload = function() { 
        var label = document.getElementById('multiuser_label');
        var target = document.getElementById('multiuser_table');
        target.style.display = 'none';
        label.onclick = function() {
          target.style.display = target.style.display == 'none' ? 'block' : 'none';
        }
        var label2 = document.getElementById('multiuser_label2');
        var target2 = document.getElementById('multiuser_table2');
  ...
  <body>
    <table border="0" align="center" cellspacing="0" cellpadding="0" width="832">
      <tr>
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../../">Products</a>&nbsp;&gt;&nbsp;<a href="../">Hextrapolate</a>&nbsp;&gt;&nbsp;Purchase    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
      ...
      <div id="center">
        <div class="content">
          ...
          <script type="text/javascript">
            <!--
            function TestFormValues(formname)
            {
              var quantity = parseInt(document[formname].quantity.value);
              var result;
              if (quantity >= 1) 
                 result = true;
              else
          ...
          <h3>Purchase a Hextrapolate license</h3>
          
          <ul>
            <li><a href="#paypal">Purchase using PayPal</a></li>
            <li><a href="#kagi">Purchase using Kagi</a></li>
          </ul>
          
          <p>Both PayPal and Kagi provide automated systems which send you your license code immediately upon completion of your payment. In order to ensure that you get your license code as quickly as possible please double-check that you have specified a current, working email address on a properly configured server that does not use any challenge/response anti-spam systems (as license codes are sent by an automated system which does not reply to such challenges). Particularly in the case of PayPal remember to check your settings before completing the purchase to make sure that you don't have an old email address set. Note that in the case of eCheck or Bank Transfer payments license codes are only sent once your payment has cleared. For further information see these links related to purchasing:</p>
          
          <ul>
            <li><a href="http://www.wincent.com/a/support/faq/#which">Which payments service should I use? PayPal or Kagi?</a></li>
            <li><a href="http://www.wincent.com/a/support/faq/#vat">I am a resident in the European Union. Will I have to pay VAT?</a></li>
            <li><a href="http://www.wincent.com/a/support/faq/#refunds">What is the Wincent refund policy?</a></li>
            <li><a href="http://www.wincent.com/a/support/activation/">Product activation information</a></li>
            <li><a href="http://www.wincent.com/a/support/activation/privacy/">Product information privacy FAQ</a></li>
          </ul>
          
          <h4><a id="paypal" name="paypal"></a>Purchase Hextrapolate using PayPal</h4>
          
          <table align="center">
            <tr>
              <td>Single-User License</td>
              <td align="center">9.95&euro;</td>
              <td>
                <form name="paypal1" id="paypal1" method="post" action="https://www.paypal.com/cgi-bin/webscr" onSubmit="return TestFormValues('paypal1')">
                  <input type="hidden" name="cmd" value="_xclick" />
                  <input type="hidden" name="business" value="win@wincent.com" />
                  <input type="hidden" name="amount" value="9.95" />
                  <input type="hidden" name="no_note" value="1" />
                  <input type="hidden" name="currency_code" value="EUR" />
                  <input type="hidden" name="lc" value="GB" />
                  <input type="hidden" name="return" value="http://www.wincent.com/" />
                  <input type="hidden" name="cancel_return" value="http://www.wincent.com/" />
                  <input type="hidden" name="notify_url" value="https://secure.wincent.com/cgi-bin/paypal_ipn.pl">
                  <input type="hidden" name="item_name" value="Hextrapolate for Mac OS X" />
                  <table>
                    <tr>
                      <td>Quantity:</td>
          ...
          <div id="multiuser_label"><h4><a href="#multiuser">Discounted multi-user licenses &gt;&gt;</a></h4></div>
          <a id="multiuser" name="multiuser"></a>
          <div id="multiuser_table">
            <table align="center">
              <tr>
                ...
                <td>
                  <form name="paypal2" id="paypal2" method="post" action="https://www.paypal.com/cgi-bin/webscr" onSubmit="return TestFormValues('paypal2')">
                    <input type="hidden" name="cmd" value="_xclick" />
                    <input type="hidden" name="business" value="win@wincent.com" />
                    ...
                    <input type="hidden" name="cancel_return" value="http://www.wincent.com/" />
                    <input type="hidden" name="notify_url" value="https://secure.wincent.com/cgi-bin/paypal_ipn.pl">
                    <input type="hidden" name="item_name" value="Hextrapolate for Mac OS X 5 User License" />
                    <table>
                      <tr>
                        <td>Quantity:</td>
                        <td><input type="text" name="quantity" value="1" size="4" /></td>
              ...
              <tr>
                ...
                <td>
                  <form name="paypal3" id="paypal3" method="post" action="https://www.paypal.com/cgi-bin/webscr" onSubmit="return TestFormValues('paypal3')">
                    <input type="hidden" name="cmd" value="_xclick" />
                    <input type="hidden" name="business" value="win@wincent.com" />
                    ...
                    <input type="hidden" name="cancel_return" value="http://www.wincent.com/" />
                    <input type="hidden" name="notify_url" value="https://secure.wincent.com/cgi-bin/paypal_ipn.pl">
                    <input type="hidden" name="item_name" value="Hextrapolate for Mac OS X 10 User License" />
                    <table>
                      <tr>
                        <td>Quantity:</td>
                        <td><input type="text" name="quantity" value="1" size="4" /></td>
              ...
              <tr>
                <td>50-User License</td>
                <td align="center">
                  149&euro;<br />
                  save 70%
                </td>
                <td>
                  <form name="paypal4" id="paypal4" method="post" action="https://www.paypal.com/cgi-bin/webscr" onSubmit="return TestFormValues('paypal4')">
                    <input type="hidden" name="cmd" value="_xclick" />
                    <input type="hidden" name="business" value="win@wincent.com" />
                    ...
                    <input type="hidden" name="cancel_return" value="http://www.wincent.com/" />
                    <input type="hidden" name="notify_url" value="https://secure.wincent.com/cgi-bin/paypal_ipn.pl">
                    <input type="hidden" name="item_name" value="Hextrapolate for Mac OS X 50 User License" />
                    <table>
                      <tr>
                        <td>Quantity:</td>
                        <td><input type="text" name="quantity" value="1" size="4" /></td>
              ...
              <tr>
                <td>100-User License</td>
                <td align="center">
                  249&euro;<br />
                  save 75%
                </td>
                <td>
                  <form name="paypal5" id="paypal5" method="post" action="https://www.paypal.com/cgi-bin/webscr" onSubmit="return TestFormValues('paypal5')">
                    <input type="hidden" name="cmd" value="_xclick" />
                    <input type="hidden" name="business" value="win@wincent.com" />
                    ...
                    <input type="hidden" name="cancel_return" value="http://www.wincent.com/" />
                    <input type="hidden" name="notify_url" value="https://secure.wincent.com/cgi-bin/paypal_ipn.pl">
                    <input type="hidden" name="item_name" value="Hextrapolate for Mac OS X 100 User License" />
                    <table>
                      <tr>
                        <td>Quantity:</td>
                        <td><input type="text" name="quantity" value="1" size="4" /></td>
          ...
          <h4><a id="kagi" name="kagi"></a>Purchase using Kagi</h4>
          ...
          <table align="center">
            <tr>
              ...
              <td align="center">9.95&euro;</td>
              <td>
                <form name="kagi1" id="kagi1" method="post" action="https://store.kagi.com/cgi-bin/store.cgi?storeID=3MJ_LIVE&amp;lang=en&amp;view=cart">
                  <input type="hidden" name="order/javascript" value="YES" /> 
                  <input type="submit" name="product/6709-1941-5860/0/quantity" value="Buy now" />
                </form>
              </td>
            </tr>
          </table>
          
          <div id="multiuser_label2"><h4><a href="#multiuser2">Discounted multi-user licenses &gt;&gt;</a></h4></div>
          <a id="multiuser2" name="multiuser2"></a>
          <div id="multiuser_table2">
            <table align="center">
              <tr>
                <td>5-User License</td>
                <td align="center">
                ...
                <td>
                  <form name="kagi2" id="kagi2" method="post" action="https://store.kagi.com/cgi-bin/store.cgi?storeID=3MJ_LIVE&amp;lang=en&amp;view=cart">
                    <input type="hidden" name="order/javascript" value="YES" /> 
                    <input type="submit" name="product/2603-4087-5018/0/quantity" value="Buy now" />
                  </form>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <form name="kagi3" id="kagi3" method="post" action="https://store.kagi.com/cgi-bin/store.cgi?storeID=3MJ_LIVE&amp;lang=en&amp;view=cart">
                    <input type="hidden" name="order/javascript" value="YES" /> 
                    <input type="submit" name="product/6060-7797-3181/0/quantity" value="Buy now" />
                  </form>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <form name="kagi4" id="kagi4" method="post" action="https://store.kagi.com/cgi-bin/store.cgi?storeID=3MJ_LIVE&amp;lang=en&amp;view=cart">
                    <input type="hidden" name="order/javascript" value="YES" /> 
                    <input type="submit" name="product/6410-1460-6415/0/quantity" value="Buy now" />
                  </form>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <form name="kagi5" id="kagi5" method="post" action="https://store.kagi.com/cgi-bin/store.cgi?storeID=3MJ_LIVE&amp;lang=en&amp;view=cart">
                    <input type="hidden" name="order/javascript" value="YES" /> 
                    <input type="submit" name="product/5776-0934-1977/0/quantity" value="Buy now" />
                  </form>
                </td>
              </tr>
              <tr>
                <td><a href="https://secure.wincent.com/s/kagi/">See all Kagi license types...</a></td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              </tr>
            </table>
