      ...
      <div id="center">
        <div class="content">
          ...
          <ul>
            <li>
              <a href="#characters"
                >Why doesn't Hextrapolate let me type the characters I want?</a
              >
            </li>
          </ul>
          ...
          <h4>
            <a id="characters" name="characters"></a>Why doesn't Hextrapolate
            let me type the characters I want?
          </h4>

          <p>
            Hextrapolate only allows you to enter characters that are valid for
            a given base (when typing in a number field) or which can be encoded
            losslessly in the selected text encoding (when typing in a text
            field). The list below shows the characters which are legal for the
            most common bases:
          </p>
          ...
          <p>
            One of the reasons Hextrapolate does not support bases greater than
            Base 36 is that this is the highest base that can be represented
            using the 26 letters of the Roman alphabet (a-z) in tandem with the
            numerals 0 through to 9. If we were to introduce a distinction
            between lower and uppercase letters then we could theoretically go
            as high as Base 62.
          </p>
