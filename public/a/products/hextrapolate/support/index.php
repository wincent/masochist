      ...
      <div id="center">
        <div class="content">
          ...
          <p>
            ...
            applies not only to Hextrapolate but to all other Wincent products
            and services.
          </p>
          ...
          <p>
            There are two Hextrapolate-related mailing lists that you can join:
          </p>

          <ul>
            <li>
              <em>hextrapolate-announce</em>: Hextrapolate announcements list
            </li>
