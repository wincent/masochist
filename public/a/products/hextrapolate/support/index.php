...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../../">Products</a>&nbsp;&gt;&nbsp;<a href="../">Hextrapolate</a>&nbsp;&gt;&nbsp;Support    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
      ...
      <div id="center">
        <div class="content">
          <h3>Hextrapolate support</h3>
          
          <p>The following support resources are available to you 24 hours a day, 365 days a year through this website.</p>
          
          <h4>Hextrapolate Frequently Asked Questions</h4>
          
          <p>The <a href="../faq/">FAQ</a> contains the answers to the most common Hextrapolate questions.</p>
          
          <p class="more">Click <a href="../faq/">here</a> to view the FAQ</p>
          
          <h4>Support pages</h4>
          
          <p>The <a href="http://www.wincent.com/a/support/">wincent.com support pages</a> group together all the support resources available to you from this website, as well as containing site-wide support information that applies not only to Hextrapolate but to all other Wincent products and services.</p>
          ...
          <p>There are two Hextrapolate-related mailing lists that you can join:</p>
          
          <ul>
            <li><em>hextrapolate-announce</em>: Hextrapolate announcements list</li>
            <li><em>hextrapolate-beta</em>: Hextrapolate beta testers list</li>
          </ul>
