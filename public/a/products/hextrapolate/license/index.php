...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <div style="text-align: center; font-family: 'Lucida Grande'; margin: 5px 250px 5px 250px; padding: 5px; font-size: x-small; border: 2px solid silver; -webkit-border-radius: 0.5em; -moz-border-radius: 0.5em; background: #fefefe;">
      ...
      <tr>
        ...
        <td style="background-image: url(/a/gfx/header/center-background.jpg); background-repeat: repeat;" colspan="11" align="center" valign="middle">          <!-- Begin: header content -->
          ...
          <img src="/a/gfx/hextrapolate-header.jpg" width="436" height="25" alt="Hextrapolate: the programmer's pal" align="middle" />
          <!-- End: header content -->
        </td>
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../../">Products</a>&nbsp;&gt;&nbsp;<a href="../">Hextrapolate</a>&nbsp;&gt;&nbsp;License    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
              ...
              <ul>
                <li><a href="http://www.wincent.com/a/products/hextrapolate/">Information</a></li>
                <li><a href="http://www.wincent.com/a/products/hextrapolate/download/">Download</a></li>
                <li><a href="https://secure.wincent.com/a/products/hextrapolate/purchase/">Purchase</a></li>
                <li><a href="http://www.wincent.com/a/products/hextrapolate/help/front_page.html">Help</a></li>
                <li><a href="http://www.wincent.com/a/products/hextrapolate/support/">Support</a></li>
                <li><a href="http://www.wincent.com/a/products/hextrapolate/history/">Version history</a></li>
                <li><a href="http://www.wincent.com/a/products/hextrapolate/faq/">Frequently Asked Questions</a></li>
                <li><a href="http://www.wincent.com/a/products/hextrapolate/credits/">Credits</a></li>
                <li><a href="http://www.wincent.com/a/products/hextrapolate/license/">License</a></li>
              </ul>
      ...
      <div id="center">
        <div class="content">
          ...
          <p>In order to install or use Hextrapolate you must read and agree to this license agreement in its entirety. This is a legal agreement between you, the end user, and Wincent, the developer of the software.</p>
          ...
          <p>You may not modify the software nor create derivative works based on the software, with the exception that you may make modifications to the LGPL-licensed GMP library to which Hextrapolate is linked. If you wish to make such modifications and relink them into Hextrapolate, you may require the Hextrapolate object files and these will be provided upon request.</p>
          ...
          <ul>
            <li><a href="http://www.wincent.com/a/products/hextrapolate/">http://www.wincent.com/a/products/hextrapolate/</a></li>
          </ul>
          ...
          <ul>
            <li><a href="http://www.wincent.com/a/products/hextrapolate/license/">http://www.wincent.com/a/products/hextrapolate/license/</a></li>
          </ul>
          
          <h4>Third-party licenses</h4>
          
          <p>Hextrapolate uses the <a href="http://www.swox.com/gmp/">GMP arbitrary precision arithmetic library</a> which is licensed under the <a href="http://www.gnu.org/copyleft/lesser.html">LGPL</a>. In accordance with subsection 6d of the license, a copy of the unmodified GMP source code used to compile the library for linking with Hextrapolate is available <a href="http://www.wincent.com/lgpl/">here</a>.</p>
