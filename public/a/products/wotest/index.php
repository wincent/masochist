...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <div style="text-align: center; font-family: 'Lucida Grande'; margin: 5px 250px 5px 250px; padding: 5px; font-size: x-small; border: 2px solid silver; -webkit-border-radius: 0.5em; -moz-border-radius: 0.5em; background: #fefefe;">
      ...
      <tr>
        ...
        <td style="background-image: url(/a/gfx/header/center-background.jpg); background-repeat: repeat;" colspan="11" align="center" valign="middle">          <!-- Begin: header content -->
          ...
          <img src="/a/gfx/wotest-header.jpg" width="387" height="25" alt="WOTest: integrated unit testing" align="middle" />
          <!-- End: header content -->
        </td>
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../">Products</a>&nbsp;&gt;&nbsp;Wotest    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
              <h2>WOTest links</h2>
              <ul>
                <li><a href="http://www.wincent.com/a/products/wotest/">Information</a></li>
                <li><a href="http://www.wincent.com/a/support/forums/ubbthreads.php?ubb=postlist&amp;Board=13&amp;page=1">Discussion & support forums</a></li>
                <li><a href="http://lists.wincent.com/mailman/listinfo/test-announce">Mailing list</a></li>
              ...
              <p align="center"><a href="http://www.apple.com/macosx/"><img src="http://www.wincent.com/a/gfx/tiger-compatible.jpg" width="128" height="128" alt="Tiger Compatible" border="0" /></a></p>
        </div>
      </div>
      <div id="center">
        <div class="content">
          ...
          <p>WOTest is an Objective-C unit testing framework that integrates with Apple's Xcode 2.1 or later. It was developed "in house" and is used in the development of all Wincent products.</p>
          
          <p>There are already a number of unit testing frameworks available and several support Objective-C. None of these was a perfect match for my needs so WOTest was developed to meet the following specific design requirements:</p>
          
          <ul>
            <li>Unit testing should be an automatic part of the build process.</li>
            <li>Unit testing should be fully integrated with Xcode.</li>
            <li>Adding unit testing to a new product should be extremely simple.</li>
            <li>The code which is unit tested should be the exact same code (bit for bit) that gets shipped to the customer.</li>
            <li>The customer should be able to run the unit tests on his or her local system if desired.</li>
            <li>The unit test framework should not impose a memory or performance penalty on those customers who do not wish to run the tests.</li>
          </ul>
          
          <p>These requirements lead to a simple design; WOTest is a single framework bundle that contains all the components necessary to perform unit testing on frameworks, bundles or applications. It is not necessary to link to the WOTest framework in order to use it, which means that customers who do not wish to run the unit tests do not see an increased memory footprint nor any reduction in performance. Likewise it is not necessary to install the framework before using it (although you may wish to embed it inside your own application or framework bundle). The WOTest framework bundle contains the WOTestRunner tool for easy testing of stand-alone frameworks and bundles, and macros for triggering the unit testing process from within your own applications.</p>
          
          <h4><a id="donations" name="donations"></a>Donations</h4>
          
          <p>WOTest is free software released under the GPL license. If it is useful to you, please consider making a <a href="https://www.paypal.com/xclick/business=win@wincent.com&amp;item_name=WOTest+donation&amp;no_note=1&amp;currency_code=EUR&amp;lc=GB">donation</a>.</p>
          ...
          <h4><a id="status" name="status"></a>Project status</h4>
          
          <p>WOTest is in daily use in the development of Wincent products but to date there has been no official public release and no support is available. The following tasks are still pending:</p>
          
          <ul>
            <li>Complete documentation</li>
            <li>Mock object rewrite using alternative (non-HOM) syntax</li>
            <li>Complete test suite</li>
          </ul>
          
          <h5><a id="download" name="download"></a>Download</h5>
          
          <p>You can check out the latest version of the source via Subversion; for example, to check out into a directory named <tt>WOTest</tt>:</p>
          
          <pre>svn co svn://svn.wincent.com/WOTest/trunk WOTest</pre>
          
          <p>To build WOTest the <a href="../buildtools">Wincent Build Tools</a>, also licensed under the GPL, are required:</p>
          ...
          <ul>
            <li>First public availability</li>
          </ul>
