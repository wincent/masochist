    ...
    >
      ...
      <tr>
        ...
        >
          ...
          /></a>
          <img
            src="/a/gfx/wotest-header.jpg"
            width="387"
            height="25"
            alt="WOTest: integrated unit testing"
            align="middle"
          />
          <!-- End: header content -->
        </td>
    ...
    <div id="container">
      <div id="left">
        <div class="sidebar">
          ...
          <ul>
            <li>
              <a href="https://wincent.com/a/products/wotest/">Information</a>
            </li>
            <li>
              <a
                href="https://wincent.com/a/support/forums/ubbthreads.php?ubb=postlist&amp;Board=13&amp;page=1"
                >Discussion & support forums</a
              >
            </li>
            <li>
              <a href="http://lists.wincent.com/mailman/listinfo/test-announce"
                >Mailing list</a
              >
            </li>
            <li>
      ...
      <div id="center">
        <div class="content">
          ...
          <p>
            WOTest is an Objective-C unit testing framework that integrates with
            Apple's Xcode 2.1 or later. It was developed "in house" and is used
            in the development of all Wincent products.
          </p>

          <p>
            There are already a number of unit testing frameworks available and
            several support Objective-C. None of these was a perfect match for
            my needs so WOTest was developed to meet the following specific
            design requirements:
          </p>
          ...
          <ul>
            ...
            <li>
              The code which is unit tested should be the exact same code (bit
              for bit) that gets shipped to the customer.
            </li>
            <li>
              The customer should be able to run the unit tests on his or her
              local system if desired.
            </li>
            <li>
              The unit test framework should not impose a memory or performance
              penalty on those customers who do not wish to run the tests.
            </li>
          </ul>

          <p>
            These requirements lead to a simple design; WOTest is a single
            framework bundle that contains all the components necessary to
            perform unit testing on frameworks, bundles or applications. It is
            not necessary to link to the WOTest framework in order to use it,
            which means that customers who do not wish to run the unit tests do
            not see an increased memory footprint nor any reduction in
            performance. Likewise it is not necessary to install the framework
            before using it (although you may wish to embed it inside your own
            application or framework bundle). The WOTest framework bundle
            contains the WOTestRunner tool for easy testing of stand-alone
            frameworks and bundles, and macros for triggering the unit testing
          ...
          <p>
            WOTest is in daily use in the development of Wincent products but to
            date there has been no official public release and no support is
            available. The following tasks are still pending:
          </p>
