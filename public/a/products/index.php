...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <div style="text-align: center; font-family: 'Lucida Grande'; margin: 5px 250px 5px 250px; padding: 5px; font-size: x-small; border: 2px solid silver; -webkit-border-radius: 0.5em; -moz-border-radius: 0.5em; background: #fefefe;">
      ...
      <tr>
        ...
        <td style="background-image: url(/a/gfx/header/center-background.jpg); background-repeat: repeat;" colspan="11" align="center" valign="middle">          <!-- Begin: header content -->
          ...
          <img src="/a/gfx/products-header.jpg" width="384" height="24" alt="Wincent: software for your Mac" align="middle" />
          <!-- End: header content -->
        </td>
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;Products    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
              ...
              <ul>
                <li>
                  ...
                  <p class="more">Current version: <a href="http://www.wincent.com/a/products/synergy-classic/history/">4.1a</a></p>
                </li>
                <li>
                  <a href="http://www.wincent.com/a/products/synergy-advance/">Synergy Advance</a>
                  <p class="more">Current version: <a href="http://www.wincent.com/a/products/synergy-advance/history/">0.5.1b</a></p>
                </li>
                <li>
                  <a href="http://www.wincent.com/a/products/renamer/">REnamer</a>
                  <p class="more">Current version: in development</p>
                </li>
                <li>
                  <a href="http://www.wincent.com/a/products/winswitch/">WinSwitch</a>
                  <p class="more">Current version: <a href="http://www.wincent.com/a/products/winswitch/history/">3.2.1</a></p>
                </li>
                <li>
                  <a href="http://www.wincent.com/a/products/getsmart-pro/">GetSmart Pro</a>
                  <p class="more">Current version: in development</p>
                </li>
              </ul>
              ...
              <ul>
                <li>
                  <a href="http://www.wincent.com/a/products/install/">Install</a>
                  <p class="more">Current version: <a href="http://www.wincent.com/a/products/install/history/">1.3.1</a></p>
                </li>
                <li>
                  <a href="http://www.wincent.com/a/products/hextrapolate/">Hextrapolate</a>
                  <p class="more">Current version: <a href="http://www.wincent.com/a/products/hextrapolate/history/">2.0</a></p>
                </li>
                <li>
                  <a href="http://www.wincent.com/a/products/wotest/">WOTest</a>
                  <p class="more">Current version: <a href="http://www.wincent.com/a/products/wotest/">r102</a></p>
                </li>
                <li>
                  <a href="http://www.wincent.com/a/products/wincent-strings-util/">Wincent Strings Utility</a>
                  <p class="more">Current version: <a href="http://www.wincent.com/a/products/wincent-strings-util/">2.0.1</a></p>
                </li>
                <li>
                  <a href="http://www.wincent.com/a/products/atosym/">atosym</a>
                  <p class="more">Current version: <a href="http://www.wincent.com/a/products/atosym/">1.0</a></p>
                </li>
                <li>
                  <a href="http://www.wincent.com/a/products/buildtools/">buildtools</a>
                  <p class="more">Current version: <a href="http://www.wincent.com/a/products/buildtools/">r35</a></p>
                </li>
                <li>
                  <a href="http://walrus.wincent.com/">Walrus</a>
                  <p class="more">Current version: <a href="http://walrus.wincent.com/">0.1</a></p>
                </li>
              </ul>
              ...
              <ul>
                <li>
                  <a href="http://www.wincent.com/a/products/bansshee/">Bansshee</a>
                  <p class="more">Current version: <a href="http://www.wincent.com/a/products/Bansshee/">1.0.1</a></p>
                </li>
              </ul>
      ...
      <div id="center">
        <div class="content">
          ...
          <h3>Wincent products</h3>
          
          <h4>Synergy</h4>
          
          <a href="https://wincent.com/products/synergy"><img style="float:left; margin: 20px; " src="http://www.wincent.com/a/gfx/synergy-classic-icon-medium.png" alt="Synergy icon" width="64" height="64" /></a>
          
          <p>The innovative iTunes controller puts you in instant control of your listening from any application thanks to its always-accesible menu bar buttons and user-definable hot keys.</p>
          
          <p><a href="https://wincent.com/products/synergy">Synergy</a> seamlessly integrates with iTunes, providing you with realtime feedback on the currently playing track even when iTunes is hidden. It can automatically locate album cover art from the Internet and download it to your computer while you listen. Under ongoing development since its initial release in 2002, Synergy boasts and <a href="https://wincent.com/products/synergy/about">impressive featureset</a>. Take it <a href="https://wincent.com/products/synergy">for a spin</a> today!</p>
          
          <ul>
            <li><a href="https://wincent.com/products/synergy">Synergy product pages</a></li>
            <li><a href="https://wincent.com/products/synergy/download">Download</a></li>
            <li><a href="https://secure.wincent.com/a/support/registration/">Recover lost license codes</a></li>
            <li><a href="synergy-classic/buttons/">Free button sets</a></li>
            <li><a href="https://secure.wincent.com/a/products/synergy-classic/purchase/">Purchase</a></li>
          </ul>
          
          <h4>Synergy Advance</h4>
          
          <a href="synergy-advance/"><img style="float:left; margin: 20px; " src="http://www.wincent.com/a/gfx/synergy-advance-icon.jpg" alt="Synergy Advance icon" width="64" height="64" /></a>
          <p>Now in public preview testing, this is Synergy's big brother, written from scratch to take advantage of Apple's latest technologies. Synergy Advance will be the ultimate addition to your audio-listening experience, picking up where its little brother leaves off and providing an additional battery of useful features that will help you to work smarter, not harder. With a massive feature-set, Synergy Advance has plenty of pleasant surprises in store which will provide you with new ways to interact with your music, both listening to it and managing it.</p>
          
          <ul>
            <li><a href="synergy-advance/">Synergy Advance product pages</a></li>
            <li><a href="synergy-advance/download/">Download preview release</a></li>
            <li><a href="http://secure.wincent.com/a/products/synergy-advance/purchase/">Purchase</a></li>
            <li><a href="http://secure.wincent.com/a/products/synergy-advance/donate/">Support development</a> with a donation</li>
            <li><a href="../support/lists/">Join the beta testers mailing list</a></li>
            <li><a href="../support/lists/">Join the announcements mailing list</a></li>
          </ul>
          
          <h4>REnamer</h4>
          
          <a href="renamer/"><img style="float:left; margin: 20px; " src="http://www.wincent.com/a/gfx/renamer-icon.png" alt="Synergy Advance icon" width="64" height="64" /></a>
          <p>Rename multiple files at once, painlessly, using the familiar "Find and Replace" metaphor which you already know. Unlock the power of regular expressions to identify patterns in your filenames and transform them. All of this with an elegant, easy-to-use interface that gives you a live preview of what changes will be made to your file system.</p>
          
          <ul>
            <li><a href="renamer/">REnamer product pages</a> (including sneak preview screencast)</li>
            <li><a href="../support/lists/">Join the beta testers mailing list</a></li>
            <li><a href="../support/lists/">Join the announcements mailing list</a></li>
          </ul>
          ...
          <a href="winswitch/"><img style="float:left; margin: 20px; " src="http://www.wincent.com/a/gfx/winswitch-icon-medium.jpg" alt="WinSwitch icon" width="64" height="64" /></a>
          <p>Apple did a superb job with its new Fast User Switching feature in Panther (Mac OS X 10.3), but for users with long names, the associated menu item is a terrible waste of precious Menu Bar real estate. WinSwitch fixes that and brings a number of other powerful features that are not available on other Panther or Tiger (Mac OS X 10.4).</p>
          
          <img style="float:right; margin: 20px; " src="../gfx/winswitch-preview.gif" alt="WinSwitch preview" width="57" height="44" />
          <p>Wouldn't it be nice if you could access the feature through a compact, icon-sized Menu Bar icon? <a href="winswitch/">WinSwitch</a> does exactly that, closely matching the performance and style of the Apple-provided menu, but without all the bulk. It can display a generic icon in the menu bar (as shown), your user picture, or the full or short username. You can customize the display size of your user picture in the menu bar, separately set the size of pictures inside the menu itself, set a hot key to jump back to the login window, or elect to show the "root" user as well, <a href="winswitch/">among many other features</a>.</p>
          
          <ul>
            <li><a href="winswitch/">WinSwitch product pages</a></li>
            <li><a href="winswitch/download/">Download</a></li>
            <li><a href="https://secure.wincent.com/a/products/winswitch/donate/">Support development with a donation</a></li>
          </ul>
          
          <h4>Install</h4>
          
          <a href="install/"><img style="float:left; margin: 20px; " src="http://www.wincent.com/a/gfx/install-icon-medium.jpg" alt="Install icon" width="64" height="64" /></a>
          <p>A robust, easy-to-use alternative to Apple's own Installer application, <a href="install/">Install</a> provides developers with all the power needed to deploy software on Mac OS X, but conveniently bypasses the need to assemble package files and write installation scripts.</p>
          
          <p>Your users will find installing your software a breeze, and you'll save yourself valuable time by not having to answer "How do I install?" queries.</p>
          
          <p>Install is easily configured through a single XML property list, and custom user interface elements and text can be inserted using RTF documents.</p>
          
          <p>Install can neatly handle all the "pre-flight" details of an installation, such as gracefully exiting target applications, moving items to the Trash, or deleting files and folders. It can install with or without root privileges, and for the current user or all users on a target machine. And if your users decide they'd like to remove your software, Install can handle that as well.</p>
          
          <ul>
            <li><a href="install/">Install product pages</a></li>
          </ul>
          
          <h4>Hextrapolate</h4>
          
          <a href="hextrapolate/"><img style="float:left; margin: 20px; " src="http://www.wincent.com/a/gfx/winhex-icon-medium.jpg" alt="Hextrapolate icon" width="64" height="64" /></a>
          <p><a href="hextrapolate/">Hextrapolate</a> (formerly WinHex) is a powerful number conversion utility with an interface so intuitive that you'll never even think of reading the instructions.</p>
          
          <p>Programmers will find that Hextrapolate's compact, uncluttered window provides the best means to instantly convert between hexadecimal, decimal, octal, binary and string representations, and go much further... Unlike other conversion applications, Hextrapolate isn't limited to 32 or 64 bit numbers; you can go as far as your system resources will allow, even to numbers that are thousands of bits in size. And similarly, feel free to stretch beyond the common bases and play with any base from 2 to 36 inclusive.</p>
          
          <ul>
            <li><a href="hextrapolate/">Hextrapolate product pages</a></li>
            <li><a href="hextrapolate/download/">Download</a></li>
            <li><a href="https://secure.wincent.com/a/products/hextrapolate/purchase/">Purchase</a></li>
          </ul>
          
          <h4>WOTest</h4>
          
          <a href="wotest/"><img style="float:left; margin: 20px; " src="http://www.wincent.com/a/gfx/framework-icon.jpg" alt="WOTest" width="64" height="64" /></a>
          <p>A lightweight, robust unit testing framework for Objective-C that fully integrates with Apple's Xcode (2.1 or later). WOTest was designed to be the easiest to use, most flexible and most robust unit testing framework available for Objective-C on Mac OS X. WOTest is currently being used internally but if enough developers express an interest it will be released under the terms of the GPL.</p>
          
          <ul>
            <li><a href="wotest/">WOTest product page</a></li>
          </ul>
          
          <h4>GetSmart Pro</h4>
          
          <a href="getsmart-pro/"><img style="float:left; margin: 20px; " src="http://www.wincent.com/a/gfx/coming-soon-icon-medium.jpg" alt="Coming soon" width="64" height="64" /></a>
          <p>When you're on the net you want to be able to "get stuff" without worrying about it the technical details.</p>
          
          <p>You want the simplicity of a drag-and-drop interface, but you also want to be able to get "under the hood" when you need to exercise finer control. You want to easily manipulate the settings for multiple downloads, <em>en masse</em>, and most importantly of all, you want a rock-solid platform that you know you can entrust your downloads to when you're not around.</p>
          
          <p><a href="getsmart-pro">GetSmart Pro</a> delivers all this and more in a sophisticated, powerful and robust download manager unlike any you've seen, on any platform.</p>
          
         <p>With an enormous feature set, a superbly thought-out and implemented user interface, excellent OS- and application-level integration, and industrial dependability, GetSmart Pro significantly raises the bar.</p>
          
          <ul>
            <li><a href="getsmart-pro/">GetSmart Pro product pages</a></li>
            <li><a href="http://secure.wincent.com/a/products/getsmart-pro/donate/">Support development</a> with a donation</li>
            <li><a href="../support/lists/">Join the beta testers mailing list</a></li>
            <li><a href="../support/lists/">Join the announcements mailing list</a></li>
          </ul>
