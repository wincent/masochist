...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <div id="breadcrumbs">
    <p><a href="https://wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../../">Products</a>&nbsp;&gt;&nbsp;<a href="../">Walrus</a>&nbsp;&gt;&nbsp;Wopen3    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
              ...
              <ul>
                ...
                <li><a href="https://wincent.com/a/products/walrus/#donations">Donations</a></li>
                <li><a href="https://wincent.com/a/products/walrus/#download">Download</a></li>
              </ul>
        </div>
      </div>
      <div id="center">
        <div class="content">
          ...
          <p>Wopen3 is a free replacement (released under the <a href="https://wincent.com/knowledge-base/GPL">GPL</a>) for Open3 in the <a href="https://wincent.com/knowledge-base/Ruby_Standard_Library">Ruby Standard Library</a>. Unlike Open3, Wopen3 does not throw away the exit code of the executed (grandchild) process. Only a child process is spawned and the exit status is returned in <tt>$?</tt> as normal.</p>
          
          <p>Wopen3 is part of <a href="http://walrus.wincent.com/">Walrus</a>, distributed as a separate <a href="https://wincent.com/knowledge-base/Gem">gem</a> for easy reuse.</p>
          
          <h4>Downloading from RubyForge</h4>
          
          <p>See the RubyForge <a href="http://rubyforge.org/frs/?group_id=3348">file listing</a>.</p>
          
          <p>To install using RubyGems:</p>
          
          <pre>sudo gem install wopen3</pre>
          
          <h4>Obtaining via Git</h4>
          
          <pre>git clone git://git.wincent.com/wopen3.git</pre>
          
          <h4>Browsing the Git source repository</h4>
          
          <p>The source code repository can be explored in a browser using the <a href="http://git.wincent.com/wopen3.git">the web interface</a>.</p>
