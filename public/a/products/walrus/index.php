...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <div style="text-align: center; font-family: 'Lucida Grande'; margin: 5px 250px 5px 250px; padding: 5px; font-size: x-small; border: 2px solid silver; -webkit-border-radius: 0.5em; -moz-border-radius: 0.5em; background: #fefefe;">
      ...
      <tr>
        ...
        <td style="background-image: url(/a/gfx/header/center-background.jpg); background-repeat: repeat;" colspan="11" align="center" valign="middle">          <!-- Begin: header content -->
          ...
          <img src="/a/gfx/walrus-header.jpg" width="441" height="25" alt="Walrus: object-oriented templating" align="middle" />
          <!-- End: header content -->
        </td>
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../">Products</a>&nbsp;&gt;&nbsp;Walrus    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
              <h2>Walrus links</h2>
              <ul>
                <li><a href="http://www.wincent.com/a/products/walrus/">Information</a></li>
              </ul>
              <h2>On this page</h2>
              <ul>
              ...
              <h2>Subprojects</h2>
              <ul>
                <li><a href="wopen3/">Wopen3</a></li>
              </ul>
              <h2>RubyForge</h2>
              <ul>
                <li><a href="http://rubyforge.org/projects/walrus/">Project page</a></li>
              </ul>
      ...
      <div id="center">
        <div class="content">
          ...
          <p>Walrus is a free Object-Oriented templating engine written in <a href="http://www.wincent.com/knowledge-base/Ruby">Ruby</a> and licensed under the <a href="http://www.wincent.com/knowledge-base/GPL">GPL</a>. Plain text templates are compiled down to Ruby code; final output is produced by executing ("filling") the compiled templates. A <tt>walrus</tt> commandline tool is included to make compiling and filling templates easy. Walrus includes a sophisticated parser generator that can make packrat parsers capable of recognizing Parsing Expression Grammars (including grammars that include left-recursion), and outputting arbitrarily complex Abstract Syntax Trees.</p>
          
          <p>Walrus was inspired by the <a href="http://www.wincent.com/knowledge-base/Cheetah_%28template_engine%29">Cheetah</a> template engine written in Python.</p>
          
          <p>For more information about Walrus see these articles published during its development:</p>
          ...
          <p>Walrus is free software released under the GPL license. If it is useful to you, please consider making a <a href="https://www.paypal.com/xclick/business=win@wincent.com&amp;item_name=Walrus+donation&amp;no_note=1&amp;currency_code=EUR&amp;lc=GB">donation</a>.</p>
          
          <h4><a id="download" name="download"></a>Downloading from RubyForge</h4>
          
          <p>See the RubyForge <a href="http://rubyforge.org/frs/?group_id=3348">file listing</a>.</p>
          
          <p>To install using RubyGems:</p>
          
          <pre>sudo gem install walrus</pre>
          ...
          <p>The source code repository can be explored in a browser using the <a href="http://git.wincent.com/Walrus.git">the web interface</a>.</p>
          
          <h4>Obtaining via Subversion</h4>
          
          <pre>svn co svn://svn.wincent.com/Walrus/trunk</pre>
          
          <p><strong>Note:</strong> All new development work is managed in the Git repository; the Subversion repository is being left on line for historical reasons only.</p>
          
          <h4>Building from source</h4>
          
          <p>Before using Walrus you must build the C extensions upon which it depends; you can do this from inside the root of the source tree by executing the following:</p>
          
          <pre>rake make</pre>
          
          <p>You can run the specs by doing the following:</p>
          
          <pre>rake spec</pre>
          
          <p><a href="feed://wincent.com/a/about/wincent/weblog/svn-log/atom.xml">An XML feed</a> showing recent commits to the repository is also available (<a href="http://www.wincent.com/s/progress/">more information</a>).</p>
