    ...
    >
      ...
      <tr>
        ...
        >
          ...
          /></a>
          <img
            src="/a/gfx/walrus-header.jpg"
            width="441"
            height="25"
            alt="Walrus: object-oriented templating"
            align="middle"
          />
          <!-- End: header content -->
        </td>
    ...
    <div id="container">
      <div id="left">
        <div class="sidebar">
          ...
          <ul>
            <li>
              <a href="https://wincent.dev/a/products/walrus/">Information</a>
            </li>
          </ul>
          <h2>On this page</h2>
          <ul>
          ...
          <ul>
            <li>
              <a href="http://rubyforge.org/projects/walrus/">Project page</a>
            </li>
          </ul>
        </div>
      </div>
      <div id="center">
        <div class="content">
          ...
          <p>
            ...
            <a href="https://wincent.dev/wiki/Ruby">Ruby</a> and
            licensed under the
            <a href="https://wincent.dev/wiki/GPL">GPL</a>. Plain text
            ...
            filling templates easy. Walrus includes a sophisticated parser
            generator that can make packrat parsers capable of recognizing
            Parsing Expression Grammars (including grammars that include
            left-recursion), and outputting arbitrarily complex Abstract Syntax
            Trees.
          </p>
          ...
          <p>
            ...
            <a
              href="https://wincent.dev/wiki/Cheetah_%28template_engine%29"
              >Cheetah</a
            >
          ...
          <p>
            For more information about Walrus see these articles published
          ...
          <h4>
            <a id="download" name="download"></a>Downloading from RubyForge
          </h4>

          <p>
            See the RubyForge
            <a href="http://rubyforge.org/frs/?group_id=3348">file listing</a>.
          </p>
          ...
          <pre>git clone git://git.wincent.dev/Walrus.git</pre>

          <h4>Building from source</h4>

          <p>
            Before using Walrus you must build the C extensions upon which it
            depends; you can do this from inside the root of the source tree by
