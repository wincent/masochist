...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Install: Special binary-only license</title>
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../../../">Products</a>&nbsp;&gt;&nbsp;<a href="../../">Install</a>&nbsp;&gt;&nbsp;<a href="../">Licensing</a>&nbsp;&gt;&nbsp;Special Binary License    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
      ...
      <div id="center">
        <div class="content">
          ...
          <h3>Special binary-only license for use with free software(in full)</h3>
          ...
          <p>Subject to the terms and conditions of this Agreement, Wincent grants to You a non-exclusive, non-assignable, non-transferable, worldwide, fully-paid up copyright license to copy the Software and distribute a maximum of one (1) copy of the Software, solely in executable form, solely with each unit of Your product for the sole purpose of deploying that product (&quot;Your Product&quot;). In order to qualify for this license the deployed product and all of its components must be either "freeware" (defined as software which is not only free of charge, but for which even voluntary payment or donations are not requested) or "open source" (defined as software that is licensed under one of the approved licenses: the GNU GPL, GNU LGPL or the BSD license). Deployed products which are considered ineligible for this license include, but are not limited to, "shareware", "donationware", and otherwise "commerical" software.</p>
