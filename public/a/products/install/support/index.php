...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../../">Products</a>&nbsp;&gt;&nbsp;<a href="../">Install</a>&nbsp;&gt;&nbsp;Support    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
      ...
      <div id="center">
        <div class="content">
          ...
          <h4>Install Frequently Asked Questions</h4>
          
          <p>The <a href="../faq/">FAQ</a> contains the answers to the most common Install questions.</p>
          
          <p class="more">Click <a href="../faq/">here</a> to view the FAQ</p>
          
          <h4>Install manual</h4>
          
          <p>The Install manual, <a href="../download/">available on the download page</a>, is a detailed technical reference containing information about every aspect of the configuration and operation of Install.</p>
          
          <p class="more">Click <a href="../download/">here</a> to go to the download page</p>
          
          <h4>Support pages</h4>
          
          <p>The <a href="http://www.wincent.com/a/support/">wincent.com support pages</a> group together all the support resources available to you from this website, as well as containing site-wide support information that applies not only to Install but to all other Wincent products and services.</p>
          ...
          <p>There are two Install-related mailing lists that you can join:</p>
          
          <ul>
            <li><em>install-announce</em>: Install announcements list</li>
            <li><em>install-beta</em>: Install beta testers list</li>
          </ul>
