    ...
    <div id="container">
      ...
      <div id="center">
        <div class="content">
          ...
          <p>
            The Install manual,
            <a href="../download/">available on the download page</a>, is a
            detailed technical reference containing information about every
            aspect of the configuration and operation of Install.
          </p>

          <p class="more">
            Click <a href="../download/">here</a> to go to the download page
          </p>
          ...
          <p>
            ...
            applies not only to Install but to all other Wincent products and
            services.
          </p>
