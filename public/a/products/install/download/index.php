    ...
    <div id="container">
      ...
      <div id="center">
        <div class="content">
          ...
          <p>
            If you do, then you can proceed directly to the
            <a href="https://wincent.com/a/products/install/licensees/"
              >licensees downloads area</a
            >. You'll need the username and password that were supplied to you
          ...
          <h4>
            ...
            <a
              href="https://wincent.com/download.php?item=Install_Binary_Manual.pdf"
              ><img
                style="float:right;"
          ...
          <p>
            One way of learning about Install's capabilities is to download the
            <a
              href="https://wincent.com/download.php?item=Install_Binary_Manual.pdf"
              >Install Binary Manual</a
            >
            (PDF, 724KB, 55 pages).
          </p>

          <p>
            Looking at <a href="../screenshots/">screenshots</a> is one way to
            see Install in action, but taking it for a test drive is that much
            better. The following commercially released applications use Install
            as their deployment solution. You can download demonstration
            versions of the software to see for yourself how well Install
            performs:
          </p>

          <ul>
            <li>
              <strong>Default Folder X</strong>: Enhancement for open/save
              dialog boxes
              <ul>
                <li>
                  <a href="http://www.stclairsoft.com/"
                    >St Clair Software company page</a
                  >
                </li>
                <li>
                  <a href="http://www.stclairsoft.com/DefaultFolderX/index.html"
                    >Default Folder X product information</a
                  >
                </li>
                <li>
                  <a href="http://www.stclairsoft.com/Main/download.html"
                    >Default Folder X download page</a
                  >
                </li>
              </ul>
            </li>
          ...
          <ul>
            <li>
              <strong>FlickrExport for Aperture</strong>: Flickr Export Plug-in
              for Aperture
              <ul>
                <li>
                  <a href="http://connectedflow.com/"
                    >Connected Flow company page</a
                  >
                </li>
                <li>
                  <a href="http://connectedflow.com/flickrexport/aperture/"
                    >FlickrExport for Aperture product information</a
                  >
                </li>
                <li>
                  <a href="http://connectedflow.com/flickrexport/aperture/"
                    >FlickrExport for Aperture download page</a
                  >
                </li>
              </ul>
            </li>
          ...
          <ul>
            <li>
              <strong>FlickrExport for iPhoto</strong>: Flickr Export Plug-in
              for iPhoto
              <ul>
                <li>
                  <a href="http://connectedflow.com/"
                ...
                <li>
                  <a href="http://connectedflow.com/flickrexport/iphoto"
                    >FlickrExport for iPhoto product information</a
                  >
                </li>
                <li>
                  <a href="http://connectedflow.com/flickrexport/iphoto"
                    >FlickrExport for iPhoto download page</a
                  >
                </li>
              </ul>
            </li>
          ...
          <ul>
            <li>
              <strong>Aperture to Final Cut Pro</strong>: Export Plug-in for
              Aperture
              <ul>
                <li>
                  <a href="http://connectedflow.com/"
                ...
                <li>
                  <a href="http://connectedflow.com/aperturetofinalcut"
                    >Aperture to Final Cut Pro product information</a
                  >
                </li>
                <li>
                  <a href="http://connectedflow.com/aperturetofinalcut"
                    >Aperture to Final Cut Pro download page</a
                  >
                </li>
              </ul>
            </li>
          ...
          <ul>
            <li>
              ...
              <ul>
                ...
                <li>
                  <a href="https://wincent.com/download.php?item=Synergy.dmg"
                    >Synergy download</a
                  >
                </li>
              </ul>
          ...
          <p>
            ...
            <a href="https://wincent.com/a/contact/mail/">contact me</a> if
            you'd like to obtain a copy of Install for trial purposes.
          </p>
        </div>
      </div>
      <div id="right">
