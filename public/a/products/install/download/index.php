...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../../">Products</a>&nbsp;&gt;&nbsp;<a href="../">Install</a>&nbsp;&gt;&nbsp;Download    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
      ...
      <div id="center">
        <div class="content">
          ...
          <h3>Downloads and testdrives</h3>
          
          <h4>Do you already have a license for Install?</h4>
          
          <p>If you do, then you can proceed directly to the <a href="https://secure.wincent.com/a/products/install/licensees/">licensees downloads area</a>. You'll need the username and password that were supplied to you when you purchased the license.</p>
          
          <h4>Not a license-holder? <a href="http://www.wincent.com/download.php?item=Install_Binary_Manual.pdf"><img style="float:right;" src="/a/gfx/download.jpg" alt="Download" width="80" height="32" /></a></h4>
          
          <p>One way of learning about Install's capabilities is to download the <a href="http://www.wincent.com/download.php?item=Install_Binary_Manual.pdf">Install Binary Manual</a> (PDF, 724KB, 55 pages).</p>
          
          <p>Looking at <a href="../screenshots/">screenshots</a> is one way to see Install in action, but taking it for a test drive is that much better. The following commercially released applications use Install as their deployment solution. You can download demonstration versions of the software to see for yourself how well Install performs:</p>
          
          <ul>
            <li><strong>Default Folder X</strong>: Enhancement for open/save dialog boxes
              <ul>
                <li><a href="http://www.stclairsoft.com/">St Clair Software company page</a></li>
                <li><a href="http://www.stclairsoft.com/DefaultFolderX/index.html">Default Folder X product information</a></li>
                <li><a href="http://www.stclairsoft.com/Main/download.html">Default Folder X download page</a></li>
              </ul>
            </li>
          </ul>
          
          <ul>
            <li><strong>FlickrExport for Aperture</strong>: Flickr Export Plug-in for Aperture
              <ul>
                <li><a href="http://connectedflow.com/">Connected Flow company page</a></li>
                <li><a href="http://connectedflow.com/flickrexport/aperture/">FlickrExport for Aperture product information</a></li>
                <li><a href="http://connectedflow.com/flickrexport/aperture/">FlickrExport for Aperture download page</a></li>
              </ul>
            </li>
          </ul>
          
          <ul>
            <li><strong>FlickrExport for iPhoto</strong>: Flickr Export Plug-in for iPhoto
              <ul>
                <li><a href="http://connectedflow.com/">Connected Flow company page</a></li>
                <li><a href="http://connectedflow.com/flickrexport/iphoto">FlickrExport for iPhoto product information</a></li>
                <li><a href="http://connectedflow.com/flickrexport/iphoto">FlickrExport for iPhoto download page</a></li>
              </ul>
            </li>
          </ul>
          
          <ul>
            <li><strong>Aperture to Final Cut Pro</strong>: Export Plug-in for Aperture
              <ul>
                <li><a href="http://connectedflow.com/">Connected Flow company page</a></li>
                <li><a href="http://connectedflow.com/aperturetofinalcut">Aperture to Final Cut Pro product information</a></li>
                <li><a href="http://connectedflow.com/aperturetofinalcut">Aperture to Final Cut Pro download page</a></li>
              </ul>
            </li>
          </ul>
          
          <ul>
            <li><strong>Synergy</strong>: iTunes menubar control, hot keys, cover art display
              <ul>
                <li><a href="http://www.wincent.com/">Wincent company page</a></li>
                <li><a href="http://synergy.wincent.com/">Synergy product information</a></li>
                <li><a href="http://www.wincent.com/download.php?item=Synergy.dmg">Synergy download</a></li>
              </ul>
            </li>
          </ul>
          <ul>
            <li><strong>WinSwitch</strong>: Menu enhancement for Panther's Fast User Switching
              <ul>
                <li><a href="http://www.wincent.com/">Wincent company page</a></li>
                <li><a href="http://winswitch.wincent.com/">WinSwitch product information</a></li>
                <li><a href="http://www.wincent.com/download?item=WinSwitch.dmg">WinSwitch download</a></li>
              </ul>
            </li>
          </ul>
          
          <p>You are also welcome to <a href="http://www.wincent.com/a/contact/mail/">contact me</a> if you'd like to obtain a copy of Install for trial purposes.</p>
