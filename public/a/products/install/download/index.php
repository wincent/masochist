...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <div id="breadcrumbs">
    <p><a href="https://wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../../">Products</a>&nbsp;&gt;&nbsp;<a href="../">Install</a>&nbsp;&gt;&nbsp;Download    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
      ...
      <div id="center">
        <div class="content">
          ...
          <p>If you do, then you can proceed directly to the <a href="https://wincent.com/a/products/install/licensees/">licensees downloads area</a>. You'll need the username and password that were supplied to you when you purchased the license.</p>
          
          <h4>Not a license-holder? <a href="https://wincent.com/download.php?item=Install_Binary_Manual.pdf"><img style="float:right;" src="/a/gfx/download.jpg" alt="Download" width="80" height="32" /></a></h4>
          
          <p>One way of learning about Install's capabilities is to download the <a href="https://wincent.com/download.php?item=Install_Binary_Manual.pdf">Install Binary Manual</a> (PDF, 724KB, 55 pages).</p>
          ...
          <ul>
            <li><strong>Synergy</strong>: iTunes menubar control, hot keys, cover art display
              <ul>
                ...
                <li><a href="https://wincent.com/download.php?item=Synergy.dmg">Synergy download</a></li>
              </ul>
            </li>
          </ul>
          <ul>
            <li><strong>WinSwitch</strong>: Menu enhancement for Panther's Fast User Switching
              <ul>
                ...
                <li><a href="https://wincent.com/download?item=WinSwitch.dmg">WinSwitch download</a></li>
              </ul>
            </li>
          </ul>
          
          <p>You are also welcome to <a href="https://wincent.com/a/contact/mail/">contact me</a> if you'd like to obtain a copy of Install for trial purposes.</p>
