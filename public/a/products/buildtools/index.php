...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>buildtools: build sugar</title>
    ...
    <div style="text-align: center; font-family: 'Lucida Grande'; margin: 5px 250px 5px 250px; padding: 5px; font-size: x-small; border: 2px solid silver; -webkit-border-radius: 0.5em; -moz-border-radius: 0.5em; background: #fefefe;">
      ...
      <tr>
        ...
        <td style="background-image: url(/a/gfx/header/center-background.jpg); background-repeat: repeat;" colspan="11" align="center" valign="middle">          <!-- Begin: header content -->
          ...
          <img src="/a/gfx/buildtools-header.jpg" width="403" height="25" alt="buildtools" align="middle" />
          <!-- End: header content -->
        </td>
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../">Products</a>&nbsp;&gt;&nbsp;Buildtools    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
              <h2>buildtools links</h2>
              <ul>
                <li><a href="http://www.wincent.com/a/products/buildtools/">Information</a></li>
                <li><a href="http://www.wincent.com/a/support/forums/ubbthreads.php?ubb=postlist&amp;Board=16&amp;page=1">Discussion & support forums</a></li>
                <li><a href="http://lists.wincent.com/mailman/listinfo/buildtools-announce">Mailing list</a></li>
      ...
      <div id="center">
        <div class="content">
          ...
          <p>The Wincent Buildtools (or simply, "buildtools") is a collection of scripts, tools and configuration files used in the build processes of a number of Wincent products (such as <a href="http://test.wincent.com/">WOTest</a>).</p>
          
          <h4><a id="download" name="download"></a>Downloads</h4>
          
          <p>A snapshot is available for <a href="http://www.wincent.com/download.php?item=buildtools.zip">download here</a> (52KB, revision 35, 6 September 2006).</p>
                    
          <p>You can also check out the latest version of the source via Subversion; for example, to check out into a directory named <tt>buildtools</tt>:</p>
          ...
          <p><tt>buildtools</tt> is free software released under the GPL license. If it is useful to you, please consider making a <a href="https://www.paypal.com/xclick/business=win@wincent.com&amp;item_name=buildtools+donation&amp;no_note=1&amp;currency_code=EUR&amp;lc=GB">donation</a>.</p>
          
          <!--
          <p><strong>Total downloads so far:</strong> <br />
          <strong>Total donations so far:</strong> &euro;<br />
          <em>(last updated )</em></p>
          -->
          
          <h4><a id="history" name="history"></a>History</h4>
          
          <h5>Revision 35 (6 September 2006)</h5>
