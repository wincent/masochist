    ...
    >
      ...
      <tr>
        ...
        >
          ...
          /></a>
          <img
            src="/a/gfx/buildtools-header.jpg"
            width="403"
            height="25"
            alt="buildtools"
            align="middle"
    ...
    <div id="container">
      <div id="left">
        <div class="sidebar">
          ...
          <ul>
            ...
            <li>
              <a
                href="https://wincent.com/a/support/forums/ubbthreads.php?ubb=postlist&amp;Board=16&amp;page=1"
                >Discussion & support forums</a
              >
            </li>
            <li>
              <a
                href="http://lists.wincent.com/mailman/listinfo/buildtools-announce"
                >Mailing list</a
              >
            </li>
            <li>
      ...
      <div id="center">
        <div class="content">
          ...
          <p>
            A snapshot is available for
            <a href="https://wincent.com/download.php?item=buildtools.zip"
              >download here</a
            >
