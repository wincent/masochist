    ...
    <div id="container">
      ...
      <div id="center">
        <div class="content">
          ...
          <p>
            Once you have installed the Synergy Preference Pane, you will be
            able to start and stop Synergy, as well as set it to launch
            automatically at login.
          </p>

          <p>
            As of Synergy version 0.9.9i2 (released 26 June 2003), Synergy comes
            with an
            <a href="https://wincent.dev/a/products/install/"
              >easy-to-use installer</a
            >. After downloading, simply double click the Synergy disk image.
            The installer is found inside the mounted disk image. Open it and
            follow the prompts! The installer knows how to do both clean
            installs and upgrades of existing installations.
          </p>
          ...
          <p>
            Depending on your selection, Synergy is installed into one of the
            following locations:
          </p>
...
/Library/PreferencePanes/</pre
          ...
          <p>
            The installer asks the System Preferences application and any
            previous versions of Synergy to quit, installs (or removes) Synergy,
            and flushes out the preference panes cache to ensure that the
