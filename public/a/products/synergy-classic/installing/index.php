...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Synergy: installation, upgrading and removal</title>
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../../">Products</a>&nbsp;&gt;&nbsp;<a href="../">Synergy Classic</a>&nbsp;&gt;&nbsp;Installing    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
      ...
      <div id="center">
        <div class="content">
          ...
          <h3>Installing, upgrading or removing Synergy</h3>
          
          <p>Once you have installed the Synergy Preference Pane, you will be able to start and stop Synergy, as well as set it to launch automatically at login.</p>
          
          <p>As of Synergy version 0.9.9i2 (released 26 June 2003), Synergy comes with an <a href="http://www.wincent.com/a/products/install/">easy-to-use installer</a>. After downloading, simply double click the Synergy disk image. The installer is found inside the mounted disk image. Open it and follow the prompts! The installer knows how to do both clean installs and upgrades of existing installations.</p>
          
          <p>To remove Synergy, click the "Uninstall" button in the installer.</p>
          
          <h4>What's actually being installed?</h4>
          
          <p>Depending on your selection, Synergy is installed into one of the following locations:</p>
          
          <pre>~/Library/PreferencePanes/
/Library/PreferencePanes/</pre>
          
          <p>The installer asks the System Preferences application and any previous versions of Synergy to quit, installs (or removes) Synergy, and flushes out the preference panes cache to ensure that the changes are reflected in the user interface.</p>
