...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Synergy: system requirements</title>
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../../">Products</a>&nbsp;&gt;&nbsp;<a href="../">Synergy Classic</a>&nbsp;&gt;&nbsp;System Requirements    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
      ...
      <div id="center">
        <div class="content">
          ...
          <h3>Synergy system requirements</h3>
          
          <p>As of version 3.5, Synergy requires Mac OS X Leopard (10.5) or later.</p>
          
          <p>Synergy 3.2 is still supported and available for <a href="../download/tiger/">download</a>, and it works on a wider range of system versions; currently from Mac OS X versions 10.2.8 right up to and including Leopard.</p>
          
          <p>Versions of Mac OS X prior to 10.2.8 are not supported.</p>
          
          <p>Some of Synergy's features such as Growl integration and <a href="http://www.wincent.com/a/products/synergy-classic/features/audioscrobbler/">Audioscrobbler support</a> require a modern version of iTunes (4.7 and up). Synergy has been qualified for use with versions of iTunes up to version 7.6.</p>
