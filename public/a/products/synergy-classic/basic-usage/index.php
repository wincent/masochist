    ...
    <div id="breadcrumbs">
      <p>
        <a href="https://wincent.dev/">Main</a>&nbsp;&gt;&nbsp;<a href="../../"
          >Products</a
        >&nbsp;&gt;&nbsp;<a href="../">Synergy Classic</a>&nbsp;&gt;&nbsp;Basic
        Usage
      </p>
    </div>
    <div id="container">
      ...
      <div id="center">
        <div class="content">
          ...
          <p>
            After <a href="../installing/">installing</a> Synergy you can start
            it up from with the System Preferences by choosing the Synergy pane
            and pressing "Start".
          </p>

          <p>
            Use Synergy to skip to the next or previous iTunes track simply by
            clicking one of the controls in the menu bar; you can also toggle
            the current track between playing and paused mode.
          </p>

          <p>
            Access the Synergy Global Menu by clicking and holding the
            Play/Pause button in the Menu Bar (the Global Menu can be used to
            switch playlists, access recent tracks, change iTunes settings and
            more).
          </p>

          <p>
            You can also control Synergy with system-wide Hot Keys. By default,
            the Hot Keys are:
          </p>
          ...
          <ul>
            ...
            <li>
              <em>Command-F11</em>: Previous track (press and hold to rewind
              within the track; press and release quickly to skip an entire
              track)
            </li>
            <li>
              <em>Command-F12</em>: Next track (press and hold to fast-forward
              within the track; press and release quickly to skip an entire
              track)
            </li>
          ...
          <p>
            These keys were chosen because they fit well alongside the
            brightness adjustment keys (F14 and F15) that Apple has allocated to
            controlling display brightness.
          </p>

          <p>
            Tip: for even greater speed, you can customise your Hot Keys so that
            you can control iTunes with Function keys alone, and no modifier
            keys like Command or Shift.
          </p>

          <img
            style="float:right;"
            src="https://wincent.dev/a/products/synergy-classic/basic-usage/extra-feedback.jpg"
            alt="Extra feedback"
            width="167"
            height="166"
          />
          <p>
            You can also turn on extra feedback in the Synergy preferences, and
            a semi-transparent feedback window will be displayed whenever you
            use a hot key to control iTunes.
          </p>
        </div>
      </div>
      <div id="right">
