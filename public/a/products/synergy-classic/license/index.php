...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../../">Products</a>&nbsp;&gt;&nbsp;<a href="../">Synergy Classic</a>&nbsp;&gt;&nbsp;License    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
      ...
      <div id="center">
        <div class="content">
          ...
          <p>Redistribution in any form without permission is disallowed. Rather than redistributing Synergy independently please direct others to the Synergy website, <a href="http://synergy.wincent.com/">synergy.wincent.com</a>, to download the product.</p>
          
          <p>There are three types of license available for Synergy: single-user, multi-user and demonstration.</p>
          
          <h4>Single-user license</h4>
          
          <p>In the case of a single-user license, purchasing Synergy grants you a limited license to use the software on one machine. Licenses are not transferrable between users, but a registered user may choose to transfer the license from one machine (the "source" machine) to another (the "destination" machine) provided that Synergy is removed from the source machine immediately after transferring it to the destination machine.</p>
          
          <h4>Multi-user license</h4>
          
          <p>In the case of a multi-user license, the purchaser is granted a limited license to install and use Synergy on more than one machine (up to the limit of machines allowed under the specific license). Licenses are not transferrable among machines, except under the provisions already outlined above. Note that in the case of the multi-user license, the license adheres to the machine rather than a specific user.</p>
          
          <h4>Demonstration license</h4>
          
          <p>In the case of the demonstration license, the user is granted a limited license to use the product on a trial basis for a period of seven days. At the end of that period it is necessary to purchase a license in order to continue using Synergy.</p>
          
          <h4>Common terms to all paid licenses</h4>
          
          <p>No warranty of any kind applies. The purpose of the seven day trial period is to allow potential purchasers to make an informed decision about whether to purchase a Synergy license. Once a license has been issued, no refunds shall apply.  Given that Synergy interacts with products and services provided by third parties (such as Apple's iTunes, Amazon's Web Services, and <a href="http://growl.info/">Growl</a>, there are no guarantees that Synergy will continue to function with future versions of those products and services, although a best effort will be made to ensure that Synergy remains compatible.</p>
          
          <p>Registered users are required to keep their serial numbers in a safe place and to refrain from disclosing them to any third party.</p>
          
          <p>Registered users found to be in breach of these conditions forfeit their license.</p>
          
          <p>I reserve the right to change these license terms at any time without notice.</p>
