      ...
      <div id="center">
        <div class="content">
          ...
          <h4>
            ...
            <img
              style="float:right;"
              src="https://typechecked.net/a/products/synergy-classic/gfx/macworld-us-4-and-a-half-mice.gif"
              width="30"
              height="11"
              alt="4.5 mice"
            />
          ...
          <h4>
            MacUser UK (4.5 mice rating)<img
              style="float:right;"
              src="https://typechecked.net/a/products/synergy-classic/gfx/macuser-uk-4-and-a-half-mice.gif"
              width="75"
              height="12"
              alt="4.5 mice"
            />
