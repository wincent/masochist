...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../../">Products</a>&nbsp;&gt;&nbsp;<a href="../">Synergy Classic</a>&nbsp;&gt;&nbsp;Support    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
      ...
      <div id="center">
        <div class="content">
          <h3>Synergy support</h3>
          
          <p>The following support resources are available to you 24 hours a day, 365 days a year through this website.</p>
          
          <h4>Synergy Frequently Asked Questions</h4>
          
          <p>The <a href="../faq/">FAQ</a> contains the answers to the most common Synergy questions.</p>
          
          <p class="more">Click <a href="../faq/">here</a> to view the FAQ</p>
          
          <h4>Lost license codes</h4>
          
          <p>The <a href="https://secure.wincent.com/a/support/registration/">license code retrieval system</a> allows you to enter the email address you used at the time of purchase and have your license code re-mailed to that address. Licenses are tied to the purchase address for security reasons, so it is important to correctly specify the address when purchasing, and to keep good backups in the event that you should change addresses. It is recommended that you burn a copy of your license notice to CD and also keep a printed copy.</p>
          
          <p class="more">Click <a href="https://secure.wincent.com/a/support/registration/">here</a> to retrieve your code</p>
          
          <h4>Support pages</h4>
          
          <p>The <a href="http://www.wincent.com/a/support/">wincent.com support pages</a> group together all the support resources available to you from this website, as well as containing site-wide support information that applies not only to Synergy but to all other Wincent products and services.</p>
          
          <p class="more">Click <a href="http://www.wincent.com/a/support/">here</a> to go to the support pages</p>
          
          <h4>Support forums</h4>
          
          <p>The <a href="http://forums.wincent.com/">support and discussion forums</a> provide you with a place where you can share your experiences and ask questions with other users at any hour of the day or night. The forums are equipped with a search function so that you can locate answers to previously asked questions.</p>
          
          <p class="more">Click <a href="http://forums.wincent.com/">here</a> to visit the forums</p>
          
          <h4>Bug tracking and feature requests database</h4>
          
          <p>You can use the <a href="http://bugs.wincent.com/">bug tracking and feature requests database</a> to submit bug reports and feature requests, as well as see what other users have reported and requested already.</p>
          
          <p class="more">Click <a href="http://bugs.wincent.com/">here</a> to visit the database</p>
          
          <h4>Mailing lists</h4>
          
          <p>There is one Synergy-related mailing lists that you can join if you are a registered user:</p>
          
          <ul>
            <li><em>synergy-registered-users</em>: Synergy announcements list</li>
          </ul>
          
          <p>For more information, or to subscribe or unsubscribe, proceed to <a href="http://www.wincent.com/a/support/lists/">the mailing lists page</a>.</p>
          
          <h4>Knowledge base</h4>
          
          <p>The wincent.com <a href="http://www.wincent.com/a/knowledge-base/">Knowledge Base</a> is a collection of useful tips, "how to" articles, and general information that covers a variety of topics that may be of interest to Mac users, developers, and IT.</p>
          
          <p class="more">Click <a href="http://www.wincent.com/a/knowledge-base/">here</a> to visit the Knowledge Base</p>
          
          <h4>News pages</h4>
          
          <p>The <a href="http://www.wincent.com/a/news/">news pages</a> contain the latest product and site news, and it's recommended that you check for updates before contacting me or opening a support ticket. For example, if there is a problem with the site or if I have limited access to the Net I will post an update to the news page so that you know what's happening.</p>
          
          <p class="more">Click <a href="http://www.wincent.com/a/news/">here</a> to visit the news pages</p>
          
          <h4>Contact page</h4>
          
          <p>The <a href="http://www.wincent.com/a/contact/">contact page</a> contains a list of useful solutions to common issues (like lost license codes, email address updates and so forth). If you wish to provide feedback you can use the contact page to get in touch with me. If you want personalized technical support, then you will need to open a support ticket (see below).</p>
          
          <p class="more">Click <a href="http://www.wincent.com/a/contact/">here</a> to use the contact page</p>
          
          <h4>Support tickets</h4>
          
          <p>If the existing online resources aren't sufficient to help you solve your problem, please <a href="https://secure.wincent.com/a/support/tickets/">open a support ticket</a>. This is the fastest way to receive personalized attention, because it will not only send me an email but also store the details of your inquiry in a database so that I can track the issue more easily.</p>
          
          <p class="more">Click <a href="https://secure.wincent.com/a/support/tickets/">here</a> to open a support ticket</p>
