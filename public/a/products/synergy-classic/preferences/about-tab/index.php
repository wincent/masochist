...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../../../">Products</a>&nbsp;&gt;&nbsp;<a href="../../">Synergy Classic</a>&nbsp;&gt;&nbsp;<a href="../">Preferences</a>&nbsp;&gt;&nbsp;About Tab    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
      ...
      <div id="center">
        <div class="content">
          ...
          <p>The About tab provides access to registration options, the Synergy website, and Help.</p>
          
          <ul>
            <li><strong>Purchase</strong>: Click this button to be taken directly to the <a href="https://secure.wincent.com/a/products/synergy-classic/purchase/">Synergy purchase page</a> in your default browser. </li>
            <li><strong>Enter serial number</strong>: Once you have paid the 5&euro; (euro) registration fee and received your registration information you should click this button to enter your email address and serial number. <em>Be sure to copy your email address and serial number exactly as they appear in your registration notice</em>. If there are extra spaces before or after your information, or if you alter the capitalisation, your registration will not validate.</li>
            <li><strong>Unregister</strong>: Click this button to clear your serial number and registration information. (The Synergy license agreement requires you to remove your registration information from one machine before transferring the license to another. Licenses are not transferrable between users.)</li>
            <li><strong>Visit Synergy Website</strong>: Clicking this button takes you to the Synergy website (http://synergy.wincent.com/) in your default browser.</li>
          </ul>
