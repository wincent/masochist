    ...
    <div id="container">
      ...
      <div id="center">
        <div class="content">
          ...
          <p>
            Audioscrobbler, also known as "last.fm", is an online music
            community that allows you to automatically publish information about
            your listening habits. For more information, and to obtain an
            Audioscrobbler account, see
            <a href="http://www.last.fm/">http://www.last.fm/</a>.
          </p>
          ...
          <ul>
            <li>
              <a href="https://wincent.dev/a/products/synergy-classic/download/"
                >Download</a
              >
              version 3.1 or later of Synergy.
            </li>
            <li>
              In the "Advanced" tab of the Synergy preferences click on the "Set
              Audioscrobbler account details" button:
            </li>
          </ul>
          ...
          <ul>
            <li>
              Fill in your Audioscrobbler username and password and click the
              "Save" button. Your password will be securely stored in the
              default
              <a href="http://www.apple.com/macosx/features/security/"
                >keychain</a
              >:
            </li>
          </ul>
          ...
          <p>
            Set a blank Audioscrobbler username in the Synergy preferences and
            Synergy's Audioscrobbler support will become inactive.
          </p>

          <h4>
            <a id="iScrobbler" name="iScrobbler"></a>Is Synergy compatible with
            iScrobbler?
          </h4>

          <p>
            Synergy and
            <a href="http://www.last.fm/tools/downloads/">iScrobbler</a> both
            submit track information to last.fm so there is no point in running
            both at the same time if you plan on using Synergy's Audioscrobbler
            support; this would lead to simultaneous duplicate submissions. You
            should either stop running iScrobbler, or turn off Synergy's
            Audioscrobbler support and let iScrobbler handle track submissions.
          </p>

          <p>
            If there is functionality in iScrobbler that you would like to see
            added to Synergy, please
          ...
          <p>
            Synergy complies with the Audioscrobbler protocol, which means that
            it submits track information according to the following criteria:
          </p>
          ...
          <ul>
            ...
            <li>
              Songs are submitted after they have been playing for 240 seconds,
              or are 50% through, whichever comes first
            </li>
            <li>
              If you seek forward or back within a track prior to submission,
              submission will not take place; note that Synergy tries to
              accurately detect when you seek within a track even when you
              manipulate iTunes directly, but for total accuracy you should
              perform all seeking from within Synergy itself (via hot keys or
              the menu bar control buttons)
            </li>
            <li>
              If the Audioscrobbler server is under heavy load, Synergy will
              comply with requests from the server to slow down and so may not
              submit immediately
            </li>
          </ul>

          <p>
            Please note that last.fm has caching policies which may delay the
            immediate appearance of new submissions; see their
            <a href="http://www.last.fm/help/faq/"
              >Frequently Asked Questions</a
            >
          ...
          <p>
            Synergy will periodically attempt to connect to the Audioscrobbler
            servers so this feature requires an active internet connection.
          </p>

          <h4>Logging</h4>

          <p>
            If you are participating in the Synergy beta test of the
            Audioscrobbler functionality you can turn on logging by executing
            the following command in the Terminal while Synergy is not running:
          </p>
...
defaults write org.wincent.Synergy LogAudioscrobblerEvents -bool yes</pre
          ...
          <p>
            To turn the logging off you would execute the following while
            Synergy is not running:
          </p>

          <pre>
defaults write org.wincent.Synergy LogAudioscrobblerEvents -bool no</pre
          >
