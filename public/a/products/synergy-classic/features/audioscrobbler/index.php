...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Synergy: Audioscrobbler</title>
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../../../">Products</a>&nbsp;&gt;&nbsp;<a href="../../">Synergy Classic</a>&nbsp;&gt;&nbsp;<a href="../">Features</a>&nbsp;&gt;&nbsp;Audioscrobbler    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
      ...
      <div id="center">
        <div class="content">
          ...
          <h3>Audioscrobbler/last.fm</h3>
          
          <h4>What is Audioscrobbler?</h4>
          
          <p>Audioscrobbler, also known as "last.fm", is an online music community that allows you to automatically publish information about your listening habits. For more information, and to obtain an Audioscrobbler account, see <a href="http://www.last.fm/">http://www.last.fm/</a>.</p>
          
          <h4>How do I use Audioscrobbler with Synergy?</h4>
          
          <ul>
            <li><a href="http://www.wincent.com/a/products/synergy-classic/download/">Download</a> version 3.1 or later of Synergy.</li>
            <li>In the "Advanced" tab of the Synergy preferences click on the "Set Audioscrobbler account details" button:</li>
          </ul>
          
          <img src="audioscrobbler1.png" alt="The &quot;Advanced&quot; preferences tab" width="467" height="431" border="0" />
          
          <ul>
            <li>Fill in your Audioscrobbler username and password and click the "Save" button. Your password will be securely stored in the default <a href="http://www.apple.com/macosx/features/security/">keychain</a>:</li>
          </ul>
          
          <img src="audioscrobbler2.png" alt="Entering the username and password" width="448" height="132" border="0" />
          
          <h4>How do I turn off Synergy's Audioscrobbler support?</h4>
          
          <p>Set a blank Audioscrobbler username in the Synergy preferences and Synergy's Audioscrobbler support will become inactive.</p>
          
          <h4><a id="iScrobbler" name="iScrobbler"></a>Is Synergy compatible with iScrobbler?</h4>
          
          <p>Synergy and <a href="http://www.last.fm/tools/downloads/">iScrobbler</a> both submit track information to last.fm so there is no point in running both at the same time if you plan on using Synergy's Audioscrobbler support; this would lead to simultaneous duplicate submissions. You should either stop running iScrobbler, or turn off Synergy's Audioscrobbler support and let iScrobbler handle track submissions.</p>
          
          <p>If there is functionality in iScrobbler that you would like to see added to Synergy, please <a href="http://www.wincent.com/a/support/bugs/">file a feature request</a>.</p>
          
          <h4>When does Synergy submit track information to Audioscrobbler?</h4>
          
          <p>Synergy complies with the Audioscrobbler protocol, which means that it submits track information according to the following criteria:</p>
          
          <ul>
            <li>Songs less than 30 seconds long are ignored</li>
            <li>Only regular file tracks (not streams) are submitted</li>
            <li>Songs are submitted after they have been playing for 240 seconds, or are 50% through, whichever comes first</li>
            <li>If you seek forward or back within a track prior to submission, submission will not take place; note that Synergy tries to accurately detect when you seek within a track even when you manipulate iTunes directly, but for total accuracy you should perform all seeking from within Synergy itself (via hot keys or the menu bar control buttons)</li>
            <li>If the Audioscrobbler server is under heavy load, Synergy will comply with requests from the server to slow down and so may not submit immediately</li>
          </ul>
          
          <p>Please note that last.fm has caching policies which may delay the immediate appearance of new submissions; see their <a href="http://www.last.fm/help/faq/">Frequently Asked Questions</a> for more information.</p>
          
          <h4>Requirements and limitations</h4>
          
          <p>Synergy will periodically attempt to connect to the Audioscrobbler servers so this feature requires an active internet connection.</p>
          
          <h4>Logging</h4>
          
          <p>If you are participating in the Synergy beta test of the Audioscrobbler functionality you can turn on logging by executing the following command in the Terminal while Synergy is not running:</p>
          
          <pre>defaults write org.wincent.Synergy LogAudioscrobblerEvents -bool yes</pre>
          
          <p>To turn the logging off you would execute the following while Synergy is not running:</p>
          
          <pre>defaults write org.wincent.Synergy LogAudioscrobblerEvents -bool no</pre>
          
          <h4>Disclaimer</h4>
          
          <p>Wincent has no affiliation with Audioscrobbler or last.fm.</p>
