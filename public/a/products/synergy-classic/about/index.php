    ...
    <div id="breadcrumbs">
      <p>
        <a href="https://wincent.dev/">Main</a>&nbsp;&gt;&nbsp;<a href="../../"
          >Products</a
        >&nbsp;&gt;&nbsp;<a href="../">Synergy Classic</a>&nbsp;&gt;&nbsp;About
      </p>
    </div>
    <div id="container">
      <div id="left">
      ...
      <div id="center">
        <div class="content">
          ...
          <img
            style="float:right;"
            src="https://wincent.dev/a/products/synergy-classic/about/menubar-controls.jpg"
            alt="Controls"
            width="112"
            height="66"
          />
          <p>
            Synergy is a tiny Cocoa application for Mac OS X 10.2 (and later)
            that puts three <a href="../buttons/">buttons</a> to control iTunes
            in your menubar: previous track, next track, and play/pause; as well
            as providing you with
            <a href="../floater/">visual feedback</a> about the currently
            playing tune. Synergy can even automatically download and
            <a href="../album-covers/">display the cover</a> of the currently
            playing album. The Synergy controls, together with the ability to
            control iTunes via
            <a href="../preferences/hot-keys/"
              >system-wide Hot Key combinations</a
            >, mean that Synergy provides the fastest way of skipping between
            songs when using the keyboard or the mouse; all this without having
            to switch to iTunes, or access its Dock menu. Synergy is only
            5&euro; (Euros).
          </p>
          ...
          <p>
            ...
            access to recently played tracks and playlists, and the floater
            displays album covers and provides information whenever a new track
            starts playing.
          </p>

          <p>
            An <a href="../screenshots/">online tour</a> is available to take
            you through Synergy's features.
          </p>
        </div>
      </div>
      <div id="right">
