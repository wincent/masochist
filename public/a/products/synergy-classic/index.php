      ...
      <div id="center">
        <div class="content">
          ...
          <img
            ...
            src="../../gfx/synergy-classic-icon.png"
            alt="Synergy icon"
            width="128"
            height="128"
          />
          <p>
            <strong
              >The new Synergy product page is now online at
              <a href="https://wincent.dev/products/synergy"
                >https:/wincent.dev/products/synergy</a
              >. The page you are currently viewing will no longer be updated
              and is being kept online for historical interest only.</strong
            >
          </p>
          <p>
            Synergy is a tiny Cocoa application for Mac OS X that puts three
            buttons to control iTunes in your menubar: previous track, next
            track, and play/pause; as well as providing you with visual feedback
            about the currently playing tune. Synergy can even automatically
            download and <a href="album-covers/">display the cover</a> of the
            currently playing album. The Synergy controls, together with the
            ability to control iTunes via system-wide
            <a href="preferences/hot-keys/">hot Key combinations</a>, mean that
            Synergy provides the fastest way of skipping between songs when
            using the keyboard or the mouse; all this without having to switch
            to iTunes, or access its Dock menu.
            <a href="https://wincent.dev/a/products/synergy-classic/purchase/"
              >Synergy licenses start at only 5&euro; (Euros)</a
            >.
          </p>

          <img
            style="float:right;"
            src="https://wincent.dev/images/old/synergy/gfx/menubarControls.jpg"
            width="112"
            height="66"
            alt="Controls"
          />
          <p>
            Synergy won't take up precious space in your Dock as it appears only
            in the menubar. It provides you with ultimate control over iTunes
            even while you're working in other applications. The Synergy
            <a href="global-menu/">global menu</a> provides you with quick
            access to recently played tracks and playlists, and
            <a href="floater/">the floater</a> displays album covers and
            provides information whenever a new track starts playing.
          </p>

          <img
            style="float:right;"
            src="https://wincent.dev/images/old/synergy/web/floaterWithAlbum.jpg"
            width="233"
            height="77"
            hspace="5"
            vspace="5"
          ...
          />
          <p>
            Version 3.4 is the current stable release. Version 4.0.1a
            <a href="history/">is a total rewrite</a> (for Snow Leopard). Take
            the <a href="screenshots/">online tour</a> to see some of Synergy's
            features.
          </p>
