    ...
    <div id="container">
      ...
      <div id="center">
        <div class="content">
          ...
          <ul>
            <li>
              Adam "Elroy" Mazzitelli (<a href="http://www.elroyonline.net/"
                >www.elroyonline.net</a
              >)
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              Herv&eacute; Bismuth, Fr&eacute;d&eacute;ric Latour (French)
            </li>
            <li>
              David Dauer; application, Felix K&uuml;hne; installer (German)
            </li>
