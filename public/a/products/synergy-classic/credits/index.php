...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../../">Products</a>&nbsp;&gt;&nbsp;<a href="../">Synergy Classic</a>&nbsp;&gt;&nbsp;Credits    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
      ...
      <div id="center">
        <div class="content">
          ...
          <h4>Icons, graphics and testing</h4>
          <ul>
            <li>Adam "Elroy" Mazzitelli (<a href="http://www.elroyonline.net/">www.elroyonline.net</a>)</li>
          </ul>
          ...
          <h4>Localizations</h4>
          <ul>
            <li>Paul B&aacute;ns&aacute;gi, Fokke de Boer (Dutch)</li>
            <li>Herv&eacute; Bismuth, Fr&eacute;d&eacute;ric Latour (French)</li>
            <li>David Dauer; application, Felix K&uuml;hne; installer (German)</li>
            <li>Michele Mangili (Italian)</li>
            <li><a href="mailto:aki@yz.main.jp">Akira Ikeda</a> (Japanese)</li>
            <li>Tore Torsteinb&oslash; (Norwegian)</li>
            <li>Neto (Portuguese)</li>
            <li>Alexander Vasilyev (Russian)</li>
            <li>Xiong Wei (Simplified Chinese)</li>
            <li>Jack MH Lin (Traditional Chinese)</li>
            <li>Jonas Barrestam (Swedish)</li>
            <li>Alphan Gunaydin (Turkish)</li>
          </ul>
          
          <h4>Button sets</h4>
          <ul>
            <li>See <a href="../buttons/">Button Set Gallery</a></li>
          </ul>
