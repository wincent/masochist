...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Wincent Strings Utility</title>
    ...
    <div style="text-align: center; font-family: 'Lucida Grande'; margin: 5px 250px 5px 250px; padding: 5px; font-size: x-small; border: 2px solid silver; -webkit-border-radius: 0.5em; -moz-border-radius: 0.5em; background: #fefefe;">
      ...
      <tr>
        ...
        <td style="background-image: url(/a/gfx/header/center-background.jpg); background-repeat: repeat;" colspan="11" align="center" valign="middle">          <!-- Begin: header content -->
          ...
          <img src="/a/gfx/strings-header.jpg" width="486" height="25" alt="Wincent Strings Utility: localization tool" align="middle" />
          <!-- End: header content -->
        </td>
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../">Products</a>&nbsp;&gt;&nbsp;Wincent Strings Utility    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
              ...
              <ul>
                <li><a href="http://www.wincent.com/a/products/wincent-strings-util/">Information</a></li>
                <li><a href="https://wincent.com/forums/wincent-strings-utility">Discussion & support forums</a></li>
                <li><a href="http://bugs.wincent.com/">Bug reports & feature requests</a></li>
              </ul>
              <h2>On this page</h2>
              <ul>
      ...
      <div id="center">
        <div class="content">
          <h3>Wincent Strings Utility</h3>
          
          <p>The Wincent Strings Utility is a localization tool derived from stringsUtil by <a href="http://www.omnigroup.com/">Omni Development</a>. It is a command line tool designed to be called from within Xcode shell script build phases. In its first mode of operation it parses localizable strings files in the development language and transforms them for use with existing localized variants; the three possible transformations are merge, extract and combine (for incremental localization).</p>
          
          <p>In its second mode of operation it can be used to preprocess localized InfoPlist.strings files by scanning them for Info.plist keys and performing substitutions of values such as copyright year and version number. For more information see <a href="wincent-strings-util.1.txt">this plaintext copy</a> of the <tt>wincent-stings-util</tt> man page.</p>
          
          <h3><a id="download" name="download"></a>Download</h3>
          
<ul>
<li><strong>Mac OS X 10.6 Snow Leopard:</strong><br />
Wincent Strings Utility version 2.0.1 (<a href="download/wincent-strings-util-2.0.1.zip">binary installer, 37KB</a>, <a href="download/wincent-strings-util-2.0.1-src.tar.bz2">source archive</a>, 66KB)</li>
<li><strong>Mac OS X 10.5 Leopard:</strong><br />
Wincent Strings Utility version 1.2 (<a href="download/wincent-strings-util-1.2.zip">binary installer, 49KB</a>, <a href="download/wincent-strings-util-1.2-src.tar.gz">source archive</a>, 53KB)</li>
<li><strong>Mac OS X 10.4 Tiger:</strong><br />
Wincent Strings Utility version 1.1 (<a href="download/wincent-strings-util-1.1.zip">source archive, 41KB</a>)</li>
</ul>
          ...
          <p>An older version of the repository is kept online for historical reasons only and can be checked out via Subversion:</p>
          
          <pre>svn co svn://svn.wincent.com/wincent-strings-util/trunk</pre>
          
          <h3><a id="donations" name="donations"></a>Donations</h3>
          
          <p>Wincent Strings Utility is free software released under the GPL license. If it is useful to you, please consider making a <a href="https://www.paypal.com/xclick/business=win@wincent.com&amp;item_name=Wincent+Strings+Utility+donation&amp;no_note=1&amp;currency_code=EUR&amp;lc=GB">donation</a>.</p>
          
          <h3><a id="history" name="history"></a>History</h3>

<h4><a id="v2.0.1" name="v2.0.1"></a>2.0.1 (29 August 2009)</h4>

<ul>
<li>Installer package now triggers a dialog when run on versions of Mac OS X prior to 10.6 Snow Leopard.</li>
<li>Source distribution now includes the Wincent Buildtools submodule, so it no longer needs to be fetched separately.</li>
</ul>

<p>A code-level changelog for this release is available <a href="history/wincent-strings-util-2.0.1-release-notes.txt">here</a>.</p>

<p>A more detailed log including full commit messages is available <a href="history/wincent-strings-util-2.0.1-detailed-release-notes.txt">here</a>.</p>

<h4><a id="v2.0" name="v2.0"></a>2.0 (28 August 2009)</h4>

<ul>
<li>Update man page.</li>
<li>Now requires Mac OS X 10.6 Snow Leopard.</li>
<li>Trim disk footprint by stripping legacy PowerPC code.</li>
<li>Fix Garbage Collection.</li>
</ul>

<p>A code-level changelog for this release is available <a href="history/wincent-strings-util-2.0-release-notes.txt">here</a>.</p>

          <h4><a id="v1.2" name="v1.2"></a>1.2 (6 January 2008)</h4>
          
          <ul>
            <li>New <tt>--extract</tt> and <tt>--combine</tt> switches for even easier incremental localization.</li>
            <li>Support recursive substitution when performing preprocessing on <tt>InfoPlist.strings</tt> files.</li>
            <li>Use double-hyphens for all switches, instead of the less-orthodox single hyphens previously used.</li>
            <li>Add checks for duplicate keys within the same file (this is never correct so the user should be notified about it).</li>
            <li>Stricter parsing of input files when using the <tt>--info</tt> switch; this allows us to detect malformed input files as well guess the input encoding for files which do not have an explicit BOM (Byte Order Mark).</li>
            <li>Allow explicit override of output encoding using the new <tt>--encode</tt> switch.</li>
            <li>Always include an explicit BOM in the output file.</li>
            <li>Add installer package for use with Apple's installer.</li>
            <li>Convert to Objective-C 2.0 and Garbage Collection; as such this release requires Mac OS X Leopard.</li>
            <li>Migrate source code from Subversion to Git and make corresponding adjustments such as removing the embedded $Id$ number from the built executable.</li>
            <li>Update build process to use <a href="http://www.wincent.com/a/products/buildtools/">Wincent Build Tools</a>.</li>
            <li>Add automated test suite using <a href="http://rspec.info/">RSpec</a>.</li>
          </ul>
          
          <p>A code-level changelog for this release is available <a href="history/1.2-release-notes.txt">here</a>.</p>
          
          <h4><a id="v1.1" name="v1.1"></a>1.1 (17 August 2006)</h4>
          
          <ul>
            <li>User-visible changes:
              <ul>
                <li>Released under the GPL (with Omni's permission)</li>
                <li>Preprocessing support for InpoPlist.strings files</li>
                <li>Errors and warnings now formatted so as to be picked up automatically by Xcode Build Results window</li>
                <li>Warn if cannot confirm UTF-16 encoding of input/output files</li>
              </ul>
            </li>
            <li>Developer-visible changes:
              <ul>
                <li><tt>describeScanLocation</tt> method (verb) renamed to <tt>scanLocationDescription</tt> (noun)</li>
                <li>Fix regression in <tt>peekCharacter</tt> and <tt>scanCharacter</tt> methods (always returned <tt>NO</tt> for last character)</li>
              </ul>
            </li>
          </ul>
          
          <h4><a id="v1.0b" name="v1.0b"></a>1.0b (19 February 2006)</h4>
          
          <ul>
            <li>Initial public release.</li>
            <li>User-visible modifications to Omni stringsUtil:
              <ul>
                <li>work with InfoPlist.strings files (unquoted key strings)</li>
                <li>force output to UTF-16 in all cases (required encoding for strings files)</li>
                <li>executable name is <tt>wincent-strings-util</tt> (change required by license)</li>
                <li>man page (required by license)</li>
                <li>usage now includes copyright info (required by license)</li>
                <li>upgrade project file to "xcodeproj" format, upgrade and rename target</li>
                <li>Universal Binary</li>
                <li>running what(1) on executable produces meaningful output</li>
                <li>non-zero exit code if writing to output file fails</li>
                <li>bail more elegantly (catch exceptions) for malformed input files</li>
                <li>emit warnings to standard error for removed keys</li>
              </ul>
            </li>
            <li>Developer-visible changes to Omni stringsUtil:
              <ul>
                <li>formatting adjustments (trim to fit 80 columns, use GNU99 C syntax)</li>
                <li>extensive refactoring for readability</li>
                <li>changes to scanner methods to more closely match Cocoa conventions</li>
