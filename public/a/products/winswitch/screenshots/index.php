    ...
    <div id="breadcrumbs">
      <p>
        <a href="https://typechecked.net/">Main</a>&nbsp;&gt;&nbsp;<a href="../../"
          >Products</a
        >&nbsp;&gt;&nbsp;<a href="../">WinSwitch</a>&nbsp;&gt;&nbsp;Screenshots
      </p>
    </div>
    <div id="container">
      <div class="content">
        ...
        <div class="screenshots">
          <img
            src="https://typechecked.net/a/products/winswitch/screenshots/menu.jpg"
            alt="The WinSwitch menu"
            width="453"
            height="493"
          />
          ...
          <img
            src="https://typechecked.net/a/products/winswitch/screenshots/preferences.jpg"
            alt="Preferences"
            width="577"
            height="365"
          />
          ...
          <img
            src="https://typechecked.net/a/products/winswitch/screenshots/notification.jpg"
            alt="Helper notification"
            width="379"
            height="198"
          />
        ...
        <div class="screenshots">
          <img
            src="https://typechecked.net/a/products/winswitch/screenshots/standardIcon.gif"
            alt="Standard icon"
            width="376"
            height="345"
          />
          ...
          <img
            src="https://typechecked.net/a/products/winswitch/screenshots/userPicture.gif"
            alt="Custom user picture"
            width="376"
            height="345"
          />
          ...
          <img
            src="https://typechecked.net/a/products/winswitch/screenshots/longName.gif"
            alt="Long username"
            width="376"
            height="345"
          />
          ...
          <img
            src="https://typechecked.net/a/products/winswitch/screenshots/shortName.gif"
            alt="Short username"
            width="376"
            height="345"
          />
          ...
          <img
            src="https://typechecked.net/a/products/winswitch/screenshots/firstName.gif"
            alt="First name"
            width="250"
            height="328"
          />
          ...
          <img
            src="https://typechecked.net/a/products/winswitch/screenshots/initials.gif"
            alt="Initials only"
            width="250"
            height="328"
          />
          ...
          <img
            src="https://typechecked.net/a/products/winswitch/screenshots/rootUser.gif"
            alt="Root user"
            width="409"
            height="390"
          />
