    ...
    <div id="container">
      <div class="content">
        ...
        <div class="screenshots">
          <img
            src="https://wincent.dev/a/products/winswitch/screenshots/menu.jpg"
          ...
          <img
            src="https://wincent.dev/a/products/winswitch/screenshots/preferences.jpg"
            alt="Preferences"
            width="577"
            height="365"
          />
          ...
          <img
            src="https://wincent.dev/a/products/winswitch/screenshots/notification.jpg"
        ...
        <div class="screenshots">
          <img
            src="https://wincent.dev/a/products/winswitch/screenshots/standardIcon.gif"
            alt="Standard icon"
            width="376"
            height="345"
          />
          ...
          <img
            src="https://wincent.dev/a/products/winswitch/screenshots/userPicture.gif"
          ...
          <img
            src="https://wincent.dev/a/products/winswitch/screenshots/longName.gif"
            alt="Long username"
            width="376"
            height="345"
          />
          ...
          <img
            src="https://wincent.dev/a/products/winswitch/screenshots/shortName.gif"
            alt="Short username"
            width="376"
            height="345"
          />
          ...
          <img
            src="https://wincent.dev/a/products/winswitch/screenshots/firstName.gif"
            alt="First name"
            width="250"
            height="328"
          />
          ...
          <img
            src="https://wincent.dev/a/products/winswitch/screenshots/initials.gif"
            alt="Initials only"
            width="250"
            height="328"
          />
          ...
          <img
            src="https://wincent.dev/a/products/winswitch/screenshots/rootUser.gif"
            alt="Root user"
            width="409"
            height="390"
          />
