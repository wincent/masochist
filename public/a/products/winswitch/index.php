    ...
    <div id="container">
      <div id="left">
        <div class="sidebar">
          ...
          <ul>
            <li>Save precious menu bar real estate.</li>
            <li>
              Show standard icon, user picture, short username, long username,
              first name only, or initials only in menu bar.
            </li>
            <li>Rapid access to Accounts preferences pane.</li>
            <li>
              Optionally include &quot;root&quot; user in list of users [<a
                href="faq/"
                >more</a
              >].
            </li>
            <li>Customize display size of user picture in menu bar.</li>
            <li>
              Customize display size of user pictures inside the menu itself.
            </li>
            <li>Define a hot key to drop back to the Login Window.</li>
            <li>
              Auto-launch applications, scripts or documents on switching to or
              from other users [<a href="faq/">more</a>].
            </li>
            <li>
              Faithfully replicate behaviour of Apple's Fast User Switching
              menu, including the display of non-local users.
            </li>
            <li>Eliminates known bugs in Apple Implementation.</li>
            <li>Open source component.</li>
            <li>
              Free (<a href="https://typechecked.net/a/products/winswitch/donate/"
                >donations gratefully accepted</a
              >).
            </li>
          </ul>
          ...
          <blockquote>
            &quot;... all the benefits of Fast User Switching without the
            excessive space requirements&quot;
          </blockquote>

          <p class="more">
            <a href="http://www.macworld.com/">Macworld</a> (<a
              href="http://www.macworld.com/2004/08/reviews/septembermacgems/"
              >Sep 2004</a
            >)
            <a href="http://www.macworld.com/2004/08/reviews/septembermacgems/">
              <img
                src="https://typechecked.net/a/products/winswitch/gfx/macworld-four-and-a-half-mice.gif"
                width="30"
                height="11"
                border="0"
                alt=""
      ...
      <div id="center">
        <div class="content">
          <h3>
            Fast User Switching without wasting valuable space in your Menu Bar
          </h3>
          ...
          <p>
            ...
            features that are not available on either Panther or Tiger (Mac OS X
            10.4).
          </p>

          <img
            src="https://typechecked.net/a/products/winswitch/screenshots/tiny-preview.gif"
            width="57"
            height="44"
            hspace="5"
            vspace="5"
          ...
          <p>
            ...
            compact, icon-sized Menu Bar icon? WinSwitch does exactly that,
            closely matching the performance and style of the Apple-provided
            menu, but without all the bulk. In fact, it even corrects some
            problems with Apple's menu by eliminating certain &quot;daemon&quot;
            users which shouldn't show up in the list, and by improving the
            alignment of user icons in the menu. WinSwitch gives you rapid
            access to the Accounts preference pane, and is completely
            customizable, allowing you to choose from six different menu bar
            styles:
          </p>
          ...
          <div class="screenshots">
            <a href="screenshots/"
              ><img
                src="https://typechecked.net/images/old/winswitch/gfx/standardIcon_t.gif"
                width="153"
                height="45"
                border="0"
                alt=""
            ...
            <a href="screenshots/"
              ><img
                src="https://typechecked.net/images/old/winswitch/gfx/userPicture_t.gif"
                width="153"
                height="45"
                border="0"
                alt=""
            ...
            <a href="screenshots/"
              ><img
                src="https://typechecked.net/images/old/winswitch/gfx/shortName_t.gif"
                width="153"
                height="45"
                border="0"
                alt=""
            ...
            <a href="screenshots/"
              ><img
                src="https://typechecked.net/images/old/winswitch/gfx/longName_t.gif"
                width="153"
                height="45"
                border="0"
                alt=""
            ...
            <a href="screenshots/"
              ><img
                src="https://typechecked.net/images/old/winswitch/gfx/firstName_t.gif"
                width="153"
                height="45"
                border="0"
                alt=""
            ...
            <a href="screenshots/"
              ><img
                src="https://typechecked.net/images/old/winswitch/gfx/initials_t.gif"
                width="153"
                height="45"
                border="0"
                alt=""
          ...
          <p>
            ...
            <a href="screenshots/"
              >include the all-powerful &quot;root&quot; user</a
            >
            in the list of users displayed in the menu,
            <a href="faq/">auto-launch documents, applications or scripts</a> on
            switching to and from other users, define a hot key to drop back to
            the login window, or tweak the display size of your user pictures
            (both in the menu bar and inside the menu itself) to your liking.
          </p>

          <p>
            WinSwitch is a complete rewrite of the
            <a href="http://www.codingmonkeys.de/map/log/archives/000047.html"
              >FUSe</a
            >
            Menu Extra released in November by
            <a href="http://www.codingmonkeys.de/map/">Martin Pittenauer</a> of
            <a href="http://www.codingmonkeys.de/">TheCodingMonkeys</a> under a
            BSD license. This is a total revision of the code base to bring the
            user experience much more closely in line with Apple's version. Like
            FUSe, WinSwitch is freeware and the source is available under a BSD
            license.
          </p>
          ...
          <blockquote>
            &quot;Easily the best user switching app out and a must have for any
            Panther user&quot;
          </blockquote>

          <blockquote>&quot;One word... GREAT&quot;</blockquote>

          <blockquote>&quot;Works wonderfully&quot;</blockquote>

          <div class="screenshots">
            <a href="http://www.versiontracker.com/dyn/moreinfo/macosx/22935"
              ><img
                src="https://typechecked.net/a/products/winswitch/gfx/versiontracker-ratings.gif"
                width="205"
                height="163"
                border="0"
                alt=""
            ...
            <p>
              <a href="http://www.versiontracker.com/dyn/moreinfo/macosx/22935"
                >5-star rating at VersionTracker</a
              >
            </p>

            <a href="http://www.macupdate.com/info.php/id/14580"
              ><img
                src="https://typechecked.net/a/products/winswitch/gfx/macupdate-ratings.gif"
                width="185"
                height="106"
                border="0"
                alt=""
          ...
          <p align="left" class="sectionBody">
            ...
            you will consider making a donation, no matter how small.
          </p>

          <p align="left" class="sectionBody">
            Another way in which to support development is to
            <a href="faq/">provide a language localization</a>.
          </p>

          <h4>Installation and removal instructions</h4>

          <p>
            To install WinSwitch, simply <a href="download/">download</a> and
            double-click the installer icon, then follow the instructions.
          </p>

          <p>
            Note that although WinSwitch is installed for all users on your
            system, other user accounts must first activate it by
            double-clicking the &quot;Activate WinSwitch&quot; command
            (installed into &quot;/Users/Shared/&quot;) the first time they wish
            it to appear in their menu bar. In subsequent sessions it will
            appear automatically. These requirements are explained at the end of
            the installation.
          </p>

          <p>
            To remove WinSwitch, run the installer again and click the
            &quot;Uninstall&quot; button.
          </p>

          <p>
            For more information about installing, uninstalling and how
            WinSwitch works with your system, see the <a href="faq/">FAQ</a>.
          </p>
        </div>
      </div>
      <div id="right">
