...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <div id="breadcrumbs">
    ...
    <div id="container">
      <div id="left">
        <div class="sidebar">
          ...
          <ul>
            ...
            <li>Show standard icon, user picture, short username, long username, first name only, or initials only in menu bar.</li>
            <li>Rapid access to Accounts preferences pane.</li>
            <li>Optionally include &quot;root&quot; user in list of users [<a href="faq/">more</a>].</li>
            <li>Customize display size of user picture in menu bar.</li>
            <li>Customize display size of user pictures inside the menu itself.</li>
            <li>Define a hot key to drop back to the Login Window.</li>
            <li>Auto-launch applications, scripts or documents on switching to or from other users [<a href="faq/">more</a>].</li>
      ...
      <div id="center">
        <div class="content">
          <h3>Fast User Switching without wasting valuable space in your Menu Bar</h3>
          ...
          <p>You can also optionally <a href="screenshots/">include the all-powerful &quot;root&quot; user</a> in the list of users displayed in the menu, <a href="faq/">auto-launch documents, applications or scripts</a> on switching to and from other users, define a hot key to drop back to the login window, or tweak the display size of your user pictures (both in the menu bar and inside the menu itself) to your liking.</p>
          
          <p>WinSwitch is a complete rewrite of the <a href="http://www.codingmonkeys.de/map/log/archives/000047.html">FUSe</a> Menu Extra released in November by <a href="http://www.codingmonkeys.de/map/">Martin Pittenauer</a> of <a href="http://www.codingmonkeys.de/">TheCodingMonkeys</a> under a BSD license. This is a total revision of the code base to bring the user experience much more closely in line with Apple's version. Like FUSe, WinSwitch is freeware and the source is available under a BSD license.</p>
          
          <h4>User quotes</h4>
          
          <blockquote>&quot;Easily the best user switching app out and a must have for any Panther user&quot;</blockquote>
          ...
          <p align="left" class="sectionBody">Another way in which to support development is to <a href="faq/">provide a language localization</a>.</p>
          
          <h4>Installation and removal instructions</h4>
          
          <p>To install WinSwitch, simply <a href="download/">download</a> and double-click the installer icon, then follow the instructions.</p>
          
          <p>Note that although WinSwitch is installed for all users on your system, other user accounts must first activate it by double-clicking the &quot;Activate WinSwitch&quot; command (installed into &quot;/Users/Shared/&quot;) the first time they wish it to appear in their menu bar. In subsequent sessions it will appear automatically. These requirements are explained at the end of the installation.</p>
          
          <p>To remove WinSwitch, run the installer again and click the &quot;Uninstall&quot; button.</p>
          
          <p>For more information about installing, uninstalling and how WinSwitch works with your system, see the <a href="faq/">FAQ</a>.</p>
