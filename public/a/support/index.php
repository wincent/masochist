...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;Support    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
      ...
      <div id="center">
        <div class="content">
          ...
          <p>The site <a href="faq/">FAQ</a> contains the answers to the most common general questions. Each <a href="../product/">product</a> also has its own FAQ page for questions specific to that product; to access, visit the specific <a href="../product/">product page</a> and click the link to the FAQ for that product.</p>
          
          <p class="more">Click <a href="faq/">here</a> to view the site FAQ</p>
          ...
          <ul>
            <li><em>Announcement mailing lists</em>: Low-volume lists (approximately one message per month) sent to advise of updates to existing products.</li>
            <li><em>Beta testing lists</em>: Discussion lists for those who wish to participate in a beta testing program for a Wincent product.</li>
          </ul>
