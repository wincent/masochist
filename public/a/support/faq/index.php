...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <div id="breadcrumbs">
    <p><a href="https://wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../">Support</a>&nbsp;&gt;&nbsp;FAQ    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
      ...
      <div id="center">
        <div class="content">
          ...
          <p>You can have your license code resent to you at any time by using the <a href="https://wincent.com/a/support/registration/form.php">lost license code form</a> (this is an automated system).</p>
          
          <p>Note that the automated systems apply to all Wincent products with the exception of <a href="http://install.wincent.com/">Install</a>; Install purchases are processed manually because they require special access to the Wincent server and must be set up manually. The expected processing times appear on the <a href="https://wincent.com/a/products/install/purchase/">Install purchase page</a>.</p>
