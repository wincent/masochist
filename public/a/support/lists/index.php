...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>wincent: mailing lists</title>
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../">Support</a>&nbsp;&gt;&nbsp;Lists    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
      ...
      <div id="center">
        <div class="content">
          ...
          <p>Due to the spam problem, all Wincent mailing lists are strictly "opt-in", meaning that the only way to join the lists is for you the user to subscribe to them personally. Wincent will never subscribe your address independently; you as the list user are responsible for subscribing (or unsubscribing) yourself.</p>
          
          <p>There are two types of mailing lists that you can join:</p>
          
          <h4>Announcement mailing lists</h4>
          
          <p>These are low-volume lists (approximately one message per month) sent to advise of updates to existing products. There is no "cross-posting" across these lists, which means that if you subscribe to the WinSwitch announcements list, for example, you will only ever receive notification of about new WinSwitch releases.</p>
          
          <h4>Beta testing lists</h4>
          
          <p>These are discussion lists for those who wish to participate in a beta testing program for a Wincent product. Once you subscribe to the list, you will receive notifications when new betas are available for download. If you discover an issue with the beta, you should first file a bug report at <a href="http://bugs.wincent.com/">bugs.wincent.com</a> (after searching for a pre-existing bug report for the same issue), and then post a message back to the list with a link to your bug report. In this way all beta testers can keep informed of the issue and contribute to tracking it down. When filing a bug report, please follow the guidelines listed at <a href="http://www.wincent.com/s/bugs/">http://www.wincent.com/s/bugs/</a>. These lists are moderated so as to filter out spam, but the volume of traffic may be higher than that of the announcement lists, depending on the number of active beta testers for that product.</p>
          
          <h4>How to subscribe, unsubscribe and look at the list archives</h4>
          
          <p>The mailing list interface is currently down for maintenance. As part of the server migration the old Mailman-powered mailing lists will be replaced with a custom Rails application. Please check back again soon.</p>
