...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>typechecked.net: email address update</title>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          ...
          you can use the form below. I will keep this information on file, but
          I won't be able to issue you with a new license-code or change your
          mailing list subscriptions for you (you must do that yourself).
        </p>

        <form
          action="https://typechecked.net/a/support/update-address/index.php"
          method="post"
        ...
        >
          <div align="center">
            <table border="0" cellpadding="5" cellspacing="0">
              ...
              <tr>
                ...
                <td>
                  ...
                  />
                  <br />
                  specify this information to demonstrate that you are the
                  purchaser
                </td>
              </tr>
              <tr>
            ...
            <textarea name="message" cols="55" rows="15" id="message">
optional comments</textarea
            ...
            <div>
              ...
              <input
                ...
                type="reset"
                id="clear"
                value="Clear form and start again"
              />
            </div>
          </div>
        </form>
