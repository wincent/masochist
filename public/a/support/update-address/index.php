...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>wincent.com: email address update</title>
    ...
    <div style="text-align: center; font-family: 'Lucida Grande'; margin: 5px 250px 5px 250px; padding: 5px; font-size: x-small; border: 2px solid silver; -webkit-border-radius: 0.5em; -moz-border-radius: 0.5em; background: #fefefe;">
      ...
      <tr>
        ...
        <td style="background-image: url(/a/gfx/header/center-background.jpg); background-repeat: repeat;" colspan="11" align="center" valign="middle">          <!-- Begin: header content -->
          ...
          <img src="/a/gfx/support-header.jpg" width="207" height="23" alt="update your email address" align="middle"/>
          <!-- End: header content -->
        </td>
  ...
  <div id="breadcrumbs">
    <p><a href="https://wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../">Support</a>&nbsp;&gt;&nbsp;Update Address    </p>
  </div>
    <div id="container">
      <div class="content">
        ...
        <p>If you want to notify me of a change of address, for my own records, you can use the form below. I will keep this information on file, but I won't be able to issue you with a new license-code or change your mailing list subscriptions for you (you must do that yourself).</p>
        
        <form action="https://wincent.com/a/support/update-address/index.php" method="post" enctype="multipart/form-data" name="update-address" id="update-address">
        <div align="center">
          <table border="0" cellpadding="5" cellspacing="0">
            <tr>
              <td align="right">Your full name:</td>
              <td>
                <input name="full-name" type="text" id="full-name" size="40" maxlength="100" />
              </td>
            </tr>
            <tr>
              <td align="right">Product(s) purchased:</td>
              <td>
                <select name="products[]" size="5" multiple="multiple">
                  <option value="Install">Install</option>
                  <option value="Synergy Classic">Synergy Classic</option>
                  <option value="Synergy Advance">Synergy Advance</option>
                  <option value="WinHex">WinHex</option>
                  <option value="WinSwitch">WinSwitch</option>
                </select>
              </td>
            </tr>
            <tr>
              <td align="right">Receipt, transaction number(s), or license code(s):</td>
              <td>
                <input name="receipt" type="text" id="receipt" size="40" maxlength="100" />
                <br />
                specify this information to demonstrate that you are the purchaser
              </td>
            </tr>
            <tr>
              <td align="right">Date(s) of purchase(s):</td>
              <td>
                <input name="date" type="text" id="date" size="40" maxlength="100" />
              </td>
            </tr>
            <tr>
              <td align="right">Old address: </td>
              <td>
                <input name="old-address" type="text" id="old-address" size="40" maxlength="100" />
                <br />
            ...
            <tr>
              ...
              <td>
                <input name="new-address" type="text" id="new-address" size="40" maxlength="100" />
                <br />
                a valid address is required
              </td>
            </tr>
        </table>
        <textarea name="message" cols="55" rows="15" id="message">optional comments</textarea>
        <div>
          <input name="submit" type="submit" id="submit" value="Send" />
          <input name="clear" type="reset" id="clear" value="Clear form and start again" />
        </div>
      </div>
    </form>
