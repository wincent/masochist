    ...
    <div id="container">
      ...
      <div id="center">
        <div class="content">
          ...
          <p>
            The
            <a href="https://wincent.dev/a/store/">Wincent store page</a>
            conveniently gathers purchase links for all major Wincent products.
            Each <a href="https://wincent.dev/a/products/">product</a> also has
            its own page for purchasing or making a donation; for example:
          </p>
          <ul>
            <li>
            ...
            <li>
              <a href="https://wincent.dev/a/products/wotest/">WOTest</a> (free,
              GPL license)
            </li>
            <li>
            ...
            <li>
              <a href="https://wincent.dev/a/products/atosym/">atosym</a> (free,
              GPL license)
            </li>
            <li>
          ...
          <p>
            Wincent uses automated systems so that customers receive their
            license codes via email as soon as they complete their payment. No
            human intervention is required so there should be no delays. Please
            see
            ...
            <a href="https://wincent.dev/a/support/faq/"
              >Frequently Asked Questions page</a
            >
            if you were expecting to receive a license code and have not yet
            received it.
          </p>
          ...
          <p>
            Prices for Wincent products are set in Euros because Wincent is
            based in Europe. During the payment process the product price will
            be converted into your local currency. There are no special fees for
            currency conversion.
          </p>
          ...
          <p>
            Wincent offers a choice of two payment processors,
            <a href="https://www.paypal.com/">PayPal</a> and
            <a href="http://www.kagi.com/">Kagi</a>. Please see
            <a href="https://wincent.dev/a/support/faq/#which">this question</a>
            on the
            <a href="https://wincent.dev/a/support/faq/"
              >Frequently Asked Questions page</a
            >
            for help in choosing a payment processor.
          </p>
        </div>
      </div>
      <div id="right">
