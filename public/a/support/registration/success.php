...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>wincent: lost license codes</title>
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../">Support</a>&nbsp;&gt;&nbsp;Registration    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
      ...
      <div id="center">
        <div class="content">
          ...
          <h3>Lost license codes</h3>
          
          
          <h4>Registration information successfully sent</h4>
          
          <p>The automated recovery system has located your registration information and has sent it to your registered email address. You should receive it shortly. Please remember to make both an electronic and a printed copy of the information for safe-keeping.</p>
          
          <p>If you do not receive the information within the next few minutes then you are advised to check that your email account is functioning correctly, that it is not over-quota, and that it is not protected by a challenge-response anti-spam mechanism. If none of these apply then it may just be that prevailing network conditions are causing a delay in the delivery of email to your mailserver, in which case the message should arrive when conditions improve.</p>
