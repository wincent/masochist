...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>wincent: Special offer</title>
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../">Store</a>&nbsp;&gt;&nbsp;Synergy Offer    </p>
  </div>
    <div id="container">
      <div class="content">
        ...
        <script type="text/javascript">
          ...
          function TestFormValues(formname)
          {
            ...
            if ((document[formname].fullname.value == "") ||
                (document[formname].registrant.value  == "") ||
                (document[formname].license.value == ""))
            {
              alert("You must enter a full name, registration address and license code");
              result = false;
            }
            else
            {
        ...
        <h3>Holiday Season 2006 Synergy offer</h3>
        
        <p>To celebrate the holiday season and get more people on board testing the preview releases of Synergy Advance Wincent is announcing a special offer during the month of December: <a href="https://secure.wincent.com/a/products/synergy-advance/purchase/">buy</a> a <a href="http://synergyadvance.com/">Synergy Advance</a> license and get a free <a href="http://synergy.wincent.com/">Synergy</a> license. This is a great opportunity to get a license for both products, or to use the complimentary Synergy license as a gift for somebody else.</p>
        
        <h4>Conditions</h4>
        
        <ul>
          <li>The offer applies to Synergy Advance licenses purchased between 1 and 31 of December 2006.</li>
          <li>In order to qualify you must purchase a full Synergy Advance license, not a discount one.</li>
          <li>All sales are final and refunds to not apply; please make sure that you take advantage of the free trial downloads of both products to thoroughly test them before making a purchase.</li>
        </ul>
        
        <h4>Fill out this form to request your complimentary license</h4>
        
        <form action="https://secure.wincent.com/a/store/synergy-offer/index.php" method="post" enctype="multipart/form-data" name="synergy-offer" id="synergy-offer" onSubmit="return TestFormValues('synergy-offer')">
        <div align="center">
          <table border="0" cellpadding="5" cellspacing="0">
            <tr>
              <td align="right">Your full name:</td>
              <td>
                <input name="fullname" type="text" id="fullname" size="40" maxlength="100" />
              </td>
            </tr>
            <tr>
              <td align="right">Synergy Advance registration email address: </td>
              <td>
                <input name="registrant" type="text" id="registrant" size="40" maxlength="100" />
                <br />
                specify the address you used at the time of purchase
              </td>
            </tr>
            <tr>
              <td align="right">Synergy Advance license code: </td>
              <td>
                <textarea name="license" cols="40" rows="5" id="license">Copy and paste license code here</textarea>
              </td>
            </tr>
            <tr>
              <td align="right">Recipient address: </td>
              <td>
                  <input name="recipient" type="text" id="recipient" size="40" maxlength="100" />
                  <br />
                  the address to which the complimentary license should be sent
              </td>
            </tr>
            <tr>
              <td align="right">This is a gift:</td>
              <td>
                <input name="gift" type="checkbox" id="gift" value="gift" />
                <br />
                if this is a gift, the license will be sent to the recipient address along with a note saying the license is a gift from "Your full name"
              </td>
            </tr>
        </table>
        <div>
