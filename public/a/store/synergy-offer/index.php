...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <table border="0" align="center" cellspacing="0" cellpadding="0" width="832">
      ...
      <tr id="menu-bar">
        ...
        <td width="48" height="25"><a href="https://wincent.com/a/store/" title="Wincent online store"><img src="/a/gfx/header/store-on.jpg" width="48" height="25" alt="Store" /></a></td>
  ...
  <div id="breadcrumbs">
    <p><a href="https://wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../">Store</a>&nbsp;&gt;&nbsp;Synergy Offer    </p>
  </div>
    <div id="container">
      <div class="content">
        ...
        <form action="https://wincent.com/a/store/synergy-offer/index.php" method="post" enctype="multipart/form-data" name="synergy-offer" id="synergy-offer" onSubmit="return TestFormValues('synergy-offer')">
        <div align="center">
