    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          ...
          the preview releases of Synergy Advance Wincent is announcing a
          special offer during the month of December:
          ...
          get a free <a href="http://synergy.wincent.com/">Synergy</a> license.
        ...
        <ul>
          <li>
            The offer applies to Synergy Advance licenses purchased between 1
            and 31 of December 2006.
          </li>
          <li>
            In order to qualify you must purchase a full Synergy Advance
            license, not a discount one.
          </li>
          <li>
            All sales are final and refunds to not apply; please make sure that
            you take advantage of the free trial downloads of both products to
            thoroughly test them before making a purchase.
          </li>
        </ul>
        ...
        <form
          action="https://wincent.com/a/store/synergy-offer/index.php"
          method="post"
          enctype="multipart/form-data"
          name="synergy-offer"
          id="synergy-offer"
          onSubmit="return TestFormValues('synergy-offer')"
        >
          <div align="center">
            <table border="0" cellpadding="5" cellspacing="0">
              ...
              <tr>
                <td align="right">
                  Synergy Advance registration email address:
                </td>
                <td>
                  <input
                    name="registrant"
              ...
              <tr>
                ...
                <td>
                  <textarea name="license" cols="40" rows="5" id="license">
Copy and paste license code here</textarea
                  >
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  ...
                  <br />
                  if this is a gift, the license will be sent to the recipient
                  address along with a note saying the license is a gift from
                  "Your full name"
                </td>
              </tr>
            </table>
