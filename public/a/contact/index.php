  ...
  <body>
    <div style="text-align: center; font-family: 'Lucida Grande'; margin: 5px 250px 5px 250px; padding: 5px; font-size: x-small; border: 2px solid silver; -webkit-border-radius: 0.5em; -moz-border-radius: 0.5em; background: #fefefe;">
      ...
      <tr id="menu-bar">
        ...
        <td width="62" height="25"><a href="http://www.wincent.com/a/contact/" title="Contact email form"><img src="/a/gfx/header/contact-on.jpg" width="62" height="25" alt="Contact" /></a></td>
  ...
  <div id="breadcrumbs">
    ...
    <div id="container">
      <div class="content">
        ...
        <ul>
          <li>Check out the site's <a href="http://www.wincent.com/a/support/faq/">Frequently Asked Questions</a></li>
          <li>Look at the documentation for a specific <a href="http://www.wincent.com/a/products/">product</a>: every Wincent product has a Frequently Asked Questions page as well as detailed documentation.</li>
          <li>Talk to other users on the <a href="http://forums.wincent.com/">support and discussion forums</a></li>
          <li>Visit the <a href="http://www.wincent.com/a/news/">news page</a> to see if there are any known issues that have recently been discovered</li>
        ...
        <p>In summary:</p>
        <ul>
          <li>Your mailing list subscriptions are completely independent of your registration, and you can <a href="http://www.wincent.com/a/support/lists/">change them at will</a>.</li>
          ...
          <li>If you want to notify me of a change of address, for my own records, you can use <a href="http://www.wincent.com/a/support/update-address/">this form</a>. I will keep this information on file, but I won't be able to issue you with a new license-code or change your mailing list subscriptions for you (you must do that yourself).</li>
        </ul>
        <h4>I want to report a problem with the website</h4>
        <p>If you're having trouble finding things on the website try looking on the <a href="http://www.wincent.com/a/site-map/">Site map</a> or performing a <a href="http://www.wincent.com/a/site-map/search/">Search.</a></p>
