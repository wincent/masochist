...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../">Contact</a>&nbsp;&gt;&nbsp;Mail    </p>
  </div>
    <div id="container">
      <div class="content">
        ...
        <script type="text/javascript">
          ...
          {
            var result;
            if ((document[formname].subject.value == "") ||
                (document[formname].sender.value  == "") ||
                (document[formname].message.value == ""))
            {
              alert("You must enter a subject, return address and message");
              result = false;
            }
            else
            {
        ...
        <h3>Contacting wincent</h3>
        
        <p>The typical response time for emails is approximately one business day (but please check the <a href="http://www.wincent.com/a/news/">news</a> page for any news items about possible delays).</p>
        
        <p>If you have a support enquiry, <strong>do not use this form</strong>. Please see the <a href="http://www.wincent.com/a/support/">support pages</a> and if necessary open a support ticket. You will receive support more quickly by opening a support ticket because it not only generates an email message but also collects and stores useful trouble-shooting information in a database to better track the issue.</p>
        
        <p>Similarly, you should consult the <a href="https://secure.wincent.com/a/support/registration/">license code retrieval system</a> before contacting Wincent with lost registration inquiries.</p>
        
        <h4>A word about spam protection</h4>
        
        <p>The Wincent mailserver is protected by a strict set of anti-spam technologies, including <a href="http://www.spamassassin.org/">SpamAssassin</a> filtering. If you find that your email is returned to you as a result of one of these protections, you may use this email form to make contact.</p>
        
        <form action="http://www.wincent.com/a/contact/mail/index.php" method="post" enctype="multipart/form-data" name="email" id="email" onSubmit="return TestFormValues('email')">
        <div align="center">
          <table border="0" cellpadding="5" cellspacing="0">
            <tr>
              <td>To: </td>
              <td>Wincent Colaiuta</td>
            </tr>
            <tr>
              <td>Subject: </td>
              <td><input name="subject" type="text" id="subject" size="40" maxlength="100" />
              </td>
            </tr>
            <tr>
              <td>From:</td>
              <td>
                  <input name="sender" type="text" id="sender" value="your address here" size="40" maxlength="100" /><br />
                  A valid return address is required (<a href="http://www.wincent.com/a/about/privacy/">privacy policy</a>);<br />
                  your IP address (52.202.171.200) will be sent along with your message.
              </td>
            </tr>
        </table>
        <textarea name="message" cols="55" rows="15" id="message"></textarea>
        <div>
