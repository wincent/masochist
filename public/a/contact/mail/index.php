...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <div id="breadcrumbs">
    <p><a href="https://wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../">Contact</a>&nbsp;&gt;&nbsp;Mail    </p>
  </div>
    <div id="container">
      <div class="content">
        ...
        <p>The typical response time for emails is approximately one business day (but please check the <a href="https://wincent.com/a/news/">news</a> page for any news items about possible delays).</p>
        
        <p>If you have a support enquiry, <strong>do not use this form</strong>. Please see the <a href="https://wincent.com/a/support/">support pages</a> and if necessary open a support ticket. You will receive support more quickly by opening a support ticket because it not only generates an email message but also collects and stores useful trouble-shooting information in a database to better track the issue.</p>
        
        <p>Similarly, you should consult the <a href="https://wincent.com/a/support/registration/">license code retrieval system</a> before contacting Wincent with lost registration inquiries.</p>
        ...
        <form action="https://wincent.com/a/contact/mail/index.php" method="post" enctype="multipart/form-data" name="email" id="email" onSubmit="return TestFormValues('email')">
        <div align="center">
          <table border="0" cellpadding="5" cellspacing="0">
            ...
            <tr>
              ...
              <td>
                  ...
                  A valid return address is required (<a href="https://wincent.com/a/about/privacy/">privacy policy</a>);<br />
