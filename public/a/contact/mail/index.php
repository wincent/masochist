  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          The typical response time for emails is approximately one business day
          (but please check the
          <a href="https://typechecked.net/a/news/">news</a> page for any news items
          about possible delays).
        </p>

        <p>
          If you have a support enquiry, <strong>do not use this form</strong>.
          Please see the
          <a href="https://typechecked.net/a/support/">support pages</a> and if
          necessary open a support ticket. You will receive support more quickly
          by opening a support ticket because it not only generates an email
          message but also collects and stores useful trouble-shooting
          information in a database to better track the issue.
        </p>

        <p>
          Similarly, you should consult the
          <a href="https://typechecked.net/a/support/registration/"
            >license code retrieval system</a
          >
          before contacting Wincent with lost registration inquiries.
        </p>

        <h4>A word about spam protection</h4>

        <p>
          The Wincent mailserver is protected by a strict set of anti-spam
          technologies, including
          <a href="http://www.spamassassin.org/">SpamAssassin</a> filtering. If
          you find that your email is returned to you as a result of one of
          these protections, you may use this email form to make contact.
        </p>

        <form
          action="https://typechecked.net/a/contact/mail/index.php"
          method="post"
          enctype="multipart/form-data"
          name="email"
          id="email"
          onSubmit="return TestFormValues('email')"
        >
          <div align="center">
              ...
              <tr>
                ...
                <td>
                  <input
                    ...
                    maxlength="100"
                  /><br />
                  A valid return address is required (<a
                    href="https://typechecked.net/a/about/privacy/"
                    >privacy policy</a
                  >);<br />
                  your IP address (52.202.171.200) will be sent along with your
                  message.
                </td>
              </tr>
            </table>
