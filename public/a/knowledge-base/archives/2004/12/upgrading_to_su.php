...
<title>Knowledge base: Upgrading to Subversion 1.1.2</title>
...
<link rel="prev" href="https://wincent.com/a/knowledge-base/archives/2004/12/messaging_nil.php" title="Messaging nil" />

<link rel="next" href="https://wincent.com/a/knowledge-base/archives/2005/04/upgrading_to_su_1.php" title="Upgrading to Subversion 1.1.4" />
...
<p align="right">
<a href="https://wincent.com/a/knowledge-base/archives/2004/12/messaging_nil.php">&laquo; Messaging nil</a> |

<a href="https://wincent.com/a/knowledge-base/">Main</a>
| <a href="https://wincent.com/a/knowledge-base/archives/2005/04/upgrading_to_su_1.php">Upgrading to Subversion 1.1.4 &raquo;</a>

</p>

<h2>December 21, 2004</h2>

<h3>Upgrading to Subversion 1.1.2</h3>

<p>This article describes how to upgrade from <a href="http://subversion.tigris.org/">Subversion</a> 1.1.0 (or 1.1.1) to the <a href="http://subversion.tigris.org/servlets/NewsItemView?newsItemID=984">just-released 1.1.2</a>. The original installation of 1.1.0 was covered in <a href="https://wincent.com/a/knowledge-base/archives/2004/11/building_subver.php">this article</a>.</p>

<div id="a000040more"><div id="more">
<p>These instructions assume that you have the Xcode Tools installed, and they use <a href="https://wincent.com/a/knowledge-base/archives/2004/11/building_wget_f.php">wget</a> to grab the source.</p>
...
<p>One thing to note: the <a href="http://svn.collab.net/repos/svn/tags/1.1.2/CHANGES">change log</a> states that 1.1.2 "adds support for BerkeleyDB 4.3". The previous lack of support for 4.3 was something I stumbled across <a href="https://wincent.com/a/knowledge-base/archives/2004/11/building_subver.php">last time</a>. Nevertheless, even if some support has been added under the hood, the build process failed if I tried using the following configure option:</p>

<pre>./configure --with-berkeley-db=/usr/local/BerkeleyDB.4.3</pre>

<p>As such, I am not really sure what the note about 4.3 in the changelog means. The Subversion issue tracker has <a href="http://subversion.tigris.org/issues/show_bug.cgi?id=2120">an issue</a> about this, but it's currently marked as being slated for version 1.3, which is still a long way off.</p>
</div></div>

<p class="posted">Posted by wincent at December 21, 2004 11:41 PM</p>
