...
<link rel="prev" href="http://www.wincent.com/a/knowledge-base/archives/2004/11/building_eeaee.php" title="Building ee/aee on Mac OS X 10.3" />

<link rel="next" href="http://www.wincent.com/a/knowledge-base/archives/2004/11/how_to_file_a_g.php" title="How to file a good bug report" />
...
<p align="right">
<a href="http://www.wincent.com/a/knowledge-base/archives/2004/11/building_eeaee.php">&laquo; Building ee/aee on Mac OS X 10.3</a> |

<a href="http://www.wincent.com/a/knowledge-base/">Main</a>
| <a href="http://www.wincent.com/a/knowledge-base/archives/2004/11/how_to_file_a_g.php">How to file a good bug report &raquo;</a>

</p>

<h2>November 21, 2004</h2>

<h3>Building wget from CVS on Mac OS X 10.3</h3>

<p>I am a big fan of the powerful <a href="http://www.gnu.org/software/wget/wget.html">wget</a> command-line downloading tool. It's been a while since version 1.9.1 came out, so I am posting instructions here on how to pull down the latest source using CVS and build it on Mac OS X 10.3.</p>

<div id="a000024more"><div id="more">
<p>Of course, there are no guarantees that this will work on your machine, given that the files in the CVS may have changed by the time you follow these instructions, but it's fairly likely that things will work. You'll need to have installed Apple's Xcode Tools. Lines beginning with a hash/pound symbol (#) are comments and don't need to be typed in.</p>

<pre># make a working directory
mkdir wget
cd wget
<br />
# pull down the latest source; the cvs password is "cvs"
cvs -d :pserver:cvs@sunsite.dk:/pack/anoncvs login
cvs -d :pserver:cvs@sunsite.dk:/pack/anoncvs checkout wget
<br />
# prepare support materials needed for build
cd wget
make -f Makefile.cvs
<br />
# do the actual build
...
<p>The wget executable is by default installed into /usr/local. You can read a summary of the options by typing "wget --help" at the command line, or read the full manual page by typing "man wget".</p>
</div></div>

<p class="posted">Posted by wincent at November 21, 2004  5:00 AM</p>
