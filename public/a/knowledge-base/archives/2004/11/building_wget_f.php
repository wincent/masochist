    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/knowledge-base/archives/2004/11/building_eeaee.php"
            >&laquo; Building ee/aee on Mac OS X 10.3</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/knowledge-base/archives/2004/11/how_to_file_a_g.php"
            >How to file a good bug report &raquo;</a
          >
        </p>
        ...
        <p>
          I am a big fan of the powerful
          <a href="http://www.gnu.org/software/wget/wget.html">wget</a>
          command-line downloading tool. It's been a while since version 1.9.1
          came out, so I am posting instructions here on how to pull down the
          latest source using CVS and build it on Mac OS X 10.3.
        </p>

        <div id="a000024more">
          <div id="more">
            <p>
              Of course, there are no guarantees that this will work on your
              machine, given that the files in the CVS may have changed by the
              time you follow these instructions, but it's fairly likely that
              things will work. You'll need to have installed Apple's Xcode
              Tools. Lines beginning with a hash/pound symbol (#) are comments
              and don't need to be typed in.
            </p>
...
sudo make install</pre>
            ...
            <p>
              The wget executable is by default installed into /usr/local. You
              can read a summary of the options by typing "wget --help" at the
              command line, or read the full manual page by typing "man wget".
            </p>
          </div>
        </div>
