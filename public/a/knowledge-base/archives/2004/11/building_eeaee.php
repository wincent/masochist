...
<title>Knowledge base: Building ee/aee on Mac OS X 10.3</title>
...
<link rel="prev" href="http://www.wincent.com/a/knowledge-base/archives/2004/11/building_subver.php" title="Building Subversion 1.1.0 on Mac OS X 10.3" />

<link rel="next" href="http://www.wincent.com/a/knowledge-base/archives/2004/11/building_wget_f.php" title="Building wget from CVS on Mac OS X 10.3" />
...
<p align="right">
<a href="http://www.wincent.com/a/knowledge-base/archives/2004/11/building_subver.php">&laquo; Building Subversion 1.1.0 on Mac OS X 10.3</a> |

<a href="http://www.wincent.com/a/knowledge-base/">Main</a>
| <a href="http://www.wincent.com/a/knowledge-base/archives/2004/11/building_wget_f.php">Building wget from CVS on Mac OS X 10.3 &raquo;</a>

</p>

<h2>November 21, 2004</h2>

<h3>Building ee/aee on Mac OS X 10.3</h3>

<p>I consider ee, the Easy Editor, and its feature-enhanced counterpart, aee, to be "must haves" on any Mac OS X installation. This brief article tells you how to build the from <a href="http://www.users.qwest.net/~hmahon/sources/">source</a>. At the time of writing the latest versions are <a href="http://www.users.qwest.net/~hmahon/sources/ee-1.4.2.src.tgz">ee 1.4.2</a> and <a href="http://www.users.qwest.net/~hmahon/sources/aee-2.2.3.tar.gz">aee 2.2.3</a>.</p>

<div id="a000025more"><div id="more">
<p>You'll need to have the Xcode Tools installed on your system. Optionally, you'll also need <a href="http://www.wincent.com/a/knowledge-base/archives/2004/11/building_wget_f.php">wget</a> to download the source archives. Lines beginning with the hash/pound symbol (#) are comments which don't need to be entered.</p>

<p>To download, build and install ee into /usr/local/bin:</p>

<pre># fetch, extract and build
...
<p>To download, build and install aee into /usr/local/bin:</p>

<pre># much the same as the ee build...
...
<p class="posted">Posted by wincent at November 21, 2004 04:08 AM</p>
