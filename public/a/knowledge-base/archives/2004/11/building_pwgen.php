...
<title>Knowledge base: Building pwgen on Mac OS X 10.3</title>
...
<link rel="prev" href="http://www.wincent.com/a/knowledge-base/archives/2004/11/using_md5_to_ve.php" title="Using MD5 or SHA1 to verify the integrity of your downloads" />

<link rel="next" href="http://www.wincent.com/a/knowledge-base/archives/2004/11/building_subver.php" title="Building Subversion 1.1.0 on Mac OS X 10.3" />
...
<p align="right">
<a href="http://www.wincent.com/a/knowledge-base/archives/2004/11/using_md5_to_ve.php">&laquo; Using MD5 or SHA1 to verify the integrity of your downloads</a> |

<a href="http://www.wincent.com/a/knowledge-base/">Main</a>
| <a href="http://www.wincent.com/a/knowledge-base/archives/2004/11/building_subver.php">Building Subversion 1.1.0 on Mac OS X 10.3 &raquo;</a>

</p>

<h2>November 21, 2004</h2>

<h3>Building pwgen on Mac OS X 10.3</h3>

<p><a href="http://sourceforge.net/projects/pwgen/">pwgen</a> is a handy command-line tool to generate passwords with a number of options that control the complexity, length and number of the generated passwords. This article shows how to build pwgen on Mac OS X 10.3 using the latest source at the time of writing, <a href="http://puzzle.dl.sourceforge.net/sourceforge/pwgen/pwgen-2.03.tar.gz">pwgen 2.03</a>.</p>

<div id="a000026more"><div id="more">
<p>As per usual, you need the Xcode Tools installed, and <a href="http://www.wincent.com/a/knowledge-base/archives/2004/11/building_wget_f.php">wget</a> if you want to use that to pull down the source archive. Lines beginning with hash/pound (#) are comments and don't need to be entered:</p>

<pre># make working directory
mkdir pwgen
cd pwgen
<br />
# fetch, extract and build the source
wget http://puzzle.dl.sourceforge.net/sourceforge/pwgen/pwgen-2.03.tar.gz
tar xzvf pwgen-2.03.tar.gz 
cd pwgen-2.03/
./configure
make
<br />
...
./pwgen -h
<br />
# install the built executable (into /usr/local/bin/)
sudo make install</pre>
</div></div>

<p class="posted">Posted by wincent at November 21, 2004 03:16 AM</p>
