...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      ...
      title="Building Subversion 1.1.0 on Mac OS X 10.3"
    />
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/knowledge-base/archives/2004/11/using_md5_to_ve.php"
            >&laquo; Using MD5 or SHA1 to verify the integrity of your
            downloads</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/knowledge-base/archives/2004/11/building_subver.php"
            >Building Subversion 1.1.0 on Mac OS X 10.3 &raquo;</a
          >
        </p>
        ...
        <p>
          <a href="http://sourceforge.net/projects/pwgen/">pwgen</a> is a handy
          command-line tool to generate passwords with a number of options that
          control the complexity, length and number of the generated passwords.
          This article shows how to build pwgen on Mac OS X 10.3 using the
          latest source at the time of writing,
          <a
            href="http://puzzle.dl.sourceforge.net/sourceforge/pwgen/pwgen-2.03.tar.gz"
            >pwgen 2.03</a
          >.
        </p>
        ...
        <div id="a000026more">
          <div id="more">
            <p>
              As per usual, you need the Xcode Tools installed, and
              <a
                href="https://typechecked.net/a/knowledge-base/archives/2004/11/building_wget_f.php"
                >wget</a
              >
              if you want to use that to pull down the source archive. Lines
              beginning with hash/pound (#) are comments and don't need to be
              entered:
            </p>
