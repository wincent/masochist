      ...
      <div class="content">
        ...
        <div id="a000337more">
          <div id="more">
            ...
            <pre>
sudo ssh -L 143:typechecked.net:143 \
         -L 110:typechecked.net:110 \
         -L 25:typechecked.net:25   \
         robinson@example.com</pre
            ...
            <pre>
sudo ssh -L 10143:typechecked.net:143 \
         -L 10110:typechecked.net:110 \
         -L 10025:typechecked.net:25   \
         robinson@example.com</pre
            >

            <p>
              These commands basically say, "Log in via SSH to my account,
              <tt>robinson</tt> on the host <tt>typechecked.net</tt>; forward any
            ...
            <p>
              ...
              Instead of connecting to <tt>typechecked.net</tt> port 143, it will
            ...
            <p>
              ...
              <a
                href="https://typechecked.net/wiki/Using_Stunnel_to_secure_SMTP_transport"
                >Stunnel</a
            ...
            <p>
              ...
              running at <tt>typechecked.net</tt> (actually the same machine as the
...
cp imapd.pem sendmail.pem</pre
            ...
            <p>
              ...
              case, <tt>typechecked.net</tt>). This is because third parties
...
define(`confSERVER_KEY',`/usr/share/ssl/certs/sendmail.pem')dnl</pre
            ...
            <p>
              ...
              can do a <tt>telnet typechecked.net 25</tt> and see if it lists
              STARTTLS in response to <tt>ehlo typechecked.net</tt>. When testing
            ...
            <p>
              ...
              (in my case, <tt>typechecked.net</tt>), the new ports (993 and 995),
