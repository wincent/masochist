...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Knowledge base: WordPress security tip</title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/knowledge-base/archives/2006/06/wordpress_updat.php"
            >&laquo; WordPress updates via Subversion</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/knowledge-base/archives/2006/06/freshclam_probl.php"
            >freshclam: "Problem with internal logger" &raquo;</a
          >
        </p>

        <h2>June 02, 2006</h2>

        <h3>WordPress security tip</h3>
...
&lt;/FilesMatch&gt;</pre
        ...
        <p>
          ...
          document root entirely and <tt>include</tt> or <tt>require</tt> it but
          that would require you to turn off
          <a href="http://www.php.net/features.safe-mode">PHP Safe Mode</a>
          and/or the <tt>open_basedir</tt> restriction, which I don't recommend
          with a product like WordPress which is both popular and has a
          less-than-perfect security record.
        </p>

        <div id="a000346more"><div id="more"></div></div>

        <p class="posted">Posted by wincent at June 2, 2006 06:55 PM</p>
      </div>
    </div>
