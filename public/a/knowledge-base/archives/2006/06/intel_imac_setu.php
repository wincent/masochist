...
sudo make install</pre>
            ...
            <p>
              ...
              <a href="https://typechecked.net/gpl/pstree-2.27.tar.gz">here</a>. To
              build it, you would follow a procedure like this one:
            </p>

            <pre># get the source
wget https://typechecked.net/gpl/pstree-2.27.tar.gz
<br />
# extract
...
cd httpd-2.0.58/
<br />
# workaround <a href="https://typechecked.net/a/knowledge-base/archives/2005/07/upgrading_to_su_2.php">APR bug</a> (see Subversion 
...
<br />
# workaround <a href="https://typechecked.net/a/knowledge-base/archives/2005/07/upgrading_to_su_2.php">APR bug</a> (see Subversion FAQ)
ac_cv_func_poll=no; export ac_cv_func_poll
<br />
# configure and build
sh ./autogen.sh
