    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.com/a/knowledge-base/archives/2006/06/wordpress_secur.php"
            >&laquo; WordPress security tip</a
          >
          |
...
ERROR: Problem with internal logger.</pre>
        ...
        <div id="a000349more">
          <div id="more">
            <p>
              The solution? Kill the process and run <tt>freshclam</tt> manually
              (slightly edited to shorten long lines):
            </p>
...
Clamd successfully notified about the update.</pre
            ...
            <p>
              This is what I saw in the <tt>/var/log/freshclam.log</tt> file;
              firstly, the last successful update:
            </p>
...
ClamAV update process started at Fri Jun  9 17:01:01 2006</pre
            ...
            <p>
              Finally, the manual update performed after killing the hung
              process:
            </p>
