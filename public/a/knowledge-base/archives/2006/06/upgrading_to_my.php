...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Knowledge base: Upgrading to MySQL 4.1.20 on Red Hat Enterprise Linux 3
    </title>
    ...
    <link
      ...
      title="SSH tunneling and secure IMAP, POP3 and SMTP"
    />
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.com/a/knowledge-base/archives/2006/05/ssh_tunneling_a.php"
            >&laquo; SSH tunneling and secure IMAP, POP3 and SMTP</a
          >
          |
          ...
          <a
            href="https://wincent.com/a/knowledge-base/archives/2006/06/subversion_131_1.php"
            >Subversion 1.3.1 to 1.3.2 upgrade notes &raquo;</a
          >
        </p>
...
sudo chkconfig --list | grep mysql</pre>
            ...
            <p>
              And it would be even easier if it could be handled by
              <tt>up2date</tt> like the rest of the system. Human intervention
              is only required in this case because RHEL ES 3 only ships with
              MySQL 3.23 by default. If you want the features of the 4.1 series
