...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Knowledge base: Avoiding protocol-related warnings</title>
    ...
    <link
      ...
      title='Eliminating "X-Authentication-Warning" headers from Squirrelmail'
    />
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/knowledge-base/archives/2006/02/unit_testing_gu.php"
            >&laquo; Unit testing guidelines</a
          >
          |
        ...
        <h3>Avoiding protocol-related warnings</h3>
        ...
        <div id="a000224more">
          <div id="more">
            <p>
              If you have code that looks like this (showing the header content
...
@end</pre>
            ...
            <p>
              GCC will generate a warning at compile time that
              <tt>MyClass</tt> seems to be missing a method implementation
              required by <tt>MyProtocol</tt>. You can suppress these warnings
              using the <tt>-Wno-protocol</tt> switch; from the GCC man page:
            </p>
...
sidered to be implemented, and no warning is issued for them.</pre
            ...
            <p>
              There are reasons why you might actually want to see these
              warnings which I won't go into here (for more info check the
              <a href="http://lists.apple.com/mailman/listinfo/objc-language"
                >objc-language mailing list</a
              >
              archives), but if you're sure that you want to be rid of them,
              then the <tt>-Wno-protocol</tt> switch is for you. It certainly
              beats declaring a bunch of methods like this in your subclass:
            </p>
...
@end</pre>
            ...
            <p>
              And in many cases it is better than the alternative of dumping the
              formal protocol and opting for an informal one (defined as a
              category in a parent or root class) instead.
            </p>
          </div>
        </div>

        <p class="posted">Posted by wincent at March 1, 2006 02:16 PM</p>
      </div>
    </div>
