...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Knowledge base: Eliminating "X-Authentication-Warning" headers from
      Squirrelmail
    </title>
    ...
    <link
      ...
      title="Subversion 1.3.1 upgrade notes"
    />
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://typechecked.net/a/knowledge-base/archives/2006/03/avoiding_protoc.php"
            >&laquo; Avoiding protocol-related warnings</a
          >
          |
          ...
          <a
            href="https://typechecked.net/a/knowledge-base/archives/2006/04/subversion_131.php"
            >Subversion 1.3.1 upgrade notes &raquo;</a
          >
        </p>
...
X-Authentication-Warning: s69819.example.com: apache set sender to user@example.com using -f</pre
            ...
            <p>
              In order to overcome this you need to have the "trusted users"
              feature enabled in <a href="http://sendmail.org/">Sendmail</a> (I
              believe it is by default in
              <a
            ...
            <p>
              Then all that has to be done is to add "apache" to
              <tt>/etc/mail/trusted-users</tt> and rebuild the Sendmail
              configuration (if you changed it). I also stopped and restarted
              Sendmail for good measure; not sure if that's required.
            </p>
          </div>
        </div>

        <p class="posted">Posted by wincent at March 9, 2006 02:04 PM</p>
      </div>
    </div>
