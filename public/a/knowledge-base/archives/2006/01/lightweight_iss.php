...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Knowledge base: Lightweight issue tracking</title>
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.dev/a/knowledge-base/archives/2006/01/locking_doublec.php"
            >&laquo; Locking, double-checked locking and speed</a
          >
          |
          ...
          <a
            href="https://wincent.dev/a/knowledge-base/archives/2006/02/unit_testing_gu.php"
            >Unit testing guidelines &raquo;</a
          >
        </p>

        <h2>January 27, 2006</h2>

        <h3>Lightweight issue tracking</h3>
        ...
        <p>
          If I later want to find all of the TODO items I can use Xcode's "Find
          In Project..." functionality or I can grep from the command-line. For
          this purpose I have the following function defined in my
          <tt>~/.bash_profile</tt>:
        </p>
  ...
  if [ $# -lt 1 ]; then
    ...
    do
      ...
      shift
            ...
            <p>
              I can then use the function to grep for TODO items in the current
              directory, in a specific file (or files), or in a specific
...
$ todo SynergyAdvanceFramework synergyd</pre
            ...
            <p>
              I'll then see a list of matching file names, line numbers, and the
              TODO items themselves. Items in <tt>.svn</tt> directories are
              filtered from the output. If no arguments are supplied then the
              function starts the grep in the current directory. The output will
              look like this:
            </p>

            <pre>
./WOITunesController.m:1683:    // TODO: add caching for this value</pre
            >

            <p>
              So that's lightweight issue tracking. You can do the same with
              bugs using a function like this:
            </p>
  ...
  if [ $# -lt 1 ]; then
    ...
    do
      ...
      shift
        ...
        <p class="posted">Posted by wincent at January 27, 2006 02:23 PM</p>
      </div>
    </div>
