...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      Knowledge base: Upgrading to Subversion 1.2.1 on Mac OS X 10.4.2
    </title>
    ...
    <link
      ...
      title="Building Universal Binaries"
    />
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.com/a/knowledge-base/archives/2005/05/disaster_recove.php"
            >&laquo; Disaster recovery notes</a
          >
          |
          ...
          <a
            href="https://wincent.com/a/knowledge-base/archives/2005/07/building_univer.php"
            >Building Universal Binaries &raquo;</a
          >
        </p>
        ...
        <p>
          Today I upgraded my local
          <a href="http://subversion.tigris.org/">Subversion</a> install from
          version 1.2 to 1.2.1. Here are some notes I made during the process.
          Curiously, this time I didn't have any problems building with GCC 4.0
          like I did
          <a
...
sudo /usr/local/apache2/bin/apachectl start</pre>
            ...
            <p>
              [Update: I later found out that I had to rebuild Apache as well in
              order to work around the APR bug]
            </p>
          </div>
        </div>
