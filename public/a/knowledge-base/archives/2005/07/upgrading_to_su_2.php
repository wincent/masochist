...
<title>Knowledge base: Upgrading to Subversion 1.2.1 on Mac OS X 10.4.2</title>
...
<link rel="prev" href="http://www.wincent.com/a/knowledge-base/archives/2005/05/disaster_recove.php" title="Disaster recovery notes" />

<link rel="next" href="http://www.wincent.com/a/knowledge-base/archives/2005/07/building_univer.php" title="Building Universal Binaries" />
...
<p align="right">
<a href="http://www.wincent.com/a/knowledge-base/archives/2005/05/disaster_recove.php">&laquo; Disaster recovery notes</a> |

<a href="http://www.wincent.com/a/knowledge-base/">Main</a>
| <a href="http://www.wincent.com/a/knowledge-base/archives/2005/07/building_univer.php">Building Universal Binaries &raquo;</a>

</p>

<h2>July 15, 2005</h2>

<h3>Upgrading to Subversion 1.2.1 on Mac OS X 10.4.2</h3>

<p>Today I upgraded my local <a href="http://subversion.tigris.org/">Subversion</a> install from version 1.2 to 1.2.1. Here are some notes I made during the process. Curiously, this time I didn't have any problems building with GCC 4.0 like I did <a href="http://www.wincent.com/a/knowledge-base/archives/2005/05/building_subver_1.php">last time</a>. Never really got to the bottom of that one...</p>

<div id="a000117more"><div id="more">
<pre># grab and unpack the source
wget http://subversion.tigris.org/downloads/subversion-1.2.1.tar.gz
tar xzvf subversion-1.2.1.tar.gz 
cd subversion-1.2.1/
<br />
# stop the server
sudo /usr/local/apache2/bin/apachectl stop
<br />
# clean up libraries from previous versions
...
<br />
# work around APR bug (see Subversion FAQ)
...
<p>[Update: I later found out that I had to rebuild Apache as well in order to work around the APR bug]</p>
</div></div>

<p class="posted">Posted by wincent at July 15, 2005 08:49 PM</p>
