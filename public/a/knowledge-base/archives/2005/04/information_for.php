...
<title>Knowledge base: Information for beta testers</title>
...
<link rel="prev" href="https://wincent.com/a/knowledge-base/archives/2005/04/upgrading_to_su_1.php" title="Upgrading to Subversion 1.1.4" />

<link rel="next" href="https://wincent.com/a/knowledge-base/archives/2005/05/keeping_subvers.php" title="Keeping Subversion alive and other notes on the update to Mac OS X 10.4" />
...
<body>
  ...
  <div id="breadcrumbs">
    <p><a href="https://wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../../../">Knowledge Base</a>&nbsp;&gt;&nbsp;<a href="../../">Archives</a>&nbsp;&gt;&nbsp;<a href="../">2005</a>&nbsp;&gt;&nbsp;04    </p>
  </div>
...
<p align="right">
<a href="https://wincent.com/a/knowledge-base/archives/2005/04/upgrading_to_su_1.php">&laquo; Upgrading to Subversion 1.1.4</a> |

<a href="https://wincent.com/a/knowledge-base/">Main</a>
| <a href="https://wincent.com/a/knowledge-base/archives/2005/05/keeping_subvers.php">Keeping Subversion alive and other notes on the update to Mac OS X 10.4 &raquo;</a>

</p>

<h2>April 23, 2005</h2>

<h3>Information for beta testers</h3>

<p>This article contains information about how to participate in beta testing programs for Wincent products.</p>

<div id="a000058more"><div id="more">
<h4>About the beta testing programs</h4>

<p>The beta testing programs provide you with an opportunity to contribute to the development of <a href="https://wincent.com/">Wincent products</a> whether they be open source like <a href="https://wincent.com/a/products/winswitch/">WinSwitch</a> or closed source like <a href="http://synergyadvance.com/">Synergy Advance</a>. In the programs, pre-release builds are made available to participants for download. The participants report bugs or problems found in the build; Wincent then attempts to fix the problem and produces another build and the testers confirm that the problem no longer exists. Sometimes a beta will go through several test-and-fix cycles before release and on other occasions a beta will end up being released as the final product.</p>

<p>It is important to realize that participating in the beta program is hard work; it is not an opportunity to get free sneak peeks at unreleased software. The pre-release builds are unsupported software that have received only internal testing by Wincent. If you find a bug you are expected to do some work isolating the problem and the circumstances under which it occurs. If you are not prepared to file thorough bug reports you should not join the beta programs (see <a href="https://wincent.com/a/knowledge-base/archives/2004/11/how_to_file_a_g.php">this article</a> for tips on how to file a good bug report).</p>

<h4>How to join the a beta testing program</h4>

<p>All Wincent beta testing programs are coordinated via mailing lists. You join the program by subscribing to the mailing list and you can leave it by unsubscribing. Instructions for how to join or leave the mailing lists appear <a href="https://wincent.com/a/support/lists/">here</a>.</p>

<h4>How the programs work</h4>

<p>When a new build is available on the servers Wincent sends an announcement to the corresponding beta mailing list for that product. If you discover problems when you download, install and test the build, you should do the following:</p>

<ol>
  <li>Search the <a href="http://bugs.wincent.com/">bugs database</a> to see if the bug has already been reported. If it has, add your comments to the existing report; otherwise file a new report.</li>
  <li>If you filed a new report, notify the other beta testers by posting a reply to the mailing list. Be sure to include a link to your bug report. In this way, everyone in the program can keep up-to-date on which bugs have been reported. (Your replies to the mailing list will be moderated by Wincent to prevent spam from getting through to the list, but they will not otherwise be modified.)</li>
</ol>

<p>Once a piece of software enters beta testing no more new features will be added prior to release; the focus of the beta phase is eliminating bugs. As such you should not post any feature requests back to the mailing list (you are should post your feature requests to the <a href="http://bugs.wincent.com/">bug tracking database</a>, but in doing so you are submitting requests for a future release of the product and not for the version currently under beta testing).</p>

<h4>Non-disclosure and confidentiality</h4>

<p>Unless otherwise specified non-disclosure (confidentiality) generally applies to all Wincent beta releases. This means that the software is not for public discussion or redistribution; the appropriate forum for discussing the beta releases is on the corresponding beta mailing list and in the bug tracking database.</p>

<h4>Are free licenses available for beta testers?</h4>

<p>No. Due to the number of people volunteering for beta testing it is not possible to give away free licenses to beta testers.</p>
</div></div>

<p class="posted">Posted by wincent at April 23, 2005 12:06 AM</p>
