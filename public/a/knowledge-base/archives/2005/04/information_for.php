...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      ...
      title="Upgrading to Subversion 1.1.4"
    />
    ...
    <div id="container">
      <div class="content">
        <p align="right">
          <a
            href="https://wincent.com/a/knowledge-base/archives/2005/04/upgrading_to_su_1.php"
            >&laquo; Upgrading to Subversion 1.1.4</a
          >
          |
        ...
        <p>
          This article contains information about how to participate in beta
          testing programs for Wincent products.
        </p>
        ...
        <div id="a000058more">
          <div id="more">
            ...
            <p>
              The beta testing programs provide you with an opportunity to
              contribute to the development of
              <a href="https://wincent.com/">Wincent products</a> whether they
              be open source like
              ...
              another build and the testers confirm that the problem no longer
              exists. Sometimes a beta will go through several test-and-fix
              cycles before release and on other occasions a beta will end up
              being released as the final product.
            </p>

            <p>
              It is important to realize that participating in the beta program
              is hard work; it is not an opportunity to get free sneak peeks at
              unreleased software. The pre-release builds are unsupported
              software that have received only internal testing by Wincent. If
              you find a bug you are expected to do some work isolating the
              problem and the circumstances under which it occurs. If you are
              not prepared to file thorough bug reports you should not join the
              beta programs (see
              <a
                href="https://wincent.com/a/knowledge-base/archives/2004/11/how_to_file_a_g.php"
                >this article</a
              >
              for tips on how to file a good bug report).
            </p>

            <h4>How to join the a beta testing program</h4>

            <p>
              All Wincent beta testing programs are coordinated via mailing
              lists. You join the program by subscribing to the mailing list and
              you can leave it by unsubscribing. Instructions for how to join or
              leave the mailing lists appear
              <a href="https://wincent.com/a/support/lists/">here</a>.
            </p>

            <h4>How the programs work</h4>

            <p>
              When a new build is available on the servers Wincent sends an
              announcement to the corresponding beta mailing list for that
              product. If you discover problems when you download, install and
              test the build, you should do the following:
            </p>
            ...
            <ol>
              ...
              <li>
                If you filed a new report, notify the other beta testers by
                posting a reply to the mailing list. Be sure to include a link
                to your bug report. In this way, everyone in the program can
                keep up-to-date on which bugs have been reported. (Your replies
                to the mailing list will be moderated by Wincent to prevent spam
                from getting through to the list, but they will not otherwise be
                modified.)
              </li>
            </ol>

            <p>
              Once a piece of software enters beta testing no more new features
              will be added prior to release; the focus of the beta phase is
            ...
            <p>
              Unless otherwise specified non-disclosure (confidentiality)
              generally applies to all Wincent beta releases. This means that
              the software is not for public discussion or redistribution; the
              appropriate forum for discussing the beta releases is on the
              corresponding beta mailing list and in the bug tracking database.
            </p>

            <h4>Are free licenses available for beta testers?</h4>

            <p>
              No. Due to the number of people volunteering for beta testing it
              is not possible to give away free licenses to beta testers.
            </p>
          </div>
        </div>
