...
<link rel="prev" href="http://www.wincent.com/a/knowledge-base/archives/2005/05/keeping_subvers.php" title="Keeping Subversion alive and other notes on the update to Mac OS X 10.4" />

<link rel="next" href="http://www.wincent.com/a/knowledge-base/archives/2005/05/building_subver_1.php" title="Building Subversion 1.2 on Mac OS X 10.4.1" />
...
<body>
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../../../">Knowledge Base</a>&nbsp;&gt;&nbsp;<a href="../../">Archives</a>&nbsp;&gt;&nbsp;<a href="../">2005</a>&nbsp;&gt;&nbsp;05    </p>
  </div>
...
<p align="right">
<a href="http://www.wincent.com/a/knowledge-base/archives/2005/05/keeping_subvers.php">&laquo; Keeping Subversion alive and other notes on the update to Mac OS X 10.4</a> |

<a href="http://www.wincent.com/a/knowledge-base/">Main</a>
| <a href="http://www.wincent.com/a/knowledge-base/archives/2005/05/building_subver_1.php">Building Subversion 1.2 on Mac OS X 10.4.1 &raquo;</a>
...
<p>I've now had a few weeks to play with Tiger and wanted to post some brief comments about it. In many ways it's the best operating system ever to come out of Cupertino (or anywhere else in the world) but there are still some problems with it and I hope Apple can correct them in the forthcoming point updates.</p>

<div id="a000069more"><div id="more">
<h4>Spotlight</h4>

<p>Wow. What a lot of potential. Unfortunately, it's still mostly unrealized potential and hasn't been capitalized upon yet.</p>

<p>Thanks to Spotlight you should never have to navigate to the Applications folder again. At least, that's the theory. Spotlight is so slow that I can easily type the entire name of an application before it appears in the search results list. For example, if I want to launch the Keychain Access application I can type "Acceso a Llaves" (that's what it's called on my Spanish system) and watch as it takes nearly a full minute to return any meaningful results. Sadly in almost all cases its quicker to launch an application by navigating to it in the Finder using your trusty old mouse.</p>

<p>It doesn't prioritize results on the basis of the ordering I've set in the Spotlight preferences either. For example, I've dragged "Applications" to near the top of the list but Application search results are often the very last to be returned in a search.</p>

<p>The general slowness of the Spotlight UI can be a problem in other ways. Even moderately fast typers will often see Spotlight failing to keep up with their typing. Hit Command-Space (that's the shortcut I have to open the Spotlight search bar) and immediately start typing and you'll often find that only the second half of the word you type appear in the search bar appears. The first half is simply lost. Goodness knows where it gets sent. When this is combined with the fact that the search only matches items where the beginning of your query string matches the beginning of a word in the file name and you often don't get results (for example, "ystem Preferences" does not return the System Preferences application but "System Preferences" does). I often see beachballs in the Spotlight search bar as well.</p>

<p>I <a href="http://bugreporter.apple.com/">filed a number of bugs with Apple</a> because I want Spotlight to fulfill its potential. I suggest you do the same; it's the only way they'll listen. Here are some suggested things you could file bug reports about:</p>

<p><em>How do you search inside bundles?</em> Answer: you can't.</p>

<p><em>Why does Apple explicitly exclude the Developer documentation from Spotlight searches?</em> It would seem one of the most logical places in the world that one would want to search.</p>

<p><em>Why can't you use the Finder to find files on your disk when you <strong>know</strong> that they exist?</em> For example, try to find "httpd.conf" using the Finder. You can't. The only way to find it is to go to the Terminal and use the "find" or "locate" commands. It seems that the "Finder" isn't living up to its name. There's no way to correct this shortcoming, even using advanced search criteria.</p>

<p><em>Why can't you create smart folders or search based on full paths (the kMDItemPath attribute)?</em> Answer: because Apple's metadata importers don't set this attribute on any files at all. My bug report for this one (4112685) was immediately closed as a duplicate.</p>

<p><em>How do you distinguish between extremely similar results?</em> What do you do when you get a lot of results with the same name? The Spotlight search bar provides you with no help at all and the "Show all" window is in dire need of a better preview mechanism and path display (as well as type-ahead find). You currently have to click a tiny "i" button or use the cursor keys to expose preview information when moving the selection should be enough to display a preview. The same problem occurs when using the search facility inside file dialogs. Type in a file name: how do you distinguish between multiple copies with the same name?</p>

<p>But like I said, Spotlight has a lot of potential. <a href="http://www.macosxhints.com/article.php?story=20050501190159752">This hint</a> shows how you can do raw queries in the Finder to find just about anything at all, including complicated boolean searches. Unfortunately, this too is of limited use because I find that most such queries crash the Finder or give me the spinning beachball. One guaranteed beachballer is to try searching for files of type "Xcode project files" and then add another criterion or two. Watch as the Finder CPU usage approaches 100%, beachballs and finally dies. </p>

<h4>Mail</h4>

<p>There have been lots of improvements here. I'm a big fan of the better control over signatures, the better handling of incorrect password attempts when signing or encrypting messages, and the unbelievable search speed. Some have reported that the new Mail is too slow, but for me its faster exactly where it needs to be: in searches.  Not only is it fast, it's also robust. Previous versions of Mail would refuse to find mails even when I knew they were in the corpus and could navigate to them manually. Another nice touch is that the mailboxes list scrolls orders of magnitude faster.</p>
...
<p>The UI is more polished and as a whole the application seems more stable.</p>

<h4>General comments</h4>

<p>The optimizations to Quartz in Tiger are fabulous. Window resizing is much more responsive and the new QuickTime Player is very slick. There is no doubt that Tiger is much, much faster at many things. Dashboard is neat and is even more useful when you know that you can close any <a href="http://www.macosxhints.com/article.php?story=20050425041434294">dashboard widget by holding the option key</a>, or <a href="http://www.macosxhints.com/article.php?story=20050422172929402">detach widgets from the dashboard</a> at will.</p>

<p>Mac OS X Hints is a valuable resource right now for tips <a href="http://www.macosxhints.com/article.php?story=20050424201429961">like this one</a>, but the sad truth is that you shouldn't have to resort to these kinds of measures to oblige Spotlight (kicking and screaming) to do what you want. The Spotlight preferences panel needs a lot of work... On the bright side, things can only get better from here.</p>
</div></div>
