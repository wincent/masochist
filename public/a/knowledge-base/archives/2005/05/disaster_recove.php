...
<link rel="prev" href="https://wincent.com/a/knowledge-base/archives/2005/05/building_subver_1.php" title="Building Subversion 1.2 on Mac OS X 10.4.1" />

<link rel="next" href="https://wincent.com/a/knowledge-base/archives/2005/07/upgrading_to_su_2.php" title="Upgrading to Subversion 1.2.1 on Mac OS X 10.4.2" />
...
<p align="right">
<a href="https://wincent.com/a/knowledge-base/archives/2005/05/building_subver_1.php">&laquo; Building Subversion 1.2 on Mac OS X 10.4.1</a> |

<a href="https://wincent.com/a/knowledge-base/">Main</a>
| <a href="https://wincent.com/a/knowledge-base/archives/2005/07/upgrading_to_su_2.php">Upgrading to Subversion 1.2.1 on Mac OS X 10.4.2 &raquo;</a>
...
<p>I've had a <a href="https://wincent.com/a/about/wincent/weblog/archives/2005/05/1041_kernel_pan.php">fairly bad run</a> lately (kernel panics, disk corruption, reinstalls). Here are some notes I made while configuring some UNIX tools &mdash; Apache 2, Subversion and the like &mdash; on the fresh install. These notes contain a lot of hard-coded paths that are specific to my installation but they may be of use to somebody out there...</p>
...
<p>Make edits to "/usr/local/apache2/conf/httpd.conf" as indicated below:</p>
...
<p>Make edits to "/Library/StartupItems/Apache2/StartupParameters.plist":</p>
...
<p>And finally fire up Apache 2. I had to reset my repository password for some reason but after doing that everything works fine.</p>

<pre>sudo /usr/local/apache2/bin/apachectl start
