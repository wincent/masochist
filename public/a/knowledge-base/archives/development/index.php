  ...
  <body>
    ...
    <div id="container">
      <div class="content">
        ...
        <p>
          By default, GCC warns when a subclass is marked as adopting a protocol
          and it inherits protocol methods from its superclass rather than
        ...
        <p>
          ...
          framework, WOTest. In doing so I've had cause to think about unit
          testing "best practice", or at least what works best for me.
        </p>
        <p>
          <a
        ...
        <p>
          If you want to build a Universal Binary that runs on both Panther
          (PowerPC) and Tiger (PowerPC and Intel) then you'll have to make a
          couple of custom build settings. From reading the xcode-users mailing
          list and revising the Apple release notes and documentation a couple
          things have become clear to me.
        </p>
        <p>
          <a
            href="https://wincent.com/a/knowledge-base/archives/2005/07/building_univer.php"
            >Read full article</a
          >
        </p>
