    ...
    >
      ...
      <tr>
        ...
        >
          ...
          /></a>
          <img
            src="/a/gfx/services-header.jpg"
            width="210"
            height="19"
            alt="wincent: services"
            align="middle"
          />
          <!-- End: header content -->
        </td>
          ...
          <ul style="width: 63px; height: 25px;">
            <li class="menu">
              <a
                ...
                ><img
                  src="/a/gfx/header/services-on.jpg"
                  width="63"
                  height="25"
                  alt="Services"
              /></a>
    ...
    <div id="container">
      <div id="left">
        <div class="sidebar">
          ...
          <ul>
            <li>
              <a href="https://typechecked.net/a/services/custom-development/"
                >Custom development</a
              >
            </li>
            <li>
              <a href="https://typechecked.net/a/services/mac-consultancy/"
                >Mac consultancy</a
              >
            </li>
            <li>
              <a href="https://typechecked.net/a/services/hosting/">Hosting</a>
            </li>
            <li>
              <a href="https://typechecked.net/a/services/web-design/"
                >Web design</a
              >
            </li>
          </ul>
      ...
      <div id="center">
        <div class="content">
          ...
          <p>
            <a href="../../about/">Wincent</a> does not currently provide any
            hosting of its own but instead recommends the best-of-class managed
            hosting service provided by Rackspace. If you use the following link
            to contract hosting services with Rackspace Wincent will receive a
            small commission:
            <img
              src="http://service.bfast.com/bfast/serve?bfmid=30735717&amp;siteid=41506187&amp;bfpage=hosting_headaches"
              border="0"
              width="1"
              height="1"
              alt="Spacer"
            /><a
              ...
              target="_top"
              >Save Yourself Hosting Headaches</a
            >.
          </p>
        </div>
      </div>
