...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>wincent: custom development services</title>
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../">Services</a>&nbsp;&gt;&nbsp;Custom Development    </p>
  </div>
    <div id="container">
      <div id="left">
        <div class="sidebar">
      ...
      <div id="center">
        <div class="content">
          ...
          <p><a href="../../about/">Wincent</a> offers custom Macintosh and UNIX development &mdash; applications built to your specifications &mdash; that leverage a number of Mac OS X and UNIX technologies:</p>
          
          <ul>
            <li>Cocoa, Carbon, POSIX layers</li>
            <li>Objective-C, C, Perl, PHP, sh languages</li>
          </ul>
          
          <p>Currently, new clients can only be accepted on a <a href="../../contact/mail/">referral</a> basis.</p>
