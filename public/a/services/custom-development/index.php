    ...
    <div id="container">
      ...
      <div id="center">
        <div class="content">
          ...
          <p>
            <a href="../../about/">Wincent</a> offers custom Macintosh and UNIX
            development &mdash; applications built to your specifications
            &mdash; that leverage a number of Mac OS X and UNIX technologies:
          </p>
          ...
          <p>
            Currently, new clients can only be accepted on a
            <a href="../../contact/mail/">referral</a> basis.
          </p>
        </div>
      </div>
      <div id="right">
