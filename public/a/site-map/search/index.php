...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <div id="breadcrumbs">
    <p><a href="http://www.wincent.com/">Main</a>&nbsp;&gt;&nbsp;<a href="../">Site Map</a>&nbsp;&gt;&nbsp;Search    </p>
  </div>
    <div id="container">
      <div class="content">
        ...
        <p>Search this site using <a href="http://www.google.com/">Google</a>:</p>
        ...
        <td nowrap="nowrap">
        <input type="hidden" name="domains" value="wincent.com"></input>
        ...
        <td>
        <input type="radio" name="sitesearch" value="wincent.com" checked id="ss1"></input>
        <label for="ss1" title="Search wincent.com"><font size="-1" color="black">wincent.com</font></label></td>
        </tr>
        </table>
        <input type="hidden" name="client" value="pub-3544007006233860"></input>
        <input type="hidden" name="forid" value="1"></input>
        <input type="hidden" name="ie" value="UTF-8"></input>
        <input type="hidden" name="oe" value="UTF-8"></input>
        <input type="hidden" name="safe" value="active"></input>
        <input type="hidden" name="cof" value="GALT:#0066CC;GL:1;DIV:#999999;VLC:336633;AH:center;BGC:FFFFFF;LBGC:FFFFFF;ALC:0066CC;LC:0066CC;T:000000;GFNT:666666;GIMP:666666;LH:50;LW:420;L:http://www.wincent.com/a/gfx/google-search-header.png;S:http://wincent.com;FORID:1"></input>
