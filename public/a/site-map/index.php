...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <div id="breadcrumbs">
      <p><a href="https://typechecked.net/">Main</a>&nbsp;&gt;&nbsp;Site Map</p>
    </div>
    <div id="container">
      <div class="content">
        <h3>Site map</h3>
        ...
        <div class="two-columns">
          ...
          <ul>
            <li>
              <a
                href="https://typechecked.net/a/products/synergy-classic/"
                title="The original iTunes menu bar controller"
                >Synergy</a
              >
              <ul>
                <li>
                  <a
                    href="https://typechecked.net/a/products/synergy-classic/download/"
                    title="Download Synergy"
                    >Download</a
                  >
                </li>
                ...
                <li>
                  <a
                    href="https://typechecked.net/a/products/synergy-classic/donate/"
                    title="Support development with a donation"
                    >Donate</a
                  >
                </li>
                ...
                <li>
                  <a
                    href="https://typechecked.net/a/products/synergy-classic/faq/"
                    title="Frequently Asked Questions"
                    >FAQ</a
                  >
                </li>
          ...
          <ul>
            ...
            <li>
              <a
                href="https://typechecked.net/a/products/winhex/"
                title="Programmers number conversion tool"
                >WinHex</a
              >
              <ul>
                <li>
                  <a
                    href="https://typechecked.net/a/products/winhex/download/"
                ...
                <li>
                  <a
                    href="https://typechecked.net/a/products/winhex/purchase/"
                ...
                <li>
                  <a
                    href="https://typechecked.net/a/products/winhex/donate/"
                    title="Support development with a donation"
                    >Donate</a
                  >
                </li>
                ...
                <li>
                  <a
                    href="https://typechecked.net/a/products/winhex/faq/"
                    title="Frequently Asked Questions"
                    >FAQ</a
                  >
                </li>
            ...
            <li>
              <a
                href="https://typechecked.net/a/products/wotest/"
                title="Objective-C unit testing framework"
                >WOTest</a
              >
              <ul>
                <li>
                  <a href="https://typechecked.net/a/products/wotest/#download"
                    >Download</a
                  >
                </li>
                <li>
                  <a href="https://typechecked.net/a/products/wotest/#donations"
                    >Donate</a
                  >
                </li>
              </ul>
            ...
            <li>
              ...
              <ul>
                <li>
                  <a
                    href="https://typechecked.net/a/products/wincent-strings-util/#download"
                    >Download</a
                  >
                </li>
                <li>
                  <a
                    href="https://typechecked.net/a/products/wincent-strings-util/#donations"
                    >Donate</a
                  >
                </li>
              </ul>
            ...
            <li>
              ...
              <ul>
                <li>
                  <a href="https://typechecked.net/a/products/atosym/#download"
                    >Download</a
                  >
                </li>
                <li>
                  <a href="https://typechecked.net/a/products/atosym/#donations"
                    >Donate</a
                  >
                </li>
              </ul>
            ...
            <li>
              ...
              <ul>
                <li>
                  <a href="https://typechecked.net/a/products/buildtools/#download"
                    >Download</a
                  >
                </li>
                <li>
                  <a href="https://typechecked.net/a/products/buildtools/#donations"
                    >Donate</a
                  >
                </li>
              </ul>
          ...
          <ul>
            <li>
              ...
              <ul>
                <li>
                  <a href="https://typechecked.net/a/products/bansshee/#download"
                    >Download</a
                  >
                </li>
                <li>
                  <a href="https://typechecked.net/a/products/bansshee/#donations"
                    >Donate</a
                  >
                </li>
              </ul>
